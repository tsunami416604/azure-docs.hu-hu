...
A [Web Apps](/app-service/overview) az App Service fő ajánlata webalkalmazások Windows-környezetek segítségével történő összeállításához és üzemeltetéséhez. A Linux-környezeteket előnyben részesítő fejlesztőknek az [App Service for Linuxot](/app-service/overview#app-service-on-linux) érdemes választaniuk. A fejlesztők közvetlenül az App Service for Linuxban is üzembe helyezhetik a rendszerképeket az egyéni futtatókörnyezetek/keretrendszerek beüzemeléséhez.
...
- Alkalmazás létrehozása a következő használatával:
  ...
  - [Node.js és MongoDB](/azure/app-service/tutorial-nodejs-mongodb-app)
  - [Java és MySQL](/app-service/app-service-web-tutorial-java-mysql)
  - [Python és PostgreSQL](/app-service/tutorial-python-postgresql-app)
