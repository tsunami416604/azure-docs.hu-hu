---
title: Exportált Resource Manager sablon testreszabása | Microsoft Docs
...
1. A saját parancsfájl használatával történő telepítéshez használja az alábbi lehetőségek egyikét:
...
2. Ha letöltötte az exportált sablont és a parancsfájlokat, keresse meg a **deploy.ps1** fájlt (PowerShell esetén) vagy a **deploy.sh** fájlt (Azure parancssori felület esetén).
