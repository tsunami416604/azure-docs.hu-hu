...
Az SSH-val kombinálva egy egyszerű bash-szkript ugyanazt az eredményt eredményezheti a következő példában. A `$computer` változót hasonlóan a felhasználó tölti fel:
