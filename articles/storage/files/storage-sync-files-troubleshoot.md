...
A szinkronizálási munkamenetek a hibák egyikével meghiúsulnak, ha sok olyan fájl van, amely nem tud szinkronizálni az egyes elemek hibáival. Hajtsa végre a Hogyan ismertetett lépéseket arról, hogy vannak-e olyan [fájlok vagy mappák, amelyek nincsenek szinkronizálva?](https://docs.microsoft.com/azure/storage/files/storage-sync-files-troubleshoot?tabs=portal1%2Cazure-portal#how-do-i-see-if-there-are-specific-files-or-folders-that-are-not-syncing) szakasz az egyes elemek hibáinak elhárításához. Szinkronizálási hiba ECS_E_SYNC_METADATA_KNOWLEDGE_LIMIT_REACHED esetén nyisson meg egy támogatási esetet.
