...
Ha figyelembe veszi az állásidőt, és készen áll arra, hogy offline állapotba hozza a StorSimple helyet, tegye meg a következőt: például távolítsa el az SMB-megosztást, hogy egyetlen felhasználó sem férhet hozzá a mappához, vagy tegyen meg semmilyen más olyan lépést, amely megakadályozza a tartalom módosítását mappa a StorSimple.
