...
A Soft delete parancsmagok az [Azure CLI-moduljának](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest)2.1.3-es és újabb verzióiban érhetők el.
