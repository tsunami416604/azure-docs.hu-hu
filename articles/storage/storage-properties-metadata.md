<properties 
  pageTitle ="設定和擷取屬性及 Azure 儲存體中的物件中繼資料 |Microsoft Azure 「 
  描述 ="將自訂中繼資料儲存在 Azure 儲存體中的物件和設定並擷取系統屬性 」。 
  services="storage" 
  documentationCenter="" 
  authors="tamram" 
  manager="adinah" 
...
- [Azure Storage Client Library for.NET 參考](http://msdn.microsoft.com/library/azure/wa_storage_30_reference_home.aspx)
- [.NET 套件的 azure 儲存體用戶端程式庫](https://www.nuget.org/packages/WindowsAzure.Storage/)
