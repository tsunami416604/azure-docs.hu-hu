...
- **Számítógép-konfiguráció**
  ...
  - .NET-keretrendszer 4 telepítve kell lennie. Lásd: [– gyakori kérdések](#faq) hogyan ellenőrizheti, ha a .NET-keretrendszer telepítve van-e a gépen.
...
| Paraméterek | Leírás |
| --- | --- |
|     /j:&lt;JournalFile&gt;  | **Kötelező**<br/> A naplófájl elérési útja. A naplófájl meghajtók készletét követi, és ezek a meghajtók előkészítése a folyamat állapotát rögzíti. A naplófájl mindig meg kell adni.  |
...
|     / ID:&lt;munkamenet-azonosító&gt;  | **Kötelező**<br/> A munkamenet-azonosító egy másolási munkamenet azonosítására szolgál. Győződjön meg, hogy egy megszakított másolási munkamenet pontos helyreállítási szolgál.  |
...
|     /sn:&lt;StorageAccountName&gt;  | **Kötelező**<br/> Csak a RepairImport és RepairExport alkalmazható. A tárfiók neve.  |
|     /sk:&lt;StorageAccountKey&gt;  | **Kötelező**<br/> A tárfiók kulcsa. |
...
|     /DataSet:&lt;dataset.csv&gt; | **Kötelező**<br/> Egy CSV-fájl, amely a címtárak listájának és/vagy a cél-meghajtók másolandó fájlok listáját tartalmazza.  |
