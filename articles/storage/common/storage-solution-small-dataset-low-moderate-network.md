...
| Funkció | Azure Storage Explorer | Azure Portal | AzCopy<br>Azure PowerShell<br>Azure CLI | Az Azure Storage REST API-k és SDK-kkal |
|---------|------------------------|--------------|-----------------------------------------|---------------------------------|
...
| Blob storage-műveletek engedélyezett<br>a blobok és mappák | Töltsön fel<br>Letöltés<br>Kezelés | Töltsön fel<br>Letöltés<br>Kezelés |Töltsön fel<br>Letöltés<br>Kezelés | Igen, testre szabható |
| Engedélyezett Gen1 a Data Lake storage<br>a fájlok és mappák műveletek | Töltsön fel<br>Letöltés<br>Kezelés | Nem |Töltsön fel<br>Letöltés<br>Kezelés                   | Nem |
| Engedélyezett fájl tárolási műveletek<br>a fájlok és könyvtárak | Töltsön fel<br>Letöltés<br>Kezelés | Töltsön fel<br>Letöltés<br>Kezelés   |Töltsön fel<br>Letöltés<br>Kezelés | Igen, testre szabható |
