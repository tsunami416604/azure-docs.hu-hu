...
| Delete Blob | [Első lépések az Azure Blob Service-szel a Pythonban](https://github.com/Azure-Samples/storage-blob-python-getting-started/blob/master/blob_basic_samples.py#L114) |
...
| Container ACL/Metadata/Properties | [Első lépések az Azure Blob Service-szel a Pythonban](https://github.com/Azure-Samples/storage-blob-python-getting-started/blob/master/blob_advanced_samples.py#L268) |
...
| **Forgatókönyv** | **Mintakód** |
|--------------|-----------------|
| Tábla létrehozása | [Első lépések az Azure Table Service-szel a Pythonban](https://github.com/Azure-Samples/storage-table-python-getting-started/blob/master/table_basic_samples.py#L46) |
