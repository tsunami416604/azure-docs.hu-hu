---
title: azcopy betöltése | Microsoft Docs
titleSuffix: Azure Storage
description: Ez a cikk a azcopy Load paranccsal kapcsolatos tudnivalókat tartalmaz.
author: normesta
ms.service: storage
ms.topic: reference
ms.date: 07/24/2020
...
ms.locfileid: "87294327"
---
# <a name="azcopy-load"></a>azcopy load

Az adatátvitelhez kapcsolódó alparancsok adott formátumokban

## <a name="synopsis"></a>Áttekintés

Az adatátvitelhez kapcsolódó alparancsok adott formátumokban, például a Microsoft avere Cloud FileSystem (CLFS) formátumában.
...
|Beállítás|Leírás|
|--|--|
|-h,-– Súgó|A betöltési parancs súgójának tartalmát jeleníti meg.|
