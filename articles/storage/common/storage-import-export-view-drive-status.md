...
Az importálási vagy exportálási feladatok állapotát a Azure Portal az **Importálás/exportálás** lapon követheti nyomon. A feladatok listája megjelenik az oldalon.
...
| Zárt | Miután az összes meghajtót visszaküldi a rendszer, ha a feladatok feldolgozásakor hiba történt, a rendszer **Lezártra** állítja a feladatot. A feladatot a rendszer a 90 nap után automatikusan törli a **lezárt** állapotban. |
...
|:--- |:--- |:--- |
| NeverReceived | Egy **NeverReceived** jelölésű meghajtó (mivel a feladatok szállításának részeként nem érkezett meg) egy másik szállítmányban érkezik. | Az operatív csapat áthelyezi a meghajtót a **fogadásba** . |
...
* [Adatok átvitele a AzCopy parancssori segédprogrammal](./storage-use-azcopy-v10.md)
