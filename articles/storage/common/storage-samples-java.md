...
| Delete Blob | [Első lépések az Azure Blob Service-ben Java-ban](https://github.com/Azure-Samples/storage-blob-java-getting-started/blob/master/src/BlobBasics.java) |
...
| Container ACL/Metadata/Properties | [Első lépések az Azure Blob Service-ben Java-ban](https://github.com/Azure-Samples/storage-blob-java-getting-started/blob/master/src/BlobAdvanced.java) |
...
| Lapblob | [Első lépések az Azure Blob Service-ben Java-ban](https://github.com/Azure-Samples/storage-blob-java-getting-started/blob/master/src/BlobBasics.java) |
...
| Snapshot Blob | [Első lépések az Azure Blob Service-ben Java-ban](https://github.com/Azure-Samples/storage-blob-java-getting-started/blob/master/src/BlobBasics.java) |
...
| **Forgatókönyv** | **Mintakód** |
|--------------|-----------------|
| Tábla létrehozása | [Bevezetés az Azure Table Service használatába Javában](https://github.com/Azure-Samples/storage-table-java-getting-started/blob/master/src/main/java/com/microsoft/azure/cosmosdb/tablesample/TableBasics.java) |
