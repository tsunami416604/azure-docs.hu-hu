...
1. Válassza a **template Deployment (üzembe helyezés egyéni sablonok használatával)**, majd a létrehozás lehetőséget, majd **a szerkesztőben válassza a saját sablon** **létrehozása**lehetőséget.
