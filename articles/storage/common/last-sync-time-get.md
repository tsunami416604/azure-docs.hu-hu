...
A Storage-fiók Azure CLI-vel való utolsó szinkronizálási időpontjának lekéréséhez tekintse meg a Storage-fiók **geoReplicationStats. lastSyncTime** tulajdonságát. A `--expand` paraméterrel a **geoReplicationStats**alatt beágyazott tulajdonságok értékeit lehet visszaadni. Ne felejtse el lecserélni a helyőrző értékeket a saját értékeire:
