...
|Azure Event Hub|Általánosan elérhető|[Események rögzítése az Azure-eseményközpontokon keresztül az Azure Blob Storage-ban vagy az Azure Data Lake Storage-ban](https://docs.microsoft.com/azure/event-hubs/event-hubs-capture-overview)|
|Azure Event Grid|Általánosan elérhető|[Oktatóanyag: Valósítsa meg a Data Lake rögzítési mintáját a Databricks Delta tábla frissítéséhez](data-lake-storage-events.md)|
