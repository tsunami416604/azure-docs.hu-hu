...
> [!NOTE]
> Az `$blobchangefeed` tároló csak azután jelenik meg, hogy engedélyezte a fiók módosítása funkciót. A tárolóban lévő Blobok listázása előtt néhány percet várnia kell, miután engedélyezte a változási csatornát. 
...
- Az egyes szegmensek különböző számú `chunkFilePaths` rendelkezhetnek, mivel a naplók belső particionálása a közzétételi átviteli sebesség kezelésére használható. Az egyes `chunkFilePath`okban lévő naplófájlok garantáltan kölcsönösen kizárják egymást, és párhuzamosan is feldolgozhatók és feldolgozhatók, anélkül, hogy az iteráció során megsértsék a Blobok módosításának sorrendjét.
...
- A naplófájl `url` tulajdonsága jelenleg mindig üres.
