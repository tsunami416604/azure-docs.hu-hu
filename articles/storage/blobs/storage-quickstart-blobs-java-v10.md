---
title: 'Gyors útmutató: BLOB létrehozása a Java Storage SDK használatával'
...
1. Hozza létre a **StorageURL** objektum egy példányát, amely a tárfiókra mutat.
    ...
    * A [StorageURL](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._storage_u_r_l?view=azure-java-stable) objektum az Ön tárfiókját jelöli. Ezzel hozza létre az új folyamatokat. 
    ...
    * A folyamat használatával hozza létre a [ServiceURL](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._service_u_r_l?view=azure-java-stable) objektum egy példányát.
    * A **ServiceURL** objektum használatával hozza létre a [ContainerURL](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._container_u_r_l?view=azure-java-stable) egy példányát.
...
2. Hozza létre a **ContainerURL** objektum egy példányát. Ez azt a tárolót jelöli, amelyhez Ön hozzá szeretne férni. A tárolók a blobok rendszerezésére szolgálnak, akárcsak a számítógépen a fájlok rendszerezésére használt mappák.
    ...
    * A [ContainerURL](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._container_u_r_l?view=azure-java-stable) használatával létrehozhatja a [BlobURL](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._blob_u_r_l?view=azure-java-stable) objektum egy példányát.
...
A tárolóban található objektumok listája a [ContainerURL.listBlobsFlatSegment](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._container_u_r_l.listblobsflatsegment?view=azure-java-stable) paranccsal kérhető le. Ez a metódus egyszerre legfeljebb 5000 objektumot ad vissza, valamint egy folytatási jelölőt (következő jelölőt), ha további listázható elemek is vannak még a tárolóban. Hozzon létre egy segédfüggvényt, amely ismételten meghívja önmagát egészen addig, ameddig az előző **listBlobsFlatSegment**-válasz tartalmaz egy következő jelölőt.
...
Blobokat a helyi lemezre a [BlobURL.download](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._blob_u_r_l.download?view=azure-java-stable) metódussal tölthet le.
...
Ha nincs szüksége az ebben a rövid útmutatóban feltöltött blobokra, a teljes tárolót törölheti a [ContainerURL.delete](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._container_u_r_l.delete?view=azure-java-stable) paranccsal. Ez a metódus a tárolóban található fájlokat is törli.
...
> [A Java Storage SDK V10 forráskódja](https://github.com/Azure/azure-storage-java/)
> [API-referencia](https://docs.microsoft.com/java/api/overview/azure/storage/client?view=azure-java-stable)
