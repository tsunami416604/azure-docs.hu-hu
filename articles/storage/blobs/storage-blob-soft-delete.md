...
Ha meghívja a [blob törlésének](/rest/api/storageservices/undelete-blob) visszavonása műveletet egy helyreállított alapszintű blobban, a rendszer visszaállítja és az összes kapcsolódó, törölt pillanatképet aktívként. Ha a `Undelete Blob` műveletet egy aktív alapszintű blobon hívja meg, az összes kapcsolódó, törölt pillanatkép aktívként való visszaállítása visszaállítja. Ha a pillanatképek aktívként lettek visszaállítva, a felhasználó által létrehozott pillanatképeket hasonlítják, nem írják felül az alap blobot.

Ha egy blobot egy adott helyreállítható törölt pillanatképre szeretne visszaállítani, meghívhatja `Undelete Blob` az alap blobon. Ezután átmásolhatja a pillanatképet a most aktív blobon keresztül. A pillanatképet egy új blobba is másolhatja.
