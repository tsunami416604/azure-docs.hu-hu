...
A mintakód létrehoz egy helyi fájlt a feltöltés és letöltés, mint a feltölteni kívánt fájl tárolására használt **forrás** és a blob neve **blob**. Az alábbi példa feltölt a fájlt a tároló neve **quickstartblobs**.
