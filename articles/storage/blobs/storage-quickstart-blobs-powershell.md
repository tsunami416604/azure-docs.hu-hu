...
Állítsa be a tároló nevét, majd hozza létre a tárolót a [New-AzStorageContainer](/powershell/module/azure.storage/new-AzStoragecontainer). A fájlokhoz való nyilvános hozzáférés engedélyezéséhez állítsa `blob` értékűre az engedélyeket. A tároló neve ebben a példában: *quickstartblobs*.
...
A tárolóban lévő blobok listájának lekérése használatával [Get-AzStorageBlob](/powershell/module/azure.storage/get-AzStorageblob). A példában csak a feltöltött blobok neve látható.
...
Töltse le a blobokat a helyi lemezre. Minden egyes blob szeretné letölteni, állítsa a nevet, és hívja [Get-AzStorageBlobContent](/powershell/module/azure.storage/get-AzStorageblobcontent) a blob letöltéséhez.
