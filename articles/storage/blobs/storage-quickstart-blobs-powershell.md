...
Töltse le a blobokat a helyi lemezre. Minden egyes blob szeretné letölteni, állítsa a nevet, és hívja [Get-AzStorageBlobConten](/powershell/module/az.storage/get-AzStorageblobcontent) a blob letöltéséhez.
