...
Egy egyéni tartomány regisztrációs eltávolításához használja a [storage-fiók frissítése az](https://docs.microsoft.com/cli/azure/storage/account#az_storage_account_update) CLI parancsot, és adja meg egy üres karakterláncot (`""`) esetében a `--custom-domain` hodnota argumentu.
