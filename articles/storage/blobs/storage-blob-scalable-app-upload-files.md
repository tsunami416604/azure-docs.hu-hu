...
Az oktatóanyag elvégzéséhez el kell végeznie az előző tárolási oktatóanyagot: [hozzon létre egy virtuális gépet és egy Storage-fiókot egy méretezhető alkalmazáshoz][previous-tutorial].
