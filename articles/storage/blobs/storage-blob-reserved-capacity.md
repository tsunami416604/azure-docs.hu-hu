...
Az Azure Storage szolgáltatás számára fenntartott kapacitás egyetlen előfizetéshez vagy egy megosztott erőforráscsoport számára érhető el. Az Azure Storage szolgáltatás számára fenntartott kapacitás megvásárlása esetén a foglalást a blobok és a Azure Data Lake Storage Gen2ek számára is használhatja. A rendszer foglalást alkalmaz a megvásárolt hatókörön belüli használatra, és nem korlátozható az előfizetésben lévő adott tárolási fiókra, tárolóra vagy objektumra. A foglalások nem oszthatók szét több előfizetésre.
...
1. Töltse ki a kötelező mezőket az alábbi táblázatban leírtak szerint:
   ...
   | **Hozzáférési szintek** | Az a hozzáférési szintet, amelyben a foglalás érvényes. A lehetőségek *közé tartoznak*a *gyakori, a*ritka elérésű és az *archív*beállítások. A hozzáférési szintekkel kapcsolatos további információkért lásd [: Azure Blob Storage: gyakori, ritka elérésű és archív hozzáférési szintek](storage-blob-storage-tiers.md). |
