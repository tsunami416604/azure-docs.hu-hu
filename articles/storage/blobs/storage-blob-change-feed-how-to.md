...
A [CloudStorageAccount. TryParse](/dotnet/api/microsoft.windowsazure.storage.cloudstorageaccount.tryparse) metódus meghívásával elemezheti a kapcsolatok karakterláncát. 

Ezután hozzon létre egy objektumot, amely a Storage-fiókban lévő Blob Storage jelképezi, és hívja meg a [CloudStorageAccount. CreateCloudBlobClient](https://docs.microsoft.com/dotnet/api/microsoft.windowsazure.storage.cloudstorageaccount.createcloudblobclient?view=azure-dotnet) metódust.
