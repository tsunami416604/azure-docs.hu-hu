---
title: A big data-elemzési megoldások az Azure Data Lake Storage Gen1 frissítsen az Azure Data Lake Storage Gen2 előzetes verzió
description: A megoldás használatához az Azure Data Lake Storage Gen2 előzetes verzió frissítése
services: storage
author: normesta
ms.topic: conceptual
ms.author: normesta
...
| A Java SDK – fájlrendszer                  | [Hivatkozás](https://docs.microsoft.com/java/api/overview/azure/datalakestore/client)                                                                                                                                                                                                                                         | *Még nem érhető el*                                                | *Még nem érhető el*                                                                                                                                             |
...
| PowerShell – kezelés és fájlrendszer | [Hivatkozás](https://docs.microsoft.com/powershell/module/azurerm.datalakestore/?view=azurermps-6.3.0)                                                                                                                                                                                                                        | Kezelés – nem támogatott a fájlrendszer - *még nem érhető el*        | Kezelés – *elérhető most -* [hivatkozás](https://docs.microsoft.com/powershell/module/azure.storage/?view=azurermps-6.13.0) fájlrendszer - *még nem érhető el* |
...
|                      | [HDInsight ](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-hdinsight-hadoop-use-portal)                                                               | [HDInsight](https://docs.microsoft.com/azure/storage/data-lake-storage/quickstart-create-connect-hdi-cluster) 3.6 - *mostantól elérhető* HDInsight 4.0 - *még nem érhető el*      | A HDInsight 3.6-os ESP – *még nem érhető el* HDInsight 4.0 ESP - *még nem érhető el*                                                                 |
|                      | Databricks futtatókörnyezete 3.1-es vagy újabb verzió                                                                                                                                               | [Databricks-modul 4.2 és újabb](https://docs.azuredatabricks.net/spark/latest/data-sources/azure/azure-datalake-gen2.html#azure-data-lake-storage-gen2) *– most már elérhető* | Databricks futtatókörnyezete 5.1-es és újabb – *elérhető most*                                                                                              |
...
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| Elemzési keretrendszer | Cloudera     | A CDH                  | [Hivatkozás](https://www.cloudera.com/documentation/enterprise/5-11-x/topics/admin_adls_config.html)                                                                                            | *Még nem érhető el*                                                                                                  | *Még nem érhető el*                                                                                                  |
|                     | Cloudera     | Altus                | [Hivatkozás](https://www.cloudera.com/more/news-and-blogs/press-releases/2017-09-27-cloudera-introduces-altus-data-engineering-microsoft-azure-hybrid-multi-cloud-data-analytic-workflows.html) | NA                                                                                                                   | *Még nem érhető el*                                                                                                  |
...
| **Másolás egyszer-és-másolási növekményes** | Azure Data Factory                                                                                                    | Felügyelt felhőbeli szolgáltatás                                                                                                                | Támogatja a növekményes másolása az ADF-ben, adatokat kell egy idősorozat-módon rendszerezhetők. Növekményes másolatok közötti legrövidebb időköz [15 perces](https://docs.microsoft.com/azure/data-factory/how-to-create-tumbling-window-trigger)s. Rövidebb időközönként, az ADF használatával nem fognak működni. Hozzáférés-vezérlési listák keresztül jelenleg nem lehet másolni. |
...
Vegye figyelembe, hogy nincsenek-e a Data Lake Storage Gen1 Data Lake Storage Gen2 frissítésre képes kezelni a fenti adatok és metaadatok másolása eszközök bevonása nélkül harmadik felek (pl.: [Cloudera](http://blog.cloudera.com/blog/2017/08/use-amazon-s3-with-cloudera-bdr/)). Adatok áttelepítése, valamint a számítási feladatok migrálását végző egy "egyablakos" élményt nyújtanak. Előfordulhat, hogy rendelkezik olyan eszközökkel, amelyek ökoszisztémát kívül a sávon kívüli frissítés végrehajtásához.
...
* Data Lake Storage Gen2 támogat fájlok akár 5 TB-os méret. A Data Lake Storage Gen2-re frissíti, szüksége lehet, hogy azok 5 TB-nál nagyobb, méretezze át a fájlokat a Data Lake Storage Gen1.
...
* A Data Lake Storage Gen1 is megadhatja a hozzáférés-vezérlési listák a legmagasabb szintű jelenleg a fiók gyökérmappájában. A Data Lake Storage Gen1 azonban a legmagasabb szintű is megadhatja a hozzáférés-vezérlési listák, a fájlrendszer, nem a teljes fiók a gyökérmappában. Ezért ha azt szeretné, a fiók szintjén beállított alapértelmezett ACL-EK, a Data Lake Storage Gen2-fiókjában található összes fájl rendszer jeggyel ismétlődő kell.
...
A Data Lake Storage Gen2 fájlelérés URI-séma kifejtett [Itt](https://docs.microsoft.com/azure/storage/data-lake-storage/use-hdi-cluster?branch=release-preview-abfs) részletei, de Összefoglalva elmondható, a rendszer *abfss: / /\<FILE_SYSTEM_NAME\> \@ \< ACCOUNT_NAME\>.dfs.core.widows.net/\<elérési út\>.*
