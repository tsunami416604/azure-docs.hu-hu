...
| Hadoop-fájl rendszer ügyfél | Igen ([az Azure Data Lake Storage](https://hadoop.apache.org/docs/current/hadoop-azure-datalake/index.html)) | Igen ([ABFS](https://jira.apache.org/jira/browse/HADOOP-15407))  | *Már elérhető*  |  
...
Ez a táblázat ismerteti, amely API-t állítja be, amely az egyéni alkalmazások érhetők el. Ahhoz, hogy egy kicsit világosabb dolog, hogy már elválasztott ezen API-készletek 2 típusokra: felügyeleti API-k és fájlrendszer API-k.

Felügyeleti API-k segítségével, miközben fájlrendszer API-k segítségével történő a fájlok és mappák fiókokat szeretne kezelni.
...
| NODE.js - kezelés                   | [Hivatkozás](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | Nem támogatott                                                      | *Rendelkezésre álló most -* [hivatkozás](https://azure.github.io/azure-storage-node/)                                                                                            |
...
| PowerShell – kezelés és a fájlrendszerhez | [Hivatkozás](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | Kezelés – nem támogatott a fájlrendszer - *még nem érhető el*        | Kezelés – *elérhető most -* [hivatkozás](https://docs.microsoft.com/powershell/module/az.storage) <br><br>Fájlrendszer - *még nem érhető el* |
...
| Használat          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Még nem érhető el*                                                                                                                                                          | *Még nem érhető el*                                                                                                                             |
...
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Lift-and-shift**                 | [Azure Data Factory](https://docs.microsoft.com/azure/data-factory/load-azure-data-lake-storage-gen2-from-gen1) | Felügyelt felhőbeli szolgáltatás                                                                                                                | Adatok és a hozzáférés-vezérlési listák jelenleg keresztül lehet másolni.                                                                                                                                                                                                                                                                      |
...
* A Data Lake Storage Gen1 is megadhatja a hozzáférés-vezérlési listák a legmagasabb szintű jelenleg a fiók gyökérmappájában. A Data Lake Storage Gen2 azonban a legmagasabb szintű is megadhatja a hozzáférés-vezérlési listákat, a gyökérmappában a fájlrendszer, nem a teljes fiók. Ezért ha azt szeretné, a fiók szintjén beállított alapértelmezett ACL-EK, a Data Lake Storage Gen2-fiókjában található összes fájl rendszer jeggyel ismétlődő kell.
...
A fő feladat, hogy lefordítása URI-t a előtaggal rendelkező `adl://` be identifikátory URI, amely rendelkezik egy `abfss://` előtag.
