...
* [QueueClientBuilder](https://azuresdkdocs.blob.core.windows.net/$web/java/azure-storage-queue/12.0.0/com/azure/storage/queue/QueueClientBuilder.html): a `QueueClientBuilder` osztály `QueueClient` objektumot konfigurál és hoz létre.
...
> [Azure Java-felhőfejlesztőknek](https://docs.microsoft.com/azure/java/)
