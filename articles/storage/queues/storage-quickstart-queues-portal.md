...
description: Ebben a rövid útmutatóban az Azure Portalon használhatja egy üzenetsor létrehozásához. Ezután használhatja az Azure Portalon???.
services: storage
author: tamram
ms.custom: mvc
ms.service: storage
