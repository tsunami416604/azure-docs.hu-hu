...
For more information on UDs and FDs, see “[Configure multiple virtual machines in an Availability Set for redundancy][Configure multiple virtual machines in an Availability Set for redundancy]”.
...
<!--Anchors--> <!--Link references-->
  ...
  [Single-Instance Update]: #single-instance-update
  [Email Notification]: #email-notification
  [Manage the Availability of your Virtual Machines]: http://azure.microsoft.com/en-us/documentation/articles/virtual-machines-manage-availability/
  [Service Level Agreements]: ../../support/legal/sla/
  [Configure multiple virtual machines in an Availability Set for redundancy]: http://azure.microsoft.com/en-us/documentation/articles/virtual-machines-manage-availability/#configure-multiple-virtual-machines-in-an-availability-set-for-redundancy
