...
-   [Jogkivonat-alapú hitelesítés](https://azure.microsoft.com/documentation/articles/active-directory-authentication-scenarios/) engedélyezi a hitelesítést az Azure Active Directory segítségével.
