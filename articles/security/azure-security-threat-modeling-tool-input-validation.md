...
### <a name="example"></a>Példa
Ha az MSXML 6.0 használ, XSLT-scripting alapértelmezésben le van tiltva; azonban biztosítania kell, hogy azt nem explicit módon engedélyezve van az XML-DOM-objektum tulajdonságának AllowXsltScript keresztül. 
...
| **Megfelelő technológiák** | Általános |
| **Attribútumok**              | –  |
| **Hivatkozások**              | [Fájl feltöltése unrestricted](https://www.owasp.org/index.php/Unrestricted_File_Upload), [aláírás-tábla](https://www.garykessler.net/library/file_sigs.html) |
...
| **Attribútumok**              | –  |
| **Hivatkozások**              | [Attribútumok metaadatai](https://msdn.microsoft.com/library/system.componentmodel.dataannotations.metadatatypeattribute), [nyilvános kulcs biztonsági biztonsági rések és kockázatcsökkentési](https://github.com/blog/1068-public-key-security-vulnerability-and-mitigation), [teljes körű útmutatót az ASP.NET mvc-ben háttértár-hozzárendelés](https://odetocode.com/Blogs/scott/archive/2012/03/11/complete-guide-to-mass-assignment-in-asp-net-mvc.aspx), [EF MVC használatával – első lépések](https://www.asp.net/mvc/tutorials/getting-started-with-ef-using-mvc/implementing-basic-crud-functionality-with-the-entity-framework-in-asp-net-mvc-application#overpost) |
...
| **Attribútumok**              | –  |
| **Hivatkozások**              | [Az ASP.NET scripting többhelyes megakadályozása](https://msdn.microsoft.com/library/ms998274.aspx), [parancsfájlok](https://cwe.mitre.org/data/definitions/79.html), [(Adatbázisközi hely Scripting) XSS megelőzési Adatlap lap](https://www.owasp.org/index.php/XSS_(Cross_Site_Scripting)_Prevention_Cheat_Sheet) |
...
| **Attribútumok**              | –  |
| **Hivatkozások**              | [Érvényesítési hozzáadása](https://www.asp.net/mvc/overview/getting-started/introduction/adding-validation), [modellt az adatok az MVC alkalmazások](https://msdn.microsoft.com/library/dd410404(v=vs.90).aspx), [irányadó elvek, az ASP.NET MVC-alkalmazások](https://msdn.microsoft.com/magazine/dd942822.aspx) |
...
| **Megfelelő technológiák** | Általános |
| **Attribútumok**              | –  |
| **Hivatkozások**              | [Az OAuth 2.0 engedélyezési keretrendszer - nyílt átirányító](https://tools.ietf.org/html/rfc6749#section-10.15) |
...
| **Megfelelő technológiák** | MVC5, MVC6 |
| **Attribútumok**              | –  |
| **Hivatkozások**              | [Modell érvényesítése az ASP.NET webes API-k](https://www.asp.net/web-api/overview/formats-and-model-binding/model-validation-in-aspnet-web-api) |
