---
title: Azure-tartományok hivatkozási listája
description: Azure-tartományok hivatkozási listája (nem átfogó)
services: security
author: memildin
manager: rkarlin
ms.assetid: ''
...
ms.locfileid: "87433215"
---
# <a name="reference-list-of-azure-domains-not-comprehensive"></a>Azure-tartományok hivatkozási listája (nem átfogó)

Ez az oldal a használatban lévő Azure-tartományok részleges listája. Némelyikük REST API végpontok.


|Szolgáltatás  |Altartomány  |
|---------|---------|
|[Azure Access Control Service](https://azure.microsoft.com/blog/one-month-retirement-notice-access-control-service/) (kivont)|*.accesscontrol.windows.net|
...
|[Azure BizTalk Services](https://azure.microsoft.com/pricing/details/biztalk-services/) (kivont)|*. biztalk.windows.net|
|[Azure Blob Storage](https://docs.microsoft.com/azure/storage/blobs/)|*.blob.core.windows.net|
|[Azure Cloud Services](https://docs.microsoft.com/azure/cloud-services/cloud-services-choose-me) és [Azure Virtual Machines](https://docs.microsoft.com/azure/virtual-machines/)|*. cloudapp.net|
...
|Azure Container Service (ACS) (elavult)|*. azurecontainer.io|
...
|Azure felügyeleti szolgáltatások|*. management.core.windows.net|
