...
description: Az Azure biztonsági alapterve Azure DDoS Protection standard szintű
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 06/22/2020
...
A Azure DDoS Protection standard Azure biztonsági alapterve olyan javaslatokat tartalmaz, amelyek segítségével javíthatja az üzemelő példány biztonsági állapotát.
...
**Útmutató**: nem alkalmazható; Az Azure DDoS célja, hogy engedélyezze a más szolgáltatásokat üzemeltető virtuális hálózatokon, önmagában egy alapvető Azure-ajánlat és a mögöttes infrastruktúra, beleértve a hálózatkezelést, teljes mértékben felügyeli a Microsoftot.
...
**Útmutató**: nem alkalmazható; A Microsoft fenntartja az Azure-erőforrásokhoz használt időforrást, például a Azure DDoS Protection.
...
* [Riasztások konfigurálása DDoS Protection-mérőszámokhoz](https://docs.microsoft.com/azure/virtual-network/manage-ddos-protection#configure-alerts-for-ddos-protection-metrics)
...
**Útmutató**: nem alkalmazható; Azure DDoS Protection nem dolgoz fel kártevő szoftverrel kapcsolatos naplókat, illetve nem hoz létre.
...
**Útmutató**: nem alkalmazható; A Azure DDoS Protection nem dolgozza fel a DNS-sel kapcsolatos naplókat, és nem hoz létre.
...
* [Az Azure DDoS Protection engedélyeinek megismerése](https://docs.microsoft.com/azure/virtual-network/manage-ddos-protection#permissions)
...
* [Azure DDos Protection API-információk](https://docs.microsoft.com/rest/api/virtual-network/)
...
**Útmutató**: az Azure Ügyfélszéf-kérelmek bevezetéséhez és konfigurálásához engedélyezve van az Azure multi-Factor Authentication (MFA) szolgáltatással rendelkező emelt szintű hozzáférési munkaállomás (Paw).
...
* [Az Azure AD hozzáférési felülvizsgálatok használata](https://docs.microsoft.com/azure/active-directory/governance/access-reviews-overview)
...
**Útmutató**: Ez a javaslat nem alkalmazható a Azure DDoS Protectionra.
...
**Útmutató**: nem alkalmazható; a DDoS Protection-csomagot a rendszer az Ön által definiált erőforráscsoport szerint fogja kiépíteni. Nincs nyilvános végpont a védelemhez vagy az elkülönítéshez.
...
**Útmutató**: a Microsoft kezeli a Azure DDoS Protection alapjául szolgáló infrastruktúrát, és szigorú ellenőrzéseket vezetett be az ügyféladatok elvesztésének vagy kihatásának megelőzésére.
...
**Útmutató**: nem alkalmazható; A Azure DDoS Protection nem tartja meg a vásárlói adatok nyugalmát.
...
**Útmutató**: nem alkalmazható; Az Azure DDoS Protection nem rendelkezik ügyféladatokat.
...
**Útmutató**: a DDoS elleni védelmi tervekkel való együttműködéshez a fiókját hozzá kell rendelni a hálózati közreműködő szerepkörhöz vagy egy adott műveletekhez rendelt egyéni szerepkörhöz.

* [Szerepköralapú hozzáférés-vezérlés kezelése a Azure DDoS Protectionban](https://docs.microsoft.com/azure/virtual-network/manage-ddos-protection)
...
**Útmutató**: nem alkalmazható; Ez a javaslat számítási erőforrások számára készült. A Microsoft kezeli a Azure DDoS Protection alapjául szolgáló infrastruktúrát, és szigorú ellenőrzéseket vezetett be az ügyféladatok elvesztésének vagy kihatásának megelőzésére.
...
**Útmutató**: nem alkalmazható; A Azure DDoS Protection nem tartja meg az ügyféladatokat.
...
**Útmutató**: nem alkalmazható; A Microsoft a biztonsági rések kezelését a Azure DDoS Protection támogató mögöttes rendszereken hajtja végre.
...
**Útmutató**: nem alkalmazható; DDoS Protection-csomagok használatához a fiókját hozzá kell rendelni a hálózati közreműködő szerepkörhöz vagy egy olyan egyéni szerepkörhöz, amely a megfelelő műveletekhez van rendelve. Nincsenek a DDoS Protection eléréséhez szükséges jelszavak, titkok vagy kulcsok.
...
**Útmutató**: nem alkalmazható; A Azure DDoS Protection nem használja a felügyelt identitásokat.
...
**Útmutató**: nem alkalmazható; Ez az útmutató számítási erőforrások számára készült. A Microsoft kártevő szoftveres verziója engedélyezve van az Azure-szolgáltatásokat támogató mögöttes gazdagépen (például Azure DDoS Protection), azonban az nem az ügyfél tartalmán fut.
...
**Útmutató**: nem alkalmazható; Azure DDoS Protection maga nem tárolja az ügyféladatokat.
