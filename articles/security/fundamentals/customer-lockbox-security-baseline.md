...
A szolgáltatás alapterve az [Azure Security Benchmark 1,0-es verziójából](../benchmarks/overview.md)származik, amely javaslatokat tesz arra vonatkozóan, hogy miként védheti meg felhőalapú megoldásait az Azure-ban az ajánlott eljárásokat ismertető útmutató segítségével.

További információ: az [Azure biztonsági alaptervek áttekintése](../benchmarks/security-baselines-overview.md).

## <a name="network-security"></a>Hálózati biztonság

*További információkért lásd [: biztonsági ellenőrzés: hálózati biztonság](../benchmarks/security-control-network-security.md).*
...
* [Ügyfélszéf naplózási naplói](./customer-lockbox-overview.md#auditing-logs)
...
**Útmutató**: engedélyezze az Azure ad multi-Factor Authentication (MFA) szolgáltatást az Ügyfélszéf-kérelmek bevezetéséhez és konfigurálásához.
...
* [Azure Active Directory példány létrehozása és konfigurálása](../../active-directory/fundamentals/active-directory-access-create-new-tenant.md)
...
* [Azure Active Directory jelentéskészítés ismertetése](../../active-directory/reports-monitoring/index.yml)

* [A Azure Active Directory hozzáférési felülvizsgálatok használata](../../active-directory/governance/access-reviews-overview.md)
...
* [A kockázatos bejelentkezés Azure Active Directory megtekintése](../../active-directory/identity-protection/overview-identity-protection.md)
...
* [Az ügyfelek adatvédelmének megismerése az Azure-ban](./protection-customer-data.md)
...
* [A titkosítás ismertetése az Azure-ban](./encryption-overview.md#encryption-of-data-in-transit)
...
*További információ [: Security Control: sebezhetőségi kezelés](../benchmarks/security-control-vulnerability-management.md).*
...
*További információkért lásd [: biztonsági ellenőrzés: adat-helyreállítás](../benchmarks/security-control-data-recovery.md).*
