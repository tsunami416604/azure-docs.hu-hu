...
### <a name="hardware-inventory"></a>Hardver leltározása
...
- Gazdagép A gazdagépen futó virtuális gépeken futó testreszabott operációs rendszer.
- Natív Olyan natív operációs rendszer, amely bérlők (például Azure Storage) futtatására használható. Ez az operációs rendszer nem rendelkezik hypervisorsal.
...
## <a name="types-of-users"></a>Felhasználói típusok
...
| Role | Belső vagy külső | Érzékenységi szint | A jogosult jogosultságok és függvények végrehajtása | Hozzáférés típusa
| --- | --- | --- | --- | --- |
