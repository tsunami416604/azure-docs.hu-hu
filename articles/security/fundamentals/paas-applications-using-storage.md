...
Az Azure Storage a következő négy szolgáltatást biztosítja: BLOB Storage, Table Storage, üzenetsor-tároló és file Storage. További információ: [Bevezetés a Microsoft Azure Storageba](/azure/storage/common/storage-introduction).
