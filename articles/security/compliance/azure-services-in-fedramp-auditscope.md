---
title: Azure-szolgáltatások a FedRAMP és a DoD SRG naplózási hatókör
description: Ez a cikk tartalmazza a táblák az Azure nyilvános és az Azure Government, amelyek bemutatják, milyen FedRAMP (Mérsékelt vs. Magas) és a DoD SRG (2, 4 vagy 5 hatás szintje) naplózási hatókör elérte az egy adott szolgáltatáshoz.
author: davib
ms.author: davib
ms.date: 5/17/2019
ms.topic: article
...
A Microsoft government cloud services teljesülnek az erőforrás-igényű az USA szövetségi kockázati & Authorization Management Program (FedRAMP), valamint az USA védelmi Minisztériuma, az információk hatással szintek 2 – 5. Védett üzembe helyezésével a szolgáltatásokat, beleértve az Azure Government, az Office 365 Egyesült Államok És a Dynamics 365 Government Szövetségi kormányzati szervek defense kihasználhatják a kompatibilis szolgáltatások széles skáláját, és.

Ez a cikk releváns felhőalapú szolgáltatások részletes listáját Azure-ban és az Azure Government FedRAMP- és DoD CC SRG megfelelőségi ajánlatok.

#### <a name="terminologysymbols-used"></a>Használt terminológia és szimbólumok

* CC SRG védelmi Minisztérium a felhő-számítástechnika a Security Requirements Guide =
* IIL = Information Impact Level
* FedRAMP Federal Risk and Authorization Management Program =  
* : heavy_check_mark: = azt jelzi, hogy a szolgáltatás által elért naplózási hatókör.

## <a name="azure-public-services-by-audit-scope"></a>Nyilvános Azure-szolgáltatások által naplózási hatókör
| _Utolsó frissítés: Június 2019_ |

| Azure-szolgáltatás| Védelmi Minisztérium CC SRG IIL 2 | FedRAMP mérsékelt | FedRAMP magas | Tervezett 2019 |
| ------------ |:---------------:|:----------------:|:------------:|:------------:|
...
| [1. generációs Azure Data Lake Storage](https://azure.microsoft.com/services/storage/data-lake-storage/) |  |  |  | :heavy_check_mark: |
...
| [Az Azure dedikált HSM](https://azure.microsoft.com/services/azure-dedicated-hsm/) |  |  |  | :heavy_check_mark: |
| [Az Azure DevOps (korábbi nevén vsts-ben)](https://azure.microsoft.com/services/devops/) | |  |  | |
...
| [Az Azure bejárati ajtajának](https://azure.microsoft.com/services/frontdoor/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Az Azure Intune-ban](https://docs.microsoft.com/intune/what-is-intune) |  | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Az Azure Service Manager (RDFE)](https://docs.microsoft.com/previous-versions/azure/ee460799(v=azure.100)) | :heavy_check_mark: | :heavy_check_mark: |  |  |
...
| [A cognitive Services: Computer Vision](https://azure.microsoft.com/services/cognitive-services/computer-vision/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [A cognitive Services: Content Moderator](https://azure.microsoft.com/services/cognitive-services/content-moderator/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [A cognitive Services: Egyéni vizuális](https://azure.microsoft.com/services/cognitive-services/custom-vision-service/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [A cognitive Services: Arcfelismerés](https://azure.microsoft.com/services/cognitive-services/face/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [A cognitive Services: Hangfelismerés](https://azure.microsoft.com/services/cognitive-services/language-understanding-intelligent-service/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [A cognitive Services: A QnA Maker](https://azure.microsoft.com/services/cognitive-services/qna-maker/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [A cognitive Services: Beszédszolgáltatások](https://azure.microsoft.com/services/cognitive-services/directory/speech/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [A cognitive Services: Text Analytics](https://azure.microsoft.com/services/cognitive-services/text-analytics/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [A cognitive Services: Translator Text](https://azure.microsoft.com/services/cognitive-services/speech-translation/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [A cognitive Services: Video Indexer](https://azure.microsoft.com/services/media-services/video-indexer/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [A folyamat](https://docs.microsoft.com/flow/getting-started) |  | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Machine Learning-szolgáltatások](https://azure.microsoft.com/services/machine-learning-service/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Microsoft Azure-portálon](https://azure.microsoft.com/features/azure-portal/)| :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [A Microsoft Genomics](https://azure.microsoft.com/services/genomics/) |  |  |  | :heavy_check_mark: |
...
| [A Network Watcher](https://azure.microsoft.com/services/network-watcher/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Network Watcher a Traffic Analytics](https://docs.microsoft.com/azure/network-watcher/traffic-analytics) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Storage: Lemezek (beleértve a felügyelt lemezek)](https://azure.microsoft.com/services/storage/disks/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Storage: Fájlok](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Virtuális gépek (beleértve a szolgáltatás számára fenntartott példányok)](https://azure.microsoft.com/services/virtual-machines/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
## <a name="azure-government-services-by-audit-scope"></a>Az Azure government-szolgáltatások naplózási hatókör szerint
| _Utolsó frissítés: Június 2019_ |

| Azure-szolgáltatás | Védelmi Minisztérium CC SRG IIL 2 | Védelmi Minisztérium CC SRG IIL 4 | DoD CC SRG IIL 5 | FedRAMP magas | Tervezett 2019
| ------------- |:---------------:|:---------------:|:---------------:|:------------:|:------------:
...
| [Automatizálás](https://azure.microsoft.com/services/automation/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: |
| [Az Azure Active Directory (ingyenes és alapszintű)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Az Azure Active Directory (prémium P1 és P2)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Az Azure Analysis Services](https://azure.microsoft.com/services/analysis-services/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Data Factory](https://azure.microsoft.com/services/data-factory/)  |  |  |  |  | :heavy_check_mark:
| [MySQL-hez készült Azure DB](https://azure.microsoft.com/services/mysql/)| :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [PostgreSQL-hez készült Azure DB](https://azure.microsoft.com/services/postgresql/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [MariaDB-hez készült Azure DB](https://azure.microsoft.com/services/mariadb/)  |  |  |  |  | :heavy_check_mark:
...
| [Az Azure bejárati ajtajának](https://azure.microsoft.com/services/frontdoor/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Az Azure Intune-ban](https://docs.microsoft.com/intune/what-is-intune) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [Az Azure Lab Services](https://azure.microsoft.com/services/lab-services/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Az Azure Service Manager (RDFE)](https://docs.microsoft.com/previous-versions/azure/ee460799(v=azure.100)) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [A cognitive Services: Computer Vision](https://azure.microsoft.com/services/cognitive-services/computer-vision/)  |  |  |  |  | :heavy_check_mark:
| [A cognitive Services: Content Moderator](https://azure.microsoft.com/services/cognitive-services/content-moderator/)  |  |  |  |  | :heavy_check_mark:
| [A cognitive Services: Arcfelismerés](https://azure.microsoft.com/services/cognitive-services/face/)  |  |  |  |  | :heavy_check_mark:
| [A cognitive Services: Hangfelismerés](https://azure.microsoft.com/services/cognitive-services/language-understanding-intelligent-service/)  |  |  |  |  | :heavy_check_mark:
| [A cognitive Services: Text Analytics](https://azure.microsoft.com/services/cognitive-services/text-analytics/)  |  |  |  |  | :heavy_check_mark:
| [A cognitive Services: Translator Text](https://azure.microsoft.com/services/cognitive-services/speech-translation/) |  |  |  |  | :heavy_check_mark:
...
| [A folyamat](https://docs.microsoft.com/flow/getting-started) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Microsoft Azure-portálon](https://azure.microsoft.com/features/azure-portal/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: **&ast;** | :heavy_check_mark: |
| [A Microsoft Defender komplex veszélyforrások elleni védelem](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)  |  |  |  |  | :heavy_check_mark:
...
| [A Network Watcher](https://azure.microsoft.com/services/network-watcher/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Storage: Lemezek (beleértve a felügyelt lemezek)](https://azure.microsoft.com/services/storage/disks/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Storage: Fájlok](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
**&ast;** Egyes szolgáltatások például az Azure portal és az Azure Resource Manager nem tárolja vagy feldolgozni DoD CC SRG IIL 5 tartalom, azonban továbbra is örökli a IIL5 ellenőrzési készletébe.
