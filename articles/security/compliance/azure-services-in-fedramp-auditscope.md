...
Ez a cikk részletesen ismerteti az Azure nyilvános és Azure Government FedRAMP és a DoD CC SRG megfelelőségi ajánlatait.
...
* Tervezett 2019 = azt jelzi, hogy a szolgáltatás felülvizsgálata folyamatban van, és a tanúsítvány a 2019-ben fog megvalósulni.

## <a name="azure-public-services-by-audit-scope"></a>Azure Public Services naplózási hatókör szerint
| _Utolsó frissítés: Szeptember 2019_ |
...
| [Azure Active Directory kiépítési szolgáltatás](https://docs.microsoft.com/en-us/azure/active-directory/manage-apps/user-provisioning)| :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Azure komplex veszélyforrások elleni védelem](https://azure.microsoft.com/features/azure-advanced-threat-protection/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Azure API a FHIR-hez](https://azure.microsoft.com/services/azure-api-for-fhir/) |  |  |  | :heavy_check_mark: |
...
| [Azure-Adatkezelő](https://azure.microsoft.com/services/data-explorer/) | |  |  | :heavy_check_mark: |
...
| [Azure dedikált HSM](https://azure.microsoft.com/services/azure-dedicated-hsm/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Dynamics 365 pénzügyi és üzemeltetési műveletekhez](https://dynamics.microsoft.com/en-us/finance-and-operations/overview/) |  |  |  | :heavy_check_mark: |
| [Event Grid](https://azure.microsoft.com/services/event-grid/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Microsoft Defender komplex veszélyforrások elleni védelem](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Áramlását](https://docs.microsoft.com/flow/getting-started) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
## <a name="azure-government-services-by-audit-scope"></a>Szolgáltatások Azure Government naplózási hatókör szerint
| _Utolsó frissítés: Szeptember 2019_ |
...
| [Azure komplex veszélyforrások elleni védelem](https://azure.microsoft.com/features/azure-advanced-threat-protection/)  |  |  |  |  | :heavy_check_mark:
...
| [MariaDB-hez készült Azure-adatbázis](https://azure.microsoft.com/services/mariadb/)  | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Cognitive Services: Arc](https://azure.microsoft.com/services/cognitive-services/face/)  | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Cognitive Services: Beszédfelismerési szolgáltatások](https://azure.microsoft.com/services/cognitive-services/directory/speech/) |  |  |  |  | :heavy_check_mark:
...
| [Microsoft Defender komplex veszélyforrások elleni védelem](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)  | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
