...
| **Azure-beli megbízhatósági kapcsolat határa** | <ul><li>[Azure AD-Multi-Factor Authentication engedélyezése az Azure-rendszergazdák számára](#multi-factor-azure-admin)</li></ul> |
...
| **Referencia**              | [SQL Server – hitelesítési mód kiválasztása](/sql/relational-databases/security/choose-an-authentication-mode) |
...
| **Referencia**              | [Csatlakozás SQL Databasehoz Azure Active Directory hitelesítés használatával](../../azure-sql/database/authentication-aad-overview.md) |
...
| **Alkalmazható technológiák** | Általános |
| **Attribútumok**              | N/A  |
| **Referencia**              | [SQL Server jelszóházirend](/previous-versions/sql/sql-server-2012/ms161959(v=sql.110)) |
...
| **Referencia**              | [Ajánlott biztonsági eljárások a foglalt adatbázisokkal](/sql/relational-databases/databases/security-best-practices-with-contained-databases) |
...
## <a name="enable-azure-ad-multi-factor-authentication-for-azure-administrators"></a><a id="multi-factor-azure-admin"></a>Azure AD-Multi-Factor Authentication engedélyezése az Azure-rendszergazdák számára
...
| **Alkalmazható technológiák** | Általános |
| **Attribútumok**              | N/A  |
| **Referencia**              | [Mi az Azure AD Multi-Factor Authentication?](../../active-directory/authentication/concept-mfa-howitworks.md) |
...
| **Referencia**              | [Service Fabric fürt biztonsági forgatókönyvei](../../service-fabric/service-fabric-cluster-security.md) |
...
| **Referencia**              | Az [ügyfél és a csomópont közötti biztonság Service Fabric](../../service-fabric/service-fabric-cluster-security.md#client-to-node-certificate-security), [Kapcsolódás biztonságos fürthöz ügyféltanúsítvány használatával](../../service-fabric/service-fabric-connect-to-secure-cluster.md) |
...
| **Alkalmazható technológiák** | Általános |
| **Attribútumok**              | Környezet – Azure |
| **Referencia**              | [Fürtök biztonsági forgatókönyvei – biztonsági javaslatok](../../service-fabric/service-fabric-cluster-security.md#security-recommendations) |
...
| **Alkalmazható technológiák** | Általános |
| **Attribútumok**              | Környezet – Azure |
| **Referencia**              | [X. 509 tanúsítványok és Service Fabric](../../service-fabric/service-fabric-cluster-security.md#x509-certificates-and-service-fabric) |
...
| **Attribútumok**              | N/A |
| **Referencia**              | [MSDN](/previous-versions/msp-n-p/ff648500(v=pandp.10)) |
...
| **Referencia**              | [MSDN](/previous-versions/msp-n-p/ff648500(v=pandp.10)), [megerősítés](https://community.microfocus.com/t5/UFT-Discussions/UFT-API-Test-with-WCF-wsHttpBinding/m-p/600927) |
...
| **Alkalmazható technológiák** | Általános |
| **Attribútumok**              | N/A  |
| **Referencia**              | [Hitelesítési forgatókönyvek az Azure ad-hez](../../active-directory/develop/authentication-vs-authorization.md), [Azure Active Directory mintakód](../../active-directory/azuread-dev/sample-v1-code.md), [Azure Active Directory fejlesztői útmutató](../../active-directory/develop/index.yml) |
...
| **Alkalmazható technológiák** | Általános |
| **Attribútumok**              | N/A  |
| **Referencia**              | [Modern hitelesítés Azure Active Directory webalkalmazásokhoz](/archive/blogs/microsoft_press/new-book-modern-authentication-with-azure-active-directory-for-web-applications) |
...
| **Alkalmazható technológiák** | Általános |
| **Attribútumok**              | N/A  |
| **Referencia**              | [ADAL](../../active-directory/azuread-dev/active-directory-authentication-libraries.md) |
...
| **Referencia**              | N/A, [Azure IoT hub .net](../../iot-hub/quickstart-send-telemetry-dotnet.md) [-tel](../../iot-hub/iot-hub-devguide-security.md), [első lépések az IOT hub és a Node js](../../iot-hub/quickstart-send-telemetry-node.md)használatával [Git repository](https://github.com/Azure/azure-iot-sdks/) |
...
| **Referencia**              | [Azure IoT Hub biztonsági tokenek](../../iot-hub/iot-hub-devguide-security.md) |
...
| **Referencia**              | A [tárolók és Blobok névtelen olvasási hozzáférésének kezelése](../../storage/blobs/anonymous-read-access-configure.md), [közös hozzáférési aláírások, 1. rész: az SAS-modell megismerése](../../storage/common/storage-sas-overview.md) |
...
| **Alkalmazható technológiák** | Általános |
| **Attribútumok**              | N/A |
| **Referencia**              | [Közös hozzáférésű aláírások, 1. rész: az SAS-modell, a](../../storage/common/storage-sas-overview.md) [közös hozzáférési aláírások ismertetése, 2. rész: sas létrehozása és használata blob Storage](../../storage/common/storage-sas-overview.md)-mel, a [fiókban lévő objektumokhoz való hozzáférés delegálása közös hozzáférési aláírások és tárolt hozzáférési szabályzatok használatával](../../storage/blobs/security-recommendations.md#identity-and-access-management) |
