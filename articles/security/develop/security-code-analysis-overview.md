...
description: További információ a Microsoft biztonsági kód elemzése bővítményről. Ezzel a bővítménnyel hozzáadhat biztonsági kód-elemzéseket az Azure DevOps CI/ID-folyamatokhoz.
author: sukhans
manager: sukhans
ms.author: terrylan
ms.date: 07/31/2019
...
A a a Microsoft fordítói szolgáltatásának integrált eszköze a felügyelt C# és a Visual Basic kód statikus elemzéséhez. További információkért lásd: a [-alapú elemzők](https://docs.microsoft.com/dotnet/standard/analyzers/).
