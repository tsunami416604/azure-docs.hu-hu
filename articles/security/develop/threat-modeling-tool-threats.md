...
| Category | Leírás |
| -------- | ----------- |
| **Hamisítási** | A szolgáltatás illegálisan férhet hozzá, majd egy másik felhasználó hitelesítési információit, például a felhasználónevet és a jelszót használja. |
