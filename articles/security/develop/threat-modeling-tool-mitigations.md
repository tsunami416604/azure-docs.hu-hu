...
Látogasson **[](threat-modeling-tool.md)** el a Threat Modeling toolra, és kezdje el még ma!
...
| **[Hitelesítés](threat-modeling-tool-authentication.md)** | Ki Ön? A hitelesítés az a folyamat, amelyben egy entitás igazolja egy másik entitás identitását, jellemzően hitelesítő adatokkal, például felhasználónévvel és jelszóval. |
| **[Engedély](threat-modeling-tool-authorization.md)** | Mire használható? Az engedélyezés az, hogy az alkalmazás hogyan biztosít hozzáférés-vezérlést az erőforrásokhoz és a műveletekhez |
