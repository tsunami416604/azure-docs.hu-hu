...
### <a name="cloud-authentication-password-hash-synchronization"></a>Felhőalapú hitelesítés: Jelszókivonat szinkronizálása
...
> [!NOTE]
> A jelszó lejárt, és a fiók zárolt állapotok jelenleg az Azure AD az Azure AD Connect nem szinkronizálja. Ha módosítja egy felhasználó jelszavát, és állítsa a *kell változtatni a jelszót a következő bejelentkezéskor* jelző, a Jelszókivonat nem lesz(nek) szinkronizálva az Azure AD az Azure AD Connect, amíg a felhasználó módosíthatja a jelszavát.
...
|Milyen felhasználói fiók állapotok támogatottak?|Letiltott fiókokat<br>(legfeljebb 30 perces késleltetés)|Letiltott fiókokat<br><br>A fiók zárolva<br><br>Fiók lejárt<br><br>A jelszó lejárt<br><br>Jelentkezzen be óra|Letiltott fiókokat<br><br>A fiók zárolva<br><br>Fiók lejárt<br><br>A jelszó lejárt<br><br>Jelentkezzen be óra|
|Mik a feltételes hozzáférési beállításokat?|[Az Azure ad-beli feltételes hozzáférés az Azure AD Premium szolgáltatással](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-azure-portal)|[Az Azure ad-beli feltételes hozzáférés az Azure AD Premium szolgáltatással](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-azure-portal)|[Az Azure ad-beli feltételes hozzáférés az Azure AD Premium szolgáltatással](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-azure-portal)<br><br>[Az AD FS-jogcímszabályok](https://adfshelp.microsoft.com/AadTrustClaims/ClaimsGenerator)|
