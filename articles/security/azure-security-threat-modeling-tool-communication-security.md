...
| --------------- | ------- |
| **Az Azure Event Hubs** | <ul><li>[Az Event Hubs használatával SSL/TLS biztonságos kommunikáció](#comm-ssltls)</li></ul> |
