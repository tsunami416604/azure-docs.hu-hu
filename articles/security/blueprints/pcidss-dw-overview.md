---
title: Azure biztonsági és megfelelőségi terv – a PCI DSS Data warehouse-bA
description: Azure biztonsági és megfelelőségi terv – a PCI DSS Data warehouse-bA
services: security
author: meladie
...
ms.locfileid: "57243516"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-pci-dss"></a>Azure biztonsági és megfelelőségi terv: A PCI DSS Data warehouse-bA

## <a name="overview"></a>Áttekintés

Az Azure biztonsági és megfelelőségi terv a data warehouse architektúrája az Azure-ban, amely segít a Payment Card Industry Data Security Standards (PCI DSS 3.2) követelményeinek központi telepítésére vonatkozó útmutatással. Közös referenciaarchitektúra bemutatja, és azt mutatja be a hitelkártya adatait (beleértve a száma, lejárati és ellenőrzési adatok) megfelelő kezeléséhez a biztonságos, előírásoknak megfelelő és többrétegű környezetben. Ez a megoldás mutatja be, amelyben ügyfeleink megfelel bizonyos biztonsági és megfelelőségi követelmények módon, és az ügyfelek létrehozása és konfigurálása saját adattárház-megoldások az Azure-ban alapjaként szolgál.
...
![Adatraktár-PCI DSS architekturális diagramja](images/pcidss-dw-architecture.png "Data warehouse-ba, a PCI DSS architekturális diagramja")
...
A referenciaarchitektúra az adatfolyam-diagram érhető el az [letöltése](https://aka.ms/pcidss-dw-tm) vagy alább találja. Ez a modell segítségével az ügyfelek megismerhetik a pontokat a rendszer infrastruktúra esetleges kockázat, ha a végzett módosítások.

![Adatraktár-PCI DSS architekturális diagramja](images/pcidss-dw-threat-model.png "PaaS webes alkalmazás a PCI DSS fenyegetések modellezése")

## <a name="compliance-documentation"></a>Megfelelőségi dokumentációja

A [Azure biztonsági és megfelelőségi terv – PCI DSS vevő felelőssége mátrix](https://aka.ms/pcidss-crm) felelősségi körébe tartozik az összes PCI DSS 3.2-es követelményeket sorolja fel.

A [Azure biztonsági és megfelelőségi terv – PCI DSS Data Warehouse megvalósítási mátrix](https://aka.ms/pcidss-dw-cim) melyik PCI DSS 3.2-es verzióját a követelmények címzett által a data warehouse architektúrája, beleértve a részletes leírást biztosít a hogyan végrehajtására az egyes kezelt vezérlőelemek kielégíti.
