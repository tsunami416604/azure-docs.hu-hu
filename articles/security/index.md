---
title: Az Azure Security dokumentációja | Microsoft Docs
description: A biztonság minden szempontból az Azure integrált része. Az Azure a globális biztonsági intelligenciából, az ügyfelek által használható kifinomult vezérlőkből és a biztonság szempontjából megerősített infrastruktúrákból származó egyedi biztonsági előnyöket kínál. Ez a hatékony kombináció védelmet biztosít az alkalmazások és az adatok számára, támogatja a megfelelőség felé tett lépéseket, és költséghatékony biztonsági megoldást biztosít a különböző méretű vállalatok számára.
services: security
author: arob98
manager: angrobe
layout: LandingPage
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Az Azure Security ismertetése</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Fontolgatom, hogy bevezetem az Azure-t a vállalatomban. Milyen biztonsági lehetőségeket kínál az Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="http://aka.ms/sharedresponsibility">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Milyen módon képes a Microsoft megosztani a biztonsággal kapcsolatos feladatokat a vállalatommal?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-storage-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Tárolóbiztonság – áttekintés</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-network-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Hálózati biztonság – áttekintés</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-azure-encryption-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Adattitkosítás – áttekintés</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-log-audit">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Milyen monitorozási és naplózási beállítások érhetők el az Azure-ban?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-encryption-atrest">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Hogyan biztosítja az Azure az inaktív adatok védelmét?</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="http://aka.ms/SecurityResponsepaper">Azure biztonsági válasz a felhőben</a>
                            </li>
                            <li style="list-style: none;">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/abstract-container-security-microsoft-azure">Tárolóbiztonság a Microsoft Azure-ban</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="cardPadding">
            <div class="card">
                <div class="cardText">
                     ...
                     <h3>Ellenőrzőlisták</h3>
                     <ul class="noBullet">
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-database-security-checklist">Adatbázisok védelme</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-operational-security-checklist">Működési biztonság</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-service-fabric-security-checklist">A Service Fabric biztonsága</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Megfelelőség</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Erőforrások &amp; szolgáltatások</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <a href="https://www.microsoft.com/en-us/trustcenter/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">MSFT adatvédelmi központ</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="https://azuremarketplace.microsoft.com/en-us/marketplace/apps?search=security&page=1">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Az Azure biztonsági partnerei</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-cyber-services">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Kiberbiztonsági tanácsadás</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-pen-testing">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Toll tesztelése</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Lemeztitkosítás</p>
                        </div>
                    </div>
                </div>
            </div>
