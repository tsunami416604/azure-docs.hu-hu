...
description: Biztonság-ellenőrzési identitás és Access Control
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
Azure AD jelentéskészítési https://docs.microsoft.com/azure/active-directory/reports-monitoring/
...
Az Azure AD kockázatos bejelentkezések megtekintése:
