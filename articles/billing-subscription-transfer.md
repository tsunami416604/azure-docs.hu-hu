...
-   **如果我接管計費從另一個訂閱的擁有權
    ...
    4.    在 [資源] 分頁中，按一下 [ **設定**。 您可以在這裡檢視並更新現有的密碼。
...
1. 您現在是帳戶管理員。 請檢視並更新服務管理員和共同管理員。 管理系統管理員 」 中的 [Azure 傳統入口網站](https://manage.windowsazure.com) 移至 [設定。 [了解詳細](http://go.microsoft.com/fwlink/?LinkID=533293)。
