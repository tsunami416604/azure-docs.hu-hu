...
Egy sikeres kérelem egy logikai értéket `true` ad vissza `false` , amely jelzi, hogy a hozzáférési típus hozzá van-e rendelve a felhasználóhoz a megadott elérési úthoz és erőforráshoz.
