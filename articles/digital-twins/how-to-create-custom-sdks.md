...
* A [Node. js](https://nodejs.org) az autorest előfeltétele
...
Ha a Node. js telepítve van, futtathatja ezt a parancsot, hogy ellenőrizze, van-e telepítve az autorest megfelelő verziója:
```cmd/sh
