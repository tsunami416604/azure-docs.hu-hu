...
Ez az oktatóanyag feltételezi, hogy [befejezte az Azure digitális Twins](tutorial-facilities-setup.md)-telepítőjét. Mielőtt továbblépne, győződjön meg arról, hogy rendelkezik a következőkkel:
...
Ez a Matcher az [első oktatóanyagban](tutorial-facilities-setup.md)hozzáadott SAMPLE_SENSOR_TEMPERATURE-érzékelőt fogja követni. 
...
1. Konfigurálja az UDF-t úgy, hogy a provisionSample. YAML fájl `matcherNames` csomópontjában a következő sor hozzáadásával vagy törlésével adja meg a hőmérséklet Matcher:
...
Ha a figyelt feltétel teljesül, a felhasználó által definiált függvény megadja a terület értékét a megfelelő üzenettel, ahogy [korábban](#udf)láttuk. A `GetAvailableAndFreshSpaces` függvény kiírja az üzenetet a-konzolon.
