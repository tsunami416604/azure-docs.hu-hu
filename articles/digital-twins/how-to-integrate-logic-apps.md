...
Először töltsön le egy egyéni Azure Digital Twins hencegés, amely úgy lett módosítva, hogy működjön a Logic Apps. Töltse le * adigitaltwins.jst* [erről a hivatkozásról](https://github.com/Azure-Samples/digital-twins-custom-swaggers/blob/main/LogicApps/preview/2020-05-31-preview/digitaltwins.json).

Ezután az összekötő áttekintő oldaláról a Azure Portalban kattintson a *Szerkesztés*elemre.
...
* **Egyéni összekötők**
    ...
    - Fájl: ez lesz a korábban letöltött egyéni hencegő fájl. Kattintson az *Importálás*elemre, keresse meg a fájlt a gépen, és kattintson a *Megnyitás gombra*.
