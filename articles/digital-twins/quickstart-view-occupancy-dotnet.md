...
1. Nyisson meg egy parancssort. Nyissa meg a mappát, ahol a digitális-twins-samples-csharp-master.zip fájlok könyvtárban találhatók.
...
1. Futtassa az `dotnet restore` parancsot.
1. Szerkesztés **appsettings.json** frissíteni **DeviceConnectionString** az előző `ConnectionString`.
