...
> [!div class="checklist"]
> * Azure Active Directory-alkalmazás titkos kódok és kulcsok biztonságos helyen Store például [Key Vault](https://azure.microsoft.com/en-us/services/key-vault/).
