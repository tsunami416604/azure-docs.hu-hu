...
-   [Authentication: Usernames, Passwords and SSH keys.][Authentication: Usernames, Passwords and SSH keys.]
-   [Generation and use of SSH keys for logging into Linux virtual machines.][Generation and use of SSH keys for logging into Linux virtual machines.]
-   [Obtaining superuser privileges using sudo][Obtaining superuser privileges using sudo]
-   [Firewall configuration][Firewall configuration]
-   [Hostname changes][Hostname changes]
-   [Virtual machine image capture][Virtual machine image capture]
-   [Attaching Disks][Attaching Disks]

## <span id="authentication"></span></a>Authentication: Usernames, Passwords and SSH Keys
...
-   See [How to Use SSH with Linux on Azure][How to Use SSH with Linux on Azure]

### <span id="keygeneration"></span></a>SSH Key Generation
...
## <span id="superuserprivileges"></span></a>Obtaining Superuser Privileges Using `sudo`
...
-   See [Using root privileges on Linux virtual machines in Azure][Using root privileges on Linux virtual machines in Azure]

## <span id="firewallconfiguration"></span></a>Firewall Configuration
...
-   See: [How to Set Up Endpoints to a Virtual Machine][How to Set Up Endpoints to a Virtual Machine]
...
## <span id="hostnamechanges"></span></a>Hostname Changes
...
-   [Azure Linux Agent User Guide][Azure Linux Agent User Guide]

### Ubuntu Images

Ubuntu images utilize cloud-init, which provides additional capabilities for bootstrapping a virtual machine.

-   See [Custom Data and Cloud-Init on Microsoft Azure][Custom Data and Cloud-Init on Microsoft Azure]

## <span id="virtualmachine"></span></a>Virtual Machine Image Capture
...
-   See: [How to Capture a Linux Virtual Machine to Use as a Template][How to Capture a Linux Virtual Machine to Use as a Template]

## <span id="attachingdisks"></span></a>Attaching Disks
...
On Linux the data disk might be named by the kernel as `/dev/sdc`, and users will need to partition, format and mount that resource. This is covered step-by-step in the tutorial: [How to Attach a Data Disk to a Virtual Machine][How to Attach a Data Disk to a Virtual Machine].

-   See also: [Configure Software RAID on Linux][Configure Software RAID on Linux]
  ...
  [How to Use SSH with Linux on Azure]: ../linux-use-ssh-key/
  [Using root privileges on Linux virtual machines in Azure]: ../virtual-machines-linux-use-root-privileges/
  [How to Set Up Endpoints to a Virtual Machine]: ../virtual-machines-set-up-endpoints/
  ...
  [How to Capture a Linux Virtual Machine to Use as a Template]: ../virtual-machines-linux-capture-image/
  [How to Attach a Data Disk to a Virtual Machine]: ../virtual-machines-linux-how-to-attach-disk/
