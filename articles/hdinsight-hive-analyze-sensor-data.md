...
-   An HDInsight (Hadoop) cluster - see [Provision Hadoop clusters in HDInsight][Provision Hadoop clusters in HDInsight] for information on creating a cluster

-   Microsoft Excel 2013

    > [WACOM.NOTE] Microsoft Excel is used for data visualization with [Power View][Power View], which is currently only available on Windows.

-   [Microsoft Hive ODBC Driver][Microsoft Hive ODBC Driver]
...
3.  Follow the instructions provided on the web page to finish the sample.
  ...
  [Provision Hadoop clusters in HDInsight]: /en-us/documentation/articles/hdinsight-provision-clusters/
