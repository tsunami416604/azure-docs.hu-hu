...
3. 輸入專案的**名稱**、**位置**和**方案**的名稱，然後按一下 [確定]****。
    ...
    ![方案總管](./media/data-factory-get-started-using-vs/solution-explorer.png)
