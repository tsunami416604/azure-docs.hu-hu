...
## <a name="azure-synapse-analytics-formerly-sql-data-warehouseazure-sql-databasesql-server"></a>Azure szinapszis Analytics (korábban SQL Data Warehouse)/Azure SQL Database/SQL Server
