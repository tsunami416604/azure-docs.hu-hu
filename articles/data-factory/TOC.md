...
## [Tárgymutató az összes cikkhez](data-factory-alltopcat.md)
## Alapelvek
### [Adatkészletek](data-factory-create-datasets.md)
### [Folyamatok és tevékenységek](data-factory-create-pipelines.md)
### [Adattovábbítási tevékenységek](data-factory-data-movement-activities.md)
### [Adatátalakítási tevékenységek](data-factory-data-transformation-activities.md)
...
## [Oktatóanyag: Adatok áthelyezése a helyszínről a felhőbe](data-factory-move-data-between-onprem-and-cloud.md)
## [Oktatóanyag: Egyéni tevékenységek létrehozása és használata egy folyamatban](data-factory-use-custom-activities.md)

# Útmutató
## Adatok áthelyezése
### [A Data Factory másolási varázslója](data-factory-copy-wizard.md)
### [1 TB betöltése 15 perc alatt a Másolás varázslóval](data-factory-load-sql-data-warehouse.md)
### [Másolási tevékenység](data-factory-data-movement-activities.md)
### [Hibrid adatáthelyezés](data-factory-move-data-between-onprem-and-cloud.md)
### [Adatkezelési átjáró](data-factory-data-management-gateway.md)
### [Útmutató a másolási tevékenységek teljesítményéhez és finomhangolásához](data-factory-copy-activity-performance.md)
### [Azure Blob Storage](data-factory-azure-blob-connector.md)
### [Azure-táblák](data-factory-azure-table-connector.md)
...
## Fejlesztés
### [Az Azure Portal használata](data-factory-copy-activity-tutorial-using-azure-portal.md)
...
### [Az Azure Resource Manager-sablonok használata](data-factory-how-to-use-resource-manager-templates.md)
...
### [Minták](data-factory-samples.md)
...
### [Az Azure Portal használata](data-factory-api-change-log.md)
### [A Megfigyelés és kezelés alkalmazás használata](data-factory-monitor-manage-app.md)
