---
title: Azure SQL Data Warehouse adatmásolása és átalakítása a Azure Data Factory használatával
...
Ez a cikk azt ismerteti, hogyan használható a másolási tevékenység a Azure Data Factoryban az adatok másolásához és a Azure SQL Data Warehouseához, valamint az adatfolyamatok használata az adatok Azure Data Lake Storage Gen2ban való átalakításához. Azure Data Factory szolgáltatásról, olvassa el a [bevezető cikk](introduction.md).
...
| writeBatchTimeout | Várakozási idő a kötegelt beszúrási művelet befejezéséhez az időtúllépés előtt. Csak akkor érvényes, ha a rendszer nem használja a főadatbázist.<br/><br/>Az engedélyezett érték **timespan**. Példa: "00: 30:00" (30 perc). | Nem                                            |
...
| time                                  | TimeSpan                       |
| tinyint                               | Byte                           |
| uniqueidentifier                      | GUID azonosítója                           |
| varbinary                             | Byte[]                         |
| varchar                               | String, Char[]                 |
