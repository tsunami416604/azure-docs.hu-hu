...
1. Miután bejelentkezett az [Azure Portalra](https://portal.azure.com/), kattintson a **További szolgáltatások** elemre, végezzen keresést a kulcsszóval (például **adat-el**), és válassza az **Adat-előállítók** lehetőséget.
