...
1. Hozzon létre egy **WordCount_Spark.py** nevű Python-fájlt a következő tartalommal: 
    ...
    if __name__ == "__main__":
        main()
    ```
1. Cserélje le * &lt;&gt; a storageAccountName-t* az Azure-tárfiók nevére. Ezután mentse a fájlt. 
...
- Igény **szerinti HDInsight-kapcsolt szolgáltatás.** Az Azure Data Factory automatikusan létrehoz egy HDInsight-fürtöt, és futtatja a Spark programot. Ezt követően pedig törli a HDInsight-fürtöt, miután a fürt egy előre meghatározott ideig tétlen volt. 
...
1. Az **Új társított szolgáltatás** ablakban végezze el az alábbi lépéseket: 
   ...
   c. Az **Azure Storage-alapú szolgáltatás**esetén válassza az **AzureBlobStorage1**lehetőséget. Ezt a társított szolgáltatást korábban hozta létre. Ha másik nevet használt, adja meg a megfelelő nevet. 
...
1. Váltson a **Szkript/Jar** lapra, és végezze el az alábbi lépéseket: 
   ...
   a. Feladathoz **csatolt szolgáltatás esetén**válassza az **AzureBlobStorage1**lehetőséget.
...
Az eszköztáron válassza az **Eseményindító hozzáadása** lehetőséget, majd az **Eseményindító most**lehetőséget. 

![Az „Aktiválás” és az „Aktiválás most” gomb](./media/tutorial-transform-data-spark-portal/trigger-now-menu.png)

## <a name="monitor-the-pipeline-run"></a>A folyamat futásának monitorozása

1. Váltson a **Figyelő** lapra. Egy Spark-fürt létrehozása nagyjából 20 percet vesz igénybe. 
...
1. A folyamat futásához kapcsolódó tevékenységfuttatások megtekintéséhez kattintson a **Tevékenységfuttatások megtekintése** elemre a **Műveletek** oszlopban.
   ...
   A folyamatfuttatási nézetre úgy válthat vissza, hogy a lap tetején a **Minden folyamatfuttatás** hivatkozást választja.
...
> [Oktatóanyag: Adatok átalakítása a Hive használatával az Azure virtuális hálózatban.](tutorial-transform-data-hive-virtual-network-portal.md)
