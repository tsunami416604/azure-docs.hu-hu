...
1. Az Azure-SSIS IR PowerShell-lel való üzembe helyezése vagy újrakonfigurálása során az Azure-SSIS IR elindítása előtt a `Set-AzDataFactoryV2IntegrationRuntime` parancsmag futtatásával egyéni beállításokat adhat hozzá vagy távolíthat el.
