...
[Egy Azure-SSIS integrációs](./tutorial-deploy-ssis-packages-azure.md) modult is létre kell hoznia Azure Data Factory-ben. Egy SQL felügyelt példányt használ végpont-kiszolgálóként.
