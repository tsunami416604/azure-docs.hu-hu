...
- Az HDFS Connector mostantól támogatja az önaláírt nyilvános tanúsítványokat az SSL-érvényesítés kihagyása mellett.
- Kijavítva: hiba történt az átjáróval a frissítés során (az óra torzítása miatt)


## <a name="2963132"></a>2.9.6313.2
### <a name="enhancements-"></a>Fejlesztések
-   DNS-bejegyzéseket adhat hozzá a engedélyezési listához Service Bus ahelyett, hogy az összes Azure-beli IP-címet a tűzfalról (ha szükséges) engedélyezte. További részletek.
