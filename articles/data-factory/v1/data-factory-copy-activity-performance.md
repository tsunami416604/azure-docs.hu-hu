---
title: Másolási tevékenység teljesítményének és finomhangolásának útmutatója
...
Ha átmeneti tároló használatával aktiválja az adatáthelyezést, megadhatja, hogy az adatok tömörítve legyenek-e, mielőtt áthelyezi az adatait a forrás adattárból egy ideiglenes vagy átmeneti adattárba, majd kibontja az adatok ideiglenes vagy átmeneti adatokból való áthelyezése előtt. tárolja a fogadó adattárat.
...
![1\. eset](./media/data-factory-copy-activity-performance/scenario-1.png)
