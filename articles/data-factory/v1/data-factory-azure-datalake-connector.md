...
| **előfizetés-azonosító** | Azure-előfizetése Azonosítóját, amelyhez a Data Lake Store-fiók tartozik. | A fogadó szükséges |
...
| --- | --- | --- | --- |
| **rekurzív** |Azt jelzi, hogy az adatok olvasható rekurzív módon az almappákat, illetve csak a megadott mappát. |TRUE hamis (alapértelmezés) |Nem |
