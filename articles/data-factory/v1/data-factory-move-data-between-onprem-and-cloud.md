...
7. Győződjön meg arról, hogy `adftutorialgateway is connected to the cloud service` üzenet jelenik meg. A Lenti állapotsor a **Cloud Service-hez csatlakozik,** és **zöld pipa jelzi**.
...
2. Cserélje le a JSON-t a jobb oldali ablaktáblán a következő szövegre:    
   ...
   * A **SqlSource** **sqlReaderQuery** tulajdonságához az SQL-lekérdezés `select * from emp` van megadva.
