---
title: 'PowerShell-parancsfájl: adatok másolása a helyszínről az Azure-ba Data Factory használatával '
...
- **Azure Storage-fiók** Ebben a példában az Azure Blob Storage-t **célként/fogadó** adattárként kell használni. Ha még nem rendelkezik Azure Storage-fiókkal, a létrehozás folyamatáért lásd a [tárfiók létrehozását](../../storage/common/storage-quickstart-create-account.md) ismertető cikket.
