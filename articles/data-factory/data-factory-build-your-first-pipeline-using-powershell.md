...
# Oktatóanyag: Az első Azure data factory létrehozása az Azure PowerShell használatával
> [AZURE.SELECTOR]
...
4. Hozza létre a **FirstDataFactoryPSH** nevű data factoryt a **New-AzureRmDataFactory** parancsmag futtatásával.  
