...
| Projekt | Az alapértelmezett BigQuery projekt irányuló lekérdezés.  | Igen |
| additionalProjects | Nyilvános vesszővel tagolt listája BigQuery projekt eléréséhez.  | Nem |
...
| e-mailben | A szolgáltatásfiók e-mail azonosítója, amely ServiceAuthentication szolgál, és csak önálló üzemeltetett infravörös használhatja  | Nem |
