...
本主題會列出每一個直接適用於 Azure Data Factory 服務的主題。 您可以搜尋關鍵字的這個網頁使用 **Ctrl + F**, ，以尋找目前感興趣的主題。
...
| [計算連結服務](data-factory-compute-linked-services.md) | 了解您可以在 Azure Data Factory 管線中用來轉換/處理資料的計算環境。 |
...
| [資料處理站的疑難排解](data-factory-troubleshoot.md) | 了解如何使用 Azure Data Factory 進行問題的疑難排解。 |
