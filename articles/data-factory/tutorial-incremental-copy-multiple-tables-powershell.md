...
>[Adatok növekményes betöltése az Azure SQL Database-ből az Azure Blob storage-változáskövetési technológia használatával](tutorial-incremental-copy-change-tracking-feature-powershell.md)
