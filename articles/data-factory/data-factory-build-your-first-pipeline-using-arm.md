<properties
    pageTitle="Az első data factory létrehozása (ARM-sablon) | Microsoft Azure"
...
Ez az oktatóanyag bemutatja, hogyan hozhatja létre első Azure data factoryját egy Azure Resource Manager- (ARM-) sablon használatával. 
...
> [AZURE.IMPORTANT] Az ebben a cikkben található útmutatások követéséhez mindenképpen hajtsa végre [Az oktatóanyag áttekintése](data-factory-build-your-first-pipeline.md) című cikkben előfeltételként felsorolt lépéseket. 
...
> [AZURE.NOTE] Az Azure data factory létrehozására szolgáló ARM-sablonra a [GitHub](https://github.com/Azure/azure-quickstart-templates/blob/master/101-data-factory-blob-to-sql/azuredeploy.json) webhelyén találhat egy másik példát.  
...
1. Futtassa a következő parancsot a Data Factory-entitásoknak az 1. lépésben létrehozott ARM-sablonnal történő telepítéséhez. 

        New-AzureRmResourceGroupDeployment -Name MyARMDeployment -ResourceGroupName ADFTutorialResourceGroup -TemplateFile C:\ADFGetStarted\ADFTutorialARM.json

## Folyamat figyelése
 
1.  Miután bejelentkezett az [Azure Portalra](https://portal.azure.com/), kattintson a **Browse** (Tallózás) elemre, és válassza a **Data factories** elemet.
...
9. A feldolgozás befejeztével a szelet **Ready** (Kész) állapotú lesz. Vegye figyelembe, hogy az igény szerinti HDInsight-fürt létrehozása általában eltart egy ideig (körülbelül 20 percig). 
