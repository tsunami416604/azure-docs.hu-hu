...
>[!NOTE]
>Ehhez az összekötőhöz hozzáférési kulcsok szükségesek egy AWS identitás-és hozzáférés-kezelési (IAM) fiókhoz az Amazon S3-ból való adatmásoláshoz. Az [ideiglenes biztonsági hitelesítő adatok](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp.html) nem támogatottak.
>
...
>[!NOTE]
>A következő modellek továbbra is támogatottak a visszamenőleges kompatibilitás érdekében. Javasoljuk, hogy a korábban említett új modellt használja, amíg a Data Factory authoring felhasználói felülete be nem váltott az új modell generálására.
