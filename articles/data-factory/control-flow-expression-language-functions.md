...
|hajtsa végre a megfelelő|Visszaadja az első **száma** az átadott tömb vagy karakterlánc elemeit, például ez a függvény visszaad `[1, 2]`:  `take([1, 2, 3, 4], 2)`<br /><br /> **Paraméter száma**: 1<br /><br /> **Név**: Gyűjtemény<br /><br /> **Leírás**: Kötelező. A gyűjtemény, az első **száma** objektumait ki.<br /><br /> **Paraméter száma**: 2<br /><br /> **Név**: Darabszám<br /><br /> **Leírás**: Kötelező. A beolvasandó objektumok száma a **gyűjtemény**. Csak pozitív egész szám lehet.|  
|kihagyás|Elemeit adja vissza, a tömb indexpozíciónál kezdődő **száma**, például ez a függvény visszaad `[3, 4]`:<br /><br /> `skip([1, 2 ,3 ,4], 2)`<br /><br /> **Paraméter száma**: 1<br /><br /> **Név**: Gyűjtemény<br /><br /> **Leírás**: Kötelező. A gyűjtemény, amelynek az első **száma** objektumait ki.<br /><br /> **Paraméter száma**: 2<br /><br /> **Név**: Darabszám<br /><br /> **Leírás**: Kötelező. Elejéről eltávolítandó objektumok száma **gyűjtemény**. Csak pozitív egész szám lehet.|  
