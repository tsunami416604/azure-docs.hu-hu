...
| e-mailben | A szolgáltatásfiók e-mail azonosítója, amely ServiceAuthentication szolgál, és csak akkor használható a saját üzemeltetésű  | Nem |
...
Adatok másolása a Google AdWords, állítsa be a type tulajdonság, az adatkészlet **GoogleAdWordsObject**. Egy adatkészlet ilyen további típus-specifikus tulajdonság nincs.
