...
Az 1-es verziójú Data Factory közreműködői szerepkörével létrehozhatók és kezelhetők a 2-es verziójú Data Factory erőforrásai. További információért lásd a [Data Factory közreműködőjével](../role-based-access-control/built-in-roles.md#data-factory-contributor) foglalkozó szakaszt.
