---
title: Oktatóanyag – Application Gateway létrehozása webalkalmazási tűzfallal – Azure Portal | Microsoft Docs
...
Ha szeretné, a [Azure PowerShell](tutorial-restrict-web-traffic-powershell.md) vagy az [Azure CLI](tutorial-restrict-web-traffic-cli.md)használatával is elvégezheti az oktatóanyagot.
...
1. Az **alapok** lapon adja meg a következő Application Gateway-beállításokhoz tartozó értékeket:
   ...
   - **Szintű**: Select **WAF v2**

     ![Új Application Gateway létrehozása: Alapvető beállítások](./media/application-gateway-web-application-firewall-portal/application-gateway-create-basics.png)
...
1. Keresse meg az Application Gateway nyilvános IP-címét az **Áttekintés** oldalon. ![Az Application Gateway nyilvános IP-címének rögzítése](./media/application-gateway-create-gateway-portal/application-gateway-record-ag-address.png) 
