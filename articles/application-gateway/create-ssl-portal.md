...
Használat [Export-PfxCertificate](https://docs.microsoft.com/powershell/module/pkiclient/export-pfxcertificate) adott vissza a tanúsítványt egy pfx-fájlba exportálása ujjlenyomattal rendelkező:
