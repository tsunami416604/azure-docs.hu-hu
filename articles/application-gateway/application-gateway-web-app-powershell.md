...
Információk az átirányítás konfigurálásáról: [Átirányítás konfigurálása az Application Gatewayen PowerShell-lel](application-gateway-configure-redirect-powershell.md).
