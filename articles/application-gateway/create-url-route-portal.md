...
Az Azure portál segítségével konfigurálhatja [URL-cím elérési út-alapú útválasztási szabályok](url-route-overview.md) létrehozásakor egy [Alkalmazásátjáró](overview.md). Ebben az oktatóanyagban létrehoz virtuális gépeknek háttérkészletek menüpontot. Ezután hozzon létre útválasztási szabályokat, győződjön meg arról, hogy a webes forgalom érkezik a készletek a megfelelő kiszolgálókat.
...
4. Adja meg *videó* a második elérési út neveként. Adja meg */video/* \* az elérési utat. Válassza ki **videoBackendPool** a háttérkészlet.
    ...
    ![Elérési út alapú szabály létrehozása](./media/create-url-route-portal/application-gateway-route-rule.png)
