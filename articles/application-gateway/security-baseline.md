...
**Útmutató**: a Azure Active Directory (ad) szerepköralapú hozzáférés-vezérlés (RBAC) használata az Azure Application Gateway-vezérlési síkon való hozzáférés vezérléséhez (a Azure Portal).
