...
Ebben a példában két új szabályokat hozhat létre, és törölje az alapértelmezett szabályt, amely lett létrehozva.  A szabályt az [az network application-gateway rule create](/cli/azure/application-gateway#az_network_application_gateway_rule_create) paranccsal adhatja hozzá.
