---
title: Application Gateway létrehozása belső átirányítással – Azure CLI | Microsoft Docs
...
Adja hozzá azt az átirányítási konfigurációt, amely a *www\.consoto.org* érkező forgalmat az Application gateway *www\.contoso.com* figyelője számára az az [Network Application-Gateway redirect-config Create](/cli/azure/network/application-gateway/redirect-config)paranccsal küldi el.
...
A szabályok a létrehozásuk sorrendjében lesznek feldolgozva, és a forgalom az Application Gatewaynek eljuttatott URL-címnek megfelelő első szabály használatával lesz átirányítva. A létrehozott alapértelmezett alapszabály nem szükséges ebben az oktatóanyagban. Ebben a példában két új, *contosoComRule* és *contosoOrgRule* nevű szabályt hoz létre, és törli a létrehozott alapértelmezett szabályt.  A szabályokat az [az Network Application-Gateway Rule Create](/cli/azure/network/application-gateway)paranccsal adhatja hozzá.
...
Ebben a példában egy virtuálisgép-méretezési csoport jön létre, amely támogatja a létrehozott alapértelmezett háttér-készletet. A létrehozott méretezési csoport neve *myvmss* , és két virtuálisgép-példányt tartalmaz, amelyeken az NGINX-t telepíti.
...
Módosítsa a címeket a másik tartományra, például http://www.contoso.orgra, és látnia kell, hogy a forgalmat a rendszer visszairányítja a www\.contoso.com-figyelőhöz.
