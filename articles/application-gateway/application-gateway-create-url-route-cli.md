...
Az aktuális rendszerhéjban hozzon létre egy customConfig.json nevű fájlt, és illessze be a következő konfigurációs. A szerkesztő létre szeretne hozni a fájlt a felhő rendszerhéj használata.  Adja meg `sensible-editor cloudConfig.json` a fájl létrehozásához elérhető szerkesztők listájának megjelenítéséhez.
