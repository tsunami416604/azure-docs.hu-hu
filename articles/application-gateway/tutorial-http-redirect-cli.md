...
![Biztonságos figyelmeztetés](./media/tutorial-http-redirect-cli/application-gateway-secure.png)
...
![Az alkalmazás átjáró alap URL-cím tesztelése](./media/tutorial-http-redirect-cli/application-gateway-nginxtest.png)
