...
A beáramló vezérlőt kizárólag a Standard_v2 és a WAF_v2 SKU támogatja, ami az automatikus skálázási előnyökkel is jár. Application Gateway reagálhat a forgalom terhelésének növekedésére vagy csökkenésére, és ennek megfelelően méretezhető, anélkül, hogy az AK-fürtből erőforrásokat kellene használnia.
...
A AGIC a Kubernetes beáramlási [erőforrással](http://kubernetes.io/docs/user-guide/ingress/), valamint a szolgáltatás és az üzembe helyezések/hüvelyek használatával konfigurálható. Számos funkciót kínál, az Azure natív Application Gateway L7 terheléselosztó használatával. Csak néhányat említsünk:
  - URL-útválasztás
