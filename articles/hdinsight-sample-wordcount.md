...
-   You must have provisioned an HDInsight cluster. For instructions on the various ways in which such clusters can be created, see [Get Started with Azure HDInsight][Get Started with Azure HDInsight] or [Provision HDInsight Clusters][Provision HDInsight Clusters]
...
1.  [Run the sample using Azure PowerShell][Run the sample using Azure PowerShell]
2.  [The Java code for the WordCount MapReduce program][The Java code for the WordCount MapReduce program]
3.  [Summary][Summary]
4.  [Next steps][Next steps]

## <span id="run-sample"></span></a>Run the sample using Azure PowerShell
...
4.  Run the following command to submit the MapReduce job:
...
5.  Run the following command to check any errors with running the MapReduce job:
...
## <span id="java-code"></span></a>The Java code for the WordCount MapReduce program
...
-   [Sample: 10GB GraySort][Sample: 10GB GraySort]
...
-   [Azure HDInsight SDK documentation][Azure HDInsight SDK documentation]
  ...
  [Run the sample using Azure PowerShell]: #run-sample
  [The Java code for the WordCount MapReduce program]: #java-code
  [Summary]: #summary
