...
This article is one in a series introducing Azure Media Services programming. The previous topic was [How to: Deliver Streaming Content][How to: Deliver Streaming Content].
...
-   [Deliver Assets with the Media Services for .NET][Deliver Assets with the Media Services for .NET]
-   [Deliver Assets with the Media Services REST API][Deliver Assets with the Media Services REST API]
...
-   [Azure Media Services Documentation][Azure Media Services Documentation]
-   [Getting Started with the Media Services SDK for .NET][Getting Started with the Media Services SDK for .NET]
-   [Building Applications with the Media Services SDK for .NET][Building Applications with the Media Services SDK for .NET]
-   [Building Applications with the Azure Media Services REST API][Building Applications with the Azure Media Services REST API]
-   [Media Services Forum][Media Services Forum]
-   [How to Monitor a Media Services Account][How to Monitor a Media Services Account]
-   [How to Manage Content in Media Services][How to Manage Content in Media Services]

  [How to: Deliver Streaming Content]: ../media-services-deliver-streaming-content/
  [Deliver Assets with the Media Services for .NET]: http://msdn.microsoft.com/en-us/library/jj129575.aspx
  [Deliver Assets with the Media Services REST API]: http://msdn.microsoft.com/en-us/library/jj129578.aspx
