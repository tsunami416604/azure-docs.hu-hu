...
*By [Microsoft Open Technologies Inc.][Microsoft Open Technologies Inc.]*
...
-   [Benefits of using the Blob service][Benefits of using the Blob service]
-   [Prerequisites][Prerequisites]
-   [How to use the Blob service with Jenkins CI][How to use the Blob service with Jenkins CI]
-   [How to install the Azure Storage plugin][How to install the Azure Storage plugin]
-   [How to configure the Azure Storage plugin to use your storage account][How to configure the Azure Storage plugin to use your storage account]
-   [How to create a post-build action that uploads your build artifacts to your storage account][How to create a post-build action that uploads your build artifacts to your storage account]
-   [How to create a build step that downloads from Azure blob storage][How to create a build step that downloads from Azure blob storage]
-   [Components used by the Blob service][Components used by the Blob service]

## <a name="overview"></a><span class="short header">Overview</span>Overview of Jenkins
...
More information about Jenkins can be found at [Meet Jenkins][Meet Jenkins].

## <a name="benefits"></a><span class="short header">Benefits</span>Benefits of using the Blob service
...
## <a name="prerequisites"></a><span class="short header">Prequisites</span>Prequisites
...
-   An Azure storage account. If you don't already have a storage account, you can create one using the steps at [How to Create a Storage Account][How to Create a Storage Account].
...
## <a name="howtouse"></a><span class="short header">How to use Blob service</span>How to use the Blob service with Jenkins CI
...
## <a name="howtoinstall"></a><span class="short header">How to install</span>How to install the Azure Storage plugin
...
## <a name="howtoconfigure"></a><span class="short header">How to configure</span>How to configure the Azure Storage plugin to use your storage account
...
## <a name="howtocreatepostbuild"></a><span class="short header">How to create post-build action</span>How to create a post-build action that uploads your build artifacts to your storage account
...
## <a name="howtocreatebuildstep"></a><span class="short header">How to create build step</span>How to create a build step that downloads from Azure blob storage
...
## <a name="components"></a><span class="short header">Blob service components</span>Components used by the Blob service
...
-   **URL format**: Blobs are addressable using the following URL format:
  ...
  [Creating a Shared Access Signature]: http://go.microsoft.com/fwlink/?LinkId=279889
