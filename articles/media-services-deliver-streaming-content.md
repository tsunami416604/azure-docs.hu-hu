...
This article is one in a series introducing Azure Media Services programming. The previous topic was [How to: Deliver an Asset by Download][How to: Deliver an Asset by Download].
...
So far we have covered delivering media by downloading from Azure Storage and using Smooth Streaming. The next topic [How to Deliver HLS content][How to Deliver HLS content] discusses delivering streaming content using Apple HTTP Live Streaming (HLS).
  ...
  [How to Deliver HLS content]: ../media-services-deliver-http-live-streaming-content/
