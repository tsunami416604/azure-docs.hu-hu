...
> [!WARNING]
Egyelőre a webes API-feladatkiszolgálóknál és az ahhoz csatlakozó ügyfélnél is ugyanazt az **Ügyfél-azonosítót**/**Alkalmazásazonosítót** és házirendeket kell használnia. Ez az iOS-re és az Androidra vonatkozó oktatóanyagokra is igaz. Ha valamely másik gyorsindítási útmutató során már létrehozott egy alkalmazást, használja az ott megadott értékeket, ne hozzon létre újakat.
