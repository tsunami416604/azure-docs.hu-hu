...
| METAADATOK | Igen | Egy URL-cím, amely egy JSON-konfigurációs dokumentumra mutat, amely az OpenID Connect Discovery specifikációjának megfelelően van formázva, amely a jól ismert OpenID konfigurációs végpontként is ismert. |
