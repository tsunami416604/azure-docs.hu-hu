...
| CodeLength | Nem | A kód hossza. Az alapértelmezett érték 0.`6` |
| CharacterSet | Nem | A kód karakterkészlete, amely normál kifejezésben való használatra van formázva. Például: `a-z0-9A-Z`. Az alapértelmezett érték 0.`0-9` A karakterkészletnek legalább 10 különböző karaktert kell tartalmaznia a megadott készletben. |
| NumRetryAttempts | Nem | Az ellenőrzési kísérletek száma, mielőtt a kód érvénytelennek minősül. Az alapértelmezett érték 0.`5` |
| ReuseSameCode | Nem | Azt határozza meg, hogy egy ismétlődő kód megadása helyett új kód generálását kell-e megadni, ha a megadott kód nem járt le, és még érvényes. Az alapértelmezett érték 0.`false` |
