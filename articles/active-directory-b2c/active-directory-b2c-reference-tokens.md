...
| 簽發者 | `iss` | `https://login.microsoftonline.com/775527ff-9a37-4307-8b3d-cc311f58d925/v2.0/` | 識別可建構並傳回權杖的 Security Token Service (STS)，以及用以使用者驗證的 Azure AD 目錄。  您的應用程式應驗證簽發者宣告，以確保權杖來自 v2.0 端點。 |
