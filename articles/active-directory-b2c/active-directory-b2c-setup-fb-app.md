...
2. Ha még nem tette meg, hogy Facebook-fejlesztőként regisztrálnia kell. Ehhez válassza ki a **Ismerkedés** az oldal jobb felső sarkában, fogadja el a Facebook-szabályzatokat, és végezze el a regisztrációs lépéseket.
...
13. Mellett kattintson a plusz **termékek**, majd válassza ki **beállítása** alatt **Facebook-bejelentkezés**.
14. A **Facebook-bejelentkezés**válassza **beállítások**.
