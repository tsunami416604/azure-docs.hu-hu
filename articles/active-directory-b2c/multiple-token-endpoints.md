...
Módosítsa a `ida:AadInstance` TaskWebApp *web. config fájljának* értékét úgy, hogy az a `{your-b2c-tenant-name}.b2clogin.com` helyett a `login.microsoftonline.com`következőre hivatkozik.
