...
3. Adja hozzá a következő jogcím-szolgáltatót, amely a kérést a LinkedIn API-ját hozza létre `/emailAddress` . A kérelem engedélyezéséhez szüksége lesz a LinkedIn hozzáférési jogkivonatra.
