...
:::image type="content" source="./media/localization-string-ids/localization-susi-2.png" alt-text="A regisztrációs vagy bejelentkezési oldal U X elemeket megjelenítő képernyőkép.":::
