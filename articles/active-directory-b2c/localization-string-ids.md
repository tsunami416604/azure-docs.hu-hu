...
| azonosító | Alapértelmezett érték |
| -- | ------------- |
| **local_intro_email** | Bejelentkezés meglévő fiókkal |
| **logonIdentifier_email** | E-mail-cím |
| **requiredField_email** | Adja meg az e-mailben |
| **invalid_email** | Adjon meg egy érvényes e-mail címet |
| **email_pattern** | ^[a-zA-Z0-9.!#$%&’' *+/=?^_\`{\|}~-]+@[a-zA-Z0-9-]+(?:\\.[a-zA-Z0-9-]+)* $ |
| **local_intro_username** | Jelentkezzen be a felhasználónevet |
| **logonIdentifier_username** | Felhasználónév |
| **requiredField_username** | Adja meg a felhasználónevet |
| **jelszó** | Jelszó |
| **requiredField_password** | Írja be a jelszót |
| **invalid_password** | A megadott jelszó nem szerepel a várt formátumnak. |
...
| **social_intro** | Bejelentkezés közösségi fiókkal |
...
| **UserMessageIfClaimsPrincipalDoesNotExist** | Azt a nem Microsoft-fiókjában található. |
| **UserMessageIfOldPasswordUsed** | Úgy tűnik, a régi jelszót használt. |  
...
| azonosító | Alapértelmezett érték |
| -- | ------------- |
| **ver_sent** | Ellenőrző kódot küldeni: |
...
| **Év** | Év |
| **verifying_blurb** | Várjon, amíg a rendszer feldolgozza az adatokat. |
| **button_cancel** | Mégse |
...
| **months** | Január, február, március, április, előfordulhat, hogy, június, július, augusztus, szeptember, október, November,. December |
...
| **ver_but_resend** | Küldjön új kódot |
...
| **required_field** | Ez az információ kötelező. |
| **alert_message** | Biztos, hogy szeretné-e a részletek megadásának megszakítása? |
...
| **text_button_send_second_code** | küldjön új kódot |
| **code_pattern** | \\d{6} |
...
| **invalid_code** | Adja meg a kapott 6 jegyű kódot |
| **button_cancel** | Mégse |
| **local_number_input_placeholder_text** | Telefonszám |
| **button_retry** | Retry |
| **alternative_text** | Nem rendelkezem telefonomra |
...
| **enter_code_text_intro** | Írja be az ellenőrző kódot, vagy  |
| **intro_entry_phone** | Adjon meg egy számot, az alábbi, hogy mi is telefon a hitelesítéséhez. |
| **intro_entry_sms** | Adja meg alább, hogy is küldünk egy kódot SMS-ben történő hitelesítéséhez. |
...
| **intro_entry_mixed** | Adjon meg egy számot, az alábbi, hogy küldjön egy kódot SMS-ben, vagy telefon a hitelesítéséhez. |
...
| **error_449** | Felhasználó túllépte az újrapróbálkozások számát. |
