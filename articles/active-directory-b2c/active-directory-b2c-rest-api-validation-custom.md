...
Az interakciót összehangoló lépésként is megtervezheti. További információkért lásd: bemutató [: REST API jogcím-cserék integrálása a Azure ad B2C felhasználói úton](active-directory-b2c-rest-api-step-custom.md)az előkészítési lépésként.
...
[Bemutató: REST API jogcím-cserék integrálása a Azure AD B2C felhasználói úton az előkészítési lépésként](active-directory-b2c-rest-api-step-custom.md)
