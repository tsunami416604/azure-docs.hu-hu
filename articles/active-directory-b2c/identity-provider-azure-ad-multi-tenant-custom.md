...
1. Válassza ki a hozzáadandó választható `family_name` jogcímeket `given_name`, és.
...
1. Nyissa meg a böngészőt, és lépjen a bérlő OpenID Connect metadata URL-címére. Keresse meg a **kiállító** objektumot, és jegyezze fel az értékét. A `https://login.microsoftonline.com/00000000-0000-0000-0000-000000000000/`következőhöz hasonlóan kell kinéznie:.
