...
2. 按一下 [ **註冊原則**。
3. 按一下 [ **+ 新增** 刀鋒視窗的頂端。
4.  **名稱** 判斷您的應用程式所使用的註冊原則名稱。 例如，輸入 "SiUp"。
...
8. 按一下 [ **建立**。 請注意，剛才建立的原則會顯示為 「**B2C_1_SiUp**」 ( **B2C\_1\_** 片段是自動預先暫止) 中 **註冊原則** 刀鋒視窗。
9. 按一下以開啟原則 」**B2C_1_SiUp**」。
...
2. 按一下 [ **登入原則**。
3. 按一下 [ **+ 新增** 刀鋒視窗的頂端。
4.  **名稱** 判斷您的應用程式所使用的登入名稱。 例如，輸入 "SiIn"。
5. 按一下 [ **身分識別提供者** ，然後選取 「 電子郵件地址 」。 (選擇性) 您也可以選取社交身分識別提供者 (如果已經設定)。 按一下 [ **確定**。
...
2. 按一下 [ **編輯原則的設定檔**。
3. 按一下 [ **+ 新增** 刀鋒視窗的頂端。
4.  **名稱** 決定編輯您的應用程式所使用的原則名稱的設定檔。 例如，輸入 "SiPe"。
5. 按一下 [ **身分識別提供者** ，然後選取 「 電子郵件地址 」。 (選擇性) 您也可以選取社交身分識別提供者 (如果已經設定)。 按一下 [ **確定**。
...
8. 按一下 [ **建立**。 請注意，剛才建立的原則會顯示為 「**B2C_1_SiPe**」 ( **B2C\_1\_** 片段是自動預先暫止) 中 **編輯原則的設定檔** 刀鋒視窗。
9. 按一下以開啟原則 」**B2C_1_SiPe**」。
