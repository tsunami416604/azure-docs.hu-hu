...
1. Tekintse át a címtár beállításait. Ezután kattintson a **Létrehozás** elemre. [Telepítési hibák elhárítása](https://docs.microsoft.com/azure/azure-resource-manager/templates/common-deployment-errors).
