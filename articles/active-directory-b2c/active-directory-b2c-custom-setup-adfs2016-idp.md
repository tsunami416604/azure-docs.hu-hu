...
> [!NOTE]
> A Visual Studio code B2C kiterjesztést használja a "socialIdpUserId." Egy közösségi szabályzatot is az ADFS szükség.
>
...
3. Frissítse az értéket a **PublicPolicyUri** URI-a szabályzat. Ha például`http://contoso.com/B2C_1A_signup_signin_adfs`
