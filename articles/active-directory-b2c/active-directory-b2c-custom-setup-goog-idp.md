---
title: Adja hozzá Google + identitás-szolgáltatóként OAuth2 egyéni házirendekkel az Azure Active Directory B2C |} Microsoft Docs
description: A minta használata Google + OAuth2 protokollt használó identitás-szolgáltatóként.
