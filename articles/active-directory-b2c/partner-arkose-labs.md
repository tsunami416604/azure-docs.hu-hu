...
1. Kövesse az utasításokat [egy webalkalmazás létrehozásához](../app-service/quickstart-php.md), egészen addig, amíg az üzenet "gratulál!Az első PHP-alkalmazás üzembe helyezése App Service "jelenik meg.
