...
Ebből a cikkből megtudhatja, hogyan engedélyezheti a bejelentkezést egy Amazon-fiók felhasználói számára [Egyéni szabályzatok](active-directory-b2c-overview-custom.md) használatával Azure Active Directory B2C (Azure ad B2C).
