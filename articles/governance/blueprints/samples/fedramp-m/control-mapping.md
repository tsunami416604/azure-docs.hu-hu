---
title: FedRAMP Mérsékelt mintavezérlők
description: A FedRAMP Mérsékelt tervminta vezérlőleképezése. Minden vezérlő le van képezve egy vagy több Azure-szabályzatok, amelyek segítik az értékelést.
ms.date: 10/31/2019
ms.topic: sample
...
ms.locfileid: "77150478"
---
# <a name="control-mapping-of-the-fedramp-moderate-blueprint-sample"></a>A FedRAMP Mérsékelt tervminta vezérlőtérképezése

A következő cikk bemutatja, hogy az Azure Blueprints FedRAMP Mérsékelt tervezet minta minta leképezi a FedRAMP Mérsékelt vezérlők. A vezérlőkről további információt a [FedRAMP security controls baseline című témakörben talál.](https://www.fedramp.gov/)

Az alábbi leképezések a **FedRAMP Mérsékelt** vezérlők. A jobb oldali navigációs sávsegítségével közvetlenül egy adott vezérlőleképezésre ugorhat. A leképezett vezérlők nagy része egy [Azure Policy](../../../policy/overview.md) kezdeményezéssel valósítva meg. A teljes kezdeményezés áttekintéséhez nyissa meg a **szabályzatot** az Azure Portalon, és válassza a **Definíciók** lapot. Ezután keresse meg és válassza ki az ** \[előzetes verziót:\]FedRAMP Mérsékelt vezérlők naplózása és konkrét virtuálisgép-bővítmények üzembe helyezése** a beépített házirend-kezdeményezés naplózási követelményeinek támogatása érdekében.
...
Most, hogy áttekintette a FedRAMP Mérsékelt tervének vezérlőtérképezését, az alábbi cikkekben megtudhatja a tervrajzot és a minta üzembe helyezését:

> [!div class="nextstepaction"]
> [FedRAMP Mérsékelt terv - Áttekintés](./index.md)
> [FodRAMP Mérsékelt terv - Lépések telepítése](./deploy.md)
