---
title: Az ISO 27001 tervezetminta telepítése
description: Az önálló ISO 27001-tervezetminta lépéseit, beleértve a tervezet összetevő paraméterének részleteit.
ms.date: 01/13/2020
ms.topic: sample
...
---
# <a name="deploy-the-iso-27001-blueprint-sample"></a>Az ISO 27001 tervezetminta telepítése

Az Azure Blueprints ISO 27001 tervezetminta üzembe helyezéséhez a következő lépéseket kell tenni:
...
1. Keresse meg az **ISO 27001** tervezetmintát _az Egyéb minták csoportban,_ és válassza **a Minta használata**lehetőséget.

1. Adja meg a tervminta _alapjait:_

   - **Tervrajz neve**: Adja meg az ISO 27001 tervminta példányának nevét.
...
1. Adja meg a tervezet hozzárendelésének paraméterértékeit:
   ...
   - Tervparaméterek
     ...
     - **Erőforrások és erőforráscsoportok engedélyezett helye**: Erőforráscsoportok és erőforrások engedélyezett helyeit jelző érték.
...
|Engedélyezett tárfiók-termékváltozatok|Szabályzat-hozzárendelés|Engedélyezett tárterület-tárolók listája|A tárfiókokhoz megadható sk-ek listája.|
|Engedélyezett virtuálisgép-skus|Szabályzat-hozzárendelés|Az engedélyezett virtuálisgép-skus-ok listája|A virtuális gépekhez megadható sk-ok listája.|
|Az ISO 27001 tervezetkezdeményezése|Szabályzat-hozzárendelés|Azon erőforrástípusok listája, amelyeknek engedélyeznie kell a diagnosztikai naplókat|Naplózandó erőforrástípusok listája, ha a diagnosztikai napló beállítása nincs engedélyezve. Az elfogadható értékek az [Azure Monitor diagnosztikai naplóinak sémájában](../../../../azure-monitor/platform/diagnostic-logs-schema.md#supported-log-categories-per-resource-type)találhatók.|

## <a name="next-steps"></a>További lépések

Most, hogy áttekintette az ISO 27001 tervezetminta telepítésének lépéseit, az alábbi cikkekben ismerkedhet meg az architektúrával és a vezérléstérképezéssel:

> [!div class="nextstepaction"]
> [ISO 27001 tervezet - Áttekintés](./index.md)
> [ISO 27001 tervrajz - Control mapping](./control-mapping.md)
