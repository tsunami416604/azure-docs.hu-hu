...
description: A FedRAMP magas tervrajzi minta leképezésének vezérlése. Minden vezérlő egy vagy több olyan Azure Policy-definícióra van leképezve, amely segítséget nyújt az értékeléshez.
ms.date: 10/26/2020
ms.topic: sample
