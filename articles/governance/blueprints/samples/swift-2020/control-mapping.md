...
description: A SWIFT CSP-CSCF v2020 tervezetének vezérlése. Minden vezérlő egy vagy több olyan Azure Policy-definícióra van leképezve, amely segítséget nyújt az értékeléshez.
ms.date: 08/18/2020
ms.topic: sample
