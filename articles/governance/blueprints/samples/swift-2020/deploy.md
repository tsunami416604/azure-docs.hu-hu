---
title: Swift CSP-CSCF v2020 tervezetminta telepítése
description: A SWIFT CSP-CSCF v2020-as tervezetminta lépéseit, beleértve a tervezet összetevő paraméterének részleteit.
ms.date: 09/24/2019
ms.topic: sample
...
ms.locfileid: "74546489"
---
# <a name="deploy-the-swift-csp-cscf-v2020-blueprint-sample"></a>A SWIFT CSP-CSCF v2020 tervezetminta telepítése

Az Azure Blueprints SWIFT CSP-CSCF v2020-as tervminta telepítéséhez a következő lépéseket kell tenni:
...
1. Keresse meg a **SWIFT CSP-CSCF v2020** tervezetminta mintát _az Egyéb minták csoportban,_ és válassza a Használja ezt a **mintát**lehetőséget.

1. Adja meg a tervminta _alapjait:_

   - **Tervrajz neve:** Adja meg a SWIFT CSP-CSCF v2020 tervezetminta másolatát.
...
|\[Előzetes\]verzió : A SWIFT CSP-CSCF v2020-as verziójának ellenőrzése és konkrét virtuálisgép-bővítmények telepítése a naplózási követelmények támogatása érdekében|Szabályzat-hozzárendelés|Csatlakoztatott munkaterület-azonosítók|Azoknak a munkaterületazonosítóknak a pontosvesszővel elválasztott listája, amelyhez a Log Analytics-ügynöknek csatlakoznia kell|
...
|\[Előzetes\]verzió : A SWIFT CSP-CSCF v2020-as verziójának ellenőrzése és konkrét virtuálisgép-bővítmények telepítése a naplózási követelmények támogatása érdekében|Szabályzat-hozzárendelés|Tartománynév (FQDN)|Az a teljesen minősített tartománynév (FQDN), amelyhez a Windows virtuális gépeket|
...
Most, hogy áttekintette a SWIFT CSP-CSCF v2020 tervezetminta telepítésének lépéseit, a következő cikkekben ismerkedhet meg a tervrajz és a vezérlőtérképezés lehetőségével:

> [!div class="nextstepaction"]
> [SWIFT CSP-CSCF v2020 tervezet - Áttekintés](./index.md)
> [SWIFT CSP-CSCF v2020 tervezet - Ellenőrzés feltérképezése](./control-mapping.md)
