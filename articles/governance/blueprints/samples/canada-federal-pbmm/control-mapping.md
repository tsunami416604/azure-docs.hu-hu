---
title: Kanada Szövetségi PBMM tervezet minta ellenőrzések
description: A kanadai szövetségi PBMM tervminták vezérlőtérképezése. Minden vezérlő le van képezve egy vagy több Azure-szabályzatok, amelyek segítik az értékelést.
ms.date: 09/04/2019
ms.topic: sample
...
---
# <a name="control-mapping-of-the-canada-federal-pbmm-blueprint-sample"></a>A kanadai szövetségi PBMM-tervezet minta vezérlőtérképezése

A következő cikk részletezi, hogy az Azure Blueprints Canada Federal Protected B, Medium Integrity, Medium Availability (PBMM) blueprint mintaleképezések a kanadai szövetségi PBMM-vezérlők. A vezérlőkkel kapcsolatos további információkért lásd: [Canada Federal PBMM](https://www.canada.ca/en/government/system/digital-government/modern-emerging-technologies/cloud-services/government-canada-security-control-profile-cloud-based-it-services.html#toc4).

Az alábbi leképezések a **Kanadai Szövetségi PBMM-vezérlőkhöz** tartoznak. A jobb oldali navigációs sávsegítségével közvetlenül egy adott vezérlőleképezésre ugorhat. A leképezett vezérlők nagy része egy [Azure Policy](../../../policy/overview.md) kezdeményezéssel valósítva meg. A teljes kezdeményezés áttekintéséhez nyissa meg a **szabályzatot** az Azure Portalon, és válassza a **Definíciók** lapot. Ezután keresse meg és válassza ki az ** \[Előzetes verzió\]: Audit Canada Federal PBMM vezérlők** beépített szakpolitikai kezdeményezés.
...
## <a name="location-constraints"></a>Helymegkötések

Ez a tervezet segít abban, hogy az összes erőforrás és erőforráscsoport központi telepítésének helyét "Canada Central" és "Canada East" -re korlátozza a következő Azure-szabályzat-definíciók hozzárendelésével:

- Engedélyezett helyek (nehéz kódolni a "Canada Central" és a "Canada East")
- Az erőforráscsoportok engedélyezett helyei (nehéz kódolni "Kanada központi" és "Kelet-Kanada")
...
## <a name="ac-6-least-privilege"></a>AC-6 Legkisebb Jogosultság
...
## <a name="au-3-2-content-of-audit-records"></a>AU-3 (2) Az ellenőrzési rekordok tartalma
...
## <a name="sc-28-1-protection-of-information-at-rest"></a>SC-28 (1) Az informatika védelme
...
Átnézte a Kanadai Szövetségi PBMM tervminta vezérlőtérképét. Ezután látogasson el az alábbi cikkekbe, amelyek ből megtudhatja az áttekintést és a minta üzembe helyezését:

> [!div class="nextstepaction"]
> [Kanada Szövetségi PBMM tervezet - Áttekintés](./control-mapping.md)
> [Kanada Szövetségi PBMM terv - Telepítése lépéseket](./deploy.md)
