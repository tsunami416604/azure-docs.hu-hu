---
title: IRS 1075 mintavezérlők
description: Az IRS 1075 minta vezérlőtérképezése. Minden vezérlő le van képezve egy vagy több Azure-szabályzat, amely segíti az értékelést.
ms.date: 11/20/2019
ms.topic: sample
...
ms.locfileid: "74546830"
---
# <a name="control-mapping-of-the-irs-1075-blueprint-sample"></a>Az IRS 1075 minta vizsgálati mintájának vezérlőtérképezése

A következő cikk bemutatja, hogy az Azure Blueprints IRS 1075 tervezet minta minta leképezi az IRS 1075 vezérlők. A vezérlőkről további információt az [IRS 1075 című témakörben talál.](https://www.irs.gov/pub/irs-pdf/p1075.pdf)

Az alábbi leképezések az **IRS 1075** vezérlőkhöz tartoznak. A jobb oldali navigációs sávsegítségével közvetlenül egy adott vezérlőleképezésre ugorhat. A leképezett vezérlők nagy része egy [Azure Policy](../../../policy/overview.md) kezdeményezéssel valósítva meg. A teljes kezdeményezés áttekintéséhez nyissa meg a **szabályzatot** az Azure Portalon, és válassza a **Definíciók** lapot. Ezután keresse meg és válassza ki az ** \[előzetes verziót:\]Az IRS 1075-vezérlők naplózása és adott virtuálisgép-bővítmények üzembe helyezése** a beépített házirend-kezdeményezés naplózási követelményeinek támogatása érdekében.
...
## <a name="9321-ac-2-account-management"></a>9.3.2.1 AC-2 számlakezelés
...
## <a name="9321-ac-2-7-account-management--role-based-schemes"></a>9.3.2.1 AC-2 (7) Számlakezelés | Szerepköralapú rendszerek
...
## <a name="9321-ac-2-12-account-management--account-monitoring--atypical-usage"></a>9.3.2.1 AC-2 (12) Számlakezelés | Fiókfigyelés / atipikus használat
...
## <a name="9314-ac-4-information-flow-enforcement"></a>9.3.1.4 AC-4 információáramlás érvényesítése
...
## <a name="9316-ac-6-7-least-privilege--review-of-user-privileges"></a>9.3.1.6 AC-6 (7) Legkisebb jogosultság | Felhasználói jogosultságok áttekintése
...
## <a name="93112-ac-17-1-remote-access--automated-monitoring--control"></a>9.3.1.12 AC-17 (1) Távoli hozzáférés | Automatizált monitoring / ellenőrzés
...
## <a name="9313-au-3-2-content-of-audit-records--centralized-management-of-planned-audit-record-content"></a>9.3.1.3 AU-3 (2) Az ellenőrzési nyilvántartások tartalma | Tervezett naplórekord-tartalom központosított kezelése
...
## <a name="9336-au-6-4-audit-review-analysis-and-reporting--central-review-and-analysis"></a>9.3.3.6 AU-6 (4) Ellenőrzés felülvizsgálata, elemzése és jelentése | Központi felülvizsgálat és elemzés
...
## <a name="93311-au-12-audit-generation"></a>9.3.3.11 AU-12 auditgeneráció
...
## <a name="9357-cm-7-2-least-functionality--prevent-program-execution"></a>9.3.5.7 CM-7 (2) Legkevésbé funkcionalitás | A program végrehajtásának megakadályozása
...
## <a name="9357-cm-7-5-least-functionality--authorized-software--whitelisting"></a>9.3.5.7 CM-7 (5) Legkevésbé funkcionalitás | Engedélyezett szoftver / Engedélyezési lista
...
## <a name="9366-cp-7-alternate-processing-site"></a>9.3.6.6 CP-7 alternatív feldolgozó hely
...
## <a name="9372-ia-2-1-identification-and-authentication-organizational-users--network-access-to-privileged-accounts"></a>9.3.7.2 IA-2 (1) Azonosítás és hitelesítés (szervezeti felhasználók) | Hálózati hozzáférés kiemelt jogosultságú fiókokhoz
...
## <a name="9372-ia-2-2-identification-and-authentication-organizational-users--network-access-to-non-privileged-accounts"></a>9.3.7.2 IA-2 (2) Azonosítás és hitelesítés (szervezeti felhasználók) | Hálózati hozzáférés nem kiemelt jogosultságú fiókokhoz
...
## <a name="9375-ia-5-1-authenticator-management--password-based-authentication"></a>9.3.7.5 IA-5 (1) Hitelesítő menedzsment | Jelszóalapú hitelesítés
...
## <a name="93143-ra-5-vulnerability-scanning"></a>9.3.14.3 RA-5 Biztonsági rés vizsgálata
...
## <a name="93165-sc-7-boundary-protection"></a>9.3.16.5 SC-7 határvédelem
...
## <a name="93165-sc-7-3-boundary-protection--access-points"></a>9.3.16.5 SC-7 (3) Határvédelem | Hozzáférési pontok
...
## <a name="93165-sc-7-4-boundary-protection--external-telecommunications-services"></a>9.3.16.5 SC-7 (4) Határvédelem | Külső távközlési szolgáltatások
...
## <a name="96163-sc-8-1-transmission-confidentiality-and-integrity--cryptographic-or-alternate-physical-protection"></a>9.6.16.3 SC-8 (1) Átviteli titkosság és integritás | Kriptográfiai vagy alternatív fizikai védelem
...
## <a name="93166-sc-28-1-protection-of-information-at-rest--cryptographic-protection"></a>9.3.16.6 SC-28 (1) A nyugalmi információkat | Kriptográfiai védelem
...
## <a name="93172-si-2-flaw-remediation"></a>9.3.17.2 SI-2 hibaelhárítás
...
## <a name="93173-si-3-malicious-code-protection"></a>9.3.17.3 Si-3 rosszindulatú kódvédelem
...
## <a name="93173-si-3-1-malicious-code-protection--central-management"></a>9.3.17.3 SI-3 (1) Rosszindulatú kódvédelem | Központi irányítás
...
## <a name="93174-si-4-information-system-monitoring"></a>9.3.17.4 SI-4 Információs Rendszer monitoring
...
## <a name="93174-si-4-18-information-system-monitoring--analyze-traffic--covert-exfiltration"></a>9.3.17.4 SI-4 (18) Információs Rendszer monitoring | Forgalom / Rejtett kiszivárgás elemzése
...
Most, hogy áttekintette az IRS 1075 tervrajz vezérlőtérképezését, a következő cikkekben megtudhatja a tervrajzot és a minta üzembe helyezésének módját:

> [!div class="nextstepaction"]
> [IRS 1075 tervezet - Áttekintés](./index.md)
> [IRS 1075 tervezet - Lépések telepítése](./deploy.md)
