---
title: Adathordozó-tervezet minta központi telepítése
description: Üzembe helyezése lépéseket az adathordozó-tervezet minta, beleértve a tervezet összetevő paraméter részleteit.
ms.date: 02/25/2020
ms.topic: sample
...
---
# <a name="deploy-the-media-blueprint-sample"></a>Az Adathordozó-tervezet minta telepítése

Az Adathordozó-tervezet minta központi telepítéséhez a következő lépéseket kell tenni:
...
1. Keresse meg az Egyéb minták **csoportban** az Adathordozó-tervezet mintamintáját, és válassza **a Minta használata**lehetőséget. _Other Samples_
...
|\[Előzetes\]verzió: Naplózási adathordozó-vezérlők és konkrét virtuálisgép-bővítmények telepítése a naplózási követelmények támogatása érdekében |Szabályzat-hozzárendelés |Rendszergazdák csoport |Csoport. Például: `Administrator; myUser1; myUser2` |
...
Most, hogy áttekintette a Médiaminta központi telepítésének lépéseit, az alábbi cikkekben ismerkedhet meg az áttekintő és vezérlőleképezéssel:

> [!div class="nextstepaction"]
> [Médiatervezetek - Áttekintés](./index.md)
> [Média tervrajzok - Control mapping](./control-mapping.md)
