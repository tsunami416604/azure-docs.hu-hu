...
|\[előzetes verzió\]: az adathordozó-vezérlők naplózása és adott virtuálisgép-bővítmények üzembe helyezése a naplózási követelmények támogatásához |Szabályzat-hozzárendelés |Rendszergazdák csoport |Csoport. Például: `Administrator; myUser1; myUser2` |
...
> [Media-tervezetek – vezérlés leképezése](./control-mapping.md)
