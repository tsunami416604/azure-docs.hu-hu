---
title: ISO 27001 ASE/SQL számítási feladatok mintavezérlők
description: Az ISO 27001 App Service-környezet/SQL Database számítási feladatok minta leképezése az Azure Policy és rBAC.
ms.date: 01/13/2020
ms.topic: sample
...
---
# <a name="control-mapping-of-the-iso-27001-asesql-workload-blueprint-sample"></a>Az ISO 27001 ASE/SQL munkaterhelés-tervezet minta vezérlőleképezése

A következő cikk bemutatja, hogy az Azure Blueprints ISO 27001 ASE/SQL workload mintamintképezési minta leképezi az ISO 27001 vezérlők. A vezérlőkről további információt az [ISO 27001](https://www.iso.org/isoiec-27001-information-security.html).
...
- \[Előzetes\]verzió : Az előfizetéstulajdonosok minimális számának ellenőrzése
...
Most, hogy áttekintette az ISO 27001 App Service-környezet/SQL-adatbázis munkaterhelés-tervezetmintájának vezérlőleképezését, az alábbi cikkekben megtudhatja az architektúrát és a minta üzembe helyezését:

> [!div class="nextstepaction"]
> [ISO 27001 App Service Environment/SQL Database workload blueprint – Áttekintés Az](./index.md)
> [ISO 27001 App Service Környezet/SQL Database munkaterhelési terv – Lépések telepítése](./deploy.md)
