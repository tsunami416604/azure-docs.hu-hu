---
title: HIPAA HITRUST-tervminta – Áttekintés
description: A HIPAA HITRUST-tervminta áttekintése. Ennek a tervmintának a segítségével az ügyfelek felmérhetik az adott HIPAA HITRUST-vezérlőket.
ms.date: 08/03/2020
ms.topic: sample
...
ms.locfileid: "88213348"
---
# <a name="overview-of-the-hipaa-hitrust-blueprint-sample"></a>A HIPAA HITRUST-tervminta áttekintése

A HIPAA HITRUST-tervminta az [Azure Policy](../../../policy/overview.md) segítségével biztosít irányítási védőkorlátokat, amelyek elősegítik a [HIPAA HITRUST](https://www.hhs.gov/hipaa/for-professionals/security/laws-regulations/index.html)-igazolás megszerzését. 
...
> [HIPAA HITRUST-terv – Vezérlőelem-leképezés](./control-mapping.md)
> [HIPAA HITRUST-terv – Üzembehelyezési lépések](./deploy.md)
