---
title: Minta – nem felügyelt lemezt használó virtuális gép naplózása
description: A JSON-minta definíciójának naplózása olyan virtuális gép létrehozásakor, amely nem használ felügyelt lemezeket.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74071144"
---
# <a name="sample---audit-when-vm-does-not-use-managed-disk"></a>Minta – naplózás, ha a virtuális gép nem használ felügyelt lemezt
