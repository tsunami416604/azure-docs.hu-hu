...
A következő cikk részletesen ismerteti, hogy a Azure Policy szabályozási megfelelőségének beépített kezdeményezési definíciója hogyan képezi le a **megfelelőségi tartományokat** és **VEZÉRLŐket** a CIS-Microsoft Azure alapjaihoz.
...
Ezután keresse meg és válassza ki a **naplózási CIS Microsoft Azure a founds benchmark 1.1.0 javaslatait, és telepítse a speciális támogató virtuálisgép-bővítmények** szabályozási megfelelőségének beépített kezdeményezési definícióját.
...
### <a name="ensure-that-net-framework-version-is-the-latest-if-used-as-a-part-of-the-web-app"></a>Győződjön meg arról, hogy a .NET-keretrendszer verziója a legújabb, ha a webalkalmazás részeként van használatban
...
### <a name="ensure-server-parameter-log_duration-is-set-to-on-for-postgresql-database-server"></a>Győződjön meg arról, hogy a (z) "log_duration" kiszolgálói paraméter "ON" értékre van beállítva a PostgreSQL adatbázis-kiszolgálóhoz

**Azonosító**: a CIS Azure 4,16 **tulajdonjoga**: ügyfél
...
### <a name="ensure-that-email-service-and-co-administrators-is-enabled"></a>Győződjön meg arról, hogy az "e-mail-szolgáltatás és a társ-rendszergazdák" engedélyezve van

**Azonosító**: a CIS Azure 4,7 **tulajdonjoga**: ügyfél

|Name (Név)<br /><sub>(Azure Portal)</sup> |Leírás |Hatás (ok) |Verzió<br /><sub>GitHub</sub> |
|---|---|---|---|---|
|[A rendszergazdáknak és az előfizetések tulajdonosainak szóló e-mailes értesítéseket engedélyezni kell az SQL felügyelt példány speciális biztonsági beállításaiban.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Faeb23562-188d-47cb-80b8-551f16ef9fff) |Naplózza, hogy az "e-mail-értesítések a rendszergazdáknak és az előfizetés tulajdonosainak" beállítás engedélyezve van az SQL felügyelt példány komplex veszélyforrások elleni védelem beállításainál Ez biztosítja, hogy az SQL felügyelt példányon észlelt rendellenes tevékenységek észlelését a lehető leghamarabb jelentse a rendszergazdáknak. |AuditIfNotExists, letiltva |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_AdvancedDataSecurityEmailAdmins_Audit.json) |
...
### <a name="ensure-that-threat-detection-types-is-set-to-all"></a>Győződjön meg arról, hogy a "fenyegetés-észlelési típusok" értéke "all".
...
|Name (Név)<br /><sub>(Azure Portal)</sup> |Leírás |Hatás (ok) |Verzió<br /><sub>GitHub</sub> |
|---|---|---|---|---|
|[Az internetre irányuló virtuális gépeket hálózati biztonsági csoportokkal kell védeni](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff6de0be7-9a8a-4b8a-b349-43cf02d22f7c) |A hálózati biztonsági csoporttal (NSG) való hozzáférés korlátozásával védi a virtuális gépet a potenciális fenyegetésektől. Ha többet szeretne megtudni a NSG-vel való forgalom szabályozásáról, látogasson el ide[https://aka.ms/nsg-doc](https://aka.ms/nsg-doc) |AuditIfNotExists, letiltva |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Security%20Center/ASC_NetworkSecurityGroupsOnVirtualMachines_Audit.json) |
...
### <a name="ensure-that-standard-pricing-tier-is-selected"></a>Győződjön meg arról, hogy a standard szintű díjszabás van kiválasztva
