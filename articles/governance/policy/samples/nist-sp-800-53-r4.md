...
A következő cikk azt ismerteti, hogyan jelennek meg a Azure Policy a szabályozások megfelelőségének beépített kezdeményezési definíciója a **megfelelőségi tartományokhoz** és a **VEZÉRLŐKHÖZ** a NIST SP 800-53 R4-hez
...
Ezután keresse meg és válassza ki az **[előzetes verzió]: naplózási NIST SP 800-53 R4 vezérlőket, és telepítsen egy adott virtuálisgép-bővítményt, hogy támogassa a naplózási követelmények** szabályozási megfelelőségének beépített kezdeményezési definícióját.
...
|Name (Név)<br /><sub>(Azure Portal)</sup> |Leírás |Hatás (ok) |Verzió<br /><sub>GitHub</sub> |
|---|---|---|---|---|
...
|[Olyan Linux rendszerű virtuális gépek naplózási eredményeinek megjelenítése, amelyek nem rendelkeznek a passwd fájl engedélyeivel 0644 értékre állítva](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb18175dd-c599-4c64-83ba-bb018a06d35b) |Ezt a házirendet csak a megfelelő üzembe helyezési szabályzattal együtt kell használni egy kezdeményezésben. Ez a definíció lehetővé teszi, hogy Azure Policy az olyan Linux virtuális gépek naplózási eredményeinek feldolgozását, amelyek nem rendelkeznek a passwd fájl engedélyeivel 0644 értékre állítva. A vendég-konfigurációs házirendekkel kapcsolatos további információkért tekintse meg a következőt:[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – előzetes verzió](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Audit.json) |
|[Olyan Linux rendszerű virtuális gépek naplózási eredményeinek megjelenítése, amelyekhez jelszó nélküli fiók tartozik](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fc40c9087-1981-4e73-9f53-39743eda9d05) |Ezt a házirendet csak a megfelelő üzembe helyezési szabályzattal együtt kell használni egy kezdeményezésben. Ez a definíció lehetővé teszi, hogy Azure Policy a jelszavak nélküli fiókokkal rendelkező Linux rendszerű virtuális gépek naplózási eredményeinek feldolgozását. A vendég-konfigurációs házirendekkel kapcsolatos további információkért tekintse meg a következőt:[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – előzetes verzió](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Audit.json) |
|[A jelszavakat visszafejthető titkosítással nem tároló Windows rendszerű virtuális gépekről származó naplózási eredmények megjelenítése](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |Ezt a házirendet csak a megfelelő üzembe helyezési szabályzattal együtt kell használni egy kezdeményezésben. Ez a definíció lehetővé teszi, hogy a Azure Policy feldolgozza a jelszavakat nem tároló Windows rendszerű virtuális gépek naplózásának eredményeit a visszafejthető titkosítás használatával. A vendég-konfigurációs házirendekkel kapcsolatos további információkért tekintse meg a következőt:[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – előzetes verzió](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|[A korábbi 24 jelszó újbóli használatát lehetővé tevő Windows rendszerű virtuális gépek naplózási eredményeinek megjelenítése](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fcdbf72d9-ac9c-4026-8a3a-491a5ac59293) |Ezt a házirendet csak a megfelelő üzembe helyezési szabályzattal együtt kell használni egy kezdeményezésben. Ez a definíció lehetővé teszi Azure Policy számára az előző 24 jelszó újbóli használatát lehetővé tevő Windowsos virtuális gépek naplózási eredményeinek feldolgozását. A vendég-konfigurációs házirendekkel kapcsolatos további információkért tekintse meg a következőt:[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – előzetes verzió](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Audit.json) |
|[Olyan Windows rendszerű virtuális gépek naplózási eredményeinek megjelenítése, amelyek nem rendelkeznek maximális jelszóval (70 nap)](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F24dde96d-f0b1-425e-884f-4a1421e2dcdc) |Ezt a házirendet csak a megfelelő üzembe helyezési szabályzattal együtt kell használni egy kezdeményezésben. Ez a definíció lehetővé teszi, hogy Azure Policy a 70 napos maximális jelszóval nem rendelkező Windows rendszerű virtuális gépek naplózási eredményeinek feldolgozását. A vendég-konfigurációs házirendekkel kapcsolatos további információkért tekintse meg a következőt:[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – előzetes verzió](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Audit.json) |
|[Olyan Windows rendszerű virtuális gépek naplózási eredményeinek megjelenítése, amelyek nem rendelkeznek legalább 1 napos jelszóval](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aa11bbc-5c76-4302-80e5-aba46a4282e7) |Ezt a házirendet csak a megfelelő üzembe helyezési szabályzattal együtt kell használni egy kezdeményezésben. Ez a definíció lehetővé teszi Azure Policy számára a Windows rendszerű virtuális gépek naplózási eredményeinek feldolgozását, amelyek nem rendelkeznek legalább 1 napos jelszóval. A vendég-konfigurációs házirendekkel kapcsolatos további információkért tekintse meg a következőt:[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – előzetes verzió](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Audit.json) |
|[Olyan Windows rendszerű virtuális gépek naplózási eredményeinek megjelenítése, amelyeken nincs engedélyezve a jelszó bonyolultsága beállítás](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff48b2913-1dc5-4834-8c72-ccc1dfd819bb) |Ezt a házirendet csak a megfelelő üzembe helyezési szabályzattal együtt kell használni egy kezdeményezésben. Ez a definíció lehetővé teszi, hogy Azure Policy a jelszó bonyolultsága beállítással nem rendelkező Windows rendszerű virtuális gépek naplózási eredményeinek feldolgozását. A vendég-konfigurációs házirendekkel kapcsolatos további információkért tekintse meg a következőt:[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – előzetes verzió](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Audit.json) |
|[A Windows rendszerű virtuális gépek naplózási eredményeinek megjelenítése, amelyek nem korlátozzák a jelszó minimális hosszát 14 karakterre](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aebc8d1-020d-4037-89a0-02043a7524ec) |Ezt a házirendet csak a megfelelő üzembe helyezési szabályzattal együtt kell használni egy kezdeményezésben. Ez a definíció lehetővé teszi Azure Policy számára a Windows rendszerű virtuális gépek naplózási eredményeinek feldolgozását, amelyek nem korlátozzák a jelszó minimális hosszát 14 karakterre. A vendég-konfigurációs házirendekkel kapcsolatos további információkért tekintse meg a következőt:[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – előzetes verzió](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Audit.json) |
|[A jelszavakat visszafejthető titkosítással nem tároló Windows rendszerű virtuális gépekről származó naplózási eredmények megjelenítése](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |Ezt a házirendet csak a megfelelő üzembe helyezési szabályzattal együtt kell használni egy kezdeményezésben. Ez a definíció lehetővé teszi, hogy a Azure Policy feldolgozza a jelszavakat nem tároló Windows rendszerű virtuális gépek naplózásának eredményeit a visszafejthető titkosítás használatával. A vendég-konfigurációs házirendekkel kapcsolatos további információkért tekintse meg a következőt:[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – előzetes verzió](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
