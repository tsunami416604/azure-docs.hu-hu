...
Először jelentkezzen be az Azure-fiókjába a Azure Portal. Kattintson a jobb felső sarokban található kérdőjelre, és válassza a elemet `Help + support` .
...
Ezután válassza a elemet `New support request` . 
...
Végül adja meg a kapcsolattartási adatait, és válassza a `Create` képernyő alján a támogatási kérés elküldéséhez.
