...
Az [X. 509 tanúsítványokat](./concepts-x509-attestation.md#x509-certificates) igazolási mechanizmusként használhatja a termelés méretezéséhez és az eszközök üzembe helyezésének egyszerűsítéséhez.  Az X. 509 tanúsítvány beszerzésének [több módja](../iot-hub/iot-hub-x509ca-overview.md#how-to-get-an-x509-ca-certificate) is van:
...
Az **ügyfél** tanúsítványa a levél tanúsítványa az eszközön.  Az **ügyfél tanúsítványa** és a társított **ügyféltanúsítvány titkos kulcsa** szükséges az eszköz ügyfelében. Attól függően, hogy milyen nyelvet választ, az ügyfélalkalmazás ezt a mechanizmust más lehet.  További információért lásd a szimulált eszköz X. 509 használatával történő létrehozásával [kapcsolatos rövid](./quick-create-simulated-device-x509.md) útmutatót.

A főtanúsítvány vagy a köztes tanúsítvány használatával létrehozhat egy regisztrációs csoportot vagy egyéni beléptetést [programozott](./how-to-manage-enrollments-sdks.md) módon vagy a [portálon](./how-to-manage-enrollments.md).
