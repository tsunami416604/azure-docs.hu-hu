...
---
# <a name="create-and-provision-a-simulated-device-using-iot-hub-device-provisioning-services"></a>Szimulált eszköz létrehozása és kiépítése az IoT Hub Device Provisioning Service használatával
