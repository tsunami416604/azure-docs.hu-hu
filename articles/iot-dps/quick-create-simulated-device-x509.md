...
---
# <a name="create-and-provision-an-x509-simulated-device-using-iot-hub-device-provisioning-service-preview"></a>Szimulált X.509-eszköz létrehozása és kiépítése az IoT Hub eszközkiépítési szolgáltatással (előzetes verzió)
