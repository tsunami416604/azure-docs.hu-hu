...
---
# <a name="quickstart-enroll-x509-devices-to-the-device-provisioning-service-using-java"></a>Gyors útmutató: A Device Provisioning Service-be a Java X.509-eszközök regisztrálása
