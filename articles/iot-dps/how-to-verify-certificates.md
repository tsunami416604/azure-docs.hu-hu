...
---
# <a name="how-to-do-proof-of-possession-for-x509-ca-certificates-with-your-device-provisioning-service"></a>How to do proof-of-possession for X.509 CA certificates with your Device Provisioning Service
...
## <a name="register-the-public-part-of-an-x509-certificate-and-get-a-verification-code"></a>Register the public part of an X.509 certificate and get a verification code
...
3. Enter a friendly display name for your certificate. Browse to the .cer or .pem file that represents the public part of your X.509 certificate. Kattintson a **Feltöltés** gombra.
...
## <a name="digitally-sign-the-verification-code-to-create-a-verification-certificate"></a>Digitally sign the verification code to create a verification certificate
...
## <a name="upload-the-signed-verification-certificate"></a>Upload the signed verification certificate
