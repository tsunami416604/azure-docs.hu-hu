...
- Érvényesítési kulcs. Hajtsa végre a [szimulált eszköz létrehozása és kiépítése](quick-create-simulated-device.md) , illetve az SDK által megadott, az alábbiakban ismertetett hátirat kulcs használatát.
