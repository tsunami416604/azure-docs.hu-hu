---
title: Külső hitelesítés egy Azure Container Registry feladatban
...
Ha még nem rendelkezik Azure Container Registry szolgáltatással, tekintse meg a gyors útmutató [: Hozzon létre egy privát tároló-beállításjegyzéket](container-registry-get-started-azure-cli.md)az Azure CLI használatával. A lemezképeket még nem kell leküldeni a beállításjegyzékbe.
