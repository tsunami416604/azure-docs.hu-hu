...
> [!IMPORTANT]
> Az ACR Build jelenleg előzetes verzióban érhető el, és csak az **USA keleti régiójában** (eastus) és a **nyugat-európai** (westeurope) régióban lévő Azure tárolóregisztrációs adatbázisok támogatják. Az előzetes verziók azzal a feltétellel érhetők el, hogy Ön beleegyezik a [kiegészítő használati feltételekbe][terms-of-use]. A szolgáltatás néhány eleme megváltozhat a nyilvános rendelkezésre állás előtt.
...
Alapértelmezés szerint az `az acr build-task run` a naplókimenetet a konzolra streameli a parancs végrehajtásakor. Itt a kimenet azt mutatja, hogy az **eastus2** összeállítás üzenetsorba került és elkészült.
