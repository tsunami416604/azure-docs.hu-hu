...
- **Azure CLI version 2.0.46 or later** - Run `az --version` to find the version. Ha telepíteni vagy frissíteni szeretne: [Az Azure CLI telepítése][azure-cli-install].
