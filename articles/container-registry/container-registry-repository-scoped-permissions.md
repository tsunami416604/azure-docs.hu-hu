...
* A [névtelen lekéréses hozzáféréshez](container-registry-faq.md#how-do-i-enable-anonymous-pull-access)engedélyezett beállításjegyzékben nem lehet hatókörleképezést létrehozni.
