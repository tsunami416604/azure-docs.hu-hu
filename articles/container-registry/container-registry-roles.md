...
| Szerepkör vagy engedély       | [Resource Manager elérése](#access-resource-manage)| [Beállításjegyzék létrehozása/törlése](#create/delete-registry) | [Rendszerkép leküldése](#push-image) | [Rendszerkép lekérése](#pull-image) | [Szabályzatok módosítása](#change-polices) |   [Bejelentkezési képek](#sign-images)  |
| ---------| --------- | --------- | --------- | --------- | --------- | --------- |
