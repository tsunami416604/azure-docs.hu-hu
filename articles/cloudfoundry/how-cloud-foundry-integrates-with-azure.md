...
Ide [](https://docs.microsoft.com/azure/cloudfoundry/cloudfoundry-oms-nozzle) kattintva megtudhatja, hogyan helyezheti üzembe az Azure log Analytics fúvókát a nyílt forráskódú és a pivotal Cloud Foundry-környezetbe, majd Hogyan férhet hozzá az adatokhoz a Azure monitor naplók konzolján. 
> [!NOTE]
