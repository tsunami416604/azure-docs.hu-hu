...
Titkosítás a fontos része az Azure biztonsági eljárásokat. Annak biztosítása, hogy a titkosítás engedélyezve van minden szintek megelőzhető, illetéktelen fél férjenek hozzá a bizalmas adatokat, az úton lévő és a tárolt adatokat is beleértve. 
...
- **Always Encrypted**: SQL Server Management Studio az Always Encrypted varázsló használatával inaktív adatok védelme.
...
## <a name="best-practice-secure-web-apps"></a>Ajánlott eljárás: webes alkalmazások védelme
...
- **Az Azure Key Vault**: webes alkalmazások fejlesztőinek ma tart lépéseket annak érdekében, hogy a bizalmas adatok nem kiszivárgott az érintett fájlok. Több módszert az adatok védelméhez, hogy a fájlokat csomagolja, és helyezzük el az Azure Key Vaultban.
...
- **App Service Environment-környezet**: Ha egy alkalmazást telepít át a további védelem van szüksége, érdemes lehet az alkalmazás-erőforrások védelméhez egy App Service Environment-környezet és a webalkalmazási tűzfal hozzáadása.
...
## <a name="best-practice-review-subscriptions-and-resource-permissions"></a>Ajánlott eljárás: tekintse át az előfizetésekre és erőforrásokra vonatkozó engedélyek
...
## <a name="best-practice-review-audit-and-security-logs"></a>Ajánlott eljárás: tekintse át a naplózási és biztonsági naplókat
...
## <a name="best-practice-implement-blueprints"></a>Ajánlott eljárás: tervek megvalósításához.
...
## <a name="best-practice-deploy-azure-policy"></a>Ajánlott eljárás: Azure-házirend központi telepítése
...
- **Az Azure storage**: az Azure beépített rugalmasság és a különböző típusú tárolóhelyek a magas rendelkezésre állást biztosít:
...
-   **Georedundáns tárolás (GRS)**: nyújt védelmet a régióra kiterjedő szolgáltatáskimaradás, az 99,99999999999999 %-ában (16 9-es) tartós objektumok egy adott évben.
...
-   **Zónaredundáns tárolás (ZRS)**: adatközpont meghibásodása elleni védelmet biztosít.
...
- **Aktív georeplikáció**: üzembe helyezés gyors vész-helyreállítási aktív georeplikációt, ha egy adatközpont-kimaradás során, vagy egy elsődleges adatbázis nem hozható létre kapcsolat.
...
## <a name="best-practice-understand-support-plans"></a>Ajánlott eljárás: megismerheti a támogatási csomagok
