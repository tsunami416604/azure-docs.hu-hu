---
title: A Hyper-V virtuális gépek felmérése Azure-beli virtuális gépekre a Azure Migrate kiszolgáló értékelésével
description: Megtudhatja, hogyan értékelheti a Hyper-V virtuális gépeket az Azure-beli virtuális gépekre való áttelepítéshez a kiszolgáló értékelése
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
- Mielőtt elkezdené ezt az oktatóanyagot, hogy felmérjék az Azure-beli virtuális gépekre való áttelepítést, győződjön meg róla, hogy felderítette az értékelni kívánt gépeket:
    - Az Azure Migrate berendezéssel rendelkező gépek felderítéséhez [kövesse ezt az oktatóanyagot](tutorial-discover-hyper-v.md). 
...
1. A **válasszon ki vagy hozzon létre egy csoportot** > válassza az **új létrehozása** elemet, és adja meg a csoport nevét. 
    ...
    :::image type="content" source="./media/tutorial-assess-hyper-v/assess-machines.png" alt-text="Új csoport létrehozása és gépek hozzáadása":::
...
![Megbízhatósági minősítés](./media/tutorial-assess-vmware-azure-vm/confidence-rating.png)
