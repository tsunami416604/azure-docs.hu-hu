...
**UEFI-rendszerindítás** | Az Azure-ban áttelepített gép automatikusan egy BIOS-rendszerindító Azure-beli virtuális gépre lesz konvertálva.<br/><br/> Az operációsrendszer-lemez legfeljebb négy partíciót tartalmazhat, és a köteteket NTFS fájlrendszerrel kell formázni.
