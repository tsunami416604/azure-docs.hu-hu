...
--- | --- | --- | ---
**Assessment** | Az áttelepítés előtt mérje fel a kiszolgálókat.  Az értékelés nem kötelező. Javasoljuk, hogy az áttelepítés előtt mérje fel a gépeket, de nem kell. <br/><br/> Az értékeléshez Azure Migrate egy könnyű berendezést állít be a virtuális gépek felderítéséhez és értékeléséhez. | Ha az értékelés után ügynök nélküli áttelepítést futtat, akkor az ügynök nélküli Migrálás során az értékeléshez beállított Azure Migrate berendezés is használatos.  |  Ha az értékelés után ügynök-alapú áttelepítést futtat, az értékeléshez beállított berendezés nem használatos az ügynök-alapú áttelepítés során. A készüléket meghagyhatja, vagy eltávolíthatja, ha nem szeretné további felderítést és értékelést végezni.
