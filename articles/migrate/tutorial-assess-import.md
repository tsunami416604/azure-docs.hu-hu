...
**Virtuális gép azonosítója** | Nem | VM-azonosító. Ez a VMware vCenter virtuális gép **értékű** értéke, vagy a Hyper-v **Hyper-v virtuális gép azonosítója** .
**Virtual Machine Manager-azonosító** | Nem | Ez a VMWare vCenter **értékű** értéke. Nem szükséges a Hyper-V-hez.
**MAC-címe**| Nem | Kiszolgáló MAC-címe.
**BIOS-AZONOSÍTÓ** | Nem | Kiszolgáló BIOS-azonosítója.
**Egyéni kiszolgáló azonosítója** | Nem | Helyi, egyedi kiszolgáló-azonosító a helyszínen. <br/> Hasznos az importált kiszolgáló helyi AZONOSÍTÓval való nyomon követéséhez.
**1. alkalmazás neve** | Nem | A kiszolgálón futó munkaterhelés neve.<br/>További alkalmazásokhoz további adatokat is hozzáadhat, ha [oszlopokat ad](#add-multiple-applications) hozzá a sablonhoz. Legfeljebb öt alkalmazást adhat hozzá.
...
**1. alkalmazás licenc lejárata** | Nem | A számítási feladat lejárati ideje (ha van ilyen).
**Üzleti egység** | Nem | Az a üzleti egység, amelyhez a kiszolgáló tartozik.
...
Ha például egy második alkalmazás összes mezőjét meg szeretné adni, adja hozzá a következő oszlopokat:

- 2\. alkalmazás neve
- 2\. alkalmazás típusa
- 2\. alkalmazás verziója
- 2\. alkalmazás licencének lejárata

> [!NOTE]
> Az alkalmazásadatok hasznosak a helyszíni környezet áttelepítésre való kiértékeléséhez. Azure Migrate Server Assessment azonban jelenleg nem hajtja végre az alkalmazás szintű értékelést, vagy az értékelés létrehozásakor figyelembe veszi az alkalmazásokat.
...
9. Az értékelés létrehozása után megtekintheti azt a **kiszolgálók** > **Azure Migrate: kiszolgálói felmérés** > **értékelések**.
