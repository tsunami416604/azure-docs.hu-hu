...
- **Berendezések megtervezése**: A Azure Migrate egy helyszíni Azure Migrate berendezést használ, amely Hyper-V virtuális gépként van üzembe helyezve, hogy folyamatosan felderítse a virtuális gépeket az értékeléshez és az áttelepítéshez. A készülék figyeli a környezet változásait, például virtuális gépek, lemezek vagy hálózati adapterek hozzáadását. Emellett metaadatokat és teljesítményadatokat is küld az Azure-nak. Meg kell állapítani, hogy hány berendezést kell üzembe helyezni.
