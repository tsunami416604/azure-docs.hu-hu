...
| [Azure Edge-zónák](#edge-zones)| Virtuális gépek, tárolók és egyéb szolgáltatások üzembe helyezése az Edge-zónákhoz az alacsony késésű és a nagy teljesítményű követelmények kielégítése érdekében.| <p>[Peremhálózati zónák a fuvarozóval](edge-zones-overview.md#carrier)<p> <p>[Saját peremhálózati zónák](edge-zones-overview.md#private-edge-zones)</p>|
| [Azure orbitális](#orbital)| A kommunikációt az űrhajóval vagy a műholdas konstellációkkal, a leküldés és az adatok továbbításával, a felhőben tárolt adatok feldolgozásával, az Azure-szolgáltatásokkal való ellátásával, valamint az ügyfelek számára készült termékek létrehozásával teheti meg.  | <p>[Globális kommunikáció](azure-orbital-overview.md#global-communication)</p>  <p>[Partneri terepi állomások](azure-orbital-overview.md#digital-transformation)</p>|
||||
...
|[Hálózati biztonsági csoportok](#nsg)|Teljes részletességű elosztott végpont-vezérlés a virtuális gépen/alhálózatban az összes hálózati forgalom forgalmához|[Hálózati forgalom szűrése hálózati biztonsági csoportokkal](../virtual-network/tutorial-filter-network-traffic.md)|
