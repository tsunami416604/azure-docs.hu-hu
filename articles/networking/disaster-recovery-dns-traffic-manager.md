...
- Az elsődleges és a másodlagos helyhez Azure DNS zóna is létezik. Tegyük fel, hogy az elsődleges hely a végpont prod.contoso.com, és a biztonsági mentési hely dr.contoso.com. A www\.contoso.com néven ismert fő alkalmazás DNS-rekordja is létezik.   
...
30 percen belül, amikor a legtöbb feloldó frissíti a gyorsítótárazott zónafájl fájlját, a www\.contoso.com kapcsolatos összes lekérdezés át lesz irányítva a dr.contoso.com.
...
Ha összetett architektúrákkal és több erőforrás-készlettel rendelkezik, amelyek ugyanazt a függvényt képesek végrehajtani, akkor az Azure Traffic Manager (a DNS alapján) beállíthatja az erőforrások állapotát, és átirányíthatja a nem kifogástalan erőforrásról a Kifogástalan állapotra. erőforrás. A következő példában mind az elsődleges, mind a másodlagos régió teljes üzembe helyezéssel rendelkezik. Ez az üzembe helyezés magában foglalja a Cloud Servicest és egy szinkronizált adatbázist. 
