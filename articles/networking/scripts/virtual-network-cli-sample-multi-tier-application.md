...
[!code-azurecli-interactive[fő](../../../cli_scripts/virtual-network/virtual-network-multi-tier-application/virtual-network-multi-tier-application.sh  "többrétegű alkalmazást a virtuális hálózat")]
