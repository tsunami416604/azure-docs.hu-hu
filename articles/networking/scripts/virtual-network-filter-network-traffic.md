...
description: Azure CLI-parancsfájl használatával szűrheti a bejövő és a kimenő virtuális gép (VM) hálózati forgalmát előtér-és háttérbeli alhálózatokkal.
