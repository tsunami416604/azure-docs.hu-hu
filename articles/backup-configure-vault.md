...
# <span id="configure-a-backup-vault-tutorial"></span></a>Configure Azure Backup to quickly and easily back-up Windows Server
...
## <span id="create"></span></a>Create a backup vault
...
## <span id="upload"></span></a>Download a vault credential
...
## <span id="download"></span></a>Download and install a backup agent

1.  In the [Management Portal][Management Portal].
...
3.  On the Quick Start page, select the type of agent you want to download. You can choose **Download Azure Backup Agent**, **Windows Server and System Center Data Protection Manager**, or **Windows Server Essentials**. For more information see:
    ...
    -   [Install Azure Backup Agent for Windows Server 2012 and System Center 2012 SP1 - Data Protection Manager][Install Azure Backup Agent for Windows Server 2012 and System Center 2012 SP1 - Data Protection Manager]
    -   [Install Azure Backup Agent for Windows Server 2012 Essentials][Install Azure Backup Agent for Windows Server 2012 Essentials]
...
## <span id="manage"></span></a>Manage backup vaults and servers
...
-   To learn more about Azure Backup, see [Azure Backup Overview][Azure Backup Overview].

-   Visit the [Azure Backup Forum][Azure Backup Forum].

  [Azure Free Trial]: /en-us/pricing/free-trial/
