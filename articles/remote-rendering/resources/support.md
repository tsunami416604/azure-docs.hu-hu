---
title: Az Azure távoli renderelés támogatási lehetőségei
description: Az Azure távoli renderelés támogatásának megismerése
author: jakrams
ms.author: jakras
ms.date: 04/22/2020
...
Technikai támogatási jegy megnyitása az Azure Remote rendering Azure Portalon belül:
...
1. Töltse ki a mezőket:
    ...
    * **Szolgáltatás**:`Remote Rendering`

    ![Azure Portal támogatási jegy mezői](media/portal-request.png)

1. Kattintson a **Next (tovább** ) gombra a lap alján.

1. Töltse ki a következő űrlapot a lehető legpontosabban és részletesebben.

1. Tekintse át és küldje el a támogatási kérelmet.
...
Az egyes dokumentációs cikkek alján megnyithatja a GitHub-problémát, hogy visszajelzést nyújtson az oldalról.
