...
* [C# Anyagtudományi Osztály](https://docs.microsoft.com/dotnet/api/microsoft.azure.remoterendering.material)
...
* [C++ Material osztály](https://docs.microsoft.com/cpp/api/remote-rendering/material)
