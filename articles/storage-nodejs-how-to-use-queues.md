...
-   [How To: Working with Shared Access Signatures][How To: Working with Shared Access Signatures]
...
Create a blank Node.js application. For instructions creating a Node.js application, see [Create and deploy a Node.js application to an Azure Web Site][Create and deploy a Node.js application to an Azure Web Site], [Node.js Cloud Service][Node.js Cloud Service] (using Windows PowerShell), or [Web Site with WebMatrix][Web Site with WebMatrix].
...
For an example of setting the environment variables in the management portal for an Azure Website, see [Node.js Web Application with Storage][Node.js Web Application with Storage]
