...
> [AZURE.NOTE] 這項功能只會在 BizTalk 服務啟動、備份等期間，針對服務的管理作業擷取記錄檔。 這類作業無論執行 Azure 傳統入口網站，或使用追蹤 [BizTalk 服務 REST Api](http://msdn.microsoft.com/library/azure/dn232347.aspx)。 如需使用管理服務進行追蹤作業的完整清單，請參閱 [作業使用 Azure 管理服務](#bizops)。<br/><br/>
