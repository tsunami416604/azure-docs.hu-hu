...
[建立和管理混合式連線](integration-hybrid-connection-create-manage.md)<br/>
[將 Azure 網站連線到內部部署資源](../web-sites-hybrid-connection-get-started.md)<br/>
[從 Azure web 應用程式連接到內部部署 SQL Server](../web-sites-hybrid-connection-connect-on-premises-sql-server.md)<br/>
