---
title: A Microsoft Azure Certified program keretében előre elfogadott |} A Microsoft Docs
description: Ismerje meg a Microsoft Azure Certified partnerprogram és, hogy a virtuálisgép-lemezkép, megoldássablon, fejlesztői szolgáltatás vagy az Azure Marketplace-en adatszolgáltatás beszerzése
...
> [!IMPORTANT]
> Az Azure minősítési esetében alkalmazható, csak akkor, ha nem tervezi egy virtuális gép vagy egy megoldássablon létrehozása az Azure piactéren.

## <a name="getting-started"></a>Első lépések
1. Első lépése az elérési úton a minősítéssel rendelkező megoldás, és hozzáláthat az Azure piactéren, hogy az alkalmazás űrlap kitöltésekor az a [Microsoft Azure Certified](https://createopportunity.azurewebsites.net) weblapon.
2. Ha megfelel a jogosultsági feltételek, és az alkalmazás jóvá van hagyva, azt fogja való használatának megkezdéséhez, hogy készítse elő a megoldás az Azure piactéren.
...
Miután előzetes jóváhagyásra a Microsoft Azure Certified programról, folytassa [regisztrálása a Microsoft-fiókjával, a Microsoft értékesítői](marketplace-publishing-accounts-creation-registration.md).
