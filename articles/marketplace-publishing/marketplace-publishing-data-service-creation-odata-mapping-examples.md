...
Hozzon létre egy új nyers PUT adatokat használjon alárendelt, vagy frissíteni a teljes alárendelt egy kiszolgálón megadott URL-CÍMÉT.  Ha az alárendelt paramétere adatfolyam, azaz strukturálatlan, például. szövegfájl.  A PUT idempotent, így a több hatására olyan állapotban, azaz x = 5.  A megadott erőforrás a teljes tartalommal PUT kell használni.
