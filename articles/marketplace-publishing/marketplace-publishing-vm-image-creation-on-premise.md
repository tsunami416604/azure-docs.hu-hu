...
Létrehozhat egy tárolót, hogy a tárfiókban található használatával a [NewAzureStorageContainer](https://docs.microsoft.com/powershell/module/azure.storage/new-azurestoragecontainer) parancsmagot.
