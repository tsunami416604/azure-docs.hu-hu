...
Átmeneti azt jelenti, hogy központi telepítése egy saját "védőfal" mögött, ahol tesztelheti, és ellenőrizze a működését, a piactéren való telepítés előtt a Termékváltozat. A Termékváltozat jelenik meg, ahogy bármilyen olyan ügyfelünk, akit helyezte üzembe, hogy átmeneti. A Virtuálisgép-lemezkép igazolnia kell, mielőtt átmeneti, a rendszer továbbítja.
...
3. Az a **férhet hozzá az előkészített ajánlat?** párbeszédpanelen adja meg a az ajánlat kipróbálásához használni kívánt Azure-előfizetések listáját az [az Azure portal](https://portal.azure.com).
...
1. Jelentkezzen be a [az Azure portal](https://portal.azure.com) az előző lépésben szereplő Azure-előfizetések egyikének használatával.
