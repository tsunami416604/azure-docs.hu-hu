...
問：如果訂用帳戶狀態從*已取消建佈*狀態還原為*作用中*狀態，將會發生什麼事？
...
- [替代的伺服器備份](backup-azure-alternate-dpm-server.md)
