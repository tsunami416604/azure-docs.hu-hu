...
# Kérdések az Azure Backup szolgáltatással kapcsolatban
...
### Biztonsági másolatot készítettem a klasszikus virtuális gépemről egy biztonsági mentési tárban. Áttelepíthetem a virtuális gépeimet a klasszikus módból Resource Manager módba, hogy egy Recovery Services-tárolóban védjem őket?
...
### Mi a fájl elérési útjának maximális hossza, amely megadható az Azure Backup-ügynök használatával a Backup szabályzatában? <br/>
...
## Azure Backup Server és System Center Data Protection Manager
...
### Regisztrálhatom a DPM-kiszolgálómat több tárolóhoz? <br/>
...
### A System Center – Data Protection Manager melyik verziója támogatott? <br/>
...
### Telepítettem az Azure Backup ügynököt a fájljaim és mappáim megvédéséhez. Telepíthetem a System Center DPM-et, hogy az Azure Backup-ügynökkel együttműködve az Azure-ban védje a helyszíni alkalmazásokat vagy a virtuális gépek számítási feladatait? <br/>
...
### Konfigurálhatom úgy a Backup szolgáltatást, hogy e-mailt küldjön, ha egy biztonsági mentési feladat sikertelen volt? <br/>
...
### Korlátozva van, hogy mikorra vagy hányszor ütemezhető egy biztonsági mentési feladat?<br/>
...
### Miért kisebb a Recovery Services-tárolóba átvitt adatok mérete a biztonsági mentéskor létrehozott adatméretnél?<br/>
...
## Miről tudok biztonsági mentést készíteni?

<a id="which-operating-systems-do-azure-backup-support-br" class="xliff"></a>

### Mely operációs rendszereket támogatja az Azure Backup? <br/>
...
## Adatmegőrzési szabály és helyreállítási pontok
...
### Az adatok visszaállításakor fizetnem kell az Azure-ból kimenő forgalomért? <br/>
...
### Továbbra is megjelenik „Az Azure Backup nem lett konfigurálva ezen a kiszolgálón” figyelmeztetés annak ellenére, hogy már konfiguráltam biztonsági mentési szabályzatot <br/>
