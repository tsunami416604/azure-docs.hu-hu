...
### <a name="if-a-backup-is-kept-for-a-long-time-does-it-take-more-time-to-recover-an-older-data-point-br"></a>Ha a biztonsági mentés hosszú ideig tart, hosszabb időt is igénybe kell venni a régebbi adatpontok helyreállítására? <br/>
...
- További információ a [biztonsági mentésről és](./backup-overview.md#backup-and-retention)a megőrzésről.
