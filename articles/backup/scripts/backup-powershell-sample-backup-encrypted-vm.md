...
| [New-AzRecoveryServicesVault](https://docs.microsoft.com/powershell/module/az.recoveryservices/new-azrecoveryservicesvaul) | Létrehoz egy recovery services-tárolót a biztonsági másolatok tárolására. | 
