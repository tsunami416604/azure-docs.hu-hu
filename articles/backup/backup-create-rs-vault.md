...
description: a biztonsági mentéseket és helyreállítási pontokat tároló Recovery Services tárolók létrehozása
ms.reviewer: sogup
author: dcurwin
manager: carmonm
...
1. Jelentkezzen be az előfizetésbe [](https://portal.azure.com/)a Azure Portalban.
