...
Ez a cikk ismerteti a Recovery Services-tároló funkcióit. Recovery Services-tároló egy tárolási egység, amely az adatok Azure-ban. Az adatok program általában másolja az adatokat, vagy a virtuális gépek (VM), a munkaterhelés, a kiszolgálókra vagy munkaállomásokra konfigurációs adatait. Recovery Services-tároló a biztonsági másolatok tárolóját a Resource Manager verziója telepítve. A Microsoft támogatja a Recovery Services-tárolók használatára és a biztonsági mentési tárolók átalakítása Recovery Services-tárolók.
