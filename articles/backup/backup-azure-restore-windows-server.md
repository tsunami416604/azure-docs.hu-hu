---
title: Az Azure-ban tárolt adatvisszaállítás Windows Server-Azure Backup
...
3. A **első lépések** lapon a **következőt**válassza ki **ezt a kiszolgálót (`<server name>`)**  > .
...
4. A **helyreállítási mód kiválasztása** lapon válassza az **egyes fájlok és mappák** lehetőséget > **tovább**elemre.
...
7. A **helyreállítási mód kiválasztása** lapon válassza az **egyes fájlok és mappák** lehetőséget > **tovább**elemre.
