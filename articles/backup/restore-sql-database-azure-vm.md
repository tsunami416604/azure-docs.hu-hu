...
Ha a teljes karakterlánc adatbázis fájlok mérete nagyobb, mint egy [adott korlát](backup-sql-server-azure-troubleshoot.md#size-limit-for-files), az Azure Backup egy másik pit összetevő adatbázisfájlok listáját tárolja, úgy, hogy nem lesz a cél visszaállítási elérési útjának beállítása a visszaállítás során a művelet. A fájlok helyette az SQL alapértelmezett elérési útra lesz visszaállítva.
