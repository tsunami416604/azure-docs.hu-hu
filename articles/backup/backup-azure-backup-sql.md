...
Mielőtt elkezdené, győződjön meg arról, [](backup-azure-dpm-introduction.md#prerequisites-and-limitations) hogy teljesülnek az Microsoft Azure Backup használatának minden előfeltétele a munkaterhelések megóvása érdekében. Az előfeltételek olyan feladatokat foglalnak magukban, mint például a Backup-tároló létrehozása, a tár hitelesítő adatainak letöltése, a Azure Backup ügynök telepítése és a kiszolgáló regisztrálása a tárolóban.
