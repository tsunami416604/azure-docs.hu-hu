<properties
    pageTitle="Mi az az Azure Backup? | Microsoft Azure"
...
>[AZURE.NOTE] Ne módosítsa vagy szerkessze az előkészítési helyet.
...
>[AZURE.WARNING] A deduplikáció nem érhető el az Azure-ban semmilyen Backup-összetevőhöz. Amikor System Center DPM és Backup Server van üzembe helyezve az Azure-ban, a virtuális géphez csatolt tárolólemezek nem deduplikálhatók.
...
>[AZURE.WARNING] Az adatok biztonsági másolatának titkosításához használt kulccsal csak az ügyfél rendelkezik. A Microsoft nem tárol másolatot az Azure-ban, és nem rendelkezik hozzáféréssel a kulcshoz. Ha az ügyfél elveszíti a kulcsot, a Microsoft nem tudja helyreállítani az adatok biztonsági másolatát.
