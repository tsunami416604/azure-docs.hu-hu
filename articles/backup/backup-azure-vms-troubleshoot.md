...
* Klasszikus virtuális gépek esetében [frissítse a virtuális gép tulajdonságát](https://blogs.msdn.com/b/mast/archive/2014/04/08/install-the-vm-agent-on-an-existing-azure-vm.aspx) jelzi, hogy az ügynök telepítve van-e. Ez a lépés nem kötelező a Resource Manager virtuális gépeken.
...
A nyilvános internet-címek feloldása szükségességét rendelkezik lett csuklós [Itt](https://blogs.msdn.com/b/mast/archive/2014/06/18/azure-vm-provisioning-stuck-on-quot-installing-extensions-on-virtual-machine-quot.aspx). Ellenőrizze a virtuális hálózat DNS-konfigurációját, és győződjön meg arról, hogy URI-azonosítókat Azure feloldható kell.
