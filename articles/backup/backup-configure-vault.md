...
- Futtassa az ügynök a Microsoft Azure Backup Server (MABS) vagy a System Center Data Protection - Manager (DPM) kiszolgálóhoz. Ebben a forgatókönyvben gépeket és számítási feladatok biztonsági mentést készíteni MABS/DPM, majd a MABS és a DPM biztonsági másolatot készít a legfeljebb egy tárolót az Azure-ban a MARS-ügynök.
...
4. Válassza ki a tárolóreplikáció típusa, és kattintson a **mentése**.
