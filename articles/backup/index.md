        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ismerkedés a VMware-kiszolgáló Azure Backup szolgáltatással történő biztonsági mentésével</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/recoveryservices">Recovery Services – REST API-referencia</a></p>
                    </div>
                </div>
            </div>
        </div>
