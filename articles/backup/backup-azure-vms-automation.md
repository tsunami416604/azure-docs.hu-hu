...
變數 `$rp` 選取的備份項目，排序次序反轉的時間-最新的復原點位於索引 0 是一個復原點的陣列。 使用標準 PowerShell 陣列索引來挑選復原點。 例如: `$rp [0]` 將選取的最新的復原點。
...
如果您想要加入此報表輸出的圖表製作功能，了解從 TechNet 部落格上 [圖表使用 PowerShell](http://blogs.technet.com/b/richard_macdonald/archive/2009/04/28/3231887.aspx)
