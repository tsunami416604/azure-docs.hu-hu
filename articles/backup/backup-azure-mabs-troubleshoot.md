...
| Védelmi csoportok konfigurálása | Nem konfigurálható védelem | Ha a védett kiszolgáló egy SQL-kiszolgáló, ellenőrizze, hogy az [ebben a cikkben](https://technet.microsoft.com/library/hh757977(v=sc.12).aspx)leírtak szerint meg lett-e biztosítva a rendszerfiók (NTAuthority\System) rendszergazdai szerepkör engedélyei a védett számítógépen.
...
| Biztonsági mentés | Hiba történt a fájlok/megosztott mappák elérésekor | Próbálja meg módosítani a vírusvédelmi beállításokat a TechNet-cikkben javasolt módon a [DPM-kiszolgálón futó víruskereső szoftver futtatásával](https://technet.microsoft.com/library/hh757911.aspx).|
