...
1. [Töltse le az az PowerShell legújabb verzióját](/powershell/azure/install-az-ps). A minimálisan szükséges verzió a 1.0.0.
    ...
    > [!WARNING]
    > Az Azure-fájlmegosztás biztonsági mentéséhez szükséges minimális PS-verzió az **az. recoveryservices szolgáltatónál 2.6.0**. Frissítse a verzióját, hogy elkerülje a meglévő parancsfájlokkal kapcsolatos problémákat. Telepítse a minimális verziót a következő PS-paranccsal:
...
### <a name="using-a-runbook-to-schedule-backups"></a>Biztonsági másolatok ütemezése runbook használatával

Ha minta parancsfájlokat keres, akkor a GitHubon a Azure Automation runbook használatával hivatkozhat a [minta parancsfájlra](https://github.com/Azure-Samples/Use-PowerShell-for-long-term-retention-of-Azure-Files-Backup) .

>[!NOTE]
> Az Azure fájlmegosztás biztonsági mentési szabályzata mostantól támogatja a biztonsági mentés konfigurálását napi/heti/havi/éves adatmegőrzéssel.
