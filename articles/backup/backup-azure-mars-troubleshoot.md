...
<li>Győződjön meg arról, hogy a feladat futtatásához a kiválasztott felhasználói fiók vagy *rendszer* vagy a helyi Rendszergazdák csoportnak azon a kiszolgálón > [!TIP] javasoljuk, hogy indítsa újra a kiszolgálót annak biztosítására, hogy módosítja a fenti lépések végrehajtása után végrehajtott következetesen alkalmazzák
