...
Az Azure Disk Backup olyan ügynök nélküli és összeomolhat konzisztens megoldás, amely [növekményes pillanatképeket](https://docs.microsoft.com/azure/virtual-machines/windows/disks-incremental-snapshots) használ, és a következő előnyöket kínálja:
