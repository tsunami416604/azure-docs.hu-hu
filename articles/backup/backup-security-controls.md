...
| Biztonsági ellenőrzés | Igen/nem | Jegyzetek| Dokumentáció
|---|---|--|--|
| Azure monitoring-támogatás (például log Analytics, alkalmazás-elemzések)| Yes | A Log Analytics erőforrás-naplókon keresztül támogatott. További információ: [Azure Backup védett munkaterhelések figyelése log Analytics használatával](backup-azure-diagnostics-mode-data-model.md). |  |
...
| Engedélyezés| Yes | A rendszer felhasználja az ügyfél által létrehozott és az Azure beépített szerepköreit. További információ: [Role-Based Access Control használata Azure Backup helyreállítási pontok kezeléséhez](./backup-rbac-rs-vault.md). |  |
