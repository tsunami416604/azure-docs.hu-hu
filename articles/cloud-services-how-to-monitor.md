...
-   [Concepts][Concepts]
-   [How to: Configure monitoring for cloud services][How to: Configure monitoring for cloud services]
-   [How to: Receive alerts for cloud services metrics][How to: Receive alerts for cloud services metrics]
-   [How to: Add metrics to the metrics table][How to: Add metrics to the metrics table]
-   [How to: Customize the metrics chart][How to: Customize the metrics chart]
-   [How to: Access verbose monitoring data outside the Management Portal][How to: Access verbose monitoring data outside the Management Portal]
...
> [WACOM.NOTE]
> If you use verbose monitoring, you can add more performance counters at role instance startup, through a diagnostics configuration file. To be able to monitor these metrics in the Management Portal, you must add the performance counters before you configure verbose monitoring. For more information, see [Enabling Diagnostics in Azure Cloud Services and Virtual Machines][Enabling Diagnostics in Azure Cloud Services and Virtual Machines].
...
## <span id="verbose"></span></a>How to: Configure monitoring for cloud services
...
-   Create a storage account to store the monitoring data. You can use different storage accounts for different roles. For more information, see help for **Storage Accounts**, or see [How To Create a Storage Account][How To Create a Storage Account].

-   Enable Azure Diagnostics for your cloud service roles.
    For more information, see [Enabling Diagnostics in Azure Cloud Services and Virtual Machines][1].
...
1.  Copy a storage access key for the storage account that that you'll use to storage the verbose monitoring data. In the [Azure Management Portal][Azure Management Portal], you can use **Manage Keys** on the **Storage Accounts** page. For more information, see [How to Manage Cloud Services][How to Manage Cloud Services], or see help for the **Storage Accounts** page.
...
1.  In the [Management Portal][Azure Management Portal], open the **Configure** page for the cloud service deployment.
...
## <span id="receivealerts"></span></a>How to: Receive alerts for cloud service metrics
...
## <span id="addmetrics"></span></a>How to: Add metrics to the metrics table

1.  In the [Management Portal][Management Portal], open the **Monitor** page for the cloud service.
...
## <span id="customizechart"></span></a>How to: Customize the metrics chart
...
## <span id="accessverbose"></span></a>How to: Access verbose monitoring data outside the Management Portal
...
-   *aggregation\_interval* = 5M, 1H, or 12H
...
For example, the following tables would store verbose monitoring data aggregated at 1-hour intervals:
  ...
  [Enabling Diagnostics in Azure Cloud Services and Virtual Machines]: http://azure.microsoft.com/en-us/documentation/articles/cloud-services-dotnet-diagnostics/
  [How To Create a Storage Account]: /en-us/manage/services/storage/how-to-create-a-storage-account/
  [1]: /en-us/documentation/articles/cloud-services-dotnet-diagnostics/
  [Azure Management Portal]: https://manage.windowsazure.com/
  [How to Manage Cloud Services]: /en-us/documentation/articles/cloud-services-how-to-manage/
  [Monitoring options]: ./media/cloud-services-how-to-monitor/CloudServices_MonitoringOptions.png
  [How to: Receive Alert Notifications and Manage Alert Rules in Azure]: http://go.microsoft.com/fwlink/?LinkId=309356
