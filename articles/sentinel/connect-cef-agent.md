...
- A Linux rendszerű gépen telepítve kell lennie a **python 2,7** vagy a **3** rendszernek.<br>A parancs használatával keresse meg a következőt: `python -version` .
