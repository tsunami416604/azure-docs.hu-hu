...
Telepítenie kell egy ügynököt egy dedikált linuxos gépen (VM vagy helyszíni) az F5 és az Azure Sentinel közötti kommunikáció támogatásához. Az alábbi ábra az Azure-beli Linux rendszerű virtuális gépek esetén történő telepítést ismerteti.
...
## <a name="step-2-configure-your-f5-to-send-cef-messages"></a>2\. lépés: az F5 beállítása CEF üzenetek küldéséhez
