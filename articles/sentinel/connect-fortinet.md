...
A Fortinet és az Azure Sentinel közötti kommunikáció támogatásához telepítenie kell egy ügynököt egy dedikált linuxos gépen (VM vagy helyszíni). Az alábbi ábra az Azure-beli Linux rendszerű virtuális gépek esetén történő telepítést ismerteti.
...
## <a name="step-2-forward-fortinet-logs-to-the-syslog-agent"></a>2\. lépés: a Fortinet-naplók továbbítása a syslog-ügynökhöz
...
1. Nyissa meg a CLI-t a Fortinet készüléken, és futtassa a következő parancsokat:
 ...
 Ha a Fortinet-eseményekhez Azure Monitor Log Analytics a megfelelő sémát szeretné használni, keressen rá a `CommonSecurityLog`kifejezésre.
