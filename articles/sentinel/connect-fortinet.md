...
1. Ha a Fortinet-eseményekhez Azure Monitor Log Analytics a megfelelő sémát szeretné használni, keressen rá a `CommonSecurityLog`kifejezésre.
