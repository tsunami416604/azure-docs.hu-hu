...
| AuditLogs | [Az Azure AD csatlakoztatása](connect-azure-active-directory.md)  | V | |
| SigninLogs | [Az Azure AD csatlakoztatása](connect-azure-active-directory.md)  | V | |
| AzureFirewall |[Azure Diagnostics](../firewall/tutorial-diagnostics.md) | V | |
| InformationProtectionLogs_CL  | [Jelentések Azure Information Protection](https://docs.microsoft.com/azure/information-protection/reports-aip)<br>[Az Azure Information Protection csatlakoztatása](connect-azure-information-protection.md)  | V | Ez általában az adattípuson kívül a **InformationProtectionEvents** függvényt használja. További információ: [a jelentések módosítása és egyéni lekérdezések létrehozása](https://docs.microsoft.com/azure/information-protection/reports-aip#how-to-modify-the-reports-and-create-custom-queries)|
...
| OfficeActivity | [Az Office 365 csatlakoztatása](connect-office-365.md) | V | |
| SecurityEvents | [A Windows biztonsági eseményeinek csatlakoztatása](connect-windows-security-events.md)  | V | A nem biztonságos protokollok-munkafüzetek esetében lásd: nem [biztonságos protokollok beállítása](/azure/sentinel/quickstart-get-visibility#use-built-in-workbooks)  |
...
| ThreatIntelligenceIndicator  | [Fenyegetésfelderítés csatlakoztatása](connect-threat-intelligence.md)  | V | |
