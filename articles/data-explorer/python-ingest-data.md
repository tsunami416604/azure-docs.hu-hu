...
* [A fürt és adatbázis](create-cluster-database-portal.md)
...
Osztályok importálása az azure-kusto-adatokat.
...
## <a name="create-a-table-on-your-cluster"></a>Hozzon létre egy táblát a fürtön
...
Leképezheti a bejövő CSV-adatokat a tábla létrehozásakor használt oszlopnevekre és adattípusokra. A céloldali tábla oszlopait képez le forrás datová Pole
...
## <a name="query-data-that-was-ingested-into-the-table"></a>A tábla be lett töltve adatlekérdezés
