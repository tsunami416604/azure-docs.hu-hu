...
> [!TIP]
> A saját munkafolyamatok létrehozásakor javasoljuk, hogy a kód idempotens. Használja például a [. Create-Merge táblát](/azure/kusto/management/create-table-command#create-merge-table) a [. Create](/azure/kusto/management/create-table-command)-szorzótábla helyett, és használja a. Create [-vagy a-Alter](/azure/kusto/management/create-alter-function) függvényt a [. Create](/azure/kusto/management/create-function) függvény helyett.
