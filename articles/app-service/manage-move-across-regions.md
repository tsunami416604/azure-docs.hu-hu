...
2. Ha egyéni tartományt használ, akkor a [megelőző jelleggel kösse a](manage-custom-dns-migrate-domain.md#bind-the-domain-name-preemptively) `awverify.`, és [engedélyezze a tartományt a célalkalmazás alkalmazásban](manage-custom-dns-migrate-domain.md#enable-the-domain-for-your-app).
