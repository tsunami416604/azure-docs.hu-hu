...
Az alkalmazás kódja a "x-appservice-proto" fejlécen keresztül ellenőrizheti a protokollt. A fejléc `http` vagy `https`értékét fogja tartalmazni. 
