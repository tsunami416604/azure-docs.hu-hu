...
Ez az útmutató bemutatja, hogyan a beépített PHP-futtatókörnyezet konfigurálása a webalkalmazásokhoz [Azure App Service](https://go.microsoft.com/fwlink/?LinkId=529714), adjon meg egyéni PHP-futtatókörnyezet, és engedélyezze a bővítmények. Az App Service használatához Regisztráljon a [az ingyenes próbaidőszak]. Ez az útmutató az lekéréséhez, először hozzon létre egy PHP-webalkalmazás App Service-ben.
