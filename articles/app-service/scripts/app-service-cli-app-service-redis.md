...
| [az redis létrehozása](https://docs.microsoft.com/en-us/cli/azure/redis#az_redis_create) | Hozzon létre új Redis Cache példányt. Ez az adatok tárolásához. |
| [az-redis-listázása](https://docs.microsoft.com/en-us/cli/azure/redis#az_redis_list_keys) | A redis cache példány az elérési kulcsainak listázása. |
