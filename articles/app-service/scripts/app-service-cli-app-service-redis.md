...
Ez a parancsfájlpélda hoz létre egy Azure redis cache és az Azure-webalkalmazásban. Az alkalmazás-beállításokkal a webes alkalmazás a redis gyorsítótárt majd hivatkozik.
...
A parancsfájl a következő parancsokat egy erőforráscsoport, webalkalmazás, redis gyorsítótár és minden kapcsolódó erőforrások létrehozásához. Minden egyes parancsa a tábla-parancs adott dokumentációjára mutató hivatkozásokat.
...
| [`az redis create`](/cli/azure/redis?view=azure-cli-latest#az_redis_create) | Hozzon létre új Redis Cache példányt. |
| [`az redis list-keys`](/cli/azure/redis?view=azure-cli-latest#az_redis_list_keys) | A redis cache példány az elérési kulcsainak listázása. |
