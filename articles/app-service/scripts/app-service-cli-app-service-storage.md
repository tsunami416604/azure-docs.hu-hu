...
| [az storage-fiók létrehozása](https://docs.microsoft.com/cli/azure/storage/account#az_storage_account_create) | Tárfiók létrehozása. Ez az a statikus eszközök tárolásához. |
| [az tárolási fiók megjelenítése-kapcsolat-karakterlánc](https://docs.microsoft.com/cli/azure/storage/account#az_storage_account_show_connection_string) | |
