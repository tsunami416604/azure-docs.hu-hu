---
title: 'PowerShell: Fájlok feltöltése FTP-n keresztül'
description: Megtudhatja, hogyan automatizálhatja az Azure PowerShellt az App Service üzembe helyezésének és felügyeletének automatizálására. Ez a minta bemutatja, hogyan tölthet fel fájlokat egy alkalmazásba FTP használatával.
...
| [Get-AzWebAppPublishingProfil](/powershell/module/az.websites/get-azwebapppublishingprofile) | Lekéri egy webalkalmazás közzétételi profilját. |
