...
| [az alkalmazás kulcs tároló konfiguráció](https://docs.microsoft.com/cli/azure/webapp/config/container#az_webapp_config_container_set) | Beállítja a Docker-tároló az Azure webalkalmazás számára. |
