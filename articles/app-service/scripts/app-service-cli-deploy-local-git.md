...
| [`az webapp deployment user set`](/cli/azure/webapp/deployment/user?view=azure-cli-latest#az_webapp_deployment_user_set) | Beállítja az App Service fiókszintű üzembehelyezési hitelesítő adatait. |
| [`az webapp deployment source config-local-git`](/cli/azure/webapp/deployment/source?view=azure-cli-latest#az_webapp_deployment_source_config_local_git) | Létrehozza egy helyi Git-adattár forrásvezérlési konfigurációját. |
