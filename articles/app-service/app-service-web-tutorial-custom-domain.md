...
* Vásároljon egy tartománynevet, és győződjön meg arról, hogy hozzáfér a tartományszolgáltatója (például a GoDaddy) DNS-jegyzékéhez.
  ...
  > [!NOTE]
  > Ha nem rendelkezik meglévő tartománynévvel, az [Azure Portallal vásárolhat egy tartományt](custom-dns-web-site-buydomains-web-app.md). 
...
Ha az App Service-csomag **Ingyenes**, zárja be a **Tarifacsomag kiválasztása** oldalt, és folytassa a [CNAME rekord leképezése](#cname) szakasszal.
