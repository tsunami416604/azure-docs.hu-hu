...
```
> [!NOTE]
> A PowerShell 3.0-ban bevezetett stop-parsing szimbólum `(--%)`arra utasítja a PowerShellt, hogy ne értelmezze a bemenetet PowerShell-parancsként vagy kifejezésként. 
>
