...
Számos tényező lehet, hogy hozzájárul a teljesítmény az alkalmazás. Részletes hibaelhárítási lépéseket: [hibaelhárítás lassú WebApp teljesítményének](app-service-web-troubleshoot-performance-degradation.md).
...
Kimenő kapcsolatok a webalkalmazásban kapcsolatos további információkért lásd a következő blogbejegyzésben: kapcsolatos [kimenő kapcsolatok az Azure-webhelyek](http://www.freekpaans.nl/2015/08/starving-outgoing-connections-on-windows-azure-web-sites/).
