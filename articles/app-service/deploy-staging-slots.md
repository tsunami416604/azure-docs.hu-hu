...
Nincs tartalom van üzembe helyezési tárhely létrehozása után. A tárolóhely egy másik adattárban ágat, vagy egy teljesen más tárházat telepítheti. A tárolóhely-konfiguráció is módosíthatja. A közzétételi profil vagy a központi telepítési hitelesítő adatok használata társított tartalom frissítések üzembe helyezési pont.  Például végezheti [közzététele a gittel tárolóhely](deploy-local-git.md).
