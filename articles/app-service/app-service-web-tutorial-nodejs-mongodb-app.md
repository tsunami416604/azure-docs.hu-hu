...
description: "Megismerheti, hogyan tehet szert egy olyan, az Azure-ban működő Node.js-alkalmazásra, amely MongoDB kapcsolati karakterlánccal rendelkező Cosmos DB-hez csatlakozik."
...
---
# <a name="build-a-nodejs-and-mongodb-web-app-in-azure"></a>Node.js- és MongoDB-webalkalmazás fejlesztése az Azure-ban
...
1. [Telepítse a Bowert](https://bower.io/) (a [MEAN.js](http://meanjs.org/docs/0.5.x/#getting-started) követelménye)
...
Futtassa az alábbi parancsot a _config/env/local-production.js_ fájlban konfigurált kapcsolati karakterlánc használatához.
...
A naplóstreamelés megkezdése után frissítse az Azure-webalkalmazást a böngészőben, hogy legyen némi webes forgalom. Ekkor láthatja, hogy a rendszer átadja a konzolnaplófájlokat a terminálnak.
