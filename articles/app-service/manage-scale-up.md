...
A App Service alkalmazások méretezésével kapcsolatos videókért tekintse meg a következő forrásokat:
 
* [Mikor kell méretezni az Azure-webhelyeket – Stefan Schackow](https://azure.microsoft.com/resources/videos/azure-web-sites-free-vs-standard-scaling/)
* [Azure websites, CPU vagy ütemezett automatikus méretezés Stefan Schackow](https://azure.microsoft.com/resources/videos/auto-scaling-azure-web-sites/)
* [Az Azure websites méretezése – Stefan Schackow](https://azure.microsoft.com/resources/videos/how-azure-web-sites-scale/)
