...
Ha Ön [alkalmazásnaplózás engedélyezése](troubleshoot-diagnostic-logs.md), hitelesítési és engedélyezési nyomkövetések látni fogja a naplófájlok közvetlenül a. Nem várt dátumértékek hitelesítési hibaüzenet jelenik meg, ha a meglévő alkalmazás naplók alapján kényelmesen megtalálhatja a részletekről. Ha engedélyezi a [sikertelen kérelmek követésének](troubleshoot-diagnostic-logs.md), láthatja pontosan milyen szerepet a hitelesítési és engedélyezési modul játszott előfordulhat, hogy a sikertelen kérelem. Az a nyomkövetési naplókat, keresse meg a hivatkozások nevű modulra `EasyAuthModule_32/64`. 
