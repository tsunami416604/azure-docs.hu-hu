...
1. Válassza a **branding**elemet. A **Kezdőlap URL-címe**mezőbe írja be a app Service alkalmazás URL-címét, majd válassza a **Mentés**lehetőséget.
