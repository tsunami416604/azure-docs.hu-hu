...
Ha a lemezképet a App Serviceban lévő egyéni tárolóba szeretné telepíteni, használja a `azure/webapps-container-deploy@v2` műveletet. Ehhez a művelethez öt paraméter tartozik:
