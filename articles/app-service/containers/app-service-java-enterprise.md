...
Töltse fel az indítási parancsfájl `/home/site/deployments/tools` App Service-példányában. Lásd: [ebben a dokumentumban](/azure/app-service/app-service-deployment-credentials#userscope) hitelesítő adatait az FTP beszerzésével kapcsolatban. 
