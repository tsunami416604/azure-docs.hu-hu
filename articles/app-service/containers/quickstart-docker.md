...
A rövid útmutató elvégzéséhez szüksége lesz egy [Azure Container Registryban](/azure/container-registry)tárolt megfelelő webalkalmazás-rendszerképre. Kövesse a gyors útmutató [: privát tároló beállításjegyzékének létrehozása a Azure Portal használatával](/azure/container-registry/container-registry-get-started-portal), de a `hello-world` rendszerkép helyett `mcr.microsoft.com/azuredocs/go` használja a rendszerképet. A [minta Docker az Azure Samples-](https://github.com/Azure-Samples/go-docs-hello-world)tárházban található.
