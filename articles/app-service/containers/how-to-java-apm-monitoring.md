---
title: Konfigurálja a Java APM és monitorozási eszközökkel, az Azure App Service Linux rendszeren
...
1. Töltse le a Java ügynököt a NewRelic, fog rendelkezni a fájl nevét hasonló `newrelic-java-x.x.x.zip`.
1. Másolja a licenckulcsot, meg kell, hogy később konfigurálja az ügynököt.
...
1. A kicsomagolt NewRelic Java ügynököt fájlok feltöltése egy könyvtárat `/home/site/wwwroot/apm`. Az ügynök számára a fájlok kell lennie a `/home/site/wwwroot/apm/newrelic`.
1. A következő YAML-fájl módosítása `/home/site/wwwroot/apm/newrelic/newrelic.yml` és licenc helyőrző értékét cserélje le a saját licenckulcsot.
