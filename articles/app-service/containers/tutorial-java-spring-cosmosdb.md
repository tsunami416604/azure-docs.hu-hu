...
4. Az alkalmazás csatlakozni az Azure Cosmos DB kulcs beszerzése. Tartsa a `primaryMasterKey`, `documentEndpoint` közelben kell őket a következő lépésben.
