...
Kattintson az **SSL-beállítások** > **nyilvános tanúsítványok (. cer)** @no__t – 3**nyilvános tanúsítvány feltöltése** az alkalmazás bal oldali navigációs sávjára.
...
Ha feltöltött vagy importált tanúsítványt szeretne használni az alkalmazás kódjában, a következő <a target="_blank" href="https://shell.azure.com" >Cloud Shell</a>parancs futtatásával elérhetővé teheti az ujjlenyomatát a `WEBSITE_LOAD_CERTIFICATES` alkalmazás beállításával:

```azurecli-interactive
az webapp config appsettings set --name <app-name> --resource-group <resource-group-name> --settings WEBSITE_LOAD_CERTIFICATES=<comma-separated-certificate-thumbprints>
```

Az összes tanúsítvány elérhetővé tételéhez állítsa az értéket `*` értékre.

> [!NOTE]
> Ez a beállítás a legtöbb díjszabási szinten elhelyezi a megadott tanúsítványokat a [jelenlegi Settingsnew](/windows-hardware/drivers/install/local-machine-and-current-user-certificate-stores) -tárolóban, de ha az alkalmazás az **elkülönített** szinten fut (azaz az alkalmazás fut egy [app Service Environmentban](environment/intro.md)), akkor előfordulhat, hogy be kell jelentkeznie a [helyi ](/windows-hardware/drivers/install/local-machine-and-current-user-certificate-stores)Ehelyett a Machine\My-tárolót.
>
...
Miután a tanúsítvány elérhetővé válik, a Tanúsítvány ujjlenyomata alapján férhet hozzá a C# kódban. A következő kód betölti a `E661583E8FABEF4C0BEF694CBC41C28FB81CD870` ujjlenyomattal rendelkező tanúsítványt.
