...
Ez a cikk bemutatja, hogyan tehet szert az operációs rendszer vagy a szoftver bizonyos fájlverzió-információkat [App Service-ben](app-service-web-overview.md). 
