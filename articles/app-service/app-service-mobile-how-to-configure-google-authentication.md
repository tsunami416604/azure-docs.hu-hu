...
6. A bal oldali navigációs **hitelesítő adatok** > **OAuth-hozzájárulás képernyő**, majd jelölje be a **E-mail cím**, adjon meg egy **termékneve**, és kattintson a **mentése**.
7. Az a **hitelesítő adatok** lapra, majd **hitelesítő adatok létrehozása** > **OAuth-Ügyfélazonosító**. Kattintson a **konfigurálási hozzájárulási képernyőn**, adjon meg egy **Terméknév**. Kattintson a **mentése**
8. Az "Ügyfél-azonosító létrehozása" képernyőn válassza ki a **webes alkalmazás**.
9. Illessze be az App Service **URL-cím** másolt korábban be **jogosult JavaScript-források**, majd illessze be az átirányítási az URI **jogosult átirányítási URI-**. Az átirányítási URI megadása az alkalmazás fűzhető hozzá az elérési út az URL-cím */.auth/login/google/callback*. Például: `https://contoso.azurewebsites.net/.auth/login/google/callback`. Győződjön meg arról, hogy a HTTPS protokollt használ. Ezt követően kattintson a **Create** (Létrehozás) gombra.
10. A következő képernyőn jegyezze fel az ügyfél-azonosító és a titkos ügyfélkódot értékeit.
