...
## <a id="update-service"></a>更新伺服器專案，以傳送推播通知
...
* 標記可讓您使用推播鎖定區隔的客戶。 [Azure 行動應用程式使用.NET 後端伺服器 SDK](app-service-mobile-dotnet-backend-how-to-use-server-sdk.md) 示範如何將標記加入至 [裝置安裝。
