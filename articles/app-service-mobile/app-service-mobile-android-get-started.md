...
本教學課程將示範如何使用 Azure 行動應用程式後端，將雲端式後端服務加入 Android 行動應用程式。 您將建立新的行動裝置應用程式後端和簡單 _Todo list_ Android 應用程式在 Azure 中儲存應用程式資料。
...
* [Android Developer Tools](https://developer.android.com/sdk/index.html), ，其中包括 Android Studio 整合式開發環境，以及最新版 Android 平台。
