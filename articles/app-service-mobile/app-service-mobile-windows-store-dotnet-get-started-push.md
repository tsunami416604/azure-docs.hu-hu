...
3. 在 **PostTodoItem** 方法中，新增下列程式碼呼叫之後 **InsertAsync**: 
...
4. 在 [方案總管] 中按兩下 **Package.appxmanifest** 的 Windows 市集應用程式，請在 **通知**, ，請將 **支援快顯通知** 至 **是**。
...
* 標記可讓您使用推播鎖定區隔的客戶。 [使用 Azure 行動應用程式的.NET 後端伺服器 SDK](app-service-mobile-dotnet-backend-how-to-use-server-sdk.md#how-to-add-tags-to-a-device-installation-to-enable-push-to-tags) 示範如何將標記加入至 [裝置安裝。
