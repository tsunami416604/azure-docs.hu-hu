...
> [!NOTE]
> Az Azure Web Apps elemzési megoldások elavult.  Az ügyfelek, akik már telepítették a megoldás továbbra is használhatják azt, de bármely új munkaterületek nem Azure Web Apps Analytics lehet hozzáadni.
