...
2. A Log Analytics-előfizetések ablaktábláján kattintson **Hozzáadás**.  
    ...
    ![munkaterületek listája](./media/log-analytics-manage-access/workspace-link-existing-01.png)
...
3. A **tarifacsomag**válassza ki a tarifacsomagot, majd kattintson a **kiválasztása**.  
    ![A kijelölt tarifacsomag](./media/log-analytics-manage-access/workspace-pricing-tier-info.png)
