<properties
    pageTitle="A Log Analyticshez való hozzáférés kezelése | Microsoft Azure"
...
3. A **Felhasználók kezelése** részen válassza ki a hozzáadni kívánt fióktípust: **Szervezeti fiók**, **Microsoft-fiók**, **Microsoft ügyfélszolgálat**.
    ...
    >[AZURE.NOTE] Az optimális teljesítmény érdekében legfeljebb három Active Directory-csoport legyen társítva egy OMS-fiókhoz. Az egyik legyen a rendszergazdák, a második a közreműködők, a harmadik pedig a csak olvasási hozzáféréssel rendelkező felhasználók csoportja. Ha ennél több csoportot használ, az befolyásolhatja a Log Analytics teljesítményét.

5. Válassza ki a hozzáadni kívánt felhasználó vagy csoport típusát: **Rendszergazda**, **Közreműködő** vagy **ReadOnly felhasználó**.  
...
2. A megerősítési párbeszédpanelen kattintson az **Igen** gombra.
...
>[AZURE.IMPORTANT] A munkaterület társításához az Azure-fióknak hozzáférést kell biztosítani a társítani kívánt munkaterülethez.  Másként fogalmazva az Azure Portal eléréséhez **ugyanazt** a fiókot kell használni, mint az OMS-munkaterület eléréshez. Ha ez nem igaz, kövesse a [Felhasználó hozzáadása meglévő munkaterülethez](#add-a-user-to-an-existing-workspace) szakasz lépéseit.
...
>[AZURE.NOTE] Miután a fiókot egy szervezeti fiókhoz társította, a társítást nem lehet eltávolítani vagy módosítani.
