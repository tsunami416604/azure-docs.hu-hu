...
| időköz | A gyakoriság, amellyel az objektumot számlálók összegyűjtése. |
...
| Típus = telj ObjectName logikai lemez CounterName = "Az aktuális lemez várólista hossza" számítógép = = "MyComputerName" &#124; a mérték által példánynév Avg(Average) |Egy adott számítógép minden példányára átlagos aktuális lemez-várólista hossza |
...
| Típus = telj ObjectName = "MSSQL$ INST2: adatbázisok" példánynév fő = | Minden teljesítményadat elnevezett SQL Server-példány INST2 a master adatbázis adatbázis-teljesítmény objektumból.  
