...
description: Ebből az oktatóanyagból megtudhatja, hogyan küldheti vissza az Azure Data Box Disket. A csomagfelvételi utasítások attól függenek, hogy hová küldi vissza az eszközt.
services: databox
author: alkohli
ms.service: databox
ms.subservice: disk
...
# <a name="tutorial-return-azure-data-box-disk"></a>Oktatóanyag: Az Azure Data Box Disk visszaküldése

Ez az oktatóanyag azt mutatja be, hogyan küldheti vissza az Azure Data Box Disket. A csomagfelvételi utasítások attól függenek, hogy hová küldi vissza az eszközt.
...
## <a name="return-azure-data-box-disk"></a>Az Azure Data Box Disk visszaküldése
...
2. Csomagolja be az összes lemezt és kábelt buborékfóliába, és helyezze őket a szállítási dobozba. Ha a tartozékok hiányoznak, a szolgáltató költségeket számíthat fel.
    - Használja fel újra az első szállításkor kapott csomagolást.  
...
### <a name="us-or-canada"></a>[Egyesült Államok vagy Kanada](#tab/in-us-or-canada)
...
3. Egyeztessen egy csomagfelvételi időpontot a UPS-szel. Csomagfelvétel ütemezése:
...
2. Küldjön e-mailt a Quantium Solutionsnek az alábbi e-mail-sablonnal.
    ...
    - Requested pickup date：mmdd (Select a requested time slot from below).
        ...
        d. 17：00-19：00
    ```
    - **Ha Oszakában történik a csomagfelvétel**, akkor módosítsa a következőre az e-mail-sablon tárgyát: `Pickup request for Microsoft Azure OSA`.
...
### <a name="korea"></a>[Dél-Korea](#tab/in-korea)
...
Végezze el a következő lépéseket, ha a Dél-afrikai Köztársaságba küldi vissza az eszközt.

1. Ragassza a megadott szállítási címkét a dobozra. Ez a címke tartalmazza a nyomkövetési számot. Ha a fuvarlevélcímke hiányzik, az **Áttekintés > Fuvarlevélcímke letöltése** menüponton keresztül tölthet le egy újat.
...
Végezze el a következő lépéseket, ha Kínába küldi vissza az eszközt.

1. Mellékelje a kapott fuvarlevélcímkét, és rögzítse a dobozra. Ez a címke tartalmazza a nyomkövetési számot. Ha a fuvarlevélcímke hiányzik, az **Áttekintés > Fuvarlevélcímke letöltése** menüponton keresztül tölthet le egy újat.

2. Az alábbi e-mail sablon használatával küldjön e-mailt a FedEx Premier Customer Care számára, amely tartalmazza a csomagfelvétel megszervezéséhez szükséges nyomkövetési számot (a szállítás hivatkozási számát):  
...
| Kapcsolattartási adatok | Részletek |
|---|---|
|Név:       | Bao Ying|
|Megnevezés | Vezető OneCall-képviselő |
|Telefon:      | 400.889.6066 mellék: 3693 |
|E-mail:     | [ying.bao@fedex.com](mailto:ying.bao@fedex.com) |

<ins>Biztonsági mentés</ins>

| Kapcsolattartási adatok | Részletek |
|---|---|
|Név:       | He Xun|
|Megnevezés | OneCall-képviselő |
|Telefon:      | 400.889.6066 mellék: 3603 |
