...
Ahogy az adatok ezen a megoldáson keresztül áramlanak, az események naplózva lesznek, és naplók jönnek létre. További információ: [Nyomon követés és eseménynaplózás az Azure Data Box hoz.](data-box-logs.md)
...
- Az adatok külső helyre és helyről történő másolásához hozzáférési hitelesítő adatokat kell megadni. Az Azure Portal on az **Eszköz hitelesítő adatai** laphoz való összes hozzáférés be kerül a [tevékenységnaplókba.](data-box-logs.md#query-activity-logs-during-setup)
...
- Az adatokat biztonságosan törölheti az eszközről, miután az Azure-ba való feltöltés befejeződött. Az adattörlés összhangban van az [ATA merevlemezek A. függelékében a NIST 800-88r1 szabványokban található iránymutatásokkal.](https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-88r1.pdf) Az adattörlési esemény a [rendelési előzményekben kerül rögzítésre.](data-box-logs.md#download-order-history)
...
- Az Adatdoboz-sorrendhez való hozzáférés szerepköralapú hozzáférés-vezérlési (RBAC) szerepkörök használatával szabályozható. További információ: [Hozzáférés-vezérlés beállítása adatdoboz-rendeléshez](data-box-logs.md#set-up-access-control-on-the-order)
...
|A. függelék a [NIST SP 800-88r1-ben](https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-88r1.pdf) lévő ATA merevlemez-meghajtókhoz      | Adattisztítás         |
