...
A megadott erőforráscsoportok alapján a Data Box Heavy minden egyes társított erőforráscsoport számára létrehoz egy megosztást. Ha például `mydbmdrg1` és `mydbmdrg2` jött létre a rendelés elhelyezésekor, a következő megosztások jönnek létre:
...
3. Miután telepítette az NFS-ügyfelet, az alábbi paranccsal csatlakoztathatja az NFS-megosztást az eszközön:
    ...
    Az alábbi példa bemutatja, hogyan csatlakozhat NFS-en keresztül egy Data Box vagy Data Box Heavy-megosztáshoz. A Data Box vagy Data Box Heavy eszköz IP-címe `169.254.250.200`, a megosztás `mydbmdrg1_MDisk` csatlakoztatva van a ubuntuVM, a csatlakoztatási pont pedig `/home/databoxubuntuhost/databox`.
...
- [Az Adatmásolás SMB-n keresztül](data-box-heavy-deploy-copy-data.md#copy-data-to-data-box-heavy)
- [Adatmásolás az NFS-en keresztül](data-box-heavy-deploy-copy-data-via-nfs.md#copy-data-to-data-box-heavy)
