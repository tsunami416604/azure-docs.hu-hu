...
description: Ebből az oktatóanyagból megtudhatja, hogyan csomagolhatja ki az Azure Data Box Disket, csatlakozhat lemezekhez, kérheti le a hozzáférési kulcsot és oldhat fel lemezeket Windows- és Linux-ügyfeleken.
services: databox
author: alkohli
ms.service: databox
ms.subservice: disk
...
2. Az Azure Portalon lépjen Data Box Disk-megrendeléséhez. A megkereséséhez lépjen az **Általános > Minden erőforrás** lehetőségre, majd válassza ki Data Box Disk-megrendelését. A hozzáférési kulcs másolásához kattintson a másolás ikonra. Ez a hozzáférési kulcs oldja fel a lemezek zárolását.
...
1. Az Azure Portalon lépjen Data Box Disk-megrendeléséhez. A megkereséséhez lépjen az **Általános > Minden erőforrás** lehetőségre, majd válassza ki Data Box Disk-megrendelését.
...
8. A lemez zárolásának feloldása után megtekintheti annak tartalmát a csatlakozási ponton. Most már készen áll az adatok másolására a *BlockBlob* vagy a *PageBlob* mappába. 
    ...
    ![A Data Box Disk tartalma 2](media/data-box-disk-deploy-set-up/data-box-disk-content-linux.png)
