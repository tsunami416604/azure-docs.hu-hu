...
description: Ebből az oktatóanyagból megtudhatja, hogyan másolhat adatokat a gazdagépről az Azure Data Box Diskre, majd hogyan hozhat létre ellenőrző összegeket az adatok integritásának ellenőrzéséhez.
services: databox
author: alkohli
ms.service: databox
ms.subservice: disk
