...
Blob, Table, and Queue storage are included in every storage account, while File storage is available by request via the [Azure Preview page][Azure Preview page].

The storage account is a unique namespace that gives you access to Azure Storage. Each storage account can contain up to 500 TB of combined blob, queue, table, and file data. See the [Azure Storage Scalability and Performance Targets][Azure Storage Scalability and Performance Targets] for details about Azure storage account capacity.
...
You can get started with Azure with a [free trial][free trial]. Once you decide to purchase a plan, you can choose from a variety of [purchase options][purchase options]. If you’re an [MSDN subscriber][MSDN subscriber], you get free monthly credits that you can use with Azure services, including Azure Storage.
...
The [Storage Pricing Details][1] page provides detailed pricing information for storage capacity, replication, and transactions. The [Data Transfers Pricing Details][Data Transfers Pricing Details] provides detailed pricing information for data egress. You can use the [Azure Storage Pricing Calculator][Azure Storage Pricing Calculator] to help estimate your costs.
...
-   [Azure Storage Scalability and Performance Targets][Azure Storage Scalability and Performance Targets]

### For .NET Developers

-   [How to use Blob Storage from .NET][How to use Blob Storage from .NET]
-   [How to use Table Storage from .NET][How to use Table Storage from .NET]
-   [How to use Queue Storage from .NET][How to use Queue Storage from .NET]

### For Java/Android Developers

-   [How to use Blob Storage from Java/Android][How to use Blob Storage from Java/Android]
-   [How to use Table Storage from Java/Android][How to use Table Storage from Java/Android]
-   [How to use Queue Storage from Java/Android][How to use Queue Storage from Java/Android]

### For Node.js Developers

-   [How to use Blob Storage from Node.js][How to use Blob Storage from Node.js]
-   [How to use Table Storage from Node.js][How to use Table Storage from Node.js]
-   [How to use Queue Storage from Node.js][How to use Queue Storage from Node.js]

### For PHP Developers

-   [How to use Blob Storage from PHP][How to use Blob Storage from PHP]
-   [How to use Table Storage from PHP][How to use Table Storage from PHP]
-   [How to use Queue Storage from PHP][How to use Queue Storage from PHP]

### For Ruby Developers

-   [How to use Blob Storage from Ruby][How to use Blob Storage from Ruby]
-   [How to use Table Storage from Ruby][How to use Table Storage from Ruby]
-   [How to use Queue Storage from Ruby][How to use Queue Storage from Ruby]

### For Python Developers

-   [How to use Blob Storage from Python][How to use Blob Storage from Python]
-   [How to use Table Storage from Python][How to use Table Storage from Python]
-   [How to use Queue Storage from Python][How to use Queue Storage from Python]

  [Azure Preview page]: /en-us/services/preview/
  ...
  [free trial]: /en-us/pricing/free-trial/
  [purchase options]: /en-us/pricing/purchase-options/
  [MSDN subscriber]: /en-us/pricing/member-offers/msdn-benefits-details/
  [Azure Import/Export Service]: http://azure.microsoft.com/en-us/documentation/articles/storage-import-export-service/
  [shared access signature]: ../storage-dotnet-shared-access-signature-part-1/
  [storage-replication-options]: ../includes/storage-replication-options.md
  [1]: /en-us/pricing/details/storage/
  [Data Transfers Pricing Details]: /en-us/pricing/details/data-transfers/
  [Azure Storage Pricing Calculator]: /en-us/pricing/calculator/?scenario=data-management
