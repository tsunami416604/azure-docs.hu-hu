...
您應該已經有 [Xamarin.Android] 和 [Azure 行動服務的 ][azure mobile services component] 元件安裝在您的專案，當您完成從 [開始使用行動服務]。
...
## <a id="update-server"></a>更新行動服務傳送推播通知
...
## <a name="test-app"></a>測試已發佈的行動服務應用程式
