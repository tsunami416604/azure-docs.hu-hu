...
> 如果您無法升級至 Visual Studio Professional 2013 Update 3 或是您偏好手動將您的行動服務專案新增至 Windows 市集應用程式解決方案，請參閱 [本版](../mobile-services-dotnet-backend-windows-store-dotnet-get-started-data.md) 的主題。
