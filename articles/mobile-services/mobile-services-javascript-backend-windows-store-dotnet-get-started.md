---
title: Get Started with Mobile Services for Windows Store apps (C#) | Microsoft Docs
...
* [Get started with offline data sync] Learn how to use offline data sync to make your app responsive and robust.
