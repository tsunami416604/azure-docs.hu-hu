...
1. 登入 [Azure classic portal], ，瀏覽至您的行動服務，按一下 **識別** 索引標籤，然後向下捲動至 **Azure active directory** 身分識別提供者區段，然後複製 **應用程式 URL** 顯示在這裡。
...
2. 瀏覽至 **Active Directory** 中 [Azure classic portal], ，然後按一下您的目錄 **網域** 並記下目錄的預設網域。
