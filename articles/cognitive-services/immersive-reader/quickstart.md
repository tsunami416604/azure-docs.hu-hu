---
title: 'Gyors útmutató: hozzon létre egy olyan webalkalmazást, amely elindítja a magával ragadó olvasót a C-vel #'
...
---
# <a name="quickstart-create-a-web-app-that-launches-the-immersive-reader-c"></a>Rövid útmutató: hozzon létre egy webalkalmazást, amely elindítja a részletes olvasót (C#)
