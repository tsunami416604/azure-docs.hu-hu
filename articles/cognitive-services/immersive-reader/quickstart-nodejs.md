...
Telepítse a fonal-függőségeket, és vegyen fel függőségeket `request` és `dotenv`, amelyeket később a rövid útmutatóban fog használni.
...
Nyissa meg a böngészőt, és navigáljon _http://localhost:3000_ . A következőnek kell megjelennie:
