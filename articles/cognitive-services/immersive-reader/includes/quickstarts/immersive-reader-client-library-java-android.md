---
title: Az olvasó Java (Android) ügyféloldali kódtár gyors üzembe helyezése
...
```
![Képernyőkép, amely a Android Studio környezeti változóit jeleníti meg.](../../media/android/java/android-studio-assets-and-env-file.png)
...
Hozzon létre egy új **AuthenticationTask. Java** Java-osztály fájlt.
