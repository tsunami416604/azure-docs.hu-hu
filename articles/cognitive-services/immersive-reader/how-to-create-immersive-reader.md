...
1. Először nyissa meg a [Azure Cloud Shell](https://docs.microsoft.com/azure/cloud-shell/overview). Győződjön meg arról, hogy a Cloud Shell a PowerShell elemre van állítva a bal felső sarokban, vagy írja be a `pwsh`.
...
1. Futtassa a `Create-ImmersiveReaderResource`függvényt, és szükség szerint adja meg a paramétereket.
