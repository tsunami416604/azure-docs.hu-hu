...
A Markdown jobb eszköz, ha automatikusan létre kell hoznia egy tartalmat a CI/CD-folyamat vagy a [Batch-tesztelés](./index.yml)részeként importálandó tudásbázisok létrehozásához.
