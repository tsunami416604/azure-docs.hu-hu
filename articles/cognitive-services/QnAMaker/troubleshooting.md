...
### <a name="when-qna-maker-returns-runtime-core-is-not-initialized-how-do-i-fix-it"></a>Ha a QnA Maker visszaadja `Runtime core is not initialized,` Hogyan javíthatom?
