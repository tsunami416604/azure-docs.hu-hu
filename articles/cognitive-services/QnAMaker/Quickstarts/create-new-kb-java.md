...
[Dokumentáció](/rest/api/cognitiveservices/qnamaker/knowledgebase)  |  [Java-minta](https://github.com/Azure-Samples/cognitive-services-qnamaker-java/blob/master/documentation-samples/quickstarts/create-knowledge-base/CreateKB.java)
