...
1. Az [apache httpclient](http://hc.apache.org/downloads.cgi) kódtárra lesz szüksége. Töltse le például a bináris HttpClient 4.x.x.tar.gz fájlt a projekt importálásához szükséges összes jar-fájl megkereséséhez.
