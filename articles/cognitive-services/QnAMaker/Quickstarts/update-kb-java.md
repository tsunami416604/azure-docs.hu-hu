---
title: 'Rövid útmutató: Tudásbázis frissítése – REST, Java – QnA Maker'
...
ms.locfileid: "49645855"
---
# <a name="quickstart-update-a-knowledge-base-in-qna-maker-using-java"></a>Rövid útmutató: Tudásbázis frissítése a QnA Makerben a Java használatával
...
Ha még nem rendelkezik tudásbázissal, létrehozhat egy minta tudásbázist ehhez a rövid útmutatóhoz: [Új tudásbázis létrehozása](create-new-kb-java.md).

1. Hozzon létre egy új Java-projektet kedvenc IDE-környezetében.
1. Adja hozzá az alábbi kódot.
1. Cserélje le a `key` értéket egy érvényes előfizetői azonosítóra.
...
1. Az [apache httpclient](https://hc.apache.org/downloads.cgi) kódtárra lesz szüksége. Töltse le például a bináris HttpClient 4.x.x.tar.gz fájlt a projekt importálásához szükséges összes jar-fájl megkereséséhez.
1. A [GSON](https://github.com/google/gson) kódtárra is szüksége van. Manuálisan [hozza létre](https://stackoverflow.com/questions/5258159/how-to-make-an-executable-jar-file) és importálja a .jar fájlt, vagy adjon hozzá egy függőséget az előnyben részesített projektfelügyeleti eszközhöz, például a Mavenhez.
...
A tudásbázis frissítése után a QnA Maker portálján, a [My knowledge bases](https://www.qnamaker.ai/Home/MyServices) (Saját tudásbázisok) lapon tekintheti meg azt. Figyelje meg, hogy a tudásbázis a testre szabott kérés alapján megváltozott.

A tudásbázis egyéb elemeinek módosításához tekintse meg a QnA Maker [JSON-sémáját](https://westus.dev.cognitive.microsoft.com/docs/services/5a93fcf85b4ccd136866eb37/operations/5ac266295b4ccd1554da7600), és módosítsa a `req` objektumot a `getRequest()` metódusban.
