---
title: Java-gyors üzembe helyezés Microsoft kérdés-válasz Maker API (v4) - Azure kognitív szolgáltatások |} Microsoft Docs
...
ms.locfileid: "36301461"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-java"></a>Gyors üzembe helyezés Microsoft kérdés-válasz Maker Java API 
<a name="HOLTop"></a>

Ez a cikk bemutatja, hogyan használható a [Microsoft kérdés-válasz készítő API](../Overview/overview.md) az alábbiakhoz Java.
