---
title: NODE.js gyors üzembe helyezés Microsoft kérdés-válasz Maker API (V4) - Azure kognitív szolgáltatások |} Microsoft Docs
...
ms.locfileid: "36301536"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-nodejs"></a>Microsoft kérdés-válasz Maker API-t Node.js gyors üzembe helyezés 
<a name="HOLTop"></a>

Ez a cikk bemutatja, hogyan használható a [Microsoft kérdés-válasz készítő API](../Overview/overview.md) a Node.js az alábbiakhoz.
