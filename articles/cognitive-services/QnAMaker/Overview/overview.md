...
**2. lépés**: Tudásbázis létrehozása a [QnA Maker](https://www.qnamaker.ai) portálon. [Fájlok és URL-címek](../concepts/data-sources-supported.md) hozzáadása a Tudásbázis létrehozásához.  
