...
1. Válasszon olyan Sign-On fiókot, amely jogosult a Active Directory engedélyeinek megadására.




## <a name="add-sharepoint-data-source-with-apis"></a>SharePoint-adatforrás hozzáadása API-kkal
