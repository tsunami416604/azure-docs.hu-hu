...
description: Megtudhatja, hogyan tölthet fel egy rendszerképet a Bing Visual Search API és a Ruby használatával, majd elemzéseket kaphat a rendszerképről.
