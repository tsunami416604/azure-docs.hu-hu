---
title: 'Gyors útmutató: A Bing Visual Search REST API és a Go lemezkép elemzések lekérése'
...
```
> [!NOTE]
> Francesco Giordano viszonyított ebben a példában a kódot.
