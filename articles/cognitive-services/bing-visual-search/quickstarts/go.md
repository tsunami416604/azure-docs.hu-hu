...
description: Megtudhatja, hogyan tölthet fel egy rendszerképet a Bing Visual Search API és a go használatával, majd elemzéseket kaphat a rendszerképről.
