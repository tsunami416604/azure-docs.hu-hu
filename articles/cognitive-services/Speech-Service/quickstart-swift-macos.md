...
description: Ismerje meg, hogyan beszédfelismerést SWIFT nyelvű beszéd SDK-val macOS rendszeren
...
ms.locfileid: "67561516"
---
# <a name="quickstart-recognize-speech-in-swift-on-macos-using-the-speech-sdk"></a>Gyors útmutató: A beszédfelismerés SDK-val macOS rendszeren Swift beszédfelismerést

[!INCLUDE [Selector](../../../includes/cognitive-services-speech-service-quickstart-selector.md)]

Ebben a cikkben megismerheti, hogyan hozhat létre macOS-alkalmazásokat SWIFT nyelvű beszéd szöveggé mikrofon gépről rögzített lefényképezze a Cognitive Services beszédfelismerő SDK segítségével.
...
MacOS-hez a Cognitive Services beszédfelismerő SDK egy keretrendszer csomag terjesztése.
