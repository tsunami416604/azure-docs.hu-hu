...
> [!NOTE]
> Ha a C++ és a Windows egy gyors üzembe helyezés van szüksége, lépjen [Itt](cpp-windows.md).
...
Kapott találhatóval, cserélje le az Előfizetés kulcs a kódban.
...
* Egy x64 a gép, futtassa:

  ```sh
  export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:$SPEECHSDK_ROOT/lib/x64"
  ```

* Egy x86 a gép, futtassa:
