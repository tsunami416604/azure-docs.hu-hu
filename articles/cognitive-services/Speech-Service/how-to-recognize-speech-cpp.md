...
description: Ismerje meg, hogyan beszédfelismerést (az egy fájlra, és egy mikrofonnal, egy egyéni modell, folyamatosan vagy végeredménye) SDK-val a Speech Pro C++.
