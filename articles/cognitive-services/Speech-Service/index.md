...
<div id="main" class="v2">    
    <div class="container">
        <h1>A Speech Service dokumentációja</h1>
        <ul class="pivots">
            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Dokumentáció</h3>
                                                    <p>További információ a Speech Service-ről, valamint az alkalmazásokban, eszközökben és termékekben történő használatáról.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
