...
A beszédfelismerési szolgáltatás telefonos beállítása a kihangsúlyozott szótag magánhangzója után, azonban a `fr-FR` Speech Service Phone-készlet nem támogatja az IPA-alterhelést (ˌ). Ha az IPA-alterhelésre van szükség, közvetlenül az IPA-t kell használnia.
...
<a id="fr-1"></a>*csak néhány idegen szó esetében* 
**1** .

> [!TIP]
> A `fr-FR` Speech Service Phone-készlet nem támogatja a következő francia liasions, `n‿`, `t‿`és `z‿`t. Ha szükségesek, érdemes lehet az IPA használatát közvetlenül használni.
...
<a id="de-v-2"></a>
**2** *szót intially csak idegen eredetű szavakban, például ppointment. Szótag – kezdetben a következőben: "v**e**rstauen.*
...
| d | `d` | **d**anken | [<sup>3</sup>](#de-c-3) Hossz**d**l | [<sup>4</sup>](#de-c-4) **D**e |  |
...
<a id="de-c-6"></a>
**6** *szót – csak idegen eredetű szavakban, például GRE**g**-ban.*<br>
<a id="de-c-7"></a>
**7** *csak idegen eredetű szavakban, például: **ng**Uyen.*<br>
<a id="de-c-8"></a>
**8** *csak idegen eredetű szavakban, például: **S**taccato.*<br>
<a id="de-c-9"></a> *csak idegen eredetű szavakban 
9, például: gr**OO**ve.*<br>
<a id="de-c-10"></a>
**10** *az IPA-`x` nehéz "CH", miután az összes nem elülső magánhangzó (a, AA, Oh, ow, uh, ELTE és a diphthong AW).*<br>
<a id="de-c-11"></a>
**11** *az IPA-`ç` egy puha "CH" az első magánhangzók után (IH, iy, eh, AE, uy, UE, OE, EU szintén a diphthongs Ay, Oy) és mássalhangzós-ben*<br>
<a id="de-c-12"></a>
**12** *szót – kezdetben csak idegen eredetű szavakban, például: **J**karbamidban. Szótag – kezdetben a következő szavakkal is hasonló: ba**CH**erach.*<br>
...
> [!TIP]
> A `es-ES` Speech Service Phone-készlet nem támogatja a következő spanyol IPA, `β`, `ð`és `ɣ`t. Ha szükségesek, érdemes lehet az IPA használatát közvetlenül használni.

# <a name="zh-cn"></a>[zh-CN](#tab/zh-CN)

A `zh-CN` beszédfelismerési szolgáltatásának beállítása a natív telefonos <a href="https://en.wikipedia.org/wiki/Pinyin" target="_blank">pinjin <span class="docon docon-navigate-external x-hidden-focus"></span> </a> -készleten alapul.
...
A `zh-TW` beszédfelismerési szolgáltatásának beállítása a natív telefonos <a href="https://en.wikipedia.org/wiki/Bopomofo" target="_blank">bopomofo <span class="docon docon-navigate-external x-hidden-focus"></span> </a> -készleten alapul.
...
A `ja-JP` beszédfelismerési szolgáltatásának beállítása a natív telefonos <a href="https://en.wikipedia.org/wiki/Kana" target="_blank">Kana <span class="docon docon-navigate-external x-hidden-focus"></span> </a> készleten alapul.
