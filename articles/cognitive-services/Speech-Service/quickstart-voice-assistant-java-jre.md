---
title: 'Gyors útmutató: egyéni hangsegéd (előzetes verzió), Java (Windows, Linux) – Speech Service'
...
ms.locfileid: "73504066"
---
# <a name="quickstart-create-a-voice-assistant-with-the-speech-sdk-java"></a>Rövid útmutató: hangsegéd létrehozása a Speech SDK-val, Java
