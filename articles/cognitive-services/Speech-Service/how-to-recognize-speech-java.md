...
description: >
  Beszédfelismerést különböző módszert mutat be (a fájlra, és a egy testre szabott modellel, folyamatosan a mikrofon vagy végeredménye) készült Java beszéd SDK-val.
