...
description: Ismerje meg, hogyan beszédfelismerést (a egy fájlra, és egy mikrofonnal, egy egyéni modell, folyamatosan vagy végeredménye) SDK-val a Speech Javához készült.
