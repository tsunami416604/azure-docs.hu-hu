...
Rövid útmutatók érhetők el is [beszédfelismerés](quickstart-cpp-linux.md).

Ebben a cikkben létrehoz egy C++ Konzolalkalmazás Linux (Ubuntu 16.04, Ubuntu 18.04, Debian 9). A Cognitive Services használata [beszéd SDK](speech-sdk.md) szintetizálásához beszéd valós idejű szöveg és a speech játsszon a PC-hangszóró. Az alkalmazást a [Linuxhoz készült Speech SDK-val](https://aka.ms/csspeech/linuxbinary) és a Linux-disztribúció C++ fordítóprogramjával lehet összeállítani (ilyen például a `g++`).
