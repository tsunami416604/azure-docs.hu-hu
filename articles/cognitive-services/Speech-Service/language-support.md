...
A Microsoft beszédfelismerés SDK-t és a REST API támogatja a következő nyelveket (területi beállítás). Az egyes nyelvekhez testreszabás szinteken érhetők el.
