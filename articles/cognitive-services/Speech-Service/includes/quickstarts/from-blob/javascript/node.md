...
Első lépésként győződjön meg arról, hogy a projekt meg van nyitva a kedvenc szerkesztőjében.

Hívja meg a fájl index. js fájlt.
...
Mivel a REST API JSON formátumban fogadja a kérelmeket, és a JSON-t is eredményül adják.
Ahhoz, hogy a kérések és válaszok könnyebben érthetőek legyenek, deklaráljuk néhány osztályt a JSON szerializálásához/deszerializálásához.
...
## <a name="create-an-initial-transcription-request"></a>Hozzon létre egy kezdeti átírási kérelmet.
Ezután létrehozjuk az átírási kérelmet.
...
## <a name="send-the-transcription-request"></a>Küldje el az átírási kérelmet.
...
Ezután meghívunk egy metódust az `CheckTranscriptionStatus` állapot vizsgálatára, és végül kinyomtatjuk az eredményeket. A következőt fogjuk megvalósítani `CheckTranscriptionStatus` .
...
## <a name="check-the-requests-status"></a>A kérelmek állapotának keresése
...
**Indítsa el az alkalmazást** futtató Node index. js fájlt.
