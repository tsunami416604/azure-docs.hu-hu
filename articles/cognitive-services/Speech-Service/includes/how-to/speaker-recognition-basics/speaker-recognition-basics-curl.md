...
Első lépésként [hozzon létre egy hangprofilt](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/createprofile). A beszédfelismerési szolgáltatás előfizetési kulcsát és régióját be kell szúrnia a jelen cikkben szereplő összes curl-parancsba.
...
Most már készen áll [egy hangminta ellenőrzésére a hangprofilban](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/verifyprofile). Ez a hangminta ugyanazt a jelszót tartalmazza, mint a hangprofil regisztrálásához használt minták.
...
A befejezéshez [törölje a hangprofilt](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/deleteprofile).
...
Először [hozzon létre egy szövegtől független ellenőrzési profilt](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/createprofile).
...
Ezután [regisztrálja a hangprofilt](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/createenrollment). A három hangminta elküldése helyett újra kell küldenie a hangmintákat, amelyek összesen 20 másodperces hangot tartalmaznak.
...
Most már készen áll [egy hangminta ellenőrzésére a hangprofilban](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/verifyprofile). Ez a hangminta nem feltétlenül tartalmaz jelszót. Bármilyen beszédet tartalmazhat, feltéve, hogy összesen legalább négy másodperces hangot tartalmaz.
...
A befejezéshez [törölje a hangprofilt](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/deleteprofile).
...
Első lépésként [hozzon létre egy szöveg-független azonosító profilt](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/createprofile).
...
Ezután [regisztrálja a hangprofilt](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/createenrollment). Újra be kell állítania a hangmintákat, amelyek összesen 20 másodperces hangot tartalmaznak. Ezeknek a mintáknak nem kell jelszót tartalmazniuk.
...
A befejezéshez [törölje a hangprofilt](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/deleteprofile).
