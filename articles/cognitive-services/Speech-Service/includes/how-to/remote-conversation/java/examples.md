...
Az itt látható kód esetében szükség van a **távoli beszélgetések 1.8.0 verziójára**, amely csak a Java (1.8.0 vagy újabb verzió) esetén támogatott Windowson és Linuxon. 

### <a name="obtaining-the-async-conversation-client-sdk"></a>Az aszinkron beszélgetés ügyféloldali SDK beszerzése

A **távoli beszélgetések** beszerzéséhez szerkessze a pom.xml fájlt az alábbiak szerint.

1. A fájl végén a záró címke előtt `</project>` hozzon létre egy elemet, amely a `repositories` Speech SDK Maven-tárházára hivatkozik:
