...
Az aszinkron átírás végrehajtása előtt el kell küldenie a hang-és beszélgetés-átírási szolgáltatást a Microsoft kognitív Speech Client SDK (1.13.0 vagy újabb verzió) használatával.

Ez a példa azt mutatja be, hogyan hozható létre egy beszélgetési átirat a csak aszinkron üzemmódhoz. Ahhoz, hogy hangot lehessen továbbítani az átiratok számára, [a SPEECH SDK-val valós időben](../../../../how-to-use-conversation-transcription.md)bevezeti a hangos adatfolyam-kódot, amely a beszélgetési beszélgetésekből származik. 
...
Telepítse a **Microsoft. CognitiveServices. Speech. Remoteconversation verziót 1.13.0 vagy újabb verzióra** a NuGet-n keresztül.
