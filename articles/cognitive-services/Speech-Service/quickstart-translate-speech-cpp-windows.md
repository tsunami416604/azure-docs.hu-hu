...
Rövid útmutatók érhetők el is [beszédfelismerés](quickstart-cpp-windows.md) és [szöveg-hang transzformációs](quickstart-text-to-speech-cpp-windows.md).
