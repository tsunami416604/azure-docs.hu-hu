...
A rangsorolási kérelem teljesítéséhez a program megkéri a felhasználó beállításait, hogy hozzon létre tartalmakat. A folyamat létrehozhat olyan tartalmat, amely kizárható a műveletekből, `excludeActions`ként látható. A rangsorolási kérelemnek szüksége van a [műveletekre](../concepts-features.md#actions-represent-a-list-of-options) és azok szolgáltatásaira, a LicenseManager CurrentContext szolgáltatásaira, a excludeActions és egy egyedi rangú esemény-azonosítóra, hogy megkapja a rangsorolt választ.
