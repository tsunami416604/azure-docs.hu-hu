...
A következő kód hurkokat mutat be a felhasználónak a parancssorban való megadására, az információknak a személyre szabására való kiválasztásához, az ügyfélnek a listából való választásához, majd a jutalom pontszámának elküldéséhez Személyre szabhatja, hogy a szolgáltatás milyen jól működött a kiválasztásában.
