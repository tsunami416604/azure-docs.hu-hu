...
* [Kubernetes](https://kubernetes.io/) fürtben telepített [Azure Stack](https://docs.microsoft.com/azure-stack/operator/). További információkért lásd: [Kubernetes üzembe helyezése az Azure Stackhez](https://docs.microsoft.com/azure-stack/user/azure-stack-solution-template-kubernetes-deploy).
