---
title: 'Oktatóanyag: automatikus javaslatok eredményeinek beszerzése Bing Autosuggest API használatával'
titleSuffix: Azure Cognitive Services
description: Ebben az oktatóanyagban egy olyan weboldalt fog felépíteni, amely lehetővé teszi a felhasználóknak a Bing Autosuggest API lekérdezését és a lekérdezési eredmények megjelenítését.
...
Ahhoz, hogy követni tudja az oktatóanyagot, szüksége lesz egy előfizetői azonosítóra a Bing Autosuggest API-hoz. Ha még nem rendelkezik ilyennel, [hozzon létre egy Bing AutoSuggest erőforrást](https://portal.azure.com/#create/Microsoft.CognitiveServicesBingAutosuggest-v7) a Azure Portalban.
...
Hozzon létre egy szövegmezővel rendelkező HTML-űrlapot. Kezelje az `oninput` eseményt, és hívja meg a `bingAutosuggest()` függvényt, és adja át a szövegmező tartalmát és a Bing AutoSuggest API kulcsot.
