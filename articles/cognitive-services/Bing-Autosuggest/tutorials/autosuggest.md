...
Hozzon létre egy szövegmezővel rendelkező HTML-űrlapot. Kezelje `oninput` az eseményt, és `bingAutosuggest()` hívja meg a függvényt, és adja át a szövegmező tartalmát és a Bing AutoSuggest API kulcsot.
