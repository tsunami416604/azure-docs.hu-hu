...
Hozzon létre egy szövegmezővel rendelkező HTML-űrlapot. Kezelje a `oninput` eseményt, és hívja meg a `bingAutosuggest()` függvényt, és adja át a szövegmező tartalmát és a Bing Autosuggest API kulcsot.
