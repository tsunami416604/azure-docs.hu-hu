...
> [!IMPORTANT]
> Ez a rövid útmutató a Form felismerő v 1.0 API-t használja. Ha az előfizetése a `West US 2` vagy `West Europe` régióban található, akkor helyette a v[2,0 API](./curl-train-extract.md) -t kell követnie.
