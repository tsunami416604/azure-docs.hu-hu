...
description: Ebben a rövid útmutatóban miniatűrt fog létrehozni egy képből a Computer Vision és a JavaScript használatával a Cognitive Servicesben.
...
ms.locfileid: "43770234"
---
# <a name="quickstart-generate-a-thumbnail---rest-javascript"></a>Rövid útmutató: Miniatűr létrehozása – REST, JavaScript
...
1. Másolja és mentse egy fájlba az alábbi szöveget, például `thumbnail.html` néven.
...
1. Kattintson a `Generate thumbnail` gombra.
