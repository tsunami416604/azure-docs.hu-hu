...
description: Ebben a rövid útmutatóban miniatűrt fog létrehozni egy képből a Computer Vision és a Java használatával a Cognitive Servicesben.
...
ms.locfileid: "43770386"
---
# <a name="quickstart-generate-a-thumbnail---rest-java"></a>Rövid útmutató: Miniatűr létrehozása – REST, Java
...
A sikeres válasz bináris formátumban tartalmazza a miniatűrképet. Ha a kérés meghiúsul, a válasz tartalmaz egy hibakódot és egy üzenetet, amely segít meghatározni a hiba okát. Az alábbi szöveg egy példa a sikeres válasz tartalmára.
