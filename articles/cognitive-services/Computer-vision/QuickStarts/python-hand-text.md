...
ms.locfileid: "67603563"
---
# <a name="quickstart-extract-handwritten-text-using-the-computer-vision-rest-api-and-python"></a>Gyors útmutató: A Computer Vision REST API és a Python használatával kézzel írt szöveg kinyerése
