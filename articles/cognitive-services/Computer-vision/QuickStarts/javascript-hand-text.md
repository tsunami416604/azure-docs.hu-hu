...
1. Szükség esetén cserélje le a `value` vezérlő attribútumának értékét `inputImage` egy másik olyan rendszerkép URL-címére, amelyből szöveget szeretne kinyerni.
