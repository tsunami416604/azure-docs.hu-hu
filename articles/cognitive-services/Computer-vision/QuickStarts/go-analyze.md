...
ms.locfileid: "67605963"
---
# <a name="quickstart-analyze-a-remote-image-using-the-computer-vision-rest-api-with-go"></a>Gyors útmutató: A Computer Vision REST API használatával a Go egy távoli kép elemzése
