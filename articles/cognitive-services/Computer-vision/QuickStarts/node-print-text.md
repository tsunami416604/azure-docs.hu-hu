...
ms.locfileid: "67604298"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-computer-vision-rest-api-and-nodejs"></a>Gyors útmutató: A Computer Vision REST API és a Node.js használatával (OCR) nyomtatott szöveg kinyerése
