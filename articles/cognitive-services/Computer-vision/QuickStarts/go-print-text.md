---
title: OCR a Computer Vision API és a Go használatával – rövid útmutató | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Ebben a rövid útmutatóban nyomtatott szöveget fog kinyerni egy képből a Computer Vision és a Go használatával a Cognitive Servicesben.
...
ms.locfileid: "43770257"
---
# <a name="quickstart-extract-printed-text-ocr---rest-go"></a>Rövid útmutató: Nyomtatott szöveg kinyerése (OCR) – REST, Go
...
1. Állítsa össze a fájlt (például: `go build get-printed-text.go`).
1. Futtassa a fájlt (például: `get-printed-text`).
