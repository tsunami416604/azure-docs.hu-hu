---
title: 'Gyors útmutató: nyomtatott szöveg kinyerése – REST, go'
...
ms.locfileid: "95014101"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-computer-vision-rest-api-with-go"></a>Gyors útmutató: nyomtatott szöveg (OCR) kinyerése a Computer Vision REST API a go használatával

> [!NOTE]
> Angol nyelvű szöveg kinyerése esetén érdemes lehet az új [olvasási műveletet](../concept-recognizing-text.md)használni. Elérhető egy [Go](../quickstarts-sdk/client-library.md?pivots=programming-language-go%253fpivots%253dprogramming-language-go#call-the-read-api) -gyors útmutató.
