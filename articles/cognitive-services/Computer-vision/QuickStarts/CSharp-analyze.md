---
title: Helyi kép elemzése a Computer Vision API és a C# használatával – rövid útmutató | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Ebben a rövid útmutatóban egy helyi képet fog elemezni a Computer Vision és a C# használatával a Cognitive Servicesben.
...
ms.locfileid: "43770130"
---
# <a name="quickstart-analyze-a-local-image---rest-c35"></a>Rövid útmutató: Helyi kép elemzése – REST, C&#35;

Ebben a rövid útmutatóban egy helyi képet fog elemezni vizuális jellemzők kinyeréséhez a Computer Visionnel.
...
> [A Computer Vision használata C# nyelvvel](../Tutorials/CSharpTutorial.md)
