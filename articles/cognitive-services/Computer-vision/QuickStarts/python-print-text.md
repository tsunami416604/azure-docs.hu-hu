---
title: OCR Computer Vision Python használatával – rövid útmutató | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Ebben a rövid útmutatóban nyomtatott szöveget fog kinyerni egy képből a Computer Vision és a Python használatával a Cognitive Servicesben.
...
ms.locfileid: "43770090"
---
# <a name="quickstart-extract-printed-text-ocr---rest-python"></a>Rövid útmutató: Nyomtatott szöveg kinyerése (OCR) – REST, Python
...
## <a name="extract-printed-text"></a>Nyomtatott szöveg kinyerése
