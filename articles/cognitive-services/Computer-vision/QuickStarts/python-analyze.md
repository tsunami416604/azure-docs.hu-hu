...
1. Mentse a kódot fájlként `.py` kiterjesztéssel. Például: `analyze-image.py`.
1. Nyisson meg egy parancssort.
1. Amikor a rendszer kéri, a `python` paranccsal futtassa a mintát. Például: `python analyze-image.py`.
