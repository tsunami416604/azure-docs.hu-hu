---
title: 'Gyors útmutató: nyomtatott szöveg kinyerése – REST, JavaScript'
...
1. Igény szerint cserélje le az `value` vezérlő `inputImage` attribútumának értékét egy másik elemzendő kép URL-címére.
