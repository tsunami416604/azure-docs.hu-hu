---
title: OCR a Computer Vision API és a Ruby használatával – rövid útmutató | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Ebben a rövid útmutatóban nyomtatott szöveget fog kinyerni egy képből a Computer Vision és a Ruby használatával a Cognitive Servicesben.
...
ms.locfileid: "43770377"
---
# <a name="quickstart-extract-printed-text-ocr---rest-ruby"></a>Rövid útmutató: Nyomtatott szöveg kinyerése (OCR) – REST, Ruby
