...
|<a name="error-subcode" />Alkód|A hibát azonosító hibakód. Ha `code` például a InvalidRequest, `subCode` ParameterInvalid vagy ParameterInvalidValue lehet. |Sztring|  
