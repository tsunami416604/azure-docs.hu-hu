...
2. A Program.cs fájl tartalmát cserélje le a következő kódra.
...
6. Írja be parancssorba egy kép elérési útját.
...
> [Oktatóanyag: Első lépések a Face API-val C#-ban](../Tutorials/FaceAPIinCSharpTutorial.md)
