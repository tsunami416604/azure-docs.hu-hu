...
Az anomáliák Kiderítő fogalmait az [áttekintést](../../overview.md) ismertető cikkben tekintheti meg.
...
## <a name="detect-anomalies-for-an-entire-series"></a>Egy egész sorozaton észlelt rendellenességek észlelése

A parancssorban futtassa a következő parancsot. A következő értékeket kell beszúrnia a parancsba.
- Az anomália-detektor szolgáltatás előfizetési kulcsa.
- Az anomália-detektor végpontjának címe. 
- Az idősoros adatsorozatok érvényes JSON-fájlja az anomáliák teszteléséhez. Ha nem rendelkezik saját fájllal, létrehozhat egy sample.jsa fájlból a [kérelem szövegtörzsének mintájában](https://westus2.dev.cognitive.microsoft.com/docs/services/AnomalyDetector/operations/post-timeseries-entire-detect).
...
Példa az összes kitöltött értékre:
...
Ha az előfeltételekből használta a mintaadatok közül, a 200-as választ kell kapnia a következő eredményekkel:
...
További információ: [anomáliák észlelése – Rest-hivatkozás](https://westus2.dev.cognitive.microsoft.com/docs/services/AnomalyDetector/operations/post-timeseries-entire-detect).
