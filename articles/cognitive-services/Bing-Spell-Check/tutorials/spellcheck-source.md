...
ms.locfileid: "55869228"
---
# <a name="tutorial-single-page-web-app"></a>Oktatóanyag: Egyoldalas webalkalmazás

Ez az [egyoldalas alkalmazást bemutató oktatóanyagban](spellcheck.md) ismertetett teljes forráskód a Bing Spell Check API-hoz. Az alkalmazás futtatásához másolja a forráskódot egy szövegszerkesztőbe, és mentse el a fájlt `spellcheck.html` néven. Ezután nyissa meg a mentett fájlt a böngészőben.
