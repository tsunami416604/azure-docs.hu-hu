...
Annak érdekében, hogy követni tudja az oktatóanyagot, szüksége lesz egy előfizetői azonosítóra a Bing Spell Check API-hoz. Ha még nem rendelkezik ilyennel, a következőkre lesz szüksége:

* Azure-előfizetés – [hozzon létre egyet ingyen](https://azure.microsoft.com/free/cognitive-services/)
* [Egy Bing Spell Check erőforrás](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSpellCheck-v7)
...
Hozzon létre egy szövegmezővel rendelkező HTML-űrlapot. Kezelje az `onsubmit` eseményt, és hívja meg a bingSpellCheck függvényt, és adja át a szöveg és a Bing Spell Check API kulcs tartalmát.
