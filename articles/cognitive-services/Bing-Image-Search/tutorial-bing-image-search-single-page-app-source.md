...
ms.locfileid: "35346974"
---
# <a name="tutorial-single-page-web-app"></a>Oktatóanyag: Egyoldalas webalkalmazást

Ez az a teljes forráskód ismertet a [alkalmazás oktatóanyag](tutorial-bing-image-search-single-page-app.md) Bing kép kereséshez. Az alkalmazás futtatásához, a forrás kódot bemásolhatja a Jegyzettömbben vagy más szövegszerkesztőben, és mentse a fájt `bing.html`. Ezután nyissa meg a mentett fájlt a Microsoft Edge vagy egy másik népszerű böngésző.
