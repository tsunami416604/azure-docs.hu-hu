...
1. Ezután nyissa meg a _MainPage.XAML.cs_ , és `_ourOnnxFileName` módosítsa az értékét a ONNX-fájl nevére.
1. A projekt `F5` létrehozásához és futtatásához használja a következőt:.
