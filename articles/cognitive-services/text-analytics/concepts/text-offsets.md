...
A többnyelvű és Emoji támogatás olyan Unicode-kódolást eredményezett, amely egynél több [adatpontot](https://wikipedia.org/wiki/Code_point) használ egy megjelenített karakter (Graféma) megjelenítéséhez. Például a hangulatjelek, mint a 🌷 és a 👍 több karaktert is használhatnak a vizualizációs attribútumok (például a bőr tónusa) további karakterekkel való összeállításához. Hasonlóképpen, a hindi szó `अनुच्छेद` kódolása öt betű és három kombináció.
