---
title: 'Gyors útmutató: Project answer keresési entitás lekérdezése'
...
**Lekérdezés:** A következő lekérdezés a veszélyeztetett fajok listáját keresi:
...
**Válasz** A válasz táblázatos értékekként formázott listát tartalmaz:
```
  "facts": {
