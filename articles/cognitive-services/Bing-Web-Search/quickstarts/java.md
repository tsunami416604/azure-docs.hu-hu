---
title: Hívás-válasz - Java gyors üzembe helyezés az Azure kognitív szolgáltatások, a Bing webes keresés API |} Microsoft Docs
...
ms.locfileid: "35347559"
---
# <a name="call-and-response-your-first-bing-web-search-query-in-java"></a>Hívás-válasz: a Java első Bing keresést a lekérdezés
...
3. A megadott kód hozzáadása nevű fájlba `BingWebSearch.java`.
