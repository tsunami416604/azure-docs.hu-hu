...
Végpont: A fejlécek, paraméterek, piaci kódok, válaszobjektumok, hibák és további részleteiért lásd: a [a Bing webes-API 7-es verziója](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-web-api-v7-reference) hivatkozást.
