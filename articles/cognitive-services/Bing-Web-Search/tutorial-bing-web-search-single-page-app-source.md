---
title: Bing webes keresés egyoldalas webalkalmazást (forráskód) |} Microsoft Docs
description: Az oktatóanyag bemutatja, hogyan használja a webes Bing keresési API egy egyoldalas webalkalmazást forráskódja.
...
ms.locfileid: "35347071"
---
# <a name="tutorial-single-page-web-app"></a>Oktatóanyag: Egyoldalas webalkalmazást

Ez az a teljes forráskód ismertet a [alkalmazás oktatóanyag](tutorial-bing-web-search-single-page-app.md) a Bing webes keresés. Az alkalmazás futtatásához, a forrás kódot bemásolhatja a Jegyzettömbben vagy más szövegszerkesztőben, és mentse a fájt `bing.html`. Ezután nyissa meg a mentett fájlt a Microsoft Edge vagy egy másik népszerű böngésző.
