...
A miniatűr méretét az `<img>` címke, illetve a miniatűr URL-címének `h` és `w` mezője is használja. A Bing adja vissza egy [miniatűr](../bing-web-search/resize-and-crop-thumbnails.md) , pontosan ezt a méretet.
