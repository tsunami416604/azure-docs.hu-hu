...
* Lásd: [az első Language Understanding Intelligent Services (LUIS) alkalmazás létrehozása] [ luis-get-started-create-app] LUIS-alkalmazások létrehozása rövid leírását.
