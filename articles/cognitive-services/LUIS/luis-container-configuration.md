...
|Igen|[Billing](#billing-setting)|Adja meg a végpont a szolgáltatás-erőforrás URI-ját az Azure-ban.|
|Igen|[Eula](#eula-setting)| Azt jelzi, hogy Ön már elfogadta a licencet, a tároló.|
...
|Igen|[Fluentd](#mount-settings)|Olvasási és írási adatok tárolót a gazdaszámítógép és a tároló található vissza gazdaszámítógéphez.|
