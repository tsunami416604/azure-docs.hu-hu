---
title: 'Rövid útmutató: Language Understanding (LUIS) a .NET-hez készült ügyféloldali kódtár készítése'
titleSuffix: Azure Cognitive Services
description: Ismerkedjen meg a .NET-hez készült LUIS ügyféloldali kódtár ezzel a rövid útmutatóval. Az alábbi lépéseket követve telepítheti a csomagot, és kipróbálhatja az alapszintű feladatokhoz tartozó példa kódját.
...
ms.locfileid: "75447745"
---
# <a name="quickstart-language-understanding-luis-authoring-2x-client-library-for-net"></a>Rövid útmutató: Language Understanding (LUIS) authoring 2. x ügyféloldali kódtár a .NET-hez

Ismerkedjen meg a .NET-hez készült 2. x ügyféloldali kódtár Language Understanding (LUIS) authoring szolgáltatásával. Az alábbi lépéseket követve telepítheti a csomagot, és kipróbálhatja az alapszintű feladatokhoz tartozó példa kódját.  Language Understanding (LUIS) lehetővé teszi, hogy egyéni gépi tanulási intelligenciát alkalmazzon egy felhasználó társalgási, természetes nyelvi szövegére az általános jelentés megbecslése érdekében, és a vonatkozó, részletes információk kiolvasását.
