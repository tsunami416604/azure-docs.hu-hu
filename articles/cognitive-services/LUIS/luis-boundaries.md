...
description: Ez a cikk az Azure Cognitive Services Language Understanding (LUIS) ismert korlátait tartalmazza. LUIS több határt is tartalmaz. A modell határain belüli vezérlőelemek, entitások és szolgáltatások megjelölése a LUIS-ben. Kvóta korlátai a kulcs típusa alapján. A billentyűzet kombinációja a LUIS webhelyet vezérli.
...
## <a name="model-boundaries"></a>Modell határai
...
| [Reguláris kifejezések entitásai](./luis-concept-entity-types.md)|20 entitás<br>500 karakter max. /reguláris kifejezési entitás mintája|
...
| [Verzió neve][luis-how-to-manage-versions] | 10 karakter az alfanumerikus és a pont (.) értékre korlátozva |
...
|S0 – alapszintű csomag|-|50/másodperc|A LUIS-végpont lekérdezése|
...
|[Beszédfelismerési integráció](../speech-service/how-to-recognize-intents-from-speech-csharp.md)|-|1000 végponti kérelmek egységenkénti áron|A kimondott szöveg teljes szöveggé konvertálása és a LUIS eredményeinek visszaadása|
