...
A Cognitive Services két természetes nyelvi feldolgozási szolgáltatást biztosít, [a Language Understanding](what-is-luis.md) és a [QnA Maker](../qnamaker/overview/overview.md)szolgáltatást, amelyek mindegyike más célt szolgál. Tudja meg, mikor kell használni az egyes szolgáltatások, és hogyan bók egymást. 
...
* [Luis](luis-concept-best-practices.md) gyakorlati tanácsok
