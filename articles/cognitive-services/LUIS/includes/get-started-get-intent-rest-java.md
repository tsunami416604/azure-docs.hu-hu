...
A Java használatával lekérdezheti az előrejelzési végpont beolvasása [API](https://aka.ms/luis-apim-v3-prediction) -t az előrejelzés eredményének lekéréséhez.
...
1. A Java-program fordítása parancssorból: 
