...
Hívja meg a [példákat. vegye fel](/javascript/api/@azure/cognitiveservices-luis-authoring/examples?view=azure-node-lates) az alkalmazás azonosítóját, a Version ID-t és a példát.
