...
1. Az importált alkalmazásnak szándéka van `OrderPizza` . Válassza ki ezt a szándékot, és vegyen fel néhány hosszúságú kimondott szöveg új kéreg-típusokkal:
...
1. Az **entitások listájának létrehozása** lapon adja meg az egyes kanonikus nevek kanonikus nevét és szinonimáit, majd válassza a **Létrehozás**lehetőséget.
    ...
    > [!div class="mx-imgBorder"]
    > ![Képernyőkép az elemek listázásához az entitáshoz](media/luis-quickstart-intent-and-list-entity/add-pizza-crust-items-list-entity.png)
