...
Megfelelő LUIS portálok három szerzői régiók támogatottak. A LUIS alkalmazás közzététele több régióban, régiónként legalább egy kulcs szükséges. 

<a name="luis-website"></a>

## <a name="luis-authoring-regions"></a>A LUIS-létrehozási régiók
Nincsenek három LUIS szerzői portál, régió alapján. Hozhat létre és közzététele ugyanabban a régióban kell. 

|LUIS|Szerzői műveletek terület|Az Azure-régió neve|
|--|--|--|
...
## <a name="publishing-regions-and-azure-resources"></a>Közzétételi régiók és az Azure-erőforrások
Az alkalmazás közzé van téve a LUIS erőforrások a LUIS portálon hozzá társított összes régióba. Például a létrehozott alkalmazás [www.luis.ai][www.luis.ai], ha létrehoz egy LUIS vagy a Cognitive Services-szolgáltatás-erőforrást az **westus** és [adja hozzá az alkalmazás erőforrásai ](luis-how-to-azure-subscription.md), az alkalmazás közzé van téve az adott régióban. 
...
## <a name="publishing-regions-are-tied-to-authoring-regions"></a>Közzétételi régiók szerzői régióban vannak társítva.
...
## <a name="europe-publishing-regions"></a>Közzétételi Európai régióban
...
## <a name="australia-publishing-regions"></a>Közzététel az ausztráliai régiókban
...
## <a name="publishing-to-other-regions"></a>Más régiókban való közzététel

Közzéteszi a más régiókban, létre kell hozni a LUIS Apps alkalmazások [ https://www.luis.ai ](https://www.luis.ai) csak. 

## <a name="other-publishing-regions"></a>Közzétételi régiók
...
A LUIS jelenleg 2 végpontok rendelkezik: egy, a szerzői és egy lekérdezési előrejelzési elemzésre.
...
## <a name="failover-regions"></a>Feladatátvételi régióban

Minden egyes régió a feladatátvétel egy másodlagos régióba tartozik. Európa meghiúsul, Európa és Délkelet belül több mint átadja a feladatokat Ausztrália belül.
