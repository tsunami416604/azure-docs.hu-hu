...
|Buy a ticket from New York to London on March 5|Location.Origin<br>Location.Destination<br>Prebuilt datetimeV2|New York<br>London<br>2018. március 5.|
...
|Kimondott szöveg|Intent predicted|Entities extracted|Magyarázat|
|--|--|--|--|
|Segítség|help|-|Nothing to extract.|
