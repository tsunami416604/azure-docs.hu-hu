...
1. A **Bot Service** szolgáltatásban adja meg a szükséges adatokat:
    ...
    |Előfizetést|Az előfizetés, amelyben létre szeretné hozni a robotot.|Az Ön elsődleges előfizetése.
...
1. A robot-emulátorban adja meg a `Book a flight from Seattle to Berlin tomorrow`t, és ugyanazt a választ kapja meg az alapszintű robotnál, ahogy az előző szakaszban a **webes csevegésben kapott tesztben** .
