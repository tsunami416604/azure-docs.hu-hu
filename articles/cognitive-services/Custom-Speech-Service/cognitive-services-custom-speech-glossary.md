...
Az akusztikai modell egy besoroló, amely rövid hangrészleteket egy bizonyos számú fonéma vagy hangegység közül eggyel felcímkéz egy adott nyelven. Az angol „speech” (beszéd) szó például négy fonémából áll: „sz, p, í, cs”. Ezek a besorolások másodpercenként 100-szor végrehajtott a rendelés:
...
A nyelvi modell szósorozatok valószínűségi eloszlása. A nyelvi modell segíti a rendszert abban, hogy válasszon hasonló hangzású szószekvenciák maguk valószínűségét alapján

## <a name="m"></a>M

## <a name="n"></a>N

### <a name="normalization"></a>Normalizálási

Normalizálási (szöveg): Így a szöveg (azaz beszédátírási) átalakítása egy szabványos, egyértelmű űrlapra, a rendszer által is olvasható.
