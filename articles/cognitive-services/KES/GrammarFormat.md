...
|----|----|----|----|
| String | EQ | Karakterlánc pontos egyezés | egyenlő |
| String | starts_with | Előtag-egyeztetést karakterlánc | starts_with |
