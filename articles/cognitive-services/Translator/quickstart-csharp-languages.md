...
## <a name="set-the-host-name-and-path"></a>Állítsa be a gazdagép nevét és elérési útja
...
Nyomtatása válasz "Viszonylag nyomtatási" (a válasz formázás), adja hozzá ezt a funkciót a Program osztályhoz:
```
