---
title: 'Rövid útmutató: Szöveg nyelvének felismerése, Node.js – Translator Text API'
...
ms.locfileid: "50248761"
---
# <a name="quickstart-use-the-translator-text-api-to-detect-text-language-with-nodejs"></a>Rövid útmutató: A Translator Text API használata szöveg nyelvének felismerésére a Node.js-sel

Ebből a rövid útmutatóból megtudhatja, hogyan ismerheti fel egy adott szöveg nyelvét a Node.js és a Translator Text REST API használatával.
