---
title: 'Translator Text: Alternatív fordítások megkeresése a PHP használatával | Microsoft Docs'
titleSuffix: Microsoft Cognitive Services
description: Ebben a rövid útmutatóban a kifejezések alternatív fordításait és példáit keresi meg a szövegkörnyezetben a Translator Text API segítségével és a PHP használatával a Cognitive Servicesben.
...
ms.locfileid: "43769696"
---
# <a name="quickstart-find-alternate-translations-and-usage-with-php"></a>Rövid útmutató: Alternatív fordítások és használat lekérése a PHP használatával
