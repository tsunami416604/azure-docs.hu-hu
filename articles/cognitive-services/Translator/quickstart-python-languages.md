...
ms.locfileid: "49644725"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-python"></a>Rövid útmutató: Támogatott nyelvek lekérése a Translator Text REST API használatával (Python)
