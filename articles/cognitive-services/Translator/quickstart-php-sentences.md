---
title: 'Rövid útmutató: Mondathosszok lekérése, PHP – Translator Text API'
...
ms.locfileid: "49645390"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-php"></a>Rövid útmutató: Mondathosszok lekérése a Translator Text REST API használatával (PHP)
