---
title: 'Rövid útmutató: Szöveg nyelvének azonosítása, PHP – Translator Text API'
...
ms.locfileid: "49649451"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-php"></a>Rövid útmutató: Szöveg nyelvének azonosítása a Translator Text REST API (PHP) használatával
