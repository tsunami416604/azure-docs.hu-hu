...
Hozzon létre egy új projektet a kedvenc IDE vagy szerkesztő használatával, vagy hozzon létre egy új mappát az asztalon. Másolja ezt a kódrészletet a projektbe/mappába egy fájlba, amelynek neve `alt-translations.js`.
