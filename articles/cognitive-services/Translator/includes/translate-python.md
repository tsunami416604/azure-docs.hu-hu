...
Hozzon létre egy új Python-projektet a kedvenc IDE-környezetében vagy szerkesztőjében. Ezután másolja a következő kódrészletet egy `translate-text.py` nevű fájlba a projektjében. Győződjön meg arról, hogy az IDE-értelmező a Python megfelelő verziójára hivatkozik, hogy elkerülje a könyvtárak felismerését.
...
A fordítószöveg globális végpontja `endpoint`a . A `path` tulajdonság a `translate` útvonalat állítja be, és meghatározza, hogy a 3-as API-verziót szeretnénk használni.
