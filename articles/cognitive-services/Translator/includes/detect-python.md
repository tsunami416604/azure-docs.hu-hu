...
A Translator Text globális végpont beállítása `base_url`. A `path` tulajdonság a `detect` útvonalat állítja be, és meghatározza, hogy a 3-as API-verziót szeretnénk használni.
