...
Hozzon létre egy új go-projektet a kedvenc IDE/szerkesztőjével vagy az asztalon lévő új mappával. Ezután másolja ezt a kódrészletet a projektbe vagy mappájába egy nevű `dictionaryLookup.go`fájlba.
