---
title: 'Rövid útmutató: Mondathosszok lekérése, Ruby – Translator Text API'
titleSuffix: Azure Cognitive Services
description: Ebben a rövid útmutatóban kideríti egy szövegben a mondatok hosszát a Translator Text API és a Ruby segítségével.
...
ms.locfileid: "49644708"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-ruby"></a>Rövid útmutató: Mondathosszok lekérése a Translator Text REST API használatával (Ruby)
