---
title: 'Translator Text: Alternatív fordítások megkeresése a Python használatával | Microsoft Docs'
titleSuffix: Microsoft Cognitive Services
description: Ebben a rövid útmutatóban a kifejezések alternatív fordításait és példáit keresi meg a szövegkörnyezetben a Translator Text API segítségével és a Python használatával a Cognitive Servicesben.
