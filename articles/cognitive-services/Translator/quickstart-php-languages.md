---
title: 'Rövid útmutató: Támogatott nyelvek lekérése, PHP – Translator Text API'
titleSuffix: Azure Cognitive Services
description: Ebben a rövid útmutatóban lekéri a fordításhoz, átíráshoz és szótárban való kereséshez támogatott nyelvek, valamint példák listáját a Translator Text API és PHP segítségével.
...
ms.locfileid: "49647249"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-php"></a>Rövid útmutató: Támogatott nyelvek lekérése a Translator Text REST API (PHP) használatával
