...
ms.locfileid: "50419384"
---
# <a name="quickstart-transliterate-text-with-the-translator-text-rest-api-java"></a>Rövid útmutató: Szöveg átírása a Translator Text REST API használatával (Java)
