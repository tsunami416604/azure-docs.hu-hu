...
<center>![設定](./media/multi-factor-authentication-end-user-signin-app-notify/notify.png)</center>

<li>請接聽電話並按驗證鍵。</li>

<center>![設定](./media/multi-factor-authentication-end-user-signin-app-notify/phone.png)</center>
