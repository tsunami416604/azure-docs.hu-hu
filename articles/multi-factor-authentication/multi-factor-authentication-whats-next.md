...
<center>![雲端](./media/multi-factor-authentication-whats-next/fraud.png)</center>
...
<center>![雲端](./media/multi-factor-authentication-whats-next/report1.png)</center>
...
<center>![雲端](./media/multi-factor-authentication-whats-next/create2.png)</center>
...
<center>![雲端](./media/multi-factor-authentication-whats-next/custom2.png)</center>

<li>在 [設定：新增語音訊息] 頁面上，按一下 [管理聲音檔]。</li>

<center>![雲端](./media/multi-factor-authentication-whats-next/custom3.png)</center>

<li>在 [設定：聲音檔] 頁面上，按一下 [上傳聲音檔]。</li>

<center>![雲端](./media/multi-factor-authentication-whats-next/custom4.png)</center>
...
<center>![雲端](./media/multi-factor-authentication-whats-next/custom5.png)</center>
...
同盟|<li>所有同盟使用者-所有同盟的使用者登入從組織內部將略過多重要素驗證使用 AD FS 所發出的宣告。</li><li>特定的 IP 位址範圍 – 系統管理員可以指定 IP 位址範圍，可以略過多重要素驗證的使用者，從公司內部網路登入。
...
|受信任的 Ip enabled|信任的 Ip 已停用
:------------- | :------------- | :------------- | 
深入了解 corpnet|瀏覽器流量多因素驗證，而不需要。 |瀏覽器流程需要多因素驗證
|對於豐富型用戶端應用程式，如果使用者尚未建立任何應用程式密碼，一般密碼都將運作。 一旦建立應用程式密碼，會需要應用程式密碼。 |豐富型用戶端應用程式所需的應用程式密碼
外部 corpnet|瀏覽器流程需要多因素驗證。 |瀏覽器流程需要多因素驗證。
|對於豐富型用戶端應用程式，應用程式需要使用密碼。 |對於豐富型用戶端應用程式，應用程式所需的密碼。
...
<li>在 [服務設定] 頁面之 [信任的 IP] 下方，選取以下任一項：
<ul>
<li>對於來自內部網路之同盟使用者所發出的要求 – 所有從公司網路登入同盟使用者，都能使用 AD FS 發行的宣告略過 Multi-Factor Authentication。 
...
<center>![雲端](./media/multi-factor-authentication-whats-next/trustedips.png)</center>
...
:------------- | :------------- | :------------- 
|<ul><li>驗證的第 1 個因素是在內部</li><li>第 2 個因素是由雲端識別身分執行的電話式方法。</li>|<ul><li>系統管理員和使用者可以使用應用程式密碼來登入。
...
>[AZURE.WARNING]  應用程式密碼無法在混合式環境，讓用戶端與內部通訊，並定域機組自動探索端點。
>
...
<center>![雲端](./media/multi-factor-authentication-whats-next/app2.png)</center>
...
<center>![雲端](./media/multi-factor-authentication-whats-next/myapp.png)</center>
...
> [AZURE.NOTE] 這項功能會實作為瀏覽器 cookie 快取。 如果未啟用瀏覽器 Cookie，它便無法運作。
