...
<center>![雲端](./media/multi-factor-authentication-get-started-cloud/cloud2.png)</center>
...
3. 在 [Active Directory] 頁面頂端，選取 [Multi-Factor Authentication Provider]。 然後在底部，按一下 [ **新增**。
...
<center>![雲端](./media/multi-factor-authentication-get-started-cloud/provider.png)</center>
...
<center>![雲端](./media/multi-factor-authentication-get-started-cloud/license.png)</center>
...
已啟用 |使用者已註冊 Multi-Factor Authentication。|編號  它們會繼續運作，直到完成註冊程序。|使用者已啟用，但尚未完成註冊程序。 系統會提示他們在下次登入時完成程序。
...
<center>![雲端](./media/multi-factor-authentication-get-started-cloud/user.png)</center>
