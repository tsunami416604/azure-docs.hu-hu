...
2. 按一下 [表單架構] 索引標籤。
3. 按一下 [新增... 按鈕。
<center>![安裝程式](./media/multi-factor-authentication-get-started-adfs-adfs2/setup1.png)</center>
...
<center>![安裝程式](./media/multi-factor-authentication-get-started-adfs-adfs2/manual.png)</center>
...
<center>![安裝程式](./media/multi-factor-authentication-get-started-adfs-adfs2/ldap1.png)</center>
20. 按一下 [編輯... 按鈕。
...
<center>![安裝程式](./media/multi-factor-authentication-get-started-adfs-adfs2/ldap2.png)</center>
...
<center>![安裝程式](./media/multi-factor-authentication-get-started-adfs-adfs2/reg.png)</center>
...
<center>![安裝程式](./media/multi-factor-authentication-get-started-adfs-adfs2/noproxy.png)</center>
8. 按一下 [確定] 按鈕。
...
<center>![安裝程式](./media/multi-factor-authentication-get-started-adfs-adfs2/trusted.png)</center>
