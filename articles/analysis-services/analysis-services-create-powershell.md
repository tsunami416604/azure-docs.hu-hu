...
Jelentkezzen be az Azure-előfizetéshez használatával a [Connect-AzureRmAccount](/powershell/module/azurerm.profile/connect-azurermaccount) parancsot. Kövesse a képernyőn megjelenő utasításokat.
...
[Kezelheti az Azure Analysis Services a PowerShell-lel](analysis-services-powershell.md)
[az SSDT a modell rendszerbe állítása](analysis-services-deploy.md)
[modell létrehozása az Azure-portálon](analysis-services-create-model-portal.md)
