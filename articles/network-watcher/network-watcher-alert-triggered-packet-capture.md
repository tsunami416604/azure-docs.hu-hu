...
1. Válassza a **Function app settings** > **Ugrás a**következőre: app Service Editor.
...
1. Nyissa meg a Function alkalmazást. Ezután válassza a **Function app settings** > az **Alkalmazásbeállítások konfigurálása**lehetőséget.
