...
Most, hogy a fordítás során futtassa a parancsmagot, és futtassa azt a `Test-AzureRmNetworkWatcherIPFlow` parancsmag segítségével tesztelheti a forgalmat. A jelen példában használjuk az első IP-cím első hálózati adapteren
