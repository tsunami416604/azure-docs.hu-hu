...
| UserDrivenUpdate | Ez a hiba akkor fordul elő, ha egy felhasználó frissítése folyamatban van. A frissítés lehet átméretezési művelet. | Nem |
| VipUnResponsive | Ez a hiba akkor fordul elő, ha az átjáró elsődleges példánya nem érhető el egy állapot-mintavételi hiba miatt. | Nem |
