...
4. A konfigurációk megkezdése után elindíthatja a Logstash a flow-naplók olvasásának megkezdéséhez a következő `sudo systemctl start logstash.service`paranccsal:.
