...
2. A **create Web App** ( **alapismeretek** ) lapon adja meg vagy válassza ki a következő adatokat:
    ...
    | Futásidejű verem | Válassza a **.net Core 3,1 (LTS)** elemet. |
    | Operációs rendszer | Válassza a **Windows**lehetőséget. |
    | Régió | Válassza ki az **USA keleti** régióját |
    | **App Service-csomag** |  |
    | Windows-csomag (USA keleti régiója) | Válassza az **Új létrehozása** lehetőséget. </br> Adja meg a **MyServicePlan** **nevet**. |
