...
4. A **Kapcsolódás a kiszolgálóhoz**lapon adja meg vagy válassza ki az alábbi adatokat:
    ...
    | Felhasználónév | Adja meg a felhasználónevet @no__t – 0, amely az SQL Server létrehozásakor van megadva. |
