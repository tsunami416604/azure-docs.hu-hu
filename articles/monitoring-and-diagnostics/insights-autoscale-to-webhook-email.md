---
title: Használja az automatikus skálázási e-mailek és a webhook riasztási értesítések küldéséhez
...
| properties |igen |értéket kell megadni {} vagy a kulcs-érték pár is tartalmazhat. |
...
| resourceGroupName |Igen |A célerőforrás alatt méretezett erőforráscsoport neve |
| resourceName |Igen |A cél erőforráson alatt méretezett neve |
| resourceType |Igen |A három támogatott értékek: "microsoft.classiccompute/domainnames/slots/roles" - szerepköröket, a "microsoft.compute/virtualmachinescalesets" - virtuálisgép-méretezési csoportok, és a "Microsoft.Web/serverfarms" - webalkalmazás felhőalapú szolgáltatás |
