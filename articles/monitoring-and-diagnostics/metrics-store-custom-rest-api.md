...
Egy egyszerű szolgáltatásnév létrehozása az Azure Active Directory-bérlőben található útmutatót [egyszerű szolgáltatás létrehozása](../active-directory/develop/howto-create-service-principal-portal.md). 
...
2. Előfordulhat, hogy metrikákat az egy régióban, amely nem támogatja az egyéni metrikákat kibocsátó. Lásd: [támogatott régiók](metrics-custom-overview.md#supported-regions). 
