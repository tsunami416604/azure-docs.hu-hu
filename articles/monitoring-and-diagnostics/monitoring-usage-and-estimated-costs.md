...
![Használat és becsült költségek portál képernyőképe](./media/monitoring-usage-and-estimated-costs/001.png)
...
![Keret csomópontonként sáv diagram képernyőképe](./media/monitoring-usage-and-estimated-costs/002.png)
...
![Használat és becsült költségek portál képernyőképe – díjszabása 2018 április](./media/monitoring-usage-and-estimated-costs/003.png)
...
![Használat monitorozása és a becsült költségekkel kell számolnia az új díjszabási modell képernyőképe](./media/monitoring-usage-and-estimated-costs/004.png)

Az új lap egy-egy zöld szalagcím a előzetes lap hasonló verzióját jeleníti meg:

![Használat monitorozása és becsült költségek a jelenlegi díjszabási modellben képernyőképe](./media/monitoring-usage-and-estimated-costs/005.png)
...
![Használat monitorozása és a becsült költségekkel kell számolnia az új díjszabási modell képernyőképe](./media/monitoring-usage-and-estimated-costs/006.png)
...
![Díjszabási modell kiválasztása képernyőképe](./media/monitoring-usage-and-estimated-costs/007.png)
