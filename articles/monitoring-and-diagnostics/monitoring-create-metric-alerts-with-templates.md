...
## <a name="resource-manager-template-for-metric-alert-that-monitors-multiple-resources"></a>Metrikaalapú riasztás, amely több erőforrást figyeli a Resource Manager-sablon

Az előző szakaszban leírt mintát az Azure Resource Manager-sablonok, metrikákkal kapcsolatos riasztások figyelése egyetlen erőforrás létrehozásához. Az Azure Monitor most már támogatja egyetlen a metrikaalapú riasztási szabály több erőforrások figyelése. Az előzetes verziójú funkció jelenleg csak az Azure Resource Manager-sablonok és a REST API használatával érhető el, és csak a virtuális gépek támogatott. Portál létrehozása és módosítása az ilyen szabályok támogatása hamarosan elérhető lesz.
...
### <a name="all-virtual-machines-in-one-or-more-resource-groups"></a>Egy vagy több erőforráscsoport az összes virtuális gép

Ezzel a sablonnal hoz létre a metrikaalapú riasztási szabály, amely figyeli a százalékos Processzorhasználat (egy Azure-régióban) található összes virtuális gép egy vagy több erőforráscsoport.

Mentse az alábbi json minden – virtuális gépek-a-resource-group.json ebben az útmutatóban céljából.
...
Mentse, és minden – virtuális gépek-a-resource-group.parameters.json Ez az útmutató céljából, az alábbi json módosítása.
...
### <a name="all-virtual-machines-in-a-subscription"></a>Egy adott előfizetés összes virtuális gép

Ezzel a sablonnal hoz létre a metrikaalapú riasztási szabály, figyelő százalékos Processzorhasználat az összes virtuális gép (egy Azure-régióban) az előfizetéshez.

Mentse az alábbi json minden – virtuális gépek-az-subscription.json ebben az útmutatóban céljából.
...
A fenti sablon az alábbi alkalmazásparaméter-fájlt is használhatja.
Mentse, és minden – virtuális gépek-az-subscription.parameters.json Ez az útmutató céljából, az alábbi json módosítása.
...
### <a name="a-list-of-virtual-machines"></a>Virtuális gépek listája

Ezzel a sablonnal hoz létre a metrikaalapú riasztási szabály, figyelő százalékos Processzorhasználat az előfizetéshez (az egyik Azure-régióból) a virtuális gépek listáját.

Mentse az alábbi json list-az-vms.json ebben az útmutatóban céljából.
...
A fenti sablon az alábbi alkalmazásparaméter-fájlt is használhatja.
Mentse, és a lista-az-vms.parameters.json Ez az útmutató céljából, az alábbi json módosítása.
