...
---
# <a name="azure-monitor-documentation"></a>Az Azure Monitor dokumentációja
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ismerje meg az Azure felügyeletet és diagnosztikát</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Riasztások létrehozása az Azure-szolgáltatásokhoz az Azure Portal használatával</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Riasztások létrehozása az Azure-szolgáltatásokhoz a platformfüggetlen CLI használatával</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Riasztások létrehozása az Azure-szolgáltatásokhoz a PowerShell használatával</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Metrikariasztás létrehozása Resource Manager-sablonnal</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/monitor/">REST API – referencia</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Figyelés</h3>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-supported-metrics">A támogatott mérőszámok listája</a></p>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-data-sources">Megfigyelési adatok forrásai</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Diagnosztika</h3>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-versioning-history">Az Azure Diagnostics bővítményeinek verzióelőzményei</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema">Azure Diagnostics-bővítményséma</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot0">Azure Diagnostics-bővítményséma 1.0</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot2">Azure Diagnostics-bővítményséma 1.2</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot3-and-later">Azure Diagnostics-bővítményséma 1.3 és újabb verziók</a></p>
                    </div>
                </div>
            </div>
        </div>
