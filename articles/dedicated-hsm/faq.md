...
### <a name="q-what-is-a-hardware-security-module-hsm"></a>KÉRDÉS: Mit jelent a hardveres biztonsági modul (HSM)?
...
### <a name="q-what-is-the-azure-dedicated-hsm-offering"></a>KÉRDÉS: Mi az Azure dedikált HSM kínál?
...
### <a name="q-what-hardware-is-used-for-dedicated-hsm"></a>KÉRDÉS: Milyen hardver szolgál a dedikált HSM?
...
### <a name="q-what-is-an-hsm-used-for"></a>KÉRDÉS: Mire használják a HSM-eket?
...
### <a name="q-how-does-dedicated-hsm-work"></a>KÉRDÉS: Hogyan működik a dedikált HSM?
...
### <a name="q-does-azure-dedicated-hsm-offer-password-based-and-ped-based-authentication"></a>KÉRDÉS: Kínál Azure dedikált HSM-be a jelszó- és PED-alapú hitelesítést?
...
### <a name="q-how-does-my-application-connect-to-a-dedicated-hsm"></a>KÉRDÉS: Hogyan csatlakozhat az alkalmazásom egy dedikált HSM?
...
### <a name="q-can-an-application-connect-to-dedicated-hsm-from-a-different-vnet-in-or-across-regions"></a>KÉRDÉS: Egy alkalmazás kapcsolódhat dedikált HSM egy vagy több régió, vagy a másik virtuális Hálózattal?
...
### <a name="q-can-i-synchronize-dedicated-hsm-with-on-premises-hsms"></a>KÉRDÉS: Is dedikált HSM is szinkronizálja a helyszíni HSM-EK?
...
### <a name="q-can-i-encrypt-data-used-by-other-azure-services-using-keys-stored-in-dedicated-hsm"></a>KÉRDÉS: Titkosítsa a dedikált HSM-ben tárolt kulcsok használata más Azure-szolgáltatások által használt adatokat?

Nem. Az Azure dedikált HSM-EK csak érhetők el a virtuális hálózaton belül.

### <a name="q-can-i-import-keys-from-an-existing-on-premises-hsm-to-dedicated-hsm"></a>KÉRDÉS: Lehet importálni kulcsok egy meglévő helyszíni HSM-ből dedikált HSM-be?

Igen, ha rendelkezik a helyszíni HSM-EK SafeNet Gemalto. Több módszerrel. Tekintse meg a Gemalto HSM dokumentációját.

### <a name="q-what-operating-systems-are-supported-by-dedicated-hsm-client-software"></a>KÉRDÉS: Mely operációs rendszerek dedikált HSM kliens szoftver által támogatott?

* Windows, Linux, Solaris, AIX, a HP-UX, a FreeBSD
* Virtuális: VMware-, Hyper-v, Xen-KVM vagy

### <a name="q-how-do-i-configure-my-client-application-to-create-a-high-availability-configuration-with-multiple-partitions-from-multiple-hsms"></a>KÉRDÉS: Hogyan konfigurálható a saját ügyfélalkalmazás több HSM moduljaiban tárolt több partícióval rendelkező magas rendelkezésre állású konfiguráció létrehozásához?
...
### <a name="q-what-authentication-mechanisms-are-supported-by-dedicated-hsm"></a>KÉRDÉS: Dedikált HSM milyen hitelesítési mechanizmusok támogatottak?

Azure dedikált HSM SafeNet hálózati HSM 7 berendezések (modell A790) használ, és támogatják a jelszóalapú hitelesítés.

### <a name="q-what-sdks-apis-client-software-is-available-to-use-with-dedicated-hsm"></a>KÉRDÉS: Ügyfél SDK-k API-k, szoftverek érhető el a dedikált HSM-mel használni?

PKCS #11, a Java (JCA/KVV), a Microsoft CAPI és a CNG, OpenSSL

### <a name="q-can-i-importmigrate-keys-from-luna-56-hsms-to-azure-dedicated-hsms"></a>KÉRDÉS: Importálás/áttelepíthetek Luna 5/6 HSM moduljaiban tárolt kulcsokat Azure dedikált HSM?

Igen. Tekintse meg a Gemalto migrálási útmutatót. 

## <a name="using-your-hsm"></a>A HSM használata

### <a name="q-how-do-i-decide-whether-to-use-azure-key-vault-or-azure-dedicated-hsm"></a>KÉRDÉS: Hogyan válasszak e használni az Azure Key Vaultot vagy az Azure dedikált HSM-be?
...
### <a name="q-what-usage-scenarios-best-suit-azure-dedicated-hsm"></a>KÉRDÉS: Milyen használati forgatókönyvek ajánlott igény szerint az Azure dedikált HSM-be?
...
### <a name="q-can-dedicated-hsm-be-used-with-office-365-customer-key-azure-information-protection-azure-data-lake-store-disk-encryption-azure-storage-encryption-azure-sql-tde"></a>KÉRDÉS: Használható dedikált HSM az Office 365 Customer Key, Azure Information Protection, Azure Data Lake Store, Disk Encryption, Azure Storage Encryption, Azure SQL TDE szolgáltatással?
...
### <a name="q-does-the-customer-get-full-exclusive-control-over-the-hsms-with-dedicated-hsms"></a>KÉRDÉS: Az ügyfél beolvasása a HSM-EK a dedikált HSM-EK teljes kizárólagos felett?
...
### <a name="q-can-microsoft-or-anyone-at-microsoft-access-keys-in-my-dedicated-hsm"></a>KÉRDÉS: A Microsoft vagy a Microsoft tárelérési kulcsok saját dedikált HSM-ben is?

Nem. A Microsoft nem rendelkezik az ügyfél lefoglalt dedikált HSM tárolt kulcsok elérését.

### <a name="q-can-i-upgrade-softwarefirmware-on-hsms-allocated-to-me"></a>KÉRDÉS: Frissíthetem a HSM-EK nekem kiosztott szoftverek és belső vezérlőprogramjának?
...
### <a name="q-how-do-i-manage-dedicated-hsm"></a>KÉRDÉS: Hogyan kezelheti a dedikált HSM?

Férnek hozzájuk segítségével kezelheti a dedikált HSM-EK SSH-val.

### <a name="q-how-do-i-manage-partitions-on-the-dedicated-hsm"></a>KÉRDÉS: Hogyan kezelhetem a partíciókat a dedikált HSM-en?

A Gemalto HSM ügyfélszoftvert a HSM-ekről és a partíciók kezelésére szolgál.

### <a name="q-how-do-i-monitor-my-hsm"></a>KÉRDÉS: Hogyan figyelhetem a saját HSM?
...
### <a name="q-can-i-get-full-access-log-of-all-hsm-operations-from-dedicated-hsm"></a>KÉRDÉS: Kaphatok minden HSM-műveletek teljes hozzáférési napló dedikált HSM-ből?

Igen. Naplók küldésével HSM a készülék a syslog-kiszolgálónak

## <a name="high-availability"></a>Magas rendelkezésre állás

### <a name="q-is-it-possible-to-configure-high-availability-in-the-same-region-or-across-multiple-regions"></a>KÉRDÉS: A lehetséges ugyanabban a régióban, illetve több régióban a magas rendelkezésre állású konfigurálásához?

Igen. Magas rendelkezésre állású konfiguráció és beállítás a HSM-ügyfélszoftver Gemalto által biztosított hajtott végre. HSM-EK ugyanazon a VNETEN vagy más virtuális hálózatok ugyanabban a régióban vagy régiók között elosztva, és a helyszíni HSM-EK site-to-site virtuális hálózat csatlakozik, vagy pont-pont típusú VPN azonos magas rendelkezésre állású konfiguráció lehet hozzáadni.
...
### <a name="q-how-many-hsms-can-i-add-to-the-same-high-availability-configuration-from-one-single-application"></a>KÉRDÉS: Hány HSM-EK adhatok hozzá ugyanazt a magas rendelkezésre állású konfigurációt egy egyszeri alkalmazásból?

16.

## <a name="support"></a>Támogatás

### <a name="q-what-is-the-sla-for-dedicated-hsm-service"></a>KÉRDÉS: Mit jelent a dedikált HSM szolgáltatás SLA?
...
### <a name="q-how-are-the-hsms-used-in-azure-dedicated-hsm-protected"></a>KÉRDÉS: A hardveres biztonsági modulok használata az Azure dedikált HSM által védett?
...
### <a name="q-what-happens-if-there-is-a-security-breach-or-hardware-tampering-event"></a>KÉRDÉS: Mi történik, ha a biztonsági szabályzat megsértése vagy illetéktelen módosítást esemény hardver?
...
### <a name="q-how-do-i-ensure-that-keys-in-my-dedicated-hsms-are-not-lost-due-to-error-or-a-malicious-insider-attack"></a>KÉRDÉS: Hogyan biztosítja, hogy a kulcsokat a saját dedikált HSM-EK nem vesznek el miatt hiba vagy egy rosszindulatú belső támadás?
...
### <a name="q-how-do-i-get-support-for-dedicated-hsm"></a>KÉRDÉS: Hogyan dedikált HSM-támogatást kérni?
...
### <a name="q-how-do-i-get-access-to-dedicated-hsm-client-software-documentation-firmware-images"></a>KÉRDÉS: Hogyan szerezhetem be a dedikált HSM-ügyfélszoftvert, a dokumentáció, a belső vezérlőprogram lemezképeiről a hozzáférést?
...
### <a name="q-if-there-is-a-security-vulnerability-found-and-a-patch-is-released-by-gemalto-who-is-responsible-for-upgradingpatching-osfirmware"></a>KÉRDÉS: Ha a biztonsági rés található és a egy javítási Gemalto, frissítése és javításokat az operációs rendszer/belső vezérlőprogram felelős által kiadott?
...
### <a name="q-is-it-safe-to-store-encryption-keys-for-my-most-important-data-in-dedicated-hsm"></a>KÉRDÉS: Rendszer biztonságosan tárolja a titkosítási kulcsokat a legfontosabb adataimat a dedikált HSM-ben?
...
### <a name="q-what-cryptographic-keys-and-algorithms-are-supported-by-dedicated-hsm"></a>KÉRDÉS: Milyen titkosítási kulcsokat és algoritmusok dedikált HSM által támogatott?
...
### <a name="q-is-dedicated-hsm-fips-140-2-level-3-validated"></a>KÉRDÉS: Dedikált HSM FIPS 140-2 3. szint érvényesítve van?
...
### <a name="q-what-do-i-need-to-do-to-make-sure-i-operate-dedicated-hsm-in-fips-140-2-level-3-validated-mode"></a>KÉRDÉS: Mit kell tennie, hogy e működnek a dedikált HSM FIPS 140-2 3. szint érvényesítve mód?
...
### <a name="q-how-many-cryptographic-operations-are-supported-per-second-with-dedicated-hsm"></a>KÉRDÉS: Hány titkosítási műveletek száma másodpercenként a dedikált HSM-mel támogatottak?
...
### <a name="q-how-many-partitions-can-be-created-in-dedicated-hsm"></a>KÉRDÉS: Hány partíció hozható létre dedikált HSM-ben?

A használt HSM adott modellen alapuló, elérhető 10 partíciók vannak.

### <a name="q-how-many-keys-can-be-supported-in-dedicated-hsm"></a>KÉRDÉS: A dedikált HSM támogatható, hogy hány kulcsot?
