...
description: Ebből a cikkből megtudhatja, hogyan hozhat létre egy Azure Bastion-gazdagépet, amely RDP/SSH-kapcsolatot biztosít a virtuális hálózatban lévő összes virtuális géphez.
services: bastion
author: cherylmc
ms.service: bastion
ms.topic: how-to
