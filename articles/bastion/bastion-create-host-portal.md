...
1. A [Azure Portal](https://portal.azure.com)kezdőlapján kattintson az **+ erőforrás létrehozása**elemre.
...
1. Nyissa meg az [Azure portált](https://portal.azure.com). Navigáljon a virtuális géphez, majd kattintson a **Kapcsolódás**elemre.
