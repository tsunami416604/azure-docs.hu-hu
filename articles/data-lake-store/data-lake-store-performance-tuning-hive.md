...
* **HDInsight Hive futó**.  A HDInsight Hive-feladatok futtatásával kapcsolatos tudnivalókért lásd: [Hive használata a HDInsight])https://docs.microsoft.com/azure/hdinsight/hdinsight-use-hive)
