...
| ConcurrentFileCount | 10      | Ez a paraméter kifejezetten a mappák fel- és letöltéséhez kapcsolódik. Ez a paraméter határozza meg az egyidejűleg fel- vagy letölthető fájlok számát. Ez a szám azt jelenti, hogy legfeljebb hány egyidejű fájl tölthető fel vagy tölthető le egyszerre, de a forgatókönyvtől függően kevesebb párhuzamosságot érhet el (például ha két fájlt tölt fel, akkor is két egyidejű fájlt tölt fel, még ha kéri 15 esetében). |
