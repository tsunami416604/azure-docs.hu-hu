<properties
   pageTitle="A Data Lake Store használatának első lépései a platformfüggetlen parancssori felülettel | Microsoft Azure"
...
5. Hozza létre a Data Lake Store-fiókot.

        azure datalake store account create <dataLakeStoreAccountName> <location> <resourceGroup>

## Mappák létrehozása a Data Lake Store-fiókban
...
## Fájlok listázása a Data Lake Store-ban
...
## Mappa hozzáférés-vezérlési listájának megtekintése a Data Lake Store-ban
