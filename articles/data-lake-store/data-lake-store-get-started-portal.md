...
4. Kattintson a **Létrehozás** elemre. Ha úgy döntött, hogy rögzíti a fiókot az irányítópulton, visszakerül az irányítópultra, és megtekintheti a Data Lake Storage Gen1 fiók üzembe helyezésének folyamatát. A Data Lake Storage Gen1 fiók üzembe helyezése után megjelenik a fiók panel.
...
## <a name="createfolder"></a>Mappák létrehozása
...
## <a name="uploaddata"></a>Adatok feltöltése
