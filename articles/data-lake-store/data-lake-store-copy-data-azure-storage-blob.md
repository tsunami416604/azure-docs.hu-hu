---
title: Adatok másolása az Azure Storage-Blobokból a Azure Data Lake Storage Gen1ba | Microsoft Docs
...
A Azure Data Lake Storage Gen1 parancssori eszközt ( [AdlCopy](https://www.microsoft.com/download/details.aspx?id=50358)) biztosít a következő forrásokból származó adatok másolásához:

* Az Azure Storage-Blobokból a Data Lake Storage Gen1ba. A AdlCopy nem használhatja adatok másolását a Data Lake Storage Gen1ról az Azure Storage-blobokra.
* Két Azure Data Lake Storage Gen1 fiók között.
...
* **Azure Data Lake Analytics fiók (nem kötelező)** – tekintse meg az [Ismerkedés a Azure Data Lake Analyticsvel](../data-lake-analytics/data-lake-analytics-get-started-portal.md) című témakört, amely útmutatást nyújt Data Lake Analytics fiók létrehozásához.
...
| Mintázat |Egy olyan regex-mintát ad meg, amely jelzi, hogy mely Blobok vagy fájlok másolhatók. A AdlCopy megkülönbözteti a kis-és nagybetűket. Az alapértelmezett minta, ha nincs megadva mintázat, az összes elem másolására szolgál. Több fájl mintázatának meghatározása nem támogatott. |
...
2. Futtassa a következő parancsot egy adott blobnak a forrás tárolójából egy Data Lake Storage Gen1 mappába való másolásához:
...
1. Nyisson meg egy parancssort, és navigáljon ahhoz a könyvtárhoz, ahol a AdlCopy telepítve van, jellemzően `%HOMEPATH%\Documents\adlcopy`.
2. Futtassa a következő parancsot egy adott fájl egy Data Lake Storage Gen1-fiókból egy másikba való másolásához.
   ...
   >
    ...
    A rendszer kérni fogja, hogy adja meg az Azure-előfizetéshez tartozó hitelesítő adatokat, amelyben a Data Lake Storage Gen1 fiókja van. A következőhöz hasonló kimenet jelenik meg:
        ...
        Finishing Copy.
        Copy Completed. 1 file copied.
3. A következő parancs a forrás Data Lake Storage Gen1 fiókjában lévő összes fájlt átmásolja a cél Data Lake Storage Gen1 fiók egyik mappájába.
...
1. Nyisson meg egy parancssort, és navigáljon ahhoz a könyvtárhoz, ahol a AdlCopy telepítve van, jellemzően `%HOMEPATH%\Documents\adlcopy`.
2. A következő parancs futtatásával másolja át a *. csv kiterjesztésű fájlokat egy adott blobból a forrás tárolójából egy Data Lake Storage Gen1 mappába:
