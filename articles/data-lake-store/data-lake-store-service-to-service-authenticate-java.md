...
4. A Java-alkalmazásban az alábbi kódrészlettel szerezheti be a korábban létrehozott Active Directory webalkalmazás jogkivonatát, amelyet a `AccessTokenProvider` alosztálya (a következő példa `ClientCredsTokenProvider`) használ. A jogkivonat-szolgáltató a memóriában gyorsítótárazza a jogkivonat beszerzéséhez használt hitelesítő adatokat, és automatikusan megújítja azt, ha közeleg a lejárati ideje. Létrehozhatók saját alosztályai is `AccessTokenProvider`, így a tokeneket az ügyfél kódja szerzi be. Egyelőre csak használja az SDK-ban megadott ilyet.
