...
A tulajdonság értéke, és a csomópont újra lesz indítva, Data Lake Storage Gen1 diagnosztikai íródik a YARN-naplókat a csomópontok (/tmp/<user>/yarn.log), és fontos részleteket, például hibákat, vagy (HTTP 429-es hibakód) szabályozás figyelhető. Ugyanezeket az adatokat a Log Analytics vagy bárhol is legyenek a naplók rendszerrel szállított is megfigyelhetők a [diagnosztikai](data-lake-store-diagnostic-logs.md) a Data Lake Storage Gen1 fiók panelen. Ajánlott legalább ügyféloldali naplózás engedélyezve van, vagy a naplóküldés átláthatók és könnyebb hibakeresés a Data Lake Storage Gen1 beállítást használják.
