...
### <a name="configure-file-permissions"></a>Fájlengedélyek konfigurálása
...
## <a name="verify-cluster-set-up"></a>Fürt beállításának ellenőrzése
...
* a `adl://hdiadlsg1storage.azuredatalakestore.net/` a Data Lake Storage Gen1 fiók gyökere.
* `/clusters/myhdiadlcluster` a fürt létrehozásakor megadott fürtözött adatmennyiség gyökerét adja meg.
* `/HdiSamples/HdiSamples/WebsiteLogSampleData/SampleLog/` a lekérdezésben használt sablonfájl helye.
