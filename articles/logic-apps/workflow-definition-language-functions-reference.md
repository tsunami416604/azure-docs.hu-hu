...
| <*területi beállítás*> | Nem | Sztring | A által `number.ToString(<format>, <locale>)`támogatott területi beállítás. Ha nincs megadva, az alapértelmezett érték: `en-us`. |
|||||
