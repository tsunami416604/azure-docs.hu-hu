---
title: A függvények hivatkozási útmutatója kifejezésekben – Azure Logic Apps
...
Ez a példa beolvassa a "Send_an_email" művelethez tartozó aktuális üzenet `body` elemét a-minden hurok aktuális iterációjában:
