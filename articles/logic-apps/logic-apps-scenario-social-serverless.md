---
title: Ügyfél-adatáttekintési irányítópult létrehozása – Azure Logic Apps
...
A függvény végén a logikai alkalmazásra adott válaszként adott vissza néhány adat, például egy egyszerű logikai érték, például `containsKeyword` vagy egy összetett objektum.
