---
title: Korlátok és konfiguráció
...
| Iterációig | – Alapértelmezett: 60 <p><p>– Maximum: 5 000 | |
||||
...
|------|-------|
| Kifejezés kiértékelési korlátja | 131 072 karakter | A `@concat()`, `@base64()``@string()` kifejezés nem lehet hosszabb ennél a korlátnál. |
