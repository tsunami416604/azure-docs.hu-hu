...
1. A [Azure Portal](https://portal.azure.com)a fő Azure-keresés mezőben adja meg `integration service environments` a szűrőt, és válassza az **integrációs szolgáltatási környezetek**lehetőséget.
