...
1. A **piactér** megnyitása után a keresőmezőbe írja be a `logic apps b2b`kifejezést, majd válassza a **Logic apps B2B**lehetőséget.
...
1. A munkaterület menüjében válassza a **munkaterület összefoglalása** > **Logic apps B2B**lehetőséget.
...
| **Direction (Irány)** | Az AS2-üzenet iránya |
...
| **Direction (Irány)** | A X12 üzenet iránya |
| **Követési azonosító** | A logikai alkalmazásban lévő összes eseményindítót és műveletet összekapcsoló azonosító |
...
| **Direction (Irány)** | A EDIFACT üzenet iránya |
| **Követési azonosító** | A logikai alkalmazásban lévő összes eseményindítót és műveletet összekapcsoló azonosító |
