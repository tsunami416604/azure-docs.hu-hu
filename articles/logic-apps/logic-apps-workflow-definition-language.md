...
|-----------|----------|------|-------------|
| <*paraméter – név*> | Igen | Karakterlánc | A definiálni kívánt paraméter neve |
...
| <*tömb – engedélyezett – paraméter-értékek*> | Nem | Array | Egy tömb, amely a paraméter által elfogadható értékekkel rendelkezik |
