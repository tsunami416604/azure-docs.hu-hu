...
* A Azure Logic Apps, például a `application/`, a `application/octet-stream`és a `multipart/formdata`ben [lévő tartalomtípusok kezelése](../logic-apps/logic-apps-content-type.md)
