...
1. Az egyes párhuzamos ágakhoz, adja hozzá a kívánt lépéseket. Egyik ágára való leküldés egy másik művelet hozzáadása, helyezze az egérmutatót, a művelet alatt, ahol szeretné egymást követő művelet hozzáadása. Válassza ki a a **plusz** (**+**) bejelentkezést, amely akkor jelenik meg, és válassza ki **művelet hozzáadása**.
