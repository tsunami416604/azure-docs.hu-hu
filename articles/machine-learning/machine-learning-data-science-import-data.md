...
> [AZURE.NOTE] Machine Learning Studio 中有一些可用於此目的範例資料集。 如需這些資訊，請參閱 [Azure Machine Learning Studio 中使用範例資料集](machine-learning-use-sample-datasets.md))。
...
Machine Learning Studio 使用名為的內部資料類型 *** 資料資料表 *** 模組之間傳遞資料。 您可以明確地轉換資料的資料表格式使用 [轉換為資料集 ][convert-to-dataset] 模組。
