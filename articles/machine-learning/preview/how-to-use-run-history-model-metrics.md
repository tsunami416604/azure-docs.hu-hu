...
- [A projekt létrehozása](quickstart-installation.md)
...
Ha még nem rendelkezik a projekt, létrehozhat egyet a [létrehozása és telepítése gyors üzembe helyezés](quickstart-installation.md) a a **projekt irányítópultján**, megnyithatja a **iris_sklearn.py** parancsfájl () ahogy.)
