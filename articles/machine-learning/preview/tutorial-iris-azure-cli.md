...
- Az [Azure Machine Learning-szolgáltatások telepítését és elindítását ismertető rövid útmutatóban](quickstart-installation.md) leírt módon telepített Azure Machine Learning Workbench alkalmazás. 
