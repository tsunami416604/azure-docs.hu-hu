...
1. A gépi tanulási a munkaterületet üzemeltető alkalmazás telepítése. Győződjön meg arról, hogy rendelkezik-e egy olyan Azure Machine Learning kísérletezhet fiókot. További információkért lásd: a [a telepítési útmutató](quickstart-installation.md).
