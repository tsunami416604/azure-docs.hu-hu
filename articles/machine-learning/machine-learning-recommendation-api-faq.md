...
Recommendations 是一項以訂用帳戶為基礎的服務。 收費是根據每個月的交易量來進行。 您可以檢查 [優惠 page] (https://datamarket.azure.com/dataset/amla/recommendations) 如需定價資訊的 Microsoft Azure Marketplace 中。
...
您可以購買或更新您的訂閱，從 [提供] 頁面] (https://datamarket.azure.com/dataset/amla/recommendations) 頁面，在 Microsoft Azure Marketplace。
...
在取得技術支援的 [Microsoft Azure 支援](https://social.msdn.microsoft.com/forums/azure/home?forum=MachineLearning) 站台。
