...
Mivel a kérdés a "melyik?" választ kapta, ez az úgynevezett besorolási probléma. Ugyanakkor ugyanezen alapvető eljárást alkalmazhatja bármilyen gépi tanulási probléma – regresszió, besorolás, fürtözés stb. – kezelésére.
...
1. Adja hozzá a **Filter-alapú funkciók kiválasztási** modulját az 5 funkció PearsonCorrelation való kiválasztásához. 
