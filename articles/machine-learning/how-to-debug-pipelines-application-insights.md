...
A OpenCensus-könyvtárhoz a `APPLICATIONINSIGHTS_CONNECTION_STRING` környezeti változó szükséges. Azt javasoljuk, hogy állítsa be ezt a környezeti változót ahelyett, hogy folyamat paraméterként adja át azt, hogy elkerülje az egyszerű szöveges kapcsolatok karakterláncának megadását.
