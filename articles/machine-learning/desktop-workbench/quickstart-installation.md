---
title: Az Azure Machine Learning szolgáltatás rövid telepítési útmutatója | Microsoft Docs
...
ms.locfileid: "53276502"
---
# <a name="quickstart-install-and-get-started-with-azure-machine-learning-service"></a>Gyors útmutató: Telepítse, és az Azure Machine Learning szolgáltatás használatának első lépései

[!INCLUDE [workbench-deprecated](../../../includes/aml-deprecating-preview-2017.md)]


Az Azure Machine Learning szolgáltatás (előzetes verzió) egy átfogó, integrált és fejlett adatelemzési megoldás. A hivatásos adatszakértők számára nyújt segítséget az adatok előkészítésében, a kísérletek kidolgozásában és a modellek felhőszinten való üzembe helyezésében.

Ez a rövid útmutató a következőket mutatja be:

* Szolgáltatásfiókok létrehozása az Azure Machine Learning szolgáltatáshoz
...
Mivel az Azure Machine Learning szolgáltatás a Microsoft Azure-portfólió részét képezi, a használatához szükség van egy Azure-előfizetésre. Ha nem rendelkezik Azure-előfizetéssel, mindössze néhány perc alatt létrehozhat egy [ingyenes fiókot](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) a virtuális gép létrehozásának megkezdése előtt.
...
## <a name="create-azure-machine-learning-service-accounts"></a>Azure Machine Learning szolgáltatás fiókjainak létrehozása
...
1. Amikor meg van nyitva az Azure Machine Learning Workbench, válassza a **PROJEKTEK** panelen lévő pluszjelet (+), majd az **Új projekt** lehetőséget.  
   ...
   ![Új munkaterület](./media/quickstart-installation/new_ws.png)
...
1. Töltse ki az űrlap mezőit, és válassza a **Létrehozás** gombot, hogy új projektet hozzon létre a Workbenchben.
   ...
   Visualstudio.com GIT-adattár URL-címe |_hagyja üresen_ | Nem kötelező kitölteni. Dönthet úgy, hogy egy projektet Git-adattárhoz társít az Azure DevOpsban a verziókövetés és az együttműködés megkönnyítése érdekében. [További tudnivalókat erről a lehetőségről itt talál](../desktop-workbench/using-git-ml-project.md#step-3-set-up-a-machine-learning-project-and-git-repo). 
   ...
   ![Új projekt](./media/quickstart-installation/new_project.png)
...
>[!TIP]
>Konfigurálhatja a Workbenchet úgy, hogy használható legyen a Python IDE-vel a zökkenőmentes adatelemzés-fejlesztési élmény érdekében. Ezután az IDE-ben kezelheti a projektet. [További tudnivalókat itt talál](../desktop-workbench/how-to-configure-your-ide.md). 
...
Az Azure Machine Learning parancssori felülete (CLI) is telepítve van. A parancssori felületen elérheti és kezelheti az Azure Machine Learning szolgáltatást az `az` parancsokkal, és a teljes adatelemzési munkafolyamathoz szükséges összes feladatot elvégezheti. [Részletek](../desktop-workbench/tutorial-iris-azure-cli.md)
...
A munkafolyamat behatóbb megismeréséért, többek között az íriszmodell webszolgáltatásként való üzembe helyezéséhez kövesse a teljes *Írisz osztályozása* oktatóanyagot. Az oktatóanyag részletes útmutatásokat tartalmaz az [adatok előkészítésével](../desktop-workbench/tutorial-classifying-iris-part-1.md), a [kísérletezéssel](../desktop-workbench/tutorial-classifying-iris-part-2.md) és a [modellkezeléssel](../desktop-workbench/tutorial-classifying-iris-part-3.md) kapcsolatban. 

> [!div class="nextstepaction"]
> [Oktatóanyag: Írisz osztályozása (1. rész)](../desktop-workbench/tutorial-classifying-iris-part-1.md)

>[!NOTE]
> Bár a modellkezelési fiókot már létrehozta, a környezet még nincs beállítva a webszolgáltatások üzembe helyezéséhez. Itt megtudhatja, hogyan állíthatja be az [üzembehelyezési környezetet](../desktop-workbench/deployment-setup-configuration.md).
