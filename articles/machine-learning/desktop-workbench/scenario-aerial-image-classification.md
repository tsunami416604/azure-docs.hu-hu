...
- [Azure Machine Learning Workbench](../service/overview-what-is-azure-ml.md)
    - Kövesse a [telepítése és gyors üzembe helyezés létrehozása](../service/quickstart-installation.md) telepítése az Azure Machine Learning-munkaterület, és kísérletezés és modell felügyeleti fiókok létrehozása.
