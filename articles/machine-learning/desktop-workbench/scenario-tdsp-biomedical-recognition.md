...
* Az Azure Machine Learning-munkaterület. Lásd: [a telepítési útmutató](../service/quickstart-installation.md). Az Azure Machine Learning-munkaterület jelenleg csak a következő operációs rendszerek telepíthetők: 
