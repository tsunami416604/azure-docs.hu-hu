...
ms.locfileid: "35645265"
---
# <a name="whats-new-in-azure-machine-learning"></a>Az Azure Machine Learning újdonságai

Ebben a cikkben megismerheti az új kiadásokat [Azure Machine Learning](../service/overview-what-is-azure-ml.md). 
...
+ Gyorsan hozhat létre és rendkívül pontos gépi tanulási és deep learning-modellek használatával [egyéni Azure Machine Learning-csomagok](../service/reference-python-package-overview.md) a következő tartományok:
  + [Számítógépes látástechnológia](../service/how-to-build-deploy-image-classification-models.md)
  + [Szövegelemzés](../service/how-to-build-deploy-text-classification-models.md)
  + [Előrejelzések](../service/how-to-build-deploy-forecast-models.md)

## <a name="2018-03-sprint-4"></a>2018-03 (sprint 4)
**Verziószám**: 0.1.1801.24353 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;([a verzió megkereséséhez](../service/known-issues-and-troubleshooting-guide.md#find-the-workbench-build-number))
...
- Az Azure Machine Learning Workbench most már támogatja a parancsprogramok natív módon fut a saját python- vagy pyspark környezetében. Ez a funkció a felhasználó hoz létre, és felügyeli a saját környezetet, a távoli virtuális gépen, és a szkriptek végrehajtása az adott cél Azure Machine Learning Workbench használatával. Lásd: [konfigurálása az Azure Machine Learning-kísérletezés szolgáltatás](experimentation-service-configuration.md) 

### <a name="model-management"></a>Modellkezelés
- Az üzembe helyezett tárolók testreszabása támogatása: lehetővé teszi, hogy a tároló rendszerképét testreszabása azáltal, hogy külső kódtárak használatával az apt-get paranccsal, és így tovább telepítési. Már nem korlátozott pip telepíthető könyvtárakhoz. Tekintse meg a [dokumentáció](model-management-custom-container.md) további információ.
...
**Verziószám**: 0.1.1712.18263 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;([a verzió megkereséséhez](../service/known-issues-and-troubleshooting-guide.md#find-the-workbench-build-number))
...
**Verziószám**: 0.1.1711.15323 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;([a verzió megkereséséhez](../service/known-issues-and-troubleshooting-guide.md#find-the-workbench-build-number))
...
**Verziószám**: 0.1.1711.15263 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;([a verzió megkereséséhez](../service/known-issues-and-troubleshooting-guide.md#find-the-workbench-build-number))
...
- [Az SQL Server és az Azure SQL DB adatforrásként támogatása](data-prep-appendix2-supported-data-sources.md#types) 
...
Számítási célnak létrehozásával kapcsolatos további információkért lásd: [konfigurálása az Azure Machine Learning-kísérletezés szolgáltatás](experimentation-service-configuration.md)
...
**Verziószám**: 0.1.1710.31013 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;([a verzió megkereséséhez](../service/known-issues-and-troubleshooting-guide.md#find-the-workbench-build-number))
...
#### <a name="sample-projects"></a>Minta-projektek
- [_Írisz osztályozása_ ](./tutorial-classifying-iris-part-1.md) mintaprojektet:
...
- [_Fejlett Adatelőkészítés Kerékpármegosztási adatok használatával_ ](./tutorial-bikeshare-dataprep.md) rögzített "Kezelni hiba érték" lépés mintaprojektet.
...
- [_Elosztott Hiperparaméter finomhangolása_ ](./scenario-distributed-tuning-of-hyperparameters.md) mintaprojektet`docker.runconfig` JSON-ból a frissített YAML formátumú.
- Új mintaprojektet [ _kép besorolása a CNTK használatával_](./scenario-image-classification-using-cntk.md).
