...
1. 發佈 Web 服務。 [本頁](machine-learning-walkthrough-5-publish-web-service.md) 說明怎麼做。 目前只針對具有單一輸出 (也就是單一計分標籤) 的要求/回應服務支援 Excel 活頁簿功能。
...
4. 按 [下載 Excel 活頁簿]****，然後在 Excel 中開啟。

5. 此時會出現安全性警告；請按一下 [啟用編輯]**** 按鈕。
