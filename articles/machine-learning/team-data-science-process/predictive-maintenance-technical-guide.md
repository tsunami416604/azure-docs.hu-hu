...
A particionálási feladat [struktúra](https://docs.microsoft.com/archive/blogs/uk_faculty_connection/getting-started-with-microsoft-big-data-hive-hdinsight-jump-start) -parancsfájlja * **AggregateFlightInfo. HQL** _
