...
Ezeket a fájlokat a 0,1%-os mintát vettük, és az utazáshoz\_adatokat és az utazást\_a fare CVS-fájlokat egyetlen adatkészletbe, amelyet a bemutató bemeneti adatkészletének használ. Az utazáshoz\_az adathoz és az utazáshoz\_viteldíj a következő mezőkből áll: emlékérem, Hack\_licenc és pickup\_DateTime. Az adatkészlet minden rekordja a következő attribútumokat tartalmazza, amelyek a New York-i taxis utakat jelképezik:
...
A Jupyter-jegyzetfüzetek eléréséhez tallózással is megkeresheti ***https://CLUSTERNAME.azurehdinsight.net/jupyter*** . Cserélje le az URL CLUSTERNAME részét a saját fürt nevére. A jegyzetfüzetek eléréséhez szüksége lesz a rendszergazdai fiók jelszavára.
