...
Ebből a szakaszból megtudhatja, hogyan indexelheti a kategorikus adatokat `StringIndexer` a `OneHotEncoder` és a modellbe bevitt funkciók kódolásával.
