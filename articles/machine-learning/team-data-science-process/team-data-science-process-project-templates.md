...
Tekintse meg a leírását, ezek a szakaszok [a csapat adatok tudományos folyamat életciklus](https://docs.microsoft.com/azure/machine-learning/team-data-science-process/lifecycle).
...
A terv megnyitásakor a TDSP bal a hivatkozásra kattintva. Módosítsa a nevet és leírást, és adja hozzá más team erőforrások van szüksége a. Adja meg a dátumok, a felhasználói élmény a szükséges.

![1](./media/team-data-science-process-project-templates/ms-project-templates.png)

Minden tevékenység rendelkezik megjegyzés. Nyissa meg ezeket a feladatokat, hogy milyen erőforrásokat létre lett hozva.
...
Ha nincs hozzáférése a Microsoft Project, az Excel-munkalap az azonos adatokhoz egyben letölthető innen: [Excel-sablon](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Team-Data-Science-Process/Project-Planning-and-Governance/Advanced%20Analytics%20Microsoft%20Project%20Plan.xlsx) akkor is húzza azt bármilyen eszközt szeretné használni.

Ezeket a sablonokat a saját kockázatára használhatja. A [szokásos nyilatkozatok](https://www.gnu.org/licenses/gpl-3.0.en.html) alkalmazni.
