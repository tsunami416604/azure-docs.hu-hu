...
* Microsoft Azure Machine Learning áttekintését lásd: [Bevezetés a Microsoft Azure machine learning](../studio/what-is-machine-learning.md).
* Egy pontozási webszolgáltatás-bővítmény telepítése egy ismertetése [központi telepítése az Azure Machine Learning webszolgáltatás](../studio/publish-a-machine-learning-web-service.md).
* Hogyan pontozási webszolgáltatás felhasználásához tárgyalását lásd: [hogyan kell használni az Azure Machine Learning Web service](../studio/consume-web-services.md).
