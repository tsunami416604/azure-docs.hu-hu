...
Ebben a lekérdezésben, ha a *\<datetime (dátum* és idő) mezőben > az *03/26/2015 12:04:39*-as mintával, a *datetime > mező\<mintáját* `'MM/dd/yyyy HH:mm:ss'`kell megadni. A teszteléshez a felhasználók futtathatnak
...
A lekérdezésben használt mezők a felvételi és lemorzsolódási helyeinek GPS-koordinátái, a *pickup\_hosszúság*, a *pickup\_szélesség*, a *lemorzsolódási\_hosszúság*és a *lemorzsolódási\_szélesség*. A felvételi és lemorzsolódási koordináták közötti közvetlen távolságot kiszámító lekérdezések a következők:
