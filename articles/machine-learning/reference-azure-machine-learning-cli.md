...
* Indítsa el a kísérlet futtatását. A parancs használatakor adja meg a runconfig-fájl nevét (a \*. runconfig előtt található szöveget, ha a fájlrendszert keresi) a-c paraméterrel.
    ...
    >
    > A teljes runconfig séma ebben a [JSON-fájlban](https://github.com/microsoft/MLOps/blob/b4bdcf8c369d188e83f40be8b748b49821f71cf2/infra-as-code/runconfigschema.json)található.
...
+ Adatkészlet regisztrálása:
    ...
    Az adatkészlet definiálásához használt JSON-fájl formátumával kapcsolatos információkért használja a `az ml dataset --show-template`.
