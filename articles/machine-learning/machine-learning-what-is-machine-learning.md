...
![什麼是 machine learning? 基本工作流程來實作 Azure 機器學習預測分析。](。 / media/machine-learning-what-is-machine-learning/machine-learning-service-parts-and-workflow.png)
...
* 操作您的預測性分析模型：
    ...
    * [訓練和重新訓練模型，透過 Api](machine-learning-retrain-models-programmatically.md)
    * [管理 web 服務端點](machine-learning-create-endpoint.md)
    * [調整 web 服務](machine-learning-scaling-endpoints.md)
    * [使用 web 服務](machine-learning-consume-web-services.md)
...
* **特性工程設計**：擷取或選取與資料集相關的特性，以便增強資料集並改善結果的程序。 例如，飛機票價資料可透過星期幾和假日來增強。 請參閱 [特徵選取和 Azure Machine Learning 中的設計](machine-learning-feature-selection-and-engineering.md)。
...
* **分割**：用來將資料分成多個樣本的方法。 請參閱 [資料分割和取樣](https://msdn.microsoft.com/library/azure/dn905960.aspx) 如需詳細資訊。
...
您可以了解基本的預測分析和機器學習使用 [逐步教學課程](machine-learning-create-experiment.md) 和 [範例上建置](machine-learning-sample-experiments.md)。
