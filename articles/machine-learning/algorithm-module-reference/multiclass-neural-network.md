...
1. Adja hozzá a **Többosztályos neurális hálózati** modult a folyamathoz az illesztőfelületen. Ezt a modult a **besorolás** kategóriában, a **Machine learning**, az **inicializálás**lehetőség alatt találja.
