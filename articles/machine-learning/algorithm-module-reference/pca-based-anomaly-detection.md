...
ms.locfileid: "77925838"
---
# <a name="pca-based-anomaly-detection"></a>PCA-alapú anomáliák észlelése
...
További információ a PCA működéséről és az anomáliák észlelésének megvalósításáról:
...
2. A **PCA-alapú anomália-észlelési** modul **Tulajdonságok** paneljén kattintson a **betanítási mód** lehetőségre, és jelezze, hogy a modellt egy meghatározott paraméterek használatával szeretné-e betanítani, vagy ha egy paraméterrel szeretné megkeresni a legjobb paramétereket.
...
5. A **bemeneti funkció engedélyezése a normalizálás lehetővé tétele**: Ha ezt a beállítást választja, az összes bemeneti funkció egy nulla középértékre normalizálható. A PEM esetében általában a normalizálás vagy a méretezés nullára javasolt, mivel a PCA célja, hogy maximalizálja a változók közötti eltérést.
     ...
     A beállítás alapértelmezés szerint engedélyezett. Törölje ezt a beállítást, ha az értékek más módszer vagy méretezés használatával már normalizálva vannak.
...
Egy anomália-észlelési modell eredményeinek kiértékeléséhez további lépések szükségesek:
