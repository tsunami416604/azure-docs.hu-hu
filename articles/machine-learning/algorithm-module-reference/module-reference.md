...
| Számítógépes látástechnológia | Rendszerkép-adatok előfeldolgozása és rendszerkép-felismeréssel kapcsolatos modulok. |  [Rendszerkép-átalakítás alkalmazása](apply-image-transformation.md) <br/> [Konvertálás rendszerkép-könyvtárba](convert-to-image-directory.md) <br/> [Init-rendszerkép átalakítása](init-image-transformation.md) <br/> [Felosztás a rendszerkép könyvtárába](split-to-image-directory.md) <br/> [DenseNet](densenet.md) <br/> [ResNet](resnet.md) |
