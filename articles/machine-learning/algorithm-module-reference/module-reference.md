...
| --- |--- | ---- |
| Adatátalakítókat formátuma | Konvertálja az adatokat a machine learning, a használt különböző fájlformátumok között | [Átalakítás fürt megosztott Kötetévé](convert-to-csv.md) |
...
| Fürtözés | Adatok egy csoportba.| [K-Means Clustering](k-means-clustering.md)
