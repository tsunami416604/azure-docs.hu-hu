...
description: Megtudhatja, hogyan hozhat létre egy Poisson regressziós modellt a Azure Machine Learning Designer Poisson regressziós moduljának használatával.
