...
Több alapértelmezett argumentum is megadható, mint `kwargs` egy olyan `AutoMLConfig` objektumban, amely megváltoztatja az alapértelmezett stack Ensemble viselkedését.
