...
Az Azure Machine Learning Studio **adatok importálása** modul támogatja a következő adatforrásokat:
...
| Adatcsatorna-szolgáltató |Adatokat olvas be egy támogatott adatcsatorna-szolgáltató. Jelenleg csak az Open Data protokoll (OData) formátum támogatott. |<b>Adatok tartalomtípus</b>: Itt adhatja meg az OData-formátum.<br/><br/><b>Forrás URL-címe</b>: Adja meg az adatcsatorna teljes URL-CÍMÉT. <br/>Ha például a következő URL-cím olvas az adatbázisunk: https://services.odata.org/northwind/northwind.svc/ |
