...
Itt is érdekes big data elemzések. A mai távközlési és kiskereskedelmi vállalatok részletes adatokat gyűjtenek az ügyfelekről, és könnyen megtudhatjuk, hogy a többmodelles kapcsolatra vonatkozó igény általános trend lesz, mivel az új trendek, például a eszközök internetes hálózata és a mindenütt elérhető eszközök, amelyek lehetővé teszik, hogy a vállalatok több rétegen is intelligens megoldásokat alkalmazzanak.  
