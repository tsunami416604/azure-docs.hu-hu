---
title: 'ML Studio (klasszikus): webszolgáltatások kezelése API Management használatával – Azure'
...
3. A **webszolgáltatás URL-címe**mezőbe írja be a következőt: " `https://ussouthcentral.services.azureml.net` ".
