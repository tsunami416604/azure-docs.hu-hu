...
Mi a teendő, ha egyéni indexelendő szeretne használni? Átadhatja azt opcionális bemenetként. Egyéni C# szintaxisú reguláris kifejezést is használhat az alsztringek cseréjére, és a szavak a beszédek egy részéből való eltávolítására is használható.
