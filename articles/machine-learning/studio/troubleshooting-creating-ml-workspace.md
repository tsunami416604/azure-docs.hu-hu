...
A munkaterület kezeléséről további információkért lásd: [Az Azure Machine Learning-munkaterület kezelése].

[Az Azure Machine Learning-munkaterület kezelése]: manage-workspace.md
...
A Machine Learning szolgáltatás egy storage-fiók adatok tárolására van szüksége. Használhat meglévő storage-fiókot, vagy létrehozhat egy új storage-fiókot (ha van egy új tárfiók létrehozására érvényes kvótáját) az új Machine Learning-munkaterület létrehozásakor.

Az új Machine Learning-munkaterület létrehozása után bejelentkezhet a Machine Learning Studio a munkaterület létrehozásához használt Microsoft-fiók használatával. Ha a hibaüzenetet tapasztal, "Munkaterület nem található" (az alábbi képernyőfelvételhez hasonlóan), használja a böngésző cookie-k törlése a következő lépéseket.
