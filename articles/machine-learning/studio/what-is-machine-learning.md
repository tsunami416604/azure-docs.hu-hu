 ...
 * [Webszolgáltatások üzembe helyezése](publish-a-machine-learning-web-service.md)
 * [A modellek újratanítása API-k segítségével](retrain-models-programmatically.md)
 * [Webszolgáltatás-végpontok kezelése](create-endpoint.md)
 * [Webszolgáltatás méretezése](scaling-webservice.md)
 * [Webszolgáltatások felhasználása](consume-web-services.md)
