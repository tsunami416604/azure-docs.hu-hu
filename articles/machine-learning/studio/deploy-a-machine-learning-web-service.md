...
* **[Képzési kísérlet létrehozása]** a Studióban (klasszikus). a prediktív elemzési modellt betaníthatja és tesztelheti a betanítási adataival, és számos beépített gépi tanulási algoritmust használhat.
