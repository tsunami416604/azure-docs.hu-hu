---
title: A Machine Learning Studio klasszikus webszolgáltatások átképezési hibaelhárítása
titleSuffix: Azure Machine Learning Studio
description: Azonosítsa és javítsa ki, amelyek a az Azure Machine Learning Studio webszolgáltatás-modell átképezési során jelentkező gyakori hibák.
...
1. A képzési webszolgáltatás hívási:  A hívás nem, a Batch Execution Service (BES), nem a Request Response Service (RRS). Használhatja a minta C# kódot az API help oldalon a híváshoz. 
...
3. Frissítse a hozzáadott a pontozási webszolgáltatás-végpont az új betanított modell: Az új végpont a pontozási modelljével újonnan betanított modell a betanítási webszolgáltatásból hozzáadott azzal a mintakóddal, a Machine Learning modellek szoftveres Átképezése megadott programozott módon, frissítse.
...
* A képzési webszolgáltatás a javítás nem: A pontozási webszolgáltatás a a javítási műveletet kell végrehajtani.
* Az alapértelmezett végpont az a web Service-ben a javítás nem: Az új pontozási webszolgáltatás végpontja hozzáadott a a javítási műveletet kell végrehajtani.
