...
建立新的 Azure Data Factory 和資源群組中的指示 [Azure 入口網站](https://ms.portal.azure.com/) 提供 [建立 Azure Data Factory](data-factory-build-your-first-pipeline-using-editor.md#step-1-creating-the-data-factory)。 將新的 ADF 執行個體命名為 *adfdsp*，並將建立的資源群組命名為 *adfdsprg*。
...
1. [在內部部署 SQL Server 連結的服務](#adf-linked-service-onprem-sql)
2. [Azure Blob 儲存體連結的服務](#adf-linked-service-blob-store)
3. [Azure SQL database 的連結的服務](#adf-linked-service-azure-sql)


### <a name="adf-linked-service-onprem-sql"></a>在內部部署 SQL Server 資料庫的連結的服務
...
### <a name="adf-linked-service-azure-sql"></a>Azure SQL database 的連結的服務
...
1. [SQL 內部資料表](#adf-table-onprem-sql)
...
### <a name="adf-table-onprem-sql"></a>SQL 內部資料表
