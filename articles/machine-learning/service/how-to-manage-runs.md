...
description: Ismerje meg, elindítása, állapot, a címke és a machine learning-példakísérleteket rendszerezése.
...
## <a name="start-and-status-a-run"></a>Kezdő és a egy Futtatás állapota
...
## <a name="cancel-or-fail-runs"></a>Szakítsa meg, vagy sikertelen futtatások
 ...
 Ha hibát láthatja, hogy vagy a Futtatás úgy tűnik, hogy Befejezés, használja a hosszú ideig tart a [ `cancel()` ](https://docs.microsoft.com/python/api/azureml-core/azureml.core.run(class)?view=azure-ml-py#cancel--) metódus a Futtatás leállítása, mielőtt végzett, és szabadként, meg lett szakítva.
