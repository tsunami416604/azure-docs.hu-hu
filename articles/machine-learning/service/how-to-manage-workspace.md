...
1. Válassza a **frissítés** lehetőséget a felül vagy a frissítési üzenetben.

    ![Munkaterület frissítése](media/how-to-manage-workspace/upgrade.png)

1. Válassza a **frissítés megerősítése**lehetőséget.
