...
1. Ha nem rendelkezik Azure-előfizetéssel, a Kezdés előtt hozzon létre egy ingyenes fiókot. Próbálja ki a [Azure Machine learning szolgáltatás ingyenes vagy fizetős verzióját](https://aka.ms/AMLFree).
...
![Tervező kezdőlapja](media/how-to-run-batch-predictions-ui/ui-batch-scoring-1.png)
...
![Egyszerű kísérlet létrehozása](media/how-to-run-batch-predictions-ui/ui-batch-scoring-2.png)
...
![Batch-következtetési folyamat létrehozása](media/how-to-run-batch-predictions-ui/ui-batch-scoring-5.png)
...
![Alapértelmezett batch-következtetési folyamat](media/how-to-run-batch-predictions-ui/ui-batch-scoring-6.png)
...
![Új csomópont](media/how-to-run-batch-predictions-ui/ui-batch-scoring-7.png)
...
![Minta beállításai](media/how-to-run-batch-predictions-ui/ui-batch-scoring-8.png)
...
![Folyamat paramétere](media/how-to-run-batch-predictions-ui/ui-batch-scoring-9.png)
...
![Folyamat üzembe helyezése](media/how-to-run-batch-predictions-ui/ui-batch-scoring-10.png)
...
![Telepítési végpont](media/how-to-run-batch-predictions-ui/ui-batch-scoring-11.png)
...
![Végponti hivatkozás](media/how-to-run-batch-predictions-ui/ui-batch-scoring-12.png)

Ezen a képernyőn látható az adott végpont alatti összes közzétett folyamat. Kattintson a következtetési folyamatra.

![Következtetési folyamat](media/how-to-run-batch-predictions-ui/ui-batch-scoring-13.png)
...
![Folyamat részletei](media/how-to-run-batch-predictions-ui/ui-batch-scoring-14.png)
...
![Folyamat futtatása](media/how-to-run-batch-predictions-ui/ui-batch-scoring-15.png)
