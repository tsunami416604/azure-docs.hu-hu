...
Ez a parancs a következő állomásnévhez `<app-name>.azurewebsites.net`hasonló adatokat ad vissza:. Használja ezt az értéket a szolgáltatás __alap URL-címének__ részeként.
