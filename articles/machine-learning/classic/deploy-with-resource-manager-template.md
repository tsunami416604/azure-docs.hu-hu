...
```
A sablon mentése mlworkspace.jsfájlként a c:\temp\. alatt
...
* Tekintse meg a [Resource Manager-sablon referenciájának súgóját](/azure/templates/microsoft.machinelearning/allversions) .
