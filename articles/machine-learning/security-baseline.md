...
- [A Microsoft antimalware konfigurálása virtuális géphez](https://docs.microsoft.com/powershell/module/servicemanagement/azure/set-azurevmmicrosoftantimalwareextension?view=azuresmps-4.0.0)

- [A Microsoft antimalware-bővítmény konfigurálása a Cloud Serviceshez](https://docs.microsoft.com/powershell/module/servicemanagement/azure/set-azureserviceantimalwareextension?view=azuresmps-4.0.0)
