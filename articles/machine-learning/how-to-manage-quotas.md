...
> [!IMPORTANT]
> Korlátok változhatnak. A legújabbak mindig az összes Azure szolgáltatási szintű kvóta [dokumentumában](https://docs.microsoft.com/azure/azure-resource-manager/management/azure-subscription-service-limits/) találhatók.
...
<sup>1</sup> a maximális élettartam a Futtatás kezdetének és befejezésének időpontjára utal. Befejezett futtatások korlátlan ideig megőrződnek; a maximális élettartamon belül nem befejezett futtatások adatait nem érhető el.
...
1. Előfizetések listájából válassza ki az előfizetést, amelynek Ön által keresett kvótát.
   ...
   Van **egy kikötés**, különösen a Azure Machine learning számítási kvóta megtekintéséhez. Ahogy említettük, a kvóta elkülönül az előfizetéshez, a számítási kvótával.
