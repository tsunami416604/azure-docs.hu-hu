---
title: Python-szkript végrehajtása a Designerben (előzetes verzió)
titleSuffix: Azure Machine Learning
description: Ismerje meg, hogyan alakíthatja át az adatátalakítást a Python használatával Azure Machine Learning Designerben (előzetes verzió).
