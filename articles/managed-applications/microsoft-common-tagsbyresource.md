---
title: Az Azure TagsByResource felhasználói felületének eleme
...
ms.locfileid: "73933141"
---
# <a name="microsoftcommontagsbyresource-ui-element"></a>Microsoft. Common. TagsByResource felhasználói felületi elem

A [címkék](../azure-resource-manager/resource-group-using-tags.md) egy központi telepítésben lévő erőforrásokkal való társítására szolgáló vezérlő.
...
- Használja az [IF](../azure-resource-manager/resource-group-template-functions-logical.md#if) függvényt a tagsByResource paraméter elérésekor. Lehetővé teszi, hogy üres objektumot rendeljen hozzá, ha nem rendel hozzá címkéket a megadott erőforrás-típushoz.
