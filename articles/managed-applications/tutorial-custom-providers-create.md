...
> [!NOTE]
> A `{subscriptionId}` és a `{resourceGroupName}` helyőrzőket le kell cserélnie az előfizetéssel és az erőforrás-csoporttal, ahol az egyéni szolgáltatót telepítette.
