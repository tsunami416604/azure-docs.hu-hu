---
title: Egyéni szolgáltató C# RESTful-végpont referencia – Azure
description: Ez a cikk az egyéni szolgáltató alapszintű referenciája C# RESTful-végpont.
...
ms.locfileid: "67800106"
---
# <a name="custom-provider-c-restful-endpoint-reference"></a>Egyéni szolgáltató C# RESTful-végpont-referencia

Ez a cikk az egyéni szolgáltató alapszintű referenciája C# RESTful-végpont. Ha ismeri az Azure egyéni szolgáltatókat, [az Áttekintés az egyéni erőforrás-szolgáltatók](./custom-providers-overview.md).

## <a name="azure-function-restful-endpoint"></a>Az Azure függvény RESTful-végpont

Az alábbi kód együttműködik az Azure-függvény. Ismerje meg, hogyan állíthatja be egy Azure-függvényt az egyéni szolgáltatók, lásd: [beállítása az Azure Functions egyéni Azure-szolgáltatók](./tutorial-custom-providers-function-setup.md)
