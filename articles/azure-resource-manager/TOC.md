...
# Gyors útmutatók
## [Sablonok létrehozása – portál](resource-manager-quickstart-create-templates-use-the-portal.md)
## [Sablonok létrehozása – VS Code](resource-manager-quickstart-create-templates-use-visual-studio-code.md)
## [Sablonok létrehozása – Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)
