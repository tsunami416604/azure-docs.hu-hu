...
1. Megjelenik a központi telepítés összegzése, beleértve a korrelációs azonosítót is. 
    ...
    ![Központi telepítés összegzése](./media/resource-manager-deployment-operations/show-correlation-id.png)
...
1. A központi telepítés összegzése lapon válassza a **művelet részletei**lehetőséget.
    ...
    ![Telepítési műveletek kiválasztása](./media/resource-manager-deployment-operations/get-operation-details.png)

1. Ekkor megjelenik a központi telepítés adott lépésének részletei. Hiba esetén a részletek között szerepel a hibaüzenet.

    ![Művelet részleteinek megjelenítése](./media/resource-manager-deployment-operations/see-operation-details.png)
