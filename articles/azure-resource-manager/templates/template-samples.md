...
| [Szerepkör társítása az Azure-előfizetéshez](https://github.com/Azure/azure-quickstart-templates/tree/master/subscription-deployments/subscription-role-assignment)| Szerepkört rendel egy felhasználóhoz egy Azure-előfizetéshez. |
|**Szerepkör-definíció**||
| [Egyéni szerepkör-definíció létrehozása](https://github.com/Azure/azure-quickstart-templates/tree/master/subscription-deployments/create-role-def)| Új szerepkör-definíciót hoz létre egy Azure-előfizetésben. |
|**Erőforrás-zárolás**||
| [Erőforráscsoport zárolása](https://github.com/Azure/azure-quickstart-templates/tree/master/subscription-deployments/create-rg-lock-role-assignment)| Létrehoz egy erőforráscsoportot, és egy **DoNotDelete** -zárolást alkalmaz az erőforráscsoporthoz. Hozzárendeli a közreműködői szerepkört egy felhasználóhoz. |
| | |
