...
A jelen cikk részletesebben ismerteti mindkét felhasználási leírást. Oktatóanyagért lásd [: oktatóanyag: több erőforrás-példány létrehozása Resource Manager-sablonok használatával](template-tutorial-create-multiple-instances.md).
