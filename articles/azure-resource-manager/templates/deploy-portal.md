...
- Ha a sablont egy központi telepítésből vagy erőforráscsoporthoz szeretné exportálni, tekintse meg a [Azure Resource Manager-sablonok exportálása](export-template-portal.md)című témakört.
