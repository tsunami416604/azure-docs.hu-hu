---
title: Sablon functions – tömbök és objektumok
...
További információ a függvény tömbhöz való használatáról: [több erőforrás-példány létrehozása Azure Resource Managerban](create-multiple-instances.md).
