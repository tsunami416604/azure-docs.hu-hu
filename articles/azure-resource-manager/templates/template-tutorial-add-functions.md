...
Ebből az oktatóanyagból megtudhatja, hogyan adhat hozzá [sablon-függvényeket](template-functions.md) a sablonhoz. A függvények használatával dinamikusan hozhat létre értékeket. A rendszer által biztosított sablon-függvények mellett létrehozhat [felhasználó által definiált függvényeket](./template-user-defined-functions.md)is. Az oktatóanyag elvégzése **7 percet** vesz igénybe.
