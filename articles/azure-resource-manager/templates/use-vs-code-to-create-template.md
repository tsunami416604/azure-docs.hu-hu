...
A definícióra ugorhat a **CTRL + kattintás**, vagy a helyi menü segítségével, ahogy az a képernyőképen látható: a ![Visual Studio Code Resource Manager-eszközök bővítményei a definícióban is elérhetők.](./media/use-vs-code-to-create-template/resource-manager-tools-extension-context-menu.png)
