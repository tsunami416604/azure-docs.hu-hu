...
Ha nincs telepítve a PowerShell, használhatja a Cloud Shell. További információ: [ARM-sablonok üzembe helyezése Cloud Shellról](deploy-cloud-shell.md).
