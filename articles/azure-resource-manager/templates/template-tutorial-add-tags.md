...
description: Címkék hozzáadása a Azure Resource Manager-sablonban (ARM-sablon) üzembe helyezett erőforrásokhoz. Címkék lehetővé teszik az erőforrások logikai rendszerezését.
author: mumian
ms.date: 03/27/2020
ms.topic: tutorial
ms.author: jgao
