...
| másolás |Nem | Egy kimenet egynél több értékének visszaküldésére szolgál. **Érték** vagy **Másolás** megadása. További információ: [a kimenet iterációja az ARM-sablonokban](copy-outputs.md). |
