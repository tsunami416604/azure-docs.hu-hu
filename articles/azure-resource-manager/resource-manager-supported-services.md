...
Az erőforrástípus nevének formátuma: **{erőforrás-szolgáltató}/{erőforrástípus}** . The resource type for a key vault is **Microsoft.KeyVault/vaults**.
