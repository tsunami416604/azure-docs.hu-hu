---
title: Azure Resource Manager csoportok kezelése az Azure CLI használatával | Microsoft Docs
description: Az Azure CLI használatával kezelheti Azure Resource Manager csoportjait.
