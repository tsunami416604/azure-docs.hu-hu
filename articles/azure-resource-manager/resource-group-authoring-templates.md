...
További információ a változók különböző értékeinek létrehozásáról `copy` használatával: [változó iteráció](resource-group-create-multiple.md#variable-iteration).
...
| címkét |Nem |Az erőforráshoz társított címkék. Címkék alkalmazása az erőforrások logikai rendszerezéséhez az előfizetésen belül. |
