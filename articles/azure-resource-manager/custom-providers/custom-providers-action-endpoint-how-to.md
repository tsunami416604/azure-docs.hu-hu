...
Egy **műveletet** végrehajtó **végpontnak** az új API-ra vonatkozó kérést és választ kell kezelnie az Azure-ban. Ha egy **művelettel** rendelkező egyéni erőforrás-szolgáltatót hoz létre, új API-készletet fog létrehozni az Azure-ban. Ebben az esetben a művelet új Azure Action API-t hoz majd `POST` hívásokhoz:
...
> [!NOTE]
> A műveletek korlátozott támogatást Azure Resource Manager sablonokban. Ahhoz, hogy a művelet meghívható legyen egy sablonon belül, tartalmaznia kell a [`list`](../templates/template-functions-resource.md#list) előtagot a nevében.
