...
> [!NOTE]
> A `id`, `name`és `type` mezők nem szükségesek, de az egyéni erőforrásnak a meglévő Azure-ökoszisztémával való integrálásához szükséges.
