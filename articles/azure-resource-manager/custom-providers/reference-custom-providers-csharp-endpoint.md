...
description: Alapszintű referenciát biztosít az Azure Custom Providers C# REST-végponthoz. A végpontot egy Azure Function-alkalmazáson keresztül biztosítjuk.
ms.topic: conceptual
