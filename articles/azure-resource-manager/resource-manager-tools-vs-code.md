---
title: Azure Resource Manager-sablonok létrehozása a Visual Studio Code használatával
...
![Visual Studio Code Resource Manager-eszközök bővítményeinek színezése](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-colorization.png)
...
- Beépített függvények nevei
    ...
    ![Visual Studio Code Resource Manager Tools Extensions IntelliSense-függvények](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-intellisense-functions.png)

- Paraméterek referenciái

    ![Visual Studio Code Resource Manager Tools Extensions IntelliSense-paraméterek](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-intellisense-parameters.png)

- Változó referenciái

    ![Visual Studio Code Resource Manager Tools Extensions IntelliSense-változók](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-intellisense-variables.png)

- resourceGroup () tulajdonságai

    ![Visual Studio Code Resource Manager Tools Extensions IntelliSense-függvények](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-intellisense-resourcegroup.png)
...
![A Visual Studio Code Resource Manager Tools Extensions Signature függvénye](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-signature-function.png)
...
![Visual Studio Code Resource Manager-eszközök bővítményei betekintés szerkesztő](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-peek-editor.png)
...
![A Visual Studio Code Resource Manager-eszközök bővítményei megkeresik az összes hivatkozást](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-find-all-references.png)
...
![Visual Studio Code Resource Manager-eszközök bővítményei hover-definíció](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-hover-parameters.png)
...
![Visual Studio Code Resource Manager-eszközök bővítményeinek megfeleltetése](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-brace-matching.png)
