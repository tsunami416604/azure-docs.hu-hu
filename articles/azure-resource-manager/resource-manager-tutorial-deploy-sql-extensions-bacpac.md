...
Ebben az oktatóanyagban használt sablon tárolva van egy [Azure Storage-fiók](https://armtutorials.blob.core.windows.net/createsql/azuredeploy.json). 
