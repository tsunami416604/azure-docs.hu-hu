...
Győződjön meg arról, hogy a Storage-fiók neve egyedi. Egyedi nevet hozhat létre az elnevezési konvenció összefűzésével a [uniqueString](resource-group-template-functions-string.md#uniquestring) függvény eredményével.
...
Győződjön meg arról, hogy a Storage-fiók neve nem hosszabb 24 karakternél. A [uniqueString](resource-group-template-functions-string.md#uniquestring) függvény 13 karaktert ad vissza. Ha egy előtagot vagy a Postfix-t ÖSSZEFŰZ a **uniqueString** eredményéhez, adjon meg egy 11 karakternél rövidebb értéket.
