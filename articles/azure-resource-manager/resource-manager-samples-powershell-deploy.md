...
|---|---|
| [Register-AzureRmResourceProvider](/powershell/module/azurerm.resources/register-azurermresourceprovider) | Egy erőforrás-szolgáltató regisztrálása, a erőforrástípusok telepíthető az előfizetéséhez.  |
