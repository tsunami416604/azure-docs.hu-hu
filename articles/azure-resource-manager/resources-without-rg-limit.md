...
A kvóták és korlátok teljes listáját az Azure- [előfizetés és a szolgáltatás korlátai, kvótái és](../azure-subscription-service-limits.md)megkötései című témakörben tekintheti meg.
