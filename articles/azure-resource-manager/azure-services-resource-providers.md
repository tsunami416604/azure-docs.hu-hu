---
title: Az Azure-szolgáltatások erőforrás-szolgáltatóinak Azure Resource Manager
...
| Microsoft. Data Lake Store | [Azure Data Lake Store](../storage/blobs/data-lake-storage-introduction.md) |
...
| Microsoft. Recoveryservices szolgáltatónál | [Site Recovery](../site-recovery/index.yml) |
...
További információ az erőforrás-szolgáltatókkal kapcsolatban: [Azure Resource Providers és types](resource-manager-supported-services.md)
