...
1. Ellenőrizze a **kind** (altípus) értékét a Visual Studio Code-ban. Ha az érték **Storage**, frissítse **StorageV2** értékre.

    ```json
    "kind": "StorageV2",
    ```
2. Egy további kimenet felvétele az exportált sablonba:
...
3. A fájl mentéséhez válassza a **Fájl**>**Mentés** lehetőséget.
