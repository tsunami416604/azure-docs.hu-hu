...
> [!NOTE]
> Korábban az Azure Customer Providers dokumentációja szerepelt a felügyelt alkalmazások dokumentációjában. A dokumentáció át lett helyezve. Most tekintse meg az Azure-beli [egyéni szolgáltatókat](../custom-providers/overview.md).
