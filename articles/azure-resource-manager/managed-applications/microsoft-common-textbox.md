...
- Ha a értéke `constraints.regex` `constraints.required` false ( **hamis**), megadható az érték. Ebben az esetben nincs szükség értékre a szövegmező sikeres ellenőrzéséhez. Ha meg van adva, meg kell egyeznie a reguláris kifejezési mintával.
