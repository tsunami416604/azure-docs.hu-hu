...
>[!IMPORTANT]
>Ha csatlakozik a US Gov-portálhoz, futtassa a következő parancsmagot:
> 
> ```powershell
...
Az Out-GridView parancsmag használatával is kiválaszthat egyet egy listából:
