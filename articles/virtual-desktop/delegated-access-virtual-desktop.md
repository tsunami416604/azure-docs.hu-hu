...
Futtassa a következő parancsmagokat létrehozása, megtekintése és szerepkör-hozzárendelések eltávolítása:
...
* **Remove-RdsRoleAssignment** törli a szerepkör-hozzárendeléseket.
