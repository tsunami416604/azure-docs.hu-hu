---
title: Windows rendszerű virtuális asztali előnézet gazdagép-készlet létrehozása Azure Resource Manager sablonnal – Azure
description: Gazdagépek létrehozása a Windows rendszerű virtuális asztali előnézetben Azure Resource Manager sablonnal.
