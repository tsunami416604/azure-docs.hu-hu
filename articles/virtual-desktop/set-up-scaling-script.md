---
title: Automatikus méretezés a munkamenet-gazdagépek – Azure
description: Ismerteti, hogyan állíthatja be az automatikus skálázási parancsfájl munkamenet gazdagépek Windows virtuális asztal (előzetes verzió).
