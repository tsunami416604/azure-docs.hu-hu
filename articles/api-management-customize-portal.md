...
-   [Change the text/logo in the page headers][Change the text/logo in the page headers]
-   [Change the styling of the headers][Change the styling of the headers]
-   [Edit the contents of a page][Edit the contents of a page]
...
-   Check out the other topics in the [Get started with advanced API configuration][Get started with advanced API configuration] tutorial.
