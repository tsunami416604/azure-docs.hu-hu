...
1. A Twilio-fiók és a hitelesítési jogkivonat. Első lépések a Twilio, kiértékelheti a díjszabás [ http://www.twilio.com/pricing ] [ twilio_pricing]. Iratkozzon fel a következő [ https://www.twilio.com/try-twilio ] [ try_twilio]. A Twilio által biztosított API-val kapcsolatos további információkért lásd: [ http://www.twilio.com/api ] [ twilio_api].
