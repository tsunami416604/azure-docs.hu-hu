...
## <a name="budget-alerts"></a>Budget alerts
...
## <a name="credit-alerts"></a>Credit alerts
...
## <a name="department-spending-quota-alerts"></a>Department spending quota alerts
...
| Alert type | Nagyvállalati szerződés | Microsoft Ügyfélszerződés | Web direct/Pay-As-You-Go |
|---|---|---|---|
| Budget | ✔ | ✔ | ✔ |
| Credit | ✔ |✘ | ✘ |
...
## <a name="view-cost-alerts"></a>View cost alerts
...
When you view the details of a dismissed alert, you can reactivate it if manual action is needed. Az alábbi képen egy példa látható.
