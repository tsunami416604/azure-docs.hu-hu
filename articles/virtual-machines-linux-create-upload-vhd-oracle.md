...
-   [Prepare an Oracle Linux 6.4+ Virtual Machine for Azure][Prepare an Oracle Linux 6.4+ Virtual Machine for Azure]
-   [Prepare an Oracle Linux 7.0+ Virtual Machine for Azure][Prepare an Oracle Linux 7.0+ Virtual Machine for Azure]

## Prerequisites

This article assumes that you have already installed an Oracle Linux operating system to a virtual hard disk. Multiple tools exist to create .vhd files, for example a virtualization solution such as Hyper-V. For instructions, see [Install the Hyper-V Role and Configure a Virtual Machine][Install the Hyper-V Role and Configure a Virtual Machine].
