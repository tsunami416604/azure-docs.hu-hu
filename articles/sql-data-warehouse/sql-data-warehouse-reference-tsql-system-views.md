...
* [sys. PDW _materialized_view_column_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-column-distribution-properties-transact-sql?view=azure-sqldw-latest) (előzetes verzió)
* [sys. PDW _materialized_view_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-distribution-properties-transact-sql?view=azure-sqldw-latest) (előzetes verzió)
* [sys. PDW _materialized_view_mappings](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-mappings-transact-sql?view=azure-sqldw-latest) (előzetes verzió)
...
## <a name="sql-data-warehouse-dynamic-management-views-dmvs"></a>SQL Data Warehouse dinamikus felügyeleti nézetek (DMV)
...
## <a name="sql-server-catalog-views"></a>SQL Server katalógus nézetei
...
* [sys. szerelvények](https://msdn.microsoft.com/library/ms189790.aspx)
...
* [sys. tanúsítványok](https://msdn.microsoft.com/library/ms189774.aspx)
...
* [sys. hitelesítő adatok](https://msdn.microsoft.com/library/ms189745.aspx)
...
* [sys. fájlcsoportok](https://msdn.microsoft.com/library/ms187782.aspx)
...
* [sys. indexek](https://msdn.microsoft.com/library/ms173760.aspx)
...
* [sys. eljárások](https://msdn.microsoft.com/library/ms188737.aspx)
...
* [sys. szinonimák](https://msdn.microsoft.com/library/ms189458.aspx)
...
* [sys. syslanguages rendszertáblában](https://msdn.microsoft.com/library/ms190303.aspx)
...
> [!NOTE]
> A nézetek használatához illessze be a "pdw_nodes_" nevet a névbe, ahogy az a következő táblázatban látható:
> 
> 
...
| sys. DM _pdw_nodes_os_dispatchers |A Transact-SQL dokumentációja nem érhető el. |
...
| sys. DM _pdw_nodes_os_memory_node_access_stats |A Transact-SQL dokumentációja nem érhető el. |
...
| sys. DM _pdw_nodes_os_spinlock_stats |A Transact-SQL dokumentációja nem érhető el. |
...
## <a name="sql-server-information_schema-views"></a>SQL Server ENTITÁSTULAJDONOS nézetek
...
* [TÁBLÁK](https://msdn.microsoft.com/library/ms186224.aspx)
