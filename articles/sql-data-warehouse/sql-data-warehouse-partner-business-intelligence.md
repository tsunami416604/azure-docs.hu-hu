...
| --- | --- | --- | --- |
| ![Birst][1] |**Birst**<br>Birst vezető felhőalapú üzleti Intelligencia és elemzés. Vállalatok hozhat létre az adatok minden üzleti felhasználó kontextusában egy megbízható forrásból. Ezután az üzleti felhasználók a szervezeten belül jelentést és elemezheti az adatokat a világszínvonalú BI-eszközök. |[Marketplace-en][birst_marketplace]<br>[Webhely][birst_website]<br>[Twitter][birst_twitter]<br>[YouTube][birst_youtube] | |
| ![ClearStory adatok][2] |**ClearStory adatok**<br>ClearStory adatok fast-ciklus elemzése lehetővé teszi a különböző adattárolókból adatokat az SQL Data Warehouse tárolja. A clearStory integrált Spark-alapú platform és az analytics alkalmazás sebességének adathozzáféréssel és -összehangolását, különálló készleteket. Gyors, együttműködő feltárása, amellyel a felhasználók számára szükséges információk feltárásához független kell lehetővé teszik. |[Webhely][clearstory_website]<br>[Adatlap][clearstory_datasheet]<br>[Twitter][clearstory_twitter]<br>[YouTube][clearstory_youtube] | |
