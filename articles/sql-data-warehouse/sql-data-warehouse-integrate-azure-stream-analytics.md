...
Azure 串流分析是完全受管理的服務，可用來對雲端中的串流資料進行低延遲、高可用性、可延展的複雜事件處理。 您可以藉由讀取了基本概念 [簡介 Azure 串流分析]][]。 然後，您就可以了解如何利用串流分析建立端對端解決方案，依照下列 [開始使用 Azure 資料流分析]][] 教學課程。

在本文中，您將學習如何使用 Azure SQL 資料倉儲資料庫做為串流分析工作的輸出接收器。

## 必要條件

首先，請完成下列步驟 [開始使用 Azure 資料流分析]][] 教學課程。
