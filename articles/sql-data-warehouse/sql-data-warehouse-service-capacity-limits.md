...
| sys. DM _pdw_dms_workers |A legutóbbi 1000 SQL-kérelmekhez tartozó DMS-feldolgozók száma összesen |
| sys. DM _pdw_errors |10,000 |
| sys. DM _pdw_exec_requests |10,000 |
| sys. DM _pdw_exec_sessions |10,000 |
| sys. DM _pdw_request_steps |A sys. DM _pdw_exec_requests tárolt legutóbbi 1000 SQL-kérelmekre vonatkozó lépések teljes száma. |
| sys. DM _pdw_os_event_logs |10,000 |
| sys. DM _pdw_sql_requests |A sys. DM _pdw_exec_requests tárolt legutóbbi 1000 SQL-kérelmek. |
