...
> [AZURE.NOTE] 藉由建立統計資料物件中，我們確定資料表中繼資料會更精確。 如果我們省略了建立統計資料，SQL 資料倉儲將會使用預設值。 如需有關統計資料，請檢閱 [統計資料] []。
...
>[AZURE.NOTE] 資料分割切換有相較於 SQL Server 的一些差異。 請務必先閱讀 [移轉您的程式碼] [] 若要深入了解這個主題。
