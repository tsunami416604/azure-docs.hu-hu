...
* [MUNKATERHELÉS-OSZTÁLYOZÓ LÉTREHOZÁSA](/sql/t-sql/statements/create-workload-classifier-transact-sql)
...
* [SET RESULT_SET_CACHING](/sql/t-sql/statements/set-statements-transact-sql) (előzetes verzió)
