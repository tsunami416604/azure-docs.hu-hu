...
1. [下載 Visual Studio 2015](https://www.visualstudio.com/downloads) 從 Visual Studio Team Services。 
2. 請依照安裝 [安裝 Visual Studio](https://msdn.microsoft.com/library/e2h7fzkw.aspx) MSDN 上的指南，然後選擇 [預設設定。
...
1. [下載 SQL Server 資料工具預覽](https://msdn.microsoft.com/library/mt204009.aspx) 2015年或 Visual Studio 2013。
2. 依照下載網站上的指示進行安裝。

## 後續步驟

有最新版本的 SSDT 之後，就可以開始 [連接](./sql-data-warehouse-get-started-connect.md) 到您的資料庫。
