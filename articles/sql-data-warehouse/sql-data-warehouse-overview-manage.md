...
A [Azure-portálon] [ Azure portal] egy webes portál, ahol létrehozása, frissítése, és törölni az adatbázisokat és adatbázis-erőforrások figyelése. Ez az eszköz kiváló, akkor csak használatának megkezdéséhez az Azure-ral, ha kis számú adatok kezelése adatraktár-adatbázisok, vagy gyorsan foglalkozhat kell.
...
[méretezhető teljesítmény]: quickstart-scale-compute-portal.md#scale-compute
