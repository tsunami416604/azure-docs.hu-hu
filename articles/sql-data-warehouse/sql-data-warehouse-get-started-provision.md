...
* **Azure SQL-kiszolgáló**: További információ: [Azure SQL Database logikai kiszolgáló létrehozása az Azure Portalon][Create an Azure SQL Database logical server with the Azure portal].
