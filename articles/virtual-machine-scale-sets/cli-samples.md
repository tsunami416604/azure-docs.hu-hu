...
description: Egy tábla, amely az Azure CLI használatával létrehozott minta bash-parancsfájlokra mutató hivatkozásokat tartalmaz, például egy méretezési készlet létrehozása és kezelése.
author: ju-shim
