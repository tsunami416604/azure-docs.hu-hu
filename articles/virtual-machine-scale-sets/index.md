        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>A Virtual Machine Scale Sets használatának első lépései</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/virtualmachinescalesets/">Virtual Machine Scale Sets – REST API-referencia</a></p>
                    </div>
                </div>
            </div>
        </div>
