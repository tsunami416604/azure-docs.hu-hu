...
| [Egyzónás méretezési csoport létrehozása](scripts/powershell-single-av-zone-scale-set.md?toc=%2fpowershell%2fazure%2ftoc.json) | Olyan virtuális-gép méretezést hoz létre, amely egyetlen rendelkezésre állási zónát használ. |
