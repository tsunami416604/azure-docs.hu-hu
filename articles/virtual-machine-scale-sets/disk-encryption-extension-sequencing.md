...
Ha azt szeretné, hogy a Azure Disk Encryption egy másik bővítmény előtt is alkalmazza, helyezze a `provisionAfterExtensions` tulajdonságot a következőre a bővítmény blokkjában.
