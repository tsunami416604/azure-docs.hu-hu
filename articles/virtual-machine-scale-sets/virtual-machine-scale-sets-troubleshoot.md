...
---
# <a name="troubleshooting-autoscale-with-virtual-machine-scale-sets"></a>Az autoskálázás hibaelhárítása Virtual Machine Scale Sets
**Probléma** – a Azure Resource Manager a virtuálisgép-méretezési csoportok használatával létrehozott egy automatikus skálázási infrastruktúrát, például egy sablon üzembe helyezésével: https://github.com/Azure/azure-quickstart-templates/tree/master/201-vmss-bottle-autoscale – megadhatja a méretezési szabályokat, és nagyszerűen működik, kivéve a virtuális gépekre helyezett terhelések mennyiségét, nem automatikus méretezéssel.
...
* Be-vagy kibővítheti a manuális méretezést?
    ...
    Próbálja meg újratelepíteni a virtuálisgép-méretezési csoport erőforrását egy másik "kapacitás" beállítással a virtuális gépek számának manuális módosításához. Példa erre a sablonra: https://github.com/Azure/azure-quickstart-templates/tree/master/201-vmss-scale-existing – előfordulhat, hogy szerkesztenie kell a sablont, hogy megbizonyosodjon róla, hogy a méretezési csoport által használt számítógép mérete azonos. Ha sikeresen megváltoztathatja a virtuális gépek számát manuálisan, akkor tudja, hogy a probléma el van különítve az autoscale-re.
...
* A diagnosztikai bővítmény működik és kibocsátja a teljesítményadatokat?
  ...
  * Megbízhatóbb jelentéskészítés és az új virtuális gépek gyorsabb elindítása.
    ...
    * A fórumok beolvasása az [MSDN webhelyen](https://social.msdn.microsoft.com/forums/azure/home?forum=WAVirtualMachinesforWindows)vagy a [verem túlcsordulása](https://stackoverflow.com/questions/tagged/azure) 
