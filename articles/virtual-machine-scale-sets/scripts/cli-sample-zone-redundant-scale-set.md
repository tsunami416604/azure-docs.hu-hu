...
ms.locfileid: "55983185"
---
# <a name="create-a-zone-redundant-virtual-machine-scale-set-with-azure-cli"></a>Hozzon létre egy zónaredundáns virtuálisgép-méretezési csoportot az Azure CLI-vel
