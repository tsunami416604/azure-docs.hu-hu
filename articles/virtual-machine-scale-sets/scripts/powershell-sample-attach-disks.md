...
description: Ez a parancsfájl létrehoz egy Azure virtuálisgép-méretezési készletet, és csatolja és előkészíti az adatlemezeket a PowerShell használatával.
author: ju-shim
