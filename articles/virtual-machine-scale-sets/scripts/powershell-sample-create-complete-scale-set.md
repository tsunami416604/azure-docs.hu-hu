---
title: Azure PowerShell-minták – Teljes virtuálisgép-méretezési készlet létrehozása
description: Ez a parancsfájl egy Windows Server 2016 rendszerű virtuálisgép-méretezési készletet hoz létre, amelyben az egyes erőforrások konfigurálva és létrehozva vannak.
author: cynthn
...
Ez a szkript létrehoz egy Windows Server 2016 rendszert futtató virtuálisgép-méretezési csoportot. Az egyes erőforrások konfigurálása és létrehozása, nem pedig a [New-AzVmss alkalmazásban elérhető beépített erőforrás-létrehozási lehetőségek](powershell-sample-create-simple-scale-set.md)használata. A szkript futtatása után a virtuálisgép-példányokat RDP-kapcsolaton keresztül érheti el.
