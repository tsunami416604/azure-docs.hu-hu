...
A [Get-AzVmss](/powershell/module/az.compute/get-azvmss?view=azps-3.7.0) parancsmag és a *InstanceView* paraméter használatával megtekintheti az automatikus példányok javításának *ServiceState* .
