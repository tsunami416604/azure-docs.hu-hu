...
- A Piactéri szolgáltatási díj 20%-ról 10%-ra csökken. Ez a kedvezmény a kereskedelmi Piactéren keresztül eladott IaaS vagy SaaS-ajánlatra vonatkozik. További információ: [csökkentett szolgáltatási díj](marketplace-commercial-transaction-capabilities-and-considerations.md#reduced-service-fee) .
...
||IP- *without* ajánlatok [közös értékesítés nélkül lehetőség a partner Centerben](./partner-center-portal/commercial-marketplace-co-sell.md)|<ul><li>A kötelező közös értékesítéshez szükséges dokumentáció biztosítására irányuló kérelem a [Felhőbeli szakértőkkel](https://partner.microsoft.com/campaigns/ced-nomination-form/) való együttműködéshez.</li></ul>|Közös értékesítés kész|
