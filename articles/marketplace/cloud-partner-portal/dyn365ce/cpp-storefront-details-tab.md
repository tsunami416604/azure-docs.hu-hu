...
Használja a **kirakat részletek** fülre, és adja meg az értékesítési és marketing és összetevők.  Ezen a lapon az alábbi hat szakaszokat tartalmazza: **Az ajánlat részletei**, **részleteket felsoroló**, **Marketing-összetevők**, **jogi**, **ügyfél-támogatási**,  **Felügyeleti vezethet**.  Egy címke, kiegészítve a csillag (*) azt jelzi, hogy azt szükséges.


## <a name="offer-details-section"></a>Az ajánlat részletei szakasz

Az összegzés és az ebben a szakaszban az ajánlat leírása, biztosít.  Ezzel a beállítással hangsúlyosan megjelenő információk a Marketplace-en.
...
A piactéren, listázás, ebben a szakaszban adatait biztosítja.
...
Ebben a szakaszban Ön marketinganyag biztosítja: embléma képeket, promóciós vagy Blueprint videó, termék dokumentációját és felhasználói felület képernyőképeket.

![Marketing-összetevők szakaszban az áruház oldala részletei lapon](./media/storefront-tab-market-artifacts.png)
...
Ön biztosítja *adatvédelmi szabályzat* és *használati feltételeket tartalmazó fájl* ebben a szakaszban az alkalmazás.

![Jogi szakaszban az áruház oldala részletei lapon](./media/storefront-tab-legal.png)
...
Ebben a szakaszban Ön biztosítja a **Adresa URL** az alkalmazáshoz.


## <a name="lead-management-section"></a>Elégtelen területén

Ebben a szakaszban a generált az ajánlat listaelem érdeklődők kezeléséhez a mechanizmus biztosítja.  Érdeklődők általában ügyfélkapcsolat-kezelő (CRM) rendszerben vannak tárolva.  A következő célok támogatottak: **Nincs**, **Azure-tábla**, **Dynamics CRM Online**, **HTTPS-végpont**, **Marketo**, és **Salesforce-ban** .  További információkért lásd: [ügyfélérdeklődések lekérése](../../cloud-partner-portal-orig/cloud-partner-portal-get-customer-leads.md).


## <a name="next-steps"></a>További lépések

Ezután Ön biztosítja az műszaki és az ügyfél támogatja az adatok a [kapcsolattartók lapon](./cpp-contacts-tab.md). 
