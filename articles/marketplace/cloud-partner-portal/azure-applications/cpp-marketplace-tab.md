---
title: Az Azure application ajánlat Marketplace lap
...
A következő táblázat ismerteti a egy az ajánlatban kirakatban létrehozásához használni kívánt beállításokat.   Kiegészítve a csillag a mező kitöltése kötelező.
...
| **Összefoglalás\***      | Az ajánlat rövid összefoglalása. A hossza legfeljebb 100 karakterből állhat.           |
...
| **Hasznos hivatkozások**    | Szükség esetén megadhat különböző forrásokra mutató hivatkozásokat a felhasználók számára az Ön ajánlatát, például a támogatási, dokumentáció, fórumokat, stb.  Javasoljuk, hogy hozzá legalább egy hivatkozást a dokumentációjában.            |
| **Javasolt kategóriák (max. 5)\*** | Válassza ki az öt kategóriába. A kiválasztott kategóriákra az ajánlat leképezése az Azure Marketplace-en és az Azure Portalon elérhető termékkategóriák szolgálnak. Ezek megjelenik, Tallózás oldalak és a termék részletes információját. |
|  |  |
...
|      Mező         |    Leírás    |
|  ---------------   |  ---------------  |
| **Kis\***        | Kisebb emblémát: 40 x 40 képpontos PNG formátumban     |
| **Közepes\***       | Közepes méretű embléma: 90 x 90 képpontos PNG formátumban    |
| **Nagy méretű\***        | Nagy méretű embléma: 115 x 115 képpontos PNG formátumban   |
| **Széles körű\***         | Széles körű embléma: 255 x 115 képpontos PNG formátumban    |
| **Fő kép**           | Nem kötelező hero embléma: 815 x 290 képpontos PNG formátumban. **Megjegyzés:** Nem lehet törölni a hero ikonra, a feltöltés után. |
