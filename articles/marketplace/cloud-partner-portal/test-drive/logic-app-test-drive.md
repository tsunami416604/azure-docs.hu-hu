...
- **Tesztelési meghajtó időtartama (óra) –** *[kötelező mező]* időtartam, ameddig a tesztvezetés aktív marad, \# óra alatt. A tesztelési meghajtó automatikusan leáll az adott időszak lejárta után.
...
Az **Azure ad-bérlő azonosítója** *[kötelező mező]* ha már elérhető bérlői azonosító, a tulajdonságok-címtár-\> azonosítóban találhatja meg azt.
...
1. Írja be az Azure AD-alkalmazás nevét, és válassza ki azt az alkalmazást, amelyhez hozzá szeretné rendelni a szerepkört.
    ![Engedélyek Azure Active Directory](./media/azure-resource-manager-test-drive/SetupSub7_2.jpg)
