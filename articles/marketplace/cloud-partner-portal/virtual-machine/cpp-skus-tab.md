---
title: Virtuális gép SKU-k lapot a Cloud Partner portálra, az Azure Marketplace-en
...
![A virtuális gépek az új ajánlat űrlap Termékváltozat lap](./media/publishvm_006.png)

A következő táblázat ismerteti a célja, a tartalmát, és ezek a mezők formázását.  Kötelező mezőt csillag (*) rendszer feltehetően.
...
| **Összefoglalás\***      | Az ajánlatot a piactéren való megjelenítéshez tömör leírása. A hosszabb 100 karakternél. |
...
* A Microsoft bizonyos országokban vagy régiókban, osztályozza *országok elengedik adó*.  Ilyen országban és régióban a Microsoft adók gyűjt az ügyfelektől származó, majd a kormányzati (kap) adók fizet.  Más országok/régiók, a partnerek felelős általában adók gyűjtését az ügyfeleknek, és az adók és a kormány. Ha az utóbbi országokból vagy régiókból értékesíthetnek választja, kiszámításához és a helyi adók fizetnie kell rendelkeznie.  <!-- TD: Find a good reference on taxing policies. The best I found was in the UWP section: https://docs.microsoft.com/windows/uwp/publish/tax-details-for-paid-apps -->
...
Igény szerint fog megadni [Test Drive](./cpp-test-drive-tab.md) információ Ha támogatja a funkcióról; ellenkező esetben adnia [marketplace](./cpp-marketplace-tab.md) az ajánlat adatait.
