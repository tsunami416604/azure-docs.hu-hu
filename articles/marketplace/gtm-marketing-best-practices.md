...
A Piactéri ajánlat és a vonatkozó kötelezettségvállalást, ügyfélközpontú igény szerint súgó, az üzleti növekedés elősegítése minőségét. Az engagement ezeknek a tevékenységeknek a segítségével a Microsoft GTM dolgozni, ahhoz, hogy a szolgáltatás legfontosabb megoldások kirakattípus a Marketplace-en keresztül bővítésére.

Miután létrehozott egy nagyszerű listázása, a következő marketing kezdeményezések segít terjessze ki üzleti tevékenységét:

* *Hozzon létre egy erős értékajánlatát.* <br>Azonosítsa a potenciális ügyfél és a kulcs versenytársaink, hogy a megoldás.

* *Hozzon létre egy egyedi kezdőlapja, hogy az alkalmazás leírására kitűnjön a webhelyen.* <br> Meghajtó a forgalmat a helyről az ajánlatra, és adja meg egy nagyszerű első benyomást. Az ajánlat lista alapján, ügyfelek döntse el, hogy szeretnének-e további, és próbálja ki a megoldásokat.

* *Engedélyezze a tesztverziós vagy más kipróbálására nyújt lehetőséget.* <br> Felhasználók szeretné az alkalmazás kézből tapasztalható. A kiadók hagyományosan láthatta sokkal magasabb érdeklődő átváltási árfolyamok, listák, amelyek egy tesztverziós vagy próbaverzió kínálnak.

* *A lista boost search engine módosítják a rangsort segítségével optimalizálhatja.* <br> Építse be az alkalmazás neve, Összegzés és listázása a keresési kulcsszavakat. 
...
Marketingkampány promóciós tevékenységek és a marketing, amely elsődleges célja a végrehajtani kívánt műveletet, vagy egy serkenti az eredményt éri közönségét vezetési taktika sorozatát. Ahogy a kampány tervez, vegye figyelembe az alábbi ajánlott eljárásokat:
...
* *Van a próbaverziót, állítsa be a Marketplace-en.* A termék használatához a bizonyos szintű engagement, és felület, vásárlás előtt. Fontolja meg a kampány célja a letöltött kísérletek számát. Ebben az esetben a kampány taktika művelet meghívásához lenne koncentrálhat, jelentősen lecsökkenti a próbaverzió a Marketplace-en.
...
* A céljainak célzott maradnak.
* Rendelje meg, amelyek igazodnak a céljai elérése érdekében integrált marketing taktika készletét.

Folyamatban van az új kiadóvá a piactéren részeként ingyenes marketplace GTM előnyt Microsofttól kapott. Úgy gondolja, hogy kritikus fontosságú ezeket az előnyöket a kampány stratégia használatával kapcsolatban. Lehetővé teszik a marketinges csapata számára a Marketplace-en kampány céljait és a kívánt célközönség művelet. A Microsoft segítségével testre szabhatja a tervbe működéséhez ezeket le.
...
### <a name="available-on-appsource-or-azure-marketplace-badge"></a>Elérhető az appsource-ban vagy az Azure Marketplace-jelvény

Ha az ajánlat az appsource-ban vagy az Azure piactéren, ezért az előnye, hogy megjelenítése a *az appsource-on elérhető* vagy *Azure Marketplace-en elérhető* jelvény a webhelyen.
...
Az ingyenes részeként biztosított Azure Marketplace-en jelvény [piaci megjelenést előnyökkel](./gtm-your-marketplace-benefits.md).
