...
| "További információ" dokumentumok | A "További információ" sales and marketing és eszközök támogatása a következők:<br>Például tanulmányok, brosúrák, ellenőrzőlisták vagy PowerPoint-bemutatókat. Minden fájl PDF formátumban lehet menteni. A cél tájékoztassa az ügyfeleket, azokat nem értékesíthetik kell lennie.<br><br>Hivatkozás hozzáadása az alkalmazás kezdőlapját, így az összes dokumentumot, és adja hozzá az URL-paraméter látogatók és kísérletek nyomon követéséhez. |
| Videók: Appsource-ban, tanácsadási szolgáltatásokat, és csak az SaaS-ajánlatok | A legerősebb videók kommunikálni az ajánlat nyújt narratíva formájában értékét:<br>Győződjön meg arról, az ügyfél, nem a vállalat, a fő képet, a történetet. A videó kell foglalkozni, az egyszerű kihívások és a cél ügyfél céljainak.<br><br>Ajánlott hossza: 60 – 90 másodperc.<br><br>Beépíthet kulcs keresőszavak, amely a videók nevét használja.<br><br>Fontolja meg további videók, például egy útmutató, első lépések vagy ügyfélajánlást. |
...
* Érdeklődő megosztás engedélyezéséhez.<br>Szerezze be az ügyfelek kapcsolattartási adatait, a alkalmazás közvetlenül a CRM-rendszerbe megkísérlésekor. Ellenőrizze, hogy már működik a folyamat a követéséhez új érdeklődők válaszaránya.
...
A a [Cloud Partner Portalon](http://cloudpartner.azure.com/#insights) a dokumentáció a Microsoft a kampányok. A dokumentáció segítségével állítsa be, és nyomon követheti a kampányok.
