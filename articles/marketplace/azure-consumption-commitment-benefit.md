---
title: Az Azure-beli felhasználási kötelezettségvállalás előnyei – Azure Marketplace
description: A Microsoft kereskedelmi Marketplace-ajánlatok készlete hozzájárul a szervezet Microsoft Azure fogyasztási kötelezettségvállalásához
...
ms.locfileid: "98601364"
---
# <a name="azure-consumption-commitment-benefit"></a>Az Azure-beli használati kötelezettségvállalás előnyei

A Microsoft kereskedelmi piactérek kiválasztott csoportja a szervezet Microsoft Azure fogyasztási kötelezettségvállalását fogja támogatni, ha a szervezete rendelkezik a következő szerződések valamelyikével:

- Microsoft Azure fogyasztási kötelezettségvállalás (MACC)
- Azure-véglegesítés a felhasználáshoz (CtC)

A programban részt vevő összes ajánlatot érvényesítjük, így biztosítva, hogy magas színvonalú megoldásokat kapjon.

Az előny kihasználása érdekében egyszerűen vásárolhat az Azure Marketplace-en egy olyan előfizetést, amely az Azure-szerződéshez kapcsolódik. Az Azure-előfizetések (korábbi nevén pénzügyi kötelezettségvállalás) nem jogosultak erre az előnyre.
...
Ha nem biztos abban, hogy a szervezete rendelkezik-e megfelelő szerződéssel, jelentkezzen be a piactéren a [Azure Portalon](https://ms.portal.azure.com/#blade/Microsoft_Azure_Marketplace/MarketplaceOffersBlade/selectedMenuItemId/home) belül a szervezethez társított bérlő alatt. Ha úgy látja, hogy az **Azure-kedvezmény csak** szűrési lehetőségként van kiválasztva, az Azure-beli használati kötelezettségek érvényesek. Az Azure Marketplace-beli vásárlások beszerzése hozzájárul a szervezet Azure-beli fogyasztási kötelezettségvállalásához, ha közvetlenül az Azure Piactéren keresztül vásárol.
