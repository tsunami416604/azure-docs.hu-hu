...
- **Átirányítási oldal**: oldal közzététele a ki webes jelenlétét, amely ismerteti az összes Azure vizsgálati meghajtóval, és több hivatkozási kapcsolat irányítja a forgalmat a test Drive-bA közzététele
- **Közösségi média**: ahol közzéteheti a közösségi csatornákat az információ a test drive rendszeres ütemezés létrehozása
- **Blogok**: egy blogbejegyzés írási tudnivalók az Azure kipróbálása. Jelölje ki a funkciók és előnyök, a felhasználó kap díjmentesen és a nagyon rövid ideig ingyenes tapasztalhat. Győződjön meg arról, az Azure vizsgálati meghajtó oldalát a blog másolás több helyen mutató hivatkozást. Íme egy minta Azure tesztverziós kapcsolatos blog-bejegyzésre mutató hivatkozást. Még jobb? A blogbejegyzés mutató hivatkozások küldése a közösségi csatornákat.
- **E-mailek gondozásának biztosításáig**: értesíti, amely rendelkezik foglalkozom a más csatornákon keresztül a márka e-mailben tájékoztatja őket a próba érdeklődőkkel meghajtó, és ösztönzés ingyenesen kipróbálhatja.
- **Értékesítési képzési lehetőségek és eszközök**: állítsa be a betanítás a bemutató a test drive élményt és kapja meg néhány módszer az értékesítési csoport is vesznek az érdeklődők és ügyfelek azt. Értékesítési azok számára is beállítása egy bemutatót egy vállalat több kapcsolattartókat, majd küldje el azok a hivatkozást a test Drive ezt követően, hogy maguk is.
...
- Van olyan sikertörténete, ahol a tesztverziós érdeklődő jön létre, vagy zárja be a üzletet segített? E-mailt küldjön <amp-testdrive@microsoft.com> megtudhatja, hogyan akkor is első kiemelt a kezdőlap meg!
