...
-   Hozza létre a Microsoft-fiók egy olyan e-mail-címmel,\'amely a vállalati s tartományhoz tartozik, de nem egyetlen személynek sem. Például windowsapps\@fabrikam.com.
...
2.  Válassza a bal oldali menüben a **kifizetési fiók** kiválasztása **Choose payment method**lehetőséget, és válassza a **Bankszámla** vagy a **PayPal**lehetőséget.
