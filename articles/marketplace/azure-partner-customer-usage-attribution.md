---
title: Az Azure partner- és ügyfél-használati attribution |} Az Azure Marketplace-en
...
```
További információkért lásd: [Góhoz készült Azure SDK](https://docs.microsoft.com/go/azure/).
