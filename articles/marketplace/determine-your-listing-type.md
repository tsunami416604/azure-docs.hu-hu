---
title: Állapítható meg a lista tartalmazza az Azure piactéren
...
>[!NOTE]
>Korlátozhatja a felderítés és a virtuális gép telepítését az ügyfelek egy adott csoportjának listázása a lemezképet, és egy személyes ajánlat, árképzési. Személyes ajánlatokat az közzétevők legközelebbi ügyfeleiknek kizárólagos ajánlatok létrehozása és testre szabott szoftver és a feltételeket, hogy azok képesek zárolásának feloldásához. Ezek a testreszabott feltételek engedélyezése kiadóinak bonyolít le különféle forgatókönyvekhez, amik, beleértve a speciális díjszabási feltételei, valamint korlátozott kiadású szoftver korai eléréséhez mező által vezetett vonatkozik. Ez lehetővé teszi, hogy ahhoz, hogy megkapja az adott árképzési gyártók és az ügyfelek korlátozott számú termékek hozzon létre egy új SKU az adatokkal. További információ [saját ajánlatok](https://azure.microsoft.com/en-us/blog/private-offers-on-azure-marketplace/).

Használja egy *Azure alkalmazás megoldássablonban* amikor megoldást igényel a virtuális készülék túl további üzembe helyezési és konfigurálási automation. Megoldás sablonok automatizálhatja egy vagy több virtuálisgép-erőforrások kiépítése, és a hálózati és tárolási erőforrásokat oszthat. Megoldás sablonok automation előnyt biztosíthatnak, egyetlen virtuális gépek és a teljes IaaS-alapú megoldás környezetekben. Megoldás sablonok létrehozásával kapcsolatos további [GitHub](https://github.com/MicrosoftDocs/azure-docs).
...
A Szolgáltatottszoftver-alapú, műszaki megoldások, használja a *SaaS-alkalmazás* nyújtanak ahhoz, hogy a megoldás a Azure piactérről előfizetés megvásárlásához Azure ügyfelek típusa. Ez a funkció használatához közzétevők kell árazása és a szolgáltatás egyszerű, havi díj kiszámlázni és lehetővé teszik a frissítés, vagy szakítsa meg a szolgáltatás bármikor. Például a virtuális gépek a Microsoft commerce-tranzakciót futtat, és az ügyfél nevében a közzétevő váltók stb. Közzétevők előfizetés számlázási egy SaaS-alkalmazás használatához engedélyezze a saját előfizetés felügyeleti szolgáltatás API, és közvetlenül kommunikáljanak az Azure piactér létesítési támogatására létesítési szolgáltatás API-k, frissítések és visszavonás az Azure portálról.

Használjon *tárolók* közzététele a megoldás Docker tároló képként kell létrehozni, hogy egy Kubernetes-alapú Azure tárolószolgáltatás, Azure Kubernetes szolgáltatás vagy az Azure-tároló példányok, például a felhasználó kiválasztása Futásidejű Kubernetes-alapú tárolót. A Microsoft jelenleg szabad és BYOL-kompatibilis licencelési modellek további, a következő néhány hónapon, beleértve az előfizetés és számlázási lehetőségek fogyasztás alapján keresztül érkező commerce lehetőségekkel.
