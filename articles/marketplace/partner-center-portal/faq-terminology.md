...
| Ajánlat típusa: Azure-alkalmazás| Rendelés | Használja az Azure-alkalmazás megoldás-sablonjának ajánlat típusát, ha a megoldáshoz egy egyszerű virtuális gépen kívül további üzembe helyezési és konfigurálási automatizálásra van szükség.|
...
| Termékváltozat| Rendelés| A közzététel során definiált SKU (már megnevezett terv) neve. Egy ajánlatnak több SKU (csomag) is lehet, de mindegyik csak egyetlen ajánlattal társítható.|
