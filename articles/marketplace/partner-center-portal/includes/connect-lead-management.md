...
1. Válasszon egy érdeklődési célt, ahová küldhetjük az érdeklődőket. A következő CRM-rendszerek támogatottak:
    ...
    * [Salesforce](../commercial-marketplace-lead-management-instructions-salesforce.md)
    ...
    Ha a CRM-rendszer nincs kifejezetten támogatva ezen a listán, az ügyfél-érdeklődő adatait az alábbi beállítások használatával tárolhatja. Ezt követően exportálhatja vagy importálhatja ezeket az adatait a CRM-rendszerbe.
