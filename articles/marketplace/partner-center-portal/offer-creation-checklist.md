...
| [A csomag díjszabása és rendelkezésre állása lap](#plan-pricing-and-availability-page)  | Csak akkor érhető el, ha az ajánlatot a Microsofton keresztül adja el.  Összegyűjti az üzleti jellemzőit (díjszabási modell), a célközönséget és a piac rendelkezésre állását az ajánlat minden egyes csomagjában (verzióban).  |
...
| Ajánlat URL-címe  | Kötelező, ha a "Letöltés most" lehetőség van kiválasztva, ahogyan az ügyfeleknek az ajánlati listához kell lépniük. |
...
| Emblémák tárolása (kicsi, közepes, nagy)  | A nagyméretű embléma (216 x 216 és 350 x 350 px) megadása kötelező. A partner Center ezt használva létrehoz egy kis (48 x 48 px) és közepes (90 x 90 px) emblémát. Ezeket később is lecserélheti a különböző rendszerképekre. Az emblémának PNG formátumúnak kell lennie. |
...
## <a name="plan-pricing-and-availability-page"></a>A csomag díjszabása és rendelkezésre állása lap
