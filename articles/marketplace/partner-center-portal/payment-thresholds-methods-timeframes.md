...
> [!NOTE]
> Ha további információt szeretne arról, ha a Microsoft a tranzakció bekövetkezte után kifizetést bocsát ki a kereskedelmi piactéren, tekintse meg a [kifizetési szabályzat részleteit](./payout-policy-details.md).
...
Általában a hónap 15. napján egy adott hónapban esedékes fizetést küldünk. Azonban további időt vesz igénybe, hogy a fizetés elérje a fiókját. A napok száma a fiókhoz használt fizetési módtól függően változhat az alább leírtak szerint.

| Payment Method (Fizetési mód) | A fiók elérésének hozzávetőleges napjai |
| --- | --- |
| PayPal | 1 munkanap |
...
## <a name="payment-methods-in-countries-and-regions"></a>Fizetési módok az országokban és a régiókban

Ezek azok az országok és régiók, amelyekben a fenti fizetési módszereket használják a piactéren. A fizetési küszöbérték minden esetben $50 USD.
...
- [Fizetési összegzés áttekintése](./payout-summary-overview.md)
