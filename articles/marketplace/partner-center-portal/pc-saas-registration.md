...
2.  Ha a fiók lehetőséget biztosít több mint egy eléréséhez, kattintson a jobb felső sarokban az Ön fiókjához, és állítsa be a portál munkamenet a kívánt Azure ad-bérlőben.
...
|  Resource           | True (Igaz)         |  A célerőforrás, amelyre a jogkivonat kérik. Az alapértelmezett érték `62d94f6c-d599-489b-a797-3e10e42fbe22`. |
|  |  |  |
...
Az Azure AD által védett alkalmazás most már használhatja a [SaaS teljesítése API 2-es verzió](./pc-saas-fulfillment-api-v2.md).
