...
|--------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| earningId                      | Az egyes keresések egyedi azonosítója                                                                                                       | Összes                                                            |
| participantId                  | A program keretében keresett partner elsődleges identitása                                                                            | Összes                                                            |
| participantIdType              | Az ösztönző programokhoz és az értékesítőhöz általában az áruházbeli programok és az Azure Marketplace program azonosítója                                          | Összes                                                            |
| participantName                | A jövedelemszerzési partner neve                                                                                                              | Összes                                                            |
| partnerCountryCode             | A kereső partner helye/országa                                                                                                  | Összes                                                            |
| Programnév                    | Ösztönző/tároló program neve                                                                                                             | Összes                                                            |
| Tranzakcióazonosító                  | A tranzakció egyedi azonosítója                                                                                                    | Összes                                                            |
| transactionCurrency            | A pénznem, amelyben az eredeti ügyfél-tranzakció bekövetkezett (ez nem a partneri hely pénzneme)                                     | Összes                                                            |
| transactionDate                | A tranzakció dátuma. Olyan programok esetében hasznos, amelyekben sok tranzakció járul hozzá egy adott keresethez                                           | Összes                                                            |
| transactionExchangeRate        | A megfelelő tranzakció USD-értékének megjelenítésére használt árfolyam dátuma                                                                 | Összes                                                            |
| transactionAmount              | A tranzakció összege az eredeti tranzakció pénznemében, amely alapján létrejött a kereset                                              | Összes                                                            |
| transactionAmountUSD           | Tranzakció összege USD-ben                                                                                                                | Összes                                                            |
| szintje                          | Üzleti szabályt jelez a beszerzéshez                                                                                                  | Összes                                                            |
| earningRate                    | Tranzakciós mennyiségre alkalmazott ösztönző arány a kereset létrehozásához                                                                      | Összes                                                            |
| quantity                       | A programtól függően változhat. A tranzakciós programok számlázott mennyiségét jelzi.                                                            | Összes                                                            |
| quantityType                   | A mennyiség típusát jelzi, például: számlázott mennyiség, MAU                                                                             | Összes                                                            |
| earningType                    | Azt jelzi, hogy díj, árengedmény, Co-op, értékesítés stb.                                                                                          | Összes                                                            |
| earningAmount                  | Jövedelemszerzési összeg az eredeti tranzakció pénznemében                                                                                      | Összes                                                            |
| earningAmountUSD               | Jövedelemszerzési összeg USD-ben                                                                                                                    | Összes                                                            |
| earningDate                    | A kereset dátuma                                                                                                                      | Összes                                                            |
| calculationDate                | A keresett adat kiszámításának dátuma a rendszeren                                                                                            | Összes                                                            |
| earningExchangeRate            | A megfelelő USD összeg megjelenítéséhez használt árfolyam                                                                                  | Összes                                                            |
| exchangeRateDate               | Az EarningAmount USD kiszámításához használt Exchange-árfolyam dátuma                                                                                   | Összes                                                            |
| paymentAmountWOTax             | Fizetési összeg (ÁFA nélkül) a csak az "eljuttatott" kifizetésekért fizetendő pénznemért                                                                 | Összes                                                            |
| paymentCurrency                | Fizessen a partner által a fizetési profilban kiválasztott pénznemre. Csak az eljuttatott kifizetések esetében látható                                                   | Összes                                                            |
| paymentExchangeRate            | A paymentAmountWOTax a fizetési pénznemben való kiszámításához használt Exchange-árfolyam a ExchangeRateDate használatával                                            | Összes                                                            |
...
| paymentStatus                  | Fizetési állapot                                                                                                                           | Összes                                                            |
| paymentStatusDescription       | A fizetési állapot rövid leírása                                                                                                   | Összes                                                            |
...
| productName                    | A tranzakcióhoz csatolt terméknév                                                                                                       | Összes                                                            |
...
| customerCountry                | Ügyfél országa                                                                                                                         | Az áruház és az Azure Marketplace                                    |
...
| Fizetési pénznem        | Az a pénznem, amelyben a fizetést elvégezték                                                                                                                                       |
