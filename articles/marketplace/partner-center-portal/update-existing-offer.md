---
title: Meglévő ajánlat frissítése – Microsoft kereskedelmi piactér
description: Egy meglévő kereskedelmi Piactéri ajánlat vagy csomag frissítése, privát célközönségek szinkronizálása és ajánlat eltávolítása.
...
Ez a cikk bemutatja, hogyan végezheti el a meglévő ajánlatok és csomagok frissítését, valamint azt is, hogyan távolíthat el ajánlatot a kereskedelmi Piactérről. Az ajánlatokat a partner Center [kereskedelmi piactér portáljának](https://partner.microsoft.com/dashboard/commercial-marketplace/offers) **Áttekintés** lapján tekintheti meg.

## <a name="update-a-published-offer"></a>Közzétett ajánlat frissítése
...
Hajtsa végre ezeket a lépéseket egy új csomag egy már közzétett ajánlathoz való hozzáadásához.
...
1. Hozzon létre egy új tervet az [irányelvek](../plans-pricing.md) alapján a **meglévő csomagok díjszabási modelljének** használatával.
1. A terv nevének módosítása után válassza a **Piszkozat mentése** lehetőséget.
1. Válassza a **Közzététel** lehetőséget, amikor készen áll a frissítések közzétételére. Megnyílik a **[felülvizsgálat és közzététel](../review-publish-offer.md)** lap, amely a frissítések befejezési állapotát biztosítja.

## <a name="update-a-plan-for-an-existing-offer"></a>Meglévő ajánlat tervének frissítése
...
## <a name="compare-changes-to-your-offer"></a>Az ajánlat változásainak összehasonlítása

Mielőtt közzéteszi az élő vagy [előnézeti](#compare-changes-to-a-preview-offer) ajánlat frissítéseit, naplózhatja a mentett módosításokat az **összehasonlítás** lapon. Az **összehasonlítás** lapot bármely ajánlat oldal jobb felső sarkában érheti el, például a **Tulajdonságok** vagy az **ajánlat listázása** oldal. Az **összehasonlítás** oldalon az ajánlat mentett változásainak és a piactéren közzétett ajánlatnak az egymás melletti verziói láthatók.
...
2. Válassza ki a **legördülő menüt** , és módosítsa az **élő ajánlatból** az **előzetes** verzióra. Ha az ajánlat még nem járt életbe, nem fogja látni az **élő ajánlat** lehetőséget.
...
A Microsoft kereskedelmi piactéren eltávolíthat ajánlatokat és terveket, ami megakadályozza, hogy az új ügyfelek megtalálják és megvásárolják azokat. Azok az ügyfelek, akik korábban megszerezték az ajánlatot vagy a csomagot, továbbra is használhatják, és szükség esetén újra le is tölthetik. Azonban nem kapják meg a frissítéseket, ha úgy dönt, hogy újból közzéteszi az ajánlatot vagy megtervezi azt egy későbbi időpontban.

- Ha le szeretné állítani az ajánlat értékesítését, miután közzétette azt, válassza az **értékesítés leállítása** az **ajánlat áttekintése** oldalról lehetőséget. A megerősítéstől számított néhány órán belül az ajánlat már nem jelenik meg a kereskedelmi piactéren.

- A csomag értékesítésének leállításához válassza az **értékesítés leállítása** lehetőséget a **csomag áttekintése** lapon. A csomag értékesítésének leállítására szolgáló lehetőség csak akkor érhető el, ha az ajánlatban több csomag is található. Dönthet úgy is, hogy leállítja az egyik csomag értékesítését anélkül, hogy az ajánlaton belüli egyéb csomagokat befolyásolná.
     >[!NOTE]
     > Miután megerősítette, hogy meg szeretné szüntetni a csomag értékesítését, újra közzé kell tennie az ajánlatot a módosítás érvénybe léptetéséhez.

Az ajánlat vagy a csomag értékesítésének leállítása után a partner Centerben még **nem érhető el** állapot jelenik meg. Ha úgy dönt, hogy kilistázza vagy eladja ezt az ajánlatot vagy megtervezi, kövesse az utasításokat a [közzétett ajánlat frissítéséhez](#update-a-published-offer). Ne feledje, hogy a módosítások elvégzése után újra **közzé** kell tennie az ajánlatot, vagy újra kell terveznie azt.
