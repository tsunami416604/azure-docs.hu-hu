---
title: Hozzon létre egy új Dynamics 365 for Customer engagement & PowerApps ajánlat a kereskedelmi piactéren
description: Új Dynamics 365 létrehozása a Customer engagement & PowerApps az Azure Marketplace-en, a AppSource-on vagy a Cloud Solution Provider (CSP) programon keresztül, a Microsoft partner Center kereskedelmi Marketplace portáljának használatával történő listázásához és értékesítéséhez.
author: JnHs
manager: evansma
ms.author: jenhayes
...
A Dynamics 365 for Customer engagement & PowerApps-ajánlatok létrehozásához először [létre kell hoznia egy partner Center-fiókot](./create-account.md) , és meg kell nyitnia a [kereskedelmi piactér irányítópultját](https://partner.microsoft.com/dashboard/commercial-marketplace/offers), ahol az **Áttekintés** lapon be van jelölve.
...
Válassza az **+ új ajánlat** gombot, majd válassza ki a **Dynamics 365 for Customer engagement & PowerApps** menüpontot. Ekkor megjelenik az **új ajánlat** párbeszédpanel.
...
Adja meg az ajánlat verziószámát. Az ügyfelek ezt a verziót fogják látni az ajánlat részleteit tartalmazó oldalon. Ha csak a marketing/leíró változások miatt frissíti a verziószámot, jelölje be a **csak marketing módosítás** jelölőnégyzetet. Ez lehetővé teszi, hogy az ajánlat megkerüljék a minősítési és kiépítési fázisokat.

### <a name="standard-contract"></a>Standard szintű szerződés
...
Ajánlata emblémáját három méretben adhatja meg: **Kicsi (48 x 48)** , **nagy (216 x 216)** és **széles (255 x 115)** . A kis méretű és a nagyméretű méretek szükségesek.
...
Jelölje be ezt a jelölőnégyzetet a CRM Biztonságos tár vagy a kiszolgálók közötti (S2S) kimenő hozzáférés konfigurálásának engedélyezéséhez. Vegye figyelembe, hogy ez a szolgáltatás a Dynamics 365 csapatának a minősítési fázisban való speciális megfontolását igényli. A Microsoft felveszi Önnel a kapcsolatot a funkció támogatásához szükséges további lépések végrehajtásához.
...
Ebben a szakaszban válassza a **+ régió hozzáadása** lehetőséget, hogy megadja azokat a földrajzi régiókat, amelyekben a CRM-csomag elérhető lesz az ügyfelek számára. A következő szuverén régiókban való üzembe helyezéshez különleges engedély és érvényesítés szükséges a minősítési folyamat során: [Németország](https://docs.microsoft.com/azure/germany/), [USA kormányzati FELHŐje](https://docs.microsoft.com/azure/azure-government/documentation-government-welcome)és tippje.
...
- **Példány URL-címe** (kötelező): Az URL-cím, amelyen az ügyfél elkezdi a tesztelési meghajtót. Általában a Dynamics 365-példány URL-címe, amely az alkalmazást futtatja a mintaadatok telepítésével (például https://testdrive.crm.dynamics.com).

- **Példány webes API URL-címe** (kötelező): A Dynamics 365-példány webes API URL-címének lekéréséhez jelentkezzen be a Microsoft 365-fiókjába, és navigáljon a **beállítások** \&gt; **Testreszabási** @no__t – 3gt; **Fejlesztői erőforrások** @no__t – 5gT; A **példány webes API-ját (szolgáltatás gyökerének URL-címe)** másolja az itt található URL-címet (például https://testdrive.crm.dynamics.com/api/data/v9.0).
...
- **Párhuzamos tesztelési meghajtók maximális** száma (kötelező): Állítsa be a tesztelési meghajtót egyszerre használó ügyfelek maximális számát. Ezek a tesztelési meghajtók már telepítve vannak, és lehetővé teszik, hogy az ügyfelek azonnal hozzáférjenek az üzembe helyezésre való várakozás nélkül.
