...
- [A test Drive marketing ajánlott eljárásainak](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal/test-drive/marketing-and-best-practices)- [tesztelése](https://github.com/Azure/AzureTestDrive/wiki/Test-Drive-Best-Practices) – ajánlott gyakorlati tanácsok
...
Az ingyenes próbaverzió konfigurálásának lehetősége az ajánlat minden csomagjában elérhető. Keresse meg az egyes ajánlatok díjszabását és rendelkezésre állását, és jelölje be a jelölőnégyzetet egy hónapos próbaverzió engedélyezéséhez.
...
Ha már beállította a csomag árát Egyesült Államok dollárban (USD), és egy másik piaci helyet ad hozzá, az új piac díját az aktuális árfolyamok alapján számítjuk ki. A közzététel előtt tekintse át az egyes piacok árát. A díjszabást a módosítások mentése után a "export prics (xlsx)" hivatkozással tekintheti át.
