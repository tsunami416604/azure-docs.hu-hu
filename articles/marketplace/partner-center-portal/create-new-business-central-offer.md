---
title: Új Dynamics 365 Business Central-ajánlat létrehozása a kereskedelmi piactéren
description: Új Dynamics 365 Business Central-ajánlat létrehozása az Azure Marketplace-en, a AppSource-on vagy a Cloud Solution Provider (CSP) programon keresztül a Microsoft partner Center kereskedelmi piactér portálján.
author: ChJenk
manager: evansma
ms.author: v-chjen
...
A Dynamics 365 Business Central-ajánlatok létrehozásának megkezdéséhez először [létre kell hoznia egy partner Center-fiókot](./create-account.md) , és meg kell nyitnia a [kereskedelmi piactér irányítópultját](https://partner.microsoft.com/dashboard/commercial-marketplace/offers), a kiválasztott **Áttekintés** oldalon.
...
Válassza az **+ új ajánlat** gombot, majd válassza a **Dynamics 365 Business Central** menüpontot. Ekkor megjelenik az **új ajánlat** párbeszédpanel.

### <a name="offer-id-and-alias"></a>Ajánlat azonosítója és alias

- **Ajánlat azonosítója**: A fiókban lévő egyes ajánlatok egyedi azonosítója. Ez az azonosító látható lesz az ügyfelek számára a Piactéri ajánlat URL-címében, és Azure Resource Manager sablonokat (ha vannak ilyenek). Az ajánlat AZONOSÍTÓjának kisbetűs alfanumerikus karakternek kell lennie (beleértve a kötőjeleket és az aláhúzásokat, de nem tartalmazhat szóközt), legfeljebb 50 karakter hosszúságú lehet, és a **Létrehozás**gombra kattintva nem módosítható.  Ha például a *test-Offer-1* értéket adja meg, az ajánlat URL-címe a következő lesz: `https://azuremarketplace.microsoft.com/marketplace/../test-offer-1`.
...
Adja meg az ajánlat emblémáját két méretben: **Kicsi (48 x 48)** és **nagyméretű (216 x 216)** .
...
Ne feledje, hogy még akkor is, ha az összes piac, a helyi törvények, valamint a korlátozások vagy más tényezők kiválasztásával bizonyos ajánlatokat egyes országokban és régiókban is meg lehet akadályozni.
...
- **Hozzáadás a**következőn: A kiegészítő alkalmazások kibővítik a Dynamics 365 Business Central funkcióit és a meglévő funkciókat. További információ: [kiegészítő alkalmazások](https://docs.microsoft.com/dynamics365/business-central/dev-itpro/developer/readiness/readiness-add-on-apps).
- **Kapcsolat**: A kapcsolódási alkalmazás abban az esetben használható, ha a Dynamics 365 Business Central és egy harmadik féltől származó megoldás vagy szolgáltatás között pont-pont típusú kapcsolatot kell létrehozni. További információ: [kapcsolat](https://docs.microsoft.com/dynamics365/business-central/dev-itpro/developer/readiness/readiness-connect-apps).
...
Ha a fenti **kapcsolat** lehetőséget választotta, adja meg az alkalmazás telepítésének URL-címét itt.
...
- **Teszt meghajtójának időtartama** (kötelező): Adja meg azt az időtartamot, ameddig a test meghajtója aktív marad, az órák száma szerint. A Test Drive Ez az időtartam lejárta után automatikusan leáll. Ez az időtartam csak egész számú órával állítható be (például "2" óra, a "1,5" nem érvényes).
...
- **Szerepkör neve** (kötelező): Adja meg az egyéni Dynamics 365 Test Drive-ban definiált biztonsági szerepkör nevét, amely a felhasználóhoz lesz hozzárendelve a tesztelési meghajtón (például Test-Drive-role).
...
- **Régió** (kötelező, egyetlen kijelölésű legördülő lista): Jelenleg 26 Azure által támogatott régió érhető el, ahol a tesztelési meghajtót elérhetővé teheti. A logikai alkalmazás erőforrásai a kiválasztott régióba lesznek telepítve. Ha a logikai alkalmazás egy adott régióban tárolt egyéni erőforrásokkal rendelkezik, győződjön meg arról, hogy a régió itt van kiválasztva. A legjobb módszer a logikai alkalmazás helyi üzembe helyezése az Azure-előfizetésben a portálon, és annak ellenőrzése, hogy megfelelően működik-e a kijelölés előtt.
...
- @no__t – 0Videos: Videók hozzáadása @ no__t-0 (nem kötelező): A videókat feltöltheti a YouTube vagy a Vimeo weboldalára, és itt hivatkozhat egy hivatkozással és egy miniatűr képpel (533 x 324 képpont), így az ügyfelek megtekinthetik az információk áttekintését, így könnyebben megismerhetik a tesztelési meghajtót, beleértve a funkcióinak sikeres használatát az ajánlata és az előnyeit kiemelő forgatókönyvek ismertetése.
  - **Név** (kötelező)
...
Adja meg a Microsoft Dynamics Business Central a megoldás célkitűzéseinek a kiadását: **Aktuális**, **következő nagyobb**, vagy a **következő alverzió**. Ez az információ lehetővé teszi a megoldás megfelelő tesztelését.
