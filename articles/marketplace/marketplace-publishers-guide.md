...
**Részt vesz a piactér előnyei**

Az Azure piactér és AppSource a Kezdőpanel a Microsoft és egy közös értékesít készen partnerség lehetőséghez ajtóküszöböt közös Ugrás piacra jutási tevékenységekhez. Indítsa el az előléptetés, igény szerinti létrehozásának és az értékesítési és közös használatával végezheti el a megtekintését a felhő üzleti motor és az üzleti növekedési lendítõtömeggel centerpiece. Nincs részt vesz a piactér díja van. Célunk a legjobb megoldás és a szolgáltatások, amely a fiókpartner-ökoszisztéma nyújt, Microsoft-ügyfelek csatlakozhatnak.
...
## <a name="storefronts"></a>Kirakatokkal
...
Minden egyes áruháznak speciális közzétételi beállítások segítségével maximalizálhatja a közzétételi befektetéseit. Az alábbi táblázat foglalja össze ezeket a beállításokat:
...
## <a name="how-to-publish-on-cloud-marketplace"></a>A felhő piactér közzététele

A felhő piactér közzétevők váljon egy egyszerű három lépéses folyamat:
1.  Az előfizetéshez közvetlenül listaelem típusának meghatározása
2.  A felhő piactér közzétevők feliratkozhatnak
3.  Végezze el a tartalom és műszaki Előfeltételek szükséges ajánlat és listaelem típusa
...
**2.    A cloud partner publisher válik**

A felhő piactéren közzétevőként regisztrálni az alábbi lépésekkel. Attól függően, hogy a Microsoft és a kijelölt listaelem típusú meglévő engagement néhány lépést nem lehet szükség: 

|Piactér-regisztrációs lépésében  |Time  |Leírás  |
|---------|---------|---------|
| 1. A Microsoft Partner Network regisztrálása | 15 perc | Csatlakozás a Microsoft Partner Network (MPN) hivatalos Microsoft-partnernek és kap további előnyökkel is jár, és ahhoz, hogy meg az Azure piactér Publisher támogatja. Regisztrálja a MPN, keresse fel a Microsoft Partner Network, és kattintson a "Regisztrálás." Fogja tudni csatlakozni a szervezet meglévő tagságát, ha van ilyen, Regisztrálás során. Regisztrálás után jegyezze fel a szervezet MPN azonosító: a rendszer kéri az aktiválása publisher profiljainak Cloud Partner portálra (3. lépés).      |
|2. Microsoft azonosító létrehozása     |   15 perc      |  A Microsoft ID a Cloud Partner portálra eléréséhez használható. Ez az e-mail cím egy Microsoft ID regisztrálni kell, és a Cloud Partner portálra (3. lépés) és a Microsoft Developer Center (4. lépés) használható. A kijelölt e-mail cím lehetőleg kell a vállalati tartományhoz, és az informatikai csapat által vezérelt. Irányelvek azonosító létrehozása előtt tekintse át a részeket irányelvek és használati útmutatók. |
|3. A piactér jelölési űrlap elküldése     |  1-3 napos       | A Microsoft Cloud piactér publisher válik a szervezet jelöl ki. Az űrlap a szervezet, az első alkalmazás vagy szolgáltatás ajánlatot közzétenni kívánt és a szintű támogatást, amely megadja kapcsolatos adatokat tartalmaz. <ul><li>[Az Azure piactér jelölési képernyő](http://aka.ms/listonazuremarketplace)</li><li>[AppSource jelölési képernyő](http://aka.ms/listonappsource)</li></ul> Az űrlap elküldése után a piactér team tekintse át az alkalmazást, és a kérelem érvényesítése. Miután a kérelem áttekintette van, értesítést fog kapni a következő lépéseket egy jóváhagyott váláshoz az e-mailben, és fér hozzá a Cloud Partner portálra, ahol végezze el az első ajánlat átjáróra a listában, és hozzon létre további kínál. Jóváhagyás esetén is kapni fog egy promóciós kódot arra a regisztrációs díj Microsoft Development Center (4. lépés). |
|4. Regisztrálja a fejlesztői központban     |    5 – 10 nap     | A Microsoft Developer Center közzétételi az alkalmazásokat, amelyek a piactéren, például a virtuális gépek, a megoldás sablonok és az Azure által kezelt alkalmazások képességek transact kitöltése kötelező. Ez a követelmény lehetővé teszi a Microsoft vállalati információk vállalata jogi, az adó és a entitások banki érvényesítéséhez. A bejegyzés a szervezet érvényes képviselője kell lennie, és szükséges személyes információt identitás ellenőrzése. A személy regisztrálása a Microsoft ID (2. lépés), amelyet a vállalatnak kell használnia, és ugyanazt a fiókot kell használni a Cloud Partner portálra. <ul>Vegye figyelembe, hogy a piactér jelölési képernyő még nem fejeződött be, ha meg kell adnia $99 regisztrációs díjat kell fizetnie. Ahhoz, hogy ez a díj az elérhetővé tételt követően, a piactér jelölési űrlap kitöltése és kapni fog egy promóciós kódot e-mailben. Fontos: A Microsoft Developer Center-fiók létrehozása előtt győződjön meg arról, nem a vállalat már rendelkezik egy. Ez az eljárás részletes leírását lásd: hogyan kell regisztrálni a fejlesztői központban utasításokat.</ul>   |
|5. Jelentkezzen be a Cloud Partner portálra     |  15 perc       |  Ha a jelölési jóváhagyják, és a regisztrált a [Microsoft Partner Network](https://partner.microsoft.com/en-us/membership/) és a [Microsoft Developer Center](https://dev.windows.com/), egy fiókot hoz létre, hozzáférhet a [felhő Partner portál](https://cloudpartner.azure.com/). Első bejelentkezési hitelesítő adatok fognak szerepelni a jelölési jóváhagyása e-mailben. A Cloud Partner portálra használatáról további információkért látogasson el a [további](https://cloudpartner.azure.com/#Learn) a portálon, és nézze meg a dokumentáció menüjében.    |

**3.    Teljes ajánlat és listaelem írja be az Előfeltételek:**

A műszaki és marketing content követelmények függ a kirakat, ajánlattípus és listaelem típusát. Tekintse át az alábbi előírások annak ellenőrzéséhez, hogy teljesíti:
-   Storefront követelmények: Az Azure piactér és AppSource
-   Listaelem szemben támasztott követelményeit: Lista, próbaverzió, és Transact
-   Az ajánlat szemben támasztott követelményeit: 
 -  Alkalmazás – a virtuális gép, tároló vagy SaaS
 -  Az ajánlat tanácsadás
...
### <a name="go-to-market-benefits"></a>Nyissa meg piacra jutási előnyei

Az Azure piactér és AppSource lehetővé teszi a közzétevők, azok az ügyfelek több millió megoldások megjelenítve. Új listák a piactéren automatikusan érhető el a vonatkozó ajánlatot az ügyfél ökoszisztéma meghajtó ismeretének segítségével szabad Ugrás piacra jutási előnyei készlete.

A Microsoft és egy közös értékesít készen partnerség lehetőséghez ajtóküszöböt közös Ugrás piacra jutási tevékenységekhez a Kezdőpanel listázása az ajánlatot a piactér kirakat a. Az összes új listaelem automatikusan érhető el egy nem költségeket, Ugrás piacra jutási előnyeit az ajánlatot az ügyfél ökoszisztéma meghajtó ismeretének segítségével. A piaci megjelenést segítő előnyök számos marketing- és értékesítési együttműködési tevékenységgel szolgálnak, amelyek a márkánknak, csatornáinknak és ökoszisztémánknak köszönhetően elősegítik a partnerek megoldásainak ismertségét és értékesítését. Nincs szükség partneri műveletre. Az ajánlat közzétételekor a GTM-csapatunk felkeresi a partnert a teljesítés megkezdése érdekében.
...
**AppSource: A közzétételi beállítások Előfeltételek**

|**Követelmény**  |**Részletek**  |**Szükséges vagy ajánlott**  |
|---------|---------|---------|
|**Az Azure Active Directory (AAD)**    |  Engedélyeznie kell az alkalmazás Azure Active Directory összevont egyszeri bejelentkezést (AAD összevont egyszeri bejelentkezés) hozzájárulásával engedélyezve van. Nyissa meg az AAD engedélyezésével kapcsolatos információk összevont egyszeri bejelentkezés     |    Szükséges   |
|**Integráció a Microsoft Cloud Services csomag**    |  Az alkalmazás integrálja az például a Microsoft Power bi-ban, a Cortana Intelligence vagy a Microsoft Azure szolgáltatások, például az eszközök internetes hálózatát más Microsoft Cloud Services       |    Ajánlott    |
|**Célközönség**    |  AppSource ajánlatok üzleti felhasználók és a vállalakozások tulajdonosai kell lennie.     |    Szükséges   |
|**A vállalati szolgáltatott szoftverként (SaaS) alkalmazásként szoftver**    |  Az alkalmazás kell lennie: <ul><li>Üzleti SaaS-alkalmazás</li><li>Arra irányul, hogy üzleti-folyamat</li><li>Üzleti felhasználók irányuló</li><li>Jelentkezzen be a munkahelyi hitelesítő adatokat (felhasználónév és jelszó) jogosultak</li></ul>       |    Szükséges    |
|**Ingyenes próbaverzió lejárta és próbaverziója**    |  Az ügyfél az alkalmazás használhatja az ingyenes korlátozott ideig kell lennie. Az ingyenes próbaidőszak két űrlap valamelyikét hajthatja végre: <ul><li>Egy "try" lehetőséget biztosít, így az ügyfelek is kezdeményezhető a próbaverzió AppSource belül</li><li>Az ügyfelek "kérelem létrehozása" származnia AppSource belül</li></ul> Mindkét esetben az ingyenes próbaverzióval kell nyújtania az ügyfél egy közötti időtartamot adja az alkalmazása nem jelent többletköltséget kipróbálásához.      |    Szükséges    |
|**Könnyen konfigurálható, azonnal használható megoldás**    |  Az alkalmazás könnyű és gyors konfigurálásához és beállítása (nem kötelező Testreszabás) kell lennie.     |    Szükséges   |
|**Felügyeleti vezethet**    |  Érdeklődők kap a piactérről, engedélyeznie kell a CRM (Marketo, Microsoft Dynamics vagy Salesforce) átfutási adatok fogadására.       |    Szükséges    |
|**Adatvédelmi szabályzatát, illetve a használati feltételek**    |  Az adatvédelmi szabályzat egy nyilvános URL-CÍMEN keresztül elérhetőnek kell lennie. A használati feltételek szövegként közzététele során kell megadni.     |    Szükséges   |
|**Támogatás**    |  Az ajánlat tartalmaznia kell egy nyilvánosan elérhető támogatási URL-címet, ahol az ügyfelek talál segítséget. A próbaverzió támogatási meg kell adni további költségek nélkül a próbaidőszak.     |    Szükséges   |

**Az Azure piactér: Közzétételi beállítások használatának előfeltételei**
...
#### <a name="prerequisites-specific-to-transaction-publishing"></a>Tranzakció közzététel vonatkozó Előfeltételek
...
|**Consulting Services tanácsadó szolgálat partner követelményei**    |  *Csak az Azure piactér*: <br>Partnerek is kell lennie egy **ezüst vagy gold kompetencia** az érintett területen a szolgáltatáshoz. A jogosult szakértelem listáját a következő:</br><br><ul><li> **Kompetencia:** felhő Platform és infrastruktúrát. <br>**Megoldás terület:** Cloud Platform, az Adatközpont</li><br><li>**Kompetencia:** alkalmazásfejlesztés és ISV <br>**Megoldás terület:** alkalmazásfejlesztés, az alkalmazások integrálása, a DevOps</li><br><li>**Kompetencia:** adatok kezelése és az elemzések <br>**Megoldás terület:** adatelemzés, Adatplatform </li></br></ul>További információkért lásd: [szakértelem keresztül Microsoft Partner Network](https://partner.microsoft.com/en-US/membership/competencies).</br><br>Listaelem további információkért lásd: [Consulting Services tanácsadó szolgálat Azure piactéren](https://docs.microsoft.com/en-us/azure/marketplace/consulting-services) |    Lista     | 


#### <a name="cloud-partner-portal-pre-publishing-checklist-for-the-azure-marketplace"></a>Cloud Partner portálra ellenőrzőlista előre közzététele az Azure piactéren
...
**Az Azure AD-integráció a piactér tanúsítására: több-Bérlős alkalmazásokhoz**
...
**Az Azure AD-integráció a piactér tanúsítására: Single-bérlői alkalmazások**
...
### <a name="become-a-cloud-marketplace-publisher"></a>A felhő piactér Publisher válik

#### <a name="becoming-a-publisher"></a>A közzétevő végrehajtása

Ebben a szakaszban a lépések azt ismertetik: <ul><li>Az Azure piactér és AppSource közzétevő válik.</li><li>A Cloud Partner portálra eléréséhez. Build, közzététele és kezelése az ajánlatot, hogy a portál fogja használni.</li></ul>
...
**A Microsoft ID kezelése az Azure piactér-fiók létrehozására vonatkozó irányelvek**
...
**Piactér kereskedelmi kapcsolatos szempontok**
...
**Használatalapú fizetés, és a saját licenc számlázási lehetőségek**
...
**Single-számlázási és a fizetési módok**
...
**Pénzügyi kötelezettségvállalást a** 
...
### <a name="azure-marketplace-vs-appsource"></a>Az Azure piactér vs. AppSource
...
Szólítsa meg, az informatikusok és a felhőalapú keresztül a fejlesztők a **Azure piactér** felderítésére, próbálja meg, és IaaS, SaaS és PaaS megoldások vásárlása:


|**Ügyfél szükséges**  |**Az Azure piactéren** |
|---------|---------|
...
Az üzleti felhasználók megszólítása **AppSource** kereséséhez, próbálja meg, és üzleti SaaS-alkalmazásokhoz és megvalósítási szolgáltatások meghajtó üzleti eredmények számítanak, és csökkentse idő érték: 
...
Válassza a kirakat kezdődik, az előfizetéshez a célközönség azonosító. Ha a megoldás mindkét célközönség célozza, akkor mindkét kirakatokkal lista csak egyszer közzé kell.
