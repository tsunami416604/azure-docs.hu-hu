---
title: SaaS-ajánlat tulajdonságainak konfigurálása a Microsoft partner Centerben
description: Megtudhatja, hogyan konfigurálhatja a szolgáltatásként (SaaS) a Microsoft kereskedelmi Marketplace ajánlatának tulajdonságait a partner Centerben.
author: mingshen-ms
ms.author: mingshen
...
Ez a cikk bemutatja, hogyan konfigurálhatja a Microsoft kereskedelmi piactéren a szolgáltatott szoftver (SaaS) tulajdonságait.

A **Tulajdonságok** lapon megadhatja az ajánlatra, az alkalmazás verziójára és a jogi szerződésekre érvényes kategóriákat és iparágakat. Ügyeljen arra, hogy az Ön ajánlatának teljes és pontos részleteit ezen a lapon lássuk el, hogy az megfelelően jelenjen meg, és a megfelelő ügyfelek számára is elérhető legyen.
...
## <a name="specify-an-app-version-optional"></a>Alkalmazás verziójának megadása (nem kötelező)

 Az **alkalmazás verziószáma** mezőben adja meg a verziószámot. Az alkalmazás verziószáma a AppSource piactéren az ajánlat verziószámának azonosítására szolgál.
