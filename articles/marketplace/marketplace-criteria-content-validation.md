...
| 7 | Marketing-összetevők | A logók helyesen jelennek meg. | <ul><li>Logók: kis (48x48 képpont) és nagyméretű (216x216 képpontok) megadása kötelező.</li><li>Képernyőkép (max. 5): a szükséges. PNG-kép 1280x720 képpont felbontással. |
...
| 3 | Piactéri összetevők | A logók helyesen jelennek meg. |<ul><li>Logók: kicsi (48 x 48 képpont) és nagy (216x216 képpont) szükséges.</li><li>Képernyőkép (max. 5): a szükséges. PNG-kép 1280 x 720 képpont felbontással.|
