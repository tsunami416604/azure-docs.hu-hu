...
Célunk, hogy segítséget nyújtson a Microsofttal való együttműködés felgyorsításához és a Microsoft ügyfeleinek a partneri ökoszisztéma által kínált legjobb megoldásokkal való összekapcsolásához. Ehhez a teljes utazás során támogatjuk a bevezetést, a közzétételt és a növekedést. Használja ki a kereskedelmi piactér képességeit, hogy növelje vállalatát.

- Bővítse megoldási portfólióját új piacokra és szegmensekre.
- Új marketing-érdeklődők és értékesítési lehetőségek előállítása.
- Felupsell és értékesítheti megoldásait, mivel ügyfelei áthelyezik a munkaterheléseket a felhőbe. 
- Az értékesítési ciklusok csökkentése, a projektek felgyorsítása és az üzlet jövedelmezőségének növelésével konkrét számítási feladatokhoz és iparági forgatókönyvekhez is forgalmazhatja megoldásait.
- Gyakorlati információkhoz juthat a lista teljesítményéről, és megtudhatja, hogyan maximalizálhatja a kampány tevékenységeit a megoldásához.

A kereskedelmi piactéren alapuló partnerek számos ingyenes technikai, marketing-és értékesítési előnyre jogosultak az üzleti növekedés elősegítése érdekében:

- Használja ki az Azure-kreditek fejlesztéséhez és teszteléséhez szükséges műszaki erőforrásokat, amelyekkel elindíthatja az alkalmazást, a technikai támogatástól, az alkalmazások kialakításával és az architektúra kialakításával.
- Elérhetővé teheti a Microsoft piaci megjelenést segítő alapismereteket, amelyek segítségével elindíthatja és népszerűsítheti megoldását. A Microsoft marketing-kampányának további bevonása és a kereskedelmi piactéren elérhető lehetőségek is jogosultak lehetnek.
- További ügyfeleket érhet el, és kiterjesztheti értékesítési lehetőségeit a [Cloud Solution Provider](https://partner.microsoft.com/cloud-solution-provider) (CSP) program, a [közös értékesítés](marketplace-co-sell.md) program és a Microsoft Sales csapatával.
