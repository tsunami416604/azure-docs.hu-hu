...
1. A **Rendszer hozzárendelt** lapján kapcsolja be az **Állapot szolgáltatást** **bekapcsolva**állásra. Kattintson a **Mentés** gombra. 
...
- [A Kulcstároló hitelesítésének biztosítása hozzáférés-vezérlési házirenddel](key-vault-group-permissions-for-apps.md)
