...
description: Rövid útmutató, amely bemutatja, hogyan hozhat létre Azure Key vaultokat, és hogyan adhat hozzá kulcsot a tárolóhoz Azure Resource Manager sablon használatával.
services: key-vault
author: sebansal
...
ms.locfileid: "92128642"
---
# <a name="quickstart-create-an-azure-key-vault-and-a-key-by-using-arm-template"></a>Rövid útmutató: Azure Key Vault és kulcs létrehozása ARM-sablon használatával 
