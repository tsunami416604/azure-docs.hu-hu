...
- A felhasználónak hozzá kell rendelnie a RBAC Bult szerepkört (például). közreműködői. [További információ](https://docs.microsoft.com/azure/role-based-access-control/role-assignments-portal)
