...
A letöltött BYOK-eszközkészlet integritásának ellenőrzéséhez a Azure PowerShell-munkamenetben használja a [Get-FileHash](/powershell/module/microsoft.powershell.utility/get-filehash) parancsmagot.
