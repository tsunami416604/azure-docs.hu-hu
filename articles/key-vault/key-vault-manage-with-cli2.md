...
Az Azure Key Vault áttekintését a [Mi az Azure Key Vault?](key-vault-overview.md)
...
A BYOK-csomag létrehozásáról a [HSM-védett kulcsok használata az Azure Key Vault szolgáltatással](key-vault-hsm-protected-keys.md)című témakörben talál további útmutatást.
...
- A programozási referenciákat [az Azure Key Vault fejlesztői útmutatójában](key-vault-developers-guide.md) talál.

- Az Azure Key Vault ról és a HSM-ekről a [HSM-védelemmel ellátott kulcsok használata az Azure Key Vault szolgáltatással](key-vault-hsm-protected-keys.md)című témakörben talál.
