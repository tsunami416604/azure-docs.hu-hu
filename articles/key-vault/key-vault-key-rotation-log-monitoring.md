...
Először engedélyeznie kell a bejelentkezést a key vault. Használja a következő PowerShell-parancsokat. (A [kulcstartó naplózásáról szóló cikkben](key-vault-logging.md)található részletek láthatók.)
