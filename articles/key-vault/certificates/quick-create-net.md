...
Ebben a példában az egyszerűség kedvéért önaláírt tanúsítványt is használhat alapértelmezett kiállítási házirenddel. Ehhez a feladathoz használja a [StartCreateCertificateAsync](/dotnet/api/azure.security.keyvault.certificates.certificateclient.startcreatecertificateasync) metódust. A metódus első paramétere elfogadja a tanúsítvány nevét és a tanúsítvány házirend-[tanúsítványának házirendjét](https://docs.microsoft.com/dotnet/api/azure.security.keyvault.certificates.certificatepolicy).
