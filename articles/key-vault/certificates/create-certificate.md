...
|--------------|----------------------|------------------|  
|DigiCert|A Key Vault OV vagy EV SSL-tanúsítványokat kínál a DigiCert| [Integrációs útmutató](https://docs.digicert.com/certificate-tools/azure-key-vault-integration-guide/)
