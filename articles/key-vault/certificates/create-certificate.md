...
|--------------|----------------------|------------------|  
|DigiCert|A Key Vault OV vagy EV SSL-tanúsítványokat kínál a DigiCert| [Integrációs útmutató](https://docs.microsoft.com/azure/key-vault/certificates/how-to-integrate-certificate-authority)
