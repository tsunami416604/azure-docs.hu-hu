...
A Azure PowerShell set-AzKeyVaultAccessPolicy parancsmag használatával frissítse a Key Vault hozzáférési szabályzatot, és adjon titkos engedélyeket a felhasználói fióknak.
```azurepowershell-interactive
