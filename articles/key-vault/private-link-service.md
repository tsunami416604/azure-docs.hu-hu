...
Új key Vault-ot hozhat létre a Set című csoportlépései és [az Azure Key Vault titkos adatainak beolvasása az Azure Portalon keresztül.](quick-create-portal.md)
...
- További információ az [Azure Key Vaultról](key-vault-overview.md)
