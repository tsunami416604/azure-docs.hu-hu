...
- [建立和管理與其他的金鑰保存庫](https://msdn.microsoft.com/library/azure/mt620024.aspx)
- [建立及管理金鑰保存庫使用 PowerShell](key-vault-get-started.md)
- [建立及管理金鑰保存庫使用 CLI](key-vault-manage-with-cli.md)
...
- [如何產生並傳輸受 HSM 保護金鑰的 Azure 金鑰保存庫](key-vault-hsm-protected-keys.md)
