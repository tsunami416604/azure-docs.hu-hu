---
title: Azure rövid útmutató – Kulcstartó létrehozása a Powershell használatával | Microsoft Docs
description: ''
services: key-vault
author: barclayn
manager: mbaldwin
...
> [Az Azure Key Vault használata egy webalkalmazásból](key-vault-use-from-web-application.md)
