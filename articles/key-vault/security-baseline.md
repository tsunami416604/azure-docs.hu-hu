...
Alkalmazás regisztrálása Azure Active Directorykal: https://docs.microsoft.com/azure/key-vault/key-vault-manage-with-cli2#registering-an-application-with-azure-active-directory
