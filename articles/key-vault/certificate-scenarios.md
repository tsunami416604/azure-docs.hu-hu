...
## <a name="import-a-certificate"></a>Tanúsítvány importálása  
 ...
 A PEM formátumról a [Kulcsok, titkos kulcsok és tanúsítványok](about-keys-secrets-and-certificates.md)– tanúsítványok című szakaszban talál további információt.  
