...
- [Azure Active Directory (Azure ad)](../active-directory/active-directory-whatis.md): az Azure ad a bérlők Active Directory szolgáltatása. Minden címtárhoz tartozik egy vagy több tartomány. Egy címtárhoz számos előfizetés tartozhat, de csak egyetlen bérlő.
