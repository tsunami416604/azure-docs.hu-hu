...
---
# <a name="import-hsm-protected-keys-for-key-vault-legacy"></a>HSM-védelemmel ellátott kulcsok importálása Key Vaulthoz (örökölt)
...
* [5. lépés: a kulcs átvitele Azure Key Vaultre](#step-5-transfer-your-key-to-azure-key-vault)
...
Győződjön meg arról, hogy a nCipher-eszközök az elérési útban vannak ( **% nfast_home% \ bin**). Írja be például a következőt:
...
Ez a parancs jogkivonat-kulcsot hoz létre a (z)% NFAST_KMDATA% \ local mappában, amelynek a neve **key_simple_** , majd a parancsban megadott **ident** . Például: **key_simple_contosokey**. Ez a fájl titkosított kulcsot tartalmaz.
...
Ha a parancs befejeződik, a **Result: Success** és a kulcs másolata a csökkentett engedélyekkel a key_xferacId_\<contosokey értéket ugyanarra > nevű fájlban található.
...
## <a name="step-5-transfer-your-key-to-azure-key-vault"></a>5\. lépés: a kulcs átvitele Azure Key Vaultre
