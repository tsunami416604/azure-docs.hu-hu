...
- Azure CLI – Ha nem rendelkezik ezzel a beállítással a környezetében, olvassa [el a Key Vault kezelése az Azure CLI használatával](manage-with-cli2.md)című témakört.
