...
- Tudjon meg többet [felügyelt identitások az Azure-erőforrások](/azure/app-service/overview-managed-identity).

- Ismerje meg, különböző módjait [hitelesítése és engedélyezése az alkalmazások](/azure/app-service/overview-authentication-authorization).
