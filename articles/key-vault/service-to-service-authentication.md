...
1. A hozzáférés ellenőrzéséhez írja be *az az Account Get-Access-Token https://vault.azure.net--Resource elemet *. Ha hibaüzenetet kap, ellenőrizze, hogy megfelelően van-e telepítve az Azure CLI megfelelő verziója.
