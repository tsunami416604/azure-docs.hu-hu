...
儲存體 Blob 連接器提供下列觸發程序和動作：
 ...
 觸發程序| 動作
--- | ---
 無| <ul><li>取得 Blob: 從容器取得特定的 Blob</li><li>上傳 Blob: 上傳新的 Blob 或更新現有的 Blob</li><li>刪除 Blob: 從容器中刪除特定的 Blob</li><li>列出 Blob: 列出目錄中的所有 blob</li><li>快照 Blob: 建立特定 Blob 的唯讀快照</li><li>複製 Blob: 從另一個 Blob 複製來建立新的 Blob。來源 Blob 可能位於相同的帳戶或另一個帳戶中。</li></ul>
