...
David Ebbo 寫了 [很棒的部落格文章](http://blog.davidebbo.com/2014/12/azure-service-principal.html) 如何設定此項目。 請遵循所有此處的指示，並取得您 **租用戶識別碼**, ，**用戶端識別碼** 和 **密碼**。 這三個欄位，加上 **訂用帳戶 ID**, ，為何需要設定連接器。 
