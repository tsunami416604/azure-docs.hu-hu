...
觸發程序 | 動作
--- | ---
None | <ul><li>刪除檔案</li><li>取得檔案</li><li>上傳檔案</li><li>列出檔案</li></ul>
...
- **檔案路徑** -指定要上傳檔案的目的地 Dropbox 檔案路徑。 範例：Photos/image.png
- **內容** -指定要上傳檔案的內容。 這通常來自邏輯應用程式的上一個步驟。
