...
> [WACOM.NOTE] HBase (version 0.98.0) is only available for use with HDInsight 3.1 clusters on HDInsight (based on Apache Hadoop and YARN 2.4.0). For version information, see [What's new in the Hadoop cluster versions provided by HDInsight?][What's new in the Hadoop cluster versions provided by HDInsight?]
...
-   An Azure storage account. For instructions, see [How To Create a Storage Account][How To Create a Storage Account].
...
-   [Provision an HBase cluster in the Azure portal][Provision an HBase cluster in the Azure portal]
-   [Create an HBase sample table from the HBase shell][Create an HBase sample table from the HBase shell]
-   [Use Hive to query an HBase table][Use Hive to query an HBase table]
-   [Use HBase C# APIs to create an HBase table and retrieve data from the table][Use HBase C# APIs to create an HBase table and retrieve data from the table]
-   [Summary][Summary]
...
3.  To retrieve the results of the Hive query, click on the **View Details** link in the **Job Session** window when the job finishes executing.
...
1.  Follow the build steps described onDownload the Marlin project from the [Marlin's project page][Marlin's project page]. Unzip it to a local directory.
...
[Provision HBase clusters on Azure Virtual Network][Provision HBase clusters on Azure Virtual Network]:
With the virtual network integration, HBase clusters can be deployed to the same virtual network as your applications so that applications can communicate with HBase directly.
  ...
  [How To Create a Storage Account]: http://azure.microsoft.com/en-us/documentation/articles/storage-create-storage-account/
  ...
  [Marlin's project page]: https://github.com/thomasjungblut/marlin
