...
Az útvonal-lekérdezés, az adatforrás, a szimbólum és a vonal rétegek, valamint a kamera határai a Térkép [esemény-figyelőn](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.map?view=azure-iot-typescript-latest#events) belül jönnek létre és állíthatók be, így biztosítható, hogy az eredmények a Térkép teljes betöltése után megjelenjenek.
