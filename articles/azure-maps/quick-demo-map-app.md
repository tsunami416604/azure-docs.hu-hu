...
3. Módosítsa a térkép alapértelmezett középpontját. Az **AzureMapDemo.html** fájlban keresse meg a **center** nevű változót. A változó szélesség–hosszúság értékpárját cserélje le a következő új értékre: **[-74.0060, 40.7128]**. Mentse a fájlt, és frissítse a böngészőt. 
3. Próbálja ki az interaktív keresést. A bemutató webalkalmazás bal felső sarkában lévő keresőmezőben keressen rá a **restaurants** (éttermek) kifejezésre. 
4. Húzza az egérkurzort a keresőmező alatt megjelenő listában egy cím vagy hely fölé, és figyelje meg, hogy a térképen az adott helyhez tartozó jelölő a helyre vonatkozó információkat jelenít meg. A magánvállalkozások adatainak védelme érdekében az itt látható nevek és címek nem valósak. 
