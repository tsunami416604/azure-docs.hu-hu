...
- Az **cloudadmin@vsphere.local** Azure VMware-megoldás felhasználója [korlátozott jogosultságokkal](concepts-role-based-access-control.md)rendelkezik. A VMware-eszközöket használó, a vendégen belüli memória-gyűjtemény nem támogatott az Azure VMware-megoldás virtuális gépei (VM-EK) használatával. Ebben az esetben az aktív és a felhasznált memória kihasználtsága továbbra is működik.
