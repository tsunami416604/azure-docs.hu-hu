<properties
    pageTitle ="保護應用程式和 Azure RemoteApp 中的資源 |Microsoft Azure 「
    描述 ="了解如何鎖定 Azure RemoteApp 中 app 和資源"
    服務 ="remoteapp"
    documentationCenter=""
    作者 ="lizap"
    管理員 ="mbaldwin"/ >
...
2.  您可以設定群組原則 (如果您的集合未加入網域，或您沒有在 AD 中正確的權限) 的替代方式， [本機原則](https://technet.microsoft.com/library/cc775702.aspx) 到您的範本映像。 請注意，當群組原則與本機原則發生衝突時，以群組原則為準。
