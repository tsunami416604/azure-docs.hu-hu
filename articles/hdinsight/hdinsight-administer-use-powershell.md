...
**選取 AzureRMSubscription** 稱為如果您有多個 Azure 訂用帳戶。
...
>[AZURE.NOTE] 只有叢集的 HDInsight 3.1.3 版或更高版本才支援。 如果不確定您的叢集版本，您可以檢查 [屬性] 頁面。  請參閱 [熟悉叢集入口網站介面](hdinsight-adminster-use-management-portal/#Get-familiar-with-the-cluster-portal-interface)。
