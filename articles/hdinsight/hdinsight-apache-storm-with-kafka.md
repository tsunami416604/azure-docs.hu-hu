...
1. A következő gomb segítségével jelentkezzen be az Azure-ba, és nyissa meg a sablon az Azure portálon.
    ...
    Az Azure Resource Manager sablon itt található: **https://hditutorialdata.blob.core.windows.net/armtemplates/create-linux-based-kafka-storm-cluster-in-vnet-v1.json**. Létrehozza a következőket:
...
2. Az alábbi útmutató segítségével a feltöltik a **egyéni telepítési** panel:
...
Az erőforrások létrehozása után, az erőforráscsoport panel jelenik meg.
...
2. Miután elindul a topológia, nyissa meg a Storm felhasználói felülete. A webes felhasználói felület https://storm-BASENAME.azurehdinsight.net/stormui helyezkedik el. Cserélje le __BASENAME__ a fürt létrehozásakor használt alap névvel. 
