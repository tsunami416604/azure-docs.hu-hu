...
>
> HDInsight 3.4-es vagy nagyobb, lásd: [az SSH használata MapReduce](hdinsight-hadoop-use-mapreduce-ssh.md) információk a HDInsight-fürthöz csatlakozik, és a MapReduce-feladatok futtatása.
