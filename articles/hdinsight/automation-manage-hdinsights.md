...
可透過 Azure 自動化中管理 HDInsight [Azure HDInsight cmdlet](https://msdn.microsoft.com/library/azure/dn479228.aspx) 可用於 [Azure PowerShell 工具](https://msdn.microsoft.com/library/azure/jj156055.aspx)。 Azure 自動化會提供立即可用的 Cmdlet，以便您在服務中執行 HDInsight 管理工作。 您也可以將 Azure 自動化中的這些 Cmdlet 與其他 Azure 服務的 Cmdlet 搭配，以透過 Azure 服務和協力廠商系統自動執行複雜的工作。
...
* 檢視中的範例 [指令碼中心](http://aka.ms/scriptcentergallery)。  
