...
A további SDK-funkciók kódrészletei a [HDINSIGHT SDK for Python](https://docs.microsoft.com/python/api/overview/azure/hdinsight)dokumentációjában találhatók.
