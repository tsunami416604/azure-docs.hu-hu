...
* (Nem kötelező) Az SSH és SCP való ismerkedés során bizonyulhat: További információ: [Az SSH használata HDInsighttal](../hdinsight-hadoop-linux-use-ssh-unix.md).
