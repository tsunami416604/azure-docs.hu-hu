...
| [Járműérzékelő-adatok feldolgozása az Event hubs Eseményközpontokból a HDInsight Apache Storm használatával][246ee964] |Event Hubs, Cosmos dB-ben az Azure Storage Blob (WASB) |C#, Java |
...
| [Sablon C# Storm-topológia projektjét, Apache Storm on HDInsight az Azure-szolgáltatások használata][ce0c02a2] |Event Hubs, Cosmos dB-ben SQL Database, a HBase, SignalR |C#, Java |
...
[6eb0d3b8]:apache-storm-deploy-monitor-topology.md "Ismerje meg, hogyan helyezheti üzembe és kezelhetők a topológiák a web-alapú Apache Storm irányítópultjának és a Storm felhasználói felületének vagy a HDInsight Tools for Visual Studio használatával."
