...
3. A **szakaszok** lapra kattintva megtekintheti az alkalmazáshoz társított szakaszokat.
    ...
    A ![Spark History Server szakaszai lap](./media/apache-spark-job-debugging/view-apache-spark-stages.png "nézetének Spark szakaszai")
    ...
    A ![Spark History Server szakaszai lap részletek](./media/apache-spark-job-debugging/view-spark-stages-details.png "megtekintése Spark-szakaszok részletei")
...
6. A Spark felhasználói felületének többi lapja is hasznos információkat nyújt a Spark-példányról.
   ...
   * Környezet lap – ezen a lapon számos hasznos információ olvasható a Spark-példányról, például:
     * Scala verziója
...
1. A Spark-előzmények kiszolgálójának elindításához az Áttekintés panelen kattintson a **Spark History-kiszolgáló** elemre a **fürt irányítópultok**területen.
    ...
    ![Azure Portal a Spark History Server]elindítása a(./media/apache-spark-job-debugging/launch-spark-history-server.png "Spark-előzmények Kiszolgáló1") -es indításakor
...
2. Megjelenik a felsorolt összes befejezett alkalmazás. További információért kattintson egy alkalmazás-AZONOSÍTÓra az alkalmazásban való részletezéshez.
    ...
    A ![Spark History Server befejezte az alkalmazások](./media/apache-spark-job-debugging/view-completed-applications.png "indítását a Spark History Kiszolgáló2")
