...
1. A Jupyter jegyzetfüzetből válassza a **feltöltés** lehetőséget a jobb felső sarokban, majd navigáljon a letöltéshez, és válassza a fájl `CNTK_model_scoring_on_Spark_walkthrough.ipynb`elemet.
