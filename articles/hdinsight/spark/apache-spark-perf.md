...
| 2\. generációs Azure Data Lake Storage| **abfs[s]:** //url/ | **Gyorsabb** | Igen | Átmeneti fürt |
...
![A fonal Spark memóriájának kezelése](./media/apache-spark-perf/yarn-spark-memory.png)
