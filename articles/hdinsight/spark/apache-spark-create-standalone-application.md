...
description: Oktatóanyag – az Apache Maven Scalában írt az összeállítási rendszer és a egy meglévő Maven archetype az IntelliJ IDEA által biztosított Scala Spark-alkalmazás létrehozása.
