...
Azure PowerShell 提供 *Cmdlet*，可讓您從遠端在 HDInsight 上執行 MapReduce 工作。 就內部而言，這透過使用 REST 呼叫 [WebHCat](https://cwiki.apache.org/confluence/display/Hive/WebHCat) (先前稱為 Templeton) HDInsight 叢集上執行。
