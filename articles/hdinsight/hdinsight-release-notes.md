...
### <a name="deprecate-spark-21-and-22-for-hdinsight-36-spark-cluster"></a>A Spark 2,1 és a 2,2 HDInsight 3,6 Spark-fürthöz való érvénytelenítése
Július 1 2020-től kezdődően az ügyfelek nem tudnak új Spark-fürtöket létrehozni a Spark 2,1 és a 2,2 használatával a HDInsight 3,6-ben. A meglévő fürtök a Microsoft támogatásának hiányában lesznek futtatva. Vegye figyelembe, hogy a Spark 2,3-ra való áttérés a HDInight 30 2020 3,6-re, a lehetséges rendszer-és támogatási megszakítás elkerülése érdekében.

### <a name="deprecate-spark-23-for-hdinsight-40-spark-cluster"></a>Az HDInsight 4,0 Spark-fürt elavult Spark 2,3
Július 1 2020-től kezdve az ügyfelek nem tudnak új Spark-fürtöket létrehozni a Spark 2,3-mel a HDInsight 4,0-on. A meglévő fürtök a Microsoft támogatásának hiányában lesznek futtatva. Vegye figyelembe, hogy a Spark 2,4-ra való áttérés a HDInight 30 2020 4,0-re, a lehetséges rendszer-és támogatási megszakítás elkerülése érdekében.

### <a name="deprecate-kafka-11-for-hdinsight-40-kafka-cluster"></a>A Kafka 1,1 elavult HDInsight 4,0 Kafka-fürthöz
Július 1 2020-től kezdődően az ügyfelek nem tudnak új Kafka-fürtöket létrehozni a HDInsight 4,0-on futó Kafka 1,1-mel. A meglévő fürtök a Microsoft támogatásának hiányában lesznek futtatva. Vegye figyelembe, hogy a HDInight 30 2020 4,0-es Kafka 2,1-re a lehetséges rendszer/támogatás megszakadásának elkerülése érdekében.
