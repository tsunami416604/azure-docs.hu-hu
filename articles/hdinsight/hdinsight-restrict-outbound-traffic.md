...
A bejövő felügyeleti forgalmat nem lehet tűzfalon keresztül elküldeni. A bejövő forgalomhoz a NSG szolgáltatás címkéit az [itt](https://docs.microsoft.com/azure/hdinsight/hdinsight-service-tags)dokumentált módon használhatja. 
...
1. Az **alkalmazási szabály felvétele** képernyőn adja meg a következő információkat:
    ...
    **FQDN-címkék szakasz**
    ...
    | Név | Forrás címe | FQDN címke | Jegyzetek |
    | --- | --- | --- | --- |
    | Rule_1 | * | WindowsUpdate és HDInsight | A HDI-szolgáltatásokhoz szükséges |

    **Cél teljes tartománynevek szakasz**

    | Név | Forrásoldali címek | Protokoll: Port | Cél teljes tartománynevek | Jegyzetek |
    | --- | --- | --- | --- | --- |
...
1. A **hálózati szabálygyűjtemény hozzáadása** képernyőn adja meg a következő információkat:
    ...
    **A szolgáltatás címkéi szakasza**
    ...
    | Név | Protokoll | Forráscímek | Szolgáltatáscímkék | Célport | Jegyzetek |
    | --- | --- | --- | --- | --- | --- |
