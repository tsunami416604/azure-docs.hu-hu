...
Az Apache HBase-régió kiszolgálójának újraindítási művelete nem fejeződött be. A következőhöz hasonló hibaüzenet jelenhet meg a munkavégző csomópontok `/var/log/hbase` könyvtárának `region-server.log`jában, ahol a régió kiszolgálójának indítása sikertelen lesz:
...
1. A hirtelen leállás miatt, bár a régió-kiszolgáló folyamata le lesz szabadítva, előfordulhat, hogy a folyamathoz társított port nem jelenik meg, ami végül a `AddressBindException`.
