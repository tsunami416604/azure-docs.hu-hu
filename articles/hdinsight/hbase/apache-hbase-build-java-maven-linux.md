...
* [A HBase Linux-alapú Azure HDInsight fürt](apache-hbase-tutorial-get-started-linux.md#create-hbase-cluster)
  ...
  > [!NOTE]
  > A jelen dokumentumban leírt lépések HDInsight fürt 3.4 és verziójú 3.5 lettek tesztelve. Példák a megadott alapértelmezett értékek vannak HDInsight 3.5 fürt.
