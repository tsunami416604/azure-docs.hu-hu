...
Más magas rendelkezésre állású szolgáltatások is elérhetők, amelyeket a nyílt forráskódú Apache megbízhatósági összetevői is támogatnak. Ezek az összetevők a HDInsight-fürtökön is elérhetők:
