...
* **HDInsight-fürtök**. Lásd: [Hadoop használatának megkezdésében a HDInsight](hdinsight-hadoop-linux-tutorial-get-started.md) lépéseit egy új Linux-alapú HDInsight-fürt létrehozásához.
