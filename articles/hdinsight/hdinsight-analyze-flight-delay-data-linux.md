...
description: Oktatóanyag – ismerje meg, hogyan adatokat nyerhet ki nyers CSV adatkészletből, átalakítja a Hive a HDInsight használatával, és majd betölti az átalakított adatokat az Azure SQL database-be az Apache Sqoop használatával.
