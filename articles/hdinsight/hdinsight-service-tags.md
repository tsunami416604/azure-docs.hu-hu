...
A HDInsight-fürthöz tartozó szolgáltatási címkék használatának legegyszerűbb módja, ha hozzáadja a globális címkét `HDInsight` egy hálózati biztonsági csoport szabályához. A szolgáltatási címkék hálózati biztonsági csoporthoz való hozzáadásával kapcsolatos útmutatásért lásd a [biztonsági csoportok: szolgáltatás címkéi](../virtual-network/security-overview.md#service-tags)című témakört.
...
| Korea | Korea középső régiója | HDInsight. KoreaCentral |
...
| Azure Government (Fairfax) | USA középső régiója   | HDInsight. USDoDCentral |
...
Ha a 2. lehetőséget választja, és azt a régiót, amelyben a fürt létrejött, nem szerepel a fentiekben, több regionális szolgáltatás címkét is engedélyeznie kell. Ha egynél többre van szükség, az erőforrás-szolgáltatók különböző régiókban való elrendezése eltérő lehet.
