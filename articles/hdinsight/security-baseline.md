...
A kiszivárgás általi adatvesztés kockázatának csökkentése érdekében korlátozza az Azure HDInsight-fürtök kimenő hálózati forgalmát az Azure Firewall használatával.

Az Azure HDInsight telepítése virtuális hálózaton belül és biztonságos egy hálózati biztonsági csoporttal:https://docs.microsoft.com/azure/hdinsight/hdinsight-create-virtual-network

Az Azure HDInsight-fürtök kimenő forgalmának korlátozása az Azure Tűzfallal:https://docs.microsoft.com/azure/hdinsight/hdinsight-restrict-outbound-traffic
...
**Útmutató:** Engedélyezze a hálózati biztonsági csoport (NSG) flog loglog logs az alhálózathoz csatlakoztatott NSG az Azure HDInsight-fürt védelmére használt. Rögzítse az NSG-folyamatnaplókat egy Azure Storage-fiókba folyamatrekordok létrehozásához. Ha a rendellenes tevékenységek kivizsgálásához szükséges, engedélyezze az Azure Network Watcher csomagrögzítését.
...
Vállalati biztonsági csomag konfigurációi az Azure Active Directory tartományi szolgáltatásokkal a HDInsightban:
