...
A átjárócsomóponthoz aktív állapotának vizsgálatához az egyik módszer az SSH használata a fürt egyik csomópontján, majd `ping headnodehost` futtatása, és az IP-cím összevetése a két átjárócsomópontokkal.
