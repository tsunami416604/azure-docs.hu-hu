---
title: "SSH-kulcsok és a Hadoop együttes használata Linux-alapú fürtökön Windows rendszerben | Microsoft Docs"
...
---
# <a name="use-ssh-with-linuxbased-hadoop-on-hdinsight-from-windows"></a>Az SSH használata a HDInsight-ra épülő Linux-alapú Hadooppal Windows rendszerben
...
> [!NOTE]
> A cikkben ismertetett eljárásokhoz Windows-alapú ügyfelet kell használnia. Ha Linux-, Unix- vagy OS X-ügyfelet használ, tekintse meg [Az SSH használata a HDInsight-ra épülő Linux-alapú Hadooppal Linux, Unix vagy OS X rendszerben](hdinsight-hadoop-linux-use-ssh-unix.md) című témakört.
> 
