...
* [在 HDInsight 中使用 .NET SDK for Hadoop 執行 Pig 工作](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
如需如何執行這項作業的相關指示，請參閱[建立自我簽署的憑證](http://go.microsoft.com/fwlink/?LinkId=511138)。

> [AZURE.NOTE] 在建立憑證時，請務必記下您使用，易記名稱，將稍後使用。
...
3. 在頁面右側上所呈現的資訊，找出您想要使用附註中的值訂閱 **訂用帳戶 ID** 資料行。
...
5. 從 **工具** 功能表上，選取 **程式庫套件管理員** 或 **Nuget 封裝管理員**, ，然後選取 **Package Manager Console**。

6. 在主控台中執行下列命令，以安裝 .NET SDK 封裝。

        Install-Package Microsoft.Azure.Management.HDInsight.Job -Pre

7. 從 [方案總管] 中，按兩下 **Program.cs** 以開啟它。 將現有程式碼取代為下者。
