...
* [使用 Azure 入口網站管理 HDInsight 的 Hadoop 叢集](hdinsight-administer-use-management-portal.md)
...
- [使用 [快速建立佈建叢集](../hdinsight-get-started.md#provision)
...
HDInsight 可以與很多 Hadoop 元件搭配使用。 如需已驗證和支援的元件清單，請參閱 [Hadoop 的什麼版本是在 Azure HDInsight](hdinsight-component-versioning.md)。 您可以使用下列其中一個選項來自訂 HDInsight：
...
請參閱 [HDInsight 中調整 Hadoop 叢集](hdinsight-hadoop-cluster-scaling.md)。
