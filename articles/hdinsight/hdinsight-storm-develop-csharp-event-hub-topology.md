...
* A [a HDInsight tools for Visual Studio](hdinsight-hadoop-visual-studio-tools-get-started.md).
...
Az Event Hubs ebben a példában az adatforrást. A "Létrehoz egy eseményközpontot" szakaszában foglaltak [Bevezetés az Event Hubs használatába](../event-hubs/event-hubs-csharp-ephcs-getstarted.md).
