<properties 
    pageTitle="Az Apache Spark on HDInsight áttekintése | Microsoft Azure" 
...
>[AZURE.NOTE] Az aktuális kiadással kapcsolatos ismert problémák és korlátozások listáját lásd: [Az Apache Spark on Azure HDInsight (Linux) ismert problémái](hdinsight-apache-spark-jupyter-spark-sql.md).


## Miért válassza a Spark on Azure HDInsight alkalmazást? 
...
| Könnyű használat                     | A Spark on HDInsight-fürtök előre konfigurált Jupyter notebookokat tartalmaznak. Ezeket interaktív adatfeldolgozásra és -megjelenítésre használhatja. Az URL-cím https://CLUSTERNAME.azurehdinsight.net/jupyter. Cserélje le a __CLUSTERNAME__ kifejezést a Spark HDInsight-fürt nevére.|
...
## Melyek a Spark on HDInsight használati esetei?
...
### Streamelés és valós idejű adatelemzés
