...
![Spark: egyesített keretrendszer](./media/hdinsight-apache-spark-overview/hdinsight-spark-overview.png)
...
![A hagyományos MapReduce és Spark](./media/hdinsight-apache-spark-overview/mapreduce-vs-spark.png)
...
![Spark-fürtarchitektúra](./media/hdinsight-apache-spark-overview/spark-architecture.png)
