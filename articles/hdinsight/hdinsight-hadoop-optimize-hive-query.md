...
* [最佳化 Hive 查詢在 HDInsight 中 Hadoop 的](hdinsight-hadoop-optimize-hive-query-v1.md)。
...
- [在 HDInsight 上使用 Apache Hive](../hdinsight-using-hive.md)
- [在 HDInsight 中使用 Hive 分析航班延誤資料](hdinsight-analyze-flight-delay-data.md)
- [使用 HDInsight 中的 Hive 分析 Twitter 資料](hdinsight-analyze-twitter-data.md)
- [分析感應器資料，在 HDInsight Hadoop 上使用 Hive 查詢主控台](hdinsight-hive-analyze-sensor-data.md)
- [搭配 HDInsight 使用 Hive 來分析網站記錄](../hdinsight-hive-analyze-web-site-log.md)
