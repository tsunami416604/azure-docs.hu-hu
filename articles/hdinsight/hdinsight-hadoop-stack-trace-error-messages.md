...
* [在 HDInsight 中的 Hadoop 進行偵錯: 檢視記錄檔和解譯錯誤訊息](hhdinsight-debug-jobs.md)
* [存取 YARN 應用程式以程式設計的方式登入在 HDInsight 中的 Hadoop](hdinsight-hadoop-access-yarn-app-logs.md)
* [收集堆積傾印以偵錯和分析 Hadoop 服務的 Blob 儲存體中](hdinsight-hadoop-collect-debug-heap-dumps.md)
* [在 Azure HDInsight 上 Hadoop 元件的版本資訊](hdinsight-release-notes.md)
