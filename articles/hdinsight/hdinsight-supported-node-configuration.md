...
* [Általános célú virtuálisgép-méretek: Dv2 sorozat 1-5](../virtual-machines/linux/sizes-general.md#dv2-series)
* [Memória-optimalizált virtuális gépek méretei: Dv2 sorozat 11-15](../virtual-machines/linux/sizes-memory.md#dv2-series-11-15)
* [Általános célú virtuálisgép-méretek: Av2 sorozat 1-8](../virtual-machines/linux/sizes-general.md#av2-series)
...
| Fürttípus | Hadoop | HBase | Interaktív lekérdezés | A Storm | Spark | ML Server | Kafka |
|---|---|---|---|---|---|---|---|
...
| Fürttípus | Hadoop | HBase | Interaktív lekérdezés | A Storm | Spark | ML-szolgáltatások |
|---|---|---|---|---|---|---|
