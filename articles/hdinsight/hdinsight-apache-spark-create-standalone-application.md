...
> [!NOTE]
> A HDInsight emellett az IntelliJ IDEA beépülő modul eszköz létrehozása és alkalmazások egy HDInsight Spark-fürt Linux rendszeren való elküldése folyamatának megkönnyítése érdekében. További információkért lásd: [használata a HDInsight-eszközei beépülő IntelliJ Idea létrehozásához és elküldéséhez a Spark-alkalmazások](hdinsight-apache-spark-intellij-tool-plugin.md).
> 
> 
...
10. Hozza létre a .jar fájlt. IntelliJ IDEA lehetővé teszi a JAR létrehozását, a projekt összetevő. A következő lépésekkel.
    ...
    3. Az a **modulokban létrehozása JAR** párbeszédpanel párbeszédpanelen kattintson a három pont (![három pont](./media/hdinsight-apache-spark-create-standalone-application/ellipsis.png) ) szemben a **fő osztály**.
