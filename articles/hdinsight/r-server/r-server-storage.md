...
Az összes könyvtár és fájl hivatkozása a Storage-fiókra mutat `wasbs://container1@storage1.blob.core.windows.net`. Ez az **alapértelmezett Storage-fiók** , amely a HDInsight-fürthöz van társítva.
