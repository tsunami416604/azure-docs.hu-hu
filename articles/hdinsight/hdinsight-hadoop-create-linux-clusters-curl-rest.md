...
Kövesse a leírt lépéseket [Azure CLI 2.0 használatának első lépései](https://docs.microsoft.com/cli/azure/get-started-with-az-cli2) , és az előfizetés használatával kapcsolódhat a `az login` parancsot.
