...
Kövesse az [Azure CLI használatának első](/cli/azure/get-started-with-az-cli2) lépései című cikkben ismertetett lépéseket, és kapcsolódjon az előfizetéséhez a `az login` paranccsal.
