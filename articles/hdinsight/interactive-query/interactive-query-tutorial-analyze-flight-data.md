---
title: 'Oktatóanyag: Hajtsa végre a kinyerési, átalakítási, betöltési (ETL) művelet az Azure HDInsight interaktív lekérdezés használata'
description: Oktatóanyag – ismerje meg, hogyan adatokat nyerhet ki nyers CSV adatkészletből, átalakítja a HDInsight interaktív lekérdezés használata, és majd betölti az átalakított adatokat az Azure SQL database-be az Apache Sqoop használatával.
...
Ebben az oktatóanyagban a nyilvánosan elérhető flight data nyers CSV adatfájl igénybe, importálja azt a HDInsight-fürt tárhely, és akkor átalakítja az adatokat az Azure HDInsight interaktív lekérdezés használatával. Az adatok átalakítására kerül, ha az adatokat betöltheti egy Azure SQL database-adatbázishoz [Apache Sqoop](https://sqoop.apache.org/).
...
> * Az adatok átalakítása használatával interaktív lekérdezés
...
Ebben az oktatóanyagban megtette a nyers adatok CSV-fájl, importálta, akkor egy HDInsight-fürt storage-ba, és majd alakította át az adatokat az Azure HDInsight interaktív lekérdezés használatával.  Folytassa a következő oktatóanyaggal, az Apache Hive-Warehouse-összekötő.

> [!div class="nextstepaction"]
>[Integráció az Apache Spark és Apache Hive, a Hive Warehouse-összekötő](./apache-hive-warehouse-connector.md)
