...
A D14v2 Worker-csomópontok esetében a llap-várólista javasolt értéke a következő: _ * 80 * *.   
...
Ha módosítania kell a végrehajtók számát, ajánlott 4 GB memóriát használni a végrehajtónál _hive. TEZ. Container. size * által megadott módon, és ügyeljen arra, hogy az összes végrehajtó számára szükséges teljes memória ne haladja meg a LLAP Daemon-tároló számára elérhető teljes memóriát.  
...
**_kaptár. llap. IO. szálkészlet munkaszála belépett. size_*_: ez az érték határozza meg a szálak készletének méretét a végrehajtók számára. Mivel a végrehajtók a megadott módon vannak rögzítve, a végrehajtók száma a LLAP démonnál megegyező lesz. A D14 v2 esetében az ajánlott érték a _* 12** .
