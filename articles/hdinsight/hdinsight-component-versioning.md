...
ms.locfileid: "74406776"
---
# <a name="what-are-the-apache-hadoop-components-and-versions-available-with-hdinsight"></a>What are the Apache Hadoop components and versions available with HDInsight?
...
## <a name="apache-hadoop-components-available-with-different-hdinsight-versions"></a>Apache Hadoop components available with different HDInsight versions
...
| Component (Összetevő)              | HDInsight 4.0 | HDInsight 3.6 (Default)     |
|------------------------|---------------|-----------------------------|
...
## <a name="check-for-current-hadoop-component-version-information"></a>Check for current Hadoop component version information
...
### <a name="available-versions"></a>Available versions
...
| HDInsight version | VM OS | Kiadási dátum | Support expiration date | Retirement date | Magas rendelkezésre állás |  Availability in the Azure portal |
| --- | --- | --- | --- | --- | --- | --- |
| HDInsight 4.0 |Ubuntu 16.0.4 LTS |2018. szeptember 24. | | |Igen |Igen |
| HDInsight 3.6 |Ubuntu 16.0.4 LTS |April 4, 2017 | December 31, 2020 |June 30, 2021 |Igen |Igen |
...
### <a name="retired-versions"></a>Retired versions

The following table lists the versions of HDInsight that are **not** available in the Azure portal.

| HDInsight version | HDP version | VM OS | Kiadási dátum | Support expiration date | Retirement date | Magas rendelkezésre állás |  Availability on the Azure portal |
| --- | --- | --- | --- | --- | --- | --- | --- |
| HDInsight 3.5 |HDP 2.5 |Ubuntu 16.0.4 LTS |September 30, 2016 |September 5, 2017 |2018. június 28. |Igen |Nem |
| HDInsight 3.4 |HDP 2.4 |Ubuntu 14.0.4 LTS |March 29, 2016 |December 29, 2016 |January 9, 2018 |Igen |Nem |
| HDInsight 3.3 |HDP 2.3 |Windows Server 2012 R2 |December 2, 2015 |June 27, 2016 |2018. július 31. |Igen |Nem |
| HDInsight 3.3 |HDP 2.3 |Ubuntu 14.0.4 LTS |December 2, 2015 |June 27, 2016 |July 31, 2017 |Igen |Nem |
| HDInsight 3.2 |HDP 2.2 |Ubuntu 12.04 LTS or Windows Server 2012 R2 |February 18, 2015 |March 1, 2016 |April 1, 2017 |Igen |Nem |
| HDInsight 3.1 |HDP 2.1 |Windows Server 2012 R2 |June 24, 2014 |May 18, 2015 |June 30, 2016 |Igen |Nem |
| HDInsight 3.0 |HDP 2.0 |Windows Server 2012 R2 |February 11, 2014 |September 17, 2014 |June 30, 2015 |Igen |Nem |
| HDInsight 2.1 |HDP 1.3 |Windows Server 2012 R2 |October 28, 2013 |May 12, 2014 |May 31, 2015 |Igen |Nem |
| HDInsight 1.6 |HDP 1.1 | |October 28, 2013 |April 26, 2014 |May 31, 2015 |Nem |Nem |
...
## <a name="enterprise-security-package-for-hdinsight"></a>Enterprise Security Package for HDInsight
...
### <a name="supported-cluster-types"></a>Supported cluster types
...
### <a name="support-for-azure-data-lake-storage"></a>Support for Azure Data Lake Storage
...
## <a name="service-level-agreement-for-hdinsight-cluster-versions"></a>Service level agreement for HDInsight cluster versions
...
## <a name="hortonworks-release-notes-associated-with-hdinsight-versions"></a>Hortonworks release notes associated with HDInsight versions
...
## <a name="default-node-configuration-and-virtual-machine-sizes-for-clusters"></a>Default node configuration and virtual machine sizes for clusters
