...
- **HDInsight 叢集**。 若要設定此叢集，請參閱 [入門 ][hdinsight-get-started]。
...
## <a id="ImportData"></a>將 HDInsight 資料匯入 Excel
...
* [將 Excel 連接到 HDInsight 使用 Microsoft Hive ODBC 驅動程式 ][hdinsight-odbc]
