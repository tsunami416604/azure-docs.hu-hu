...
|ÁLLAPOT|Az egyik: megszakított, elfogadott, ClusterStorageProvisioned, AzureVMConfiguration, HDInsightConfiguration, működési, futó, hiba, törlés, törölt, időtúllépés, DeleteQueued, DeleteTimedout, DeleteError, PatchQueued, CertRolloverQueued, ResizeQueued vagy ClusterCustomization.|
