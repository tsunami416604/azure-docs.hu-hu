...
| Eszközök | - [Az Ambari nézetek használata Tez feladatokhoz](hdinsight-debug-ambari-tez-view.md)<br>- [Hive-lekérdezések optimalizálása](hdinsight-hadoop-optimize-hive-query.md)<br>- [Az HDInsight IntelliJ eszközzel](./spark/apache-spark-intellij-tool-plugin.md)<br>- [HDInsight Eclipse eszköz](./spark/apache-spark-eclipse-tool-plugin.md)<br>- [HDInsight VSCode eszköz](hdinsight-for-vscode.md)<br>- [HDInsight Visual Studio eszközzel](./hadoop/apache-hadoop-visual-studio-tools-get-started.md) |
