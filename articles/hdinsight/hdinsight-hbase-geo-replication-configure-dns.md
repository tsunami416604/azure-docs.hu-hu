...
- [設定兩個虛擬網路 ][hdinsight-hbase-geo-replication-vnet]
- 設定虛擬網路的 DNS (本教學課程)
- [設定 HBase 異地複寫 ][hdinsight-hbase-geo-replication]


下圖說明您在中建立兩個虛擬網路 [設定兩個虛擬網路 ][hdinsight-hbase-geo-replication-vnet]:
...
- **具備 VPN 連線的兩個 Azure 虛擬網路**。 如需指示，請參閱 [設定兩個 Azure 虛擬網路 ][hdinsight-hbase-geo-replication-vnet]。
...
- [設定兩個 Azure 虛擬網路 ][hdinsight-hbase-geo-replication-vnet]
- [設定 HBase 異地複寫 ][hdinsight-hbase-geo-replication]
