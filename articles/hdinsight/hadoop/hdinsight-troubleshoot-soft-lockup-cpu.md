...
description: a watchdog BUG Soft kizárható PROCESSZORa megjelenik a kernel syslogs-ben
...
A [](https://bugzilla.kernel.org/show_bug.cgi?id=199437) Linux kernel hibája okozza a processzorok lágy lefagyását.
