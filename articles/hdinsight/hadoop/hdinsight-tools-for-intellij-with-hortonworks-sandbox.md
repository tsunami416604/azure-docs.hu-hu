...
1. Nyissa meg a IntelliJ ÖTLETET a számítógépén. Az **új projekt** párbeszédpanelen hajtsa végre a következő lépéseket:
   ...
   1. Válassza a **HDInsight** > **Spark on HDInsight (Scala)** lehetőséget.
...
8. A **Név** mezőben adja meg a megfelelő nevet. A **típus** mezőben válassza az **objektum**lehetőséget. Ezután kattintson **az OK gombra**.
...
4. Az **új emulátor csatolása** párbeszédpanelen adja meg a Hortonworks-homokozó gyökeréhez beállított jelszót. Ezután adja meg az alábbi képernyőképen használt értékeket. Ezután kattintson **az OK gombra**. 
