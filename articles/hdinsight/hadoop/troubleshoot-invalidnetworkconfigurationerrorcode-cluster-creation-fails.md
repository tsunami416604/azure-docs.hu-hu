...
A hibakód másik oka `InvalidNetworkConfigurationErrorCode` lehet az elavult paraméter használata a `EnableVmProtection` PowerShellben vagy egy Azure-Runbook.
