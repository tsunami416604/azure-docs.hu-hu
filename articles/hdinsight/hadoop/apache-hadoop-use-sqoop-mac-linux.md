...
* [HDInsight használatával repülőjáratok késési adatainak elemzése](../interactive-query/interactive-query-tutorial-analyze-flight-data.md): Repülőjáratok késési adatainak elemzése interaktív lekérdezés használatával, és a Sqoop használatával egy Azure SQL database-adatok exportálása.
