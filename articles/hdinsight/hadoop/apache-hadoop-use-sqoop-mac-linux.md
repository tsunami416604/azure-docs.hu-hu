...
* Előfordulhat, hogy kell konfigurálnia az SQL Server távoli kapcsolatokat fogadjon. További információkért lásd: a [az SQL Server adatbázismotorral való csatlakozás hibaelhárítása](http://social.technet.microsoft.com/wiki/contents/articles/2102.how-to-troubleshoot-connecting-to-the-sql-server-database-engine.aspx) dokumentumot.
