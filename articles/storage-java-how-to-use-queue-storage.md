...
-   [Configure your application to access queue storage][Configure your application to access queue storage]
...
-   [Additional options for dequeuing messages][Additional options for dequeuing messages]
-   [How to: List the queues][How to: List the queues]
