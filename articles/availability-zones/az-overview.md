...
- [Az Azure Cosmos DB zóna redundáns régió hozzáadása](../cosmos-db/high-availability.md#availability-zone-support)
- [Ismerkedés az Azure Cache Redis rendelkezésre állási zónák](https://aka.ms/redis/az/getstarted)
