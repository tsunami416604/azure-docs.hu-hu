---
title: Példa Azure igazolási szabályzatra
description: Példák az Azure igazolási szabályzatára.
...
## <a name="unsigned-policy-for-an-sgx-enclave-with-policyformatjwt"></a>Aláíratlan szabályzat egy SGX ENKLÁVÉHOZ enklávéhoz PolicyFormat = JWT
...
## <a name="signed-policy-for-an-sgx-enclave-with-policyformatjwt"></a>Aláírt szabályzat egy SGX ENKLÁVÉHOZ enklávéhoz PolicyFormat = JWT
