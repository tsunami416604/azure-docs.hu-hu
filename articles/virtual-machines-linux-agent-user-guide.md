...
-   or from the [Github Open Source Repository for the Azure Linux Agent][Github Open Source Repository for the Azure Linux Agent]
...
### Sample Role Topology File
  ...
  [Github Open Source Repository for the Azure Linux Agent]: https://github.com/WindowsAzure/WALinuxAgent
