...
Azure 客戶享有 [特別優惠](http://www.twilio.com/azure): 價值 $10 的 Twilio 點數升級 Twilio 帳戶時。 此 Twilio 點數可用來折抵任何 Twilio 使用量 ($10 點數相當於最多傳送 1,000 則簡訊，或最多接收 1000 分鐘的撥入語音，視電話號碼所在地點或通話目的地而定)。 兌換 Twilio 點數，並開始使用: [http://ahoy.twilio.com/azure](http://ahoy.twilio.com/azure)。
