...
<tags ms.service="storage" ms.workload="storage" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="10/17/2014" ms.author="tamram"></tags>
...
> [WACOM.NOTE] This guide assumes that you have installed AzCopy 3.0.0 or later. AzCopy 3.x is now in general availability.
> This guide also covers using AzCopy 4.0.0, which is a preview release of AzCopy. Throughout this guide, functions provided only in the preview release are designated as *preview*.
> Note that for AzCopy 4.x, command-line options and functionality may change in future releases.

## Table of contents

-   [Download and install AzCopy][Download and install AzCopy]
-   [Understand the AzCopy command-line syntax][Understand the AzCopy command-line syntax]
-   [Limit concurrent writes while copying data][Limit concurrent writes while copying data]
-   [Copy Azure blobs with AzCopy][Copy Azure blobs with AzCopy]
-   [Copy files in an Azure file share with AzCopy (preview version only)][Copy files in an Azure file share with AzCopy (preview version only)]
-   [Copy Azure Table Entities with AzCopy (preview version only)][Copy Azure Table Entities with AzCopy (preview version only)]
-   [AzCopy versions][AzCopy versions]
-   [Next steps][Next steps]

## <span id="install"></span></a> Download and install AzCopy

1.  Download the [latest version of AzCopy][latest version of AzCopy], or the [latest preview version][latest preview version].
...
## <span id="syntax"></span></a> Understand the AzCopy command-line syntax
...
| Option Name                                                             | Description                                                                                                                                                                                                                                                                                                                                                     | Applicable to Blob Storage (Y/N) | Applicable to File Storage (Y/N) (preview release only) | Applicable to Table Storage (Y/N) (preview release only) |
|-------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|---------------------------------------------------------|----------------------------------------------------------|
| **/Source:\<source\>**                                                  | Specifies the source data from which to copy. The source can be a file system directory, a blob container, a blob virtual directory, a storage file share, a storage file directory, or an Azure table.                                                                                                                                                         | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/Dest:\<destination\>**                                               | Specifies the destination to copy to. The destination can be a file system directory, a blob container, a blob virtual directory, a storage file share, a storage file directory, or an Azure table.                                                                                                                                                            | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/Pattern:\<file-pattern\>**                                           | Specifies a file pattern that indicates which files to copy. The behavior of the /Pattern parameter is determined by the location of the source data, and the presence of the recursive mode option. Recursive mode is specified via option /S.                                                                                                                 
                                                                            ...
                                                                            The default file pattern used when no file pattern is specified is \*.\* for a file system location or an empty prefix for an Azure Storage location. Specifying multiple file patterns is not supported.                                                                                                                                                       | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | N                                                        |
| **/DestKey:\<storage-key\>**                                            | Specifies the storage account key for the destination resource.                                                                                                                                                                                                                                                                                                 | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/DestSAS:\<sas-token\>**                                              | Specifies a Shared Access Signature (SAS) for the destination container (if applicable). Surround the SAS with double quotes, as it may contains special command-line characters.                                                                                                                                                                               
                                                                            If the destination resource is a blob container or table, you can either specify this option followed by the SAS token, or you can specify the SAS as part of the destination blob's URI, without this option.                                                                                                                                                  
                                                                            If the source and destination are both blobs, then the destination blob must reside within the same storage account as the source blob.                                                                                                                                                                                                                         | Y                                | N                                                       | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only                                            |
| **/SourceKey:\<storage-key\>**                                          | Specifies the storage account key for the source resource.                                                                                                                                                                                                                                                                                                      | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/SourceSAS:\<sas-token\>**                                            | Specifies a Shared Access Signature for the source container (if applicable). Surround the SAS with double quotes, as it may contains special command-line characters.                                                                                                                                                                                          
                                                                            ...
                                                                            If the source is a table, a key or a SAS must be provided.                                                                                                                                                                                                                                                                                                      | Y                                | N                                                       | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/S**                                                                  | Specifies recursive mode for copy operations. In recursive mode, AzCopy will copy all blobs or files that match the specified file pattern, including those in subfolders.                                                                                                                                                                                      | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | N                                                        |
| **/BlobType:\<block | page\>**                                          | Specifies whether the destination blob is a block blob or a page blob. This option is applicable only when uploading blob; otherwise, an error is generated. If the destination is a blob and this option is not specified, then by default AzCopy will create a block blob.                                                                                    | Y                                | N                                                       | N                                                        |
| **/CheckMD5**                                                           | Calculates an MD5 hash for downloaded data and verifies that the MD5 hash stored in the blob or file's Content-MD5 property matches the calculated hash. The MD5 check is turned off by default, so you must specify this option to perform the MD5 check when downloading data.                                                                                
                                                                            ...
                                                                            AzCopy always sets the Content-MD5 property for an Azure blob or file after uploading it to the service.                                                                                                                                                                                                                                                        | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | N                                                        |
| **/Snapshot**                                                           | Indicates whether to transfer snapshots. This option is only valid when the source is a blob.                                                                                                                                                                                                                                                                   
                                                                            The transferred blob snapshots are renamed in this format: [blob-name] (snapshot-time)[extension].                                                                                                                                                                                                                                                              
                                                                            By default, snapshots are not copied.                                                                                                                                                                                                                                                                                                                           | Y                                | N                                                       | N                                                        |
| **/V:[verbose log-file]**                                               | Outputs verbose status messages into a log file. By default, the verbose log file is named `AzCopyVerbose.log` in `%LocalAppData%\Microsoft\Azure\AzCopy`. If you specify an existing file location for this option, the verbose log will be appended to that file.                                                                                             | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/Z:[journal-file-folder]**                                            | Specifies a journal file folder for resuming an operation.                                                                                                                                                                                                                                                                                                      
                                                                            ...
                                                                            Note that resuming an operation from a journal file created by a previous version of AzCopy is not supported.                                                                                                                                                                                                                                                   | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/@:parameter-file**                                                   | Specifies a file that contains parameters. AzCopy processes the parameters in the file just as if they had been specified on the command line.                                                                                                                                                                                                                  
                                                                            ...
                                                                            You can specify multiple response files. However, note that AzCopy does not support nested response files.                                                                                                                                                                                                                                                      | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
...
| **/MT**                                                                 | Sets the downloaded file's last-modified time to be the same as the source blob or file's.                                                                                                                                                                                                                                                                      | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | N                                                        |
| **/XN**                                                                 | Excludes a newer source resource. The resource will not be copied if the source is newer than destination.                                                                                                                                                                                                                                                      | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | N                                                        |
| **/XO**                                                                 | Excludes an older source resource. The resource will not be copied if the source resource is older than destination.                                                                                                                                                                                                                                            | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | N                                                        |
| **/A**                                                                  | Uploads only files that have the Archive attribute set.                                                                                                                                                                                                                                                                                                         | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | N                                                        |
| **/IA:[RASHCNETOI]**                                                    | Uploads only files that have any of the specified attributes set.                                                                                                                                                                                                                                                                                               
                                                                            ...
                                                                            T   Temporary files                                                                                                                                                                                                                                                                                                                                             
                                                                            O   Offline files                                                                                                                                                                                                                                                                                                                                               
                                                                            I   Non-indexed Files                                                                                                                                                                                                                                                                                                                                           | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | N                                                        |
| **/XA:[RASHCNETOI]**                                                    | Excludes files that have any of the specified attributes set.                                                                                                                                                                                                                                                                                                   
                                                                            Available attributes include:                                                                                                                                                                                                                                                                                                                                   
                                                                            R   Read-only files                                                                                                                                                                                                                                                                                                                                             
                                                                            A   Files ready for archiving                                                                                                                                                                                                                                                                                                                                   
                                                                            S   System files                                                                                                                                                                                                                                                                                                                                                
                                                                            ...
                                                                            I   Non-indexed Files                                                                                                                                                                                                                                                                                                                                           | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | N                                                        |
| **/Delimiter:\<delimiter\>**                                            | Indicates the delimiter character used to delimit virtual directories in a blob name.                                                                                                                                                                                                                                                                           
                                                                            ...
                                                                            This option is only applicable for downloading blobs.                                                                                                                                                                                                                                                                                                           | Y                                | N                                                       | N                                                        |
| **/NC:\<number-of-concurrents\>**                                       | Specifies the number of concurrent operations.                                                                                                                                                                                                                                                                                                                  
                                                                            ...
                                                                            The upper limit for concurrent operations is 512.                                                                                                                                                                                                                                                                                                               | Y                                | Y                                                       
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (preview only)                                          | N                                                        |
| **/SourceType:Blob|Table**                                              | Specifies that the `source` resource is a blob available in the local development environment, running in the storage emulator.                                                                                                                                                                                                                                 | Y                                | N                                                       | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/DestType:Blob|Table**                                                | Specifies that the `destination` resource is a blob available in the local development environment, running in the storage emulator.                                                                                                                                                                                                                            | Y                                | N                                                       | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/PKRS:\<"key1\#key2\#key3\#..."\>**                                   | Splits the partition key range to enable exporting table data in parallel, which increases the speed of the export operation.                                                                                                                                                                                                                                   
                                                                            ...
                                                                               [bb, \<last partition key\>]                                                                                                                                                                                                                                                                                                                                 | N                                | N                                                       | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/SplitSize:**<file-size>**\<file-size\>**                             | Specifies the exported file split size in MB.                                                                                                                                                                                                                                                                                                                   
                                                                            If this option is not specified, AzCopy will export table data to single file.                                                                                                                                                                                                                                                                                  
                                                                            If the table data is exported to a blob, and the exported file size reaches the 200 GB limit for blob size, then AzCopy will split the exported file, even if this option is not specified.                                                                                                                                                                     | N                                | N                                                       | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/EntityOperation:\<InsertOrSkip | InsertOrMerge | InsertOrReplace\>** | Specifies the table data import behavior.                                                                                                                                                                                                                                                                                                                       
                                                                            ...
                                                                            InsertOrReplace - Replaces an existing entity or inserts a new entity if it does not exist in the table.                                                                                                                                                                                                                                                        | N                                | N                                                       | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |
| **/Manifest:\<manifest-file\>**                                         | Specifies the manifest file for the import operation.                                                                                                                                                                                                                                                                                                           
                                                                            The manifest file is generated during the export operation.                                                                                                                                                                                                                                                                                                     | N                                | N                                                       | Y                                                        
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (preview only)                                           |

## <span id="limit-writes"></span></a> Limit concurrent writes while copying data
...
## <span id="copy-blobs"></span></a> Copy Azure blobs with AzCopy
...
When you copy a blob within a storage account or across storage accounts, a server-side copy operation is performed. For more information about server-side copy operations, see [Introducing Asynchronous Cross-Account Copy Blob][Introducing Asynchronous Cross-Account Copy Blob].
...
## <span id="copy-files"></span></a> Copy files in Azure File storage with AzCopy (preview version only)
...
## <span id="copy-entities"></span></a> Copy Entities in an Azure Table with AzCopy (preview version only)
...
The generated JSON data file follows the payload format for minimal metadata. For details on this payload format, see [Payload Format for Table Service Operations][Payload Format for Table Service Operations].
...
## <span id="versions"></span></a> AzCopy versions
...
-   [Store files in Blob storage][Store files in Blob storage]
-   [Create an SMB file share in Azure with File storage][Create an SMB file share in Azure with File storage]

### Azure Storage blog posts:

-   [Introducing Microsoft Azure File Service][Introducing Microsoft Azure File Service]
-   [AzCopy 2.5: Optimized for Large-Scale Copy Scenarios][AzCopy 2.5: Optimized for Large-Scale Copy Scenarios]
-   [AzCopy: Support for read-access geo-redundant storage][AzCopy: Support for read-access geo-redundant storage]
-   [AzCopy: Transfer data with re-startable mode and SAS token][AzCopy: Transfer data with re-startable mode and SAS token]
-   [AzCopy: Using cross-account Copy Blob][AzCopy: Using cross-account Copy Blob]
-   [AzCopy: Uploading/downloading files for Windows Azure Blobs][AzCopy: Uploading/downloading files for Windows Azure Blobs]
  ...
  [latest preview version]: http://aka.ms/downloadazcopypr
  [Introducing Asynchronous Cross-Account Copy Blob]: http://blogs.msdn.com/b/windowsazurestorage/archive/2012/06/12/introducing-asynchronous-cross-account-copy-blob.aspx
  [Payload Format for Table Service Operations]: http://msdn.microsoft.com/library/azure/dn535600.aspx
