...
可透過 Azure 自動化中管理 API 管理 [API 管理 REST API](https://msdn.microsoft.com/library/azure/dn776326.aspx)。 在 Azure 自動化內，您可以利用 REST API 撰寫 PowerShell 工作流程指令碼，以執行許多 API 管理工作。 您也可以將 Azure 自動化中的這些 REST API 與其他 Azure 服務的 Cmdlet 搭配，以透過 Azure 服務和協力廠商系統自動執行複雜的工作。
