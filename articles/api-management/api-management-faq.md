...
Használja az [`New-AzApiManagementBackend`](https://docs.microsoft.com/powershell/module/az.apimanagement/new-azapimanagementbackend) (új háttérrendszer) vagy [`Set-AzApiManagementBackend`](https://docs.microsoft.com/powershell/module/az.apimanagement/set-azapimanagementbackend) a (meglévő háttérrendszer) PowerShell `True`-parancsmagokat, és állítsa `-SkipCertificateChainValidation` a paramétert a következőre:. 
...
1. Hozzon [](/rest/api/apimanagement/) létre egy háttérbeli entitást API Management használatával.     
...
Ha többet szeretne megtudni a klasszikus és a Resource Manager-modellekről az Azure-ban, tekintse át az [üzembe helyezési modellek különbségét](../azure-resource-manager/resource-manager-deployment-model.md).
...
Igen. További információ: [erőforrások áthelyezése új erőforráscsoporthoz vagy](../azure-resource-manager/resource-group-move-resources.md)előfizetésbe.
