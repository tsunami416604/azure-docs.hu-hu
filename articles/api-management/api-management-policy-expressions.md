...
|<a id="ref-context-response"></a>összefüggésben. Válasz|Szövegtörzs: [IMessageBody](#ref-imessagebody)<br /><br /> [Fejlécek](#ref-context-response-headers): IReadOnlyDictionary < karakterlánc, karakterlánc [] ><br /><br /> StatusCode: int<br /><br /> StatusReason: karakterlánc|
