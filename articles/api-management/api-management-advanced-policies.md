...
#### <a name="example"></a>Példa
 A következő API-szintű szabályzat továbbítja a háttérszolgáltatás 60 másodperces időtúllépési időköz minden kérelemhez.
...
|Elem|Leírás|Szükséges|
|-------------|-----------------|--------------|
|továbbítás – kérelem|A gyökérelem.|Igen|

### <a name="attributes"></a>Attribútumok

|Attribútum|Leírás|Szükséges|Alapértelmezett|
|---------------|-----------------|--------------|-------------|
|timeout="integer"|Az időkorlát másodpercben a háttérszolgáltatás hívása előtt sikertelen lesz.|Nem|300 másodperc|
...
|Elem|Leírás|Szükséges|
|-------------|-----------------|--------------|
|naplófájl – eventhub|A gyökérelem. Ez az elem értéke a karakterláncot az eseményközpont bejelentkezni.|Igen|

### <a name="attributes"></a>Attribútumok

|Attribútum|Leírás|Szükséges|
|---------------|-----------------|--------------|
|naplózó-azonosító|A naplózó azonosítóját az API Management szolgáltatás regisztrálva.|Igen|
|partíció-azonosító|Itt adhatja meg, ahol az üzenetek küldése történik a partíció indexét.|Választható. Ez az attribútum nem használható, ha `partition-key` szolgál.|
...
|Attribútum|Leírás|Szükséges|Alapértelmezett|
|---------------|-----------------|--------------|--------------|
|állapotkód|Adja meg a válasz állapotkódja, és válassza ki a megfelelő példa vagy séma szolgál.|Nem|200|
...
|a különbözeti|Egy pozitív szám, a várakozási időköz növekmény megadása másodpercben. Az exponenciális, és lineáris újrapróbálkozási algoritmusok megvalósításának szolgál.|Nem|–|
...
|Attribútum|Leírás|Szükséges|Alapértelmezett|
|---------------|-----------------|--------------|-------------|
|URL-címe = "string"|Proxykiszolgáló URL-cím formájában http://host:port.|Igen|–|
|felhasználónév = "string"|A proxy-hitelesítéshez használandó felhasználónév.|Nem|–|
