---
title: A Role-Based Access Control használata az Azure-ban API Management | Microsoft Docs
...
Ha többet szeretne megtudni az Azure-beli Role-Based Access Controlról, tekintse meg a következő cikkeket:
