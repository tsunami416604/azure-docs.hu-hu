...
- [A API Management költségeinek megtervezése és kezelése](plan-manage-costs.md)
- [API Management korlátok](../azure-resource-manager/management/azure-subscription-service-limits.md#api-management-limits)