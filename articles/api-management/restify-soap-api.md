---
title: "A SOAP API importálhatja, és az Azure portál használatával REST átalakítása |} Microsoft Docs"
description: "Megtudhatja, hogyan importálhatja egy SOAP API, és átalakíthatja a REST API-kezeléssel."
...
---
# <a name="import-a-soap-api-and-convert-to-rest"></a>Egy SOAP API importálhatja, és a többi átalakítása

Ez a cikk bemutatja, hogyan importálhatja egy SOAP API, és átalakíthatja a többi. A cikk azt is bemutatja, hogyan tesztelheti a APIM API.

Ebből a cikkből megismerheti, hogyan:

> [!div class="checklist"]
> * Egy SOAP API importálhatja, és a többi átalakítása
...
2. Válassza ki **WSDL** a a **hozzáadása egy új API** listája.
    ...
    ![A SOAP API](./media/restify-soap-api/wsdl-api.png)
3. Az a **WSDL specification**, adja meg az URL-címet a SOAP API tároló.
4. Kattintson a **többi SOAP** választógombot. Ez a beállítás kattintáskor APIM tett kísérletet automatikus átalakulása XML és JSON között. Ebben az esetben fogyasztók kell lennie a API felület meghívásakor, egy restful API, és adja vissza JSON. APIM kéréseknek konvertálásakor SOAP hívásakor.

    ![SOAP és REST közötti](./media/restify-soap-api/soap-to-rest.png)
