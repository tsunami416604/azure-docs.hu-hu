...
> 如果您熟悉 [bootstrap](http://getbootstrap.com/), ，這些規則，實際上是 [變數較少](http://getbootstrap.com/css/) 開發人員入口網站所使用的 bootstrap 佈景主題內。
...
對所選取元素的樣式完成變更時，請按一下 [預覽變更]****，在畫面上查看結果。 目前只有管理員可看見這些結果。 若要讓每個人都可看見這些變更，請在樣式編輯器中按一下 [發行]**** 按鈕並確認變更。
