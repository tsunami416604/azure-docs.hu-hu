...
A [rendszergazdák](howto-administer-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) az előre definiált szerepkörök használatával meghatározhatják az Azure IoT Central-alkalmazások hozzáférési szabályait. A rendszergazdák olyan szerepkörökhöz rendelhetnek felhasználókat, amelyek meghatározzák az alkalmazás azon területeit, amelyekhez a felhasználó hozzáfér.
