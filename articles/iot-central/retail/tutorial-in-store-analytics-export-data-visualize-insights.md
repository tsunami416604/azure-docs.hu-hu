...
* Az előző két oktatóanyag befejezéséhez [hozzon létre egy üzleten belüli elemzési alkalmazást az Azure IoT Centralban,](./tutorial-in-store-analytics-create-app.md) és [szabja testre az operátorirányítópultot, és kezelje az eszközöket az Azure IoT Centralban.](./tutorial-in-store-analytics-customize-dashboard.md)
...
![Eseményközpont](./media/tutorial-in-store-analytics-visualize-insights/event-hub.png)
...
![Folyamatos adatexportálási konfiguráció](./media/tutorial-in-store-analytics-visualize-insights/export-configuration.png)
...
![Zóna adatkészletei](./media/tutorial-in-store-analytics-visualize-insights/dataset-1.png)
...
![Foglaltsági adatkészlet](./media/tutorial-in-store-analytics-visualize-insights/dataset-2.png)
...
A logikai alkalmazás létrehozása előtt szüksége van az IoT Central-alkalmazáshoz csatlakoztatott két RuuviTag-érzékelő eszközazonosítóira az [Azure IoT Central oktatóanyagának létrehozása](./tutorial-in-store-analytics-create-app.md) című oktatóalkalmazásban:
...
1. Jegyezze fel az **eszközazonosítókat.** A következő screenshot, az azonosítók **f5dcf4ac32e8** és **e29ffc8d5326**:
    ...
    ![Eszközazonosítók](./media/tutorial-in-store-analytics-visualize-insights/device-ids.png)
...
1. Válassza a **Mentés,** majd a **Tervező** lehetőséget a hozzáadott logika vizuális verziójának megtekintéséhez:
    ...
    ![Logikai alkalmazás tervezése](./media/tutorial-in-store-analytics-visualize-insights/logic-app.png)
...
1. A bejelentkezési folyamat befejezése után a **Sorok hozzáadása adatkészlethez** műveletben:
    ...
    * A módosítások mentéséhez válassza a **Mentés** gombot. A **Zone 1 környezeti** művelet a ![következő képernyőképhez hasonlóan néz ki: 1. zóna környezet](./media/tutorial-in-store-analytics-visualize-insights/zone-1-action.png)
...
1. A **Sorok hozzáadása adatkészlethez 2** műveletben:
    ...
    * Jelölje be a **Páratartalom** mezőt, majd válassza a **Tovább lehetőséget** az **Elemzési telemetria ielemetási mező**mellett. Ezután válassza a **páratartalmat**.
    * Jelölje be a **Hőmérséklet** mezőt, majd válassza a **Tovább pont** lehetőséget az **Elemzési telemetria ielemtria**mellett. Ezután válassza ki a **hőmérsékletet**.
    A módosítások mentéséhez válassza a **Mentés** gombot.  A **Zone 2 környezeti** művelet a ![következő képernyőképre néz ki: 2. zóna környezet](./media/tutorial-in-store-analytics-visualize-insights/zone-2-action.png)
...
1. A **Sorok hozzáadása adatkészlethez** műveletben:
    ...
    * A módosítások mentéséhez válassza a **Mentés** gombot. A **Dwell Time felület** művelet a ![következő képernyőképhez hasonlóan néz ki: Kihasználtsági művelet](./media/tutorial-in-store-analytics-visualize-insights/occupancy-action-1.png)
...
1. A **Sorok hozzáadása adatkészlethez** műveletben:
    ...
    * A módosítások mentéséhez válassza a **Mentés** gombot. A **Személyek száma felület** művelet a ![következő képernyőképhez hasonlóan néz ki: Kihasználtsági művelet](./media/tutorial-in-store-analytics-visualize-insights/occupancy-action-2.png)
...
![Vonaldiagram beállításai](./media/tutorial-in-store-analytics-visualize-insights/line-chart.png)
...
![Kártyabeállítások](./media/tutorial-in-store-analytics-visualize-insights/card-settings.png)
...
![Power BI-irányítópult](./media/tutorial-in-store-analytics-visualize-insights/pbi-dashboard-graphics.png)
