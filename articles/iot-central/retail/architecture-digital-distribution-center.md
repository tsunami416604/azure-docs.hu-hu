...
A digitálisan összekapcsolt vállalati szintű ökoszisztémában a videokamerák az elsődleges érzékelők. A gépi tanulás és a mesterséges intelligencia fejlődése, amely lehetővé teszi a videó strukturált adatokká alakítását és feldolgozását a felhőbe való küldés előtt. Ip-kamerák segítségével képeket készíthetünk, tömöríthetjük őket a kamerán, majd elküldhetjük a tömörített adatokat a videoelemzési folyamat szélvonalán keresztül, vagy GigE vision kamerákkal készíthetünk képeket az érzékelőn, majd elküldhetjük ezeket a képeket közvetlenül az Azure IoT Edge-nek, amely a videóelemzési folyamat feldolgozása előtt tömörít. 
...
* További információ a [digitális elosztóközpont-sablon telepítéséről](./tutorial-iot-central-digital-distribution-center.md)
