...
További információ: [A telepítés és a séta egy csatlakoztatott logisztikai alkalmazássablon](./tutorial-iot-central-connected-logistics.md) oktatóanyag.
...
További információ: [A telepítés és a séta a digitális elosztóközpont alkalmazássablon](./tutorial-iot-central-digital-distribution-center.md) oktatóanyag.
...
További információkért tekintse meg a [Hozzon létre egy in-store elemzési alkalmazás az Azure IoT Central](./tutorial-in-store-analytics-create-app.md) oktatóanyag.
...
További információ: [A telepítés és az intelligens készletkezelési alkalmazássablon oktatóanyaga.](./tutorial-iot-central-smart-inventory-management.md)
...
További információ: [A telepítés és a séta a mikro-teljesítési központ alkalmazássablon](./tutorial-micro-fulfillment-center.md) oktatóanyag.

## <a name="next-steps"></a>További lépések

Kiskereskedelmi megoldás létrehozásának első lépései:

* Első lépések: [Hozzon létre egy in-store elemzési alkalmazást az Azure IoT Central oktatóanyagban,](./tutorial-in-store-analytics-create-app.md) amely bemutatja, hogyan hozhat létre megoldást az egyik üzleten belüli elemzési alkalmazássablonnal.
* [Telepítsen és léptsen végig egy csatlakoztatott logisztikai alkalmazássablonon.](./tutorial-iot-central-connected-logistics.md)
* [Digitális elosztóközpont-alkalmazássablon telepítése és végigvezeti azt.](./tutorial-iot-central-digital-distribution-center.md)
* [Intelligens készletkezelési alkalmazássablon üzembe helyezése és végigvezeti azt.](./tutorial-iot-central-smart-inventory-management.md)
* [Telepítse és sétáljon végig a mikro-teljesítési központ alkalmazássablonon.](./tutorial-micro-fulfillment-center.md)
