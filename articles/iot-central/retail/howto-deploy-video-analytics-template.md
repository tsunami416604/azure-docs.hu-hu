...
Most áttekintheti a video Analytics alkalmazás-sablon üzembe helyezésének és használatának lépéseit. a kezdéshez tekintse meg a [video Analytics n-alkalmazás létrehozása az Azure-ban IoT Central](tutorial-video-analytics-create-app.md) .
