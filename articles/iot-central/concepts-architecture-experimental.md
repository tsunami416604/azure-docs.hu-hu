...
![Legfelső szintű architektúra](media/concepts-architecture-experimental/architecture.png)
...
Hogyan eszközök csatlakoztatása az Azure IoT Central alkalmazásnak kapcsolatos további információkért lásd: [eszközkapcsolatok](concepts-connectivity-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
Eszköz csatlakoztatása az Azure IoT Central kapcsolatos további információkért lásd: [eszközkapcsolatok](concepts-connectivity-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
![Sablon-architektúra](media/concepts-architecture-experimental/template_architecture.png)
...
Egy [rendszergazdai hozzáférési szabályokat definiálhat](howto-administer-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) az előre definiált szerepkörök használatával az Azure IoT Central alkalmazáshoz. A rendszergazda felhasználókat rendelhet szerepköröket, amelyek meghatározzák, milyen területeken, az alkalmazás a felhasználónak hozzáférése van.
...
Most, hogy az Azure IoT Central architektúrája megismerkedett a javasolt következő lépésre kapcsolatos [eszközkapcsolatok](concepts-connectivity-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) az Azure IoT Central.