...
> [Hozzon létre egy új sablon-verziót](howto-version-device-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
> [csatlakoztasson egy MXChip IoT fejlesztői készlet-eszközt az Azure IoT Central-alkalmazáshoz](howto-connect-devkit-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
