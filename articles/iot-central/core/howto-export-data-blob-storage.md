...
7. Válassza ki a kívánt **adatformátumot** : JSON vagy [Apache Avro](https://avro.apache.org/docs/current/index.html) Format.
...
> [!NOTE]
> Győződjön meg arról, hogy az eszközök `contentType: application/JSON` és `contentEncoding:utf-8` (vagy `utf-16`, `utf-32`) üzeneteket küldenek. Példaként tekintse meg [IoT hub dokumentációját](https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-routing-query-syntax#message-routing-query-based-on-message-body) .
