...
1. Hozzon létre egy [telemetria-szabályt](tutorial-create-telemetry-rules-pnp.md). Mentse a szabályt, és adjon hozzá egy új műveletet.

    ![Webhook-létrehozási képernyő](media/howto-create-webhooks-pnp/webhookcreate.png)
...
Most, hogy megismerte a webhookok beállítását és használatát, a javasolt következő lépés az [Azure monitor műveleti csoportok konfigurálásának](howto-use-action-groups-pnp.md)megismerése.
