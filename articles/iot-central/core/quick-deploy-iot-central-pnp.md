...
![Azure IoT Central alkalmazás létrehozása lap](media/quick-deploy-iot-central-pnp/iotcentralcreate-templates-pnp.png)
...
1. Az Azure IoT Central az alkalmazás neve alapján egyedi **URL-** előtagot is létrehoz az Ön számára. Ezt az URL-címet használja az alkalmazás eléréséhez. Ha szeretné, megváltoztathatja ezt az URL-előtagot valami emlékezetre.
    ...
    ![Azure IoT Central alkalmazás létrehozása lap](media/quick-deploy-iot-central-pnp/iotcentralcreate-industry-pnp.png)
...
> [Szimulált eszköz hozzáadása a IoT Central alkalmazáshoz](./quick-create-pnp-device-pnp.md)
