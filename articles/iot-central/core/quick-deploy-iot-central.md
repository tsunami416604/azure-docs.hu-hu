...
Hozzon létre egy új alkalmazást az iparághoz kapcsolódó IoT Central sablonok listájából, amely segítséget nyújt a gyors kezdéshez, vagy az **egyéni alkalmazás** sablonjának használatával. Ebben a rövid útmutatóban az **egyéni alkalmazás** sablont használja.
...
1. Válassza az **Egyéni** alkalmazás lehetőséget, és győződjön meg arról, hogy az **egyéni alkalmazás** sablon van kiválasztva.
...
1. Az Azure IoT Central az alkalmazás neve alapján egyedi **URL-** előtagot is létrehoz az Ön számára. Ezt az URL-címet használja az alkalmazás eléréséhez. Módosítsa ezt az URL-előtagot valami emlékezetre, ha szeretné.
    ...
    ![Azure IoT Central számlázási adatok](media/quick-deploy-iot-central/iotcentralcreate-billinginfo-pnp.png)
