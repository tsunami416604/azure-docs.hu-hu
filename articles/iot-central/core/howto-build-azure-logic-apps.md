...
Az Azure Portalon Logic Apps az IoT Central-összekötő használatával bármikor elindíthatja a munkafolyamatokat. Ezután kiválaszthatja, hogy melyik IoT Central alkalmazáshoz és melyik szabályhoz csatlakozhat, és így is ugyanúgy működik. Minden alkalommal nem szükséges elindítani a IoT Central szabályok lapról.
