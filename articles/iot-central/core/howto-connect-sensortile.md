...
* Az Android-eszközön telepített ST-érzékelő alkalmazás a [következő címről tölthető le](https://play.google.com/store/apps/details?id=com.st.bluems):. További információért látogasson el a következőre: [St. érzékelő](https://www.st.com/stblesensor)
...
Az Azure IoT Central alkalmazásban adjon hozzá egy valódi eszközt a **SensorTile. Box** eszköz sablonjában, és jegyezze fel az eszköz kapcsolatának részleteit: a **hatókör-azonosítót**, az **eszköz azonosítóját**és az **elsődleges kulcsot**:
...
1. A bal oldali ablaktábla használatával válassza a **Felhőbeli naplózás** gombot.
