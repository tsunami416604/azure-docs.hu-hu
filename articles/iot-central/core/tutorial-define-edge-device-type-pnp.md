...
A Azure IoT Edge áttekintéséhez [tekintse meg ezt a cikket](overview-iot-central-pnp.md). 
...
![Központi alkalmazás lapja](./media/tutorial-define-edge-device-type-pnp/gateway-transparent.png)
...
![Központi alkalmazás lapja](./media/tutorial-define-edge-device-type-pnp/gateway-module.png)
...
![Központi alkalmazás lapja](./media/tutorial-define-edge-device-type-pnp/gateway-module-transparent.png)
...
![Központi alkalmazás lapja](./media/tutorial-define-edge-device-type-pnp/gateway-module2-transparent.png)
...
![Központi alkalmazás lapja](./media/tutorial-define-edge-device-type-pnp/edgedevicetemplate.png)

Új sablon létrehozásához kattintson az **+ új** elemre.

![Eszközök sablonjai – új](./media/tutorial-define-edge-device-type-pnp/edgedevicetemplatenew.png)
...
![Eszközök sablonjainak kiválasztása – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/selectiotedge.png)
...
![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgedevicetemplateuploadmanifest.png)
...
![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-upload.png)
...
![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/deploymentmanifestvalidate.png)

Az alábbi folyamat az üzembe helyezési jegyzék életciklusát mutatja IoT Centralban.

![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/dmflow.png)
...
![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgedevicetemplatereview.png)

Ha az átjáró eszközét választotta, akkor ez a felülvizsgálati oldal jelenik meg.

![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-review.png)
...
![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgedevicetemplatelanding.png)
...
![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgemodelling.png)
...
* Kattintson a SimulatedTemperatureSensor modul képesség modell felületének **kezelése** lehetőségre. Kattintson a **képesség hozzáadása**lehetőségre. 
    ...
    ![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplateaddcapability.png)
  
* Adja hozzá a gépet objektumtípus típusú objektumként, mivel ez egy összetett típus
  
    ![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplatemachineobject.png)
    ...
    ![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplatemachineattributes.png)
...
* Környezeti elem hozzáadása objektumtípus, mivel ez egy összetett típus
    ...
    ![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplateambientattributes.png)

  
* TimeCreated hozzáadása DateTime típusú típusként, majd kattintson a **Mentés** gombra.
  
    ![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplateallattributes.png)
...
Ha bejelölte Azure IoT Edge eszköz legyen átjáró-eszköz, hozzáadhat alsóbb rétegbeli kapcsolatokat az eszköz képességi modelljeihez az átjáró-eszközhöz csatlakozó eszközökhöz.
  ...
  ![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-add-relationship.png)

A kapcsolat hozzáadhatók egy eszközhöz vagy egy modulhoz.
  
  ![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-relationship-types.png)


Kiválaszthat egy alsóbb rétegbeli eszköz képességeinek modelljét vagy kiválaszthatja az Asterix elemet. 
  
  ![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-downstream-rel.png)
  ...
  ![Eszköz sablonja – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-add-relationship-asterix.png)
...
2. A módosítások mentéséhez kattintson a **Save (Mentés** ) gombra:
    ...
    ![Felhő tulajdonságai – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplatecloudproperties.png)
...
![Testreszabások – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplatecustomize.png)
...
![Nézetek – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/visualizingthedevice.png)
...
![Nézetek – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/sensorambientchart.png)
...
![Nézetek – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/sensorambienttelemetrychart.png)
...
![Nézetek – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/viewsdashboard.png)
...
![Nézetek – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/editingdeviceandclouddata.png)
...
![Nézetek – Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/views-properties.png)
...
2. Kattintson a **Publish** (Közzététel) elemre.
    ...
    ![Nézetek – közzététel](./media/tutorial-define-edge-device-type-pnp/edgetemplatepublish.png)

1. Az **eszközbeállítások közzététele** párbeszédpanelen válassza a **Közzététel**lehetőséget:
  
    ![Nézetek – közzététel](./media/tutorial-define-edge-device-type-pnp/edgepublishtemplate.png)
...
![Nézetek – közzététel](./media/tutorial-define-edge-device-type-pnp/publishedtemplate.png)
