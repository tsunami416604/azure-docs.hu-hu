...
Létrehozhat egy másolatot bármely alkalmazásról, levonva az eszköz példányait, az eszköz adatelőzményeit és a felhasználói adatmennyiségeket. A másolás egy szabványos alkalmazás, amelyért díjat kell fizetnie. Egy alkalmazás másolásával nem hozhat létre próbaverziós alkalmazást.

Válassza a **Másolás**lehetőséget. A párbeszédpanelen adja meg az új szabványos alkalmazás részleteit. Ezután a **Másolás** gombra kattintva erősítse meg, hogy folytatni kívánja. Ha többet szeretne megtudni az űrlap mezőiről, tekintse meg az [alkalmazás létrehozása](quick-deploy-iot-central.md) rövid útmutatót.
...
> [!NOTE]
> Ha egy alkalmazás a **megosztható hivatkozás** használatával jön létre, az elérhető helyszínek **Európa** és **USA**.
