...
![Microsoft Partner Centeren ügyfél megtekintése](media/howto-create-application-csp/image1.png)
...
![Segítségével kezelheti az Azure IoT Central](media/howto-create-application-csp/image2.png)
...
![Hozzon létre a CSP-kezelője](media/howto-create-application-csp/image3.png)
...
![Hozzon létre az alkalmazás oldalán a CSP-k](media/howto-create-application-csp/image4.png)

![Hozzon létre az alkalmazás oldalán a CSP-k](media/howto-create-application-csp/image4-1.png)
