...
ms.locfileid: "69875525"
---
# <a name="tutorial-configure-rules-and-actions-for-your-device-in-azure-iot-central"></a>Oktatóanyag: Szabályok és műveletek konfigurálása az eszközhöz az Azure IoT Central
...
1. Új telemetria-szabály az alkalmazáshoz való hozzáadásához a bal oldali navigációs menüben válassza ki az **eszközök sablonjait**:
...
1. **Művelet**hozzáadásához először **mentse** a szabályt, majd görgessen le a telemetria- **szabály konfigurálása** panelen. Válassza ki **+** a **műveletek**mellett a következőt, majd válassza az **e-mail**lehetőséget:
