...
1. Válassza az **eszközök** lehetőséget a bal oldali navigációs menüben. Itt látható az összes eszköz és az eszköz sablonjainak listája.
...
1. Az **eszközök** lap jobb oldali ablaktábláján megjelenik az adott eszköz sablonjában létrehozott eszközök listája. Válasszon ki egy egyéni eszközt az eszköz adatai lap megjelenítéséhez:
    ...
    ![Eszköz részletei lap](./media/howto-manage-devices-pnp/devicelist.png)
...
1. Válassza az **eszközök** lehetőséget a bal oldali navigációs menüben.
...
1. Válassza az **Importálás**lehetőséget.
    ...
    ![Importálási művelet](./media/howto-manage-devices-pnp/bulkimport1a.png)
...
1. Miután az importálás befejeződik, megjelenik egy sikeres üzenet az eszköz működési paneljén.
    ...
    ![Sikeres importálás](./media/howto-manage-devices-pnp/bulkimport3a.png)
...
1. A bal oldali panelen válassza a **minden eszköz**lehetőséget:
    ...
    ![Nem társított eszközök](./media/howto-manage-devices-pnp/unassociateddevices1a.png)
...
1. **Áttelepítés**kiválasztása:
    ...
    ![Eszközök társítása](./media/howto-manage-devices-pnp/unassociateddevices2a.png)
...
1. Válassza ki az exportálni kívánt eszközöket, majd válassza ki az **Exportálás** műveletet.
    ...
    ![Exportálás](./media/howto-manage-devices-pnp/export1a.png)
...
1. A fájl **letöltése** hivatkozásra kattintva letöltheti a fájlt a lemez helyi mappájába.
    ...
    ![Sikeres exportálás](./media/howto-manage-devices-pnp/export2a.png)
...
1. Válassza az **eszközök** lehetőséget a navigációs menüben.
