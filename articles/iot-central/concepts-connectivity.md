...
1. Az operátor letilthat egy eszközt. Ha egy eszköz le van tiltva, nem tud adatküldést küldeni a IoT Central alkalmazásnak. A letiltott eszközök kiépítési állapota letiltva. Az operátornak vissza kell állítania az eszközt az adatok küldésének folytatásához. Ha egy operátor feloldja egy eszköz blokkolását, a kiépítési állapot az előző értékre, regisztrálvavagy kiépítve tér vissza.
