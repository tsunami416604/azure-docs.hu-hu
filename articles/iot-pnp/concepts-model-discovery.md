...
## <a name="model-discovery"></a>Modell felderítése
...
1. Ha az eszköz be van kapcsolva, a a DPS globális végpontján csatlakozik, és a hitelesítés az engedélyezett módszerek egyikével történik.
...
1. Ezután ellenőrizze, hogy az adott AZONOSÍTÓval rendelkező felület szerepel-e a globális modell adattárában. További információ: [Global Model repository](howto-manage-models.md).
1. Ha az illesztőfelület nem szerepel a globális modell-tárházban, próbálja meg megkeresni a saját megoldásában ismert saját modellekben. A privát modell tárházának eléréséhez kapcsolati karakterláncra van szükség. További információ: [Private Model repository](howto-manage-models.md).
1. Ha nem találja az összes felületet a globális modell adattárában vagy egy privát modell adattárában, megtekintheti, hogy az eszköz meg tudja-e adni az illesztőfelület-definíciót. Az eszközök a szabványos [ModelDefinition](concepts-common-interfaces.md) felületet implementálják, hogy az adott paranccsal hogyan lehet lekérdezni a csatoló fájljait egy parancs használatával.
