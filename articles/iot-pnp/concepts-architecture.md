...
A modell tárház beépített szerepköralapú hozzáférés-vezérléssel rendelkezik, amely lehetővé teszi az illesztőfelület-definíciók elérésének korlátozását.
