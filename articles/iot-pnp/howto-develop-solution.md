...
a **get_digital_twin_interface_instance. js** lekérdezi az eszközhöz társított digitális Twin-példányokat, és kinyomtatja azt a parancssorban. Nem igényli, hogy az eszköz minta fusson.
...
Ez a [IoT](https://preview.catalog.azureiotsolutions.com) -portálon található, a **vállalati tárházhoz**tartozó **kapcsolatok karakterláncok** lapján megtalálhatja ezt a kapcsolatokat megadó karakterláncot.
...
1. Adjon meg egy értéket a **név** mezőben, és válasszonegy végpontot. Ha még nem konfigurált végpontot, válassza a **végpont hozzáadása**elemet.
