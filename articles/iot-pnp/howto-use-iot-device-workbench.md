...
- **Projekt típusa** A Code Generator egy projektfájlt is létrehoz, hogy integrálni tudja a kódot a saját projektbe vagy az eszköz SDK-projektbe. Jelenleg a támogatott projektek típusai a következők:
    ...
    - **CMAK-projekt**: egy olyan eszköz-projekthez [](https://cmake.org/) , amely a cmakt használja Build rendszerként. Ez a beállítás a `CMakeLists.txt` C kóddal megegyező mappában hozza létre a fájlt.
...
1. A [Visual Studio 2019 (Community, Professional vagy Enterprise)](https://visualstudio.microsoft.com/downloads/) telepítése – ügyeljen arra, hogy a **NuGet csomagkezelő** összetevőjét és az **asztali C++ fejlesztést** is tartalmazza a számítási feladatok segítségével.
