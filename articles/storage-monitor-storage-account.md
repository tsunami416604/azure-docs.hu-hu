...
# <span id="createstorageaccount"></span></a>How To Monitor a Storage Account
...
-   [How to: Configure monitoring for a storage account][How to: Configure monitoring for a storage account]
-   [How to: Customize the dashboard for monitoring][How to: Customize the dashboard for monitoring]
-   [How to: Customize the Monitor page][How to: Customize the Monitor page]
-   [How to: Add metrics to the metrics table][How to: Add metrics to the metrics table]
-   [How to: Customize the metrics chart on the Monitor page][How to: Customize the metrics chart on the Monitor page]
-   [How to: Configure logging][How to: Configure logging]

## <span id="configurestoragemonitoring"></span></a>How to: Configure monitoring for a storage account

1.  In the [Management Portal][Management Portal], click **Storage**, and then click the storage account name to open the dashboard.
...
Metrics are stored in the storage account in four tables named $MetricsTransactionsBlob, $MetricsTransactionsTable, $MetricsTransactionsQueue, and $MetricsCapacityBlob. For more information, see [About Storage Analytics Metrics][About Storage Analytics Metrics].
...
## <span id="customizestoragemonitoring"></span></a>How to: Customize the dashboard for monitoring
...
## <span id="customizemonitorpage"></span></a>How to: Customize the Monitor page
...
## <span id="addmonitoringmetrics"></span></a>How to: Add metrics to the metrics table
...
## <span id="customizemetricschart"></span></a>How to: Customize the metrics chart on the Monitor page
...
## <span id="configurelogging"></span></a>How to: Configure logging
...
The diagnostics logs are saved in a blob container named $logs in your storage account. For information about accessing the $logs container, see [About Storage Analytics Logging][About Storage Analytics Logging].

  [Storage Analytics and Billing]: http://msdn.microsoft.com/en-us/library/windowsazure/hh360997.aspx
  ...
  [About Storage Analytics Logging]: http://msdn.microsoft.com/en-us/library/windowsazure/hh343262.aspx
