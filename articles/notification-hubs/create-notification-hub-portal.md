...
2. A bal oldali menüben válassza a **minden szolgáltatás** lehetőséget **, majd a** bal oldali menüben a`*` **Kedvencek** szakaszhoz adja hozzá a következőt: **értesítési központ névterek** melletti keresés. **Notification Hub** Válassza az **értesítési központ névterek**lehetőséget. 
