...
4.  在 QSAppDelegate.m 檔案中新增下列方法：
    ...
    這會更新 **deviceToken** 屬性。
    > [AZURE.NOTE] 此時，此方法中不應有任何其他程式碼。 如果您已呼叫 **registerNativeWithDeviceToken** 您完成時所新增的方法 [開始使用通知中樞](/manage/services/notification-hubs/get-started-notification-hubs-ios/"%20target="_blank") 教學課程，您必須註解化或移除該呼叫。
