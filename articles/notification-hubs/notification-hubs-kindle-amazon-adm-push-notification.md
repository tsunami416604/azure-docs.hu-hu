...
* Az Android SDK (feltéve, hogy, hogy használ-e az eclipse-ben) kérhet az [Android fejlesztői portál](https://go.microsoft.com/fwlink/?LinkId=389797).
...
2. Az Eclipse-ben kattintson a jobb gombbal a projektjére, majd kattintson a **Properties** (Tulajdonságok) elemre. Válassza ki **Java létrehozása elérési út** a bal oldalon, majd a **kódtárak** a felső fülön. Kattintson a **külső Jar hozzáadása**, és válassza ki a `\SDK\Android\DeviceMessaging\lib\amazon-device-messaging-*.jar` a könyvtárból, ahová kicsomagolta az Amazon SDK-t.
...
1. Az eclipse-ben hozzon létre egy új fájlt `api_key.txt` a a projekt könyvtáreszközeiben.
