...
Egy értesítés küldésekor egyszerűen használja a Notification Hubs SDK [ `ScheduledNotification` osztályát](https://msdn.microsoft.com/library/microsoft.azure.notificationhubs.schedulednotification.aspx) az alábbi példában látható módon:
