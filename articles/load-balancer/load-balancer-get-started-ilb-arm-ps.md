...
> [!NOTE]
> Az Azure két üzembehelyezési modellel rendelkezik az erőforrások létrehozásához és használatához: [Resource Manager-alapú](../azure-resource-manager/resource-manager-deployment-model.md) és [klasszikus](load-balancer-get-started-ilb-classic-ps.md). Ez a cikk leírja, hogyan hozhat létre egy terheléselosztót a Resource Manager-alapú üzemi modellben. A Microsoft azt javasolja, hogy az Azure Resource Managert használja a legtöbb új üzembe helyezéshez.
