---
title: Standard Load Balancer létrehozása – Azure Portal | Microsoft Docs
description: Ismerje meg, hogyan hozhat létre egy standard terheléselosztót az Azure Portal használatával.
...
---
# <a name="create-a-standard-load-balancer-to-load-balance-vms-using-the-azure-portal"></a>Standard Load Balancer létrehozása a virtuális gépek terhelésének elosztásához az Azure Portal használatával.
