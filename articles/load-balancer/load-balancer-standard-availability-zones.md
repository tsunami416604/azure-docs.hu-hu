...
- A zónák könnyebben érthetővé és tárolják a hibákat.  Azonban a zóna meghibásodása nem különbözik más hibáktól, amikor olyan fogalmakat tartalmaz, mint az időtúllépések, az újrapróbálkozások és a leállítási algoritmusok. Annak ellenére, hogy Azure Load Balancer a zóna-redundáns elérési utakat biztosít, és gyors helyreállítást tesz lehetővé, a csomagok szintjén valós időben, újraküldést vagy újraépítést eredményezhet a hiba bekövetkezésekor, és fontos tisztában lennie azzal, hogy az alkalmazás hogyan alakul ki a hibákkal. A terheléselosztási séma megmarad, de a következőket kell megterveznie:
