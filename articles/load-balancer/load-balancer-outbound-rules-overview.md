...
description: Kimenő hálózati címfordítások definiálása kimenő szabályok használatával
...
- azt határozza meg, hogy a TCP alaphelyzetbe állítása üresjárati időkorláton történjen (nyilvános előzetes verzióban). 
...
### <a name="tcprst"></a><a name="tcpreset"></a> A TCP alaphelyzetbe állításának engedélyezése üresjárati időkorláton (előzetes verzió)
...
Tekintse át az [Üresjárati időkorlát (előzetes verzió) TCP-visszaállítását](https://aka.ms/lbtcpreset) , beleértve a régiók rendelkezésre állását.
...
- A portál nem használható a kimenő szabályok konfigurálásához és megtekintéséhez.  Ehelyett használja a sablonok, REST API, az az CLI 2,0 vagy a PowerShell használatát.
