...
Alapszintű Load Balancer létrehozásához használja ```-SKU Basic``` a következőt:. A Microsoft a standard szintű használatot javasolja a termelési munkaterhelésekhez.
...
Alapszintű nyilvános IP-címek létrehozásához használható ```-SKU Basic``` . A Microsoft a standard szintű használatot javasolja a termelési munkaterhelésekhez.
