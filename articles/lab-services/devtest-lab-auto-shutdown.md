...
### <a name="set-auto-shut-down-policy-for-a-lab"></a>Automatikus leállítás házirend beállítása laborhoz
...
1. A **virtuális gép** lapon válassza az **automatikus leállítás** lehetőséget a bal oldali menüben. 
