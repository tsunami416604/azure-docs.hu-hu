...
Alapértelmezés szerint az összetevők végrehajtás a sorrendben, amelyben a virtuális gép kerül.
A következő lépések bemutatják, hogyan módosíthatja a sorrendben, amelyben az összetevők futnak.
...
Az Azure Resource Manager-sablonok meghatározása egy megismételhető üzembe helyezési deklaratív lehetőséget biztosít.
A következő lépések bemutatják, hogyan a virtuális gép létrehozása az Azure Resource Manager-sablon mentéséhez.
