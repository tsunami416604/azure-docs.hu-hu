...
1. Az összetevők hozzáadása után megváltoztathatja [az](#change-the-order-in-which-artifacts-are-run)összetevők futtatásának sorrendjét. Visszatérhet az összetevők [megtekintéséhez vagy módosításához](#view-or-modify-an-artifact)is.
...
A mentés után a Azure Resource Manager sablonnal telepítheti az [új virtuális gépeket Azure PowerShell](../azure-resource-manager/template-deployment-overview.md)használatával.
...
* Ismerkedjen meg a [DevTest Labs Azure Resource Manager](https://github.com/Azure/azure-devtestlab/tree/master/samples/DevTestLabs/QuickStartTemplates)a rövid útmutató sablonjának galériájában.
