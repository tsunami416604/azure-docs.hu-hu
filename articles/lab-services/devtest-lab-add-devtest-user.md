...
| Felhasználók hozzáadása laborhoz |Nem |Yes |Nem |
...
A `subscriptionId` , a és az `labResourceGroup` értékeket a Azure Portal Lab paneljéről kérheti le `labName` .
