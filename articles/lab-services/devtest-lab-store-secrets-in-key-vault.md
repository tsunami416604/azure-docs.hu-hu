...
A probléma megoldásához és a titkos kulcsok biztonságos helyen való tárolásához a DevTest Labs támogatja a titkos kulcsok tárolását egy [Azure-beli kulcstartóban.](../key-vault/key-vault-overview.md) Amikor egy felhasználó először ment egy titkos kulcsot, a DevTest Labs szolgáltatás automatikusan létrehoz egy key vault ugyanabban az erőforráscsoportban, amely tartalmazza a labort, és tárolja a titkos kulcsot a key vaultban. DevTest Labs létrehoz egy külön key vault minden felhasználó számára. 
