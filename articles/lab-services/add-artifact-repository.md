...
- A tárház URI-ja (példa `https://github.com/<myteam>/<nameofrepo>.git` : `"https://MyProject1.visualstudio.com/DefaultCollection/_git/TeamArtifacts"`vagy.
...
- A tárház típusa. Az engedélyezett értékek `VsoGit` a `GitHub`következők: vagy.
