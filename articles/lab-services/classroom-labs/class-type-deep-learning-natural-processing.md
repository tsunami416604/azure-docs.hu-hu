...
| ----------- | ------------ |  
| Marketplace-rendszerképek | Engedélyezze a Data Science Virtual Machine for Linux (Ubuntu) rendszerképet a labor-fiókban való használathoz.  A vonatkozó utasításokért lásd az alábbi cikkeket: [Itt adhatja meg a tesztkörnyezet-készítők számára elérhető Piactéri lemezképeket](tutorial-setup-lab-account.md#specify-marketplace-images-available-to-lab-creators). | 
