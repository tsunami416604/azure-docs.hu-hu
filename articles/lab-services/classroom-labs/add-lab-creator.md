...
- Egy Microsoft e-mail-fiók `@outlook.com`, `@hotmail.com`például `@msn.com`,, `@live.com`, vagy.
...
Microsoft-fiókra való feliratkozáshoz az oktatóknak a következő címen kell [http://signup.live.com](http://signup.live.com)megjelenniük:.  
