...
Ezekkel az információkkal segítséget kaphat, ha bármilyen technikai problémába ütközik, miközben labor-fiókban végez laboratóriumi használatot.
...
4. Egy másik labor támogatási kapcsolattartási adatait úgy tekintheti meg, hogy az adott laborra vált a legördülő listában. 
    ...
    ![Váltás másik laborra](../media/lab-user-support-information/switch-another-lab.png)
5. Most megjelenik a másik labor támogatási kapcsolattartási adatai. 
...
- [Hogyan tekinthet meg a tesztkörnyezet létrehozója a támogatási kapcsolattartási adatokat](lab-creator-support-information.md)
