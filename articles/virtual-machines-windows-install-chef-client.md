...
Chef is a client-server system. To find out your options for using a Chef server, see [Choose your installation][Choose your installation]. You'll need information about the Chef server to set up the client. To install Chef client on an Azure virtual machine, you have the following choices:

-   Use the Management Portal to install the Chef client when you create a virtual machine running Windows Server 2012 or Windows Server 2012 R2. For instructions, see [Microsoft Azure Portal][Microsoft Azure Portal].
-   Use Windows PowerShell to install the Chef client on an existing virtual machine. A sample [script][script] is available on Github.
-   Use a Chef plug-in, [knife-azure][knife-azure], to create a virtual machine instance and install the Chef client.

## Additional Resources

[Chef and Microsoft Azure][Chef and Microsoft Azure]
