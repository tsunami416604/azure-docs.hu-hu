...
-   [Create a DocumentDB Account][Create a DocumentDB Account]

## Table of contents

-   [Connect to a DocumentDB Account][Connect to a DocumentDB Account]
-   [Create a database][Create a database]
-   [Create a collection][Create a collection]
-   [Create documents][Create documents]
-   [Query DocumentDB Resources][Query DocumentDB Resources]
-   [Next steps][Next steps]

## <span id="Connect"></span></a>Connect to a DocumentDB Account
...
**Warning:** Never store credentials in source code. To keep this sample simple, they are shown in the source code. See [Windows Azure Web Sites: How Application Strings and Connection Strings Work][Windows Azure Web Sites: How Application Strings and Connection Strings Work] for information on how to store credentials.
...
## <span id="CreateDB"></span></a>Create a database
...
## <span id="CreateColl"></span></a>Create a collection
...
## <span id="CreateDoc"></span></a>Create documents
...
## <span id="Query"></span></a>Query DocumentDB Resources
...
For the full get-started sample, click [here][here].

## <span id="NextSteps"></span></a>Next steps

-   Learn how to [monitor a DocumentDB account][monitor a DocumentDB account].
-   For details on the programming model, see the Development section on the [DocumentDB documentation page][DocumentDB documentation page]
  ...
  [here]: https://github.com/Azure/azure-documentdb-net/tree/master/tutorials/get-started
  [monitor a DocumentDB account]: http://go.microsoft.com/fwlink/p/?LinkId=402378
  [DocumentDB documentation page]: http://go.microsoft.com/fwlink/p/?LinkID=402319
