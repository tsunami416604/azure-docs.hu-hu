...
>[AZURE.NOTE] 字串範圍索引是在 2015 年 7 月 7 日的 REST API 2015-06-03 版導入。 若要針對字串建立 Order By 的原則，您必須使用 .NET SDK 的 SDK 1.2.0 版，或 Python、Node.js 或 Java SDK 的 1.1.0 版。
>
...
## 範例
請查看本 [Github 範例專案](https://github.com/Azure/azure-documentdb-net/tree/master/samples/code-samples/Queries.OrderBy) 來示範如何使用 Order By，如包括建立索引編製原則和分頁使用 Order By。 這些範例是開放原始碼，我們鼓勵您提交提取要求，並附上可幫助其他 DocumentDB 開發人員的貢獻。 請參閱 [貢獻指導方針](https://github.com/Azure/azure-documentdb-net/blob/master/Contributing.md) 有關如何貢獻的指引。  
