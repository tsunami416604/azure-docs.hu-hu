...
## Az adatbázis-oktatóanyag előfeltételei
...
## 1. lépés: DocumentDB-adatbázisfiók létrehozása
...
## 2. lépés: Új Python Flask-webalkalmazás létrehozása
...
## 3. lépés: A Python Flask-webalkalmazás módosítása

### A Python Flask-csomagok hozzáadása a projekthez
...
### A virtuális környezet ellenőrzése
...
### Adatbázis-, gyűjtemény- és dokumentum-definíciók létrehozása
...
### A szükséges importálások hozzáadása a views.py fájlhoz
...
### Adatbázisok, gyűjtemények és dokumentumok létrehozása
...
### Adatbázis, gyűjtemény és dokumentum beolvasása, valamint az űrlap elküldése
...
### Konfigurációs fájl hozzáadása, és az \_\_init\_\_.py fájl módosítása
...
## 4. lépés: A webalkalmazás helyileg történő futtatása
...
## 5. lépés: A webalkalmazás Azure Websitesra történő telepítése
