...
* **[Gyorsindítás](#quickstart)**: Kevesebb mint 10 perc leforgása alatt letöltheti a mintaprojektet, megadhatja a kapcsolati adatokat, és elindíthat egy DocumentDB-alkalmazást.
...
## <a name="quickstart"></a>Gyorsindítás
1. Töltse le a mintaprojekt .zip fájlját a [GitHubról](https://github.com/Azure-Samples/documentdb-dotnet-getting-started-quickstart/archive/master.zip), vagy klónozza a [documentdb-dotnet-getting-started-quickstart](https://github.com/Azure-Samples/documentdb-dotnet-getting-started-quickstart) tárházat.
...
## <a name="a-idtutorialatutorial"></a><a id="tutorial"></a>Oktatóanyag
