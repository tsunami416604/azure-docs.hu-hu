...
![螢幕擷取畫面示範建立資料庫的方法，並反白顯示 ](./media/documentdb-create-database/docdb-database-creation-1-3.png)

1.  在 [Azure 入口網站](https://portal.azure.com/), ，在 Jumpbar 中按一下 [ **DocumentDB 帳戶**。

2.  在 [DocumentDB 帳戶]**** 刀鋒視窗中，選取要在其中新增 DocumentDB NoSQL 資料庫的帳戶。 如果您沒有任何列出的帳戶，您將需要 [建立 DocumentDB 帳戶](documentdb-create-account.md)。
