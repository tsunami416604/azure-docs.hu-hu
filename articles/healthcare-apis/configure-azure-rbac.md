---
title: Azure szerepköralapú Access Control (RBAC) konfigurálása a FHIR készült Azure API-hoz
...
:::image type="content" source="media/rbac/add-azure-rbac-role-assignment.png" alt-text="Azure RBAC szerepkör-hozzárendelés hozzáadása":::
