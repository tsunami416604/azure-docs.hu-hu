---
title: Az FHIR-hez készült Azure IoT-összekötő (előzetes verzió) metrikáinak megtekintése és konfigurálása
...
ms.locfileid: "93394288"
---
# <a name="view-and-configure-azure-iot-connector-for-fhir-preview-metrics"></a>Az FHIR-hez készült Azure IoT-összekötő (előzetes verzió) metrikáinak megtekintése és konfigurálása 

Ebből a cikkből megtudhatja, hogyan tekintheti meg és konfigurálhatja az Azure IoT Connectort az FHIR * Mérőszámokhoz. 

> [!TIP]
> Kövesse az [Azure IoT CONNECTOR FHIR (előzetes verzió) metrikáinak exportálásával](./iot-metrics-diagnostics-export.md) kapcsolatos útmutatót a diagnosztikai beállítások segítségével, amelyből megtudhatja, hogyan állíthatja be a metrikai adatok exportálását.
