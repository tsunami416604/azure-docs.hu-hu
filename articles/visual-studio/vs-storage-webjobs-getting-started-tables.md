...
Ez a cikk C#-kódrészleteket tartalmaz, amelyek bemutatják, hogyan használható az Azure WebJobs SDK 1-es verziójú. x verziója az Azure Table Storage szolgáltatással. A kód minták a [Webjobs SDK](https://github.com/Azure/azure-webjobs-sdk/wiki) 1. x verzióját használják.
