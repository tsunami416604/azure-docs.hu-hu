...
Ez a cikk C#-kód példákat tartalmaz, amelyek bemutatják, hogyan indíthat el egy folyamatot egy Azure-Blob létrehozásakor vagy frissítésekor. A kód minták a [Webjobs SDK](https://github.com/Azure/azure-webjobs-sdk/wiki) 1. x verzióját használják. Amikor egy Webjobs-projekthez hozzáadja a Storage-fiókot a Visual Studio **csatlakoztatott szolgáltatások hozzáadása** párbeszédpanelének használatával, a rendszer telepíti a megfelelő Azure Storage NuGet-csomagot, a megfelelő .net-hivatkozásokat hozzáadja a projekthez, és a Storage-fiókhoz tartozó kapcsolati karakterláncok frissülnek az app. config fájlban.
 ...
 **Megjegyzés:** A webjobs SDK megvizsgálja a naplófájlokat az új vagy módosított Blobok figyeléséhez. Ez a folyamat természeténél fogva lassú; Előfordulhat, hogy a rendszer nem indít el egy függvényt, amíg a blob létrehozása után több percig vagy tovább nem ér.  Ha az alkalmazásnak azonnal fel kell dolgoznia a blobokat, az ajánlott módszer egy üzenetsor létrehozása a blob létrehozásakor, és a **QueueTrigger** attribútum használata a **BlobTrigger** attribútum helyett a blobot feldolgozó függvényen.
