...
1. A keresőmezőbe írja be a `when a http request` a kérelem-trigger megkereséséhez. Az eseményindítók listából válassza ki ezt az eseményindítót: **http-kérés fogadásakor**
...
1. A keresőmezőbe írja be a `delay until` szűrőt. A műveletek listában válassza a következő műveletet: **késleltetés, amíg**
...
|----------------|-----|------|---------|
| **POST** | <*végpont URL-címe*> | **nyers** <p>**JSON (alkalmazás/JSON)** <p>A **RAW** mezőben adja meg a kérelemben elküldeni kívánt adattartalmat. <p>**Megjegyzés**: Ez a beállítás automatikusan konfigurálja a **fejlécek** értékeit. | **Kulcs**: Content-Type <br>**Érték**: alkalmazás/JSON |
|||||
