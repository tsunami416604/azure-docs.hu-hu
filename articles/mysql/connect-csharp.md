...
ms.locfileid: "60526192"
---
# <a name="azure-database-for-mysql-use-net-c-to-connect-and-query-data"></a>Azure Database for MySQL: A .NET használata (C#) való csatlakozás és adatok lekérdezése
