...
ms.locfileid: "53547456"
---
# <a name="azure-database-for-mysql-use-net-c-to-connect-and-query-data"></a>Azure Database for MySQL-hez: A .NET használata (C#) való csatlakozás és adatok lekérdezése
