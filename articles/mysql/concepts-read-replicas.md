...
Miután az alkalmazás sikeresen feldolgozta az olvasásokat és az írásokat, befejezte a feladatátvételt. Az alkalmazások által tapasztalható állásidő mennyisége attól függ, hogy mikor észlel egy problémát, és végrehajtja a korábban felsorolt 1. és 2. lépést.
...
A replika a forrással megegyező kiszolgáló-konfiguráció használatával jön létre. A replika létrehozása után több beállítás is módosítható a forráskiszolgálóról függetlenül: számítási generáció, virtuális mag, tárterület és biztonsági mentés megőrzési ideje. Az árképzési szint külön is módosítható, kivéve az alapszintű csomagból vagy abból.
...
Ha frissíteni szeretné a fenti paraméterek egyikét a forráskiszolgálón, törölje a replika-kiszolgálókat, frissítse a paraméter értékét a forráson, majd hozza létre újra a replikákat.

### <a name="gtid"></a>GTID

A GTID a következő címen támogatott:

* A MySQL 5,7-es és 8,0-es verziója.
...
A GTID alapértelmezés szerint ki van kapcsolva. Ha a GTID engedélyezve van, nem kapcsolhatja vissza. Ha ki kell kapcsolnia a GTID, forduljon az ügyfélszolgálathoz.
