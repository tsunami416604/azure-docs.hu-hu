...
description: Adattitkosítás Azure Database for MySQL az ügyfél által felügyelt kulccsal
author: kummanish
ms.author: manishku
ms.service: mysql
ms.topic: conceptual
...
Miután egy Azure Database for MySQL titkosítva lett az ügyfél felügyelt kulcsával Key Vault, a kiszolgáló minden újonnan létrehozott példánya, bár helyi vagy geo-visszaállítási művelet, illetve olvasási replikák is titkosítva lett ugyanazzal az ügyfél által felügyelt kulccsal. Azonban módosíthatók úgy, hogy tükrözzék az új ügyfél felügyelt kulcsát a titkosításhoz. Az ügyfél által felügyelt kulcs megváltozása után a kiszolgáló régi biztonsági mentései a legújabb kulcsot fogják használni.
...
Megtudhatja, hogyan telepítheti az adattitkosítást a MySQL-hez készült Azure Database-hez a [Azure Portal](howto-data-encryption-portal.md)használatával.
