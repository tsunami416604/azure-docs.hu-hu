...
[!code-azurecli-interactive[fő](../../../cli_scripts/mysql/scale-mysql-server/scale-mysql-server.sh?highlight=15-16 "létrehozása és a skála MySQL az Azure-adatbázis.")]
...
[!code-azurecli-interactive[fő](../../../cli_scripts/mysql/scale-mysql-server/delete-mysql.sh  "az erőforráscsoportot.")]
