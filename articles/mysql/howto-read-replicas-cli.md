...
Ehhez futtassa egy olvasási adatbázisreplika-kiszolgáló törlése végezhető a a **[az mysql server delete](/cli/azure/mysql/server#az_mysql_server_delete)** parancsot.
