---
title: Azure Database for MySQL Server VNet Services-végpont áttekintése | Microsoft Docs
...
ms.locfileid: "68610374"
---
# <a name="use-virtual-network-service-endpoints-and-rules-for-azure-database-for-mysql"></a>Virtual Network szolgáltatási végpontok és szabályok használata Azure Database for MySQLhoz
...
- A virtuális hálózati szolgáltatási végpontok bekapcsolása a **Microsoft. SQL** -szolgáltatási címkével Azure Database for MySQL a végpontokat is engedélyezi az összes Azure Database-szolgáltatáshoz: Azure Database for MySQL, Azure Database for PostgreSQL, Azure SQL Database és Azure SQL Data Warehouse.
