...
# A MySQL-hez készült Azure Database: Csatlakozás és adatlekérdezés a PHP használatával
...
### MacOS
- Töltse le [PHP 7.1.4-es verzióját](http://php.net/downloads.php)
...
### Linux (Ubuntu)
- Töltse le a [PHP 7.1.4 non-thread safe (x64) verzióját](http://php.net/downloads.php)
- Telepítse a PHP-t, majd tekintse át a [PHP kézikönyvét](http://php.net/manual/install.unix.php) a további konfiguráláshoz

<a id="windows" class="xliff"></a>

### Windows
- Töltse le a [PHP 7.1.4 non-thread safe (x64) verzióját](http://windows.php.net/download#php-7.1)
