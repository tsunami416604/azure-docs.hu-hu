...
description: Ez a témakör az Azure Database for MySQL használata esetén rendelkezésre álló magas rendelkezésre állásról nyújt tájékoztatást.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
---
# <a name="high-availability-concepts-in-azure-database-for-mysql"></a>Magas rendelkezésre állási fogalmak az Azure Database for MySQL-ben
Az Azure Database for MySQL szolgáltatás garantáltan magas szintű rendelkezésre állást biztosít. A pénzügyileg támogatott szolgáltatásiszint-szerződés (SLA) 99,99%, általános anammár a rendelkezésre állás függvényében. A szolgáltatás használata gyakorlatilag nincs alkalmazás leállási idő.
...
A HA-modellhez hasonlóan, amikor egy Azure Database for MySQL fel- vagy leskálázása kor van felskálázva, egy új kiszolgálópéldány jön létre a megadott mérettel. A meglévő adattároló leválik az eredeti példányról, és az új példányhoz kapcsolódik.
