---
title: 'Rövid útmutató: a Java és a JDBC használata az Azure Database for MySQLFlexible Server használatával'
description: Ismerje meg, hogyan használható a Java és a JDBC Azure Database for MySQL rugalmas kiszolgálói adatbázissal.
author: mksuni
ms.author: sumuth
ms.service: mysql
...
Ez a témakör bemutatja, hogyan hozhat létre egy olyan minta alkalmazást, amely a javát és a [JDBC](https://en.wikipedia.org/wiki/Java_Database_Connectivity) -t használja [Azure Database for MySQL rugalmas kiszolgáló](./index.yml)adatainak tárolására és lekérésére.
...
> [!NOTE]
> Részletesebb információkat talál a MySQL-kiszolgálók létrehozásáról a következő cikkben: [Azure Database for MySQL-kiszolgáló létrehozása az Azure Portal használatával](./quickstart-create-server-portal.md).
...
Győződjön meg arról, hogy meg van <IP-címe> a kiszolgáló helyi számítógépről való eléréséhez. Ez a parancs létrehoz egy kialakítható, MySQL-hez rugalmas kiszolgálót, amely fejlesztésre alkalmas.

A létrehozott MySQL-kiszolgálónak van egy **flexibleserverdb** nevű üres adatbázisa. Ezt az adatbázist fogjuk használni ehhez a cikkhez.
