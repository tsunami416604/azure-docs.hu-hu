...
Használja a [Azure Portal](howto-server-parameters.md)  V [Azure CLI](howto-configure-server-parameters-using-cli.md) to, vagy állítson be egy másik értéket a paraméterhez.
