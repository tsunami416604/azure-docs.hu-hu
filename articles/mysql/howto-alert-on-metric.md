---
title: Metrikariasztások konfigurálása - Azure portal – Azure Database for MySQL
description: Ez a cikk ismerteti, hogyan konfigurálhatja és érheti el a metrikariasztások at Azure Database for MySQL az Azure Portalon.
author: rachel-msft
ms.author: raagyema
ms.service: mysql
ms.topic: conceptual
...
ms.locfileid: "80067879"
---
# <a name="use-the-azure-portal-to-set-up-alerts-on-metrics-for-azure-database-for-mysql"></a>Az Azure Portal használatával riasztásokat állíthat be a MySQL-hez készült Azure Database metrikákra vonatkozóan 

Ez a cikk bemutatja, hogyan állíthatja be az Azure Database for MySQL riasztások az Azure Portalhasználatával. Az Azure-szolgáltatások figyelési metrikák alapján kaphat riasztást.
...
1. Az [Azure Portalon](https://portal.azure.com/)válassza ki a figyelni kívánt Azure-adatbázist a MySQL-kiszolgálóhoz.
