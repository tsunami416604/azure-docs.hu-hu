...
description: Ez a rövid útmutató végigvezeti Önt a Azure Portal használatával, hogy gyorsan hozzon létre egy minta Azure Database for MySQL-kiszolgálót körülbelül öt perc alatt.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.custom: mvc
