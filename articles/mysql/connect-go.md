...
ms.locfileid: "53536644"
---
# <a name="azure-database-for-mysql-use-go-language-to-connect-and-query-data"></a>Azure Database for MySQL-hez: Csatlakozás és adatok lekérdezése a Go nyelv használatával
