...
|------------|----------------------------|--------|-----------------|-----------|------|
|Felügyeleti  |9000, 9003, 1438, 1440, 1452|TCP     |Any              |MI ALHÁLÓZAT  |Allow |
...
| Name (Név)       |Port          |Protocol|Forrás           |Cél|Action|
|------------|--------------|--------|-----------------|-----------|------|
|Felügyeleti  |80, 443, 12000|TCP     |MI ALHÁLÓZAT        |AzureCloud |Allow |
|mi_subnet   |Any           |Any     |MI ALHÁLÓZAT        |MI ALHÁLÓZAT  |Allow |
...
- Ismerje meg, hogyan hozhat létre felügyelt példányt:
  ...
  - [Egy Azure Resource Manager-sablon használatával (az JumpBox használatával, a SSMS tartalmazza)](https://portal.azure.com/). 
