...
|[Monitorozás az Azure Monitor naplóival](saas-dbpertenant-log-analytics.md) | Megtudhatja, hogyan használhat [Azure monitor naplókat](../log-analytics/log-analytics-overview.md) nagy mennyiségű erőforrás több készleten történő figyeléséhez. |
