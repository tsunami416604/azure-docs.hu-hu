...
> [!NOTE]
> Létrehozása és feltöltése az Azure AD és az Azure AD majd konfigurálása az Azure SQL Database és az SQL Data Warehouse kapcsolatban [konfigurálása az Azure SQL Database az Azure AD](sql-database-aad-authentication-configure.md).
>
...
* Csak az SQL Server az Azure AD rendszergazdája kezdetben is elérheti az Azure SQL server vagy az Azure SQL Data Warehouse egy Azure Active Directory-fiókkal. Az Active Directory-rendszergazda úgy is konfigurálhatja a további Azure AD adatbázis-felhasználók.   
