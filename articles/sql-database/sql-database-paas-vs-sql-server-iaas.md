...
A **SQL-adatbázis** Basic, Standard, Premium, az általános célú és kritikus szolgáltatásszintek biztosít a Microsoft 99,99 %-os SLA-elérhetőséget garantál. További információk: [SLA a következőhöz: SQL-adatbázis](https://azure.microsoft.com/support/legal/sla/sql-database/). A legújabb SQL-adatbázis szolgáltatásszintjei és a támogatott üzletmenet folytonosságát biztosító tervekben kapcsolatos tudnivalókat lásd: [alapjául szolgáló vásárlási modell DTU-alapú](sql-database-service-tiers-dtu.md) és [vCore-alapú alapjául szolgáló vásárlási modell (előzetes verzió)](sql-database-service-tiers-vcore.md).
