...
- `SQL_LATIN1_GENERAL_CP1_CI_AS`Az SQL Database-kiszolgálón `LATIN1_GENERAL` létrehozott összes adatbázis alapértelmezett rendezése a (z) angol (Egyesült Államok), `CP1` a 1252-es kódlap, `CI` a kis-és nagybetűk megkülönböztetése `AS` , és a hangsúly-érzékeny.
