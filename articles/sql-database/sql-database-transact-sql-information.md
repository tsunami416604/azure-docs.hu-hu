...
- Log olvasó: A log olvasó, amely nem érhető el az SQL Database támaszkodó Szintaxis: Leküldéses replikáció, adatváltozások rögzítése. Az SQL Database a leküldéses replikációs tétel előfizetője lehet.
...
- .NET Framework: Az SQL Server CLR-integráció
- Szemantikai keresés
- Kiszolgáló hitelesítő adatai: Használat [adatbázishoz kötődő hitelesítő adatok](https://msdn.microsoft.com/library/mt270260.aspx) helyette.
...
- Eseményindítók: Kiszolgáló hatókörű vagy bejelentkezési eseményindítók
- `USE` Utasítás: Ha módosítani szeretné az adatbázis-környezet egy másik adatbázishoz, az új adatbázishoz új kapcsolatot kell létesíteni.
