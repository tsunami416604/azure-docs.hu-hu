...
* Az oktatóanyag-sorozat harmadik része feltételezi, hogy elvégezte az első [**részt**](sql-database-tutorial-predictive-model-prepare-data.md) , és a [**második részt.**](sql-database-tutorial-predictive-model-build-compare.md)
