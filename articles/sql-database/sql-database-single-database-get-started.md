...
- Egy önálló adatbázis létrehozása az Azure Powershell használatával kiszolgáló nélküli számítási szinten: [létrehozása kiszolgáló nélküli adatbázis](sql-database-serverless.md#create-new-database-in-serverless-compute-tier).