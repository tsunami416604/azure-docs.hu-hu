...
- **Microsoft SQL Server 2008 R2 SP1 系統 CLR 類型 (x86)**
 ...
 您可以安裝 Microsoft SQL Server 2008 R2 SP1 系統 CLR 類型 (x86) 從  [這裡](http://www.microsoft.com/download/en/details.aspx?id=26728)

- **Microsoft SQL Server 2008 R2 SP1 共用管理物件 (x86)**

 您可以安裝 Microsoft SQL Server 2008 R2 SP1 共用管理物件 (x86) 從 [這裡](http://www.microsoft.com/download/en/details.aspx?id=26728)
