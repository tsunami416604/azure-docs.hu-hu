...
Telepítse az **AzureRM.Sql** modul legújabb előzetes verzióját a rugalmasfeladat-parancsmagok beszerzéséhez. Rendszergazdai jogú parancssorból (futtatás rendszergazdaként) futtassa az alábbi parancsokat.
