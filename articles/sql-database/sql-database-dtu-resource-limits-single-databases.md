...
> [!TIP]
> A folyamatban lévő műveletek figyeléséről lásd:: [SQL REST API használatával műveleteinek kezelésére](https://docs.microsoft.com/rest/api/sql/databaseoperations/databaseoperations_listbydatabase
