...
Az **Azure SQL-erőforrások** oldalának megnyitásához a Azure Portal menüben válassza az **Azure SQL** lehetőséget, vagy keresse meg és válassza ki az **Azure SQL** -t bármely oldalon.
...
![Azure SQL-portál lap](../media/sql-database-technical-overview/add-azure-sql-resources.png)
...
![adatbázisok csempe részletei](../media/sql-database-technical-overview/single-sql-database-deployment-options.png)
