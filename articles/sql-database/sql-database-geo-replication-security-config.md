...
>[AZURE.NOTE] 如果您想要獨立變更主要和次要資料庫的讀取權限，您必須使用傳統的登入和使用者。 獨立於主要次要複本上，將無法管理包含的使用者。
...
>[AZURE.NOTE] **INFORMATION_SCHEMA** 和 **sys** 使用者擁有 *NULL* SID，而**客體** SID 是 **0x00**。 如果資料庫建立者是伺服器系統管理員，而不是 **DbManager** 的成員，**dbo** SID 可能會以 *0x01060000000001648000000000048454* 開頭。
