...
Ha engedélyezni szeretné az Azure-ban üzemeltetett alkalmazások számára az SQL Serverhez való csatlakozást, engedélyezni kell az Azure-kapcsolatokat. Ha egy Azure-alkalmazás megpróbál csatlakozni az adatbázis-kiszolgálóhoz, a tűzfal ellenőrzi, hogy az Azure-kapcsolatok engedélyezettek-e. Ez közvetlenül az Azure Portal paneljén kapcsolható be a tűzfalszabályok beállításával, valamint az **Azure-szolgáltatások és-erőforrások engedélyezésével, hogy hozzáférjenek ehhez** a kiszolgálóhoz **ON** a **tűzfalak és a virtuális hálózatok** beállításaiban. Ha a kapcsolat nem engedélyezett, a kérelem nem éri el a SQL Database-kiszolgálót.
