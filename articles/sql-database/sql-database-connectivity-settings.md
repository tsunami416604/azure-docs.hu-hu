...
ms.locfileid: "83684928"
---
# <a name="azure-sql-connectivity-settings"></a>Az Azure SQL-kapcsolatok beállításai
> [!NOTE]
> Ez a cikk az Azure-beli logikai SQL Serverre vonatkozik, amelyet a logikai kiszolgálón létrehozott Azure SQL Database-és SQL Data Warehouse-adatbázisokhoz használ. Az egyszerűség kedvéért a jelen témakörben az SQL Database és az SQL Data Warehouse megnevezése egyaránt SQL Database.
...
A [hálózati hozzáférés áttekintése című témakörben](sql-database-networkaccess-overview.md)leírtak szerint az ügyfelek csatlakozhatnak SQL Database nyilvános végpontok (IP-alapú TŰZFALSZABÁLYOK, VNET-alapú tűzfalszabályok) vagy privát végpontok (privát hivatkozás használatával) használatával. 
...
További információ: TLS- [megfontolások SQL Database kapcsolathoz](sql-database-connect-query.md#tls-considerations-for-sql-database-connectivity).
