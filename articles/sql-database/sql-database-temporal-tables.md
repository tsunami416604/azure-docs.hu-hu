...
## <a name="step-1-configure-tables-as-temporal"></a>1. lépés: A historikus, táblák konfigurálása
...
Látogasson el a Channel 9 felvesszük Önnel a [valódi ügyfelek historikus implementációs sikertörténete](https://channel9.msdn.com/Blogs/jsturtevant/Azure-SQL-Temporal-Tables-with-RockStep-Solutions) , és tekintse meg a [historikus bemutató élő](https://channel9.msdn.com/Shows/Data-Exposed/Temporal-in-SQL-Server-2016).
