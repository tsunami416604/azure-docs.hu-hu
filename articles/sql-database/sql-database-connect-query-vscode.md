...
2. A **CTRL**+**billentyűt**+lenyomva futtassa a**lekérdezést, és** jelenítse `ProductCategory` meg az eredményeket a és a `Product` táblákból.
...
2. Nyomja le a **CTRL**+**billentyűt**+**, és** szúrjon be `Product` egy új sort a táblázatba.
...
2. Nyomja le a **CTRL**+**Shift**+**E** billentyűt a `Product` tábla megadott sorának frissítéséhez.
...
2. Nyomja le a **CTRL**+**Shift**+**E** billentyűt a `Product` tábla megadott sorának törléséhez.
