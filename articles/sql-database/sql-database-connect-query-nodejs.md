...
> [!IMPORTANT]
> Rendelkeznie kell egy tűzfalszabállyal azon számítógép nyilvános IP-címéhez, amelyen ezt az oktatóanyagot elvégzi. Ha egy másik számítógépen, vagy másik nyilvános IP-címmel rendelkezik, hozzon létre egy [kiszolgálószintű tűzfalszabályt az Azure portal használatával](sql-database-server-level-firewall-rule.md).
