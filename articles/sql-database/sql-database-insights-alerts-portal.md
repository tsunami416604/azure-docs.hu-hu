---
title: Telepítési riasztások és értesítések (Azure Portal)
description: Az Azure Portal használatával SQL Database-riasztásokat hozhat létre, amelyek értesítéseket vagy automatizálást indíthatnak el, ha a megadott feltételek teljesülnek.
...
---
# <a name="create-alerts-for-azure-sql-database-and-azure-synapse-analytics-databases-using-azure-portal"></a>Riasztások létrehozása az Azure SQL Database és az Azure Synapse Analytics-adatbázisokhoz az Azure Portal használatával

## <a name="overview"></a>Áttekintés

Ez a cikk bemutatja, hogyan állíthat be riasztásokat egy, készletező és adattárház-adatbázisok hoz az Azure SQL Database és az Azure Synapse Analytics (korábban Azure SQL Data Warehouse) az Azure Portalon. Riasztások küldhet egy e-mailt, vagy hívja a web hook, ha néhány metrika (például adatbázis mérete vagy cpu-használat) eléri a küszöbértéket. Ez a cikk a riasztási időszakok beállításával kapcsolatos gyakorlati tanácsokat is tartalmaz.

> [!IMPORTANT]
> Ez a funkció még nem érhető el a felügyelt példányban. Alternatív megoldásként az SQL Agent segítségével e-mail-értesítéseket küldhet bizonyos mutatókhoz [a dinamikus felügyeleti nézetek](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/system-dynamic-management-views)alapján.
...
* [Azure-portál](../monitoring-and-diagnostics/insights-alerts-portal.md)
...
5. A **Jellogika konfigurálása** lapon jelöljön ki egy jelet.
  ![Válassza](media/sql-database-insights-alerts-portal/select-signal.png)ki a jelet .
