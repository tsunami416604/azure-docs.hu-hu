...
* [Azure Portalra](../monitoring-and-diagnostics/insights-alerts-portal.md)
...
5. A **jel logikai beállítása** lapon válasszon ki egy jelet.
  ![válassza a jel](media/sql-database-insights-alerts-portal/select-signal.png)lehetőséget.
6. Ha kiválasztott egy jelet, például a **CPU-százalékot**, megjelenik a **jel logikai beállítása** lap.
  ![a jel logikájának konfigurálása](media/sql-database-insights-alerts-portal/configure-signal-logic.png)
7. Ezen a lapon konfigurálhatja a küszöbértéket, az operátort, az összesítési típust, a küszöbértéket, az Összesítés részletességét és a kiértékelés gyakoriságát. Ezután kattintson a **Done** (Kész) gombra.
