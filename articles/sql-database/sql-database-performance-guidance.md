...
Ezek a kézi módszert, mert később szüksége lesz, hogy mit [szolgáltatásszintek](sql-database-service-tiers.md) kellene kiválasztania vagy kell újraírnia a programot alkalmazást vagy az adatbázis és a módosítások deply.
