...
| **Adatbázisméret** | Önálló adatbázis/rugalmas készlet | 5 GB – 4 TB | Akár 100 TB | 5 GB – 4 TB |
...
|**Biztonsági másolatok**|Összes|RA-GRS, 7-35 nap (alapértelmezés szerint 7 nap)| RA-GRS, 7 nap, állandó időpontra történő helyreállítás (PITR) | RA-GRS, 7-35 nap (alapértelmezés szerint 7 nap) |
...
- Az általános célú szolgáltatási szinten egy csatolt `tempdb` SSD-t használ, és ez a tárolási költség a virtuális mag ár részét képezi.
- Az üzleti szempontból kritikus szolgáltatási szinten `tempdb` megosztja a csatlakoztatott SSD-t az MDF-és az ldf- `tempdb` fájlokkal, és a tárolási költséget a virtuális mag ára tartalmazza.
