...
Azt javasoljuk, hogy engedélyezze a kimenő forgalmat az IP-címekre a 1433-es TCP-porton lévő összes [Azure SQL Database ÁTJÁRÓ IP-címének](sql-database-connectivity-architecture.md#azure-sql-database-gateway-ip-addresses) , valamint a tűzfal eszközén a 11000-11999-es porttartomány. A porttartomány-tartományokkal kapcsolatos további információkért lásd: a [kapcsolatkérelem-házirend](sql-database-connectivity-architecture.md#connection-policy).
