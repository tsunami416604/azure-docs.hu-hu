...
- Telepítés [PowerShell](https://docs.microsoft.com/powershell/azure/install-azurerm-ps?view=azurermps-5.6.0) 
...
Egy új üzembe helyezésének lépései:
