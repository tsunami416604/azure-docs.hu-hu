...
### Kiszolgálók, készletek, adatbázisok és tűzfalak
...
### Adatbázisok horizontális felskálázása
#### [Áttekintés](sql-database-elastic-scale-introduction.md)
#### [Méretezhető felhőalapú adatbázisok létrehozása](sql-database-elastic-database-client-library.md)
...
#### [Azure Security Center az Azure SQL Database-hez](../security-center/security-center-sql-database.md?toc=%2fazure%2fsql-database%2ftoc.json)
...
### [Adatbázis-fejlesztés](sql-database-develop-overview.md)
### [SQL Server-adatbázisok áttelepítése](sql-database-cloud-migrate.md)
...
### [Bejelentkezések](sql-database-manage-logins.md)
...
### [Adatbázisok létrehozása](sql-database-get-started-powershell.md)
...
### Referencia
#### [.NET (alapfogalmak)](https://msdn.microsoft.com/library/kb9s9ks0.aspx)
#### [.NET (API-referencia)](https://msdn.microsoft.com/library/system.data.sqlclient.aspx)
#### [Entity Framework](https://www.nuget.org/packages/EntityFramework/)
#### [Azure SDK (letöltés)](https://www.visualstudio.com/vs/azure-tools/)
#### [Azure SDK (dokumentáció)](../dotnet-sdk.md)
#### [PowerShell-parancsmagok – Szolgáltatásfelügyelet](https://msdn.microsoft.com/library/azure/dn546723.aspx)
#### REST
##### [REST (erőforrás-kezelés)](https://msdn.microsoft.com/library/azure/mt420159)
##### [REST (szolgáltatásfelügyelet)](https://msdn.microsoft.com/library/azure/dn505719.aspx)
...
### [Mindig titkosított – Azure Key Vault](sql-database-always-encrypted-azure-key-vault.md)
...
## Adatok maszkolása
### [Dinamikus adatmaszkolás](sql-database-dynamic-data-masking-get-started-portal.md)
...
### [Az adatbázis teljesítménye](sql-database-single-database-monitor.md)
