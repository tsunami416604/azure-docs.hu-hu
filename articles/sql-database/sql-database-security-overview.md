...
Az SQL Database a mozgásban lévő adatok titkosításával védi a vásárlói adatokat [Transport Layer Security](https://support.microsoft.com/en-us/help/3135244/tls-1-2-support-for-microsoft-sql-server).
