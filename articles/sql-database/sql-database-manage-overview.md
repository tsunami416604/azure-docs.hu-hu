...
如需有關管理 Azure SQL Database 使用 SSMS， [使用 SSMS 管理 SQL Database](sql-database-manage-azure-ssms.md)
...
如需有關管理 Azure SQL Database 使用命令列工具 [使用 PowerShell 管理 SQL Database](sql-database-command-line-tools.md)
