...
Az [Azure Portal](https://portal.azure.com) a legtöbb erőforráshoz beépített figyelési és riasztási lehetőségeket biztosít. Az SQL Database esetén figyelési és riasztási lehetőségeket biztosít az adatbázisokhoz és készletekhez. Ez a beépített figyelési és riasztási erőforrás-specifikus megoldás, ezért érdemes kis mennyiségű erőforrást használni, de nem nagyon kényelmes, ha sok erőforrással dolgozik.
