...
- **Globálisan elosztott alkalmazások:** Számos vállalat span számos régióban, és még számos országokban vagy régiókban. Hálózati késés minimalizálása érdekében a legjobb, ha az adatok egy régióban Önhöz. Az adatszinkronizálás könnyedén tarthatja adatbázisok szinkronizálása a világ különböző pontjain található régiókban.
...
- A felhasználói típusok adatokat tartalmazó oszlopok nem támogatottak.
...
### <a name="what-regions-support-data-sync"></a>Milyen régió támogatja az adatok szinkronizálása

Az SQL Data Sync minden régióban érhető el.

### <a name="is-a-sql-database-account-required"></a>Egy SQL Database-fiók szükséges
...
### <a name="should-i-use-sql-data-sync-to-back-up-and-restore-my-databases"></a>Érdemes használni az SQL Data Sync szolgáltatással való biztonsági mentése és visszaállítása az adatbázisok
