...
a virtuális mag méretének rugalmassága segít a teljesítmény-és a régión belüli vertikális felskálázásban, a fenntartott kapacitási juttatás elvesztése nélkül. SQL Database fenntartott kapacitással rugalmasan helyezheti át a gyors adatbázisokat a készletek és az önálló adatbázisok között a normál működés részeként (ugyanazon a régión és teljesítményen belül) anélkül, hogy elveszítené a fenntartott kapacitás előnyeit. Ha nem alkalmazott puffert tart fenn a foglalásban, a teljesítménybeli tüskéket hatékonyan kezelheti a költségkeret túllépése nélkül.
