...
A üzletileg kritikus szolgáltatási réteg olyan alkalmazásokhoz lett tervezve, amelyek alacsony késleltetésű válaszokat igényelnek a mögöttes SSD-tárolóból (átlagosan 1-2 MS), a gyors helyreállítást, ha az alapul szolgáló infrastruktúra meghibásodik, vagy le kell töltenie a jelentéseket, az elemzéseket és a csak olvasható lekérdezéseket az elsődleges adatbázis díjmentesen olvasható másodlagos replikáján.
