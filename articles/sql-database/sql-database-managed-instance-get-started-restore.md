...
> [!NOTE]
> Az SQL Server-adatbázisok az Azure Blob Storage és a közös hozzáférésű jogosultságkód (SAS) használatával történő biztonsági mentéséről és visszaállításáról bővebben lásd:[SQL Server-alapú biztonsági mentés URL-címre](sql-database-managed-instance-get-started-restore.md).
