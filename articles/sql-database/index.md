...
description: "Ismerje meg, hogyan használhat Azure SQL-adatbázisokat."
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>SQL Server eszközök</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt238365.aspx">SQL Server-eszközök</a></p>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>SQL Server-illesztőprogramok</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt654049.aspx">SQL Server-illesztőprogramok</a></p>
