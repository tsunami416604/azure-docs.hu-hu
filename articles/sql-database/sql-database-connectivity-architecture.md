...
A következő cikk részletesen ismerteti, hogyan történik a forgalom áttelepítésének módja az egyes régiókban lévő új átjárók számára: [Azure SQL Database forgalom áttelepítése újabb átjáróra](sql-database-gateway-migration.md)
