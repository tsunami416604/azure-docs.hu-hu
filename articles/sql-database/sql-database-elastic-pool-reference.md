...
- 每個集區有最大數目的資料庫和集區 eDTU：
  ...
  | 高級| 50| 1500|
    ...
    *** * 目前限制為每個集區的資料庫數目和集區 Edtu 數目應該 increase.***
...
| [建立和管理 Azure 入口網站中的 SQL Database 彈性資料庫集區](sql-database-elastic-pool-portal.md)| 如何使用 Azure 入口網站建立和管理彈性資料庫集區|
| [建立和管理 SQL Database 彈性資料庫集區使用 PowerShell](sql-database-elastic-pool-powershell.md)| 如何使用 PowerShell Cmdlet 建立和管理彈性資料庫集區|
| [建立和管理 SQL 資料庫與 Azure SQL Database Library for.NET](sql-database-elastic-pool-powershell.md)| 如何使用 C# 建立和管理彈性資料庫集區|
...
| :-- | :-- |
| [新 AzureRmSqlElasticPool](https://msdn.microsoft.com/library/azure/mt619378.aspx)| [建立彈性資料庫集區](https://msdn.microsoft.com/library/mt163596.aspx)|
| [設定 AzureRmSqlElasticPool](https://msdn.microsoft.com/library/azure/mt603511.aspx)| [彈性資料庫集區的效能設定](https://msdn.microsoft.com/library/mt163641.aspx)|
| [移除 AzureRmSqlElasticPool](https://msdn.microsoft.com/library/azure/mt619355.aspx)| [刪除彈性資料庫集區](https://msdn.microsoft.com/library/mt163672.aspx)|
...
| [Get AzureRmSqlElasticPoolDatabaseActivity]()| [取得資料庫移入和移出集區的狀態](https://msdn.microsoft.com/library/mt163669.aspx)|
...
| 工作| 詳細資料|
| :-- | :-- |
| 建立新的彈性資料庫 (直接在集區中)| [建立資料庫 (Azure SQL Database)](https://msdn.microsoft.com/library/dn268335.aspx)|
