...
Ez az oktatóanyag a következő oktatóanyagban létrehozott erőforrásokat használja kiindulási pontként: [Felügyelt Azure SQL Database-példány létrehozása](sql-database-managed-instance-get-started.md).
