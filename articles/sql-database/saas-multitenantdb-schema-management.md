...
- **az\_SP\_Add\_Target Group** létrehozza a célcsoport nevét, és hozzáadja a *DemoServerGroup*a csoporthoz.

- **az\_SP\_Add\_Target\_Group tag** hozzáadja a következő elemeket:
    ...
    - A *katalógus-MT-&lt;User&gt; * kiszolgálón található sablon-adatbázishoz (*basetenantdb*) tartozó céladatbázis-tag típusa *database*
...
- **az\_SP\_Add Job** létrehoz egy *hivatkozási adatok központi telepítés*nevű feladatot.
...
* **az\_SP\_Add Job** létrehoz egy új feladatot, amelyet *\_\_online reindex\_\_PK VenueTyp 265E44FD7FD4C885*.
