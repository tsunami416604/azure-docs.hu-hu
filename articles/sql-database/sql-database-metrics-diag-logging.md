...
> [!NOTE]
> A biztonsági telemetriai adatok naplózási naplójának engedélyezéséhez olvassa [el az Adatbázis naplózásának beállítása](sql-database-auditing.md#subheading-2) és naplózási naplók beállítása az Azure Monitor [naplóiban és az Azure Event Hubs-ban.](https://techcommunity.microsoft.com/t5/Azure-SQL-Database/SQL-Audit-logs-in-Azure-Log-Analytics-and-Azure-Event-Hubs/ba-p/386242)
