---
title: PowerShell-példaaktív georeplikációs készletes Azure SQL-adatbázis
description: Az Azure PowerShell példaparancsfájlja aktív georeplikációt állít be egy készletezett adatbázishoz az Azure SQL Database-ben, és adja át a feladatát.
...
---
# <a name="use-powershell-to-configure-active-geo-replication-for-a-pooled-database-in-azure-sql-database"></a>A PowerShell használatával aktív georeplikációt konfigurálhat egy készletezett adatbázishoz az Azure SQL Database-ben

Ez a PowerShell-parancsfájl-példa konfigurálja az Azure SQL Database-ben egy készletezett adatbázis aktív georeplikációját, és átadja azt az adatbázis másodlagos replikájának.
...
| [Új-AzsqlDatabase](/powershell/module/az.sql/new-azsqldatabase) | Egyetlen adatbázist vagy készletezett adatbázist hoz létre. |
