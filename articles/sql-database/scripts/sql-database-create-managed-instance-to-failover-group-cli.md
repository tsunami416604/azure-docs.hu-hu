...
| [az hálózati nsg szabály](/cli/azure/network/nsg/rule)| Hálózati biztonsági szabály parancsok. |
...
| [az hálózati vnet-átjáró](/cli/azure/network/vnet-gateway) | Virtuális hálózati átjáró parancsai |
