...
Amikor a Transact-SQL parancsfájl befejeződik, kattintson egy cellára a **event_data_XML** oszlop fejlécében. Egy ** \<esemény>** elem jelenik meg, amely egy Update utasítást mutat be.
