...
Ez a PowerShell-parancsfájl feltételezi, hogy már telepítette a Az modul. További információ: [Azure PowerShell-modul telepítéséhez](/powershell/azure/install-Az-ps).
