---
title: Videó indexelve, Azure SaaS SQL app | Microsoft Docs
...
- *Fogalmi* [Több-bérlős SaaS-adatbázisok bérletének mintái][saas-concept-design-patterns-563e]
...
- [1. **(Indítás)** Üdvözlő dia, 0:00:03](#anchor-image-wtip-min00001)
...
- [8. A hibrid modell a MT/ST, 0:13:01 előnyeinek előnyeit ötvözi](#anchor-image-wtip-min01301)
- [9. Egybérlős és több-bérlős: előnyök és hátrányok, 0:16:44](#anchor-image-wtip-min01644)
- [10. A készletek költséghatékonyak a kiszámíthatatlan munkaterhelések esetében, 0:19:36](#anchor-image-wtip-min01936)
- [11. Bemutató a bérlői adatbázishoz, hibrid ST/MT, 0:20:08](#anchor-image-wtip-min02008)
...
- [16. Minták a E2E SaaS-forgatókönyvbe, 0:43:15](#anchor-image-wtip-min04315)
...
- [23. Bérlők kiépítés és előkészítés, 0:57:44](#anchor-image-wtip-min05744)
...
- [26. PowerShell a létesítéshez és a katalógushoz, 1:00:02](#anchor-image-wtip-min10002)
- [27. T-SQL SELECT * FROM TenantsExtended, 1:03:30](#anchor-image-wtip-min10330)
- [28. Kiszámíthatatlan bérlői számítási feladatok kezelése, 1:04:36](#anchor-image-wtip-min10436)
- [29. Rugalmas készlet figyelése, 1:06:39](#anchor-image-wtip-min10639)
- [30. A terhelés és a teljesítmény figyelése, 1:09:42](#anchor-image-wtip-min10942)
- [31. Séma-kezelés nagy méretekben, 1:10:33](#anchor-image-wtip-min11033)
...
- [35. Bérlői adatok kinyerése az SQL DW-be, 1:16:32](#anchor-image-wtip-min11632)
- [36. A napi értékesítés eloszlásának gráfja, 1:16:48](#anchor-image-wtip-min11648)
- [37. Tördelés és a művelet meghívása, 1:19:52](#anchor-image-wtip-min11952)
...
#### <a name="1-start-welcome-slide-00001"></a>1. *(Indítás)* Üdvözlő dia, 0:00:01

*Tanulás a MYOB: Tervezési minták az SaaS-alkalmazásokhoz Azure SQL Database-BRK3120*

[![Üdvözlő dia][image-wtip-min00003-brk3120-whole-welcome]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1)

- Cím: Tanulás a MYOB: Tervezési minták az SaaS-alkalmazásokhoz Azure SQL Database
...
#### <a name="8-hybrid-model-blends-benefits-of-mtst-01229"></a>8. A hibrid modell a MT/ST, 0:12:29 előnyeinek előnyeit ötvözi
...
#### <a name="10-pools-are-cost-effective-for-unpredictable-workloads-01749"></a>10. A készletek költséghatékonyak a kiszámíthatatlan munkaterhelések esetében, 0:17:49
...
#### <a name="11-demo-of-database-per-tenant-and-hybrid-stmt-01959"></a>11. Bemutató a bérlői adatbázishoz, hibrid ST/MT, 0:19:59
...
#### <a name="16-patterns-compose-into-e2e-saas-scenario-03142"></a>16. Minták a E2E SaaS-forgatókönyvbe, 0:31:42
...
#### <a name="23-provisioning-tenants-and-onboarding-05619"></a>23. Bérlők kiépítés és előkészítés, 0:56:19
...
#### <a name="26-powershell-to-provision-and-catalog-05956"></a>26. PowerShell a létesítéshez és a katalógushoz, 0:59:56
...
#### <a name="28-managing-unpredictable-tenant-workloads-10334"></a>28. Kiszámíthatatlan bérlői számítási feladatok kezelése, 1:03:34
...
#### <a name="30-load-generation-and-performance-monitoring-10937"></a>30. A terhelés és a teljesítmény figyelése, 1:09:37
...
#### <a name="31-schema-management-at-scale-10940"></a>31. Séma-kezelés nagy méretekben, 1:09:40
...
#### <a name="35-extract-tenant-data-into-sql-dw-11546"></a>35. Bérlői adatok kinyerése az SQL DW-be, 1:15:46
...
#### <a name="36-graph-of-daily-sale-distribution-11638"></a>36. A napi értékesítés eloszlásának gráfja, 1:16:38
...
#### <a name="37-wrap-up-and-call-to-action-11743"></a>37. Tördelés és a művelet meghívása, 1:17:43
