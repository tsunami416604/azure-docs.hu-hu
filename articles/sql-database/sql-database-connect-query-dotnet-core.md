...
ms.locfileid: "50913070"
---
# <a name="quickstart-use-net-core-c-to-query-an-azure-sql-database"></a>Rövid útmutató: A .NET Core (C#) használata Azure SQL Database-adatbázisok lekérdezéséhez
