...
- Megtudhatja, hogyan [tervezheti meg első Azure SQL-adatbázisát a SSMS használatával](sql-database-design-first-database.md) , illetve hogyan [tervezhet Azure SQL Database-adatbázist, és hogyan csatlakozhat a C# és a ADO.net](sql-database-design-first-database-csharp.md).
