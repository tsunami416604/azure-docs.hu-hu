...
> [!NOTE]
> Az adatbázisok DTU-korlátját CPU, olvasás, írás és memória határozza meg az adatbázis számára. Mivel azonban a SQL Server adatbázismotor a teljesítmény javítása érdekében általában az összes rendelkezésre álló memóriát használja az adat-gyorsítótárazáshoz `avg_memory_usage_percent` , az érték általában 100%-ra csökken, függetlenül az adatbázis aktuális terhelésével. Ezért annak ellenére, hogy a memória indirekt módon befolyásolja a DTU korlátot, a rendszer nem használja a DTU-kihasználtsági képletben.
>
