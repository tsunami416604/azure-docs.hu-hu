...
[Rugalmas adatbáziseszközöket](sql-database-elastic-scale-get-started.md) és [sorszintű biztonságot (RLS)](https://msdn.microsoft.com/library/dn765131) egy hatékony rugalmasan és hatékony méretezést az adatréteg egy több-bérlős alkalmazás az Azure SQL Database képességeket kínál. További információkért lásd: [Tervminták több-bérlős SaaS-alkalmazásokhoz az Azure SQL Database](sql-database-design-patterns-multi-tenancy-saas-applications.md) további információt. 
