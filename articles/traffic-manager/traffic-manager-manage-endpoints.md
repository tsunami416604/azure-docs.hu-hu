...
>[AZURE.NOTE]  Ez a cikk leírja, hogyan használható a klasszikus portál. A klasszikus Azure portál kizárólag a felhőszolgáltatások és a webalkalmazások létrehozását és végpontként való hozzárendelését támogatja. Az előnyben részesített felület az új [Azure Portal](https://portal.azure.com).
...
* [Traffic Manager – Profilok letiltása, engedélyezése vagy törlése](traffic-manager-manage-profiles.md)
