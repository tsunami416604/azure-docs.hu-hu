...
## <a name="example-1-combining-performance-and-weighted-traffic-routing"></a>1\. példa: A "Performance" és a "súlyozott" forgalom útválasztásának egyesítése
