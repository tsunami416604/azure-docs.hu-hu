...
- [Az erőforrás-naplózás engedélyezése](traffic-manager-diagnostic-logs.md)

- [Metrikák és riasztások Traffic Manager](traffic-manager-metrics-alerts.md)
...
- [Metrikariasztások létrehozása, megtekintése és kezelése az Azure Monitorral](traffic-manager-metrics-alerts.md)
...
- [A biztonságos, Azure által felügyelt munkaállomások ismertetése](/security/compass/concept-azure-managed-workstation)
...
- [Az Azure AD-kockázatok észlelésének ismertetése](../active-directory/identity-protection/overview-identity-protection.md)
