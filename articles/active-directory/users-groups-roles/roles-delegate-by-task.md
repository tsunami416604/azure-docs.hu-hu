...
> [!NOTE]
> Az Azure AD B2C-t a globális rendszergazdák nem rendelkeznek ugyanazokkal az engedélyekkel, az Azure AD globális rendszergazdaként. Ha az Azure AD B2C-vel globális rendszergazdai jogosultságokkal rendelkezik, ellenőrizze, hogy biztosan megfeleljen az Azure AD B2C-címtár, és nem Azure AD-címtárral.
...
Olvasási nevesített helyek | Biztonsági olvasó | Feltételes hozzáférésű rendszergazda, a biztonsági rendszergazda
