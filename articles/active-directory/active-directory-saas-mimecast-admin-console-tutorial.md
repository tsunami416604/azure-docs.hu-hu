<properties 
    ...
    description="了解如何使用 Azure Active Directory 與 Mimecast 管理員主控台啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在搜尋方塊****中，輸入 **Mimecast Admin Console**。
...
2.  在 **Mimecast 管理員主控台 * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
