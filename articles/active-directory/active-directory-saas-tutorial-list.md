...
| ![embléma](./media/active-directory-saas-tutorial-list/active-directory-saas-adpetime-tutorial.png)| [ADP eTime](active-directory-saas-adpetime-tutorial.md)|
...
| ![embléma](./media/active-directory-saas-tutorial-list/active-directory-saas-bgsonline-tutorial.png)| [Online Háttérkép](active-directory-saas-bgsonline-tutorial.md)|
...
| ![embléma](./media/active-directory-saas-tutorial-list/active-directory-saas-bpmonline-tutorial.png)| [Online Bpmâ](active-directory-saas-bpmonline-tutorial.md)|
| ![embléma](./media/active-directory-saas-tutorial-list/active-directory-saas-bridge-tutorial.png)| [Híd](active-directory-saas-bridge-tutorial.md)|
...
| ![embléma](./media/active-directory-saas-tutorial-list/active-directory-saas-salesforce-sandbox-tutorial.png)| [Salesforce védőfal](active-directory-saas-salesforce-sandbox-tutorial.md)|[Salesforce védőfal – a felhasználók átadása](active-directory-saas-salesforce-sandbox-provisioning-tutorial.md)|
...
| ![embléma](./media/active-directory-saas-tutorial-list/active-directory-saas-skillsmanager-tutorial.png)| [Ismeretek Manager](active-directory-saas-skillsmanager-tutorial.md)|
...
| ![embléma](./media/active-directory-saas-tutorial-list/active-directory-saas-tableauonline-tutorial.png)| [Online tableau.](active-directory-saas-tableauonline-tutorial.md)|
| ![embléma](./media/active-directory-saas-tutorial-list/active-directory-saas-tableauserver-tutorial.png)| [Tableau kiszolgáló](active-directory-saas-tableauserver-tutorial.md)|
...
| ![embléma](./media/active-directory-saas-tutorial-list/active-directory-saas-workplacebyfacebook-tutorial.png)| [Munkahelyi által Facebook-on](active-directory-saas-workplacebyfacebook-tutorial.md)|
...
| ![embléma](./media/active-directory-saas-tutorial-list/active-directory-saas-yardielearning-tutorial.png)| [Yardi tanulási](active-directory-saas-yardielearning-tutorial.md)|
