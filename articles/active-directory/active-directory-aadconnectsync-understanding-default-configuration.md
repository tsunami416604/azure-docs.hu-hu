...
由於這是現成可用的規則，因此我們在開啟規則時，將會出現警告。 您不應建立任何 [變更為全新的規則](active-directory-aadconnectsync-best-practices-changing-default-configuration.md) 讓您被要求動作為何。 在此案例中，您只想要檢視規則，因此請選取 [否]****。
