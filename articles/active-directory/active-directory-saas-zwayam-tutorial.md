...
4. Írja be a keresőmezőbe, **Zwayam**, jelölje be **Zwayam** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Zwayam](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_samlbase.png)

3. Az a **Zwayam tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk Zwayam tartomány és az URL-címek](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/active-directory-saas-zwayam-tutorial/tutorial_general_400.png)
...
6. A a **Zwayam konfigurációs** kattintson **konfigurálása Zwayam** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML Entitásazonosító** a a **rövid összefoglaló szakasz** , majd illessze be a **SAML Entitásazonosító** értéket **bejelentkezési URL-cím** a textbox **Zwayam tartomány és az URL-címek** szakasz.
    ...
    ![Zwayam konfiguráció](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_configure.png) 
...
1. Az Azure portálon a bal oldali ablaktáblán kattintson a **Azure Active Directory** gombra.
    ...
    ![Az Azure Active Directory gomb](./media/active-directory-saas-zwayam-tutorial/create_aaduser_01.png)

2. Azon felhasználók listájának megtekintéséhez keresse fel **felhasználók és csoportok**, és kattintson a **minden felhasználó**.

    ![A "felhasználók és csoportok" és "Minden felhasználó" hivatkozások](./media/active-directory-saas-zwayam-tutorial/create_aaduser_02.png)

3. Megnyitásához a **felhasználói** párbeszédpanel, kattintson a **Hozzáadás** tetején a **minden felhasználó** párbeszédpanel megnyitásához.

    ![A Hozzáadás gombra.](./media/active-directory-saas-zwayam-tutorial/create_aaduser_03.png)

4. Az a **felhasználói** párbeszédpanelen hajtsa végre az alábbi lépéseket:

    ![A felhasználó párbeszédpanel](./media/active-directory-saas-zwayam-tutorial/create_aaduser_04.png)
...
2. Az alkalmazások listában válassza ki a **Zwayam**.
    ...
    ![Az alkalmazások listáját a Zwayam hivatkozás](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_app.png)  
