<properties 
    ...
    description="了解如何使用 FM: 系統與 Azure Active Directory 來啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在**搜尋方塊**中，輸入 **FM:Systems**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-fm-systems-tutorial/IC795900.png "Application Gallery")
...
5.  將下載的中繼資料檔案提交給 FM: Systems 支援小組。
    >[AZURE.NOTE] FM: Systems 支援小組必須執行實際的 SSO 設定。
...
2.  在 **fm: systems * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
