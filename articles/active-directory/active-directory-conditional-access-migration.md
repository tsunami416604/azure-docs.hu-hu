...
- [Ajánlott eljárások az Azure Active Directory feltételes hozzáférés](conditional-access/best-practices.md) útmutatásra a feltételes hozzáférés a szervezet üzembe helyezéséhez.

- [Többtényezős hitelesítés az Azure Active Directory feltételes hozzáférés az adott alkalmazások](conditional-access/app-based-mfa.md) való ismerkedésre a felhasználói felület az Azure Portalon.
...
- Ha azt szeretné tudni, hogyan lehet feltételes hozzáférési szabályzat konfigurálása, lásd: [GRequire MFA, Azure Active Directory feltételes hozzáférés az adott alkalmazások](conditional-access/app-based-mfa.md).
