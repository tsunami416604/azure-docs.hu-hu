...
6.  在**搜尋方塊**中，輸入 **Zendesk**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-zendesk-tutorial/IC773084.png "Application Gallery")
...
4.  在 **設定單一登入在 Zendesk** ] 頁面上，下載您的憑證，按一下 [ **下載憑證**, ，然後將儲存在本機憑證檔當做 **c:\\zendesk.cer**。
...
2.  在 **Zendesk * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
