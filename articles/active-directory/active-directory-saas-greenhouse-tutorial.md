<properties 
    ...
    description="了解如何使用 Azure Active Directory 中的 Greenhouse，來啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在**搜尋方塊**中，輸入 **greenhouse**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-greenhouse-tutorial/IC790784.png "Application Gallery")
...
4.  在 **設定單一登入在 Greenhouse** 頁面上，按一下 **下載中繼資料**, ，然後儲存在本機電腦上的中繼資料檔案。
...
3.  按一下 [新使用者]****。
    ...
    ![新增使用者](./media/active-directory-saas-greenhouse-tutorial/IC790792.png "New User")
...
2.  在 **Greenhouse * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
