<properties 
    ...
    description="了解如何使用 Azure Active Directory 與 Overdrive Books 啟用單一登入、 自動化佈建和更多功能!" 
...
1.  在 Azure AD 入口網站上 **OverDrive** 應用程式整合頁面上，按一下 **設定單一登入** 開啟 ** 設定單一登入 ** ] 對話方塊。
...
2.  在 **OverDrive * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
