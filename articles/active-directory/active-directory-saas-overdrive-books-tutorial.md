<properties 
    pageTitle="教學課程：Azure Active Directory 與 Overdrive Books 整合 | Microsoft Azure" 
...
完成本教學課程之後, 您已指派給 OverDrive 的 Azure AD 使用者將能夠登入位於您 OverDrive 公司網站 (服務提供者起始登入)，應用程式的單一登入或使用 [存取面板簡介](active-directory-saas-access-panel-introduction.md)。
...
>[AZURE.NOTE]您可以使用任何其他 OverDrive 使用者帳戶建立工具或 Api 來佈建 AAD 使用者帳戶提供加速。
