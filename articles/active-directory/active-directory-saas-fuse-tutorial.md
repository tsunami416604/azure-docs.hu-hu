...
本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合保險絲。<br>與 Azure AD 整合將為您提供下列優點:
...
建立此連結關聯性的方法，就是將 Azure AD 中 [使用者名稱]**** 的值，指派為 Fuse 中 [Username]**** 的值。
...
4. * *[建立保險絲測試使用者](#creating-a-fuse-test-user)* *-若要連結到她在 Azure AD 代表保險絲中有對應的 Britta Simon。
