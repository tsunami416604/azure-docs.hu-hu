...
> Az Privileged Identity Management PowerShell-parancsmagok az Azure AD előzetes verziójának moduljában támogatottak. Ha egy másik modult használ, és a modul mostantól hibaüzenetet ad vissza, kezdje el használni ezt az új modult. Ha egy másik modulra épülő éles rendszerek vannak, kérjük, lépjen kapcsolatba pim_preview@microsoft.com
...
1. A bérlő AZONOSÍTÓjának megkereséséhez nyissa meg **Azure Active Directory** > **Tulajdonságok** > **Directory-azonosítóját**. A parancsmagok szakaszban ezt az azonosítót kell használnia, amikor meg kell adnia a resourceId.
