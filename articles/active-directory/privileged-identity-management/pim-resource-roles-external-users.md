---
title: Vendégek meghívása és Azure-beli erőforrás-szerepkörök kiosztása Privileged Identity Management-Azure Active Directoryban | Microsoft Docs
...
1. Válassza **Azure Active Directory** > **felhasználói beállítások**lehetőséget.
...
1. A vendég tevékenységének megtekintéséhez válassza **Azure Active Directory** > **felhasználók** > *vendég nevét*.
