...
A Azure AD Privileged Identity Management segítségével felügyelheti az Azure AD, az Azure-erőforrások és más Microsoft Online Services Kiemelt felügyeleti szerepköreit. Egy olyan világban, ahol privilegizált identitások vannak hozzárendelve és elfelejtve, Privileged Identity Management olyan megoldásokat kínál, mint az igény szerinti hozzáférés, a jóváhagyási munkafolyamatok kérése és a teljes körűen integrált hozzáférési felülvizsgálatok, így azonosíthatja, feltárhatja és megakadályozhatja a kártékony a Kiemelt szerepkörökkel kapcsolatos tevékenységek valós időben. A munkahelyen a Kiemelt szerepkörök kezeléséhez Privileged Identity Management üzembe helyezése nagy mértékben csökkenti a kockázatokat, miközben a Kiemelt szerepkörök tevékenységeivel kapcsolatos értékes információkra felszínre kerül.
...
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| Kritikus előfizetések tulajdonosa | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | Az előfizetés egyéb tulajdonosai | 1 óra | None | – | 3 hónap |
| Kevésbé kritikus előfizetések felhasználói hozzáférésének rendszergazdája | :heavy_check_mark: | :heavy_check_mark: | x | None | 1 óra | None | – | 3 hónap |
| Virtuális gépek közreműködője | x | :heavy_check_mark: | x | None | 3 óra | None | – | 6 hónap |
