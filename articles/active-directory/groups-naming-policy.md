...
3. Kövesse a [Azure Active Directory-parancsmagok csoportbeállítások konfigurálásához](users-groups-roles/groups-settings-cmdlets.md) ehhez a bérlőhöz tartozó csoport beállításokat szeretne létrehozni.
...
További információkért tekintse meg a cikket [Azure Active Directory-parancsmagok csoportbeállítások konfigurálásához](users-groups-roles/groups-settings-cmdlets.md).
...
* [Elévülési szabályzatot, az Office 365-csoportok](users-groups-roles/groups-lifecycle.md)
...
* [A csoport dinamikus szabályok kezelése](users-groups-roles/groups-dynamic-membership.md)
