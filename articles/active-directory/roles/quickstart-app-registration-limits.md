...
- Az Azure AD szerepkör-hozzárendelésekről további információt a [rendszergazdai szerepkörök hozzárendelése](permissions-reference.md)című témakörben talál.
