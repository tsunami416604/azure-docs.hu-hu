...
A regionális támogatási szakemberek számára való delegálás például az [ügyfélszolgálati rendszergazda](permissions-reference.md#helpdesk-administrator) szerepkör, amely csak az általuk támogatott régióban lévő felhasználók kezelésére korlátozódik.
...
- [Szerepkörök létrehozása, eltávolítása, feltöltése és hozzáadása felügyeleti egységekhez](admin-units-manage.md): az eljárások befejezése
...
- [Felügyeleti egység Graph-támogatás](/graph/api/resources/administrativeunit?view=graph-rest-1.0&preserve-view=true): Részletes dokumentáció a Microsoft Graph felügyeleti egységekhez.
...
- [Az AUs kezelése](admin-units-manage.md)
- [Felhasználók kezelése az AUs-ban](admin-units-add-manage-users.md)
- [Csoportok kezelése az AUs-ban](admin-units-add-manage-groups.md)
- [Hatókörrel rendelkező szerepkörök társítása egy AU-hoz](admin-units-assign-roles.md)
