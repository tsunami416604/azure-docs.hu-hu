...
A felhasználók és csoportok alkalmazásban való kiépítésének és megszüntetésének automatizálásához a SCIM használatával kapcsolatos részletes útmutatásért lásd: [scim-végpont létrehozása és a felhasználók üzembe](use-scim-to-provision-users-and-groups.md)helyezésének konfigurálása.
