...
[A felhasználók automatikus üzembe helyezésének megtervezése](../app-provisioning/plan-auto-user-provisioning.md)

[Kiépítés konfigurálása egy katalógusbeli alkalmazáshoz](../manage-apps/configure-automatic-user-provisioning-portal.md)
