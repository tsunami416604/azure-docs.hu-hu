...
4. Kattintson a **alkalmazásregisztrációk**, majd válassza ki **új regisztrációs**.
5. Hozzon létre egy új ügyfél alkalmazást, kövesse az utasításokat.
