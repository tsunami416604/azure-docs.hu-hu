...
Eddig a legtöbb fejlesztő dolgozott együtt az Azure ad v 1.0 platformmal a munkahelyi és iskolai fiókok (az Azure AD által kiépített) hitelesítéséhez az Azure AD v 1.0 végpontról származó jogkivonatok igénylésével, az Azure ad Authentication Library (ADAL) használatával, Azure Portal az alkalmazások regisztrálásához és konfigurálásához, valamint a Microsoft Graph API-t a programozott alkalmazások konfigurálásához.
