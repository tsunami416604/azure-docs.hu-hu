...
A [TestData](https://github.com/AzureAD/microsoft-authentication-library-for-java/blob/dev/src/samples/public-client/TestData.java) a MSAL Java dev-minták konfigurálásához használt osztály:
