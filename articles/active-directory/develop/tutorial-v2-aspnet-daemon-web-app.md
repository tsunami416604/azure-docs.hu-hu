...
1. Az alkalmazás oldalainak listájában válassza a **Hitelesítés** elemet. Ezután:
   - A **Speciális beállítások** szakaszban állítsa be **https://localhost:44316/Account/EndSession** a **kijelentkezési URL-címet** .
...
1. A Visual Studióban hozzon létre egy új  **C# Visual** **ASP.net webalkalmazás (.NET-keretrendszer)** projektet. 
...
1. Frissítse a **megosztott\_layout. cshtml** és a **Home\Index.cshtml** , hogy megfelelően összekapcsolja a különböző nézeteket.
...
1. Az alkalmazás **hitelesítés** lapján frissítse a **kijelentkezési URL-** mezőket a szolgáltatás címével. Használja például a [https://dotnet-web-daemon-v2-contoso.azurewebsites.net](https://dotnet-web-daemon-v2-contoso.azurewebsites.net).
1. A **branding (védjegyezés** ) menüben frissítse a **Kezdőlap URL-** címét a szolgáltatás címére. Használja például a [https://dotnet-web-daemon-v2-contoso.azurewebsites.net](https://dotnet-web-daemon-v2-contoso.azurewebsites.net).
