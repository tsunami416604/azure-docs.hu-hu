...
| Azonnali hitelesítés | |A dátum és idő, mikor történt a hitelesítés rögzíti. | `<AuthnStatement AuthnInstant="2011-12-29T05:35:22.000Z">` | 
...
|Name (Név) | `unique_name` |Itt egy emberi olvasható érték, amely azonosítja a jogkivonat tárgyában. Ez az érték nem garantált egy bérlőn belül egyedinek kell lennie, és célja, hogy csak megjelenítési célokra használhatók. | `<Attribute Name=”http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name”>`<br>`<AttributeValue>frankm@contoso.com<AttributeValue>`|
