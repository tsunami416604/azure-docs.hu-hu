...
| ![jelölőnégyzetet](./media/active-directory-integration-checklist/checkbox-two.svg) |Ne tekintse meg a hozzáférési jogkivonat értékét, vagy próbálja meg ügyfélként elemezni.  Megváltoztathatják az értékeket, a formátumokat, vagy akár a figyelmeztetés nélkül is titkosítva lesznek – mindig a id_token használja, ha az ügyfélnek valamit kell megtanulnia a felhasználóval kapcsolatban, vagy a Microsoft Graph meghívását.  Csak a webes API-knak kell elemezni a hozzáférési jogkivonatokat (mivel ezek a formátum és a titkosítási kulcsok beállítása). |
