---
title: Azure Active Directory v2 Windows desktop használatának első lépései |} A Microsoft Docs
description: A Windows asztali .NET (XAML) alkalmazások hogyan hozzáférési jogkivonatot kapjon, és a egy API-t egy Azure Active Directory v2 végpontot védi.
