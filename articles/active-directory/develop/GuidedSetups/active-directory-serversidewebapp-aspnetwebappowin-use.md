---
title: "Az Azure AD v2 ASP.NET Web Server első lépései – használja |} Microsoft Docs"
...
> Ezen a lapon egy fekete háttérrel SVG-formátumban ad hozzá a Bejelentkezés gombra:<br/>![Jelentkezzen be Microsoft](media/active-directory-serversidewebapp-aspnetwebappowin-use/aspnetsigninbuttonsample.png)<br/> Több bejelentkezési gomb, előbb lépjen a [ezen a lapon](https://docs.microsoft.com/azure/active-directory/develop/active-directory-branding-guidelines "irányelvek Branding").
<!--end-collapse-->
