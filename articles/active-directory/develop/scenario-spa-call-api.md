---
title: Egyoldalas alkalmazás (webes API meghívása) – Microsoft Identity platform
description: Ismerje meg, hogyan hozhat létre egy egyoldalas alkalmazást (webes API meghívása)
