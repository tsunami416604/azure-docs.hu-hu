...
1. Keresse meg és válassza ki az **Azure Active Directoryt**. A **Active Directory** lapon válassza a **Alkalmazásregisztrációk** lehetőséget, majd válassza az **új regisztráció**lehetőséget.
