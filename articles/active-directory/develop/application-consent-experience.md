---
title: Az Azure AD-alkalmazások hozzájárulási folyamatának ismertetése
...
## <a name="consent-and-permissions"></a>Engedély és engedélyek
...
| # | Component (Összetevő) | Rendeltetés |
| ----- | ----- | ----- |
