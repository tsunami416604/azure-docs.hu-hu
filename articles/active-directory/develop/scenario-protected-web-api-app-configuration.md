...
Íme egy C#-kód, amely egy olyan ügyfelet mutat be, amely az API-t hívja meg, miután beszerezte a tokent a .NET-hez készült Microsoft Authentication Library (MSAL.NET) használatával:
