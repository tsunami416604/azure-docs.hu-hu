...
**Hozzáférési jogkivonat beszerzésére**: szeretné elérni az Azure AD Graph, az ügyfelek sikeresen hitelesíteni először az Azure AD szükséges. További információkért lásd: [hitelesítési forgatókönyvek az Azure ad-ben](authentication-scenarios.md).

**Állítsa össze és a lekérdezések futtatásához**: kövesse az alábbi lépéseket:
