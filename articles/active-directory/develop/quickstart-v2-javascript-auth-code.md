...
>
> 1. Nyissa meg a <a href="https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationsListBlade/quickStartType/JavascriptSpaQuickstartPage/sourceType/docs" target="_blank">Azure Portal- <span class="docon docon-navigate-external x-hidden-focus"></span> Alkalmazásregisztrációk</a>.
