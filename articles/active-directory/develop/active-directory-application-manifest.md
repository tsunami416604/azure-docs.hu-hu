...
|errorURL     |karakterlánc         |`http://MyRegisteredAppError`         |Hiba történt egy alkalmazás URL-CÍMÉT. |
...
|optionalClaims     |  karakterlánc       |     `null`    |    A [választható jogcímek](active-directory-optional-claims.md) a jogkivonat a biztonsági jogkivonat-szolgáltatás az adott alkalmazás által visszaadott.     |
...
|Kezdőlap     |  karakterlánc       |`http://MyRegistererdApp`         |    Az alkalmazás kezdőlapját URL-CÍMÉT.     |
...
|logoutUrl     |   karakterlánc      |     `http://MyRegisteredAppLogout`    |   Jelentkezzen ki az alkalmazás URL-CÍMÉT.      |
...
|PublicClient     |  logikai       |      `false`   | Megadja, hogy egy alkalmazás egy nyilvános ügyfél (például egy telepített alkalmazás egy mobileszközön fut). Alapértelmezett értéke false.        |
...
|samlMetadataUrl    |karakterlánc| `http://MyRegisteredAppSAMLMetadata` |Az alkalmazás SAML-metaadataira mutató URL-cím.| 
