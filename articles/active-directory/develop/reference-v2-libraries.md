...
description: Kompatibilis klienskódtárak és kiszolgáló közbenső tárak, és a kapcsolódó könyvtár, forrás és minták hivatkozások, a Microsoft identity platform végpont.
...
> [!NOTE]
> Az Azure AD authentication library (ADAL) keres? Kivétel a [ADAL könyvtár az útmutató](active-directory-authentication-libraries.md).

## <a name="types-of-libraries"></a>Szalagtárak típusai

A Microsoft identity platform endpoint és kódtárak két típusú működik:
...
Listáját-kódtárak együttese a Microsoft identity platform végponttal működik tekintse meg a következő szakasz ebben a cikkben.
...
| Platform | Szalagtár | Letöltés | Forráskód | Sample | Leírások | Fogalmi doc | Ütemterv |
| --- | --- | --- | --- | --- | --- | --- | ---|
...
| Platform | Szalagtár | Letöltés | Forráskód | Sample | Leírások
| --- | --- | --- | --- | --- | --- |
...
Bármely szabványokkal kompatibilis könyvtár használhatja a Microsoft identity platform végpont, ezért fontos, hogy tudja, hol találhat a támogatást.
...
* [Hozzon létre egy támogatási kérést](https://docs.microsoft.com/azure/azure-supportability/how-to-create-azure-support-request) , ha a hibát látja, ha a Microsoft identity platform végpont nem felelnek meg az OAuth 2.0 vagy OpenID Connect 1.0.
