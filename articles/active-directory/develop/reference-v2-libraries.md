...
|![Angular JS](media/sample-v2-code/logo_angular.png) | MSAL szögletes JS | [NPM](https://www.npmjs.com/package/@azure/msal-angularjs) | [GitHubon](https://github.com/AzureAD/microsoft-authentication-library-for-js/blob/dev/lib/msal-angularjs/README.md) |  |  | |
...
| Platform | Szalagtár neve | Tesztelt verzió | Forráskód | Minta |
|:---:|:---:|:---:|:---:|:---:|
