...
ms.locfileid: "49988722"
---
# <a name="quickstart-configure-a-client-application-to-access-web-apis-preview"></a>Rövid útmutató: Ügyfélalkalmazás konfigurálása webes API-k elérésére (előzetes verzió)
