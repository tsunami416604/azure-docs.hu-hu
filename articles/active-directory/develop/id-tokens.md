...
|`unique_name` |  Sztring | Itt egy emberi olvasható érték, amely azonosítja a jogkivonat tárgyában. Ez az érték nem garantált egy bérlőn belül egyedinek kell lennie, és csak megjelenítési célokra használható. Csak az 1.0-s verziójú kiadott `id_tokens`. |
