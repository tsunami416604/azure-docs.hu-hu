---
title: Az Azure AD v2.0 ASP.NET webkiszolgálóra első lépések |} A Microsoft Docs
...
További tudnivalók: Web apps webes API-k hívása:.
...
> [Webalkalmazások webes API-k hívása]( https://aka.ms/msal-net-authorization-code)
