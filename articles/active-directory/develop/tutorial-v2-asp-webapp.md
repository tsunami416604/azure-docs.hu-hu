...
Ebben az oktatóanyagban egy ASP.NET MVC-webalkalmazást hoz létre, amely a felhasználók számára a web interface for .NET (OWIN) middleware és a Microsoft Identity platform használatával jelentkezik be.
