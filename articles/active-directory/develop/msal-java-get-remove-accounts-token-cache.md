...
Ha el szeretne távolítani egy fiókot a gyorsítótárból, keresse meg azt a fiókot, amelyet el szeretne távolítani, majd hívja meg az `PublicClientApplication.removeAccount()` alábbi példában látható módon:
