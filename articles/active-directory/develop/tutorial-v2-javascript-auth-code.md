...
Kövesse az utasításokat [egy új egyoldalas alkalmazás regisztrálásához](https://docs.microsoft.com/zure/active-directory/develop/scenario-spa-app-registration).
