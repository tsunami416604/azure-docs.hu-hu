...
1. A Visual Studióban hozzon létre vagy nyisson meg egy ASP.NET MVC-projektben vagy egy ASP.NET webes API projektet. Az MVC, webes API-t, egyetlen lapon alkalmazás, Azure API App, Azure Mobile Apps és Azure Mobile Service sablonok is használhatja.
...
- [Hitelesítési forgatókönyvek az Azure Active Directory](active-directory-authentication-scenarios.md)
- [Jelentkezzen be a Microsoft ASP.NET-webalkalmazás hozzáadása](guidedsetups/active-directory-aspnetwebapp-v1.md)
