...
description: Megtudhatja, hogyan konfigurálhatja a Mobile App kódját a webes API-k meghívásához
...
- [A szükséges hibák megoldása](msal-net-xamarin-android-considerations.md#troubleshooting)
