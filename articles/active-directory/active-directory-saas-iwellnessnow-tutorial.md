...
4. Írja be a keresőmezőbe, **iWellnessNow**, jelölje be **iWellnessNow** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![az eredménylistában iWellnessNow](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_samlbase.png)
...
3. A a **iWellnessNow tartomány és az URL-címek** szakaszban, ha **szolgáltató metaadatfájl** , és konfigurálja az alkalmazást a szeretne **IDP** kezdeményezett mód, hajtsa végre a a következő lépéseket:
    ...
    ![Tartomány- és URL-címeket az egyszeri bejelentkezés iWellnessNow feltöltése](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_upload.png)

    a. Kattintson a **feltöltés metaadatfájl**.

    ![Tartomány- és URL-címeket az egyszeri bejelentkezés iWellnessNow uploadconfig](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_uploadconfig.png)
    ...
    ![Tartomány- és URL-címek egyetlen bejelentkezési adatokat iWellnessNow](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_url3.png)
...
4. Ha nem rendelkezik **szolgáltató metaadatfájl** , és konfigurálja az alkalmazást a szeretne **IDP** kezdeményezett mód, hajtsa végre a következő lépéseket:
    ...
    ![Tartomány- és URL-címek egyetlen bejelentkezési adatokat iWellnessNow](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_url.png)
...
5. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:
    ...
    ![Tartomány- és URL-címek egyetlen bejelentkezési adatokat iWellnessNow](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_url1.png)
...
5. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_certificate.png) 

6. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_general_400.png)
...
1. Az Azure portálon a bal oldali ablaktáblán kattintson a **Azure Active Directory** gombra.
    ...
    ![Az Azure Active Directory gomb](./media/active-directory-saas-iwellnessnow-tutorial/create_aaduser_01.png)

2. Azon felhasználók listájának megtekintéséhez keresse fel **felhasználók és csoportok**, és kattintson a **minden felhasználó**.

    ![A "felhasználók és csoportok" és "Minden felhasználó" hivatkozások](./media/active-directory-saas-iwellnessnow-tutorial/create_aaduser_02.png)

3. Megnyitásához a **felhasználói** párbeszédpanel, kattintson a **Hozzáadás** tetején a **minden felhasználó** párbeszédpanel megnyitásához.

    ![A Hozzáadás gombra.](./media/active-directory-saas-iwellnessnow-tutorial/create_aaduser_03.png)

4. Az a **felhasználói** párbeszédpanelen hajtsa végre az alábbi lépéseket:

    ![A felhasználó párbeszédpanel](./media/active-directory-saas-iwellnessnow-tutorial/create_aaduser_04.png)
...
2. Az alkalmazások listában válassza ki a **iWellnessNow**.
    ...
    ![Az alkalmazások listáját a iWellnessNow hivatkozás](./media/active-directory-saas-iwellnessnow-tutorial/tutorial_iwellnessnow_app.png)  
