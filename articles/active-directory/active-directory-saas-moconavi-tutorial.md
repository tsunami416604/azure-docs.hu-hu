...
4. Írja be a keresőmezőbe, **moconavi**, jelölje be **moconavi** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![az eredménylistában moconavi](./media/active-directory-saas-moconavi-tutorial/tutorial_moconavi_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/active-directory-saas-moconavi-tutorial/tutorial_moconavi_samlbase.png)

3. Az a **moconavi tartomány és az URL-címek** területen tegye a következőket:

    ![Tartomány- és URL-címek egyetlen bejelentkezési adatokat moconavi](./media/active-directory-saas-moconavi-tutorial/tutorial_moconavi_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/active-directory-saas-moconavi-tutorial/tutorial_moconavi_certificate.png)

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/active-directory-saas-moconavi-tutorial/tutorial_general_400.png)
...
1. Az Azure portálon a bal oldali ablaktáblán kattintson a **Azure Active Directory** gombra.
    ...
    ![Az Azure Active Directory gomb](./media/active-directory-saas-moconavi-tutorial/create_aaduser_01.png)

2. Azon felhasználók listájának megtekintéséhez keresse fel **felhasználók és csoportok**, és kattintson a **minden felhasználó**.

    ![A "felhasználók és csoportok" és "Minden felhasználó" hivatkozások](./media/active-directory-saas-moconavi-tutorial/create_aaduser_02.png)

3. Megnyitásához a **felhasználói** párbeszédpanel, kattintson a **Hozzáadás** tetején a **minden felhasználó** párbeszédpanel megnyitásához.

    ![A Hozzáadás gombra.](./media/active-directory-saas-moconavi-tutorial/create_aaduser_03.png)

4. Az a **felhasználói** párbeszédpanelen hajtsa végre az alábbi lépéseket:

    ![A felhasználó párbeszédpanel](./media/active-directory-saas-moconavi-tutorial/create_aaduser_04.png)
...
2. Az alkalmazások listában válassza ki a **moconavi**.
    ...
    ![Az alkalmazások listáját a moconavi hivatkozás](./media/active-directory-saas-moconavi-tutorial/tutorial_moconavi_app.png)
...
3. Kattintson a **beállítás csatlakozás** gombra.
    ...
    ![Egyszeri bejelentkezés tesztelése](./media/active-directory-saas-moconavi-tutorial/testing1.png)

4. Adja meg `https://mcs-admin.moconavi.biz/gateway` be **URL-cím kapcsolódás** szövegmező, majd **végzett** gombra.

    ![Egyszeri bejelentkezés tesztelése](./media/active-directory-saas-moconavi-tutorial/testing2.png)

5. Az alábbi képernyőfelvételen hajtsa végre a következő lépéseket:

    ![Egyszeri bejelentkezés tesztelése](./media/active-directory-saas-moconavi-tutorial/testing3.png)
...
6. Az Azure AD-jelszó a bemeneti **jelszó** szövegmező majd **bejelentkezési** gombra.
    ...
    ![Egyszeri bejelentkezés tesztelése](./media/active-directory-saas-moconavi-tutorial/testing4.png)

7. Az Azure AD authentication akkor sikeres, ha a menüt.

    ![Egyszeri bejelentkezés tesztelése](./media/active-directory-saas-moconavi-tutorial/testing5.png)
