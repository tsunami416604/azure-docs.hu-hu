...
| --- | --- | --- | --- | --- |
| Rendszerhez rendelt | Szabad | Előnézet | Előnézet | Előnézet | 
| Felhasználóhoz rendelt | Előnézet | Előnézet | Előnézet | Előnézet |
...
| Felügyelt identitás típusa | Általánosan elérhető<br>Globális Azure-régiók | Azure Government | Azure Germany | Azure China 21Vianet |
| --- | --- | --- | --- | --- |
| Rendszerhez rendelt | Szabad | Szabad | Szabad | Szabad |
| Felhasználóhoz rendelt | Előnézet | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok |
...
|Felügyelt identitás típusa | Általánosan elérhető<br>Globális Azure-régiók | Azure Government | Azure Germany | Azure China 21Vianet |
| --- | --- | --- | --- | --- |
| Rendszerhez rendelt | Előnézet | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok |
| Felhasználóhoz rendelt | Előnézet | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok |
...
Felügyelt identitás típusa | Általánosan elérhető<br>Globális Azure-régiók | Azure Government | Azure Germany | Azure China 21Vianet |
| --- | --- | --- | --- | --- |
| Rendszerhez rendelt | Előnézet | Előnézet | Nem állnak rendelkezésre adatok | Előnézet |
| Felhasználóhoz rendelt | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok |
...
Felügyelt identitás típusa | Általánosan elérhető<br>Globális Azure-régiók | Azure Government | Azure Germany | Azure China 21Vianet |
| --- | --- | --- | --- | --- |
| Rendszerhez rendelt | Szabad | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok |
| Felhasználóhoz rendelt | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok |
...
Felügyelt identitás típusa | Általánosan elérhető<br>Globális Azure-régiók | Azure Government | Azure Germany | Azure China 21Vianet |
| --- | --- | --- | --- | --- |
| Rendszerhez rendelt | Szabad | Szabad | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok |
| Felhasználóhoz rendelt | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok |
...
Felügyelt identitás típusa | Általánosan elérhető<br>Globális Azure-régiók | Azure Government | Azure Germany | Azure China 21Vianet |
| --- | --- | --- | --- | --- |
| Rendszerhez rendelt | Linux: Előnézet<br>Windows: Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok |
| Felhasználóhoz rendelt | Linux: Előnézet<br>Windows: Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok | Nem állnak rendelkezésre adatok |
...
|--------|------------|--------|
| Azure Global | `https://management.azure.com/`| Szabad |
| Azure Government | `https://management.usgovcloudapi.net/` | Szabad |
| Azure Germany | `https://management.microsoftazure.de/` | Szabad |
| Azure China 21Vianet | `https://management.chinacloudapi.cn` | Szabad |

### <a name="azure-key-vault"></a>Azure Key Vault

| Felhő | Erőforrás-azonosító | Állapot |
|--------|------------|--------|
| Azure Global | `https://vault.azure.net`| Szabad |
| Azure Government | `https://vault.usgovcloudapi.net` | Szabad |
| Azure Germany |  `https://vault.microsoftazure.de` | Szabad |
| Azure China 21Vianet | `https://vault.azure.cn` | Szabad |

### <a name="azure-data-lake"></a>Azure Data Lake 

| Felhő | Erőforrás-azonosító | Állapot |
|--------|------------|--------|
| Azure Global | `https://datalake.azure.net/` | Szabad |
...
| Felhő | Erőforrás-azonosító | Állapot |
|--------|------------|--------|
| Azure Global | `https://database.windows.net/` | Szabad |
| Azure Government | `https://database.usgovcloudapi.net/` | Szabad |
| Azure Germany | `https://database.cloudapi.de/` | Szabad |
| Azure China 21Vianet | `https://database.chinacloudapi.cn/` | Szabad |

### <a name="azure-event-hubs"></a>Azure Event Hubs

| Felhő | Erőforrás-azonosító | Állapot |
|--------|------------|--------|
| Azure Global | `https://eventhubs.azure.net` | Előnézet |
| Azure Government |  | Nem érhető el |
| Azure Germany |   | Nem érhető el |
| Azure China 21Vianet |  | Nem érhető el |
...
| Felhő | Erőforrás-azonosító | Állapot |
|--------|------------|--------|
| Azure Global | `https://servicebus.azure.net`  | Előnézet |
| Azure Government |  | Nem érhető el |
| Azure Germany |   | Nem érhető el |
| Azure China 21Vianet |  | Nem érhető el |
...
| Felhő | Erőforrás-azonosító | Állapot |
|--------|------------|--------|
| Azure Global | `https://storage.azure.com/` | Szabad |
| Azure Government | `https://storage.azure.com/` | Szabad |
| Azure Germany | `https://storage.azure.com/` | Szabad |
| Azure China 21Vianet | `https://storage.azure.com/` | Szabad |

### <a name="azure-analysis-services"></a>Azure Analysis Services

| Felhő | Erőforrás-azonosító | Állapot |
|--------|------------|--------|
| Azure Global | `https://*.asazure.windows.net` | Szabad |
| Azure Government | `https://*.asazure.usgovcloudapi.net` | Szabad |
| Azure Germany | `https://*.asazure.cloudapi.de` | Szabad |
| Azure China 21Vianet | `https://*.asazure.chinacloudapi.cn` | Szabad |