...
### <a name="what-azure-rbac-permissions-are-required-to-managed-identity-on-a-resource"></a>Milyen Azure RBAC-engedélyek szükségesek egy erőforrást a felügyelt identitás? 

- Rendszer által hozzárendelt felügyelt identitás: Az erőforrás keresztül kell írási engedéllyel. Exampl, a virtuális gépek kell Microsoft.Compute/virtualMachines/write. Ez a művelet adott beépített szerepkörök, például erőforrás megtalálható [virtuális gépek Közreműködője](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#virtual-machine-contributor).
- Felhasználó által hozzárendelt felügyelt identitás: Az erőforrás keresztül kell írási engedéllyel. Ha például a virtuális gépek kell Microsoft.Compute/virtualMachines/write. Mellett [felügyelt identitások üzemeltetője](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#managed-identity-operator) szerepkör-hozzárendelés a felügyelt identitás keresztül.
