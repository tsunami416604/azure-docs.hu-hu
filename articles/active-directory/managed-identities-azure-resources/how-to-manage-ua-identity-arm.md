...
Felhasználó által hozzárendelt felügyelt identitás létrehozásához használja a következő sablont. Cserélje le a `<USER ASSIGNED IDENTITY NAME>` értéket a saját értékeire:
