...
6.  在 [帳戶組態] 頁面上，執行下列步驟：
    ...
    1.  選取 **啟用外部授權**。
    2.  在 **主登入控制** 區段中，選取 **SmarterU** ] 索引標籤。
    3.  在 **使用者預設登入** 區段中，選取 **SmarterU** ] 索引標籤。
    4.  選取 **啟用 Okta**。
    5.  複製檔案的內容下載的中繼資料，並接著將它貼到 **Okta 中繼資料** 文字方塊。
    6.  按一下 [ **儲存**。
...
>[AZURE.NOTE] 您可以使用任何其他 SmarterU 使用者帳戶建立工具或 Api 來佈建 AAD 使用者帳戶提供 SmarterU。
