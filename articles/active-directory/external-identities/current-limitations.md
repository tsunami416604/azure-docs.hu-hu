...
Az Azure AD B2B az Azure AD szolgáltatási könyvtárának korlátaira vonatkozik. A felhasználók által létrehozható könyvtárak számával és azon könyvtárak számával kapcsolatos részletekért, amelyekhez a felhasználó vagy a vendég felhasználó tartozhat, tekintse meg az [Azure ad szolgáltatás korlátai és korlátozásai](../users-groups-roles/directory-service-limits-restrictions.md)című témakört.
