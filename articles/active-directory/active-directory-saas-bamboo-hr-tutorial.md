<properties 
    ...
    description="了解如何使用 Azure Active Directory 與 Bamboo HR 啟用單一登入、 自動化佈建和更多功能!" 
...
# 教學課程：Azure Active Directory 與 Bamboo HR 整合
...
4.  在 **設定單一登入在 BambooHR** 頁面上，按一下 **下載憑證**, ，然後儲存您的電腦上的憑證檔案。
...
7.  在 [SAML 單一登入]**** 區段中，執行下列步驟：
    ...
    1.  在 Azure 網站中，在 **BambooHR 在設定單一登入** 對話方塊頁面中，複製 **單一登入服務 URL** 值，並接著將它貼入 ** SSO 登入 URL ** 文字方塊。
...
2.  在 **BambooHR * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
