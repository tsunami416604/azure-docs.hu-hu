...
> [AZURE.IMPORTANT] Azure AD 使用公開金鑰密碼編譯來簽署權杖，並確認它們有效。 請參閱 [重要簽署金鑰變換的相關資訊在 Azure AD 中](https://msdn.microsoft.com/library/azure/dn641920.aspx) 如需有關必要的邏輯，您必須在您的應用程式，以確保永遠以最新的金鑰來更新。
