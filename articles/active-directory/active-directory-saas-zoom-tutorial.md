...
完成本教學課程之後, 您已指派給 Zoom 的 Azure AD 使用者將能夠單一登入應用程式在您的 Zoom 公司網站 (服務提供者起始登入)，或使用 [存取面板簡介](active-directory-saas-access-panel-introduction.md)
...
6.  在**搜尋方塊**中，輸入 **Zoom**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-zoom-tutorial/IC784694.png "Application Gallery")
