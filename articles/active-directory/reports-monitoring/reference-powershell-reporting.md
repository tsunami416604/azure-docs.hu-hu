...
| Alkalmazási helyzet                      | PowerShell-parancs |
| :--                           | :--                |
...
| A fentiek közül mindegyik              | Get-AzureADAuditDirectoryLogs-Filter "initiatedBy/app/displayName EQ" Azure AD Cloud Sync "és Kategória EQ" Application Management "és activityDateTime gt 2019-04-18"|
...
| A fentiek közül mindegyik              | Get-AzureADAuditSignInLogs-Filter "userDisplayName EQ" Timothy Perkins "és status/errorCode ne 0 és appDisplayName EQ" StoreFrontStudio [wsfed enabled] "" |
