...
A bejelentkezési adatok Azure Portallal való elérésének alternatívájaként a [jelentéskészítő API-t](concept-reporting-api.md) is használhatja.
...
További információ: [Bejelentkezési tevékenységre vonatkozó jelentések az Azure Active Directory portálon](concept-sign-ins.md).
