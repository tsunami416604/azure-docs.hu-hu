...
Ha a bejelentkezés sikertelen, akkor a hibának megfelelő hibakód jelenik meg. [Egy hibakód leírásának megkeresése](https://login.microsoftonline.com/error).
