...
Most, hogy létrehozta a csoport és a virtuális gép MSI hozzáadva a tagsághoz, [konfigurálása az Azure AD-alapú hitelesítés, az SQL Server](~/articles/sql-database/sql-database-aad-authentication-configure.md#provision-an-azure-active-directory-administrator-for-your-managed-instance) az alábbi lépéseket követve:
