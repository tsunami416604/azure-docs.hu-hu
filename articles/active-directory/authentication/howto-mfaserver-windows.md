...
* Ha az "Azure multi-factor authentication user match" jelölőnégyzet be van jelölve, és nem szerepel a felhasználói listában, újraindítás után nem fog tudni bejelentkezni a gépre.
...
## <a name="to-secure-an-application-with-windows-authentication-use-the-following-procedure"></a>Ha egy alkalmazást Windows-hitelesítéssel szeretne biztonságossá tenni, kövesse az alábbi eljárást
