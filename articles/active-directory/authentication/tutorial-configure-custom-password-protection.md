...
1. Lépjen a **saját alkalmazások** lapra [https://myapps.microsoft.com](https://myapps.microsoft.com)címen.
...
> [Kockázatalapú Azure-Multi-Factor Authentication engedélyezése](tutorial-mfa-applications.md)
