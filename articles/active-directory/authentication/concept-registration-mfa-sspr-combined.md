...
| --- | --- | --- | --- |
| Microsoft Authenticator | Yes (maximum of 5) | Nem | Igen |
| Other authenticator app | Yes (maximum of 5) | Nem | Igen |
| Hardware token | Nem | Nem | Igen |
| Telefonszám | Igen | Igen | Igen |
| Alternate phone | Igen | Igen | Igen |
| Office phone | Nem | Nem | Nem |
| E-mail cím | Igen | Igen | Igen |
| Security questions | Igen | Nem | Igen |
