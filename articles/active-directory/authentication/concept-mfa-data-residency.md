...
|--------------------------------------|-----------------|
| OATH jogkivonat                           | Multi-Factor Authentication naplókban     |
...
| Eseménytípus                           | Adattár típusa |
|--------------------------------------|-----------------|
| OATH jogkivonat                           | Multi-Factor Authentication naplókban<br />Multi-Factor Authentication tevékenység jelentés adattár |
