...
| Number of methods required to reset | One | Kettő |
| :---: | :---: | :---: |
| Mobile app features available | Kód | Code or Notification |
...
| Number of methods registered | Number of methods required | Eredmény |
| :---: | :---: | :---: |
