...
| 6329 | MMS (3040): admaexport. cpp (2837): a kiszolgáló nem tartalmazza az LDAP-jelszó házirendjének vezérlőjét. | Ez a probléma akkor fordul elő, ha a LDAP_SERVER_POLICY_HINTS_OID-vezérlő (1.2.840.113556.1.4.2066) nincs engedélyezve a tartományvezérlőn. A jelszó-visszaírási funkció használatához engedélyeznie kell a vezérlőt. Ehhez a tartományvezérlőknek Windows Server 2008R2 vagy újabb rendszeren kell lenniük. |
...
1. Jelentkezzen be a Azure AD Connect-kiszolgálóra, és indítsa el a **synchronization Service Manager** a **Start** > **synchronization Service**-t választva.
1. Az **Összekötők** lapon válassza ki a helyszíni **Active Directory tartományi szolgáltatások** -összekötőt, majd válassza a **Tulajdonságok**lehetőséget.  
   ![Synchronization Service Manager a tulajdonságok szerkesztését bemutató](./media/active-directory-passwords-troubleshoot/checkpermission01.png)  
...
* **Felhasználói azonosító**: ki volt a felhasználó, aki látta a hibát? Ilyen például a *felhasználó\@contoso.com*.
