...
| Minden Microsoft 365 csomag | Az Azure Multi-Factor Authentication [felhasználónkénti alapon engedélyezhető](howto-mfa-userstates.md), illetve engedélyezhető vagy letiltható az összes felhasználó számára a [biztonsági alapértékek](../fundamentals/concept-fundamentals-security-defaults.md)használatával. Az Azure Multi-Factor Authentication felügyelete a Microsoft 365 portálon keresztül történik. A jobb felhasználói élmény érdekében frissítsen prémium szintű Azure AD P1-re vagy P2-re, és használja a feltételes hozzáférést. További információ: [biztonságos Microsoft 365 erőforrások a többtényezős hitelesítéssel](/microsoft-365/admin/security-and-compliance/set-up-multi-factor-authentication). |
