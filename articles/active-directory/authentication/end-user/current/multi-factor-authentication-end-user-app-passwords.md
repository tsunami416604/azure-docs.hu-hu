...
- Próbálja ki a [Microsoft Authenticator alkalmazás](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) ellenőrzése a bejelentkezéseket app értesítések szövegek vagy hívások fogadása helyett.
