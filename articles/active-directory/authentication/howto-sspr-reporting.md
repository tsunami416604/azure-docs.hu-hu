---
title: Az önkiszolgáló jelszó-átállítási jelentések – Azure Active Directoryban
...
A következő kérdéseket vet is, amely szerepel az [Azure-portálon] (a jelentések általhttps://portal.azure.com/):
...
[Reporting]: ./media/howto-sspr-reporting/sspr-reporting.png "Az Azure AD naplózza az önkiszolgáló jelszó-Változtatási tevékenység naplózási – példa"
