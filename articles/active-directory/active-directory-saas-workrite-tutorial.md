...
本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合 Workrite。<br>與 Azure AD 整合 Workrite 可以提供下列優點: 
...
若要讓單一登入運作，Azure AD 必須知道 Workrite 與 Azure AD 中互相對應的使用者。 換句話說，必須在 Azure AD 使用者和 Workrite 中的相關使用者之間建立連結關聯性。<br>
藉由指定的值建立此連結關聯性 **使用者名稱** 在 Azure AD 中的值為 **Username** Workrite 中。
...
4. **[建立測試使用者 Workrite](#creating-a-halogen-software-test-user)** -若要連結到她在 Azure AD 代表 Workrite 中有對應的 Britta Simon。
...
<br><br>![指派給使用者][402]<br>
    ...
    a. 型別 **電子郵件**, 、 **名字** 和 **姓氏** 的有效 azure AD 使用者想要佈建。
