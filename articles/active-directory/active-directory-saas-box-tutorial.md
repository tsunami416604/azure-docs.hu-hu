...
6.  在 **搜尋方塊**, ，型別 **方塊**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-box-tutorial/IC701023.png "Application gallery")

7.  在 [結果] 窗格中，選取 **方塊**, ，然後按一下 [ **完成** 加入應用程式。
...
本節的目的是概述如何依據 SAML 通訊協定來使用同盟，讓使用者能夠以自己的 Azure AD 帳戶在 Box 中進行驗證。 <br>
...
2. 在 * * 方塊 * * 應用程式整合頁面上，按一下 [ **指派使用者**。 <br><br> ![指派使用者](./media/active-directory-saas-box-tutorial/IC769552.png "Assign users")

3.  選取測試使用者，請按一下 **指派**, ，然後按一下 [ **是** 以確認您的作業。 <br><br> ![[是]](./media/active-directory-saas-box-tutorial/IC767830.png "Yes")
...
在 Box 租用戶，同步處理的使用者都會在 **受管理的使用者** 中 **系統管理員主控台**。
