...
7. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **társított bejelentkezés**. az alkalmazás csatolásához **ADP összevont egyszeri Bejelentkezéses**.
