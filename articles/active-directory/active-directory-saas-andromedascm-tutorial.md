...
4. Írja be a keresőmezőbe, **Andromeda**, jelölje be **Andromeda** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Andromeda](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_addfromgallery.png)
...
3. Az a **Andromeda tartomány és az URL-címek** területen tegye a következőket, ha szeretne beállítani az alkalmazás **IDP** kezdeményezett mód:
    ...
    ![Az egyszeri bejelentkezés információk Andromeda tartomány és az URL-címek](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_url.png)
...
4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:
    ...
    ![Az egyszeri bejelentkezés információk Andromeda tartomány és az URL-címek](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_url1.png)
...
9. A a **Andromeda konfigurációs** kattintson **konfigurálása Andromeda** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML-alapú egyszeri bejelentkezési URL-címe** a a **rövid összefoglaló szakasz.**
    ...
    ![Andromeda konfiguráció](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_configure.png)
...
11. A menubar tetején kattintson **Admin** , és keresse meg **felügyeleti**.
    ...
    ![Andromeda rendszergazda](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_admin.png)
...
2. Az alkalmazások listában válassza ki a **Andromeda**.
    ...
    ![Az alkalmazások listáját a Andromeda hivatkozás](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_app.png)  
