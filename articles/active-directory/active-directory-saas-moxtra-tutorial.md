...
本教學課程的目標在於告訴您如何 Moxtra 整合 Azure Active Directory (Azure AD)。<br>整合 Moxtra 與 Azure AD 為您提供下列優點:
...
4. * *[建立 Moxtra 測試使用者](#creating-a-moxtra-test-user)* *-若要連結到她在 Azure AD 代表 Moxtra 中有對應的 Britta Simon。
...
1. 針對下表中的每個資料列，執行下列步驟：
   ...
   | idpid| *\<the **Entity ID** value from the **Configure single sign-on at Moxtra** dialog in the Azure portal \>*|
    ...
    a.按一下 [新增使用者屬性 <br><br>![設定單一登入](./media/active-directory-saas-moxtra-tutorial/tutorial_general_81.png) <br>

    b.在 **加入使用者屬性** ] 對話方塊中，輸入屬性名稱以及該資料表中的資料列所顯示的屬性值。<br><br>![設定單一登入](./media/active-directory-saas-moxtra-tutorial/tutorial_general_82.png) <br>
