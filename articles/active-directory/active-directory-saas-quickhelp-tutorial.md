...
本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合 QuickHelp。<br>整合 QuickHelp 與 Azure AD 為您提供下列優點:
...
4. * *[建立 QuickHelp 測試使用者](#creating-a-quickhelp-test-user)* *-若要連結到她在 Azure AD 代表 QuickHelp 中有對應的 Britta Simon。
