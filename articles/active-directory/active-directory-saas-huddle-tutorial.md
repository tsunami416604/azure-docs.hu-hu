<properties 
    ...
    description="了解如何使用 Azure Active Directory 中的 Huddle，來啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在**搜尋方塊**中，輸入 **Huddle**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-huddle-tutorial/IC787831.png "Application Gallery")
...
2.  在 **{1>huddle<1} * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
