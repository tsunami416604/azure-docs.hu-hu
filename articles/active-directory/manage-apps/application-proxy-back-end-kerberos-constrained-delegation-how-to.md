...
-   Üzembe helyezés az Azure AD-alkalmazásproxy kiszolgálónként [alkalmazásproxy – első lépések](application-proxy-enable.md) és általános alkalmazás-hozzáférési nem KCD a várt módon működik.
