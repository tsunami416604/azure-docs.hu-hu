...
7. Egyszerű szolgáltatás létrehozásakor az [Azure ad PowerShell-modul](/powershell/azure/active-directory/install-adv2?view=azureadps-2.0) használatával
