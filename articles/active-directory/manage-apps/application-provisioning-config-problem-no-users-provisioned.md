...
- **Egy hatókör-szűrő konfigurálva** **van, amely egy attribútumérték alapján szűri ki a felhasználót**. A szűrők hatókörével kapcsolatos további információkért lásd: [hatóköri szűrők](define-conditional-rules-for-provisioning-user-accounts.md).
