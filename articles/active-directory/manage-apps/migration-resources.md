...
| [Eszköz: Az Active Directory összevonási szolgáltatások áttelepítési készültségi parancsfájl](https://aka.ms/migrateapps/adfsscript) | Ez a parancsfájl futtatása meghatározni a migrálás az Azure AD-alkalmazások készen áll-e a helyszíni Active Directory összevonási szolgáltatások (AD FS) kiszolgálón.|
