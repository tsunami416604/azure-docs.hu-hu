...
| A vállalati alkalmazás jelenleg nem érhető el. Próbálkozzon újra később... Az összekötő túllépte az időkorlátot. | A felhasználók lehet, hogy ez a hibaüzenet az alkalmazást, ha azok nem megfelelően definiálja az alkalmazás a helyi oldalán közzétett elérésére tett kísérlet során. Győződjön meg arról, hogy a felhasználók rendelkeznek-e a megfelelő engedélyekkel, meghatározottak szerint a helyi gépen a háttéralkalmazás. |
