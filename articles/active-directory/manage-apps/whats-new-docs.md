...
### <a name="updated-articles"></a>Frissített cikkek
- [Gyors útmutató: alkalmazás hozzáadása a Azure Active Directory (Azure AD) bérlőhöz](add-application-portal.md)
...
### <a name="new-articles"></a>Új cikkek
- [Egyszeri bejelentkezési lehetőségek az Azure AD-ben](sso-options.md)
...
- [Megteheti a műveletet a Azure Active Directory](manage-application-permissions.md)
...
- [Rögzített hivatkozások átirányítása az Azure AD Application Proxy közzétett alkalmazásokhoz](application-proxy-configure-hard-coded-link-translation.md)
...
- [Gyors útmutató: alkalmazás tulajdonságainak konfigurálása a Azure Active Directory (Azure AD) bérlőben](add-application-portal-configure.md)
- [Rövid útmutató: egyszeri bejelentkezés (SSO) beállítása egy alkalmazáshoz a Azure Active Directory (Azure AD) bérlőben](add-application-portal-setup-sso.md)
- [Gyors útmutató: alkalmazások megtekintése a Azure Active Directory (Azure AD) Bérlővel az Identitáskezelés kezeléséhez](view-applications-portal.md)
- [Gyors útmutató: alkalmazás hozzáadása a Azure Active Directory (Azure AD) bérlőhöz](add-application-portal.md)
