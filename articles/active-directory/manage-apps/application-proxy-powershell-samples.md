...
| [A tanúsítvány feltöltése nélkül közzétett összes Azure AD-alkalmazásproxy letöltése](scripts/powershell-get-all-custom-domain-no-cert.md) | Felsorolja az összes olyan alkalmazásproxy-alkalmazást, amely egyéni tartományokat használ, de nincs feltöltve érvényes SSL-tanúsítvány. |
