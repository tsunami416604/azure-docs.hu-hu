...
|---|---|
| [Új – AzureADUserAppRoleAssignment](https://docs.microsoft.com/powershell/module/AzureAD/new-azureaduserapproleassignment?view=azureadps-2.0) | Felhasználó társítása egy alkalmazás-szerepkörhöz. |
