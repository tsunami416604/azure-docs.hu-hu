...
description: PowerShell-példa, amely felsorolja az összes Azure Active Directory (Azure AD) alkalmazásproxy-alkalmazások, amelyek helyettesítő karaktereket használó.
...
---
# <a name="get-all-application-proxy-apps-using-wildcard-publishing"></a>Az összes alkalmazásproxy-alkalmazás beszereznihelyettesítő közzététellel

Ez a PowerShell-parancsfájl-példa felsorolja az összes Azure Active Directory (Azure AD) alkalmazásproxy-alkalmazást, amely helyettesítő karakteres közzétételt használ.
