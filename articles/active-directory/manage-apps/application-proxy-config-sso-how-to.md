...
Az egyszeri bejelentkezés konfigurálásához először ellenőrizze, hogy az alkalmazás konfigurálva van-e az előhitelesítéshez Azure Active Directoryon keresztül. Ehhez a konfigurációhoz nyissa meg a **Azure Active Directory** -&gt; **vállalati alkalmazások** -&gt; **minden alkalmazás** -&gt; az alkalmazás- **&gt; alkalmazásproxy**. Ezen az oldalon látható az "előzetes hitelesítés" mező, és győződjön meg arról, hogy a "Azure Active Directory. 
