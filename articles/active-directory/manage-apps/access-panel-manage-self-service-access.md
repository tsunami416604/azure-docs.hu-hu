...
ms.locfileid: "88641789"
---
# <a name="how-to-use-self-service-application-access"></a>Önkiszolgáló alkalmazás-hozzáférés használata

Mielőtt a felhasználók saját maguk is felfedezhetik alkalmazásaikat az alkalmazásokból, engedélyeznie kell az **önkiszolgáló alkalmazásokhoz való hozzáférést** minden olyan alkalmazáshoz, amely számára engedélyezni szeretné a felhasználók számára az önfelderítést és a hozzáférés kérését.
