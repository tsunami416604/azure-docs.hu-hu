...
Az Azure AD-re történő átállással költségeket takarít meg és megszabadul a helyszíni infrastruktúra kezelésével járó gondoktól. Az Azure AD önkiszolgáló hozzáférést is nyújt az alkalmazásokhoz, amivel a rendszergazdák és felhasználók számára is időt takarít meg. Az egyszeri bejelentkezés megszünteti az alkalmazáshoz tartozó jelszavakat, ami költségmegtakarítást jelent, ha az alkalmazásokban a jelszó visszaállításokra és az elfelejtett jelszavak visszaállítása közbeni termelékenység kiesésre gondolunk.
