...
- Engedélyezheti a felhasználóknak, hogy automatikusan beolvasása bejelentkezett Vodeclic (egyszeri bejelentkezés) számára a saját Azure AD-fiókok.
...
- Egy Vodeclic egyszeri bejelentkezés engedélyezve van az előfizetésben
...
## <a name="adding-vodeclic-from-the-gallery"></a>A gyűjteményből Vodeclic hozzáadása
...
**A gyűjteményből Vodeclic hozzáadásához hajtsa végre az alábbi lépéseket:**
...
4. Írja be a keresőmezőbe, **Vodeclic**, jelölje be **Vodeclic** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
Ebben a szakaszban, konfigurálás és tesztelés az Azure AD egyszeri bejelentkezéshez "Britta Simon" nevű tesztfelhasználó alapján Vodeclic.

Az egyszeri bejelentkezés működéséhez az Azure AD meg kell tudja, hogy mi a párjukhoz felhasználó Vodeclic a felhasználó Azure AD-ben. Ez azt jelenti az Azure AD-felhasználó és a kapcsolódó felhasználó a Vodeclic közötti kapcsolat kapcsolatot kell létrehozni.

Vodeclic, rendelje hozzá a értékének a **felhasználónév** értékeként Azure AD-ben a **felhasználónév** a hivatkozás kapcsolat létrehozására.

Az Azure AD egyszeri bejelentkezést a Vodeclic tesztelése és konfigurálása, hogy végezze el a következő építőelemeket kell:
...
**Konfigurálása az Azure AD az egyszeri bejelentkezés Vodeclic, hajtsa végre az alábbi lépéseket:**

1. Az Azure portálon a a **Vodeclic** alkalmazás integráció lapján, kattintson a **egyszeri bejelentkezés**.
...
3. Az a **Vodeclic tartomány és az URL-címek** szakaszban, ha szeretne beállítani az alkalmazás által kezdeményezett IDP módban, hajtsa végre az alábbi lépéseket:
    ...
    a. Az a **azonosító** szövegmező, adja meg a következő minta használatával URL-címe:`https://<companyname>.lms.vodeclic.net/auth/saml`

    b. Az a **válasz URL-CÍMEN** szövegmező, adja meg a következő minta használatával URL-címe:`https://<companyname>.lms.vodeclic.net/auth/saml/callback`
...
4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:
    ...
    Az a **bejelentkezési URL-cím** szövegmező, adja meg a következő minta használatával URL-címe:`https://<companyname>.lms.vodeclic.net/auth/saml`
     
    > [!NOTE] 
    > Ezek az értékek nincsenek valós. Frissítheti ezeket az értékeket a tényleges azonosítója, válasz URL-CÍMEN és bejelentkezési URL-cím. Ügyfél [Vodeclic ügyfél-támogatási csoport](mailto:hotline@vodeclic.com) beolvasni ezeket az értékeket.
...
7. Egyszeri bejelentkezés konfigurálása **Vodeclic** oldalon kell küldeniük a letöltött **metaadatainak XML-kódja** való [Vodeclic támogatási csoport](mailto:hotline@vodeclic.com). Akkor állítsa be ezt a beállítást, hogy a SAML SSO kapcsolat mindkét oldalán megfelelően beállítva.
...
Ebben a szakaszban egy Vodeclic Britta Simon nevű felhasználót hoz létre. Együttműködve [Vodeclic támogatási csoport](mailto:hotline@vodeclic.com) a felhasználók hozzáadása a Vodeclic platform. Felhasználók kell létrehoznia és aktiválni az egyszeri bejelentkezés használata előtt.

> [!NOTE]
> Szükség lehet az beszerzése a gép szerepel az engedélyezési listán alkalmazás követelményeinek megfelelően, és az, hogy szeretne-e megosztása a nyilvános IP-címet a [Vodeclic támogatási csoport](mailto:hotline@vodeclic.com).
...
**Britta Simon hozzárendelése Vodeclic, hajtsa végre az alábbi lépéseket:**
...
Ha a hozzáférési panelen Vodeclic csempére kattint, akkor kell beolvasása automatikusan bejelentkezett az Vodeclic alkalmazására.
