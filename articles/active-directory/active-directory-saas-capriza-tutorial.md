...
本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合 Capriza。<br>整合 Capriza 與 Azure AD 為您提供下列優點:
...
4. * *[建立 Capriza 測試使用者](#creating-a-capriza-test-user)* *-若要連結到她在 Azure AD 代表 Capriza 中有對應的 Britta Simon。
...
本節的目標是要在 Capriza 中建立名為 Britta Simon 的使用者。 Capriza 支援預設啟用的 Just-In-Time 佈建。 * * 請請確定您的網域名稱與 Capriza 設定的使用者佈建。 將之後，只有在 just-in-time 佈建使用者 work.* *
