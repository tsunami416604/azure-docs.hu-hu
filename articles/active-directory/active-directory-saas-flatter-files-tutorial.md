<properties
    pageTitle="教學課程: Azure Active Directory 整合的呈現檔案 |Microsoft Azure"
    description="了解如何設定單一登入 Azure Active Directory 之間呈現的檔案。"
...
# 教學課程: Azure Active Directory 整合，以呈現的檔案

本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合呈現的檔案。<br>與 Azure AD 整合呈現檔案會將您提供下列優點:

- 您可以在 Azure AD 中呈現的檔案具有存取控制
- 您可以啟用您自動登入 (Single Sign-on) 呈現檔案的使用者使用其 Azure AD 帳戶
...
若要呈現的檔案與設定 Azure AD 整合，您需要下列項目:
...
若要設定呈現的檔案中整合 Azure AD，您需要將呈現的檔案從資源庫新增至您的受管理 SaaS 應用程式清單。

**若要新增組件庫更平面的檔案，請執行下列步驟:**
...
本節的目標在於告訴您如何設定和測試 Azure AD 單一登入與呈現名為"Britta Simon"的測試使用者為基礎的檔案。

單一登入工作，Azure AD 必須知道使用者在 Azure AD 中互相對應的使用者呈現的檔案中。換句話說，必須建立 Azure AD 使用者和呈現的檔案中的相關的使用者之間的連結關聯性。<br>
藉由指定的值建立此連結關聯性 **使用者名稱** 在 Azure AD 中的值為 **Username** 中呈現的檔案。

若要設定並測試 Azure AD 單一登入與呈現的檔案，您必須完成下列建置組塊:
...
**若要呈現的檔案與設定 Azure AD 單一登入，請執行下列步驟:**
...
本節目標是建立在呈現的檔案中名為 Britta Simon 的使用者。

**若要建立名為 Britta Simon 呈現的檔案中的使用者，請執行下列步驟:**
...
**若要指派 Britta Simon 呈現的檔案，請執行下列步驟:**
...
當您按一下存取面板中的呈現檔案並排顯示時，您應該取得自動登入應用程式呈現的檔案。
