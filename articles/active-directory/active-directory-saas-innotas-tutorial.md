<properties 
    ...
    description="了解如何使用 Azure Active Directory 中的 Innotas，來啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在搜尋方塊****中，輸入 **Innotas**。

    ![應用程式資源庫](./media/active-directory-saas-innotas-tutorial/IC777332.png "Application gallery")
...
2.  在 **Innotas * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
