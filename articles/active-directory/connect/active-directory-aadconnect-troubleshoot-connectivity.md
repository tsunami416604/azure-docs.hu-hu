...
Először győződjön meg arról, hogy kell [ **machine.config** ](active-directory-aadconnect-prerequisites.md#connectivity) megfelelően van konfigurálva.  
...
* Ha ezt a hibát látja, ellenőrizze a [machine.config](active-directory-aadconnect-prerequisites.md#connectivity) megfelelően van konfigurálva.
...
![Microsoft-Account szolgál.](./media/active-directory-aadconnect-troubleshoot-connectivity/unknownerror.png)
...
Ha a proxykiszolgáló megfelelően van konfigurálva, egy sikeres állapotnak kell kapnia: ![proxy200](./media/active-directory-aadconnect-troubleshoot-connectivity/invokewebrequest200.png)
...
Ha a proxy nem megfelelően van konfigurálva, hibaüzenetet kap: ![proxy200](./media/active-directory-aadconnect-troubleshoot-connectivity/invokewebrequest403.png)
...
A single-bejelentkezési segéd működjön a winhttp kell konfigurálni. Ez a konfiguráció végezheti [ **netsh**](active-directory-aadconnect-prerequisites.md#connectivity).  
...
* Ha ezt a hibát látja, tekintse meg a proxykiszolgáló-konfigurációt [netsh](active-directory-aadconnect-prerequisites.md#connectivity) és helyességének ellenőrzéséhez.
