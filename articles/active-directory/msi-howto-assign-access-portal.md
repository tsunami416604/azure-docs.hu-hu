...
Engedélyezését MSI a egy Azure-erőforrás, például egy [Azure virtuális gép](msi-qs-configure-portal-windows-vm.md) vagy [Azure VMSS](msi-qs-configure-portal-windows-vmss.md):
...
- Azure virtuális géphez engedélyezheti a MSI [konfigurálása az Azure virtuális gép felügyelt szolgáltatás identitásának (MSI) az Azure portál használatával](msi-qs-configure-portal-windows-vm.md).
