...
5.  將下載的中繼資料檔傳送給 Brightspace by Desire2Learn 支援小組。
    ...
    >[AZURE.NOTE] 您的 Brightspace by Desire2Learn 支援小組必須執行實際的 SSO 設定。
...
>[AZURE.NOTE] 您可以使用其他任何 Brightspace Desire2Learn 使用者帳戶建立工具或 Api 所提供 Brightspace by Desire2Learn 來佈建 Azure Active Directory 使用者帳戶。
