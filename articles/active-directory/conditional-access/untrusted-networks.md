---
title: A többtényezős hitelesítés (MFA) megkövetelése a nem megbízható hálózatokról való hozzáféréshez Azure Active Directory (Azure AD) feltételes hozzáféréssel | Microsoft Docs
