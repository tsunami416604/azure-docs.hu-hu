...
Az Azure Active Directory feltételes hozzáférés lehetővé teszi a felhőalapú alkalmazások az Intune alkalmazásvédelmi szabályzatait támogató ügyfélalkalmazások való hozzáférés korlátozásához. Például korlátozhatja hozzáférést az Exchange online-hoz az Outlook alkalmazást.
...
1. **Felhasználók és csoportok**: Minden egyes feltételes hozzáférési szabályzat rendelkeznie kell legalább egy kiválasztott felhasználó vagy csoport.
1. **Felhőalapú alkalmazások:** Felhőbeli alkalmazásokat, ki kell választania **Office 365 Exchange Online**.

   ![Feltételes hozzáférés](./media/app-based-conditional-access/07.png)

1. **Feltételek:** Mint **feltételek**, konfigurálnia kell **eszközplatformok** és **ügyfélalkalmazás**:
   1. Mint **eszközplatformok**válassza **Android** és **iOS**.

      ![Feltételes hozzáférés](./media/app-based-conditional-access/03.png)

   1. Mint **ügyfélalkalmazások (előzetes verzió)** válassza **mobilalkalmazások és asztali alkalmazások** és **Modern hitelesítési ügyfelek**.

      ![Feltételes hozzáférés](./media/app-based-conditional-access/91.png)

1. Mint **hozzáférés-vezérlés**, rendelkeznie kell **jóváhagyott ügyfélalkalmazás (előzetes verzió) megkövetelése** kiválasztott.
...
1. **Feltételek:** Mint **feltételek**, konfigurálnia kell **ügyfélalkalmazások (előzetes verzió)** . 
   1. Mint **ügyfélalkalmazások (előzetes verzió)** válassza **mobilalkalmazások és asztali ügyfelek** és **Exchange ActiveSync-ügyfelek**.
...
- Jelentkezzen be ugyanazokkal a hitelesítő adatokkal, mint az Outlook alkalmazás használt tett kísérletek
...
1. A **neve** a feltételes hozzáférési szabályzat.
1. **Felhasználók és csoportok**: Minden egyes feltételes hozzáférési szabályzat rendelkeznie kell legalább egy kiválasztott felhasználó vagy csoport.
1. **Felhőalapú alkalmazások:** Felhőbeli alkalmazásokat, ki kell választania **Office 365 Exchange Online** és **Office 365 SharePoint Online**. 
...
1. **Feltételek:** Mint **feltételek**, konfigurálnia kell **eszközplatformok** és **ügyfélalkalmazás**:
   ...
   1. Mint **ügyfélalkalmazások (előzetes verzió)** válassza **mobilalkalmazások és asztali ügyfelek** és **Modern hitelesítési ügyfelek**.
...
1. A **neve** a feltételes hozzáférési szabályzat.
1. **Felhasználók és csoportok**: Minden egyes feltételes hozzáférési szabályzat rendelkeznie kell legalább egy kiválasztott felhasználó vagy csoport.
1. **Felhőalapú alkalmazások:** Felhőbeli alkalmazásokat, ki kell választania **Office 365 Exchange Online**. Online 

   ![Feltételes hozzáférés](./media/app-based-conditional-access/07.png)

1. **Feltételek:** Mint **feltételek**, konfigurálnia kell **ügyfélalkalmazás**:
   1. Mint **ügyfélalkalmazások (előzetes verzió)** válassza **mobilalkalmazások és asztali ügyfelek** és **Exchange ActiveSync-ügyfelek**.
...
1. Mint **hozzáférés-vezérlés**, szüksége lesz kiválasztva a következőket:
