...
- Az a **második** fázis, kéri a még nem teljesített követelmények teljesítéséhez. A szabályzatok közül bármelyik letiltja a hozzáférést, ha, letiltott és nem kéri a más szabályzati vezérlőket kielégítéséhez. A szabályzatokkal letiltható akkor, ha más házirend szabályozza, a következő sorrendben kielégítéséhez kéri:

   ![Rendelés](./media/best-practices/06.png)
    
   Külső MFA-szolgáltatók és a használati feltételeket tartalmazó fájl jár a Tovább gombra.
...
Igen, használhatja az Exchange ActiveSync feltételes hozzáférési szabályzat egyes [korlátozások](block-legacy-authentication.md). 
...
1. Ha kibontja a házirend több felhasználónak bele. Továbbra is minden rendszergazda kizárása a házirendet, győződjön meg arról, hogy azok továbbra is rendelkezik hozzáféréssel, és frissítheti egy szabályzatot, ha szükség egy az megváltoztatására.
1. A szabályzat minden felhasználóra vonatkozni csak szükség esetén. 
