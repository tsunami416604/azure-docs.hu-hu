<properties 
    ...
    description="了解如何使用 Azure Active Directory 中的 Concur，來啟用單一登入、 自動化佈建和更多功能!" 
...
5.  在**搜尋方塊**中，輸入 **Concur**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-concur-tutorial/IC721727.png "Application Gallery")
...
1.  在 Azure AD 入口網站上 **Concur * * 應用程式整合頁面上，按一下 [* * 設定單一登入** 開啟 ** 設定單一登入 ** ] 對話方塊。
...
2.  在 **Concur * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
