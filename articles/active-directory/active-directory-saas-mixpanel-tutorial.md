...
本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合 Mixpanel。<br>整合 Mixpanel 與 Azure AD 為您提供下列優點:
...
![應用程式][4]<br>
6. 在 [搜尋] 方塊中，輸入 **Mixpanel**。<br><br>
![建立 Azure AD 測試使用者](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_01.png)<br>
7. 在 [結果] 窗格中，選取 **Mixpanel**, ，然後按一下 [ **完成** 加入應用程式。
<br><br>
...
若要讓單一登入運作，Azure AD 必須知道 Mixpanel 與 Azure AD 中互相對應的使用者。換句話說，必須建立 Azure AD 使用者和 Mixpanel 中的相關的使用者之間的連結關聯性。<br>
...
4. * *[建立 Mixpanel 測試使用者](#creating-a-mixpanel-test-user)* *-若要連結到她在 Azure AD 代表 Mixpanel 中有對應的 Britta Simon。
...
1. 在 Azure 傳統入口網站上 **Mixpanel** 應用程式整合頁面上，按一下 [ **設定單一登入** 開啟 **設定單一登入**  ] 對話方塊。
<br><br> ![設定單一登入][6] <br>

2. 在 **您希望使用者如何登入 Mixpanel** 頁面上，選取 **Azure AD 單一登入**, ，然後按一下 [ **下一步**。
<br><br> ![設定單一登入](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_03.png) <br>

3. 在 [設定 App 設定]**** 對話方塊頁面執行下列步驟：
<br><br>![設定單一登入](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_04.png) <br>

    a. 在 [登入 URL]**** 文字方塊中，使用以下模式輸入您的使用者用來登入 Mixpanel 應用程式的 URL：**“https://mixpanel.com/login/”**。
    > [AZURE.NOTE] 請註冊 [https://mixpanel.com/register/](https://mixpanel.com/register/) 來設定您的登入認證及連絡人 [Mixpanel 支援小組](mailto:support@Mixpanel.com) 來為您租用戶啟用 SSO 設定。<br>您也可以取得您的登入 URL 值如有必要向 Mixpanel 支援小組。

    b. 按 [下一步]****。

4. 在 **Mixpanel 在設定單一登入** 頁面上，執行下列步驟:
<br><br>![設定單一登入](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_05.png) <br>
...
6. 在頁面底部，按一下 [的小 **齒輪** 左上角的圖示。 
   <br><br>![Mixpanel 單一登入](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_06.png) <br>

7. 按一下 [ **存取安全性** 索引標籤，然後再按一下 **變更設定**。
   <br><br>![Mixpanel 設定](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_08.png) <br>

8. 在 **變更您的憑證** 對話方塊頁面上，按一下 [ **選擇檔案** 來上傳您下載的憑證，然後按一下 **下一步**。
  <br><br>![Mixpanel 設定](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_09.png) <br>

9. 在 Azure 傳統入口網站上 **Mixpanel 在設定單一登入** 對話方塊頁面中，複製 **單一登入服務 URL** 值，請將它貼到 [驗證 URL] 文字方塊中，在 **變更驗證 URL** 對話方塊頁面上，然後再按一下 **下一步**。
...
<br><br>![建立 Azure AD 測試使用者](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_09.png) <br>

2. 從 [目錄]**** 清單中，選取要啟用目錄整合的目錄。

3. 若要顯示在上方功能表中的使用者，清單中，按一下 [ **使用者**。
<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_03.png) <br>

4. 若要開啟 **新增使用者** ] 對話方塊的底部工具列上，按一下 [ **新增使用者**。
<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_04.png) <br>

5. 在 **告訴我們這位使用者** 對話方塊頁面上，執行下列步驟:
<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_05.png) <br>
...
<br><br>![建立 Azure AD 測試使用者](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_06.png) <br>
...
<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_07.png) <br>

8. 在 **取得暫時密碼** 對話方塊頁面上，執行下列步驟:
<br><br>![建立 Azure AD 測試使用者](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_08.png) <br>
...
4. 在 **小組成員** 文字方塊中，在 Azure 中輸入 Britta 的電子郵件地址。
...
本節目標是讓 Britta Simon，授予其存取權 Mixpanel 使用 Azure 單一登入。
<br><br>![將使用者指派][200] <br>
...
<br><br>![設定單一登入](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_50.png) <br>
