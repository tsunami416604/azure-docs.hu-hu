---
title: Regisztráció a saját jelszavának alaphelyzetbe állításához – Azure AD
description: Regisztrálja hitelesítési adatait az Azure AD önkiszolgáló jelszó-visszaállításhoz, így rendszergazdai segítség nélkül állíthatja vissza saját jelszavát.
...
ms.locfileid: "73820449"
---
# <a name="register-to-reset-your-own-password"></a>Regisztráció a saját jelszavának alaphelyzetbe állításához
...
Végfelhasználóként visszaállíthatja a jelszavát, vagy saját maga oldhatja fel a fiókját, ha Azure Active Directory (Azure AD) önkiszolgáló jelszó-visszaállítást (SSPR) használ. A funkció használata előtt regisztrálnia kell a hitelesítési módszereit, vagy meg kell erősítenie a rendszergazda által feltöltött előre definiált hitelesítési módszereket.
...
4. Adja meg és ellenőrizze a rendszergazda által igényelt adatokat. Ha több lehetőség is rendelkezésre áll, javasoljuk, hogy több metódust regisztráljon. Ez rugalmasságot biztosít, ha az egyik metódus nem érhető el. Ilyen például az, amikor utazik, és nem fér hozzá az irodai telefonhoz.
    ...
    ![Hitelesítési módszerek regisztrálása és a Befejezés kiválasztása][Register]
...
Előfordulhat, hogy a rendszergazdáknak egy adott idő elteltével meg kell erősíteniük a hitelesítési módszereket annak érdekében, hogy továbbra is a megfelelő módszerek legyenek regisztrálva.
