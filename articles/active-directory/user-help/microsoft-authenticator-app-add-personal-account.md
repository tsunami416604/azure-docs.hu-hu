...
2. Alsó részén a **biztonsággal kapcsolatos alapok** lappján válassza a **további biztonsági beállítások** hivatkozásra.
    ...
    ![Biztonsági alapvető beállítások lapról a "további biztonsági beállítások" hivatkozás kiemelésével](./media/microsoft-authenticator-app-add-personal-account/more-security-options-link.png)
...
2. Válassza ki **fiók hozzáadása** származó a **testreszabása és vezérlési** a jobb felső sarokban lévő ikonra.
    ...
    ![Fiókok oldala, amelyen a Testreszabás és ellenőrzési ikonja kiemelve](./media/microsoft-authenticator-app-add-personal-account/customize-and-control-icon.png)
