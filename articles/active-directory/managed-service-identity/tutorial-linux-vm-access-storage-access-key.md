...
Ez az oktatóanyag bemutatja, hogyan kérheti le a tárfiókok hozzáférési kulcsait egy linuxos virtuális gép (VM) a rendszer által hozzárendelt identitásának használatával. A tárelérési kulcsokat a szokásos módon használhatja a tárolási műveletek során, például a Storage SDK használata esetén. Ebben az oktatóanyagban blobokat töltünk fel és le az Azure CLI használatával. Az alábbiakat fogja elsajátítani:
