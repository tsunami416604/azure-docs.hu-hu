...
Egy Azure-erőforrás a MSI bekapcsolását követően [például egy Azure virtuális gép](qs-configure-powershell-windows-vm.md):
...
- Egy Azure virtuális gépen az MSI engedélyezéséről [konfigurálása az Azure virtuális gép felügyelt szolgáltatás Identity (MSI) PowerShell használatával](qs-configure-powershell-windows-vm.md).
