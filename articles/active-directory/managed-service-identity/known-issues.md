...
![Az Azure-erőforrások automation-szkript felügyelt identitások exportálási hiba](../managed-service-identity/media/msi-known-issues/automation-script-export-error.png)
