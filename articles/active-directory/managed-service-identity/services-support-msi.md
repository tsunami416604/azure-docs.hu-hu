...
| Azure API Management | Előzetes verzió | Nem érhető el | [Azure Resource Manager-sablon](/azure/api-management/api-management-howto-use-managed-service-identity) | 
