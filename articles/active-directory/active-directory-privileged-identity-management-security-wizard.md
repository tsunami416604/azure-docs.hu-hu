...
* Ha szeretne hozzáadni vagy felhasználók eltávolítása a szerepkörök vagy-hozzárendelések módosítása az állandó jogosulttá, további információk: [hozzáadása vagy egy felhasználói szerepkör eltávolítása](active-directory-privileged-identity-management-how-to-add-role-to-user.md).
* Ha szeretné a PIM kezelése hozzáférést biztosít a több felhasználó, további információk: [a PIM kezelése hozzáférés biztosítása](active-directory-privileged-identity-management-how-to-give-access-to-pim.md).
