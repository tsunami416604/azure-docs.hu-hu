...
- [整合現有的應用程式](active-directory-sso-integrate-existing-apps.md)
- [使用 Azure AD 應用程式 Proxy 發行新的應用程式](active-directory-application-proxy-configure.md)
- [使用 Azure 應用程式庫中的應用程式](active-directory-appssoaccess-whatis.md/#get-started-with-the-azure-ad-application-gallery.md)
...
- [使用 Azure AD 應用程式管理的存取](active-directory-managing-access-to-apps.md)
- [使用 Azure AD 連接器將自動化](active-directory-saas-app-provisioning.md)
