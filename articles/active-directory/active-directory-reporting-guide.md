...
# Azure Active Directory 報告指南
 ...
 - [Azure Active Directory Reporting 預覽](active-directory-reporting-previews.md)
 ...
 - [Azure Active Directory 報告的延遲](active-directory-reporting-latencies.md)
 - [Azure Active Directory 報告 「 未知的動作項目 」 事件](active-directory-reporting-unknown-actor.md)
 - [Azure Active Directory 所有使用者登入活動都報告](active-directory-reporting-all-user-sign-in-activity-report.md)
