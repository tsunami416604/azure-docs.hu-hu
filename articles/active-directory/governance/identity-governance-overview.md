---
title: Identitáskezelést – az Azure Active Directory |} A Microsoft Docs
...
Identitáskezelést lehetővé teheti a szervezet alkalmazottai, üzleti partnerek és szállítók, és a szolgáltatások és alkalmazások között a következő feladatokat végezheti el:
...
![Identitás-életciklus](./media/identity-governance-overview/identity-lifecycle.png)
...
![Access-életciklus](./media/identity-governance-overview/access-lifecycle.png)
...
Nem áll fenn tökéletes megoldás vagy javaslat, minden ügyfél számára, míg a következő konfigurációk egy útmutató, amellyel a referenciakonfiguráció szabályzatok a Microsoft azt javasolja, hogy kövesse egy több biztonságosan és hatékonyan munkaerő biztosításához adja meg.
...
Az első lépéseket ismertető lapján is megtekinthet **Identitáskezelést** használatához tagjogosultság-kezelés az Azure Portalon, hozzáférési felülvizsgálatok, a Privileged Identity Management és a használati feltételeket tartalmazó fájl.

![Első lépések Identitáskezelést](./media/identity-governance-overview/getting-started.png)
