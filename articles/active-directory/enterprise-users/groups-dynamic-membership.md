...
- [Operátor prioritásának](#operator-precedence) beállítása
- [Összetett kifejezésekkel rendelkező szabályok](#rules-with-complex-expressions); például: `(user.proxyAddresses -any (_ -contains "contoso"))`
