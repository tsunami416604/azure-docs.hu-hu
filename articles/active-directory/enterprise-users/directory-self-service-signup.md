...
A beállítás részleteit a Get-MsolCompanyInformation következő PowerShell-parancsmaggal kérheti le. További részletekért lásd: [Get-MsolCompanyInformation](/powershell/module/msonline/get-msolcompanyinformation?view=azureadps-1.0).
