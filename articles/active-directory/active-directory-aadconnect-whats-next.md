...
4. 在 [目錄] 頁面頂端，選取 **授權**。
5. 在 [授權] 頁面中，選取 Active Directory Premium 或 Enterprise Mobility Suite，，然後按一下 [ **指派**。
...
## 啟動已排程的同步處理工作
如果您需要執行同步處理工作，可以再次執行「Azure AD Connect 精靈」。  您需要提供 Azure AD 認證。  在精靈中，選取 **自訂同步處理選項** 工作，並透過精靈中按 [下一步。 在結束時，請確認 **完成初始設定時，立即開始同步處理程序** 核取方塊。
