...
* [Licencek hozzárendelése egy csoporthoz az Azure Active Directory](users-groups-roles/licensing-groups-assign.md)
* [Az Azure Active Directory csoport kapcsolatos problémák észleléséhez és a](users-groups-roles/licensing-groups-resolve-problems.md)
* [Hogyan kell egyéni licenccel rendelkező felhasználók migrálása Csoportalapú licencelésre, az Azure Active Directoryban](users-groups-roles/licensing-groups-migrate-users.md)
* [Csoportalapú licencelés további forgatókönyvek az Azure Active Directory](users-groups-roles/licensing-group-advanced.md)
