...
6.  在 [搜尋方塊]**** 中，輸入 **thoughtworks mingle**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-thoughtworks-mingle-tutorial/IC785151.png "Application Gallery")
...
1.  在 Azure AD 入口網站上 **Thoughtworks Mingle * * 應用程式整合頁面上，按一下 [* * 設定單一登入** 開啟 ** 設定單一登入 ** ] 對話方塊。
