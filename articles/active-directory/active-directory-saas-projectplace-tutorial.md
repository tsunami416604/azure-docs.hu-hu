...
6.  在搜尋方塊****中，輸入 **Projectplace**。

    ![應用程式資源庫](./media/active-directory-saas-projectplace-tutorial/IC790218.png "Application Gallery")
...
4.  在 **設定單一登入在 Projectplace** 頁面上，按一下 **下載中繼資料**, ，然後儲存您的電腦上的中繼資料檔案。
...
5.  將中繼資料檔傳送給 Projectplace 支援小組。
    >[AZURE.NOTE] 單一登入設定必須由 Projectplace 支援小組執行。 組態完成後，您將會收到通知。
...
2.  在 **Projectplace * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
