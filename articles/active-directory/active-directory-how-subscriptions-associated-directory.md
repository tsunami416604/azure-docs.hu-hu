<properties
    pageTitle="Hogyan kapcsolódnak az Azure-előfizetések az Azure Active Directoryhoz? | Microsoft Azure"
...
## Fiókok, amelyekkel bejelentkezhet
...
> [AZURE.NOTE]
> A klasszikus Azure portálra történő bejelentkezéshez az msmith@hotmail.com fióknak előfizetésre van szüksége az Azure-hoz. A fióknak a szolgáltatás rendszergazdájának vagy az előfizetés társadminisztrátorának kell lennie.
...
## Az Azure-előfizetések és az Azure AD kapcsolata
...
## Előfizetés vagy címtár kezelése
...
## Miért nem tudok kezelni egy címtárat a jelenlegi felhasználói fiókommal?
...
## A munkahelyi vagy iskolai fiók használata Microsoft-fiókkal létrehozott Azure-előfizetés kezeléséhez
...
## Bejelentkezés, ha a munkahelyi fiókját használta a Microsoft-fiókhoz
...
### Nincs előfizetésem az Azure-hoz
...
### Van előfizetésem az Azure-hoz a Microsoft-fiókomon keresztül
