...
6.  在**搜尋方塊**中，輸入 **Aha!**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-aha-tutorial/IC798945.png "Application Gallery")
...
3.  在 **設定應用程式 URL** 頁面上，於 * * Aha! 登入 URL] 文字方塊中，輸入 URL 用於您的使用者登入您的 Aha! 應用程式 (例如: 「*https://company.aha.io/session/new*」)，然後按一下 [ **下一步**。
