...
A PIM többtényezős hitelesítés használatával kapcsolatos további információk: [többtényezős hitelesítés megkövetelése hogyan](active-directory-privileged-identity-management-how-to-require-mfa.md).
