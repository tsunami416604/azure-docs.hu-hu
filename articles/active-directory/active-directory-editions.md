...
> [AZURE.NOTE] 這兩種版本的價格選項，請參閱 [Azure Active Directory 定價](https://azure.microsoft.com/pricing/details/active-directory/)。<br>Azure Active Directory Premium 和 Azure Active Directory Basic 目前不適用於中國。請透過 Azure Active Directory 論壇與我們連絡以取得詳細資訊
...
>
>-Active Directory B2C 是消費者應用程式的身分識別與存取管理解決方案。 如需詳細資訊，請參閱 [Azure Active Directory B2C](https://azure.microsoft.com/documentation/services/active-directory-b2c/)
...
| | [使用者和群組管理 (加入 / 更新 / 刪除)，以使用者為基礎的佈建](active-directory-administer.md), ，[裝置註冊](active-directory-conditional-access-device-registration-overview.md)| ![勾選][12]| ![勾選][12]| ![勾選][12]| ![勾選][12]|
| | [SaaS 應用程式、 自訂應用程式、 應用程式 Proxy 應用程式的 SSO](active-directory-enable-sso-scenario.md)| 每位使用者 10 個應用程式 [2]| 每位使用者 10 個應用程式 [2]| 沒有限制| 每位使用者 10 個應用程式 [2]|
...
| **高階和基本功能**| [群組為基礎的應用程式存取管理和佈建](active-directory-accessmanagement-group-saasapps.md)| | ![勾選][12]| ![勾選][12]| |
| | [自助式密碼重設雲端使用者的](active-directory-passwords.md)| | ![勾選][12]| ![勾選][12]| ![勾選][12]|
| | [公司商標 (登入頁面和存取面板自訂)](active-directory-add-company-branding.md)| | ![勾選][12]| ![勾選][12]| ![勾選][12]|
...
| | [自助式密碼重設、 變更、 解除鎖定與內部部署回寫](active-directory-passwords-getting-started.md/#enable-users-to-reset-or-change-their-ad-passwords)| | | ![勾選][12]| |
| | [多因素驗證 (雲端和內部部署)](multi-factor-authentication.md)| | | ![勾選][12]| 針對 Office 365 應用程式限定於雲端|
| | [Microsoft Identity Manager (MIM) 使用者授權和 MIM 伺服器 [3]]() http://www.microsoft.com/server-cloud/products/microsoft-identity-manager/default.aspx| | | ![勾選][12]| |
| | [Cloud App Discovery](active-directory-cloudappdiscovery-whatis.md)| | | ![勾選][12]| |
| | [Azure Active Directory Connect 健全狀況](active-directory-aadconnect-health.md)| | | ![勾選][12]| |
| | 群組帳戶的自動密碼變換| | | ![勾選][12]| |
| | **預覽**：條件式存取| | | ![勾選][12]| |
...
| | MDM 自動註冊，自助 Bitlocker 修復，透過 Azure AD Join 的 Windows 10 裝置的其他本機系統管理員| | | ![勾選][12]| |
