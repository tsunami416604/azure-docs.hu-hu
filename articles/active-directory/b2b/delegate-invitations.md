...
3. A **külső felhasználók**területen válassza a **külső együttműködési beállítások kezelése**lehetőséget.
   > [!NOTE]
   > A **külső együttműködési beállítások** a **szervezeti kapcsolatok** lapon is elérhetők. Azure Active Directory a **kezelés**alatt lépjen a **szervezeti kapcsolatok** > **Beállítások**elemre.
