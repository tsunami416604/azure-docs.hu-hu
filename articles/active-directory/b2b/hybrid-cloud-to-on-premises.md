...
2.  A rendszer létrehoz egy vendég felhasználói objektumot a contoso-bérlőben (például egy, a guest_fabrikam. com # EXT #@contoso.onmicrosoft.com) egyszerű felhasználónevet használó felhasználói objektumot.
