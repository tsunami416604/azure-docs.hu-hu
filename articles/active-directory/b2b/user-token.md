...
Ha tudni szeretné, hogy a token hogyan néz ki egy B2B Collaboration-felhasználóhoz, akkor itt látható a tulajdonosi jogkivonat részletei és a token tartalma egy Azure Active Directory (Azure AD) vendégnek és egy Microsoft-fiók vendégnek az erőforrás-bérlőben (tenantid 04dcc6ab-388a-4559-b527-fbec656300ea). A JSON Web Token (JWT) tartalmának megtekintéséhez használja a [https://jwt.io/](https://jwt.io/) vagy a [https://jwt.ms/](https://jwt.ms/).
