---
title: A felhasználói jogkivonatok ismertetése a B2B-együttműködésben – Azure AD
description: Felhasználói jogkivonat-hivatkozás az Azure Active Directory B2B-együttműködéséhez
...
---
# <a name="understand-user-tokens-in-azure-ad-b2b-collaboration"></a>A felhasználói jogkivonatok ismertetése az Azure AD B2B-együttműködésben

Ha tudni szeretné, hogy néz ki a jogkivonat egy B2B együttműködési felhasználó számára, itt vannak az Azure Active Directory (Azure AD) vendég és a Microsoft-fiók egyik vendégének tulajdonosi tokenadatai és tokentartalmai az erőforrás-bérlőben (tenantid esetén 04dcc6ab-388a-4559-b527-fbec656300ea). A JSON webtoken (JWT) tartalmának megtekintéséhez használja [https://jwt.io/](https://jwt.io/) a vagy [https://jwt.ms/](https://jwt.ms/).

## <a name="azure-ad-guest-token"></a>Azure AD vendégtoken
```
...
## <a name="microsoft-account-guest-token"></a>Microsoft-fiók vendégtokenje
```
