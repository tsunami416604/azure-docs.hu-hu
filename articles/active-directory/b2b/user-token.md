---
title: B2B-együttműködés – Azure Active Directoryban lévő felhasználói jogkivonatok ismertetése |} A Microsoft Docs
description: Felhasználói jogkivonat-referencia az Azure Active Directory B2B-együttműködés
...
ms.locfileid: "56675381"
---
# <a name="understand-user-tokens-in-azure-ad-b2b-collaboration"></a>Megismerheti az Azure AD B2B együttműködés felhasználói jogkivonatok

Ha szeretné tudni, hogy a jogkivonat néz ki a B2B-együttműködés felhasználói számára, az alábbiakban a tulajdonosi jogkivonat részleteit és a token tartalmát egy Azure Active Directory (Azure AD) Vendég és a egy Microsoft fiók Vendég az erőforrás-bérlőben (a bérlő azonosítója 04dcc6ab-388a-4559-b527-fbec656300ea). A JSON webes jogkivonat (JWT) tartalmát használja [ https://jwt.io/ ](https://jwt.io/) vagy [ https://jwt.ms/ ](https://jwt.ms/).
...
## <a name="microsoft-account-guest-token"></a>A Microsoft-fiók Vendég jogkivonat
```
