...
7.  在 [結果] 窗格中，選取 **Bime**, ，然後按一下 [ **完成** 加入應用程式。
...
7.  在 [帳戶組態] 頁面上，執行下列步驟：
    ...
    1.  選取 **啟用 SAML 驗證**。
    2.  在 Azure 網站中，在 **在 Bime 設定單一登入** 對話方塊頁面中，複製 **遠端登入 URL** 值，並接著將它貼入 **遠端登入 URL** 文字方塊。
...
>[AZURE.NOTE] 您可以使用任何其他 Bime 使用者帳戶建立工具或 Api 來佈建 AAD 使用者帳戶提供 Bime。
