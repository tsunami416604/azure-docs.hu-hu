...
`RegisterConnector.ps1-modulePath"C:\Program Files\Microsoft AAD 應用程式 Proxy Connector\Modules\"moduleName"AppProxyPSModule"Authenticationmode 權杖-權杖 $SecureToken TenantId < 租用戶 GUID >`
