<properties 
    ...
    description="了解如何使用 Azure Active Directory 中的 ClickTime，來啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在**搜尋方塊**中，輸入 **ClickTime**。
    ...
    ![應用程式庫](./media/active-directory-saas-clicktime-tutorial/IC777275.png "Application gallery")
...
2.  在 **ClickTime * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
