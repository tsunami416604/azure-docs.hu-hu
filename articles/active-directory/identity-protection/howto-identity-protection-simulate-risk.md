...
1. A [Tor-böngésző](https://www.torproject.org/projects/torbrowser.html.en)használatával navigáljon [https://myapps.microsoft.com](https://myapps.microsoft.com).   
...
2. Az új VPN használatával lépjen a [https://myapps.microsoft.com ra](https://myapps.microsoft.com) , és adja meg a teszt fiókjának hitelesítő adatait.
...
1. A szokásos böngésző használatával navigáljon [https://myapps.microsoft.com](https://myapps.microsoft.com).  
...
5. Jelentkezzen be [https://myapps.microsoft.com](https://myapps.microsoft.com) a korábban és az előző bejelentkezést követő néhány percen belül megegyező hitelesítő adatok használatával.
...
1. Keresse meg **Azure Active Directory** > **biztonsági** > **áttekintését**.
1. Válassza a **felhasználói kockázati házirend konfigurálása**lehetőséget.
   ...
   1. **Házirend** ki - ának **kikapcsolása**
