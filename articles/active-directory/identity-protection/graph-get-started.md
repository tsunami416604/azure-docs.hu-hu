...
A Microsoft Graph és hogyan hozhat létre alkalmazásokat a Graph API-val kapcsolatos további információkért tekintse meg a [dokumentáció](https://docs.microsoft.com/en-us/graph/overview) és sok mást a a [Microsoft Graph-hely](https://developer.microsoft.com/en-us/graph). 
