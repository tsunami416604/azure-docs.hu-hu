...
A következő parancsmag segítségével további információkhoz juthat a házirendek konfigurálásához. Vonatkozó tudnivalókat, lásd: [PowerShell dokumentációs](https://docs.microsoft.com/en-us/powershell/module/azuread/?view=azureadps-2.0-preview&branch=master#groups).
