...
- [klasszikus Azure portál](role-based-access-control-configure.md)
...
3. Válassza a **Felhasználók** lehetőséget az Erőforráscsoport panel jobb felső részén.  
    ![Felhasználók – ikon](./media/role-based-access-control-configure/users_icon.png)
4. A **Felhasználók** panel az összes olyan felhasználót, csoportot és alkalmazást felsorolja, amely hozzáféréssel rendelkezik az erőforráscsoporthoz.  
...
> [AZURE.NOTE] Az új RBAC-modellben a hagyományos előfizetés-adminisztrátorok és társadminisztrátorok minősülnek tulajdonosoknak.


## Hozzáférés felvétele
...
1. Válassza a **Hozzáadás** lehetőséget a **Felhasználók** panelen.  
    ![Hozzáadás – ikon](./media/role-based-access-control-configure/add_icon.png)  
...
1. Válassza ki a szerepkör-hozzárendelést a **Felhasználók** panelen.
2. A hozzárendelés részleteit megjelenítő panelen válassza az **Eltávolítás** lehetőséget.  
    ![Eltávolítás – ikon](./media/role-based-access-control-configure/remove_icon.png)
