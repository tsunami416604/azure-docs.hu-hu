---
title: Oktatóanyag – egy meglévő erdő és egy új erdő integrálása egyetlen Azure AD-Bérlővel Azure AD Connect felhőalapú kiépítés használatával.
description: Megtudhatja, hogyan adhat hozzá felhőalapú kiépítési környezetet egy meglévő hibrid identitási környezethez. .
...
Ez az oktatóanyag végigvezeti a felhőalapú kiépítés meglévő hibrid identitási környezetbe való felvételének lépésein. 
...
Ebben a forgatókönyvben egy meglévő erdő van szinkronizálva, Azure AD Connect Sync használatával egy Azure AD-bérlőhöz. És van egy új erdő, amelyet szinkronizálni szeretne ugyanahhoz az Azure AD-bérlőhöz. A Felhőbeli kiépítés beállítása az új erdőhöz történik. 
...
![Képernyőfelvétel: a "Microsoft Azure AD-létesítési ügynök csomagjának" Splash-képernyője.](media/how-to-install/install1.png)</br>
...
![A "kapcsolat Active Directory" képernyőt bemutató képernyőkép.](media/how-to-install/install3.png)</br>
...
![Képernyőkép, amely a "konfigurálás kész" képernyőt jeleníti meg.](media/how-to-install/install4.png)</br>
