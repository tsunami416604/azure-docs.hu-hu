---
title: Oktatóanyag – Integráljon egy meglévő erdőt és egy új erdőt egyetlen Azure AD-bérlővel az Azure AD Connect felhőalapú kiépítés használatával.
...
Ez az oktatóanyag bemutatja a felhőkiépítés hozzáadása egy meglévő hibrid identitáskörnyezet. 

![Létrehozás](media/tutorial-existing-forest/existing-forest-new-forest.png)

Használhatja a környezetet létrehozott ebben az oktatóanyagban a teszteléshez, vagy egyre jobban megismerjék, hogyan működik a hibrid identitások. 

Ebben a forgatókönyvben van egy meglévő erdő az Azure AD Connect-szinkronizálás egy Azure AD-bérlővel szinkronizálva. És van egy új erdő, amely szinkronizálni szeretné az azonos Azure AD-bérlő. Az új erdő felhőalapú kiépítését fogja beállítani. 
...
1. Windows Server 2012 R2 vagy nagyobb rendszert futtató, tartományhoz csatlakozó gazdakiszolgáló identitása legalább 4 GB RAM-mal és .NET 4.7.1+ futtatóidővel 
...
2. Ha tűzfal van a kiszolgálók és az Azure AD között, konfigurálja a következő elemeket:
   ...
   - Ha a tűzfal vagy a proxy lehetővé teszi a biztonságos utótagok megadását, akkor adjon kapcsolatokat ** \*a .msappproxy.net** és ** \*a .servicebus.windows.net**. Ha nem, engedélyezze a hozzáférést az [Azure-adatközpont IP-tartományaihoz,](https://www.microsoft.com/download/details.aspx?id=41653)amelyek hetente frissülnek.
...
3. A bal oldalon válassza az **Azure Active Directory**lehetőséget, kattintson az Azure **AD Connect** elemre, és középen válassza a **Kiépítés kezelése (előzetes verzió) lehetőséget.**</br>
![Azure Portal](media/how-to-install/install6.png)</br>
4. Kattintson a "Download agent"
5. Az Azure AD Connect kiépítési ügynök futtatása
6. A kezdőképen **fogadja el** a licencelési feltételeket, és kattintson a Telepítés **gombra.**</br>
...
8. Az **Active Directory csatlakoztatása** képernyőn kattintson a **Címtár hozzáadása** elemre, majd jelentkezzen be az Active Directory tartományi rendszergazdai fiókjával.  MEGJEGYZÉS: A tartományi rendszergazdai fióknak nem kell jelszómódosítási követelményekkel rendelkeznie. Abban az esetben, ha a jelszó lejár, vagy megváltozik, újra kell konfigurálnia az ügynököt az új hitelesítő adatokkal. Ez a művelet hozzáadja a helyszíni könyvtárat.  Kattintson a **Tovább** gombra.</br>
![Üdvözlőképernyő](media/how-to-install/install3.png)</br>

9. A **Konfiguráció teljes** képernyőjén kattintson a **Megerősítés gombra.**  Ez a művelet regisztrálja és újraindítja az ügynököt.</br>
...
Most már sikeresen beállított egy hibrid identitáskezelési környezetet, amely segítségével tesztelheti és megismerkedhet az Azure által kínált lehetőségekkel.
