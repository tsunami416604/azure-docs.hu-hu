...
3. Győződjön meg arról, hogy a kísérleti hatókörben lévő objektumok rendelkeznek ms-DS-consistencyGUID feltöltve, így a Felhőbeli kiépítés megnehezíti az objektumokat. Ne feledje, hogy Azure AD Connect szinkronizálása nem tölti fel az MS-DS-consistencyGUID alapértelmezés szerint a csoport objektumaihoz.
...
Legalább az [Azure ad-csatlakozási](https://www.microsoft.com/download/details.aspx?id=47594) 1.4.32.0 kell rendelkeznie. Azure AD Connect szinkronizálásának frissítéséhez hajtsa végre a [Azure ad Connect: frissítés a legújabb verzióra](../hybrid/how-to-upgrade-previous-version.md)című témakör lépéseit.  Ez a lépés abban az esetben jelenik meg, ha a tesztkörnyezetben nem a Azure AD Connect legújabb verziója található.
...
## <a name="scope-azure-ad-connect-sync-to-exclude-the-pilot-ou"></a>Hatókör Azure AD Connect szinkronizálás a kísérleti szervezeti egység kizárásához
Most konfigurálja Azure AD Connect a fentiekben létrehozott kísérleti szervezeti egység kizárásához.  A felhő-kiépítési ügynök kezelni fogja a felhasználók szinkronizálását.  Az alábbi lépéseket követve Azure AD Connect hatókörét.
