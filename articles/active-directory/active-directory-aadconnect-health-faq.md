...
* * 問: 我管理多個 Azure AD 目錄。 我切換到使用 Azure Active Directory Premium? * *
...
號 安裝代理程式不需要您重新啟動伺服器。 不過，安裝某些先決條件的步驟可能需要重新啟動伺服器。
...
如果您需要設定 proxy 代理程式註冊期間，您需要修改您的 Internet Explorer Proxy 設定。 <br>
