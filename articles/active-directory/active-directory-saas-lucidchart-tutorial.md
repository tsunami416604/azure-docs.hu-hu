<properties 
    ...
    description="了解如何使用 Azure Active Directory 中的 Lucidchart，來啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在搜尋方塊****中，輸入 **Lucidchart**。

    ![應用程式資源庫](./media/active-directory-saas-lucidchart-tutorial/IC791184.png "Application Gallery")
...
8.  在 [SAML 驗證設定]**** 對話方塊頁面上執行下列步驟：
    ...
    1.  選取 **啟用 SAML 驗證**, ，然後按一下 [ **選擇性**。
        ![基本驗證設定](./media/active-directory-saas-lucidchart-tutorial/IC791192.png "SAML Authentication Settings")
...
2.  在 **Lucidchart * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
