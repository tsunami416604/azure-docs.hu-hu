...
1.  Nyissa meg a [ **Azure Portal** ](https://portal.azure.com/) , és jelentkezzen be egy **globális rendszergazda** vagy **Co-rendszergazda segítségét.** Ugorjon a 7. Ha már az alkalmazás konfigurációs panel az Azure ad-val.
