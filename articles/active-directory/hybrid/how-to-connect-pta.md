...
- A bejelentkezési felhasználónevek lehetnek a helyszíni alapértelmezett felhasználónevek (`userPrincipalName`) vagy más, Azure AD Connect konfigurált attribútumok (más néven `Alternate ID`).
