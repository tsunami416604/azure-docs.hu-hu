...
Azure Active Directory lehetővé teszi az egyszeri bejelentkezést és a továbbfejlesztett alkalmazás-hozzáférési biztonságot több ezer SaaS-alkalmazás és helyszíni webalkalmazás számára. További információ: [alkalmazások integrálása a Azure Active Directory](../develop/quickstart-v1-integrate-apps-with-azure-ad.md)
...
* A felhasználók az Azure AD-ben az Office 365, az Intune, az SaaS-alkalmazások és a harmadik féltől származó alkalmazások számára is kihasználhatják közös identitását.
