...
Annak ellenőrzéséhez, hogy a Azure AD Connect melyik verziója van telepítve a kiszolgálón, lépjen a Vezérlőpultra, és keresse meg Microsoft Azure AD kapcsolódás telepített verzióját a **programok** > **programok és szolgáltatások**elem kiválasztásával, ahogy az itt látható:
