...
* A Azure AD Connect-kiszolgálónak nincs engedélyezve a PowerShell-átírás Csoportházirend.
...
| Objektumok száma a Active Directoryban | CPU | Memória | Merevlemez mérete |
| --- | --- | --- | --- |
