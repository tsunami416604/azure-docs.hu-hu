...
* Egy Azure AD-bérlő. You get one with an [Azure free trial](https://azure.microsoft.com/pricing/free-trial/). You can use one of the following portals to manage Azure AD Connect:
...
* Windows Server 2012R2
  * Microsoft PowerShell is installed by default. Nincs szükség műveletre.
...
| Number of objects in Active Directory | CPU | Memória | Hard drive size |
| --- | --- | --- | --- |
