...
![Az üzembe helyezés megtervezése](./media/how-to-connect-fed-azure-adfs/deployment.png)
...
![Virtuális hálózat létrehozása](./media/how-to-connect-fed-azure-adfs/deploynetwork1.png)
...
![Alhálózat](./media/how-to-connect-fed-azure-adfs/deploynetwork2.png)

![DMZ-alhálózat](./media/how-to-connect-fed-azure-adfs/deploynetwork3.png)
...
![Az NSG létrehozása](./media/how-to-connect-fed-azure-adfs/creatensg1.png)
...
![Az NSG inicializálása](./media/how-to-connect-fed-azure-adfs/nsgint1.png)
...
![Az NSG konfigurálása](./media/how-to-connect-fed-azure-adfs/nsgconfigure1.png)
...
![Alhálózatok panel az NSG társítását követően](./media/how-to-connect-fed-azure-adfs/nsgconfigure2.png)
...
![Tárfiókok létrehozása](./media/how-to-connect-fed-azure-adfs/storageaccount1.png)
...
![Rendelkezésre állási csoportok](./media/how-to-connect-fed-azure-adfs/availabilityset1.png)
...
![Virtuális gépek üzembe helyezve](./media/how-to-connect-fed-azure-adfs/virtualmachinesdeployed_noadfs.png)
...
![Terheléselosztó tallózása](./media/how-to-connect-fed-azure-adfs/browseloadbalancer.png)
...
![Belső terheléselosztó](./media/how-to-connect-fed-azure-adfs/ilbdeployment1.png)
...
![Terheléselosztók listája az ILB létrehozását követően](./media/how-to-connect-fed-azure-adfs/ilbdeployment2.png)
...
![Az ILB-háttérkészlet konfigurálása](./media/how-to-connect-fed-azure-adfs/ilbdeployment3.png)
...
![Az ILB-mintavétel konfigurálása](./media/how-to-connect-fed-azure-adfs/ilbdeployment4.png)
...
![ILB-terheléselosztási szabályok konfigurálása](./media/how-to-connect-fed-azure-adfs/ilbdeployment5.png)
...
![Internetre irányuló terheléselosztó](./media/how-to-connect-fed-azure-adfs/elbdeployment1.png)

Az üzembe helyezést követően a terheléselosztó megjelenik a Terheléselosztók listában.

![Terheléselosztók listája](./media/how-to-connect-fed-azure-adfs/elbdeployment2.png)
...
![Az internetre irányuló terheléselosztó konfigurálása](./media/how-to-connect-fed-azure-adfs/elbdeployment3.png) 

![Az internetre irányuló terheléselosztó konfigurálása (DNS)](./media/how-to-connect-fed-azure-adfs/elbdeployment4.png)
...
![Az internetre irányuló terheléselosztó háttérkészletének konfigurálása](./media/how-to-connect-fed-azure-adfs/elbdeployment5.png)
...
![Az internetre irányuló terheléselosztó mintavételének konfigurálása](./media/how-to-connect-fed-azure-adfs/elbdeployment6.png)
...
![Az internetre irányuló terheléselosztó terheléselosztási szabályainak konfigurálása](./media/how-to-connect-fed-azure-adfs/elbdeployment7.png)
...
![INT-hozzáférési szabályok (bejövő)](./media/how-to-connect-fed-azure-adfs/nsg_int.png)
...
![EXT-hozzáférési szabályok (bejövő)](./media/how-to-connect-fed-azure-adfs/nsg_dmz.png)
...
![Bejelentkezési lap tesztelése](./media/how-to-connect-fed-azure-adfs/test1.png)

A sikeres bejelentkezést követően a rendszer az alább látható üzenetet jeleníti meg:

![Teszt sikeres](./media/how-to-connect-fed-azure-adfs/test2.png)
...
* [Az AD FS konfigurálása és felügyelete az Azure AD Connect segítségével](how-to-connect-fed-whatis.md)
