---
title: 'Oktatóanyag: Összevonása egy AD egyetlen erdővel rendelkező környezetben az Azure-bA |} A Microsoft Docs'
description: Bemutatja, hogyan állíthatja be az összevonási használatával hibrid identitás környezetben.
...
ms.locfileid: "51248044"
---
# <a name="tutorial-federate-a-single-ad-forest-environment-to-the-cloud"></a>Oktatóanyag: Összevonása egy AD egyetlen erdővel rendelkező környezetben a felhőbe

![Létrehozás](media/tutorial-federation/diagram.png)

A következő oktatóanyag végigvezeti egy hibrid identitás-környezet összevonási létrehozása.  Ebben a környezetben felhasználható, tesztelési vagy az első több megismerkedhet a hibrid identitás működésével.
...
## <a name="install-active-directory-pre-requisites"></a>Az Active Directory előfeltételek telepítése
...
## <a name="create-a-certificate-for-ad-fs"></a>Hozzon létre egy tanúsítványt az AD FS-hez
Most létre fogunk hozni egy AD FS által használt SSL-tanúsítványt.  Ez lesz az önaláírt tanúsítványt, és csak tesztelésre.  A Microsoft nem javasolja az éles környezetben egy önaláírt tanúsítvány használatával. Tegye a következőket:
...
6. A felhasználói bejelentkezési képernyőn válassza ki a **és az AD FS összevonási** kattintson **tovább**.
![Összevonási](media/tutorial-federation/fed1.png)

1. A csatlakozás az Azure ad Szolgáltatáshoz képernyőn, adja meg a felhasználónevet és jelszót a fentiekben létrehozott globális rendszergazdai, és kattintson a **tovább**.
...
9. A tartományi rendszergazda hitelesítő adatai oldalon írja be a contoso\rendszergazda felhasználónévvel és jelszóval, és kattintson a **tovább.**
10. Az AD FS farm képernyőn ellenőrizze, hogy **egy új AD FS farm konfigurálásához** van kiválasztva.
11. Válassza ki **összevonási kiszolgálókon telepített tanúsítvány használata** kattintson **Tallózás**.
12. A keresőmezőbe írja be a DC1, és válassza ki azt talált.  Kattintson az **OK** gombra.
13. Az a **tanúsítványfájl** legördülő menüben válassza **adfs.contoso.com** a fentiekben létrehozott tanúsítvány.  Kattintson a **Tovább** gombra.
![Összevonási](media/tutorial-federation/fed2.png)

1. Az AD FS kiszolgáló képernyőn kattintson a **Tallózás** és a Keresés mezőbe írja be a DC1, és jelölje ki talált.  Kattintson az **OK** gombra.  Kattintson a **Tovább** gombra.
![Összevonási](media/tutorial-federation/fed3.png)

1. A Web application Proxy kiszolgálók képernyőn kattintson a **tovább**.
2. Az AD FS szolgáltatás fiók képernyőn írja be a contoso\rendszergazda felhasználónévvel és jelszóval, és kattintson a **tovább.**
3. Az Azure AD tartományi képernyőn válassza ki az ellenőrzött egyéni tartományt a legördülő listából, majd kattintson **tovább**.
...
6. Miután a telepítés befejeződött, jelentkezzen ki, és jelentkezzen be újra a Synchronization Service Managert vagy a szinkronizálási Szabályszerkesztő használata előtt.
