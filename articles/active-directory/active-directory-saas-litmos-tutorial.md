...
本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合 Litmos。<br>整合 Litmos 與 Azure AD 為您提供下列優點:
...
4. * *[建立 Litmos 測試使用者](#creating-a-halogen-software-test-user)* *-若要連結到她在 Azure AD 代表 Litmos 中有對應的 Britta Simon。
