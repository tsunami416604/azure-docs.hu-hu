<properties
    pageTitle="管理 Azure Active Directory 中的密碼 | Microsoft Azure"
...
如果您是系統管理員，可以在 Azure 傳統入口網站的 Azure Active Directory (Azure AD) 中重設使用者的密碼。 按一下您的目錄名稱並在 [使用者] 頁面上按一下使用者的名稱，然後按一下入口網站底部的 [**重設密碼**]。

本主題的其餘部分涵蓋 Azure AD 支援的完整密碼管理功能，包括：
...
- **由系統管理員起始的密碼重設**可讓系統管理員在 Azure 傳統入口網站中重設使用者或其他系統管理員的密碼。
...
> [AZURE.NOTE]
> Azure AD Premium 可用於使用 Azure AD 全球執行個體的中國客戶。 由 21Vianet 在中國提供的 Microsoft Azure 服務目前不支援 Azure AD Premium。 如需詳細資訊，與我們連絡 [Azure Active Directory 論壇](http://feedback.azure.com/forums/169401-azure-active-directory)。

使用下列連結可前往您最感興趣的文件：

- [概觀: Azure AD 中的密碼管理](active-directory-passwords-how-it-works.md)
- [自助式密碼重設 Azure AD 中: 如何啟用、 設定及測試自助式密碼重設](active-directory-passwords-getting-started.md#enable-users-to-reset-their-azure-ad-passwords)
- [自助式密碼重設 Azure AD 中: 如何自訂密碼重設以符合您的需求](active-directory-passwords-customize.md)
- [自助式密碼重設 Azure AD 中: 部署和管理的最佳作法](active-directory-passwords-best-practices.md)
...
- [Azure AD 密碼管理常見問題集](active-directory-passwords-faq.md)


## 後續步驟

- [管理 Azure AD](active-directory-administer.md)
- [建立或編輯在 Azure AD 中的使用者](active-directory-create-users.md)
