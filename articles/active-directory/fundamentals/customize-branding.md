...
Testreszabhatja az Azure AD bejelentkezési lapjait, amelyek akkor jelennek meg, amikor a felhasználók bejelentkeznek a szervezet bérlői specifikus alkalmazásaiba, például a [ *https://outlook.com/contoso.com ba* ](https://outlook.com/contoso.com)vagy egy tartományi változó átadásakor, például [ *https://passwordreset.microsoftonline.com/?whr=contoso.com* ](https://passwordreset.microsoftonline.com/?whr=contoso.com).

Az egyéni arculat nem jelenik meg azonnal, amikor a felhasználók olyan webhelyekre látogatnak, mint például a www\.office.com. Ehelyett a felhasználónak be kell jelentkeznie a testreszabott arculat megjelenése előtt. Miután a felhasználó bejelentkezett, a márkaépítés 15 percet vagy hosszabb időt is igénybe vehet. 
...
Adja hozzá az egyéni arculatot a lapokhoz az URL-cím végének `?whr=yourdomainname`szöveggel való módosításával. Ez a módosítás több oldalon is működik, beleértve a Multi-Factor Authentication (MFA) telepítési oldalát, az önkiszolgáló jelszó-visszaállítás (SSPR) telepítési lapját és a bejelentkezési lapot.
