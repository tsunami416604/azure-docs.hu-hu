...
A közeljövőben az Azure AD-fiókkal rendelkező felhasználók a továbbiakban nem regisztrálhatnak és nem kezelhetik a konvergens alkalmazásokat az alkalmazásregisztrációs portálon (apps.dev.microsoft.com), illetve nem regisztrálhatnak és kezelhetnek alkalmazásokat az alkalmazásregisztrációkban (örökölt) az Azure Portalon.
