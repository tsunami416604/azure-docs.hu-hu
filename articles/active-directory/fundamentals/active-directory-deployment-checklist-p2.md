...
| [A felhasználók üzembe helyezésének és megszüntetésének automatizálása](../app-provisioning/user-provisioning.md) | A jogosulatlan hozzáférés megakadályozása érdekében távolítsa el az alkalmazotti fiók életciklusának manuális lépéseit. Az Azure AD a forrásból (HR-rendszerbe) hiteles identitások szinkronizálásával. |  |
