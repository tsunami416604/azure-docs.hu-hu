...
本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合 GaggleAMP。<br>整合 GaggleAMP 與 Azure AD 為您提供下列優點:
...
建立此連結關聯性的方法，就是將 Azure AD 中 [使用者名稱]**** 的值，指派為 GaggleAMP 中 [Username]**** 的值。
...
4. * *[建立 GaggleAMP 測試使用者](#creating-a-GaggleAMP-test-user)* *-若要連結到她在 Azure AD 代表 GaggleAMP 中有對應的 Britta Simon。
...
<br><br>![設定單一登入](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_04.png) <br>
    ...
    > [AZURE.NOTE]請連絡您 [GaggleAMP 銷售團隊](mailto:sales@gaggleamp.com) 如果您需要 **登入 URL** 應用程式。 」
