...
- [尋找您的網域註冊機構或 DNS 主機服務提供者](https://support.office.com/article/Find-your-domain-registrar-or-DNS-hosting-provider-b5b633ba-1e56-4a98-8ff5-2acaac63a5c8/)
- [使用 Office 365 中的網域名稱](https://support.office.com/article/Work-with-domain-names-in-Office-365-4f1bd681-337a-4bd3-a7b7-cf77b18d0870/)
...
- 適用於 Windows PowerShell 的 Azure Active Directory 模組。 有關哪一個指令程式中，您可以使用這個的詳細資訊，請參閱 [Azure AD 中管理網域](https://msdn.microsoft.com/library/azure/dn919677.aspx)。
...
- [新增並驗證網域，使用 Azure 傳統入口網站](#add-and-verify-a-domain-using-the-azure-management-portal)
- [編輯雲端服務的 DNS 記錄](#edit-dns-records-for-your-cloud-services)
- [驗證任何網域名稱註冊機構的網域](#verify-a-domain-at-any-domain-name-registrar)

### 使用 Azure 傳統入口網站新增和驗證網域

1. 在 Azure 傳統入口網站中，按一下 [Active Directory]****，然後按一下您的組織目錄的名稱。您可以執行下列其中一項：
    1. 在預設目錄頁面上，按一下 [ **新增網域** 中 ** 改善使用者登入經驗 **一節。
