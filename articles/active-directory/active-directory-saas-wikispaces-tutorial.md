...
6.  在**搜尋方塊**中，輸入 **Wikispaces**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-wikispaces-tutorial/IC787186.png "Application Gallery")
...
4.  在 **設定單一登入在 Wikispaces** 頁面上，按一下 **下載中繼資料**, ，然後儲存您的電腦上的中繼資料檔案。
...
2.  在 **Wikispaces * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
