---
title: 'Oktatóanyag: Azure Active Directory-integráció az Synergi |} A Microsoft Docs'
...
ms.locfileid: "39041428"
---
# <a name="tutorial-azure-active-directory-integration-with-synergi"></a>Oktatóanyag: Azure Active Directory-integráció az Synergi
...
3. **[Hozzon létre egy Synergi tesztfelhasználót](#create-a-synergi-test-user)**  – egy megfelelője a Britta Simon Synergi, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Synergi tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Synergi konfigurációs** területén kattintson **konfigurálása Synergi** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-CÍMÉT és a SAML Entitásazonosító** származó a **gyors útmutató szakaszban.**

    ![Synergi konfiguráció](./media/synergi-tutorial/tutorial_synergi_configure.png) 

7. Az egyszeri bejelentkezés konfigurálása **Synergi** oldalon kell küldenie a letöltött **Certificate(Base64) kijelentkezéses URL-cím és SAML Entitásazonosító** való [Synergi támogatási csapatának](https://www.irmsecurity.com/contact/).
