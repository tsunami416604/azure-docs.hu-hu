...
2. A **[Zoho egyszeri bejelentkezés konfigurálása](#configure-zoho-one-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
### <a name="configure-zoho-one-single-sign-on"></a>A Zoho egyszeri bejelentkezés konfigurálása
