...
2. **[LCVista egyszeri bejelentkezés konfigurálása](#configure-lcvista-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
### <a name="configure-lcvista-single-sign-on"></a>LCVista egyetlen Sign-On konfigurálása
...
2. Az **SAML-konfiguráció** szakaszban jelölje be az **SAML-bejelentkezés engedélyezése** szakaszt, és adja meg a részleteket az alábbi képen látható módon. 
    ...
    ![Egyetlen Sign-On konfigurálása](./media/lcvista-tutorial/tutorial_lcvista_config.png)
...
Ha a hozzáférési panelen a LCVista csempére kattint, automatikusan be kell jelentkeznie arra a LCVista, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
