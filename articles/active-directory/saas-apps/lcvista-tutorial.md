...
4. A Keresés mezőbe írja be a **LCVista**.
...
3. **[LCVista tesztfelhasználó létrehozása](#creating-a-lcvista-test-user)**  – egy megfelelője a Britta Simon LCVista, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **LCVista tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **LCVista konfigurációs** területén kattintson **konfigurálása LCVista** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML Entitásazonosító** és **SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/lcvista-tutorial/tutorial_lcvista_configure.png) 

7.  Jelentkezzen be rendszergazdaként LCVista alkalmazását.

8. Az a **SAML-Config** négyzet a szakaszban a **SAML engedélyezése bejelentkezési** , és adja meg, hogy kép alatt leírtak szerint. 
