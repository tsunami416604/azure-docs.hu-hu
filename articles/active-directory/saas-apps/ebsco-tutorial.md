---
title: 'Oktatóanyag: Az Azure Active Directory-integrációval rendelkező EBSCO |} A Microsoft Docs'
...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve EBSCO (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* EBSCO egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a EBSCO **SP** és **Identitásszolgáltató** által kezdeményezett egyszeri bejelentkezés

* Támogatja a EBSCO **igény szerinti** felhasználók átadása
...
4. A Keresés mezőbe írja be a **EBSCO**, jelölje be **EBSCO** az eredmény panelen, majd kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában EBSCO](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az EBSCO nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó EBSCO hivatkozás kapcsolata kell létrehozni.
...
2. **[EBSCO egyszeri bejelentkezés konfigurálása](#configure-ebsco-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre EBSCO tesztfelhasználót](#create-ebsco-test-user)**  – egy megfelelője a Britta Simon EBSCO, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **EBSCO** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszra, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód, hajtsa végre a következő lépést:
    ...
    ![EBSCO tartomány és URL-címeket egyetlen bejelentkezési adatait](common/idp-identifier.png)
...
6. EBSCO alkalmazások a SAML helyességi feltételek vár egy megadott formátumban, amely megköveteli, hogy egyéni attribútum-leképezéshez az SAML-jogkivonat attribútumai konfigurációja. Az alábbi képernyőképen az alapértelmezett attribútumok listáját jeleníti meg. Kattintson a **szerkesztése** ikonra kattintva nyissa meg a **felhasználói attribútumok** párbeszédpanel.
    ...
    ![image](common/edit-attribute.png)
     ...
     > [!Note]
    > A **neve** attribútum kötelező, és az le van képezve **Névazonosító érték** EBSCO alkalmazásban. Ez hozzáadódik alapértelmezés szerint, így nem kell manuálisan adja hozzá ezt.

7. Emellett a fentiekben EBSCO alkalmazás vár néhány további attribútumok vissza SAML-válasz átadni. A a **felhasználói jogcímek** szakaszában a **felhasználói attribútumok** párbeszédpanelen a következő lépésekkel adja hozzá a SAML-jogkivonat attribútumot, ahogyan az alábbi táblázatban: 
...
9. Az a **EBSCO beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
Az egyszeri bejelentkezés konfigurálása **EBSCO** oldalon kell küldenie a letöltött **metaadatainak XML** és az Azure Portalról másolt URL-címek megfelelő [EBSCO támogatási csoportjának](mailto:sso@ebsco.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **EBSCO**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **EBSCO**.

    ![Az alkalmazások listáját a EBSCO hivatkozásra](common/all-applications.png)
...
1. A fenti beállítás befejezése után törölje a jelet a cookie-k/gyorsítótár és a bejelentkezési újra. Nem kell manuálisan jelentkezzen be újra, és a személyre szabási beállításait a rendszer megjegyezze őket
