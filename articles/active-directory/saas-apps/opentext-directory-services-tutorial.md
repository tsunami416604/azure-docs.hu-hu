...
Ha a hozzáférési panelen a OpenText Directory Services csempére kattint, automatikusan be kell jelentkeznie a OpenText, amelyhez be kell állítania az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [A OpenText-címtárszolgáltatások védetté tétele a fejlett láthatósággal és vezérlőkkel](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
