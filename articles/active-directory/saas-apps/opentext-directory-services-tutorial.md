...
* A OpenText konfigurálása után kényszerítheti a munkamenet-vezérlést, amely a szervezet bizalmas adatai kiszűrése és beszivárgását valós időben védi. A munkamenet-vezérlő a feltételes hozzáférésből is kiterjeszthető. [Megtudhatja, hogyan kényszerítheti ki a munkamenet-vezérlést Microsoft Cloud app Security használatával](/cloud-app-security/proxy-deployment-any-app).

## <a name="adding-opentext-directory-services-from-the-gallery"></a>OpenText-címtárszolgáltatások hozzáadása a katalógusból
...
Az Azure AD SSO OpenText Directory-szolgáltatásokkal történő konfigurálásához és teszteléséhez hajtsa végre a következő építőelemeket:
...
1. A [Azure Portal](https://portal.azure.com/)a **Opentext Directory Services** alkalmazás-integráció lapján keresse meg a **kezelés** szakaszt, és válassza az **egyszeri bejelentkezés**lehetőséget.
...
Ha a hozzáférési panelen a OpenText Directory Services csempére kattint, automatikusan be kell jelentkeznie a OpenText, amelyhez be kell állítania az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
...
- [A OpenText kipróbálása az Azure AD szolgáltatással](https://aad.portal.azure.com/)

- [Mi a munkamenet-vezérlő a Microsoft Cloud App Securityban?](/cloud-app-security/proxy-intro-aad)

- [A OpenText-címtárszolgáltatások védetté tétele a fejlett láthatósággal és vezérlőkkel](/cloud-app-security/proxy-intro-aad)