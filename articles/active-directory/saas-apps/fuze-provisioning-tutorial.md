...
ms.locfileid: "68602151"
---
# <a name="tutorial-configure-fuze-for-automatic-user-provisioning"></a>Oktatóanyag: Gyutacs konfigurálása automatikus felhasználó-kiépítési szolgáltatáshoz
...
5. A **rendszergazdai hitelesítő adatok** szakaszban `https://api.fuze.com/scim/v2` adja meg a **bérlői URL-címet**. Adja meg a **scim-hitelesítési jogkivonat** értékét a Gyutacs-képviselőtől a **titkos**jogkivonatban. Kattintson a **kapcsolat tesztelése** lehetőségre, hogy az Azure ad képes legyen csatlakozni a Gyutacs. Ha a kapcsolat meghiúsul, győződjön meg arról, hogy a Gyutacs-fiókja rendszergazdai jogosultságokkal rendelkezik, és próbálkozzon újra.
...
* A Gyutacs a jogosultságok nevűegyéni scim-attribútumokat támogatja. Ezek az attribútumok csak akkor hozhatók létre és nem frissíthetők. 
