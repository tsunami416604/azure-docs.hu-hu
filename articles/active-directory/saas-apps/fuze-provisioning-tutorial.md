...
5. A **rendszergazdai hitelesítő adatok** szakaszban adja meg a `https://api.fuze.com/scim/v2` a **bérlői URL-címben**. Adja meg a **scim-hitelesítési jogkivonat** értékét a Gyutacs-képviselőtől a **titkos jogkivonatban**. Kattintson a **kapcsolat tesztelése** lehetőségre, hogy az Azure ad képes legyen csatlakozni a Gyutacs. Ha a kapcsolat meghiúsul, győződjön meg arról, hogy a Gyutacs-fiókja rendszergazdai jogosultságokkal rendelkezik, és próbálkozzon újra.
