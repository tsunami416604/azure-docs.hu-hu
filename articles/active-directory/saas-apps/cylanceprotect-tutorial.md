...
4. Írja be a keresőmezőbe, **CylancePROTECT**, jelölje be **CylancePROTECT** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában CylancePROTECT](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_samlbase.png)

3. Az a **CylancePROTECT tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk CylancePROTECT tartomány és az URL-címek](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** kattintson **Certificate(Base64)** és mentse a tanúsítványadatának fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/cylanceprotect-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **CylancePROTECT**.
    ...
    ![Az alkalmazások listáját a CylancePROTECT hivatkozás](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_app.png)  
