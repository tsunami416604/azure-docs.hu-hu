...
1. Az **alapszintű SAML-konfiguráció** szakaszban adja meg a következő mezők értékeit:
    ...
    A **bejelentkezési URL** szövegmezőbe írja be a következő URL-címet: `https://login.teamviewer.com/LogOn`
...
Amikor a hozzáférési panelen a TeamViewer csempére kattint, automatikusan be kell jelentkeznie a TeamViewerbe, amelyhez be kell állítania az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
