...
3. **[Hozzon létre egy futtató Palo Alto Networks - GlobalProtect tesztfelhasználó](#create-a-palo-alto-networks---globalprotect-test-user)**  – van egy Britta Simon megfelelője a Palo Alto Networks - GlobalProtect, amely kapcsolódik az Azure AD felhasználói ábrázolása.
...
3. Az a **Palo Alto Networks - GlobalProtect tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
4. Palo Alto Networks - GlobalProtect alkalmazás vár a SAML helyességi feltételek egy meghatározott formátumnak. Állítsa be a következő jogcímek ehhez az alkalmazáshoz. Ezek az attribútumok értékeinek kezelheti a "**felhasználói attribútumok**" szakasz alkalmazás integráció lapján. Az alábbi képernyőfelvételen látható erre egy példa látható.
...
8. Egy másik böngészőablakban rendszergazdaként nyissa meg a Palo Alto hálózatok tűzfal felügyeleti felhasználói Felületéhez.
...
10. Válassza ki **identitásszolgáltató SAML** a bal oldali navigációs sávot, majd kattintson a "Importálása" a metaadatait tartalmazó fájl importálása.
...
11. Hajtsa végre a következő műveleteket az importálási ablakot a
...
2. Az alkalmazások listájában jelölje ki a **Palo Alto Networks - GlobalProtect**.
