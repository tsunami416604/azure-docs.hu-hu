...
ms.locfileid: "70846930"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-arc-facilities"></a>Oktatóanyag: Egyszeri bejelentkezéses (SSO) integráció Azure Active Directory ARC-létesítményekkel
...
1. A [Azure Portal](https://portal.azure.com/)az **arc létesítmények** alkalmazás-integráció lapján keresse meg a **kezelés** szakaszt, és válassza az **egyszeri bejelentkezés**lehetőséget.
...
Az **arc-létesítményekre** való egyszeri bejelentkezés konfigurálásához el kell küldenie a letöltött **tanúsítványt (Base64)** és a megfelelő másolt url-címeket a Azure Portalról az [arc-létesítmények támogatási csapatának](mailto:support@arcfacilities.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
Amikor a hozzáférési panelen a ARC létesítmények csempére kattint, automatikusan be kell jelentkeznie az ARC-létesítményekbe, amelyekhez be kell állítania az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Az ARC-létesítmények kipróbálása az Azure AD-vel](https://aad.portal.azure.com/)
