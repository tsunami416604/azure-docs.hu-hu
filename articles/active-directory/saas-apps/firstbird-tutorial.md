...
A lépések elvégzése után küldje el Firstbird az összevonási metaadatok XML-fájlját egy támogatási kérelemben e-mailben a [support@firstbird.com](mailto:support@firstbird.com) következő tárgyra: "SSO Configuration".
...
Ha a hozzáférési panelen a Firstbird csempére kattint, automatikusan be kell jelentkeznie arra a Firstbird, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
