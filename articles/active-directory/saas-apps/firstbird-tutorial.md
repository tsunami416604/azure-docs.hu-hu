...
ms.openlocfilehash: 3afbbfdcacb932deb688c31d513c134f52137d7d
ms.sourcegitcommit: 5fbca3354f47d936e46582e76ff49b77a989f299
ms.translationtype: MT
ms.contentlocale: hu-HU
ms.lasthandoff: 03/12/2019
ms.locfileid: "57771718"
---
...
* Szabályozhatja, ki férhet hozzá Firstbird Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Firstbird (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
Firstbird az Azure AD-integráció konfigurálásához a következőkre van szükség:

* Az Azure AD-előfizetés. Ha nem rendelkezik egy Azure AD-környezetet, beszerezheti a egy havi próbalehetőség [Itt](https://azure.microsoft.com/pricing/free-trial/)
* Firstbird egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a Firstbird **SP és IDP** által kezdeményezett egyszeri bejelentkezés
* Támogatja a Firstbird **igény szerinti** felhasználók átadása

## <a name="adding-firstbird-from-the-gallery"></a>Firstbird hozzáadása a katalógusból

Az Azure AD integrálása a Firstbird konfigurálásához hozzá kell Firstbird a katalógusból a felügyelt SaaS-alkalmazások listájára.
...
4. A Keresés mezőbe írja be a **Firstbird**válassza **Firstbird** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában Firstbird](common/search_new_app.png)
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Firstbird** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
6. Firstbird alkalmazás a SAML helyességi feltételek vár egy megadott formátumban. Konfigurálja a következő jogcímek ehhez az alkalmazáshoz. Ezek az attribútumok értékeinek kezelheti a **felhasználói attribútumok** szakasz alkalmazás integráció lapján. Az a **állítsa be egyszeri bejelentkezést az SAML** kattintson **szerkesztése** gombra kattintva nyissa meg a **felhasználói attribútumok** párbeszédpanel.
...
Miután végrehajtotta ezeket a lépéseket, kérjük, küldjön Firstbird az összevonási metaadatainak XML-fájl egy támogatási kérést az e-mailben a [ support@firstbird.com ](mailto:support@firstbird.com) a tulajdonos: "Egyszeri bejelentkezési konfiguráció".

Firstbird majd menteni a konfigurációt a rendszer ennek megfelelően, és egyszeri bejelentkezés aktiválja a fiókhoz. Ezt követően a támogatási munkatársak tagja felveszi Önnel a kapcsolatot a konfiguráció ellenőrzése.

> [!NOTE]
> Szüksége lesz az egyszeri bejelentkezési beállítás, a szerződés tartalmazza.
...
Ebben a szakaszban engedélyezze Britta Simon által biztosított hozzáférés Firstbird Azure egyszeri bejelentkezés használatára.

1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Firstbird**.

    ![Vállalati alkalmazások panelen](common/enterprise_applications.png)

2. Az alkalmazások listáját, írja be, és válassza ki **Firstbird**.

    ![Az alkalmazások listáját a Firstbird hivatkozásra](common/all_applications.png)
...
### <a name="create-firstbird-test-user"></a>Firstbird tesztfelhasználó létrehozása

Ebben a szakaszban egy Britta Simon nevű felhasználó Firstbird jön létre. Firstbird támogatja a just-in-time-kiépítés, amely alapértelmezés szerint engedélyezve van. Nincs meg ebben a szakaszban a művelet elem. Ha a felhasználó már nem létezik az Firstbird, amikor megpróbálja elérni Firstbird egy új jön létre.

### <a name="test-single-sign-on"></a>Az egyszeri bejelentkezés tesztelése

Ebben a szakaszban tesztelni az Azure AD egyszeri bejelentkezés beállításai a hozzáférési panelen.

Ha a hozzáférési panelen a Firstbird csempére kattint, meg kell lehet automatikusan bejelentkezett a Firstbird, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
