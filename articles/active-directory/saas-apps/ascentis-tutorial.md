---
title: 'Oktatóanyag: Azure Active Directory integráció a megmászással | Microsoft Docs'
...
---
# <a name="tutorial-integrate-ascentis-with-azure-active-directory"></a>Oktatóanyag: Átfedések integrálása a Azure Active Directory
...
Az egyszeri bejelentkezés a **Megmászási** oldalon való konfigurálásához el kell küldenie a letöltött **tanúsítványt (Base64)** és a megfelelő másolt url-címeket a Azure Portal az [átfedések támogatási csapatának](mailto:support@ascentis.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
Ebben a szakaszban egy Britta Simon nevű felhasználót hoz létre az átfedésben. A feljutást [támogató csapattal](mailto:support@ascentis.com) együtt veheti fel a felhasználókat az emelkedési platformba. Felhasználók kell létrehozni és egyszeri bejelentkezés használata előtt aktiválva.
