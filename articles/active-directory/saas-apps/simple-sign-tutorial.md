...
2. **[Egyszerű aláírási egyszeri bejelentkezés konfigurálása](#configure-simple-sign-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
### <a name="configure-simple-sign-single-sign-on"></a>Egyszerű aláírás egyszeri bejelentkezésének konfigurálása
