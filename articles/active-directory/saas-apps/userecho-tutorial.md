...
* Szabályozhatja, ki férhet hozzá UserEcho Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve UserEcho (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* UserEcho egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a UserEcho **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **UserEcho**válassza **UserEcho** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában UserEcho](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az UserEcho nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó UserEcho hivatkozás kapcsolata kell létrehozni.
...
2. **[UserEcho egyszeri bejelentkezés konfigurálása](#configure-userecho-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre UserEcho tesztfelhasználót](#create-userecho-test-user)**  – egy megfelelője a Britta Simon UserEcho, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **UserEcho** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![UserEcho tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier.png)

    a. Az a **bejelentkezési URL-cím** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<companyname>.userecho.com/`

    b. Az a **azonosító (entityid)** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<companyname>.userecho.com/saml/metadata/`

    > [!NOTE]
    > Ezek a értékei nem valódi. Frissítse a tényleges bejelentkezési URL-címet és azonosító ezeket az értékeket. Kapcsolattartó [UserEcho ügyfél-támogatási csapatának](https://feedback.userecho.com/) beolvasni ezeket az értékeket. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.
...
6. Az a **UserEcho beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
2. A felső eszköztáron kattintson a felhasználónevére, bontsa ki a menüben, és kattintson **telepítő**.
   
    ![Egyszeri bejelentkezés konfigurálása](./media/userecho-tutorial/tutorial_userecho_06.png) 

3. Kattintson a **Integrációk**.
...
5. Az a **egyszeri bejelentkezés (SAML)** lapon, a következő lépésekkel:
    ...
    b. Beillesztés **bejelentkezési URL-cím**, azokat az Azure Portalról másolt a **SAML egyszeri bejelentkezési URL-cím** szövegmezőbe.
    
    c. Beillesztés **kijelentkezési URL-címe**, az Azure Portalról másolt a **távoli kijelentkezési URL-címe** szövegmezőbe.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **UserEcho**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **UserEcho**.

    ![Az alkalmazások listáját a UserEcho hivatkozásra](common/all-applications.png)
...
3. Kattintson a **felhasználók**, bontsa ki a **felhasználók** szakaszban.
...
5. Kattintson a **egy új felhasználó meghívása**.
   
    ![Egyszeri bejelentkezés konfigurálása](./media/userecho-tutorial/tutorial_userecho_12.png)

6. Az a **egy új felhasználó meghívása** párbeszédpanelen hajtsa végre az alábbi lépéseket:
