...
4. Írja be a keresőmezőbe, **TimeLive**, jelölje be **TimeLive** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában TimeLive](./media/timelive-tutorial/tutorial_timelive_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/timelive-tutorial/tutorial_timelive_samlbase.png)

3. Az a **TimeLive tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk TimeLive tartomány és az URL-címek](./media/timelive-tutorial/tutorial_timelive_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** kattintson **Certificate(Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/timelive-tutorial/tutorial_timelive_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/timelive-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **TimeLive**.
    ...
    ![Az alkalmazások listáját a TimeLive hivatkozás](./media/timelive-tutorial/tutorial_timelive_app.png)  
