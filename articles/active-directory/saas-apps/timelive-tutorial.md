---
title: 'Oktatóanyag: Azure Active Directory-integráció az TimeLive |} A Microsoft Docs'
...
ms.locfileid: "39041255"
---
# <a name="tutorial-azure-active-directory-integration-with-timelive"></a>Oktatóanyag: Azure Active Directory-integráció az TimeLive
...
3. **[Hozzon létre egy TimeLive tesztfelhasználót](#create-a-timelive-test-user)**  – egy megfelelője a Britta Simon TimeLive, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **TimeLive tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **TimeLive konfigurációs** területén kattintson **konfigurálása TimeLive** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-CÍMÉT és a SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![TimeLive konfiguráció](./media/timelive-tutorial/tutorial_timelive_configure.png)

7. Egy másik böngészőablakban jelentkezzen be a TimeLive vállalati hely rendszergazdaként.

8. Válassza ki **beállítások** alatt **rendszergazdai beállítások**.

    ![TimeLive konfiguráció](./media/timelive-tutorial/configure1.png)

9. Az a **alkalmazás szabályozó** szakaszban, hajtsa végre az alábbi lépéseket:
