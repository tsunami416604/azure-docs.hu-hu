...
1. Az **alapszintű SAML-konfiguráció** szakaszban adja meg a következő mezők értékeit:
    ...
    a. A **bejelentkezési URL-cím** szövegmezőbe írja be a következő URL-címet: `https://<COMPANYNAME>.bizagi.com/<PROJECTNAME>`

    b. Az **azonosító (Entity ID)** szövegmezőbe írja be a következő URL-címet: `https://<COMPANYNAME>.bizagi.com/<PROJECTNAME>`
