...
2. Egyszeri **[Bejelentkezés konfigurálása](#configure-inkling-single-sign-on)** – az Sign-On beállításainak konfigurálása az alkalmazás oldalán.
...
### <a name="configure-inkling-single-sign-on"></a>Egyszeres Sign-On konfigurálása
...
Ha a hozzáférési panelen rákattint a insejtes csempére, automatikusan be kell jelentkeznie a megjelenő üzenetbe, amelyhez be kell állítania az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
