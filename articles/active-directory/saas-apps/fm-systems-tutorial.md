...
* Szabályozhatja, ki férhet hozzá FM:Systems Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve FM:Systems (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* FM:Systems egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a FM:Systems **Identitásszolgáltató** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **FM:Systems**válassza **FM:Systems** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában FM:Systems](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az FM:Systems nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó FM:Systems hivatkozás kapcsolata kell létrehozni.
...
2. **[FM:Systems egyszeri bejelentkezés konfigurálása](#configure-fmsystems-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre FM:Systems tesztfelhasználót](#create-fmsystems-test-user)**  – egy megfelelője a Britta Simon a felhasználó Azure ad-ben reprezentációja kapcsolódó FM:Systems rendelkeznie.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **FM:Systems** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![FM:Systems tartomány és URL-címeket egyetlen bejelentkezési adatait](common/both-replyurl.png)
...
6. Az a **FM:Systems beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **FM:Systems**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **FM:Systems**.

    ![Az alkalmazások listáját a FM:Systems hivatkozásra](common/all-applications.png)
...
### <a name="create-fmsystems-test-user"></a>FM:Systems tesztfelhasználó létrehozása
...
Ha a hozzáférési panelen a FM:Systems csempére kattint, meg kell lehet automatikusan bejelentkezett a FM:Systems, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
