...
3. **[Hozzon létre egy PlanMyLeave tesztfelhasználót](#create-a-planmyleave-test-user)**  – egy megfelelője a Britta Simon PlanMyLeave, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **PlanMyLeave tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **PlanMyLeave konfigurációs** területén kattintson **konfigurálása PlanMyLeave** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![PlanMyLeave konfiguráció](./media/planmyleave-tutorial/tutorial_planmyleave_configure.png) 
7. Egy másik böngészőablakban jelentkezzen be rendszergazdaként a PlanMyLeave bérlő.

8. Lépjen a **rendszerbeállítás**. Ezután a a **biztonságkezelés** szakaszban kattintson **vállalati SAML-beállítások** .

    ![Egyszeri bejelentkezés az alkalmazás oldalán konfigurálása](./media/planmyleave-tutorial/tutorial_planmyleave_002.png) 

9. Az a **SAML-beállítások** területén kattintson a szerkesztőben ikonra.
