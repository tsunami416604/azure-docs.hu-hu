...
2. **[PlanMyLeave egyszeri bejelentkezés konfigurálása](#configure-planmyleave-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
2. Nyissa meg a **rendszerbeállítást**. Ezután a **biztonság kezelése** szakaszban kattintson a **vállalati SAML-beállítások** elemre.
    ...
    ![Egyszeri bejelentkezés konfigurálása az alkalmazás oldalán](./media/planmyleave-tutorial/tutorial_planmyleave_002.png) 

3. Az **SAML-beállítások** szakaszban kattintson a szerkesztő ikonra.

    ![Egyszeri bejelentkezés konfigurálása az alkalmazás oldalán](./media/planmyleave-tutorial/tutorial_planmyleave_003.png)

4. Az **SAML-beállítások frissítése** szakaszban hajtsa végre a következő lépéseket:

    ![Egyszeri bejelentkezés konfigurálása az alkalmazás oldalán](./media/planmyleave-tutorial/tutorial_planmyleave_004.png)
...
Ha a hozzáférési panelen a PlanMyLeave csempére kattint, automatikusan be kell jelentkeznie arra a PlanMyLeave, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
