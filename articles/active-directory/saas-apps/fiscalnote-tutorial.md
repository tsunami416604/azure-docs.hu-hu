...
4. Írja be a keresőmezőbe, **FiscalNote**, jelölje be **FiscalNote** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában FiscalNote](./media/fiscalnote-tutorial/tutorial_fiscalnote_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/fiscalnote-tutorial/tutorial_fiscalnote_samlbase.png)

3. Az a **FiscalNote tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk FiscalNote tartomány és az URL-címek](./media/fiscalnote-tutorial/tutorial_fiscalnote_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** kattintson **Certificate(Raw)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/fiscalnote-tutorial/tutorial_fiscalnote_certificate.png)
...
7. Kattintson a **mentése** gombra.
    ...
    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/fiscalnote-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **FiscalNote**.
    ...
    ![Az alkalmazások listáját a FiscalNote hivatkozás](./media/fiscalnote-tutorial/tutorial_fiscalnote_app.png)  
