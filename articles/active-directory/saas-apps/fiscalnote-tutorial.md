---
title: 'Oktatóanyag: Azure Active Directory-integráció az FiscalNote |} A Microsoft Docs'
...
ms.locfileid: "39047409"
---
# <a name="tutorial-azure-active-directory-integration-with-fiscalnote"></a>Oktatóanyag: Azure Active Directory-integráció az FiscalNote
...
3. **[Hozzon létre egy FiscalNote tesztfelhasználót](#create-a-fiscalnote-test-user)**  – egy megfelelője a Britta Simon FiscalNote, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **FiscalNote tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
8. Az a **FiscalNote konfigurációs** területén kattintson **konfigurálása FiscalNote** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-címe, SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![FiscalNote konfiguráció](./media/fiscalnote-tutorial/tutorial_fiscalnote_configure.png) 

9. Az egyszeri bejelentkezés konfigurálása **FiscalNote** oldalon kell küldenie a letöltött **Certificate(Raw), kijelentkezéses URL-címe, SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** való [FiscalNote támogatási csoport](mailto:support@fiscalnote.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
