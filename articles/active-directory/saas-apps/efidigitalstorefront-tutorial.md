---
title: 'Oktatóanyag: Azure Active Directory-integráció az EFI digitális kirakat |} A Microsoft Docs'
...
3. **[Hozzon létre egy EFI digitális kirakat tesztfelhasználót](#create-a-efi-digital-storefront-test-user)**  – egy megfelelője a Britta Simon EFI digitális megjelennie, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **EFI digitális kirakat tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
