...
4. Írja be a keresőmezőbe, **EFI digitális kirakat**, jelölje be **EFI digitális kirakat** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![EFI digitális kirakat az eredménylistában](./media/efidigitalstorefront-tutorial/tutorial_efidigital_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/efidigitalstorefront-tutorial/tutorial_efidigital_samlbase.png)

3. Az a **EFI digitális kirakat tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk EFI digitális kirakat tartomány és az URL-címek](./media/efidigitalstorefront-tutorial/tutorial_efidigital_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/efidigitalstorefront-tutorial/tutorial_efidigital_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/efidigitalstorefront-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **EFI digitális kirakat**.
    ...
    ![Az alkalmazások listáját az EFI digitális kirakat hivatkozás](./media/efidigitalstorefront-tutorial/tutorial_efidigital_app.png)  
