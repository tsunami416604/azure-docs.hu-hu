...
4. Írja be a keresőmezőbe, **etouches**, jelölje be **etouches** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![az eredménylistában etouches](./media/etouches-tutorial/tutorial_etouches_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/etouches-tutorial/tutorial_etouches_samlbase.png)

3. Az a **etouches tartomány és az URL-címek** területen tegye a következőket:

    ![az egyszeri bejelentkezési adatokat etouches tartomány és az URL-címek](./media/etouches-tutorial/tutorial_etouches_url.png)
...
6. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/etouches-tutorial/tutorial_etouches_certificate.png) 

7. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/etouches-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **etouches**.
    ...
    ![Az alkalmazások listáját a etouches hivatkozás](./media/etouches-tutorial/tutorial_etouches_app.png) 
