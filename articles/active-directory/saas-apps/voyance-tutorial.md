...
2. **[Voyance egyszeri bejelentkezés konfigurálása](#configure-voyance-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
2. Lépjen a navigációs sáv jobb felső sarkába, és kattintson a **profil**elemre.
    ...
    ![Egyszeri bejelentkezés konfigurálása az App Side Acme Egyetemen](./media/voyance-tutorial/tutorial_voyance_001.png) 

3. Kattintson a **rendszergazdai beállítások**elemre.

    ![Egyszeri bejelentkezés konfigurálása az alkalmazás oldalán rendszergazdai beállítások](./media/voyance-tutorial/tutorial_voyance_002.png)

4. Kattintson a **felhasználói hozzáférés** fülre.

    ![Egyszeri bejelentkezés konfigurálása az alkalmazás oldali felhasználói hozzáféréshez](./media/voyance-tutorial/tutorial_voyance_003.png)

5. Ha az Azure AD-t az SAML 2,0-et használó identitásszolgáltató szeretné konfigurálni, kattintson az **SSO letiltva** gombra.

    ![Az egyszeri bejelentkezés konfigurálása az alkalmazás oldali egyszeri bejelentkezéshez letiltva gomb](./media/voyance-tutorial/tutorial_voyance_004.png)

6. Nyissa meg az **SAML v2** szakaszt, és hajtsa végre az alábbi lépéseket:

    ![Egyszeri bejelentkezés konfigurálása az alkalmazás oldali SAML v2-ben](./media/voyance-tutorial/tutorial-voyance-005.png)
...
Ha a hozzáférési panelen a voyance csempére kattint, automatikusan be kell jelentkeznie arra a voyance, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
