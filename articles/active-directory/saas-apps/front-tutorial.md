...
4. Írja be a keresőmezőbe, **első**, jelölje be **első** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában első](./media/front-tutorial/tutorial_front_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/front-tutorial/tutorial_front_samlbase.png)
...
2. Az alkalmazások listában válassza ki a **első**.
    ...
    ![Az alkalmazások listáját az első hivatkozás](./media/front-tutorial/tutorial_front_app.png)  
