...
2. **[Secret Server (on-PREMISES) SSO konfigurálása](#configure-secret-server-on-premises-sso)** – az egyes Sign-On beállításainak konfigurálása az alkalmazás oldalán.
