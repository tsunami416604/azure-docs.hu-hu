...
3. **[Samanage tesztfelhasználó létrehozása](#creating-a-samanage-test-user)**  – egy megfelelője a Britta Simon Samanage, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Samanage tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Samanage konfigurációs** területén kattintson **konfigurálása Samanage** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-CÍMÉT, és a SAML Entitásazonosító** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/samanage-tutorial/tutorial_samanage_configure.png) 

7. Egy másik böngészőablakban jelentkezzen be a Samanage vállalati hely rendszergazdaként.
...
10. Navigáljon a **bejelentkezési SAML használatával** szakaszban, hajtsa végre az alábbi lépéseket:
