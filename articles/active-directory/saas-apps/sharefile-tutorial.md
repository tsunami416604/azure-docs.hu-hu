...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    a. A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://<tenant-name>.sharefile.com/saml/login`
...
2. Kattintson a **felhasználók kezelése lehetőségre \> a felhasználók kezelése kezdőlap \> + alkalmazott létrehozása**elemre.
...
3. Az **alapszintű információ** szakaszban hajtsa végre az alábbi lépéseket:
    ...
    a. Az **E-mail cím** szövegmezőbe írja be a Britta Simon e-mail-címét **brittasimon\@contoso.com**.
