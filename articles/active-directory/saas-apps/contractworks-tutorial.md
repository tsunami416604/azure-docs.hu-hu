...
4. Írja be a keresőmezőbe, **ContractWorks**, jelölje be **ContractWorks** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában ContractWorks](./media/contractworks-tutorial/tutorial_contractworks_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/contractworks-tutorial/tutorial_contractworks_samlbase.png)
...
3. Az a **ContractWorks tartomány és az URL-címek** területen tegye a következőket, ha szeretne beállítani az alkalmazás **IDP** kezdeményezett mód:
    ...
    ![Az egyszeri bejelentkezés információk ContractWorks tartomány és az URL-címek](./media/contractworks-tutorial/tutorial_contractworks_url.png)

    Az a **azonosító** szövegmezőhöz URL-címet írja be: `https://login.securedocs.com/saml/metadata`

4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:

    ![Az egyszeri bejelentkezés információk ContractWorks tartomány és az URL-címek](./media/contractworks-tutorial/tutorial_contractworks_url1.png)
...
8. Kattintson a **mentése** gombra.
    ...
    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/contractworks-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **ContractWorks**.
    ...
    ![Az alkalmazások listáját a ContractWorks hivatkozás](./media/contractworks-tutorial/tutorial_contractworks_app.png)  
