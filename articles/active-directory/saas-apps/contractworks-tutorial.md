...
Az egyszeri bejelentkezés **ContractWorks** -oldalon való konfigurálásához el kell küldenie az **alkalmazás-összevonási metaadatok URL-címét** a [ContractWorks támogatási csapatának](mailto:support@contractworks.com). Ezt a beállítást úgy állították be, hogy az SAML SSO-kapcsolatok mindkét oldalon helyesen legyenek beállítva.

### <a name="create-contractworks-test-user"></a>ContractWorks-tesztelési felhasználó létrehozása

Ebben a szakaszban egy B. Simon nevű felhasználót hoz létre a ContractWorks-ben. Együttműködik a [ContractWorks támogatási csapatával](mailto:support@contractworks.com) , hogy hozzáadja a felhasználókat a ContractWorks platformhoz. Az egyszeri bejelentkezés használata előtt létre kell hozni és aktiválni kell a felhasználókat.

## <a name="test-sso"></a>Egyszeri bejelentkezés tesztelése 

Ebben a szakaszban az Azure AD egyszeri bejelentkezési konfigurációját teszteli a hozzáférési panel használatával.

Ha a hozzáférési panelen a ContractWorks csempére kattint, automatikusan be kell jelentkeznie arra a ContractWorks, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
