...
1. Az **alapszintű SAML-konfiguráció** szakaszban adja meg a következő mezők értékeit:
    ...
    A **bejelentkezési URL** szövegmezőbe írja be a következő URL-címet: `https://my.splashtop.com/login/sso`
...
1. A Splashtop web Portalon lépjen a **fiók adatai** / **csapat** lapra, és görgessen le az **egyszeri bejelentkezések** kereséséhez. Ezután kattintson **az alkalmaz új SSO-metódusra**elemre.
...
1. A tanúsítvány adatainak megtekintéséhez kattintson a jobb gombbal a Splashtop alkalmazásból letöltött tanúsítvány fájlra Azure Portal, szerkessze a jegyzettömböt, majd másolja ki a tartalmat, illessze be a **tanúsítvány letöltése (Base64)** mezőbe.
    ...
    ![rendszerkép](media/splashtop-tutorial/cert-1.png) ![rendszerkép](media/splashtop-tutorial/cert-2.png) ![rendszerkép](media/splashtop-tutorial/azure-sso-2.png)
...
1. Hívja meg a teszt felhasználót, például `B.Simon@contoso.com` a Splashtop csapata számára az újonnan létrehozott SSO-módszerrel.
