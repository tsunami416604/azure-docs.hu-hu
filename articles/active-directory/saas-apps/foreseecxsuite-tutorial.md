---
title: 'Oktatóanyag: A CX Suite bizonyulhat az Azure Active Directory-integráció |} A Microsoft Docs'
...
* Engedélyezheti a felhasználóknak, hogy a rendszer automatikusan bejelentkezett CX Suite fája (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* CX csomag egyetlen bejelentkezési engedélyezett előfizetéssel fája

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a CX Suite fája **SP** által kezdeményezett egyszeri bejelentkezés

* Támogatja a CX Suite fája **igény szerinti** felhasználók átadása
...
4. A Keresés mezőbe írja be a **CX Suite bizonyulhat**, jelölje be **fája CX Suite** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
     ...
     ![Az eredmények listájában CX Suite fája](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az fája CX Suite nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó fája CX Suite hivatkozás kapcsolata kell létrehozni.
...
2. **[Fája CX Suite egyszeri bejelentkezés konfigurálása](#configure-foresee-cx-suite-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre fája CX Suite tesztfelhasználót](#create-foresee-cx-suite-test-user)**  – van egy megfelelője a Britta Simon fája CX csomag, amely kapcsolódik az Azure AD felhasználói ábrázolása.
...
1. Az a [az Azure portal](https://portal.azure.com/), a a **fája CX Suite** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezési**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszt, ha rendelkezik **szolgáltató metaadatait tartalmazó fájl**, hajtsa végre az alábbi lépéseket:
    ...
    c. A metaadatfájl sikeres feltöltése után a **azonosító** érték alapszintű SAML-konfigurációja szakasz automatikusan lekéri.

    ![Fája CX Suite tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier.png)
...
6. Az a **fája CX Suite beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-foresee-cx-suite-single-sign-on"></a>Konfigurálása CX Suite egyszeri bejelentkezés fája

Az egyszeri bejelentkezés konfigurálása **fája CX Suite** oldalon kell küldenie a letöltött **összevonási metaadatainak XML** és az Azure Portalról másolt URL-címek megfelelő [fája CX támogatás csapat](mailto:support@foresee.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **CX Suite bizonyulhat**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **fája CX Suite**.

    ![A CX Suite fája hivatkozásra az alkalmazások listáját](common/all-applications.png)
...
Ha a hozzáférési panelen a CX Suite fája csempére kattint, akkor kell automatikusan megtörténik a az fája CX Suite, amelynek beállítása egyszeri Bejelentkezést. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
