...
2. **[Mercell egyszeri bejelentkezés konfigurálása](#configure-mercell-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    Az **azonosító** szövegmezőbe írja be az URL-címet:  `https://my.mercell.com/`
...
### <a name="configure-mercell-single-sign-on"></a>Mercell egyetlen Sign-On konfigurálása
...
Ha a hozzáférési panelen a Mercell csempére kattint, automatikusan be kell jelentkeznie arra a Mercell, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
