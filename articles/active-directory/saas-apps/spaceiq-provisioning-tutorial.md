...
5. A **rendszergazdai hitelesítő adatok** szakaszban adja meg a `https://api.spaceiq.com/scim` a **bérlői URL-címben**. Adja meg a **scim-hitelesítési jogkivonat** értékét a **titkos tokenben**. Kattintson a **kapcsolat tesztelése** lehetőségre, hogy az Azure ad képes legyen csatlakozni a SpaceIQ. Ha a kapcsolat meghiúsul, győződjön meg arról, hogy a SpaceIQ-fiókja rendszergazdai jogosultságokkal rendelkezik, és próbálkozzon újra.
