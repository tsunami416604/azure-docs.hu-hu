...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_samlbase.png)

3. Az a **RedBrick állapotfigyelő tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezési adatokat redBrick állapotfigyelő tartomány- és URL-címek](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_url.png)
    ...
    ![Az egyszeri bejelentkezési adatokat redBrick állapotfigyelő tartomány- és URL-címek](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_url1.png)
...
6. Az a **SAML-aláíró tanúsítványa** kattintson **Certificate(Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_certificate.png) 

7. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/redbrickhealth-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **RedBrick állapotfigyelő**.
    ...
    ![Az alkalmazások listáját a RedBrick állapotfigyelő hivatkozás](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_app.png)  
