...
3. **[Hozzon létre egy Eli bevezetési tesztfelhasználót](#create-an-eli-onboarding-test-user)**  – egy megfelelője a Britta Simon Eli bevezetése, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Eli bevezetési tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **Eli bevezetési** oldalon kell küldenie a letöltött **metaadatainak XML** való [Eli bevezetési támogatási csapat](mailto:support@geteli.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
