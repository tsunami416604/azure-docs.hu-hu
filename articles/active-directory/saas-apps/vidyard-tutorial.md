---
title: 'Oktatóanyag: Azure Active Directory-integráció az Vidyard |} A Microsoft Docs'
...
ms.locfileid: "39056225"
---
# <a name="tutorial-azure-active-directory-integration-with-vidyard"></a>Oktatóanyag: Azure Active Directory-integráció az Vidyard
...
3. **[Hozzon létre egy Vidyard tesztfelhasználót](#create-a-vidyard-test-user)**  – egy megfelelője a Britta Simon Vidyard, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Vidyard tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód:
...
7. Az a **Vidyard konfigurációs** területén kattintson **konfigurálása Vidyard** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Vidyard konfiguráció](./media/vidyard-tutorial/tutorial_vidyard_configure.png)

8. Egy másik böngészőablakban jelentkezzen be a Vidyard szoftver vállalati hely rendszergazdaként.

9. A Vidyard irányítópultján válassza ki **csoport** > **biztonsági**
...
11. Az a **SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
...
12. Válassza az egyszeri bejelentkezés lap **hozzárendelése** mellett egy meglévő profilt
...
13. Válassza ki a szervezet csoport, amely látható a **rendelje hozzá a rendelkezésre álló csoportok**.

    ![Vidyard konfiguráció](./media/vidyard-tutorial/configure5.png)

14. A hozzárendelt csoportokat láthatja a **jelenleg hozzárendelt csoportok**. Válasszon egy szerepkört beállításával a szervezet, és kattintson a csoport **megerősítése**.
