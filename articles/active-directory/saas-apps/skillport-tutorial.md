...
Ebből az oktatóanyagból megtudhatja, hogyan integrálhatja a Skillport a Azure Active Directory (Azure AD) szolgáltatással.
A Skillport és az Azure AD integrálásával a következő előnyöket nyújtja:

* Az Azure AD-ben beállíthatja, hogy ki férhet hozzá a Skillport.
* Lehetővé teheti a felhasználók számára, hogy automatikusan bejelentkezzenek a Skillport (egyszeri bejelentkezés) az Azure AD-fiókokkal.
...
Az Azure AD-integráció Skillport való konfigurálásához a következő elemek szükségesek:

* Egy Azure AD-előfizetés. Ha nem rendelkezik Azure AD-környezettel, [ingyenes fiókot](https://azure.microsoft.com/free/) szerezhet be
* Skillport egyszeri bejelentkezésre engedélyezett előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban egy tesztkörnyezetben konfigurálja és teszteli az Azure AD egyszeri bejelentkezést.

* A Skillport támogatja az **SP** által KEZDEMÉNYEZett SSO-t

## <a name="adding-skillport-from-the-gallery"></a>Skillport hozzáadása a gyűjteményből

A Skillport Azure AD-be való integrálásának konfigurálásához hozzá kell adnia a Skillport a katalógusból a felügyelt SaaS-alkalmazások listájához.

**Ha Skillport szeretne hozzáadni a katalógusból, hajtsa végre a következő lépéseket:**
...
2. **[Skillport egyszeri bejelentkezés konfigurálása](#configure-skillport-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
3. **[Azure ad-felhasználó létrehozása](#create-an-azure-ad-test-user)** – az Azure ad egyszeri bejelentkezés teszteléséhez a Britta Simon használatával.
4. **[Az Azure ad-teszt felhasználójának kiosztása](#assign-the-azure-ad-test-user)** – a Britta Simon engedélyezése az Azure ad egyszeri bejelentkezés használatára.
5. **[Hozzon létre Skillport-teszt felhasználót](#create-skillport-test-user)** – hogy a Skillport Britta, a felhasználó Azure ad-képviseletéhez kapcsolódó partnerrel rendelkezzen.
...
6. A **Skillport beállítása** szakaszban másolja ki a megfelelő URL-címeket a követelmények szerint.
...
### <a name="configure-skillport-single-sign-on"></a>Skillport egyetlen Sign-On konfigurálása
...
Ha a hozzáférési panelen a Skillport csempére kattint, automatikusan be kell jelentkeznie arra a Skillport, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
