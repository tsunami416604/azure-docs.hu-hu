...
* Szabályozhatja, ki férhet hozzá Skillport Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Skillport (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Skillport egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a Skillport **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **Skillport**válassza **Skillport** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

    ![Az eredmények listájában Skillport](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az Skillport nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó Skillport hivatkozás kapcsolata kell létrehozni.
...
2. **[Skillport egyszeri bejelentkezés konfigurálása](#configure-skillport-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre Skillport tesztfelhasználót](#create-skillport-test-user)**  – egy megfelelője a Britta Simon Skillport, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Skillport** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![Skillport tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier-reply.png)
    ...
    b. Az a **azonosító** mezőbe írja be az URL-cím:
...
6. Az a **Skillport beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
Az egyszeri bejelentkezés konfigurálása **Skillport** oldalon kell küldenie a letöltött **összevonási metaadatainak XML** és az Azure Portalról másolt URL-címek megfelelő [Skillport támogatási csapatának](https://www.skillsoft.com/contact.asp). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Skillport**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Skillport**.

    ![Az alkalmazások listáját a Skillport hivatkozásra](common/all-applications.png)
...
### <a name="create-skillport-test-user"></a>Skillport tesztfelhasználó létrehozása
