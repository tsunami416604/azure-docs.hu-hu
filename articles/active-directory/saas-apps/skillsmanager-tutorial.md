---
title: 'Oktatóanyag: Azure Active Directory-integráció és az ismeretek Manager |} A Microsoft Docs'
...
ms.locfileid: "39050680"
---
# <a name="tutorial-azure-active-directory-integration-with-skills-manager"></a>Oktatóanyag: Azure Active Directory-integráció és az ismeretek Manager
...
3. **[Hozzon létre egy képességek Manager tesztfelhasználót](#create-a-skills-manager-test-user)**  – egy megfelelője a Britta Simon rendelkezik, amely kapcsolódik az Azure AD felhasználói ábrázolása képességek Managerben.
...
3. Az a **képességek Manager tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
