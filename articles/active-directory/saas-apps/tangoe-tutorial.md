...
2. A **[Tango Premium Mobile egyszeri bejelentkezés beállítása](#configure-tangoe-command-premium-mobile-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
### <a name="configure-tangoe-command-premium-mobile-single-sign-on"></a>A Tango Premium Mobile egyszeri bejelentkezés konfigurálása
