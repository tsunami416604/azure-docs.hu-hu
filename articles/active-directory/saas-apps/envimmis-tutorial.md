...
* Engedélyezheti a felhasználóknak, hogy a rendszer automatikusan bejelentkezve Envi MMIS (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Envi MMIS egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a Envi MMIS **SP** és **Identitásszolgáltató** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **Envi MMIS**válassza **Envi MMIS** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
     ...
     ![Az eredmények listájában Envi MMIS](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban konfigurálni és tesztelés az Azure AD egyszeri bejelentkezés Envi MMIS nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó Envi MMIS hivatkozás kapcsolata kell létrehozni.
...
2. **[Envi MMIS egyszeri bejelentkezés konfigurálása](#configure-envi-mmis-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre Envi MMIS tesztfelhasználót](#create-envi-mmis-test-user)**  – egy megfelelője a Britta Simon Envi MMIS, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Envi MMIS** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszra, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód, hajtsa végre az alábbi lépéseket:
    ...
    ![Envi MMIS tartomány és URL-címeket egyetlen bejelentkezési adatait](common/idp-intiated.png)

    a. Az a **azonosító** szövegmezőbe írja be a következő minta használatával URL-cím: `https://www.<CUSTOMER DOMAIN>.com/Account`

    b. Az a **válasz URL-cím** szövegmezőbe írja be a következő minta használatával URL-cím: `https://www.<CUSTOMER DOMAIN>.com/Account/Acs`

5. Kattintson a **további URL-címet beállítani** , és hajtsa végre a következő lépést, ha az alkalmazás a konfigurálni kívánt **SP** kezdeményezett mód:

    ![Envi MMIS tartomány és URL-címeket egyetlen bejelentkezési adatait](common/metadata-upload-additional-signon.png)

    Az a **bejelentkezési URL-** szövegmezőbe írja be a következő minta használatával URL-cím:  `https://www.<CUSTOMER DOMAIN>.com/Account`

    > [!NOTE]
    > Ezek a értékei nem valódi. Az értékeket módosítsa a tényleges azonosítóját, válasz URL-cím és bejelentkezési URL-címet. Kapcsolattartó [Envi MMIS ügyfél-támogatási csapatának](mailto:support@ioscorp.com) beolvasni ezeket az értékeket. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.
...
7. Az a **Envi MMIS beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
4. Válassza ki **távoli hitelesítés használata** jelölőnégyzetet, majd **HTTP-átirányítás** származó a **hitelesítési típus** legördülő listából.

    ![Egyszeri bejelentkezés Mentés gomb konfigurálása](./media/envimmis-tutorial/configure3.png)

5. Válassza ki **erőforrások** fülre, majd **metaadatok feltöltése**.

    ![Egyszeri bejelentkezés Mentés gomb konfigurálása](./media/envimmis-tutorial/configure4.png)

6. Az a **metaadatok feltöltése** előugró ablakban hajtsa végre az alábbi lépéseket:
...
7. A letöltött metaadat-fájl feltöltése után a mezők automatikusan fog első betöltve. Kattintson a **Update**
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Envi MMIS**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Envi MMIS**.

    ![Az alkalmazások listáját a Envi MMIS hivatkozás](common/all-applications.png)
...
Ahhoz, hogy az Azure AD-felhasználók Envi MMIS bejelentkezni, akkor ki kell építeni Envi MMIS be. Envi MMIS, esetén kiépítése a manuális feladat.

**Üzembe helyez egy felhasználói fiókot, hajtsa végre az alábbi lépéseket:**

1. Jelentkezzen be rendszergazdaként a Envi MMIS vállalati webhely.

2. Kattintson a **Felhasználólista** fülre.
...
Ha a hozzáférési panelen a Envi MMIS csempére kattint, meg kell lehet automatikusan bejelentkezett a Envi MMIS, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
