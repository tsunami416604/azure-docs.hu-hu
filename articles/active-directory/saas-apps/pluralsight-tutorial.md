...
4. Írja be a keresőmezőbe, **Pluralsight**, jelölje be **Pluralsight** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Pluralsight](./media/pluralsight-tutorial/tutorial_pluralsight_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/pluralsight-tutorial/tutorial_pluralsight_samlbase.png)

3. Az a **Pluralsight tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk Pluralsight tartomány és az URL-címek](./media/pluralsight-tutorial/tutorial_pluralsight_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/pluralsight-tutorial/tutorial_pluralsight_certificate.png) 
...
2. Az alkalmazások listában válassza ki a **Pluralsight**.
    ...
    ![Az alkalmazások listáját a Pluralsight hivatkozás](./media/pluralsight-tutorial/tutorial_pluralsight_app.png)  
