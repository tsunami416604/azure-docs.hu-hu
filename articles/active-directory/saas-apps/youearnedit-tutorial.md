---
title: 'Oktatóanyag: Az Azure Active Directory-integrációval rendelkező YouEarnedIt |} A Microsoft Docs'
...
ms.openlocfilehash: 9888bd515ef5a87ed224bc9ae98acc7e5ee922a5
ms.sourcegitcommit: 5fbca3354f47d936e46582e76ff49b77a989f299
ms.translationtype: MT
ms.contentlocale: hu-HU
ms.lasthandoff: 03/12/2019
ms.locfileid: "57773358"
---
...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve YouEarnedIt (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* YouEarnedIt egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a YouEarnedIt **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **YouEarnedIt**válassza **YouEarnedIt** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában YouEarnedIt](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az YouEarnedIt nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó YouEarnedIt hivatkozás kapcsolata kell létrehozni.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **YouEarnedIt** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
6. Az a **YouEarnedIt beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-youearnedit-single-sign-on"></a>YouEarnedIt egyszeri bejelentkezés konfigurálása

Az egyszeri bejelentkezés konfigurálása **YouEarnedIt** oldalon kell küldenie a letöltött **tanúsítvány (Base64)** és a megfelelő másolt URL-címek az Azure Portalról a hozzárendelt YouEarnedIt ügyfél sikeres kezelő. Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **YouEarnedIt**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listáját, írja be, és válassza ki **YouEarnedIt**.

    ![Az alkalmazások listáját a YouEarnedIt hivatkozásra](common/all-applications.png)
...
### <a name="create-youearnedit-test-user"></a>YouEarnedIt tesztfelhasználó létrehozása
