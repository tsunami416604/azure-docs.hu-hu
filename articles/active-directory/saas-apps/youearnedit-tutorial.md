...
1. A Keresés mezőbe írja be a **YouEarnedt**válassza **YouEarnedt** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[Hozzon létre egy YouEarnedIt tesztfelhasználót](#create-a-youearnedit-test-user)**  – egy megfelelője a Britta Simon YouEarnedIt, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a **YouEarnedIt tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    > [!NOTE] 
    > Ezek a értékei nem valódi. Ezek az értékek frissítse a tényleges bejelentkezési URL- és azonosító. Kapcsolattartó [YouEarnedIt ügyfél-támogatási csapatának](https://youearnedit.freshdesk.com/support/tickets/new) beolvasni ezeket az értékeket. 
...
1. Az a **YouEarnedIt konfigurációs** területén kattintson **konfigurálása YouEarnedIt** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![YouEarnedIt konfiguráció](./media/youearnedit-tutorial/tutorial_youearnedit_configure.png) 

1. Az egyszeri bejelentkezés konfigurálása **YouEarnedIt** oldalon kell küldenie a letöltött **Certificate(Base64)** és **SAML egyszeri bejelentkezési szolgáltatás URL-cím** való [ Támogatási csoport YouEarnedIt](https://youearnedit.freshdesk.com/support/tickets/new). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
Ebben a szakaszban egy felhasználói Britta Simon nevű YouEarnedIt hoz létre. Együttműködve YouEarnedIt támogatási csapatával a felhasználók hozzáadása az YouEarnedIt platformon.
...
1. Az alkalmazások listájában jelölje ki a **YouEarnedIt**.
