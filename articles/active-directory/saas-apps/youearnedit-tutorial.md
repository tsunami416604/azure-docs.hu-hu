...
7. Az egyszeri bejelentkezés konfigurálása **YouEarnedIt** oldalon kell küldenie a letöltött **Certificate(Base64)** és **SAML egyszeri bejelentkezési szolgáltatás URL-cím** való [ Támogatási csoport YouEarnedIt](https://youearnedit.freshdesk.com/support/tickets/new). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
