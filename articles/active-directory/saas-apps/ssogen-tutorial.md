...
Ha rákattint a SSOGEN – Azure AD SSO Gateway for Oracle E-Business Suite-EBS, PeopleSoft és JDE csempe a hozzáférési panelen, automatikusan be kell jelentkeznie a SSOGEN-Azure AD SSO Gateway for Oracle E-Business Suite-EBS, PeopleSoft és JDE, amelyhez be van állítva az egyszeri bejelentkezés. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
...
- [SSOGEN – Azure AD SSO-átjáró az Oracle E-Business Suite-EBS, PeopleSoft és JDE számára speciális láthatósággal és ellenőrzésekkel](/cloud-app-security/proxy-intro-aad)