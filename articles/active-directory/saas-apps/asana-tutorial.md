...
Ha a hozzáférési panelen rákattint a a-ra, az egyszeri bejelentkezés beállítása után automatikusan be kell jelentkeznie a következőre:. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
