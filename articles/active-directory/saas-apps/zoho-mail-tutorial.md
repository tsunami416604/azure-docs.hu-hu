...
1. A Keresés mezőbe írja be a **Zoho**válassza **Zoho** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[Zoho tesztfelhasználó létrehozása](#create-a-zoho-test-user)**  – egy megfelelője a Britta Simon Zoho, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a **Zoho tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Az a **Zoho konfigurációs** területén kattintson **konfigurálása Zoho** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-cím, jelszó URL-Címének módosítása és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**
...
1. Nyissa meg a **Vezérlőpult**.
   
    ![Vezérlőpultot](./media/zoho-mail-tutorial/ic789607.png "vezérlőpultot")

1. Kattintson a **SAML-hitelesítés** fülre.
   
    ![SAML-hitelesítés](./media/zoho-mail-tutorial/ic789608.png "SAML-hitelesítés")

1. Az a **SAML-hitelesítés részletei** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Az alkalmazások listájában jelölje ki a **Zoho**.
