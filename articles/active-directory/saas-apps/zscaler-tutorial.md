...
1. Az **alapszintű SAML-konfiguráció** szakaszban adja meg a következő mezők értékeit:
    ...
    A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://<companyname>.zscaler.net`
...
1. Lépjen az **adminisztráció > hitelesítés > hitelesítési beállítások** lapra, és hajtsa végre a következő lépéseket:
    ...
    ![Felügyeleti](./media/zscaler-tutorial/ic800206.png "Felügyelet")
...
1. Kattintson a **kapcsolatok** fülre.
    ...
    ![Kapcsolatok](./media/zscaler-tutorial/ic769493.png "Connections (Kapcsolatok)")
