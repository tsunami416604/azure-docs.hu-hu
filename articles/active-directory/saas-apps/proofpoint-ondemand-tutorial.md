...
1. A Keresés mezőbe írja be a **igény szerinti Proofpoint**, jelölje be **Proofpoint igény szerinti** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[Hozzon létre egy Proofpoint a igény szerinti tesztfelhasználó](#create-a-proofpoint-on-demand-test-user)**  – egy megfelelője a Britta Simon Proofpoint igény szerint, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a **igény szerint tartomány és URL-címekről Proofpoint** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Az alkalmazások listájában jelölje ki a **igény szerinti Proofpoint**.
