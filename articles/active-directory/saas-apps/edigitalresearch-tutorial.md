...
1. Az egyszeri bejelentkezés konfigurálása **eDigitalResearch** oldalon kell küldenie a letöltött **(Base64) tanúsítványfájl**, **SAML Entitásazonosító**, és **kijelentkezés URL-cím** való [eDigitalResearch támogatási csapatának](http://www.maruedr.com/contact). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
