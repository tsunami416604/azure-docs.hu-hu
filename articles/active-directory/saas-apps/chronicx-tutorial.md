...
3. **[Hozzon létre egy ChronicX® tesztfelhasználót](#create-a-chronicx®-test-user)**  – egy megfelelője a Britta Simon ChronicX®, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **ChronicX® tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **ChronicX®** oldalon kell küldenie a letöltött **metaadatainak XML** való [ChronicX® támogatási csapatának](https://www.casebank.com/contact-us/). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
