...
* Szabályozhatja, ki férhet hozzá a Kiteworks Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezett a Kiteworks (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Kiteworks egyszeri bejelentkezéses engedélyezett előfizetés
...
4. A Keresés mezőbe írja be a **Kiteworks**válassza **Kiteworks** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában Kiteworks](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés a Kiteworks nevű tesztfelhasználó alapján **Britta Simon**.
Egyszeri bejelentkezés működjön, az Azure AD-felhasználót és a kapcsolódó felhasználó a Kiteworks hivatkozás kapcsolata kell hozható létre.
...
2. **[Kiteworks egyszeri bejelentkezés konfigurálása](#configure-kiteworks-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Kiteworks** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![Kiteworks tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier.png)

    a. Az a **bejelentkezési URL-cím** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<subdomain>.kiteworks.com`

    b. Az a **azonosító (entityid)** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<subdomain>.kiteworks.com/sp/module.php/saml/sp/saml2-acs.php/sp-sso`
...
6. Az a **állítsa be a Kiteworks** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-kiteworks-single-sign-on"></a>Kiteworks egyszeri bejelentkezés konfigurálása
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Kiteworks**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Kiteworks**.

    ![Az alkalmazások listáját a Kiteworks hivatkozásra](common/all-applications.png)
