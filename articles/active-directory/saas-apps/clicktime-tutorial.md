...
2. **[ClickTime egyszeri bejelentkezés konfigurálása](#configure-clicktime-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
### <a name="configure-clicktime-single-sign-on"></a>ClickTime egyetlen Sign-On konfigurálása
...
Ha a hozzáférési panelen a ClickTime csempére kattint, automatikusan be kell jelentkeznie arra a ClickTime, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
