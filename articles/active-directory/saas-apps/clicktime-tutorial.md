---
title: 'Oktatóanyag: Azure Active Directory integráció a ClickTime-szel | Microsoft Docs'
description: Megtudhatja, hogyan konfigurálhat egyszeri bejelentkezést Azure Active Directory és ClickTime között.
...
Ebből az oktatóanyagból megtudhatja, hogyan integrálhatja a ClickTime a Azure Active Directory (Azure AD) szolgáltatással.
A ClickTime és az Azure AD integrálásával a következő előnyöket nyújtja:

* Az Azure AD-ben beállíthatja, hogy ki férhet hozzá a ClickTime.
* Lehetővé teheti a felhasználók számára, hogy automatikusan bejelentkezzenek a ClickTime (egyszeri bejelentkezés) az Azure AD-fiókokkal.
...
Az Azure AD-integráció ClickTime való konfigurálásához a következő elemek szükségesek:

* Egy Azure AD-előfizetés. Ha még nem rendelkezik Azure AD-környezettel, [itt](https://azure.microsoft.com/pricing/free-trial/) kérhet egy hónapos próbaverziót
* ClickTime egyszeri bejelentkezésre engedélyezett előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban egy tesztkörnyezetben konfigurálja és teszteli az Azure AD egyszeri bejelentkezést.

* A ClickTime támogatja a **identitásszolgáltató** által kezdeményezett egyszeri bejelentkezést

## <a name="adding-clicktime-from-the-gallery"></a>ClickTime hozzáadása a gyűjteményből

A ClickTime Azure AD-be való integrálásának konfigurálásához hozzá kell adnia a ClickTime a katalógusból a felügyelt SaaS-alkalmazások listájához.

**Ha ClickTime szeretne hozzáadni a katalógusból, hajtsa végre a következő lépéseket:**
...
2. **[ClickTime egyszeri bejelentkezés konfigurálása](#configure-clicktime-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
3. **[Azure ad-felhasználó létrehozása](#create-an-azure-ad-test-user)** – az Azure ad egyszeri bejelentkezés teszteléséhez a Britta Simon használatával.
4. **[Az Azure ad-teszt felhasználójának kiosztása](#assign-the-azure-ad-test-user)** – a Britta Simon engedélyezése az Azure ad egyszeri bejelentkezés használatára.
5. **[Hozzon létre ClickTime-teszt felhasználót](#create-clicktime-test-user)** – hogy a ClickTime Britta, a felhasználó Azure ad-képviseletéhez kapcsolódó partnerrel rendelkezzen.
...
4. Az **egyszeri bejelentkezés SAML-vel való beállítása** lapon hajtsa végre a következő lépéseket:
    ...
    a. Az **azonosító** szövegmezőbe írja be a következő URL-címet: `https://app.clicktime.com/sp/`
...
6. A **ClickTime beállítása** szakaszban másolja ki a megfelelő URL-címeket a követelmények szerint.
...
1. Az **egyszeri bejelentkezési beállítások** konfigurálása szakaszban hajtsa végre a következő lépéseket:
   
    ![Biztonsági beállítások](./media/clicktime-tutorial/tic777280.png "Biztonsági beállítások")
   
    a.  Jelölje be az egyszeri bejelentkezés (SSO) és az **Azure ad**használatával történő bejelentkezés **engedélyezése** jelölőnégyzetet.
...
### <a name="create-clicktime-test-user"></a>ClickTime-tesztelési felhasználó létrehozása

Ahhoz, hogy az Azure AD-felhasználók bejelentkezzenek a ClickTime, a ClickTime-ben kell kiépíteni őket.  
ClickTime esetén a kiépítés manuális feladat.

> [!NOTE]
> Az Azure AD felhasználói fiókjainak kiépítéséhez bármilyen más, a ClickTime által biztosított ClickTime felhasználói fiók létrehozására szolgáló eszközt vagy API-t használhat.
...
1. A felső eszköztáron kattintson a **vállalat**elemre, majd a **személyek**elemre.
    ...
    ![Személyek](./media/clicktime-tutorial/tic777282.png "Emberek")
...
1. Az új személy szakaszban hajtsa végre a következő lépéseket:
    ...
    ![Személyek](./media/clicktime-tutorial/tic777284.png "Emberek")
   
    a.  A **teljes név** szövegmezőbe írja be a felhasználó teljes nevét, például a **Britta Simon**nevet. 
  
    b.  Az **e-mail-cím** szövegmezőbe írja be a felhasználó, például a **brittasimon\@contoso.com**.
