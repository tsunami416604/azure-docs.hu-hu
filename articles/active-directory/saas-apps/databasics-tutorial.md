...
1. A Keresés mezőbe írja be a **DATABASICS**válassza **DATABASICS** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[Hozzon létre egy DATABASICS tesztfelhasználót](#create-a-databasics-test-user)**  – egy megfelelője a Britta Simon DATABASICS, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a **DATABASICS tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. A DATABASICS oldalon konfigurálása egyszeri bejelentkezéshez, végezze el a képernyőn az alábbi URL-cím használatával. Az űrlap elküldésekor, miután a [DATABASICS ügyfél-támogatási csapatának](https://www.data-basics.com/support/) felveszi Önnel a kapcsolatot.
...
1. Az alkalmazások listájában jelölje ki a **DATABASICS**.
