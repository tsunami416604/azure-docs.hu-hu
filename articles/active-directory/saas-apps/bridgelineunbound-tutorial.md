...
Amikor a hozzáférési panelen a bridgeline kötetlen csempére kattint, automatikusan be kell jelentkeznie arra a bridgeline, amelyhez be van állítva az egyszeri bejelentkezés. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
