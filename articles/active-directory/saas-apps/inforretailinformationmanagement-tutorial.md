...
4. Írja be a keresőmezőbe, **szakasza kereskedelmi – információkezelés**, jelölje be **szakasza kereskedelmi – információkezelés** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel a az alkalmazás.
    ...
    ![Szakasza kereskedelmi – az eredménylistában kezelése](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_samlbase.png)
...
3. Az a **szakasza kereskedelmi – információk felügyeleti tartományhoz és URL-címek** szakaszban, ha szeretne beállítani az alkalmazás által kezdeményezett IDP módban, hajtsa végre az alábbi lépéseket:
    ...
    ![Az egyszeri bejelentkezés információk IDP szakasza kereskedelmi – információk felügyeleti tartományhoz és URL-címek](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url.png)
...
4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:
    ...
    ![Szakasza kereskedelmi – információk felügyeleti tartományhoz és URL-címek egyetlen bejelentkezés információk SP](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url1.png)
...
5. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_certificate.png) 

6. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/inforretailinformationmanagement-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **szakasza kereskedelmi – információkezelés**.
    ...
    ![A szakasza kereskedelmi – kezelése hivatkozásra az alkalmazások listáját](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_app.png)  
