...
Ha a hozzáférési panelen az infor Retail-Information Management csempére kattint, automatikusan be kell jelentkeznie az infor Retail – Information Management szolgáltatásba, amelyhez az SSO-t beállította. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
