...
4. Írja be a keresőmezőbe, **Cisco felhő**, jelölje be **Cisco felhő** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Cisco felhő az eredménylistában](./media/ciscocloud-tutorial/tutorial_ciscocloud_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/ciscocloud-tutorial/tutorial_ciscocloud_samlbase.png)
...
3. Az a **Cisco felhőalapú tartományt és URL-címek** területen tegye a következőket, ha szeretne beállítani az alkalmazás **IDP** kezdeményezett mód:
    ...
    ![Cisco felhőalapú tartományt és URL-címeket az egyszeri bejelentkezés információk](./media/ciscocloud-tutorial/tutorial_ciscocloud_url.png)
...
4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:
    ...
    ![Cisco felhőalapú tartományt és URL-címeket az egyszeri bejelentkezés információk](./media/ciscocloud-tutorial/tutorial_ciscocloud_url1.png)
...
5. Az a **SAML-aláíró tanúsítványa** területen kattintson a Másolás gombra másolása **alkalmazás összevonási metaadatainak URL-címe** és illessze be a Jegyzettömbbe.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/ciscocloud-tutorial/tutorial_ciscocloud_certificate.png)

6. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/ciscocloud-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **Cisco felhő**.
    ...
    ![Az alkalmazások listáját a Cisco felhő hivatkozás](./media/ciscocloud-tutorial/tutorial_ciscocloud_app.png)  
