---
title: 'Oktatóanyag: Azure Active Directory integráció a TargetProcess-szel | Microsoft Docs'
description: Megtudhatja, hogyan konfigurálhat egyszeri bejelentkezést Azure Active Directory és TargetProcess között.
...
Ebből az oktatóanyagból megtudhatja, hogyan integrálhatja a TargetProcess a Azure Active Directory (Azure AD) szolgáltatással.
A TargetProcess és az Azure AD integrálásával a következő előnyöket nyújtja:

* Az Azure AD-ben beállíthatja, hogy ki férhet hozzá a TargetProcess.
* Lehetővé teheti a felhasználók számára, hogy automatikusan bejelentkezzenek a TargetProcess (egyszeri bejelentkezés) az Azure AD-fiókokkal.
...
Az Azure AD-integráció TargetProcess való konfigurálásához a következő elemek szükségesek:

* Egy Azure AD-előfizetés. Ha még nem rendelkezik Azure AD-környezettel, [itt](https://azure.microsoft.com/pricing/free-trial/) kérhet egy hónapos próbaverziót
* TargetProcess egyszeri bejelentkezésre engedélyezett előfizetés
...
* A TargetProcess **csak időben támogatja a** felhasználók kiépítési folyamatát

## <a name="adding-targetprocess-from-the-gallery"></a>TargetProcess hozzáadása a gyűjteményből

A TargetProcess Azure AD-be való integrálásának konfigurálásához hozzá kell adnia a TargetProcess a katalógusból a felügyelt SaaS-alkalmazások listájához.

**Ha TargetProcess szeretne hozzáadni a katalógusból, hajtsa végre a következő lépéseket:**
...
2. **[TargetProcess egyszeri bejelentkezés konfigurálása](#configure-targetprocess-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
3. **[Azure ad-felhasználó létrehozása](#create-an-azure-ad-test-user)** – az Azure ad egyszeri bejelentkezés teszteléséhez a Britta Simon használatával.
4. **[Az Azure ad-teszt felhasználójának kiosztása](#assign-the-azure-ad-test-user)** – a Britta Simon engedélyezése az Azure ad egyszeri bejelentkezés használatára.
5. **[Hozzon létre TargetProcess-teszt felhasználót](#create-targetprocess-test-user)** – hogy a TargetProcess Britta, a felhasználó Azure ad-képviseletéhez kapcsolódó partnerrel rendelkezzen.
...
6. A **TargetProcess beállítása** szakaszban másolja ki a megfelelő URL-címeket a követelmények szerint.
...
1. Kattintson az **egyszeri bejelentkezés** fülre.
    ...
    ![kattintson az egyszeres Sign-On](./media/target-process-tutorial/tutorial_target_process_07.png)
...
### <a name="create-targetprocess-test-user"></a>TargetProcess-tesztelési felhasználó létrehozása

Ebben a szakaszban egy Britta Simon nevű felhasználó jön létre a TargetProcess-ben. A TargetProcess támogatja az igény szerinti felhasználói üzembe helyezést, amely alapértelmezés szerint engedélyezve van. Ez a szakasz nem tartalmaz műveleti elemeket. Ha egy felhasználó még nem létezik a TargetProcess-ben, a rendszer egy újat hoz létre a hitelesítés után.

> [!Note]
> Ha manuálisan kell létrehoznia egy felhasználót, lépjen kapcsolatba a [TargetProcess támogatási csapatával](mailto:support@targetprocess.com).

### <a name="test-single-sign-on"></a>Az egyszeri bejelentkezés tesztelése

Ebben a szakaszban az Azure AD egyszeri bejelentkezési konfigurációját teszteli a hozzáférési panel használatával.

Ha a hozzáférési panelen a TargetProcess csempére kattint, automatikusan be kell jelentkeznie arra a TargetProcess, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
