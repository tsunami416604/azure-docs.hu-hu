---
title: 'Oktatóanyag: Azure Active Directory-integráció az Nexonia |} A Microsoft Docs'
...
ms.locfileid: "39046440"
---
# <a name="tutorial-azure-active-directory-integration-with-nexonia"></a>Oktatóanyag: Azure Active Directory-integráció az Nexonia
...
3. **[Hozzon létre egy Nexonia tesztfelhasználót](#create-a-nexonia-test-user)**  – egy megfelelője a Britta Simon Nexonia, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Nexonia tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Nexonia konfigurációs** területén kattintson **konfigurálása Nexonia** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-címe, SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Nexonia konfiguráció](./media/nexonia-tutorial/tutorial_nexonia_configure.png) 

7. Az egyszeri bejelentkezés konfigurálása **Nexonia** oldalon kell küldenie a letöltött **tanúsítvány (Base64), kijelentkezéses URL-címe, SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** és **SAML entitás azonosítója**  való [Nexonia támogatási csapatának](https://nexonia.zendesk.com/hc/requests/new). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
