---
title: 'Oktatóanyag: Azure Active Directory integráció a Wizergos hatékonyságnövelő szoftverrel | Microsoft Docs'
description: Megtudhatja, hogyan konfigurálhat egyszeri bejelentkezést Azure Active Directory és Wizergos hatékonyságnövelő szoftverek között.
...
Ebből az oktatóanyagból megtudhatja, hogyan integrálhatja a Wizergos hatékonyságnövelő szoftvereket Azure Active Directory (Azure AD) használatával.
A Wizergos hatékonyságnövelő szoftvereknek az Azure AD-vel való integrálása a következő előnyöket biztosítja:

* Az Azure AD-ben beállíthatja, hogy ki férhet hozzá a Wizergos hatékonyságnövelő szoftverekhez.
* Lehetővé teheti a felhasználók számára, hogy automatikusan bejelentkezzenek, hogy Wizergos a hatékonyságnövelő szoftvereket (egyszeri bejelentkezés) az Azure AD-fiókjával.
...
Az Azure AD-integráció Wizergos hatékonyságnövelő szoftverrel való konfigurálásához a következő elemek szükségesek:

* Egy Azure AD-előfizetés. Ha nem rendelkezik Azure AD-környezettel, [ingyenes fiókot](https://azure.microsoft.com/free/) szerezhet be
* Wizergos hatékonyságnövelő szoftveres egyszeri bejelentkezésre alkalmas előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban egy tesztkörnyezetben konfigurálja és teszteli az Azure AD egyszeri bejelentkezést.

* A Wizergos hatékonyságnövelő szoftver támogatja a **identitásszolgáltató** által kezdeményezett egyszeri bejelentkezést

## <a name="adding-wizergos-productivity-software-from-the-gallery"></a>Wizergos hatékonyságnövelő szoftver hozzáadása a katalógusból

A Wizergos hatékonyságnövelő szoftvereknek az Azure AD-be való integrálásának konfigurálásához hozzá kell adnia a Wizergos hatékonyságnövelő szoftvereket a katalógusból a felügyelt SaaS-alkalmazások listájához.

**A Wizergos hatékonyságnövelő szoftvereknek a katalógusból való hozzáadásához hajtsa végre a következő lépéseket:**
...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    ![Wizergos hatékonyságnövelő szoftverek tartománya és URL-címek egyszeri bejelentkezési adatai](common/idp-identifier.png)
...
6. A **Wizergos hatékonyságnövelő szoftver beállítása** szakaszban másolja ki a megfelelő URL-címeket a követelmények szerint.
...
### <a name="create-wizergos-productivity-software-test-user"></a>Wizergos hatékonyságnövelő szoftveres tesztelési felhasználó létrehozása

Ebben a szakaszban egy Britta Simon nevű felhasználót hoz létre a Wizergos hatékonyságnövelő szoftverben. Működjön együtt a [Wizergos hatékonyságnövelő szoftverfejlesztői csapatával](mailTo:support@wizergos.com) , hogy hozzáadja a felhasználókat a Wizergos hatékonyságnövelő szoftver platformhoz.

### <a name="test-single-sign-on"></a>Az egyszeri bejelentkezés tesztelése 

Ebben a szakaszban az Azure AD egyszeri bejelentkezési konfigurációját teszteli a hozzáférési panel használatával.

Ha a hozzáférési panelen a Wizergos hatékonyságnövelő szoftver csempére kattint, automatikusan be kell jelentkeznie a Wizergos hatékonyságnövelő szoftverbe, amelyhez be kell állítania az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
