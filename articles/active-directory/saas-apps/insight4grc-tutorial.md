...
3. **[Hozzon létre egy Insight4GRC tesztfelhasználót](#create-an-insight4grc-test-user)**  – egy megfelelője a Britta Simon Insight4GRC, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Insight4GRC tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód:
...
7. Az egyszeri bejelentkezés konfigurálása **Insight4GRC** oldalon kell küldenie a másolt **alkalmazás összevonási metaadatainak URL-címe** való [Insight4GRC támogatási csapatának](mailto:support.ss@rsmuk.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
