---
title: 'Oktatóanyag: Azure Active Directory-integráció az SciQuest költségek igazgató |} A Microsoft Docs'
...
ms.locfileid: "39045508"
---
# <a name="tutorial-azure-active-directory-integration-with-sciquest-spend-director"></a>Oktatóanyag: Azure Active Directory-integráció az SciQuest költségek igazgató
...
3. **[Hozzon létre egy SciQuest költségek igazgató tesztfelhasználót](#create-a-sciquest-spend-director-test-user)**  – egy megfelelője a Britta Simon SciQuest költségek igazgató, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **SciQuest költségek Director tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **SciQuest költségek igazgató** oldalon kell küldenie a letöltött **metaadatainak XML** való [SciQuest költségek igazgató támogatási csapatával](https://www.jaggaer.com/contact-us/).
