---
title: 'Oktatóanyag: Azure Active Directory-integráció az Peoplecart |} A Microsoft Docs'
...
ms.locfileid: "39040932"
---
# <a name="tutorial-azure-active-directory-integration-with-peoplecart"></a>Oktatóanyag: Azure Active Directory-integráció az Peoplecart
...
3. **[Hozzon létre egy Peoplecart tesztfelhasználót](#create-a-peoplecart-test-user)**  – egy megfelelője a Britta Simon Peoplecart, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Peoplecart tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Peoplecart konfigurációs** területén kattintson **konfigurálása Peoplecart** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Peoplecart konfiguráció](./media/peoplecart-tutorial/tutorial_peoplecart_configure.png) 

7. Az egyszeri bejelentkezés konfigurálása **Peoplecart** oldalon kell küldenie a letöltött **metaadatainak XML** és **SAML egyszeri bejelentkezési szolgáltatás URL-cím** való [Peoplecart támogatási csoport](https://peoplecart.com/ContactUs.aspx). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
