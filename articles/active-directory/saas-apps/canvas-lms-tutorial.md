...
1. A Keresés mezőbe írja be a **Vászonalapú**.

    ![Az Azure ad-ben tesztfelhasználó létrehozása](./media/canvas-lms-tutorial/tutorial_canvaslms_search.png)

1. Az eredmények panelen válassza ki a **Vászonalapú**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[Egy vászon tesztfelhasználó létrehozása](#creating-a-canvas-test-user)**  – szeretné, hogy egy Britta Simon megfelelője a vásznon, amely kapcsolódik az Azure AD felhasználói ábrázolása.
...
1. Az a **Vászonalapú tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Lépjen a **tanfolyamok \> felügyelt fiókok \> Microsoft**.
   
    ![Vászonalapú](./media/canvas-lms-tutorial/IC775990.png "vászon")

1. Válassza a bal oldali navigációs panelen, **hitelesítési**, és kattintson a **új SAML-konfiguráció hozzáadása**.
   
    ![Hitelesítési](./media/canvas-lms-tutorial/IC775991.png "hitelesítés")

1. Az aktuális Integration oldalon hajtsa végre az alábbi lépéseket:
...
1. Új felhasználó párbeszédpanel oldal hozzáadása hajtsa végre az alábbi lépéseket:
...
1. Az alkalmazások listájában jelölje ki a **Vászonalapú**.
