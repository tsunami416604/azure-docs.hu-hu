...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://na11.springcm.com/atlas/SSO/SSOEndpoint.ashx?aid=<identifier>`
...
1. A felső menüben kattintson a **Ugrás**gombra, kattintson a **Beállítások**elemre, majd a **FIÓKBEÁLLÍTÁSOK** szakaszban kattintson az **SAML SSO**elemre.
    ...
    ![SAML SSO](./media/spring-cm-tutorial/ic797051.png "SAML EGYSZERI BEJELENTKEZÉS")
