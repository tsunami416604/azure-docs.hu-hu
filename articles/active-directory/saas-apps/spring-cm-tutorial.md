...
4. A Keresés mezőbe írja be a **SpringCM**.
...
3. **[SpringCM tesztfelhasználó létrehozása](#creating-a-springcm-test-user)**  – egy megfelelője a Britta Simon SpringCM, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **SpringCM tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **SpringCM konfigurációs** területén kattintson **konfigurálása SpringCM** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/spring-cm-tutorial/tutorial_springcm_configure.png)     

7. Egy másik böngészőablakban, jelentkezzen be a **SpringCM** rendszergazdaként a vállalati webhely.

8. A felső menüben kattintson **Ugrás**, kattintson a **beállítások**, majd a **fiók beállítások** területén kattintson **SAML SSO**.
   
    ![AZ SAML SSO](./media/spring-cm-tutorial/ic797051.png "SAML EGYSZERI BEJELENTKEZÉS")

9. Az Identity Provider konfigurációs szakaszban hajtsa végre az alábbi lépéseket:
...
3. Kattintson a **felhasználó létrehozása**.

4. Válassza ki a **felhasználói szerepkör**.

5. Válassza ki **aktiválási e-mailt**.

6. Írja be az Utónév, Vezetéknév és egy érvényes Azure Active Directory felhasználói fiók, a kapcsolódó szövegmezőkben kiépítendő e-mail-címe.
