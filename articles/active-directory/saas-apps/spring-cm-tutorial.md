...
2. **[SpringCM egyszeri bejelentkezés konfigurálása](#configure-springcm-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    > [!NOTE]
    > Az érték nem valódi. Frissítse az értéket a tényleges Sign-On URL-címmel. Az érték beszerzéséhez forduljon a SpringCM ügyfélszolgálati [csapatához](https://knowledge.springcm.com/support) . Az Azure Portal **alapszintű SAML-konfiguráció** szakaszában látható mintázatokat is megtekintheti.

4. Az **egyszeres Sign-On beállítása az SAML** használatával lapon az **SAML aláíró tanúsítvány** szakaszban kattintson a **Letöltés** gombra a **tanúsítvány (RAW)** letöltéséhez a megadott beállítások alapján, és mentse azt a számítógépre.
...
### <a name="configure-springcm-single-sign-on"></a>SpringCM egyetlen Sign-On konfigurálása
...
Ha a hozzáférési panelen a SpringCM csempére kattint, automatikusan be kell jelentkeznie arra a SpringCM, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
