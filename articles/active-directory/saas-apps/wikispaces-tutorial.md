---
title: 'Oktatóanyag: Azure Active Directory-integráció az Wikispaces |} A Microsoft Docs'
...
ms.locfileid: "39050571"
---
# <a name="tutorial-azure-active-directory-integration-with-wikispaces"></a>Oktatóanyag: Azure Active Directory-integráció az Wikispaces
...
4. A Keresés mezőbe írja be a **Wikispaces**.
...
3. **[Wikispaces tesztfelhasználó létrehozása](#creating-a-wikispaces-test-user)**  – egy megfelelője a Britta Simon Wikispaces, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Wikispaces tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **Wikispaces** oldalon kell küldenie a letöltött **metaadatainak XML** való [Wikispaces támogatási csoportjának](https://www.wikispaces.com/site/help). Értesítést fog kapni, amint a konfiguráció befejeződött.
