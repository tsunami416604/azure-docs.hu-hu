...
2. **[Wikispaces egyszeri bejelentkezés konfigurálása](#configure-wikispaces-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
Ha a hozzáférési panelen a Wikispaces csempére kattint, automatikusan be kell jelentkeznie arra a Wikispaces, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
