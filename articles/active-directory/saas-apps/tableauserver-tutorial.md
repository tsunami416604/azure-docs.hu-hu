...
1. A Keresés mezőbe írja be a **Tableau Server**.

    ![Az Azure ad-ben tesztfelhasználó létrehozása](./media/tableauserver-tutorial/tutorial_tableauserver_search.png)

1. Az eredmények panelen válassza ki a **Tableau Server**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[A Tableau Server tesztfelhasználó létrehozása](#creating-a-tableau-server-test-user)**  - a-megfelelője a Britta Simon rendelkezik a Tableau Server, amely kapcsolódik az Azure AD felhasználói ábrázolása.
...
1. Az a **Tableau Server tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Az alkalmazások listájában jelölje ki a **Tableau Server**.
