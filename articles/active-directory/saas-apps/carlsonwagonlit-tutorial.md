...
4. Írja be a keresőmezőbe, **Carlson Wagonlit utazás**, jelölje be **Carlson Wagonlit utazás** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Carlson Wagonlit utazás](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_samlbase.png)

3. Az a **Carlson Wagonlit utazás tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk Carlson Wagonlit utazás tartomány és az URL-címek](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_url.png)

    Az a **azonosító** szövegmező, írja be az értéket: `cwt-stage`

4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.

    ![A tanúsítvány letöltési hivatkozását](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/carlsonwagonlit-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **Carlson Wagonlit utazás**.
    ...
    ![Az alkalmazások listáját a Carlson Wagonlit utazás hivatkozás](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_app.png)  
