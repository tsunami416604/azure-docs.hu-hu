---
title: 'Oktatóanyag: Azure Active Directory-integráció az Supermood |} A Microsoft Docs'
...
ms.locfileid: "39041024"
---
# <a name="tutorial-azure-active-directory-integration-with-supermood"></a>Oktatóanyag: Azure Active Directory-integráció az Supermood
...
3. **[Hozzon létre egy Supermood tesztfelhasználót](#create-a-supermood-test-user)**  – egy megfelelője a Britta Simon Supermood, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Supermood tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **SAML-aláíró tanúsítvány** területén kattintson a Másolás gombra, hogy **alkalmazás összevonási metaadatainak URL-címe** , és illessze be a Jegyzettömbbe.
...
8. Nyissa meg a Supermood.co felügyeleti panel biztonsági rendszergazdaként.

9. Kattintson a **fiókom** (bal alsó sarokban található) és **egyszeri bejelentkezés (SSO)**.

    ![A tanúsítvány egyetlen](./media/supermood-tutorial/tutorial_supermood_single.png)
10. A **a SAML 2.0 konfigurációk**, kattintson a **adjon hozzá egy e-mail-tartomány egy SAML 2.0 konfigurációs**.

    ![A tanúsítvány hozzáadása](./media/supermood-tutorial/tutorial_supermood_add.png)

11. A **adjon hozzá egy e-mail-tartomány egy SAML 2.0 konfigurációs**. szakaszban, hajtsa végre az alábbi lépéseket:
