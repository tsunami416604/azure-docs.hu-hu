...
1. Az **alapszintű SAML-konfiguráció** szakaszban, ha az alkalmazást **identitásszolgáltató** kezdeményezett módban szeretné konfigurálni, hajtsa végre a következő lépéseket:
    ...
    b. A **továbbítási állapot** szövegmezőbe írja be a következő URL-címet: `https://supermood.co/auth/sso/saml20`
...
1. Kattintson a **további URL-címek beállítása** elemre, és hajtsa végre a következő lépéseket, ha az alkalmazást **SP** -ben kezdeményezett módban szeretné konfigurálni:
    ...
    A **bejelentkezési URL** szövegmezőbe írja be a következő URL-címet: `https://supermood.co/app/#!/loginv2`
...
Ha a hozzáférési panelen a főhangulat csempére kattint, automatikusan be kell jelentkeznie arra a főalkalmazásba, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
