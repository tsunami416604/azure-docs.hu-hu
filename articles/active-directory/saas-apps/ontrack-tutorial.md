...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve OnTrack (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* OnTrack egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a OnTrack **Identitásszolgáltató** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **OnTrack**válassza **OnTrack** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában OnTrack](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az OnTrack nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó OnTrack hivatkozás kapcsolata kell létrehozni.
...
2. **[OnTrack egyszeri bejelentkezés konfigurálása](#configure-ontrack-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre OnTrack tesztfelhasználót](#create-ontrack-test-user)**  – egy megfelelője a Britta Simon OnTrack, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **OnTrack** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **állítsa be egyszeri bejelentkezést az SAML** lapon, a következő lépésekkel:
    ...
    ![OnTrack tartomány és URL-címeket egyetlen bejelentkezési adatait](common/idp-intiated.png)

    a. Az a **azonosító** szövegbeviteli mező:
    ...
    b. Az a **válasz URL-cím** szövegbeviteli mező:
...
6. Emellett a fentiekben OnTrack alkalmazás vár néhány további attribútumok vissza SAML-válasz átadni. A a **felhasználói jogcímek** szakaszában a **felhasználói attribútumok** párbeszédpanelen a következő lépésekkel adja hozzá a SAML-jogkivonat attribútumot, ahogyan az alábbi táblázatban:
...
8. Az a **OnTrack beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
Az egyszeri bejelentkezés konfigurálása **OnTrack** oldalon kell küldenie a letöltött **összevonási metaadatainak XML** és az Azure Portalról másolt URL-címek megfelelő [OnTrack támogatási csapatának](mailto:CustomerService@insigniagroup.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **OnTrack**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **OnTrack**.

    ![Az alkalmazások listáját a OnTrack hivatkozás](common/all-applications.png)
...
Ha a hozzáférési panelen a OnTrack csempére kattint, meg kell lehet automatikusan bejelentkezett a OnTrack, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
