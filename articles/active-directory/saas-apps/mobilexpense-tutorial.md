---
title: 'Oktatóanyag: Azure Active Directory-integráció az Mobile Xpense |} A Microsoft Docs'
...
ms.locfileid: "39041779"
---
# <a name="tutorial-azure-active-directory-integration-with-mobile-xpense"></a>Oktatóanyag: Azure Active Directory-integráció az Mobile Xpense
...
3. **[Hozzon létre egy Mobile Xpense tesztfelhasználót](#create-a-mobile-xpense-test-user)**  – egy megfelelője a Britta Simon Mobile Xpense, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Mobile Xpense tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás Identitásszolgáltató által kezdeményezett módban konfigurálása:
...
4. Ellenőrizze **speciális URL-beállítások megjelenítése** , és hajtsa végre a következő lépést, ha az alkalmazás a konfigurálni kívánt **SP** kezdeményezett mód:
    ...
    > [!NOTE] 
    > Ezek a értékei nem valódi. Frissítse a tényleges válasz URL-címet, és a bejelentkezési URL-ezeket az értékeket. Kapcsolattartó [Mobile Xpense ügyfél-támogatási csapatának](http://www.mobilexpense.net/contact) beolvasni ezeket az értékeket. 
...
7. Az egyszeri bejelentkezés konfigurálása **Mobile Xpense** oldalon kell küldenie a letöltött **metaadatainak XML** való [Mobile Xpense támogatási csapatának](http://www.mobilexpense.net/contact). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
Ebben a szakaszban egy felhasználói Britta Simon nevű MobileXpense hoz létre. a munkahelyi [MobileXpense támogatási csapatának](http://www.mobilexpense.net/contact) a felhasználók hozzáadása az MobileXpense platformon. Felhasználók kell létrehozni és egyszeri bejelentkezés használata előtt aktiválva. 
