---
title: 'Oktatóanyag: Azure Active Directory-integráció az CompetencyIQ |} A Microsoft Docs'
...
ms.locfileid: "39048021"
---
# <a name="tutorial-azure-active-directory-integration-with-competencyiq"></a>Oktatóanyag: Azure Active Directory-integráció az CompetencyIQ
...
4. A Keresés mezőbe írja be a **CompetencyIQ**.
...
3. **[CompetencyIQ tesztfelhasználó létrehozása](#creating-a-competencyiq-test-user)**  – egy megfelelője a Britta Simon CompetencyIQ, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **CompetencyIQ tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **CompetencyIQ konfigurációs** területén kattintson **konfigurálása CompetencyIQ** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML Entitásazonosító**, és **SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/competencyiq-tutorial/tutorial_competencyiq_configure.png) 

7. Az egyszeri bejelentkezés konfigurálása **CompetencyIQ** oldalon kell küldenie a letöltött **metaadatainak XML**, **SAML Entitásazonosító** és **SAML egyszeri bejelentkezési szolgáltatás URL-cím** való [CompetencyIQ támogatási csapatának](https://www.competencyiq.com/). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
