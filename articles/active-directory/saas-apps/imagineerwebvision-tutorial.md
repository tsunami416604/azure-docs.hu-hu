...
2. Az **[imaginer Webvíziójának egyszeri bejelentkezésének konfigurálása](#configure-imagineer-webvision-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
### <a name="configure-imagineer-webvision-single-sign-on"></a>Imaginer-alapú webvíziós egyszeri bejelentkezés konfigurálása
