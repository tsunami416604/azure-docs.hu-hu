...
- Szabályozhatja, hogy ki férhet hozzá a közvetlen Azure AD-ben
...
1. Hozzáadása közvetlenül a katalógusból
...
4. A Keresés mezőbe írja be a **közvetlen**. Válassza ki **közvetlen** az eredmények panelen, és válassza ki a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
Ebben a szakaszban konfigurálni, és közvetlenül a teszt "Britta Simon." nevű felhasználó az Azure AD egyszeri bejelentkezés tesztelése

Az egyszeri bejelentkezés működéséhez az Azure AD tudnia kell, a partner felhasználó közvetlen mi egy felhasználó számára az Azure ad-ben. Más szóval egy hivatkozás közötti kapcsolat egy Azure AD-felhasználót és a kapcsolódó felhasználó közvetlen kell létrehozni.
...
3. **[Közvetlen tesztfelhasználó létrehozása](#creating-a-direct-test-user)**  – Britta Simon egy megfelelője a felhasználó Azure ad-ben reprezentációja kapcsolódó közvetlen rendelkeznie.
...
**Britta Simon közvetlen hozzárendelni, hajtsa végre az alábbi lépéseket:**
