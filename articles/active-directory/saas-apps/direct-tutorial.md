...
Ebből az oktatóanyagból megtudhatja, hogyan integrálhatja közvetlenül a Azure Active Directory (Azure AD) szolgáltatással.
Az Azure AD közvetlen integrálásával a következő előnyöket nyújtja:

* Az Azure AD-ben ellenőrizheti, hogy ki férhet hozzá a Directhez.
* Engedélyezheti a felhasználók számára, hogy automatikusan bejelentkezzenek a közvetlen (egyszeri bejelentkezés) Azure AD-fiókjával.
...
Az Azure AD-integráció közvetlen konfigurálásához a következő elemek szükségesek:

* Egy Azure AD-előfizetés. Ha nem rendelkezik Azure AD-környezettel, [ingyenes fiókot](https://azure.microsoft.com/free/) szerezhet be
* közvetlen egyszeri bejelentkezésre engedélyezett előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban egy tesztkörnyezetben konfigurálja és teszteli az Azure AD egyszeri bejelentkezést.

* a Direct támogatja az **SP** és a **identitásszolgáltató** által kezdeményezett SSO

## <a name="adding-direct-from-the-gallery"></a>Közvetlen Hozzáadás a katalógusból

Az Azure AD-ba való közvetlen integráció konfigurálásához közvetlenül a katalógusból kell hozzáadnia a felügyelt SaaS-alkalmazások listájához.

**A következő lépésekkel adhat hozzá közvetlenül a katalógushoz:**
...
2. **[Közvetlen egyszeri bejelentkezés konfigurálása](#configure-direct-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
3. **[Azure ad-felhasználó létrehozása](#create-an-azure-ad-test-user)** – az Azure ad egyszeri bejelentkezés teszteléséhez a Britta Simon használatával.
4. **[Az Azure ad-teszt felhasználójának kiosztása](#assign-the-azure-ad-test-user)** – a Britta Simon engedélyezése az Azure ad egyszeri bejelentkezés használatára.
5. **[Közvetlen tesztelési felhasználó létrehozása](#create-direct-test-user)** – ha a Britta Simon közvetlen partnere van, amely a felhasználó Azure ad-képviseletéhez van társítva.
...
7. A **közvetlen beállítás** szakaszban másolja ki a megfelelő URL-címeket (ka) t a követelmény szerint.
...
### <a name="configure-direct-single-sign-on"></a>Közvetlen egyszeri Sign-On konfigurálása

Az egyszeri bejelentkezés **közvetlen** elérésű konfigurálásához el kell küldenie a letöltött **összevonási metaadatokat tartalmazó XML-fájlt** és a megfelelő másolt url-címeket a Azure Portalról a [közvetlen támogatási csapatnak](https://direct4b.com/ja/support.html#inquiry). Ezt a beállítást úgy állították be, hogy az SAML SSO-kapcsolatok mindkét oldalon helyesen legyenek beállítva.
...
2. Az alkalmazások listában válassza a **Direct (közvetlen**) lehetőséget.
...
### <a name="create-direct-test-user"></a>Közvetlen tesztelési felhasználó létrehozása

Ebben a szakaszban egy Britta Simon nevű felhasználót hoz létre a Direct-ban. A [közvetlen támogatási csapattal](https://direct4b.com/ja/support.html#inquiry) a közvetlen platformon veheti fel a felhasználókat. Az egyszeri bejelentkezés használata előtt létre kell hozni és aktiválni kell a felhasználókat.
