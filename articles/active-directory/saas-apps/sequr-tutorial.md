...
4. Írja be a keresőmezőbe, **Sequr**, jelölje be **Sequr** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Sequr](./media/sequr-tutorial/tutorial_sequr_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/sequr-tutorial/tutorial_sequr_samlbase.png)
...
3. Az a **Sequr tartomány és az URL-címek** területen tegye a következőket, ha szeretne beállítani az alkalmazás **IDP** kezdeményezett mód:
    ...
    ![Az egyszeri bejelentkezés információk Sequr tartomány és az URL-címek](./media/sequr-tutorial/tutorial_sequr_url.png)

    Az a **azonosító** szövegmező, írja be az URL-cím: `https://login.sequr.io`

4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:

    ![Az egyszeri bejelentkezés információk Sequr tartomány és az URL-címek](./media/sequr-tutorial/tutorial_sequr_url1.png)
...
5. Az a **SAML-aláíró tanúsítványa** kattintson **Certificate(Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/sequr-tutorial/tutorial_sequr_certificate.png) 

6. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/sequr-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **Sequr**.
    ...
    ![Az alkalmazások listáját a Sequr hivatkozás](./media/sequr-tutorial/tutorial_sequr_app.png)  
