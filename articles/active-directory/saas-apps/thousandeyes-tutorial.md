---
title: 'Oktatóanyag: Azure Active Directory-integráció az ThousandEyes |} A Microsoft Docs'
...
ms.locfileid: "39041806"
---
# <a name="tutorial-azure-active-directory-integration-with-thousandeyes"></a>Oktatóanyag: Azure Active Directory-integráció az ThousandEyes
...
4. A Keresés mezőbe írja be a **ThousandEyes**.
...
3. **[ThousandEyes tesztfelhasználó létrehozása](#creating-a-thousandeyes-test-user)**  – egy megfelelője a Britta Simon ThousandEyes, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **ThousandEyes tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **ThousandEyes konfigurációs** területén kattintson **konfigurálása ThousandEyes** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-címe, SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/thousandeyes-tutorial/tutorial_thousandeyes_configure.png) 

7. Egy másik böngészőablakban, jelentkezzen be a **ThousandEyes** rendszergazdaként a vállalati webhely.
...
10. Kattintson a **biztonság és hitelesítés** fülre.

    ![A biztonság és hitelesítés](./media/thousandeyes-tutorial/ic790068.png "biztonság és hitelesítés")

11. Az a **beállítása egyszeri bejelentkezéshez** szakaszban, hajtsa végre az alábbi lépéseket:
