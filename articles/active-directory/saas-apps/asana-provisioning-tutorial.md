...
> [!NOTE] 
> Az Azure AD-integrációs kiépítés támaszkodik a [Asana API](https://asana.com/developers/api-reference/users), amely Asana rendelkezésére áll.
