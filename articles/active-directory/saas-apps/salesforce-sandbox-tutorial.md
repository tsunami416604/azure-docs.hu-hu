...
1. A Keresés mezőbe írja be a **Salesforce védőfal**, jelölje be **Salesforce védőfal** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[Hozzon létre egy Salesforce védőfal tesztfelhasználót](#create-a-salesforce-sandbox-test-user)**  - a-megfelelője a Britta Simon rendelkezik, amely kapcsolódik az Azure AD felhasználói ábrázolása Salesforce tesztkörnyezetben.
...
1. Az a **Salesforce védőfal tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Az a **Salesforce tesztkörnyezet konfigurációs** területén kattintson **Salesforce-tesztkörnyezet konfigurálása** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**
...
1. A SAML egyszeri bejelentkezés beállításai szakaszban hajtsa végre a következő lépéseket:
...
1. Az a **hitelesítési konfiguráció** területén kattintson **szerkesztése**, később, **hitelesítési szolgáltatás**, válassza ki a SAML egyszeri bejelentkezési beállítás nevét az előző szakaszt, és végül kattintson a **mentése**.
...
1. Az alkalmazások listájában jelölje ki a **Salesforce védőfal**.
