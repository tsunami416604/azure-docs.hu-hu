...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://microsoftrr.performnet.com/biwv1auth/Shibboleth.sso/Login?providerId=<Azure AD Identifier>`

    > [!NOTE]
    > Az érték nem valódi. Az oktatóanyag későbbi lépéseiben a `<Azure AD Identifier>` értéket fogja kapni.
...
6. A **saját díjazási pontok első sub/Top csapatának beállítása** szakaszban másolja ki a megfelelő URL-címeket (ka) t a követelménynek megfelelően. 
    ...
    >[!NOTE]
    >Fűzze hozzá a másolt Azure AD-azonosító értékét a bejelentkezés URL-címéhez a Azure Portal **alapszintű SAML-konfiguráció** szakaszának `<Azure AD Identifier>` helyén.
