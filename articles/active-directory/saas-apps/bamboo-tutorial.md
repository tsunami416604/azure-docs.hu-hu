...
3. **[Hozzon létre egy bambusz feloldási GmbH teszt felhasználó által a SAML SSO](#create-a-saml-sso-for-bamboo-by-resolution-gmbh-test-user)**  – bambusz a SAML SSO-megfelelője a Britta Simon van megoldás, amely kapcsolódik az Azure AD felhasználói ábrázolása GmbH által.
...
3. Az a **SAML SSO bambusz felbontása GmbH tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás Identitásszolgáltató által kezdeményezett módban konfigurálása:
...
7. Bejelentkezés a SAML SSO bambusz feloldási GmbH vállalati hely által a rendszergazdaként.

8. A fő eszköztár jobb oldalán kattintson a **beállítások** > **bővítmények**.

    ![A beállítások](./media/bamboo-tutorial/tutorial_bamboo_setings.png)

9. BIZTONSÁG szakaszában keresse meg, kattintson a **SAML egyszeri bejelentkezés** a menüsávon a.
...
12. Az a **identitás-szolgáltató konfigurációjának** lapon kattintson **tovább**.
