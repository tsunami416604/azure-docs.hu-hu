...
5. A **rendszergazdai hitelesítő adatok** szakaszban adja `https://identitymanagement.services.iProva.nl/scim` meg a **bérlői URL-címet**. Adja meg a **titkos tokenben**korábban beolvasott **állandó jogkivonat** értékét. Kattintson a **kapcsolat tesztelése** lehetőségre, hogy az Azure ad képes legyen csatlakozni a iProva. Ha a kapcsolat meghiúsul, győződjön meg arról, hogy a iProva-fiókja rendszergazdai jogosultságokkal rendelkezik, és próbálkozzon újra.
