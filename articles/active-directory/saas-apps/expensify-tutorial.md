...
4. Írja be a keresőmezőbe, **Expensify**, jelölje be **Expensify** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában expensify](./media/expensify-tutorial/tutorial_expensify_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/expensify-tutorial/tutorial_expensify_samlbase.png)

3. Az a **Expensify tartomány és az URL-címek** területen tegye a következőket:

    ![Tartomány- és URL-címek egyetlen bejelentkezési adatokat expensify](./media/expensify-tutorial/tutorial_expensify_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/expensify-tutorial/tutorial_expensify_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/expensify-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **Expensify**.
    ...
    ![Az alkalmazások listáját a Expensify hivatkozás](./media/expensify-tutorial/tutorial_expensify_app.png)  
