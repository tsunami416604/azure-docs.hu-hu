...
4. A Keresés mezőbe írja be a **emberiség**.

    ![Az Azure ad-ben tesztfelhasználó létrehozása](./media/shiftplanning-tutorial/tutorial_humanity_search.png)

5. Az eredmények panelen válassza ki a **emberiség**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
3. **[Emberiség tesztfelhasználó létrehozása](#creating-a-humanity-test-user)**  – egy megfelelője a Britta Simon emberiség, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **emberiség tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **emberiség konfigurációs** területén kattintson **konfigurálása emberiség** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML egyszeri bejelentkezési szolgáltatás URL-CÍMÉT, és kijelentkezéses URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/shiftplanning-tutorial/tutorial_humanity_configure.png) 

7. Egy másik böngészőablakban, jelentkezzen be a **emberiség** rendszergazdaként a vállalati webhely.
...
10. Az a **egyszeri bejelentkezés** szakaszban, hajtsa végre az alábbi lépéseket:
