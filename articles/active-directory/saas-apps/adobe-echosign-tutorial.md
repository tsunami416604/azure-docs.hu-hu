...
1. Az **SAML-beállítások** szakaszban hajtsa végre a következő lépéseket:
   ...
   g. Nyissa meg a letöltött **tanúsítvány (Base64)** fájlt a Jegyzettömbben. Másolja a tartalmát a vágólapra, majd illessze be a **identitásszolgáltató-tanúsítvány** szövegmezőbe.
...
2. A felső menüben válassza a **fiók**lehetőséget. Ezután a bal oldali ablaktáblán válassza a **felhasználók & csoportok** lehetőséget, > **hozzon létre egy új felhasználót**.
