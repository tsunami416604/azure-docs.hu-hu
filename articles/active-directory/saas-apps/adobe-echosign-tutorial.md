...
2. Az **[Adobe Sign egyszeri bejelentkezés konfigurálása](#configure-adobe-sign-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
1. Az **SAML-beállítások** szakaszban hajtsa végre a következő lépéseket:
   ...
   ![Képernyőkép, amely kiemeli az SAML-beállításokat, beleértve az SAML Kötelezőt is.](./media/adobe-echosign-tutorial/ic789521.png "SAML-beállítások")
...
Amikor a hozzáférési panelen az Adobe Sign csempére kattint, automatikusan be kell jelentkeznie arra az Adobe-aláírásba, amelyhez be kell állítania az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
