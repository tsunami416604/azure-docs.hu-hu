...
2. **[HappyFox egyszeri bejelentkezés konfigurálása](#configure-happyfox-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
### <a name="configure-happyfox-single-sign-on"></a>HappyFox egyetlen Sign-On konfigurálása
...
6. Kattintson a **Beállítások mentése** gombra.
    ...
    ![Egyetlen Sign-On konfigurálása](./media/happyfox-tutorial/savesettings.png)
