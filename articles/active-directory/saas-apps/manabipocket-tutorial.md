...
3. **[Hozzon létre egy Manabi Pocket tesztfelhasználót](#create-a-manabi-pocket-test-user)**  – a felhasználó Azure ad-ben reprezentációja kapcsolódó Manabi zsebébe tenni egy megfelelője a Britta Simon rendelkeznie.
...
3. Az a **Manabi Pocket tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **Manabi Pocket** oldalon kell küldenie a letöltött **metaadatainak XML** való [Manabi Pocket támogatási csapatának](mailto:info-ed-cl@ntt.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
