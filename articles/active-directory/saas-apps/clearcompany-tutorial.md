...
ms.date: 08/28/2017
ms.author: jeedes
ms.openlocfilehash: cf10c1b3bc1ff76a15ae3e73e2c8e5f045052ce1
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: hu-HU
ms.lasthandoff: 06/18/2018
ms.locfileid: "35927709"
---
...
4. Írja be a keresőmezőbe, **ClearCompany**, jelölje be **ClearCompany** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában ClearCompany](./media/clearcompany-tutorial/tutorial_clearcompany_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/clearcompany-tutorial/tutorial_clearcompany_samlbase.png)
...
3. Az a **ClearCompany tartomány és az URL-címek** szakaszban, ha szeretne beállítani az alkalmazás által kezdeményezett IDP módban, hajtsa végre az alábbi lépéseket:
    ...
    ![Az egyszeri bejelentkezés információk ClearCompany tartomány és az URL-címek](./media/clearcompany-tutorial/tutorial_clearcompany_url1.png)

    Az a **azonosító** szövegmező, írja be az URL-cím: `https://api.clearcompany.com`

4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:

    ![Az egyszeri bejelentkezés információk ClearCompany tartomány és az URL-címek](./media/clearcompany-tutorial/tutorial_clearcompany_url2.png)
...
5. Az a **SAML-aláíró tanúsítványa** kattintson **Certificate(Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/clearcompany-tutorial/tutorial_clearcompany_certificate.png) 

6. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/clearcompany-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **ClearCompany**.
    ...
    ![Az alkalmazások listáját a ClearCompany hivatkozás](./media/clearcompany-tutorial/tutorial_clearcompany_app.png)  
