...
* Szabályozhatja, ki férhet hozzá RFPIO Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve RFPIO (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* RFPIO egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a RFPIO **SP és IDP** által kezdeményezett egyszeri bejelentkezés

## <a name="adding-rfpio-from-the-gallery"></a>RFPIO hozzáadása a katalógusból
...
4. A Keresés mezőbe írja be a **RFPIO**válassza **RFPIO** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

    ![Az eredmények listájában RFPIO](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az RFPIO nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó RFPIO hivatkozás kapcsolata kell létrehozni.
...
2. **[RFPIO egyszeri bejelentkezés konfigurálása](#configure-rfpio-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre RFPIO tesztfelhasználót](#create-rfpio-test-user)**  – egy megfelelője a Britta Simon RFPIO, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **RFPIO** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszra, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód, hajtsa végre a következő lépést:
    ...
    ![RFPIO tartomány és URL-címeket egyetlen bejelentkezési adatait](common/idp-identifier.png)

    a. Az a **azonosító** szövegmezőbe írja be a következő minta használatával URL-cím: `https://www.rfpio.com`
    ...
    ![RFPIO tartomány és URL-címeket egyetlen bejelentkezési adatait](common/idp-preintegrated-relay.png)

5. Kattintson a **további URL-címet beállítani** , és hajtsa végre a következő lépést, ha az alkalmazás a konfigurálni kívánt **SP** kezdeményezett mód:

    ![image](common/both-preintegrated-signon.png)

    Az a **bejelentkezési URL-** szövegmezőbe írja be a következő minta használatával URL-cím:  `https://www.app.rfpio.com`

    > [!NOTE]
    > Ezek a értékei nem valódi. Az értékeket módosítsa a tényleges azonosítóját, valamint a bejelentkezési URL-címet. Kapcsolattartó [RFPIO ügyfél-támogatási csapatának](https://www.rfpio.com/contact/) beolvasni ezeket az értékeket. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.
...
7. Az a **RFPIO beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
1. Ebben a szakaszban végre a következő műveleteket:
    ...
    > [!NOTE]
    >Másolja a tartalmat a letöltött **összevonási metaadatainak XML** használata **Jegyzettömb ++** vagy megfelelő **XML-szerkesztő**.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **RFPIO**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **RFPIO**.

    ![Az alkalmazások listáját a RFPIO hivatkozásra](common/all-applications.png)
