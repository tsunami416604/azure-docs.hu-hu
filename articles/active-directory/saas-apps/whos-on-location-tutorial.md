...
2. Kattintson az **eszközök**  ->  **fiók** elemre.
    ...
    ![A képernyőképen a WhosOnLocation hely eszközök menüjében kiválasztott fiók látható.](./media/WhosOnLocation-tutorial/config1.png)

3. A bal oldali Navigátorban válassza az **alkalmazotti hozzáférés** lehetőséget.

    ![Képernyőfelvétel: a fiók profiljában kiválasztott alkalmazotti hozzáférés.](./media/WhosOnLocation-tutorial/config2.png)

4. Hajtsa végre a következő lépéseket a következő lapon.

    ![Képernyőfelvétel: a employess-hozzáférés lap, amelyen megadhatja a felhasználói adatbevitelt.](./media/WhosOnLocation-tutorial/config3.png)
...
Ha a hozzáférési panelen a WhosOnLocation csempére kattint, automatikusan be kell jelentkeznie arra a WhosOnLocation, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
...
- [A WhosOnLocation és a speciális láthatóság és vezérlők elleni védelem](/cloud-app-security/proxy-intro-aad)