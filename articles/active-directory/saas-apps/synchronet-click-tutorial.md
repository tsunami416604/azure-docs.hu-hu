...
Amikor rákattint a SynchroNet a csempére a hozzáférési panelen, automatikusan be kell jelentkeznie a SynchroNet, amelyhez be kell állítania az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
...
- [A SynchroNet védelemmel való ellátása kattintson a speciális láthatóság és vezérlők lehetőségre](/cloud-app-security/proxy-intro-aad)