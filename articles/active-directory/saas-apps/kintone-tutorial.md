...
4. Írja be a keresőmezőbe, **Kintone**.
    ...
    ![Az Azure AD tesztfelhasználó létrehozása](./media/kintone-tutorial/tutorial_kintone_search.png)

5. Az eredmények panelen válassza ki a **Kintone**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

    ![Az Azure AD tesztfelhasználó létrehozása](./media/kintone-tutorial/tutorial_kintone_addfromgallery.png)
...
9. Kattintson a **felhasználók és rendszergazdák**.
    ...
    ![Felhasználók és rendszergazdák](./media/kintone-tutorial/ic785880.png "felhasználók és rendszergazdák")
...
11. Kattintson a **engedélyezése SAML-alapú hitelesítés**.
    ...
    ![SAML-alapú hitelesítés](./media/kintone-tutorial/ic785882.png "SAML-alapú hitelesítés")

12. A SAML-alapú hitelesítés területen a következő lépésekkel:
    
    ![SAML-alapú hitelesítés](./media/kintone-tutorial/ic785883.png "SAML-alapú hitelesítés")
...
1. Az a **Azure-portálon**, a bal oldali navigációs ablaktábláján kattintson **Azure Active Directory** ikonra.
    ...
    ![Az Azure AD tesztfelhasználó létrehozása](./media/kintone-tutorial/create_aaduser_01.png) 

2. Azon felhasználók listájának megtekintéséhez keresse fel **felhasználók és csoportok** kattintson **minden felhasználó**.
    
    ![Az Azure AD tesztfelhasználó létrehozása](./media/kintone-tutorial/create_aaduser_02.png) 

3. Lehetőségre a **felhasználói** párbeszédpanel, kattintson a **Hozzáadás** párbeszédpanel tetején.
 
    ![Az Azure AD tesztfelhasználó létrehozása](./media/kintone-tutorial/create_aaduser_03.png) 

4. Az a **felhasználói** párbeszédpanel lapon, a következő lépésekkel:
 
    ![Az Azure AD tesztfelhasználó létrehozása](./media/kintone-tutorial/create_aaduser_04.png) 
...
3. Kattintson a **felhasználók és rendszergazdák**.
    ...
    ![& Felhasználói rendszerfelügyelet](./media/kintone-tutorial/ic785880.png "felhasználó & rendszerfelügyelet")
