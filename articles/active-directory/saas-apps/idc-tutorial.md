...
* Az IDC támogatja **az SP és a identitásszolgáltató** által KEZDEMÉNYEZett SSO
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-idc"></a>Az Azure AD egyszeri bejelentkezés konfigurálása és tesztelése az IDC-hez
...
Az Azure AD SSO az IDC-vel való konfigurálásához és teszteléséhez hajtsa végre a következő építőelemeket:
...
1. A [Azure Portal](https://portal.azure.com/)az **IDC** -alkalmazás integrációja lapon keresse meg a **kezelés** szakaszt, és válassza az **egyszeri bejelentkezés**lehetőséget.
...
1. Ha a **identitásszolgáltató** által kezdeményezett módban szeretné konfigurálni az alkalmazást, az **ALAPszintű SAML-konfiguráció** szakaszban adja meg a következő mezők értékeit:
    ...
    a. Az **azonosító** szövegmezőbe írja be az URL-címet a következő minta használatával: `urn:idc:authentication:saml2:entity:cas:prod-2016:<ClientCode>`
...
1. Kattintson a **további URL-címek beállítása** elemre, és hajtsa végre a következő lépéseket, ha az alkalmazást **SP** -ben kezdeményezett módban szeretné konfigurálni:
    ...
    > [!NOTE]
    > Ezek az értékek nem valósak. Frissítse ezeket az értékeket a tényleges azonosító és válasz URL-címmel. A fenti értékek megszerzéséhez forduljon az IDC ügyfél-támogatási csapatához. Az Azure Portal **alapszintű SAML-konfiguráció** szakaszában látható mintázatokat is megtekintheti.
...
Amikor a hozzáférési panelen az IDC csempére kattint, automatikusan be kell jelentkeznie az IDC-be, amelyhez be kell állítania az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
...
- [Az IDC kipróbálása az Azure AD-vel](https://aad.portal.azure.com/)