---
title: 'Oktatóanyag: Azure Active Directory-integráció IMPAC kockázati Manager |} A Microsoft Docs'
...
ms.locfileid: "39052628"
---
# <a name="tutorial-azure-active-directory-integration-with-impac-risk-manager"></a>Oktatóanyag: Azure Active Directory-integráció a IMPAC kockázati Managerrel
...
3. **[Hozzon létre egy IMPAC kockázati Manager tesztfelhasználót](#create-a-impac-risk-manager-test-user)**  – szeretné, hogy egy megfelelője a Britta Simon IMPAC kockázati Managerben, amely kapcsolódik az Azure AD felhasználói ábrázolása.
...
3. Az a **IMPAC kockázati Manager tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás Identitásszolgáltató által kezdeményezett módban konfigurálása:
...
7. Az a **IMPAC kockázati Manager konfigurációs** területén kattintson **IMPAC kockázati Manager konfigurálása** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML egyszeri bejelentkezési szolgáltatás URL-cím, a SAML Entitásazonosító** és **kijelentkezéses URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_configure.png)

8. Az egyszeri bejelentkezés konfigurálása **IMPAC kockázati Manager** oldalon kell küldenie a letöltött **Certificate(Base64)**, **kijelentkezéses URL-címet, a SAML Entitásazonosító,** és  **SAML egyszeri bejelentkezési szolgáltatás URL-cím** való [IMPAC kockázati Manager támogatási munkacsoportjának](mailto:rmsupport@Impac.co.nz). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
