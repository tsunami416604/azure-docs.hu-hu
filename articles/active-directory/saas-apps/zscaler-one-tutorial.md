...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Zscaler egy (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Zscaler egy egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Zscaler egy támogatja **SP** által kezdeményezett egyszeri bejelentkezés

* Zscaler egy támogatja **igény szerinti** felhasználók átadása
...
Ebben a szakaszban, konfigurálás és tesztelés az Azure AD egyszeri bejelentkezés Zscaler egy úgynevezett tesztfelhasználó alapján **Britta Simon**.
Egyszeri bejelentkezés működjön, az Azure AD-felhasználót és a kapcsolódó felhasználó a Zscaler egy hivatkozás kapcsolata kell hozható létre.
...
2. **[Zscaler egy egyszeri bejelentkezés konfigurálása](#configure-zscaler-one-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre egy Zscaler tesztfelhasználót](#create-zscaler-one-test-user)**  – egy megfelelője a Britta Simon Zscaler egy felhasználó Azure ad-ben reprezentációja van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Zscaler egy** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![Zscaler tartománya és URL-címek egyszeri bejelentkezési adatait](common/sp-signonurl.png)

    Az a **bejelentkezési URL-** beviteli mező, írja be az URL-cím jelentkezhessen be a Zscaler egy alkalmazásnak a felhasználók által használt-e.

    > [!NOTE]
    > A tényleges bejelentkezési URL-címet, frissítse az értéket. Kapcsolattartó [Zscaler egy ügyfél-támogatási csapatának](https://www.zscaler.com/company/contact) a gépkulcsengedélyek értékének. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.

5. A Zscaler egy alkalmazás a SAML helyességi feltételek vár egy megadott formátumban, amely megköveteli, hogy egyéni attribútum-leképezéshez az SAML-jogkivonat attribútumai konfigurációja. Az alábbi képernyőképen az alapértelmezett attribútumok listáját jeleníti meg. Kattintson a **szerkesztése** ikonra kattintva nyissa meg a **felhasználói attribútumok** párbeszédpanel.

    ![image](common/edit-attribute.png)

6. Emellett a fentiekben Zscaler egy alkalmazás vár néhány további attribútumok vissza SAML-válasz átadni. A a **felhasználói jogcímek** szakaszában a **felhasználói attribútumok** párbeszédpanelen a következő lépésekkel adja hozzá a SAML-jogkivonat attribútumot, ahogyan az alábbi táblázatban:
...
8. Az a **Zscaler egy beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-zscaler-one-single-sign-on"></a>Zscaler egy egyszeri bejelentkezés konfigurálása

1. Automatizálhatja a Zscaler egy konfigurációra, telepítenie kell **saját alkalmazások biztonságos bejelentkezési böngészőbővítmény** kattintva **a bővítmény telepítése**.

    ![Saját alkalmazások kiterjesztése](common/install-myappssecure-extension.png)

2. A felvett bővítmény a böngészőre, kattintson a **telepítő Zscaler egy** fog irányítja át a Zscaler egy alkalmazást. Itt adja meg a rendszergazdai hitelesítő adataival bejelentkezni a Zscaler egy. A webböngésző-bővítmény automatikusan konfigurálja az alkalmazást, és 3 – 6. lépések automatizálásához.

    ![Egyszeri bejelentkezés beállítása](common/setup-sso.png)

3. Ha azt szeretné beállítani egy Zscaler manuálisan, nyisson meg egy új böngészőablakban, és jelentkezzen be rendszergazdaként a Zscaler egy vállalati hely, és hajtsa végre az alábbi lépéseket:
...
7. Kattintson a **OK** gombra kattintva zárja be a **Internetbeállítások** párbeszédpanel.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Zscaler egy**.
...
### <a name="create-zscaler-one-test-user"></a>Hozzon létre Zscaler egy tesztfelhasználót.

Ebben a szakaszban egy Britta Simon nevű felhasználó a Zscaler egy jön létre. Zscaler egy támogatja a just-in-time-felhasználók létrehozásának, amely alapértelmezés szerint engedélyezve van. Nincs meg ebben a szakaszban a művelet elem. Ha a felhasználó még nem létezik a Zscaler egy, a hitelesítés után egy új jön létre.
...
Ha a hozzáférési panelen a Zscaler egy csempére kattint, akkor kell automatikusan megtörténik a a Zscaler egy, amelynek beállítása egyszeri Bejelentkezést. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
