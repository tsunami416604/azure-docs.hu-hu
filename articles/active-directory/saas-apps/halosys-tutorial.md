...
2. **[Halosys egyszeri bejelentkezés konfigurálása](#configure-halosys-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
### <a name="configure-halosys-single-sign-on"></a>Halosys egyetlen Sign-On konfigurálása
...
Ha a hozzáférési panelen a Halosys csempére kattint, automatikusan be kell jelentkeznie arra a Halosys, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
