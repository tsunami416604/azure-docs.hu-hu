---
title: 'Oktatóanyag: Az Azure Active Directory-integrációval rendelkező Accredible |} A Microsoft Docs'
...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Accredible (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Accredible egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a Accredible **Identitásszolgáltató** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **Accredible**válassza **Accredible** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
     ...
     ![Az eredmények listájában Accredible](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az Accredible nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó Accredible hivatkozás kapcsolata kell létrehozni.
...
2. **[Accredible egyszeri bejelentkezés konfigurálása](#configure-accredible-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre Accredible tesztfelhasználót](#create-accredible-test-user)**  – egy megfelelője a Britta Simon Accredible, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Accredible** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **állítsa be egyszeri bejelentkezést az SAML** lapon, a következő lépésekkel:
    ...
    ![Accredible tartomány és URL-címeket egyetlen bejelentkezési adatait](common/idp-intiated.png)
    ...
    b. Az a **válasz URL-cím** szövegmezőbe írja be a következő minta használatával URL-cím: `https://api.accredible.com/v1/saml/admin/<Unique id>/consume`
...
6. Az a **Accredible beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
Az egyszeri bejelentkezés konfigurálása **Accredible** oldalon kell küldenie a letöltött **összevonási metaadatainak XML** és az Azure Portalról másolt URL-címek megfelelő [Accredible támogatási csapatának](mailto:support@accredible.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Accredible**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Accredible**.

    ![Az alkalmazások listáját a Accredible hivatkozásra](common/all-applications.png)
...
Ha a hozzáférési panelen a Accredible csempére kattint, meg kell lehet automatikusan bejelentkezett a Accredible, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
