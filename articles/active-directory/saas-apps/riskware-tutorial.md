...
2. **[Riskware egyszeri bejelentkezés konfigurálása](#configure-riskware-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    | BEMUTATÓ| `https://riskcloud.net/demo?ccode=<COMPANYCODE>` |
    |||
    ...
    | BEMUTATÓ| `https://riskcloud.net/demo` |
    |||

    > [!NOTE]
    > A bejelentkezési URL-cím értéke nem valós. Frissítse az értéket a tényleges Sign-On URL-címmel. Az érték beszerzéséhez forduljon a riskware ügyfélszolgálati [csapatához](mailto:support@pansoftware.com.au) . Az Azure Portal **alapszintű SAML-konfiguráció** szakaszában látható mintázatokat is megtekintheti.
...
### <a name="configure-riskware-single-sign-on"></a>Riskware egyetlen Sign-On konfigurálása
...
Ha a hozzáférési panelen a riskware csempére kattint, automatikusan be kell jelentkeznie arra a riskware, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
