...
Amikor a hozzáférési panelen a humán csempére kattint, automatikusan be kell jelentkeznie arra az emberi adatszolgáltatásra, amelyhez az SSO-t beállította. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
...
- [Az emberi védelem a speciális láthatósággal és ellenőrzésekkel](/cloud-app-security/proxy-intro-aad)