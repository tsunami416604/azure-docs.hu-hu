---
title: 'Oktatóanyag: Az Azure Active Directory-integrációval rendelkező Egnyte |} A Microsoft Docs'
...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Egnyte (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Egnyte egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a Egnyte **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **Egnyte**válassza **Egnyte** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
     ...
     ![Az eredmények listájában Egnyte](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az Egnyte nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó Egnyte hivatkozás kapcsolata kell létrehozni.
...
2. **[Egnyte egyszeri bejelentkezés konfigurálása](#configure-egnyte-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre Egnyte tesztfelhasználót](#create-egnyte-test-user)**  – egy megfelelője a Britta Simon Egnyte, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Egnyte** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![Egnyte tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-signonurl.png)

    Az a **bejelentkezési URL-** szövegmezőbe írja be a következő minta használatával URL-cím:  `https://<companyname>.egnyte.com`

    > [!NOTE]
    > Az érték nem valódi. Frissítse az értéket a tényleges bejelentkezési URL-CÍMÉT. Kapcsolattartó [Egnyte ügyfél-támogatási csapatának](https://www.egnyte.com/corp/contact_egnyte.html) a gépkulcsengedélyek értékének. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.
...
5. Az a **Egnyte beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
3. Kattintson a menü **beállítások**.

    ![Beállítások](./media/egnyte-tutorial/ic787820.png "beállításai")

4. Kattintson a **konfigurációs** fülre, majd **biztonsági**.

    ![Biztonsági](./media/egnyte-tutorial/ic787821.png "biztonsági")

5. Az a **egyszeri bejelentkezéses hitelesítéshez** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Egnyte**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Egnyte**.

    ![Az alkalmazások listáját a Egnyte hivatkozásra](common/all-applications.png)
...
Ha a hozzáférési panelen a Egnyte csempére kattint, meg kell lehet automatikusan bejelentkezett a Egnyte, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
