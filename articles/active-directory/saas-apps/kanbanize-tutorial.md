...
1. Ha a **identitásszolgáltató** által kezdeményezett módban szeretné konfigurálni az alkalmazást, az **ALAPszintű SAML-konfiguráció** szakaszban adja meg a következő mezők értékeit:
    ...
    b. A **Válasz URL-címe** szövegmezőbe írja be a következő mintát használó URL-címet: `https://<subdomain>.kanbanize.com/saml/acs`

    c. Kattintson a **további URL-címek beállítása**elemre.

    d. A **továbbítási állapot** szövegmezőbe írja be a következő URL-címet: `/ctrl_login/saml_login`

1. Kattintson a **további URL-címek beállítása** elemre, és hajtsa végre a következő lépést, ha az alkalmazást **SP** -ben kezdeményezett módban szeretné konfigurálni:

    A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://<subdomain>.kanbanize.com`
...
7. Az **egyszeri bejelentkezés integrációs** lapján a **konfigurációk**területen hajtsa végre a következő lépéseket:
    ...
    d. Az E-mail szövegmezőben adja meg az **attribútum nevét** , `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress` értéket.

    e. Az **Utónév** szövegmezőbe írja be a (z) nevet a következő értékre: `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname`

    f. Az utónév szövegmezőbe írja be a következő értéket az **attribútum nevénél** : `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname`
