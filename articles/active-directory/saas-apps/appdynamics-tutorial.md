...
2. **[AppDynamics egyszeri bejelentkezés konfigurálása](#configure-appdynamics-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
### <a name="configure-appdynamics-single-sign-on"></a>AppDynamics egyetlen Sign-On konfigurálása
...
Ha a hozzáférési panelen a AppDynamics csempére kattint, automatikusan be kell jelentkeznie arra a AppDynamics, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
