...
2. **[Moconavi egyszeri bejelentkezés konfigurálása](#configure-moconavi-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    a. A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://<yourserverurl>/moconavi-saml2/saml/login`
...
4. Adja meg `https://mcs-admin.moconavi.biz/gateway` a **Kapcsolódás URL-cím** szövegmezőbe, majd kattintson a **kész** gombra.
...
5. Az alábbi képernyőképen hajtsa végre a következő lépéseket:
    ...
    a. Adja meg a **bemeneti hitelesítési kulcsot**:`azureAD` a **bemeneti hitelesítési kulcs** szövegmezőbe.

    b. Adja meg a **bemeneti**felhasználói azonosító: `your ad account` a **bemeneti felhasználói azonosító** szövegmezőbe.
