...
4. Írja be a keresőmezőbe, **Onit**, jelölje be **Onit** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Onit](./media/onit-tutorial/tutorial_onit_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/onit-tutorial/tutorial_onit_samlbase.png)

3. Az a **Onit tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk Onit tartomány és az URL-címek](./media/onit-tutorial/tutorial_onit_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** szakaszban, másolja a **UJJLENYOMAT** tanúsítvány értékét.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/onit-tutorial/tutorial_onit_certificate.png) 
...
7. Kattintson a **mentése** gombra.
    ...
    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/onit-tutorial/tutorial_general_400.png)
...
10. Kattintson a felső menüben **felügyeleti**.
   ...
   ![Felügyeleti](./media/onit-tutorial/IC791174.png "felügyeleti")
11. Kattintson a **Szerkesztés Corporation**.
   
   ![Szerkesztés Corporation](./media/onit-tutorial/IC791175.png "Szerkesztés Corporation")
...
2. Kattintson a **felhasználó hozzáadása**.
   ...
   ![Felügyeleti](./media/onit-tutorial/IC791180.png "felügyeleti")
...
2. Az alkalmazások listában válassza ki a **Onit**.
    ...
    ![Az alkalmazások listáját a Onit hivatkozás](./media/onit-tutorial/tutorial_onit_app.png)  
