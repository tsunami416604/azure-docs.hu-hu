---
title: 'Oktatóanyag: Az Azure Active Directory-integrációval rendelkező FactSet |} A Microsoft Docs'
...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve FactSet (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* FactSet egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a FactSet **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **FactSet**válassza **FactSet** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
     ...
     ![Az eredmények listájában FactSet](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az FactSet nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó FactSet hivatkozás kapcsolata kell létrehozni.
...
2. **[FactSet egyszeri bejelentkezés konfigurálása](#configure-factset-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre FactSet tesztfelhasználót](#create-factset-test-user)**  – egy megfelelője a Britta Simon FactSet, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **FactSet** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
6. Az a **FactSet beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **FactSet**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **FactSet**.

    ![Az alkalmazások listáját a FactSet hivatkozásra](common/all-applications.png)
...
Ha a hozzáférési panelen a FactSet csempére kattint, meg kell lehet automatikusan bejelentkezett a FactSet, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
