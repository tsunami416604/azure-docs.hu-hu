...
ms.date: 12/06/2017
ms.author: jeedes
ms.openlocfilehash: 8ff39f8e0b764d0b89a84de043b937cec04c586b
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: hu-HU
ms.lasthandoff: 06/18/2018
ms.locfileid: "35926018"
---
...
4. Írja be a keresőmezőbe, **FactSet**, jelölje be **FactSet** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában FactSet](./media/factset-tutorial/tutorial_factset_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/factset-tutorial/tutorial_factset_samlbase.png)

3. Az a **FactSet tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk FactSet tartomány és az URL-címek](./media/factset-tutorial/tutorial_factset_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/factset-tutorial/tutorial_factset_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/factset-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **FactSet**.
    ...
    ![Az alkalmazások listáját a FactSet hivatkozás](./media/factset-tutorial/tutorial_factset_app.png)  
