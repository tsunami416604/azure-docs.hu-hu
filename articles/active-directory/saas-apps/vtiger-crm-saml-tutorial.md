...
2. Az **[VTIGER CRM (SAML) egyszeri bejelentkezés konfigurálása](#configure-vtiger-crm-saml-sso)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
