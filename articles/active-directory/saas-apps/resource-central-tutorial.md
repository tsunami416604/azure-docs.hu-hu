...
* Használhatja a Microsoft Access panelt. Ha a hozzáférési panelen a forrás központi csempére kattint, a rendszer átirányítja az erőforrás központi bejelentkezési URL-címére. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
