...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-people"></a>Oktatóanyag: Egyszeri bejelentkezéses (SSO) integráció Azure Active Directory személyekkel
