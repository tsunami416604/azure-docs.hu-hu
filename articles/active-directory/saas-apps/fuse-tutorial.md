...
2. A **[biztosíték egyszeri bejelentkezésének konfigurálása](#configure-fuse-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://{tenantname}.fuseuniversal.com/`

    > [!NOTE]
    > Az érték nem valódi. Frissítse az értéket a tényleges bejelentkezési URL-címmel. Az érték beszerzéséhez vegye fel a kapcsolatot az [ügyfél-támogatási csapattal](mailto:support@fusion-universal.com) . Az Azure Portal **alapszintű SAML-konfiguráció** szakaszában látható mintázatokat is megtekintheti.
...
### <a name="configure-fuse-single-sign-on"></a>A biztosíték egyszeri bejelentkezésének konfigurálása
