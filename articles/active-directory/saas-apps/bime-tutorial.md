...
* Szabályozhatja, ki férhet hozzá Bime Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Bime (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Bime egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a Bime **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **Bime**válassza **Bime** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában Bime](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az Bime nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó Bime hivatkozás kapcsolata kell létrehozni.
...
2. **[Bime egyszeri bejelentkezés konfigurálása](#configure-bime-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre Bime tesztfelhasználót](#create-bime-test-user)**  – egy megfelelője a Britta Simon Bime, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Bime** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![Bime tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier.png)

    a. Az a **bejelentkezési URL-cím** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<tenant-name>.Bimeapp.com`

    b. Az a **azonosító (entityid)** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<tenant-name>.Bimeapp.com`

    > [!NOTE]
    > Ezek a értékei nem valódi. Frissítse a tényleges bejelentkezési URL-címet és azonosító ezeket az értékeket. Kapcsolattartó [Bime ügyfél-támogatási csapatának](https://bime.zendesk.com/hc/categories/202604307-Support-tech-notes-and-tips-) beolvasni ezeket az értékeket. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.
...
7. Az a **Bime beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
2. Az eszköztáron kattintson **rendszergazdai**, majd **fiók**.
  
    ![Rendszergazdai](./media/bime-tutorial/ic775558.png "rendszergazda")

3. A fiók konfigurálása lapon hajtsa végre az alábbi lépéseket:
    ...
    c. Az a **tanúsítvány-ujjlenyomat** szövegmezőjébe illessze be a **UJJLENYOMAT** Azure Portalról másolt érték.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Bime**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Bime**.

    ![Az alkalmazások listáját a Bime hivatkozásra](common/all-applications.png)
...
2. Az eszköztáron kattintson **rendszergazdai**, majd **felhasználók**.
...
Ha a hozzáférési panelen a Bime csempére kattint, meg kell lehet automatikusan bejelentkezett a Bime, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
