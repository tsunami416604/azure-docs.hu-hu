...
4. Írja be a keresőmezőbe, **Spacio**, jelölje be **Spacio** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Spacio](./media/spacio-tutorial/tutorial_spacio_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/spacio-tutorial/tutorial_spacio_samlbase.png)

3. Az a **Spacio tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk Spacio tartomány és az URL-címek](./media/spacio-tutorial/tutorial_spacio_url.png)
...
4. Kattintson a **mentése** gombra.
    ...
    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/spacio-tutorial/tutorial_general_400.png)
...
5. Az a **SAML-aláíró tanúsítványa** területen kattintson a Másolás gombra másolása **alkalmazás összevonási metaadatainak URL-címe** és illessze be a Jegyzettömbbe. 
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/spacio-tutorial/tutorial_spacio_certificate.png)

6. Egyszeri bejelentkezés konfigurálása **Spacio** oldalon kell küldeniük a **alkalmazás összevonási metaadatainak URL-címe** való [Spacio támogatási csoport](mailto:support@spac.io). Akkor állítsa be ezt a beállítást, hogy a SAML SSO kapcsolat mindkét oldalán megfelelően beállítva.
...
2. Az alkalmazások listában válassza ki a **Spacio**.
    ...
    ![Az alkalmazások listáját a Spacio hivatkozás](./media/spacio-tutorial/tutorial_spacio_app.png)  
