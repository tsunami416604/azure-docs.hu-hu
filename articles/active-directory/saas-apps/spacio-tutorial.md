...
3. **[Hozzon létre egy Spacio tesztfelhasználót](#create-a-spacio-test-user)**  – egy megfelelője a Britta Simon Spacio, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Spacio tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **Spacio** oldalon kell küldenie a **alkalmazás összevonási metaadatainak URL-címe** való [Spacio támogatási csapatának](mailto:support@spac.io). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
