...
* Szabályozhatja, ki férhet hozzá LockPath Keylight Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy a rendszer automatikusan bejelentkezve LockPath Keylight (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* LockPath Keylight egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a LockPath Keylight **SP** által kezdeményezett egyszeri bejelentkezés
* Támogatja a LockPath Keylight **igény szerinti** felhasználók átadása
...
4. A Keresés mezőbe írja be a **LockPath Keylight**válassza **LockPath Keylight** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

    ![Az eredmények listájában LockPath Keylight](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban konfigurálni és tesztelés az Azure AD egyszeri bejelentkezés LockPath Keylight nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó LockPath Keylight hivatkozás kapcsolata kell létrehozni.
...
2. **[LockPath Keylight egyszeri bejelentkezés konfigurálása](#configure-lockpath-keylight-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre LockPath Keylight tesztfelhasználót](#create-lockpath-keylight-test-user)**  – egy megfelelője a Britta Simon LockPath Keylight, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **LockPath Keylight** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![LockPath Keylight tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier-reply.png)

    a. Az a **bejelentkezési URL-cím** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<company name>.keylightgrc.com/`

    b. Az a **azonosító (entityid)** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<company name>.keylightgrc.com`
    ...
    > [!NOTE]
    > Ezek a értékei nem valódi. Frissítse a tényleges bejelentkezési URL-címet, a azonosítója és a válasz URL-cím ezeket az értékeket. Kapcsolattartó [LockPath Keylight ügyfél-támogatási csapatának](https://www.lockpath.com/contact/) beolvasni ezeket az értékeket. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.
...
6. Az a **LockPath Keylight beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-lockpath-keylight-single-sign-on"></a>LockPath Keylight egyszeri bejelentkezés konfigurálása
...
1. Az a **SAML-beállítások szerkesztése** párbeszédpanel lapon, a következő lépésekkel:
    ...
    b. Az a **Identity Provider bejelentkezési URL-cím** szövegmezőjébe illessze be a **bejelentkezési URL-cím** az Azure Portalról másolt érték.

    c. Az a **Identity Provider kijelentkezési URL-címe** szövegmezőjébe illessze be a **kijelentkezési URL-címe** az Azure Portalról másolt érték.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **LockPath Keylight**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **LockPath Keylight**.

    ![Az alkalmazások listáját a LockPath Keylight hivatkozás](common/all-applications.png)
...
Ha a hozzáférési panelen a LockPath Keylight csempére kattint, meg kell lehet automatikusan bejelentkezett a LockPath Keylight, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
