...
3. **[Egy sor WORKS tesztfelhasználó létrehozása](#creating-a-line-works-test-user)**  – egy megfelelője a Britta Simon sor működik, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    a. Az a **bejelentkezési URL-** szövegmezőbe írja be a következő minta használatával URL-címe: `https://auth.worksmobile.com/d/login/<domain>/`
...
6. Az a **állítsa be a sor WORKS** területén másolja a megfelelő URL-címet a követelmény alapján.
    ...
    ![VONAL WORKS konfigurációja](common/configuresection.png)
...
### <a name="creating-a-line-works-test-user"></a>Egy sor WORKS tesztfelhasználó létrehozása
...
2. Az alkalmazások listájában jelölje ki a **sor WORKS**.
    ...
    ![Egyszeri bejelentkezés konfigurálása](./media/worksmobile-tutorial/tutorial_lineworks_app.png)
