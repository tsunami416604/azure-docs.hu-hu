---
title: 'Oktatóanyag: Az Azure Active Directory-integráció a sor WORKS |} A Microsoft Docs'
...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezett sor Works (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* SOR működik egy bejelentkezési engedélyezett előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a sor WORKS **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **sor WORKS**, jelölje be **sor WORKS** eredmény panelen kattintson a **hozzáadása** gombra kattintva vegye fel az alkalmazást.
    ...
    ![SOR működik a találatok listájában](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés a sor WORKS nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó a sor WORKS hivatkozás kapcsolata kell létrehozni.
...
2. **[SOR WORKS egyszeri bejelentkezés konfigurálása](#configure-line-works-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre sor WORKS tesztfelhasználót](#create-line-works-test-user)**  – egy megfelelője a Britta Simon sor működik, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![SOR WORKS tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier.png)

    a. Az a **bejelentkezési URL-cím** szövegmezőbe írja be a következő minta használatával URL-cím: `https://auth.worksmobile.com/d/login/<domain>/`

    b. Az a **azonosító (entityid)** szövegmezőbe írja be egy URL-címe: `worksmobile.com`
...
6. Az a **állítsa be a sor WORKS** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-line-works-single-sign-on"></a>SOR WORKS egyszeri bejelentkezés konfigurálása

Az egyszeri bejelentkezés konfigurálása **sor WORKS** oldalán, kérjük, olvassa el a [sor WORKS SSO dokumentumok](https://developers.worksmobile.com/jp/document/1001080101) és a egy sor WORKS beállítás konfigurálása.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **sor működik**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **sor WORKS**.

    ![A sor WORKS hivatkozásra az alkalmazások listáját](common/all-applications.png)
...
### <a name="create-line-works-test-user"></a>SOR WORKS tesztfelhasználó létrehozása
...
Ha a hozzáférési panelen a sor WORKS csempére kattint, meg kell lehet automatikusan bejelentkezett a sor működését, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
