...
4. Írja be a keresőmezőbe, **Workrite**, jelölje be **Workrite** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Workrite](./media/workrite-tutorial/tutorial_workrite_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/workrite-tutorial/tutorial_workrite_samlbase.png)

3. Az a **Workrite tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk Workrite tartomány és az URL-címek](./media/workrite-tutorial/tutorial_workrite_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** kattintson **Certificate(Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/workrite-tutorial/tutorial_workrite_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/workrite-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **Workrite**.
    ...
    ![Az alkalmazások listáját a Workrite hivatkozás](./media/workrite-tutorial/tutorial_workrite_app.png)  
