...
4. A Keresés mezőbe írja be a **Showpad**.
...
3. **[Showpad tesztfelhasználó létrehozása](#creating-a-showpad-test-user)**  – egy megfelelője a Britta Simon Showpad, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Showpad tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Bejelentkezés a Showpad bérlői rendszergazdaként.
...
8. Navigáljon a "**egyszeri bejelentkezés**"és kattintson a"**engedélyezése**."
   
    ![Egyszeri bejelentkezés az alkalmazás oldalán konfigurálása](./media/showpad-tutorial/tutorial_showpad_002.png)

9. Az a **hozzáadni egy SAML 2.0-s** párbeszédpanelen hajtsa végre az alábbi lépéseket:
