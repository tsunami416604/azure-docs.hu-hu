...
4. Írja be a keresőmezőbe, **UserVoice**, jelölje be **UserVoice** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában UserVoice](./media/uservoice-tutorial/tutorial_uservoice_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/uservoice-tutorial/tutorial_uservoice_samlbase.png)

3. Az a **UserVoice tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információt UserVoice tartomány és az URL-címek](./media/uservoice-tutorial/tutorial_uservoice_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** szakaszban, másolja a **UJJLENYOMAT** tanúsítvány értékét.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/uservoice-tutorial/tutorial_uservoice_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/uservoice-tutorial/tutorial_general_400.png)
...
8. A felső eszköztáron kattintson **beállítások**, majd válassza ki **webes portál** a menüből.
    ...
    ![Az alkalmazás ügyféloldali beállítások szakaszban](./media/uservoice-tutorial/ic777519.png "beállítások")
...
9. A a **webes portál** lap a **felhasználóhitelesítés** területen kattintson **szerkesztése** megnyitásához a **felhasználói hitelesítés szerkesztése** párbeszédpanel lap.
    ...
    ![Webes portál lapon](./media/uservoice-tutorial/ic777520.png "webes portál")
...
2. Az alkalmazások listában válassza ki a **UserVoice**.
    ...
    ![Az alkalmazások listáját a UserVoice-hivatkozás](./media/uservoice-tutorial/tutorial_uservoice_app.png)  
