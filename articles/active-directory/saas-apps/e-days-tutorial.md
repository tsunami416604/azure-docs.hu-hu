...
Ha a hozzáférési panelen az E-nap csempére kattint, automatikusan be kell jelentkeznie arra az E-napra, amelyhez az SSO-t beállította. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
