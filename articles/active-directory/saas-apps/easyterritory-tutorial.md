...
4. Írja be a keresőmezőbe, **EasyTerritory**, jelölje be **EasyTerritory** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában EasyTerritory](./media/easyterritory-tutorial/tutorial_easyterritory_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/easyterritory-tutorial/tutorial_easyterritory_samlbase.png)
...
3. Az a **EasyTerritory tartomány és az URL-címek** szakaszban, ha szeretne beállítani az alkalmazás által kezdeményezett IDP módban, hajtsa végre az alábbi lépéseket:
    ...
    ![Az egyszeri bejelentkezés információk EasyTerritory tartomány és az URL-címek](./media/easyterritory-tutorial/tutorial_easyterritory_url.png)
...
4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:
    ...
    ![Az egyszeri bejelentkezés információk EasyTerritory tartomány és az URL-címek](./media/easyterritory-tutorial/tutorial_easyterritory_url1.png)
...
5. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/easyterritory-tutorial/tutorial_easyterritory_certificate.png) 

6. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/easyterritory-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **EasyTerritory**.
    ...
    ![Az alkalmazások listáját a EasyTerritory hivatkozás](./media/easyterritory-tutorial/tutorial_easyterritory_app.png)  
