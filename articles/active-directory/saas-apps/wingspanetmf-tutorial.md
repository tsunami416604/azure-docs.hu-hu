...
4. A Keresés mezőbe írja be a **Wingspan eTMF**.
...
3. **[Wingspan eTMF tesztfelhasználó létrehozása](#creating-a-wingspan-etmf-test-user)**  – egy megfelelője a Britta Simon a felhasználó Azure ad-ben reprezentációja kapcsolódó Wingspan eTMF rendelkeznie.
...
3. Az a **Wingspan eTMF tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **Wingspan eTMF** oldalon kell küldenie a letöltött **metaadatainak XML** való [Wingspan eTMF támogatási](http://www.wingspan.com/contact-us/). Azok beállítaniuk ezt, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
