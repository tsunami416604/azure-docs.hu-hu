...
* Szabályozhatja, ki férhet hozzá Wingspan eTMF Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Wingspan eTMF (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Wingspan eTMF egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a wingspan eTMF **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **Wingspan eTMF**válassza **Wingspan eTMF** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában wingspan eTMF](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az Wingspan eTMF nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó Wingspan eTMF hivatkozás kapcsolata kell létrehozni.
...
2. **[Egyszeri bejelentkezés Wingspan eTMF konfigurálása](#configure-wingspan-etmf-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre Wingspan eTMF tesztfelhasználót](#create-wingspan-etmf-test-user)**  – egy megfelelője a Britta Simon a felhasználó Azure ad-ben reprezentációja kapcsolódó Wingspan eTMF rendelkeznie.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Wingspan eTMF** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![Wingspan eTMF tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier-reply.png)

    a. Az a **bejelentkezési URL-** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<customer name>.<instance name>.mywingspan.com/saml`

    b. Az a **azonosító** mezőbe írja be a következő minta használatával URL-cím: `http://saml.<instance name>.wingspan.com/shibboleth`
...
6. Az a **Wingspan eTMF beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Wingspan eTMF**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Wingspan eTMF**.

    ![Az alkalmazások listáját a Wingspan eTMF hivatkozás](common/all-applications.png)
...
Ha a hozzáférési panelen, a Wingspan eTMF csempére kattint, meg kell lehet automatikusan bejelentkezett a Wingspan eTMF, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
