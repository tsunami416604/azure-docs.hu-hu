...
3. **[Hozzon létre egy Getabstract tesztfelhasználót](#create-a-getabstract-test-user)**  – egy megfelelője a Britta Simon Getabstract, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Getabstract tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód:
...
7. Az egyszeri bejelentkezés konfigurálása **Getabstract** oldalon kell küldenie a letöltött **metaadatainak XML** való [Getabstract támogatási csapatának](https://www.getabstract.com/en/contact). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
