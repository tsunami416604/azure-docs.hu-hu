...
4. Írja be a keresőmezőbe, **Clever**, jelölje be **Clever** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában intelligens](./media/clever-tutorial/tutorial_clever_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/clever-tutorial/tutorial_clever_samlbase.png)

3. Az a **intelligens tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információkat intelligens tartomány- és URL-címek](./media/clever-tutorial/tutorial_clever_url.png)
...
7. Kattintson a **mentése** gombra.
    ...
    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/clever-tutorial/tutorial_general_400.png)
