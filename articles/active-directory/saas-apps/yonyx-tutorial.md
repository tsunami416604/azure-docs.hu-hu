---
title: 'Oktatóanyag: Azure Active Directory-integráció az interaktív útmutatók Yonyx |} A Microsoft Docs'
...
ms.locfileid: "39050629"
---
# <a name="tutorial-azure-active-directory-integration-with-yonyx-interactive-guides"></a>Oktatóanyag: Azure Active Directory-integráció az Yonyx interaktív útmutatók
...
3. **[Hozzon létre egy interaktív útmutatók Yonyx tesztfelhasználót](#create-a-yonyx-interactive-guides-test-user)**  – egy megfelelője a Britta Simon Yonyx interaktív útmutatók, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Yonyx interaktív útmutatók tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
