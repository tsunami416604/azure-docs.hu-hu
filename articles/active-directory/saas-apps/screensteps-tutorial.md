...
2. **[ScreenSteps egyszeri bejelentkezés konfigurálása](#configure-screensteps-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
