...
1. A Keresés mezőbe írja be a **Boomi**válassza **Boomi** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[Hozzon létre egy Boomi tesztfelhasználót](#create-a-boomi-test-user)**  – egy megfelelője a Britta Simon Boomi, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a **Boomi tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Boomi alkalmazás a SAML helyességi feltételek vár egy megadott formátumban. Állítsa be a következő jogcímek ehhez az alkalmazáshoz. Ezek az attribútumok értékeinek kezelheti a "**felhasználói attribútumok**" szakasz alkalmazás integráció lapján. Az alábbi képernyőfelvételen látható erre egy példa látható.
    
    ![Egyszeri bejelentkezés konfigurálása](./media/boomi-tutorial/tutorial_attribute.png)

1. Az a **felhasználói attribútumok** szakaszában a **egyszeri bejelentkezési** párbeszédpanelen, az alábbi táblázatban szereplő minden egyes sorára hajtsa végre az alábbi lépéseket:
...
1. Az a **Boomi konfigurációs** területén kattintson **konfigurálása Boomi** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**
...
1. Navigáljon a **cégnév** , majd **beállítása**.

1. Kattintson a **egyszeri bejelentkezési beállítások** lapra, és hajtsa végre az alábbi lépéseket.
...
1. Miután bejelentkezett, lépjen **felhasználókezelés** , majd **felhasználók**.

    ![Felhasználók](./media/boomi-tutorial/tutorial_boomi_001.png "felhasználók")

1. Kattintson a **+** ikon és a **Hozzáadás/karbantartása felhasználói szerepkörök** párbeszédpanel nyílik meg.
...
1. Az alkalmazások listájában jelölje ki a **Boomi**.
