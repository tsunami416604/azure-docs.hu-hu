...
1. A Keresés mezőbe írja be a **NetDocuments**.

    ![Az Azure ad-ben tesztfelhasználó létrehozása](./media/netdocuments-tutorial/tutorial_netdocuments_search.png)

1. Az eredmények panelen válassza ki a **NetDocuments**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[NetDocuments tesztfelhasználó létrehozása](#creating-a-netdocuments-test-user)**  – egy megfelelője a Britta Simon NetDocuments, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a **NetDocuments tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Kattintson a **hozzáadása és eltávolítása a felhasználók és csoportok**.
   
    ![Tárház](./media/netdocuments-tutorial/ic795047.png "tárház")

1. Kattintson a **speciális hitelesítési beállítások konfigurálása**.
...
1. Az a **összevont identitás** párbeszédpanelen hajtsa végre az alábbi lépéseket:
...
1. Az a **E-mail cím** szövegmezőbe írja be egy érvényes Azure Active Directory-fiókot kíván üzembe helyezni, és kattintson az e-mail-címe **felhasználó hozzáadása**.
...
1. Az alkalmazások listájában jelölje ki a **NetDocuments**.
