...
4. A Keresés mezőbe írja be a **Kantega SSO a JIRA**.
...
3. **[Egy Kantega egyszeri bejelentkezés az JIRA tesztfelhasználó létrehozása](#creating-a-kantega-sso-for-jira-test-user)**  – Kantega egyszeri Bejelentkezést a felhasználó Azure ad-ben reprezentációja kapcsolódó JIRA-megfelelője a Britta Simon van.
...
3. A **Identitásszolgáltató** módban indul a **Kantega SSO JIRA tartomány és URL-címek** szakasz hajtsa végre a következő lépést:
...
7. Egy másik böngészőablakban jelentkezzen be a JIRA helyszíni kiszolgálón rendszergazdaként.
...
9. A bővítmények lapon szakasz alatt kattintson **új bővítmények keresése**. Keresés **Kantega SSO a JIRA (SAML & Kerberos)** kattintson **telepítése** gombra az új SAML beépülő modul telepítéséhez.
...
13. Új beépülő modul részen **INTEGRÁCIÓK**. Kattintson a **konfigurálása** a új beépülő modul konfigurálásához.
...
20. Az a **JIRA felhasználói fiókok** szakaszban, hajtsa végre a következő lépéseket:
...
3. A **felhasználókezelés** szakasz lapra, majd **felhasználó létrehozása**.
