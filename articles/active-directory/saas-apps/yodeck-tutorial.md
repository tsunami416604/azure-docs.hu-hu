...
3. **[Hozzon létre egy Yodeck tesztfelhasználót](#create-a-yodeck-test-user)**  – egy megfelelője a Britta Simon Yodeck, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Yodeck tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód:
...
7. Egy másik böngészőablakban jelentkezzen be a Yodeck vállalati hely rendszergazdaként.

8. Kattintson a **felhasználói beállítások** lehetőséget a képernyő jobb felső sarokban a lapot, majd válassza a **fiókbeállításokat**.

    ![Yodeck konfiguráció](./media/yodeck-tutorial/configure1.png)

9. Válassza ki **SAML** , és hajtsa végre az alábbi lépéseket:
