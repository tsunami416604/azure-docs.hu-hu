---
title: 'Oktatóanyag: Azure Active Directory-integráció az Pega rendszerek |} A Microsoft Docs'
...
3. **[Hozzon létre egy Pega rendszerek tesztfelhasználót](#create-a-pega-systems-test-user)**  - a-megfelelője a Britta Simon rendelkezik, amely kapcsolódik az Azure AD felhasználói ábrázolása Pega rendszerekben.
...
3. Az a **Pega rendszerek tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód:
...
9. Az egyszeri bejelentkezés konfigurálása **Pega rendszerek** oldalán, nyissa meg a **Pega portál** rendszergazdai fiókkal egy másik böngészőablakban.

10. Válassza ki **létrehozása** -> **SysAdmin (rendszergazda)** -> **hitelesítési szolgáltatás**.

    ![Egyszeri bejelentkezés Mentés gomb konfigurálása](./media/pegasystems-tutorial/tutorial_pegasystems_admin.png)
    
11. A következő műveleteket végrehajtására **Aauthentication szolgáltatás-létrehozás** képernyőjén:
...
12. A **identitásszolgáltató (IdP) információt** területén kattintson a **importálás IdP-metaadatok** , és keresse meg a metaadat-fájlt, amely már letöltötte az Azure Portalról. Kattintson a **küldés** a metaadatok betöltése.

    ![Egyszeri bejelentkezés Mentés gomb konfigurálása](./media/pegasystems-tutorial/tutorial_pegasystems_admin2.png)
    
13. Az IdP-adat Ez kitölti a lent látható módon.

    ![Egyszeri bejelentkezés Mentés gomb konfigurálása](./media/pegasystems-tutorial/tutorial_pegasystems_admin3.png)
    
14. A következő műveleteket végrehajtására **Service Provider (SP) beállítások** szakaszban:
