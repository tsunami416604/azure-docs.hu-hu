...
2. **[Gigya egyszeri bejelentkezés konfigurálása](#configure-gigya-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
3. Az **SAML-bejelentkezés** szakaszban hajtsa végre a következő lépéseket:
    ...
    c. Az **egyszeri bejelentkezési szolgáltatás URL-címe** szövegmezőbe illessze be az Azure Portalról másolt **bejelentkezési URL-cím** értékét.
...
2. Lépjen a **rendszergazda \> a felhasználók kezelése**elemre, majd kattintson a **felhasználók meghívása**elemre.
...
Ha a hozzáférési panelen a Gigya csempére kattint, automatikusan be kell jelentkeznie arra a Gigya, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
