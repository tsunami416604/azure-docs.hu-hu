...
4. **[A Zscaler két tesztfelhasználót létrehozása](#creating-a-zscaler-two-test-user)**  – egy megfelelője a Britta Simon Zscaler két, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Zscaler két tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Zscaler két konfigurációs** területén kattintson **Zscaler két konfigurálása** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/zscaler-two-tutorial/tutorial_zscalertwo_configure.png) 

7. Egy másik böngészőablakban jelentkezzen be a ZScaler két vállalati hely rendszergazdaként.
