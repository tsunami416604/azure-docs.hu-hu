...
4. A Keresés mezőbe írja be a **Moxi léphet**.

    ![Az Azure ad-ben tesztfelhasználó létrehozása](./media/moxiengage-tutorial/tutorial_moxiengage_search.png)

5. Az eredmények panelen válassza ki a **Moxi léphet**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
3. **[Moxi léphet tesztfelhasználó létrehozása](#creating-a-moxi-engage-test-user)**  – van egy megfelelője a Britta Simon Moxi léphet, amely kapcsolódik az Azure AD felhasználói ábrázolása.
...
3. Az a **Moxi léphet tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **Moxi léphet** oldalon kell küldenie a letöltött **metaadatainak XML** való [Moxi léphet támogatási csoport](mailto:support@moxiworks.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
