---
title: 'Oktatóanyag: Azure Active Directory-integráció az Workfront |} A Microsoft Docs'
...
4. A Keresés mezőbe írja be a **Workfront**.
...
3. **[Workfront tesztfelhasználó létrehozása](#creating-a-workfront-test-user)**  – egy megfelelője a Britta Simon Workfront, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Workfront tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Workfront konfigurációs** területén kattintson **konfigurálása Workfront** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-címet, és a SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/workfront-tutorial/tutorial_workfront_configure.png) 

7. Bejelentkezés a Workfront vállalati webhelyre rendszergazdaként.

8. Lépjen a **egyszeri bejelentkezés beállítása**.
