...
2. **[Workfront egyszeri bejelentkezés konfigurálása](#configure-workfront-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
Ha a hozzáférési panelen a Workfront csempére kattint, automatikusan be kell jelentkeznie arra a Workfront, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
