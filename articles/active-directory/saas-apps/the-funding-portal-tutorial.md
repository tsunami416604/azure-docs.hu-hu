...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-the-funding-portal"></a>Oktatóanyag: Azure Active Directory egyszeri bejelentkezés (SSO) integrációja a finanszírozási portálon
