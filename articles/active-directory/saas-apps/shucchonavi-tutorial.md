...
* Engedélyezheti a felhasználóknak, hogy a rendszer automatikusan bejelentkezve Shuccho Navi (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Shuccho Navi egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a Shuccho Navi **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **Shuccho Navi**válassza **Shuccho Navi** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
     ...
     ![Az eredmények listájában Shuccho Navi](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban konfigurálni és tesztelés az Azure AD egyszeri bejelentkezés Shuccho Navi nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó Shuccho Navi hivatkozás kapcsolata kell létrehozni.
...
2. **[Shuccho Navi egyszeri bejelentkezés konfigurálása](#configure-shuccho-navi-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre Shuccho Navi tesztfelhasználót](#create-shuccho-navi-test-user)**  – egy megfelelője a Britta Simon Shuccho Navi, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![Shuccho Navi tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-signonurl.png)
    ...
    > [!NOTE]
    > Az érték nem valódi. Frissítse az értéket a tényleges bejelentkezési URL-CÍMÉT. Kapcsolattartó [Shuccho Navi ügyfél-támogatási csapatának](mailto:sys_ntabtm@nta.co.jp) a gépkulcsengedélyek értékének. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.

5. Az a **állítsa be egyszeri bejelentkezést az SAML** lap a **SAML-aláíró tanúsítvány** területén kattintson **letöltése** letöltéséhez a **összevonási metaadatainak XML**  a megadott lehetőségek közül a követelmény alapján, majd mentse el a számítógépen.

    ![A tanúsítvány letöltési hivatkozás](common/metadataxml.png)

6. Az a **Shuccho Navi beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
Az egyszeri bejelentkezés konfigurálása **Shuccho Navi** oldalon kell küldenie a letöltött **metaadatainak XML** és az Azure Portalról másolt URL-címek megfelelő [Shuccho Navi támogatási csapatának](mailto:sys_ntabtm@nta.co.jp). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Shuccho Navi**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Shuccho Navi**.

    ![Az alkalmazások listáját a Shuccho Navi hivatkozás](common/all-applications.png)
...
### <a name="create-shuccho-navi-test-user"></a>Shuccho Navi tesztfelhasználó létrehozása
...
Ha a hozzáférési panelen a Shuccho Navi csempére kattint, meg kell lehet automatikusan bejelentkezett a Shuccho Navi, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
