---
title: 'Oktatóanyag: Azure Active Directory-integráció az Communifire |} A Microsoft Docs'
...
ms.locfileid: "39053807"
---
# <a name="tutorial-azure-active-directory-integration-with-communifire"></a>Oktatóanyag: Azure Active Directory-integráció az Communifire
...
3. **[Hozzon létre egy Communifire tesztfelhasználót](#create-a-communifire-test-user)**  – egy megfelelője a Britta Simon Communifire, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Communifire tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás Identitásszolgáltató által kezdeményezett módban konfigurálása:
...
8. Az egyszeri bejelentkezés konfigurálása **Communifire** oldalon kell küldenie a letöltött **metaadatainak XML** való [Communifire támogatási csapatának](https://my.axerosolutions.com/spaces/77/communifire-support/help/welcome). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
