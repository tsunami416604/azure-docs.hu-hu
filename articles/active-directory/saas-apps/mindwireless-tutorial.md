...
4. Írja be a keresőmezőbe, **mindWireless**, jelölje be **mindWireless** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![az eredménylistában mindWireless](./media/mindwireless-tutorial/tutorial_mindwireless_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/mindwireless-tutorial/tutorial_mindwireless_samlbase.png)

3. Az a **mindWireless tartomány és az URL-címek** területen tegye a következőket:

    ![az egyszeri bejelentkezési adatokat mindWireless tartomány és az URL-címek](./media/mindwireless-tutorial/tutorial_mindwireless_url.png)
...
7. Az a **SAML-aláíró tanúsítványa** kattintson **Certificate(Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/mindwireless-tutorial/tutorial_mindwireless_certificate.png) 

8. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/mindwireless-tutorial/tutorial_general_400.png)
...
9. A a **mindWireless konfigurációs** kattintson **mindWireless konfigurálása** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **Sign-Out URL-címet, a SAML entitás azonosítója és a SAML-alapú egyszeri bejelentkezési URL-címe** a a **rövid összefoglaló szakasz.**
    ...
    ![Konfigurációs mindWireless](./media/mindwireless-tutorial/tutorial_mindwireless_configure.png) 
...
2. Az alkalmazások listában válassza ki a **mindWireless**.
    ...
    ![Az alkalmazások listáját a mindWireless hivatkozás](./media/mindwireless-tutorial/tutorial_mindwireless_app.png)  
