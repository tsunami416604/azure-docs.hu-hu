...
3. **[Hozzon létre egy IriusRisk tesztfelhasználót](#create-a-iriusrisk-test-user)**  – egy megfelelője a Britta Simon IriusRisk, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **IriusRisk tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **IriusRisk** oldalon kell küldenie a letöltött **metaadatainak XML** való [IriusRisk támogatási csapatának](mailto:info@continuumsecurity.net). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
