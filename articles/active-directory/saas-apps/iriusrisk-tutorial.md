...
4. Írja be a keresőmezőbe, **IriusRisk**, jelölje be **IriusRisk** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában IriusRisk](./media/iriusrisk-tutorial/tutorial_iriusrisk_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/iriusrisk-tutorial/tutorial_iriusrisk_samlbase.png)

3. Az a **IriusRisk tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk IriusRisk tartomány és az URL-címek](./media/iriusrisk-tutorial/tutorial_iriusrisk_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/iriusrisk-tutorial/tutorial_iriusrisk_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/iriusrisk-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **IriusRisk**.
    ...
    ![Az alkalmazások listáját a IriusRisk hivatkozás](./media/iriusrisk-tutorial/tutorial_iriusrisk_app.png)  
