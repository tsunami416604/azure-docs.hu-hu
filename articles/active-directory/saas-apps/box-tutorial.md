...
4. Írja be a keresőmezőbe, **mezőben**, jelölje be **mezőben** az eredmények listájában, és válassza a **Hozzáadás**.
    ...
    ![Az eredmények listájában párbeszédpanel](./media/box-tutorial/tutorial_box_search.png)
...
3. A **mezőben tartomány és az URL-címek**, tegye a következőket:
    ...
    ![Az egyszeri bejelentkezés információkat "Mezőben a tartomány és az URL-címek"](./media/box-tutorial/url3.png)
...
4. A **SAML-aláíró tanúsítványa**, jelölje be **metaadatainak XML-kódja**, és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/box-tutorial/tutorial_box_certificate.png) 

5. Kattintson a **Mentés** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/box-tutorial/tutorial_general_400.png)
...
2. Az a **alkalmazások** listáról válassza ki **mezőben**.
    ...
    ![A csatolás](./media/box-tutorial/tutorial_box_app.png)  
...
* [A felhasználók átadása konfigurálása](box-userprovisioning-tutorial.md)
