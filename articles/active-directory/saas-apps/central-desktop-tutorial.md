...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    a. A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://<companyname>.centraldesktop.com`
...
2. Válassza a **személyek** lehetőséget, majd válassza a **belső Tagok hozzáadása**lehetőséget.
    ...
    ![Személyek](./media/central-desktop-tutorial/ic781051.png "Emberek")
