...
1. A SCIM-kiépítés konfigurálásához szükséges titkos token beszerzéséhez forduljon a myPolicies képviselőjéhez **support@mypolicies.com** .
...
5. A **rendszergazdai hitelesítő adatok** szakaszban adja meg `https://<myPoliciesCustomDomain>.mypolicies.com/scim` a **bérlői URL** -ben, ahol a `<myPoliciesCustomDomain>` a myPolicies egyéni tartománya. Az URL-címről lekérheti a myPolicies-ügyfél tartományát.
