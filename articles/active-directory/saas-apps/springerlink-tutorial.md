...
3. Az a **Springer hivatkozás tartomány és URL-címek** szakaszra, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód:
...
7. Az egyszeri bejelentkezés konfigurálása **Springer hivatkozás** oldalon kell küldenie a **alkalmazás összevonási metaadatainak URL-címe** való [Springer hivatkozás támogatási csapatának](mailto:identity@springernature.com).
