...
3. **[Hozzon létre egy Dealpath tesztfelhasználót](#create-a-dealpath-test-user)**  – egy megfelelője a Britta Simon Dealpath, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Dealpath tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Dealpath konfigurációs** területén kattintson **konfigurálása Dealpath** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Dealpath konfiguráció](./media/dealpath-tutorial/tutorial_dealpath_configure.png) 

7. Egy másik böngészőablakban, jelentkezzen be rendszergazdaként Dealpath.

8. Kattintson a jobb felső sarokban, **felügyeleti eszközökkel** , és keresse meg **Integrációk**, ezt a **SAML 2.0-s hitelesítési** szakaszban kattintson **Beállítások**:

    ![Dealpath konfiguráció](./media/dealpath-tutorial/tutorial_dealpath_admin.png)

9. Az a **SAML 2.0-s hitelesítés beállítása** lapon, a következő lépésekkel:
