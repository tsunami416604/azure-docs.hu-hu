---
title: 'Oktatóanyag: Azure Active Directory integráció a Dealpath-szel | Microsoft Docs'
description: Megtudhatja, hogyan konfigurálhat egyszeri bejelentkezést Azure Active Directory és Dealpath között.
...
Ebből az oktatóanyagból megtudhatja, hogyan integrálhatja a Dealpath a Azure Active Directory (Azure AD) szolgáltatással.
A Dealpath és az Azure AD integrálásával a következő előnyöket nyújtja:

* Az Azure AD-ben beállíthatja, hogy ki férhet hozzá a Dealpath.
* Lehetővé teheti a felhasználók számára, hogy automatikusan bejelentkezzenek a Dealpath (egyszeri bejelentkezés) az Azure AD-fiókokkal.
...
Az Azure AD-integráció Dealpath való konfigurálásához a következő elemek szükségesek:

* Egy Azure AD-előfizetés. Ha még nem rendelkezik Azure AD-környezettel, [itt](https://azure.microsoft.com/pricing/free-trial/) kérhet egy hónapos próbaverziót
* Dealpath egyszeri bejelentkezésre engedélyezett előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban egy tesztkörnyezetben konfigurálja és teszteli az Azure AD egyszeri bejelentkezést.

* A Dealpath támogatja az **SP** által KEZDEMÉNYEZett SSO-t

## <a name="adding-dealpath-from-the-gallery"></a>Dealpath hozzáadása a gyűjteményből

A Dealpath Azure AD-be való integrálásának konfigurálásához hozzá kell adnia a Dealpath a katalógusból a felügyelt SaaS-alkalmazások listájához.

**Ha Dealpath szeretne hozzáadni a katalógusból, hajtsa végre a következő lépéseket:**
...
2. **[Dealpath egyszeri bejelentkezés konfigurálása](#configure-dealpath-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
3. **[Azure ad-felhasználó létrehozása](#create-an-azure-ad-test-user)** – az Azure ad egyszeri bejelentkezés teszteléséhez a Britta Simon használatával.
4. **[Az Azure ad-teszt felhasználójának kiosztása](#assign-the-azure-ad-test-user)** – a Britta Simon engedélyezése az Azure ad egyszeri bejelentkezés használatára.
5. **[Hozzon létre Dealpath-teszt felhasználót](#create-dealpath-test-user)** – hogy a Dealpath Britta, a felhasználó Azure ad-képviseletéhez kapcsolódó partnerrel rendelkezzen.
...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    ![Dealpath tartomány és URL-címek egyszeri bejelentkezési adatai](common/sp-identifier.png)

    a. A **bejelentkezési URL-cím** szövegmezőbe írja be az URL-címet: `https://app.dealpath.com/account/login`

    b. Az **azonosító (Entity ID)** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://api.dealpath.com/saml/metadata/<ID>`

    > [!NOTE]
    > Az azonosító értéke nem valódi. Frissítse az értéket a tényleges azonosítóval. Az értékek lekéréséhez forduljon a Dealpath ügyfélszolgálati [csapatához](mailto:kenter@dealpath.com) . Az Azure Portal **alapszintű SAML-konfiguráció** szakaszában látható mintázatokat is megtekintheti.
...
6. A **Dealpath beállítása** szakaszban másolja ki a megfelelő URL-címeket a követelmények szerint.
...
### <a name="configure-dealpath-single-sign-on"></a>Dealpath egyetlen Sign-On konfigurálása
...
### <a name="create-dealpath-test-user"></a>Dealpath-tesztelési felhasználó létrehozása

Ebben a szakaszban egy Britta Simon nevű felhasználót hoz létre a Dealpath-ben. A [Dealpath ügyfél-támogatási csapattal](mailto:kenter@dealpath.com) együttműködve veheti fel a felhasználókat a Dealpath-platformba. Az egyszeri bejelentkezés használata előtt létre kell hozni és aktiválni kell a felhasználókat

### <a name="test-single-sign-on"></a>Az egyszeri bejelentkezés tesztelése 

Ebben a szakaszban az Azure AD egyszeri bejelentkezési konfigurációját teszteli a hozzáférési panel használatával.

Ha a hozzáférési panelen a Dealpath csempére kattint, automatikusan be kell jelentkeznie arra a Dealpath, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
