...
4. A Keresés mezőbe írja be a **Jobbadmin**.
...
3. **[Jobbadmin tesztfelhasználó létrehozása](#creating-a-jobbadmin-test-user)**  – egy megfelelője a Britta Simon Jobbadmin, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Jobbadmin tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **Jobbadmin** oldalon kell küldenie a letöltött **metaadatainak XML** való [Jobbadmin támogatási csapatának](https://www.jobbnorge.no/om-oss/kontakt-oss). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
