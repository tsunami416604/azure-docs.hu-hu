...
4. Írja be a keresőmezőbe, **AppNeta Teljesítményfigyelő**, jelölje be **AppNeta Teljesítményfigyelő** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában AppNeta Teljesítményfigyelő](./media/appneta-tutorial/tutorial_appneta_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/appneta-tutorial/tutorial_appneta_samlbase.png)

3. Az a **AppNeta teljesítményt figyelő tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk AppNeta teljesítményt figyelő tartomány és az URL-címek](./media/appneta-tutorial/tutorial_appneta_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/appneta-tutorial/tutorial_appneta_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/appneta-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **AppNeta Teljesítményfigyelő**.
    ...
    ![Az alkalmazások listáját a AppNeta Teljesítményfigyelő hivatkozás](./media/appneta-tutorial/tutorial_appneta_app.png)  
