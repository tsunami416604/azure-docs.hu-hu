...
5. Kattintson a **további URL-címek beállítása** elemre, és hajtsa végre a következő lépést, ha az alkalmazást **SP** -ben kezdeményezett módban szeretné konfigurálni:
    ...
    A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://<subdomain>.wdesk.com/auth/login/saml/<instancename>`
...
2. Navigáljon a **rendszergazda** > **fiók rendszergazdája**elemre.
...
5. A **felhasználó** szövegmezőbe írja be a felhasználó (például brittasimon@contoso.com) felhasználónevét, majd kattintson a **Folytatás** gombra.
...
6.  Adja meg a részleteket az alábbi ábrán látható módon:
    ...
    a. Az **e-mail** szövege szövegmezőbe írja be a brittasimon@contoso.comhoz hasonló felhasználó e-mail címét.
