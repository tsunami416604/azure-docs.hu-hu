...
4. **[Hozzon létre az SAP HANA tesztfelhasználót](#create-sap-hana-test-user)**  - a-megfelelője a Britta Simon rendelkezik, amely kapcsolódik az Azure AD felhasználói ábrázolása SAP HANA-ban.
