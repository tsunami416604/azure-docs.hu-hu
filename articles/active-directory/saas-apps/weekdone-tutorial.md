...
2. **[Weekdone egyszeri bejelentkezés konfigurálása](#configure-weekdone-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
4. Az **alapszintű SAML-konfiguráció** szakaszban, ha az alkalmazást **identitásszolgáltató** kezdeményezett módban szeretné konfigurálni, hajtsa végre a következő lépéseket:
    ...
    ![Weekdone tartomány és URL-címek egyszeri bejelentkezési adatai](common/idp-intiated.png)
...
5. Kattintson a **további URL-címek beállítása** elemre, és hajtsa végre a következő lépést, ha az alkalmazást **SP** -ben kezdeményezett módban szeretné konfigurálni:
    ...
    ![Weekdone tartomány és URL-címek egyszeri bejelentkezési adatai](common/metadata-upload-additional-signon.png)
...
Ha a hozzáférési panelen a Weekdone csempére kattint, automatikusan be kell jelentkeznie arra a Weekdone, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
