...
Ha a hozzáférési panelen a NumlyEngage™ csempére kattint, automatikusan be kell jelentkeznie arra a NumlyEngage-™, amelyhez be szeretné állítani az SSO-t. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [A NumlyEngage™ának biztosítása speciális láthatósággal és vezérlőkkel](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
