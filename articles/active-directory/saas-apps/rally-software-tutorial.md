...
4. Írja be a keresőmezőbe, **Rally szoftver**, jelölje be **Rally szoftver** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Szoftver Rally az eredménylistában](./media/rally-software-tutorial/tutorial_rallysoftware_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/rally-software-tutorial/tutorial_rallysoftware_samlbase.png)

3. Az a **Rally szoftver tartomány és az URL-címek** területen tegye a következőket:

    ![Szoftver tartomány és az URL-címek egyetlen bejelentkezési adatokat Rally](./media/rally-software-tutorial/tutorial_rallysoftware_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/rally-software-tutorial/tutorial_rallysoftware_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/rally-software-tutorial/tutorial_general_400.png)
...
6. A a **szoftverkonfigurációt Rally** kattintson **Rally szoftver konfigurálása** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **Sign-Out URL-címet, és a SAML Entitásazonosító** a a **rövid összefoglaló szakasz.**
    ...
    ![Rally szoftverkonfigurációjának összeállítása](./media/rally-software-tutorial/tutorial_rallysoftware_configure.png) 
...
4. Az a **felhasználó létrehozása** területen tegye a következőket:
    ...
    ![Hozzon létre felhasználói](./media/rally-software-tutorial/ic781040.png "felhasználó létrehozása")
...
2. Az alkalmazások listában válassza ki a **Rally szoftver**.
    ...
    ![Az alkalmazások listáját a szoftver Rally hivatkozás](./media/rally-software-tutorial/tutorial_rallysoftware_app.png)  
