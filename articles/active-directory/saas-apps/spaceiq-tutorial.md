...
4. Írja be a keresőmezőbe, **SpaceIQ**, jelölje be **SpaceIQ** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában SpaceIQ](./media/spaceiq-tutorial/tutorial_spaceiq_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/spaceiq-tutorial/tutorial_spaceiq_samlbase.png)

3. Az a **SpaceIQ tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk SpaceIQ tartomány és az URL-címek](./media/spaceiq-tutorial/tutorial_spaceiq_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** kattintson **(tanúsítvány Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/spaceiq-tutorial/tutorial_spaceiq_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/spaceiq-tutorial/tutorial_general_400.png)
...
10. Az a **SSO** párbeszédpanelen hajtsa végre az alábbi lépéseket:
    ...
    ![SAML-alapú hitelesítési beállítások](./media/spaceiq-tutorial/setting3.png)
...
2. Az alkalmazások listában válassza ki a **SpaceIQ**.
    ...
    ![Az alkalmazások listáját a SpaceIQ hivatkozás](./media/spaceiq-tutorial/tutorial_spaceiq_app.png)  
