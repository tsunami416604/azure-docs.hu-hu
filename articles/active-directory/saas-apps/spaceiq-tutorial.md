...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve SpaceIQ (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* SpaceIQ egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a SpaceIQ **Identitásszolgáltató** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **SpaceIQ**válassza **SpaceIQ** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredmények listájában SpaceIQ](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az SpaceIQ nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó SpaceIQ hivatkozás kapcsolata kell létrehozni.
...
2. **[SpaceIQ egyszeri bejelentkezés konfigurálása](#configure-spaceiq-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre SpaceIQ tesztfelhasználót](#create-spaceiq-test-user)**  – egy megfelelője a Britta Simon SpaceIQ, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **SpaceIQ** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **állítsa be egyszeri bejelentkezést az SAML** lapon, a következő lépésekkel:
    ...
    ![SpaceIQ tartomány és URL-címeket egyetlen bejelentkezési adatait](common/idp-intiated.png)

    a. Az a **azonosító** szövegmezőbe írja be az URL-cím: `https://api.spaceiq.com`

    b. Az a **válasz URL-cím** szövegmezőbe írja be a következő minta használatával URL-cím: `https://api.spaceiq.com/saml/<instanceid>/callback`
...
6. Az a **SpaceIQ beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
1. Az a **SSO** párbeszédpanelen hajtsa végre az alábbi lépéseket:
    ...
    a. Az a **SAML kiállítójának URL-címe** mezőbe illessze be a **az Azure AD-azonosító** az Azure AD alkalmazás-konfigurációs ablakából másolt érték.

    b. Másolás a **SAML visszahívási végpont URL-címe (csak olvasható)** értékét, és illessze be az értéket a **válasz URL-cím** párbeszédpanel a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.

    c. Másolás a **SAML célközönség URI (írásvédett)** értékét, és illessze be az értéket a **azonosító** párbeszédpanel a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **SpaceIQ**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **SpaceIQ**.

    ![Az alkalmazások listáját a SpaceIQ hivatkozásra](common/all-applications.png)
...
Ha a hozzáférési panelen a SpaceIQ csempére kattint, meg kell lehet automatikusan bejelentkezett a SpaceIQ, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
