...
4. Írja be a keresőmezőbe, **InTime**, jelölje be **InTime** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában InTime](./media/intime-tutorial/tutorial_intime_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/intime-tutorial/tutorial_intime_samlbase.png)

3. Az a **InTime tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információkat inTime tartomány- és URL-címek](./media/intime-tutorial/tutorial_intime_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/intime-tutorial/tutorial_intime_certificate.png) 
...
6. Kattintson a **mentése** gombra.
    ...
    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/intime-tutorial/tutorial_general_400.png)
