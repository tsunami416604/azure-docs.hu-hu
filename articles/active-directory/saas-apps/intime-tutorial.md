---
title: 'Oktatóanyag: Azure Active Directory-integráció az InTime |} A Microsoft Docs'
...
ms.locfileid: "39046872"
---
# <a name="tutorial-azure-active-directory-integration-with-intime"></a>Oktatóanyag: Azure Active Directory-integráció az InTime
...
3. **[Hozzon létre egy InTime tesztfelhasználót](#create-a-intime-test-user)**  – egy megfelelője a Britta Simon InTime, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **InTime tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
