...
4. Írja be a keresőmezőbe, **MOBI**, jelölje be **MOBI** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában MOBI](./media/mobi-tutorial/tutorial_mobi_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/mobi-tutorial/tutorial_mobi_samlbase.png)
...
3. Az a **MOBI tartomány és az URL-címek** szakaszban, ha szeretne beállítani az alkalmazás által kezdeményezett IDP módban, hajtsa végre az alábbi lépéseket:
    ...
    ![Az egyszeri bejelentkezés információk MOBI tartomány és az URL-címek](./media/mobi-tutorial/tutorial_mobi_url.png)
...
4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:
    ...
    ![Az egyszeri bejelentkezés információk MOBI tartomány és az URL-címek](./media/mobi-tutorial/tutorial_mobi_url1.png)
...
5. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/mobi-tutorial/tutorial_mobi_certificate.png) 

6. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/mobi-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **MOBI**.
    ...
    ![Az alkalmazások listáját a MOBI hivatkozás](./media/mobi-tutorial/tutorial_mobi_app.png)  
