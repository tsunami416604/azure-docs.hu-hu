...
* Szabályozhatja, ki férhet hozzá Syncplicity Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Syncplicity (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Syncplicity egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a Syncplicity **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **Syncplicity**válassza **Syncplicity** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

    ![Az eredmények listájában Syncplicity](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az Syncplicity nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó Syncplicity hivatkozás kapcsolata kell létrehozni.
...
2. **[Syncplicity egyszeri bejelentkezés konfigurálása](#configure-syncplicity-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre Syncplicity tesztfelhasználót](#create-syncplicity-test-user)**  – egy megfelelője a Britta Simon Syncplicity, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Syncplicity** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![Syncplicity tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier.png)
...
6. Az a **Syncplicity beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-syncplicity-single-sign-on"></a>Syncplicity egyszeri bejelentkezés konfigurálása
...
1. Az a **egyszeri bejelentkezéses (SSO)** párbeszédpanel lapon, a következő lépésekkel:
    ...
    c. A a **entitásazonosító** szövegmezőjébe illessze be az értéket, **Azure Ad-azonosító** Azure Portalról másolt.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Syncplicity**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Syncplicity**.

    ![Az alkalmazások listáját a Syncplicity hivatkozásra](common/all-applications.png)
...
Ha a hozzáférési panelen a Syncplicity csempére kattint, meg kell lehet automatikusan bejelentkezett a Syncplicity, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
