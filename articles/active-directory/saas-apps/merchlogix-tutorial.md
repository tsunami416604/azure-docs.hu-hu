...
4. Írja be a keresőmezőbe, **Merchlogix**, jelölje be **Merchlogix** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Merchlogix](./media/merchlogix-tutorial/tutorial_merchlogix_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/merchlogix-tutorial/tutorial_merchlogix_samlbase.png)

3. Az a **Merchlogix tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk Merchlogix tartomány és az URL-címek](./media/merchlogix-tutorial/tutorial_merchlogix_url.png)
...
4. A a **SAML-aláíró tanúsítványa** kattintson **tanúsítvány (Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/merchlogix-tutorial/tutorial_merchlogix_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/merchlogix-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **Merchlogix**.
    ...
    ![Az alkalmazások listáját a Merchlogix hivatkozás](./media/merchlogix-tutorial/tutorial_merchlogix_app.png)  
