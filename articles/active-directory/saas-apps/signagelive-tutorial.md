...
Amikor kiválasztja a **Signagelive** csempét a MyApps-portálon, automatikusan be kell jelentkeznie. További információ a MyApps-portálról: [Mi a MyApps-portál?](../user-help/my-apps-portal-end-user-access.md).
