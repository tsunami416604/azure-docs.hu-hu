---
title: 'Oktatóanyag: Azure Active Directory-integráció az TrackVia |} A Microsoft Docs'
...
ms.locfileid: "39042173"
---
# <a name="tutorial-azure-active-directory-integration-with-trackvia"></a>Oktatóanyag: Azure Active Directory-integráció az TrackVia
...
3. **[Hozzon létre egy TrackVia tesztfelhasználót](#create-a-trackvia-test-user)**  – egy megfelelője a Britta Simon TrackVia, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **TrackVia tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód:
...
7. Az a **TrackVia konfigurációs** területén kattintson **konfigurálása TrackVia** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML Entitásazonosító** származó a **gyors útmutató szakaszban.**

    ![TrackVia konfiguráció](./media/trackvia-tutorial/tutorial_trackvia_configure.png)
    
8. Másik böngésző ablakában jelentkezzen be a TrackVia vállalati hely rendszergazdaként.

9. Kattintson a Trackvia **My Account** beállításokat, majd válassza ki **az egyszeri bejelentkezést** fülre, hajtsa végre az alábbi lépéseket:
