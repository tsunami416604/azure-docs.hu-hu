...
4. Írja be a keresőmezőbe, **TrackVia**, jelölje be **TrackVia** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában TrackVia](./media/trackvia-tutorial/tutorial_trackvia_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/trackvia-tutorial/tutorial_trackvia_samlbase.png)
...
3. Az a **TrackVia tartomány és az URL-címek** területen tegye a következőket, ha szeretne beállítani az alkalmazás **IDP** kezdeményezett mód:
    ...
    ![Az egyszeri bejelentkezés információk TrackVia tartomány és az URL-címek](./media/trackvia-tutorial/tutorial_trackvia_url.png)

    Az a **azonosító** szövegmező, írja be az értéket: `TrackVia`

4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:

    ![Az egyszeri bejelentkezés információk TrackVia tartomány és az URL-címek](./media/trackvia-tutorial/tutorial_trackvia_url1.png)
...
5. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/trackvia-tutorial/tutorial_trackvia_certificate.png) 

6. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/trackvia-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **TrackVia**.
    ...
    ![Az alkalmazások listáját a TrackVia hivatkozás](./media/trackvia-tutorial/tutorial_trackvia_app.png)  
