...
3. **[Hozzon létre egy Boxcryptor tesztfelhasználót](#create-a-boxcryptor-test-user)**  – egy megfelelője a Britta Simon Boxcryptor, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Boxcryptor tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Boxcryptor konfigurációs** területén kattintson **konfigurálása Boxcryptor** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML egyszeri bejelentkezési szolgáltatás URL-cím** és **SAML Entitásazonosító** származó a **gyors útmutató szakaszban.**

    ![Andromeda SCM-konfiguráció](./media/boxcryptor-tutorial/tutorial_boxcryptor_configure.png)

7. Az egyszeri bejelentkezés konfigurálása **Boxcryptor** oldalon kell küldenie a letöltött **tanúsítvány (Base64)**, **SAML egyszeri bejelentkezési szolgáltatás URL-cím** és **SAML Entitásazonosító** való [Boxcryptor támogatási csapatának](mailto:support@boxcryptor.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
