...
2. A **[Adoddle cSaas-platform egyszeri bejelentkezésének konfigurálása](#configure-adoddle-csaas-platform-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
### <a name="configure-adoddle-csaas-platform-single-sign-on"></a>A Adoddle cSaas-platform egyszeri bejelentkezésének konfigurálása
...
Ha a hozzáférési panelen a Adoddle cSaas-platform csempére kattint, automatikusan be kell jelentkeznie a Adoddle cSaas-platformra, amelyhez be kell állítania az SSO-t. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
