...
4. Írja be a keresőmezőbe, **Druva**, jelölje be **Druva** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Druva](./media/druva-tutorial/tutorial_druva_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/druva-tutorial/tutorial_druva_samlbase.png)
...
5. Az a **SAML-aláíró tanúsítványa** kattintson **Certificate(Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/druva-tutorial/tutorial_druva_certificate.png) 
...
12. Az egyszeri bejelentkezés beállításai párbeszédpanel hajtsa végre a következő lépéseket:
    ...
    ![Az egyszeri bejelentkezés beállítások](./media/druva-tutorial/ic795092.png "az egyszeri bejelentkezés beállításai")
...
13. Az a **beállítások** kattintson **SSO jogkivonat készítése**.
    ...
    ![Beállítások](./media/druva-tutorial/ic795093.png "beállítások")

14. Az a **egyszeri bejelentkezés hitelesítési jogkivonat** párbeszédpanelen hajtsa végre a következő lépéseket:

    ![Egyszeri bejelentkezési Token](./media/druva-tutorial/ic795094.png "SSO jogkivonat")
...
2. Az alkalmazások listában válassza ki a **Druva**.
    ...
    ![Az alkalmazások listáját a Druva hivatkozás](./media/druva-tutorial/tutorial_druva_app.png)  
