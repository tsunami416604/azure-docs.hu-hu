...
1. A Keresés mezőbe írja be a **Capriza Platform**.

    ![Az Azure ad-ben tesztfelhasználó létrehozása](./media/capriza-tutorial/tutorial_caprizaplatform_search.png)

1. Az eredmények panelen válassza ki a **Capriza Platform**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[Capriza Platform tesztfelhasználó létrehozása](#creating-a-capriza-platform-test-user)**  – egy megfelelője a Britta Simon Capriza Platform, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a **Capriza Platform tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Az a **Capriza Platformregisztrációt** területén kattintson **Capriza Platform konfigurálása** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-címe, SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/capriza-tutorial/tutorial_caprizaplatform_configure.png) 

1. Az egyszeri bejelentkezés konfigurálása **Capriza Platform** oldalon kell küldenie a letöltött **tanúsítvány**, **kijelentkezéses URL-cím**, **SAML Entitásazonosító**és **SAML egyszeri bejelentkezési szolgáltatás URL-cím** való [Capriza Platform támogatási csapatának](mailTo:support@capriza.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az alkalmazások listájában jelölje ki a **Capriza Platform**.
