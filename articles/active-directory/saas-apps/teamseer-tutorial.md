...
2. **[TeamSeer egyszeri bejelentkezés konfigurálása](#configure-teamseer-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
Ha a hozzáférési panelen a TeamSeer csempére kattint, automatikusan be kell jelentkeznie arra a TeamSeer, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
