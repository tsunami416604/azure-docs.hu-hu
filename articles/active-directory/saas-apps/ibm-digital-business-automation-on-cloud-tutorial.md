...
- [Az IBM digitális üzleti automatizálásának biztosítása a felhőben fejlett láthatósággal és ellenőrzésekkel](/cloud-app-security/proxy-intro-aad)