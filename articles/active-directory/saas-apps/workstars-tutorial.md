...
4. Írja be a keresőmezőbe, **Workstars**, jelölje be **Workstars** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Workstars](./media/workstars-tutorial/tutorial_workstars_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/workstars-tutorial/tutorial_workstars_samlbase.png)

3. Az a **Workstars tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk Workstars tartomány és az URL-címek](./media/workstars-tutorial/tutorial_workstars_url.png)
...
4. A a **SAML-aláíró tanúsítványa** kattintson **tanúsítvány (Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/workstars-tutorial/tutorial_workstars_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/workstars-tutorial/tutorial_general_400.png)
...
8. Kattintson az eszköztáron **beállítások**.
    ...
    ![Workstars Dokumentumb](./media/workstars-tutorial/tutorial_workstars_sett.png)
...
2. Az alkalmazások listában válassza ki a **Workstars**.
    ...
    ![Az alkalmazások listáját a Workstars hivatkozás](./media/workstars-tutorial/tutorial_workstars_app.png)  
