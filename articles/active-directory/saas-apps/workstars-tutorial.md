---
title: 'Oktatóanyag: Azure Active Directory-integráció az Workstars |} A Microsoft Docs'
...
ms.locfileid: "39055540"
---
# <a name="tutorial-azure-active-directory-integration-with-workstars"></a>Oktatóanyag: Azure Active Directory-integráció az Workstars
...
3. **[Hozzon létre egy Workstars tesztfelhasználót](#create-a-workstars-test-user)**  – egy megfelelője a Britta Simon Workstars, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Workstars tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Workstars konfigurációs** területén kattintson **konfigurálása Workstars** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-címe, SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Workstars konfiguráció](./media/workstars-tutorial/tutorial_workstars_configure.png) 

7. Egy másik böngészőablakban jelentkezzen be a Workstars vállalati hely rendszergazdaként.

8. Az eszköztáron kattintson **beállítások**.

    ![Workstars eltávolítási](./media/workstars-tutorial/tutorial_workstars_sett.png)

9. Lépjen a **bejelentkezés** > **beállítások**.
