...
2. A **[cerner központi egyszeri bejelentkezésének konfigurálása](#configure-cerner-central-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
### <a name="configure-cerner-central-single-sign-on"></a>A Cerner Central egyetlen Sign-On konfigurálása
...
Ha a hozzáférési panelen a Cerner központi csempére kattint, automatikusan be kell jelentkeznie a Cerner központi részére, amelyhez be kell állítania az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
