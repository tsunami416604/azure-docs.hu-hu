---
title: 'Oktatóanyag: Azure Active Directory integráció a CloudPassage-szel | Microsoft Docs'
...
ms.locfileid: "73157361"
---
# <a name="tutorial-azure-active-directory-integration-with-cloudpassage"></a>Oktatóanyag: Azure Active Directory integráció a CloudPassage

Ebből az oktatóanyagból megtudhatja, hogyan integrálhatja a CloudPassage a Azure Active Directory (Azure AD) szolgáltatással.
A CloudPassage és az Azure AD integrálásával a következő előnyöket nyújtja:

* Az Azure AD-ben beállíthatja, hogy ki férhet hozzá a CloudPassage.
* Lehetővé teheti a felhasználók számára, hogy automatikusan bejelentkezzenek a CloudPassage (egyszeri bejelentkezés) az Azure AD-fiókokkal.
...
Az Azure AD-integráció CloudPassage való konfigurálásához a következő elemek szükségesek:

* Egy Azure AD-előfizetés. Ha még nem rendelkezik Azure AD-környezettel, [itt](https://azure.microsoft.com/pricing/free-trial/) kérhet egy hónapos próbaverziót
* CloudPassage egyszeri bejelentkezésre engedélyezett előfizetés
...
**Ha CloudPassage szeretne hozzáadni a katalógusból, hajtsa végre a következő lépéseket:**
...
4. A keresőmezőbe írja be a **CloudPassage**kifejezést, válassza a **CloudPassage** elemet az eredmény panelen, majd kattintson a **Hozzáadás** gombra az alkalmazás hozzáadásához.

     ![CloudPassage az eredmények listájában](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés konfigurálása és tesztelése

Ebben a szakaszban az Azure AD egyszeri bejelentkezést az CloudPassage-mel konfigurálja és teszteli a **Britta Simon**nevű tesztelési felhasználó alapján.
Az egyszeri bejelentkezés működéséhez az Azure AD-felhasználó és a CloudPassage kapcsolódó felhasználó közötti kapcsolat létesítésére van szükség.

Az Azure AD egyszeri bejelentkezés CloudPassage való konfigurálásához és teszteléséhez a következő építőelemeket kell végrehajtania:

1. Az **[Azure ad egyszeri bejelentkezésének konfigurálása](#configure-azure-ad-single-sign-on)** – lehetővé teszi a felhasználók számára a funkció használatát.
2. **[CloudPassage egyszeri bejelentkezés konfigurálása](#configure-cloudpassage-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
3. **[Azure ad-felhasználó létrehozása](#create-an-azure-ad-test-user)** – az Azure ad egyszeri bejelentkezés teszteléséhez a Britta Simon használatával.
4. **[Az Azure ad-teszt felhasználójának kiosztása](#assign-the-azure-ad-test-user)** – a Britta Simon engedélyezése az Azure ad egyszeri bejelentkezés használatára.
5. **[Hozzon létre CloudPassage-teszt felhasználót](#create-cloudpassage-test-user)** – hogy a CloudPassage Britta, a felhasználó Azure ad-képviseletéhez kapcsolódó partnerrel rendelkezzen.
...
Az Azure AD egyszeri bejelentkezés CloudPassage való konfigurálásához hajtsa végre a következő lépéseket:

1. A [Azure Portal](https://portal.azure.com/) **CloudPassage** alkalmazás-integráció lapján válassza az **egyszeri bejelentkezés**lehetőséget.
...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    ![CloudPassage tartomány és URL-címek egyszeri bejelentkezési adatai](common/sp-reply.png)

    a. A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://portal.cloudpassage.com/saml/init/accountid`
...
5. A CloudPassage alkalmazás megadott formátumban várja az SAML-kijelentéseket. Konfigurálja a következő jogcímeket ehhez az alkalmazáshoz. Az attribútumok értékeit az alkalmazás-integráció lapon, a **felhasználói attribútumok** szakaszban kezelheti. Az **egyszeri bejelentkezés SAML-vel való beállítása** lapon kattintson a **Szerkesztés** gombra a **felhasználói attribútumok** párbeszédpanel megnyitásához.
...
8. A **CloudPassage beállítása** szakaszban másolja ki a megfelelő URL-címeket a követelmények szerint.
...
Ebben a szakaszban a Britta Simon használatával engedélyezheti az Azure egyszeri bejelentkezést a CloudPassage hozzáférésének biztosításával.

1. A Azure Portal válassza a **vállalati alkalmazások**lehetőséget, válassza a **minden alkalmazás**lehetőséget, majd válassza a **CloudPassage**lehetőséget.

    ![Vállalati alkalmazások panel](common/enterprise-applications.png)

2. Az alkalmazások listában válassza a **CloudPassage**lehetőséget.

    ![Az CloudPassage hivatkozás az alkalmazások listájában](common/all-applications.png)
...
Ennek a szakasznak a célja egy Britta Simon nevű felhasználó létrehozása a CloudPassage-ben.

**A következő lépések végrehajtásával hozhat létre egy Britta Simon nevű felhasználót a CloudPassage-ben:**
