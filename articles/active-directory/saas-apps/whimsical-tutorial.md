...
Ha a hozzáférési panelen a szeszélyes csempére kattint, automatikusan be kell jelentkeznie arra a Szeszélybe, amelyhez az SSO-t beállította. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
