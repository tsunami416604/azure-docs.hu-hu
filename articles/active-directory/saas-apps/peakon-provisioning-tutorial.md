...
* A Peakon összes egyéni felhasználói attribútumát ki kell terjeszteni a Peakon egyéni SCIM-bővítményének `urn:ietf:params:scim:schemas:extension:peakon:2.0:User`.
