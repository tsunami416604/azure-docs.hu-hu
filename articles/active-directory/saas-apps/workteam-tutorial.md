...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Workteam (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Workteam egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a Workteam **SP** és **Identitásszolgáltató** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **Workteam**válassza **Workteam** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
     ...
     ![Az eredmények listájában Workteam](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az Workteam nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó Workteam hivatkozás kapcsolata kell létrehozni.
...
2. **[Workteam egyszeri bejelentkezés konfigurálása](#configure-workteam-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre Workteam tesztfelhasználót](#create-workteam-test-user)**  – egy megfelelője a Britta Simon Workteam, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Workteam** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszra, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett módban a felhasználónak nincs bármely lépése végrehajtani, mert az alkalmazás már előre integrált az Azure-ral.
    ...
    ![Workteam tartomány és URL-címeket egyetlen bejelentkezési adatait](common/preintegrated.png)

5. Kattintson a **további URL-címet beállítani** , és hajtsa végre a következő lépést, ha az alkalmazás a konfigurálni kívánt **SP** kezdeményezett mód:

    ![Workteam tartomány és URL-címeket egyetlen bejelentkezési adatait](common/metadata-upload-additional-signon.png)
...
7. Az a **Workteam beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
1. Egy másik böngészőablakban jelentkezzen be Workteam egy biztonsági-rendszergazdaként.

2. Kattintson a jobb felső sarokban a **embléma profil** majd kattintson a **szervezeti beállítások**. 

    ![Workteam beállításai](./media/workteam-tutorial/tutorial_workteam_settings.png)

3. A **hitelesítési** területén kattintson a **beállítások embléma**.

     ![Workteam azure](./media/workteam-tutorial/tutorial_workteam_azure.png)

4. Az a **SAML-beállítások** lapon, a következő lépésekkel:

     ![Workteam saml](./media/workteam-tutorial/tutorial_workteam_saml.png)

    a. Válassza ki **identitásszolgáltató SAML** , **AD Azure**.

    b. Az a **SAML egyszeri bejelentkezési szolgáltatás URL-cím** szövegmező, illessze be az értéket a **bejelentkezési URL-cím**, az Azure Portalról másolt.

    c. A a **SAML Entitásazonosító** szövegmezőjébe illessze be az értéket, **az Azure AD-azonosító**, az Azure Portalról másolt.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Workteam**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Workteam**.

    ![Az alkalmazások listáját a Workteam hivatkozásra](common/all-applications.png)
...
### <a name="create-workteam-test-user"></a>Workteam tesztfelhasználó létrehozása

Ahhoz, hogy az Azure AD-felhasználók Workteam bejelentkezni, akkor ki kell építeni Workteam be. Workteam a kiépítés manuális feladat.
...
Ha a hozzáférési panelen a Workteam csempére kattint, meg kell lehet automatikusan bejelentkezett a Workteam, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
