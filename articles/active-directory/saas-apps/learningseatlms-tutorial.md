...
2. Az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán a **[learning Seat LMS egyszeri bejelentkezés konfigurálásával](#configure-learning-seat-lms-single-sign-on)** .
...
4. Az **alapszintű SAML-konfiguráció** szakaszban, ha az alkalmazást **identitásszolgáltató** kezdeményezett módban szeretné konfigurálni, hajtsa végre a következő lépéseket:
    ...
    ![A Learning Seat LMS-tartomány és az URL-címek egyszeri bejelentkezési adatai](common/idp-intiated.png)
...
5. Kattintson a **további URL-címek beállítása** elemre, és hajtsa végre a következő lépést, ha az alkalmazást **SP** -ben kezdeményezett módban szeretné konfigurálni:
    ...
    ![A Learning Seat LMS-tartomány és az URL-címek egyszeri bejelentkezési adatai](common/metadata-upload-additional-signon.png)

    A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://<subdomain>.learningseatlms.com`
...
### <a name="configure-learning-seat-lms-single-sign-on"></a>A Learning Seat LMS egyszeri bejelentkezésének konfigurálása
