...
1. A Keresés mezőbe írja be a **Learning munkaállomás LMS**.

    ![Az Azure ad-ben tesztfelhasználó létrehozása](./media/learningseatlms-tutorial/tutorial_learnconnect_search.png)

1. Az eredmények panelen válassza ki a **Learning munkaállomás LMS**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[Learning munkaállomás LMS tesztfelhasználó létrehozása](#creating-a-learnconnect-test-user)**  – egy megfelelője a Britta Simon Learning munkaállomás segítségével, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a **Learning munkaállomás LMS tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód:
...
1. Az egyszeri bejelentkezés konfigurálása **Learning munkaállomás LMS** oldalon kell küldenie a letöltött **metaadatainak XML** való [Learning munkaállomás-ügyfélszolgálathoz](http://help.learningseatlms.com/help).
...
1. Az alkalmazások listájában jelölje ki a **Learning munkaállomás LMS**.
