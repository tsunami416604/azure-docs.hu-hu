---
title: 'Oktatóanyag: Azure Active Directory-integráció az Panopto |} A Microsoft Docs'
...
ms.locfileid: "39051448"
---
# <a name="tutorial-azure-active-directory-integration-with-panopto"></a>Oktatóanyag: Azure Active Directory-integráció az Panopto
...
4. A Keresés mezőbe írja be a **Panopto**.
...
3. **[Panopto tesztfelhasználó létrehozása](#creating-a-panopto-test-user)**  – egy megfelelője a Britta Simon Panopto, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Panopto tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Panopto konfigurációs** területén kattintson **konfigurálása Panopto** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/panopto-tutorial/tutorial_panopto_configure.png) 

7. Egy másik böngészőablakban jelentkezzen be a Panopto vállalati hely rendszergazdaként.

8. A bal oldali eszköztáron kattintson **rendszer**, és kattintson a **Identitásszolgáltatók**.
   
   ![Rendszer](./media/panopto-tutorial/ic777670.png "rendszer")
9. Kattintson a **szolgáltató hozzáadása**.
   
   ![Identitás-szolgáltatóktól](./media/panopto-tutorial/ic777671.png "Identitásszolgáltatók")
   
10. Az SAML-szolgáltató szakaszában hajtsa végre az alábbi lépéseket:
