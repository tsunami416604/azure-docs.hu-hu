...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve XaitPorter (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* XaitPorter egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a XaitPorter **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **XaitPorter**válassza **XaitPorter** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában XaitPorter](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az XaitPorter nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó XaitPorter hivatkozás kapcsolata kell létrehozni.
...
2. **[XaitPorter egyszeri bejelentkezés konfigurálása](#configure-xaitporter-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre XaitPorter tesztfelhasználót](#create-xaitporter-test-user)**  – egy megfelelője a Britta Simon XaitPorter, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **XaitPorter** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![XaitPorter tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier.png)

    a. Az a **bejelentkezési URL-cím** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<subdomain>.xaitporter.com/saml/login`

    b. Az a **azonosító (entityid)** szövegmezőbe írja be a következő minta használatával URL-cím: `https://<subdomain>.xaitporter.com`

    > [!NOTE]
    > Ezek a értékei nem valódi. Frissítse a tényleges bejelentkezési URL-címet és azonosító ezeket az értékeket. Kapcsolattartó [XaitPorter ügyfél-támogatási csapatának](https://www.xait.com/support/) beolvasni ezeket az értékeket. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.
...
6. Adja meg a **IP-cím** vagy a **alkalmazás összevonási metaadatainak URL-címe** , a [SmartRecruiters támogatási csoportjának](https://www.smartrecruiters.com/about-us/contact-us/), így XaitPorter is győződjön meg arról, hogy IP-cím elérhető a a Engedélyezési lista konfigurálása a saját oldalán XaitPorter példány. 
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **XaitPorter**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **XaitPorter**.

    ![Az alkalmazások listáját a XaitPorter hivatkozásra](common/all-applications.png)
...
Ha a hozzáférési panelen a XaitPorter csempére kattint, meg kell lehet automatikusan bejelentkezett a XaitPorter, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
