---
title: 'Oktatóanyag: Azure Active Directory-integráció az XaitPorter |} A Microsoft Docs'
...
ms.locfileid: "39055576"
---
# <a name="tutorial-azure-active-directory-integration-with-xaitporter"></a>Oktatóanyag: Azure Active Directory-integráció az XaitPorter
...
3. **[Hozzon létre egy XaitPorter tesztfelhasználót](#create-a-xaitporter-test-user)**  – egy megfelelője a Britta Simon XaitPorter, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **XaitPorter tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
7. Egy másik böngészőablakban jelentkezzen be a XaitPorter vállalati hely rendszergazdaként.

8. Kattintson a **rendszergazdai**.

    ![Egyszeri bejelentkezés konfigurálása](./media/xaitporter-tutorial/user1.png)

9. Válassza ki **felügyelete egyszeri bejelentkezéssel** származó a **System telepítése** legördülő listából.

    ![Egyszeri bejelentkezés konfigurálása](./media/xaitporter-tutorial/user2.png)

10. Az a **kezelése EGYSZERI bejelentkezés** szakaszban, hajtsa végre az alábbi lépéseket:
