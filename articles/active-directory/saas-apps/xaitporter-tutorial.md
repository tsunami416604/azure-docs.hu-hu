...
ms.date: 04/16/2017
ms.author: jeedes
ms.openlocfilehash: 068ea487d2b3465f6b31329df5c7a9df1f513016
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: hu-HU
ms.lasthandoff: 06/18/2018
ms.locfileid: "35927605"
---
...
4. Írja be a keresőmezőbe, **XaitPorter**, jelölje be **XaitPorter** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában XaitPorter](./media/xaitporter-tutorial/tutorial_xaitporter_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/xaitporter-tutorial/tutorial_xaitporter_samlbase.png)

3. Az a **XaitPorter tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk XaitPorter tartomány és az URL-címek](./media/xaitporter-tutorial/tutorial_xaitporter_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson a Másolás gombra másolása **alkalmazás összevonási metaadatainak URL-címe** és illessze be a Jegyzettömbbe. 
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/xaitporter-tutorial/tutorial_xaitporter_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/xaitporter-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **XaitPorter**.
    ...
    ![Az alkalmazások listáját a XaitPorter hivatkozás](./media/xaitporter-tutorial/tutorial_xaitporter_app.png)  
