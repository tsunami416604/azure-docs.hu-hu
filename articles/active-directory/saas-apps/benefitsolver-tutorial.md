...
ms.openlocfilehash: 51f750f9aef6b5be8ac0c1d8f5256773c50b5efb
ms.sourcegitcommit: 7e772d8802f1bc9b5eb20860ae2df96d31908a32
ms.translationtype: MT
ms.contentlocale: hu-HU
ms.lasthandoff: 03/06/2019
ms.locfileid: "57435048"
---
...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Benefitsolver (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Benefitsolver egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a Benefitsolver **SP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **Benefitsolver**válassza **Benefitsolver** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

    ![Az eredmények listájában Benefitsolver](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az Benefitsolver nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó Benefitsolver hivatkozás kapcsolata kell létrehozni.
...
2. **[Benefitsolver egyszeri bejelentkezés konfigurálása](#configure-benefitsolver-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre Benefitsolver tesztfelhasználót](#create-benefitsolver-test-user)**  – egy megfelelője a Britta Simon Benefitsolver, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **Benefitsolver** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![Benefitsolver tartomány és URL-címeket egyetlen bejelentkezési adatait](common/sp-identifier-reply.png)

    a. Az a **bejelentkezési URL-** szövegmezőbe írja be a következő minta használatával URL-cím: `http://<companyname>.benefitsolver.com`

    b. Az a **azonosító** mezőbe írja be a következő minta használatával URL-cím: `https://<companyname>.benefitsolver.com/saml20`

    c. Az a **válasz URL-cím** szövegmezőbe írja be az URL-cím a következő minta használatával: `https://www.benefitsolver.com/benefits/BenefitSolverView?page_name=single_signon_saml`

    > [!NOTE]
    > Ezek a értékei nem valódi. Ezek az értékek frissítse a tényleges bejelentkezési URL-, azonosítóját és válasz URL-cím. Kapcsolattartó [Benefitsolver ügyfél-támogatási csapatának](https://www.businessolver.com/contact) beolvasni ezeket az értékeket. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.

5. Benefitsolver alkalmazás a SAML helyességi feltételek vár egy megadott formátumban. Konfigurálja a következő jogcímek ehhez az alkalmazáshoz. Ezek az attribútumok értékeinek kezelheti a **felhasználói attribútumok** szakasz alkalmazás integráció lapján. Az a **állítsa be egyszeri bejelentkezést az SAML** kattintson **szerkesztése** gombra kattintva nyissa meg a **felhasználói attribútumok** párbeszédpanel.
...
8. Az a **Benefitsolver beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-benefitsolver-single-sign-on"></a>Benefitsolver egyszeri bejelentkezés konfigurálása

Az egyszeri bejelentkezés konfigurálása **Benefitsolver** oldalon kell küldenie a letöltött **metaadatainak XML** és az Azure Portalról másolt URL-címek megfelelő [Benefitsolver támogatási csapatának](https://www.businessolver.com/contact). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **Benefitsolver**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **Benefitsolver**.

    ![Az alkalmazások listáját a Benefitsolver hivatkozásra](common/all-applications.png)
...
### <a name="create-benefitsolver-test-user"></a>Benefitsolver tesztfelhasználó létrehozása
...
Ha a hozzáférési panelen a Benefitsolver csempére kattint, meg kell lehet automatikusan bejelentkezett a Benefitsolver, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
