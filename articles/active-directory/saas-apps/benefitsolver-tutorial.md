---
title: 'Oktatóanyag: Azure Active Directory-integráció az Benefitsolver |} A Microsoft Docs'
...
ms.locfileid: "39048062"
---
# <a name="tutorial-azure-active-directory-integration-with-benefitsolver"></a>Oktatóanyag: Azure Active Directory-integráció az Benefitsolver
...
3. **[Hozzon létre egy Benefitsolver tesztfelhasználót](#create-a-benefitsolver-test-user)**  – egy megfelelője a Britta Simon Benefitsolver, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Benefitsolver tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
4. Benefitsolver alkalmazását a SAML helyességi feltételek vár egy megadott formátumban, amelyhez egyéni attribútumleképezések való hozzáadása a **saml-jogkivonat attribútumai** konfigurációja.
...
8. Az egyszeri bejelentkezés konfigurálása **Benefitsolver** oldalon kell küldenie a letöltött **metaadatainak XML** való [Benefitsolver támogatási csapatának](https://www.businessolver.com/contact).
