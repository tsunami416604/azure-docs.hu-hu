...
4. Írja be a keresőmezőbe, **Benefitsolver**, jelölje be **Benefitsolver** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Benefitsolver](./media/benefitsolver-tutorial/tutorial_benefitsolver_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/benefitsolver-tutorial/tutorial_benefitsolver_samlbase.png)

3. Az a **Benefitsolver tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk Benefitsolver tartomány és az URL-címek](./media/benefitsolver-tutorial/tutorial_benefitsolver_url.png)
...
6. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/benefitsolver-tutorial/tutorial_benefitsolver_certificate.png) 

7. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/benefitsolver-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **Benefitsolver**.
    ...
    ![Az alkalmazások listáját a Benefitsolver hivatkozás](./media/benefitsolver-tutorial/tutorial_benefitsolver_app.png)  
