...
Ha a hozzáférési panelen a Coggle csempére kattint, automatikusan be kell jelentkeznie arra a Coggle, amelyhez az SSO-t beállította. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
...
- [A Coggle és a speciális láthatóság és vezérlők elleni védelem](/cloud-app-security/proxy-intro-aad)