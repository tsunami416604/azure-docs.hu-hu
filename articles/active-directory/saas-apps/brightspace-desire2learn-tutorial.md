...
2. **[Brightspace konfigurálása Desire2Learn egyszeri bejelentkezéssel](#configure-brightspace-by-desire2learn-single-sign-on)** – az egyszeri bejelentkezési beállítások konfigurálása az alkalmazás oldalán.
...
### <a name="configure-brightspace-by-desire2learn-single-sign-on"></a>Brightspace konfigurálása Desire2Learn egyszeri bejelentkezéssel
...
Ha a hozzáférési panelen a Brightspace by Desire2Learn csempe elemre kattint, automatikusan be kell jelentkeznie a Brightspace olyan Desire2Learn, amelyhez be kell állítania az SSO-t. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
