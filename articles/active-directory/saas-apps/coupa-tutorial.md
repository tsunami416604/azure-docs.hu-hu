...
>[!NOTE]
>A HRE felhasználói fiókjainak kiépítéséhez a Coupa által biztosított bármely egyéb felhasználói fiók-létrehozási eszközt vagy API-t használhatja.
