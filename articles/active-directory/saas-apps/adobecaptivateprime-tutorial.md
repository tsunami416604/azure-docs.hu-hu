...
2. Az **[Adobe rabul Prime egyszeri bejelentkezés konfigurálása](#configure-adobe-captivate-prime-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
4. Az **egyszeri bejelentkezés SAML-vel való beállítása** lapon hajtsa végre a következő lépéseket:
    ...
    a. Az **azonosító** szövegmezőbe írja be a következő URL-címet: `https://captivateprime.adobe.com`

    b. A **Válasz URL-címe** szövegmezőbe írja be a következő URL-címet: `https://captivateprime.adobe.com/saml/SSO`
...
### <a name="configure-adobe-captivate-prime-single-sign-on"></a>Az Adobe rabul Prime egyszeri bejelentkezés konfigurálása
