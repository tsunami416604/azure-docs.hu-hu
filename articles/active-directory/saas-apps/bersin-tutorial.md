---
title: 'Oktatóanyag: Azure Active Directory-integráció az Bersin |} A Microsoft Docs'
...
ms.locfileid: "39047977"
---
# <a name="tutorial-azure-active-directory-integration-with-bersin"></a>Oktatóanyag: Azure Active Directory-integráció az Bersin
...
3. **[Hozzon létre egy Bersin tesztfelhasználót](#create-a-bersin-test-user)**  – egy megfelelője a Britta Simon Bersin, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Bersin tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód:
...
4. Ha az alkalmazás a konfigurálni kívánt **SP** kezdeményezett mód, hajtsa végre a következő lépést:
...
7. Az egyszeri bejelentkezés konfigurálása **Bersin** oldalon kell küldenie a letöltött **metaadatainak XML** való [Bersin támogatási csapatának](mailto:USBersinServiceClient@deloitte.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
