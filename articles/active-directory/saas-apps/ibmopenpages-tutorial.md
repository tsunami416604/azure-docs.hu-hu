---
title: 'Oktatóanyag: Azure Active Directory-integráció az IBM OpenPages |} A Microsoft Docs'
...
3. **[Hozzon létre egy IBM OpenPages tesztfelhasználót](#create-an-ibm-openpages-test-user)**  – egy megfelelője a Britta Simon IBM OpenPages, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **IBM OpenPages tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
7. Az egyszeri bejelentkezés konfigurálása **IBM OpenPages** oldalon kell küldenie a letöltött **metaadatainak XML** való [IBM OpenPages támogatási csapatának](https://www.ibm.com/support/home/). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
