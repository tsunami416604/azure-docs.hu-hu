---
title: 'Oktatóanyag: Azure Active Directory-integráció az Tidemark |} A Microsoft Docs'
...
ms.locfileid: "39055725"
---
# <a name="tutorial-azure-active-directory-integration-with-tidemark"></a>Oktatóanyag: Azure Active Directory-integráció az Tidemark
...
4. A Keresés mezőbe írja be a **Tidemark**.
...
3. **[Tidemark tesztfelhasználó létrehozása](#creating-a-tidemark-test-user)**  – egy megfelelője a Britta Simon Tidemark, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Tidemark tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az a **Tidemark konfigurációs** területén kattintson **konfigurálása Tidemark** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **kijelentkezéses URL-címe, SAML Entitásazonosító és SAML egyszeri bejelentkezési szolgáltatás URL-cím** származó a **gyors útmutató szakaszban.**

    ![Egyszeri bejelentkezés konfigurálása](./media/tidemark-tutorial/tutorial_tidemark_configure.png) 

7. Az egyszeri bejelentkezés konfigurálása **Tidemark** oldalon kell küldenie a letöltött **Certificate(Base64), SAML Entitásazonosító, kijelentkezéses URL-cím és SAML egyszeri bejelentkezési szolgáltatás URL-cím** való [Tidemark támogatási csoport](http://www.tidemark.com/contact-us). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
