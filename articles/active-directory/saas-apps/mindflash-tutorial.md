---
title: 'Oktatóanyag: Azure Active Directory-integráció az Mindflash |} A Microsoft Docs'
...
ms.locfileid: "39041132"
---
# <a name="tutorial-azure-active-directory-integration-with-mindflash"></a>Oktatóanyag: Azure Active Directory-integráció az Mindflash
...
4. A Keresés mezőbe írja be a **Mindflash**.
...
3. **[Mindflash tesztfelhasználó létrehozása](#creating-a-mindflash-test-user)**  – egy megfelelője a Britta Simon Mindflash, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Mindflash tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **Mindflash** oldalon kell küldenie a letöltött **metaadatainak XML** való [Mindflash támogatási csapatának](https://www.mindflash.com/contact/).
...
2. Lépjen a **felhasználók kezelése**.
...
4. Az a **az új felhasználók hozzáadása** szakaszban, a következő lépésekkel egy érvényes Azure AD-fiókot kíván üzembe helyezni:
