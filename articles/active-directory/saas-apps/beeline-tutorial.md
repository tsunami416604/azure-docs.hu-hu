---
title: 'Oktatóanyag: A BeeLine az Azure Active Directory-integráció |} A Microsoft Docs'
...
* Szabályozhatja, ki férhet hozzá a BeeLine Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezett a BeeLine (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* A beeLine támogatja **Identitásszolgáltató** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **BeeLine**, jelölje be **BeeLine** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában a beeLine](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés a BeeLine nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működéséhez egy Azure AD-felhasználót és a kapcsolódó felhasználó a BeeLine hivatkozás kapcsolatának kell létrehozni.
...
2. **[A BeeLine egyszeri bejelentkezés konfigurálása](#configure-beeline-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[A BeeLine tesztfelhasználó létrehozása](#create-beeline-test-user)**  –, amely kapcsolódik az Azure AD felhasználói ábrázolása a BeeLine-megfelelője a Britta Simon van.
...
1. Az a [az Azure portal](https://portal.azure.com/), a a **BeeLine** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezési**.
...
4. Az a **állítsa be egyszeri bejelentkezést az SAML** lapon, a következő lépésekkel:
    ...
    ![A beeLine-tartomány és URL-címek egyszeri bejelentkezési adatait](common/idp-intiated.png)
...
7. Az a **állítsa be a BeeLine** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-beeline-single-sign-on"></a>A BeeLine egyszeri bejelentkezés konfigurálása

Az egyszeri bejelentkezés konfigurálása **BeeLine** oldalon kell küldenie a letöltött **összevonási metaadatainak XML** és az Azure Portalról másolt URL-címek megfelelő [BeeLine támogatási csapatának](https://www.beeline.com/contact-us/). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **BeeLine**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **BeeLine**.

    ![A BeeLine hivatkozásra az alkalmazások listáját](common/all-applications.png)
...
### <a name="create-beeline-test-user"></a>A BeeLine tesztfelhasználó létrehozása
...
Ha a hozzáférési panelen a BeeLine csempére kattint, meg kell lehet automatikusan bejelentkezett a BeeLine, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
