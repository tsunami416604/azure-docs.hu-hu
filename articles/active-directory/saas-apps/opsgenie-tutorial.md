...
## <a name="configure-and-test-azure-ad-single-sign-on-for-opsgenie"></a>Az Azure AD egyszeri bejelentkezés konfigurálása és tesztelése a OpsGenie
...
Az Azure AD SSO és a OpsGenie konfigurálásához és teszteléséhez hajtsa végre a következő építőelemeket:
...
1. **[OPSGENIE SSO konfigurálása](#configure-opsgenie-sso)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
    * **[Hozzon létre OpsGenie-teszt felhasználót](#create-opsgenie-test-user)** – ha a felhasználó Azure ad-képviseletéhez kapcsolódó B. Simon-OpsGenie rendelkezik.
...
1. A [Azure Portal](https://portal.azure.com/) **OpsGenie** alkalmazás-integráció lapján keresse meg a **kezelés** szakaszt, és válassza az **egyszeri bejelentkezés**lehetőséget.
...
1. Nyisson meg egy másik böngésző-példányt, majd jelentkezzen be a OpsGenie rendszergazdaként.
...
Ha a hozzáférési panelen a OpsGenie csempére kattint, automatikusan be kell jelentkeznie arra a OpsGenie, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
...
- [A OpsGenie kipróbálása az Azure AD-vel](https://aad.portal.azure.com/)
