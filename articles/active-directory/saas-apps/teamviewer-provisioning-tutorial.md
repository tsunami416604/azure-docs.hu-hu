---
title: 'Oktatóanyag: A TeamViewer konfigurálása az Azure Active Directoryval való automatikus felhasználói kiépítéshez | Microsoft dokumentumok'
description: Ismerje meg, hogyan építheti ki és vonhat ki automatikusan felhasználói fiókokat az Azure AD-ből a TeamViewerhez.
...
---
# <a name="tutorial-configure-teamviewer-for-automatic-user-provisioning"></a>Oktatóanyag: A TeamViewer konfigurálása automatikus felhasználói kiépítéshez

Ez az oktatóanyag ismerteti azokat a lépéseket, amelyeket a TeamViewer és az Azure Active Directory (Azure AD) automatikus felhasználói kiépítés konfigurálásához végre kell hajtania. Ha konfigurálva van, az Azure AD automatikusan rendelkezik a felhasználókés csoportok de-rendelkezések et [a TeamViewer](https://www.teamviewer.com/buy-now/) számára az Azure AD-kiépítési szolgáltatás használatával. A szolgáltatás működésével, működésével és a gyakori kérdésekkel kapcsolatos fontos részletekről az Automatikus felhasználói kiépítés és a [SaaS-alkalmazások üzembe helyezésének automatizálása az Azure Active Directoryval.](../manage-apps/user-provisioning.md) 


## <a name="capabilities-supported"></a>Támogatott képességek
> [!div class="checklist"]
> * Felhasználók létrehozása a TeamViewerprogramban
> * Felhasználók eltávolítása a TeamViewer programban, ha már nincs szükségük hozzáférésre
> * Felhasználói attribútumok szinkronizálása az Azure AD és a TeamViewer között
> * [Egyszeri bejelentkezés a](https://docs.microsoft.com/azure/active-directory/saas-apps/teamviewer-tutorial) TeamViewerprogramba (ajánlott)
...
* Érvényes [Tensor-licenc](https://www.teamviewer.com/de/teamviewer-tensor/) a TeamViewer számára.
* Érvényes egyéni azonosító az [egyszeri bejelentkezési](https://community.teamviewer.com/t5/Knowledge-Base/Single-Sign-On-with-Azure-Active-Directory/ta-p/60209#toc-hId--473669723) konfigurációból.
...
3. Határozza meg, hogy milyen adatokat szeretne leképezni az [Azure AD és a TeamViewer között.](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes) 
...
1. Jelentkezzen be a [TeamViewer felügyeleti konzoljára](https://login.teamviewer.com). Nyissa meg a **Profil szerkesztése ( Profil szerkesztése**) .

    ![TeamViewer felügyeleti konzol](./media/teamviewer-provisioning-tutorial/admin.png)

2.  Keresse meg az **Alkalmazások**lapot. Kattintson a **Create Script Token gombra.**

    ![TeamViewer token létrehozása](./media/teamviewer-provisioning-tutorial/createtoken.png)

3.  Adja meg a parancsfájltoken nevét. Kattintson a **Mentés** gombra.

    ![TeamViewer token neve](./media/teamviewer-provisioning-tutorial/tokenname.png)

4. Másolja a **tokenre,** és kattintson az **OK**gombra. Ez az érték a TeamViewer-alkalmazás **titkos jogkivonat** mezőjébe kerül az Azure Portalon.

    ![TeamViewer Token](./media/teamviewer-provisioning-tutorial/token.png)

## <a name="step-3-add-teamviewer-from-the-azure-ad-application-gallery"></a>3. lépés TeamViewer hozzáadása az Azure AD alkalmazásgyűjteményéből

A TeamViewer hozzáadása az Azure AD alkalmazásgalériából a TeamViewer kiépítésének megkezdéséhez. Ha korábban már beállította a TeamViewer for SSO-t, használhatja ugyanazt az alkalmazást. Azonban ajánlott, hogy hozzon létre egy külön alkalmazást, amikor az integráció tesztelése kezdetben. További információ az alkalmazások hozzáadásáról a galériából [itt.](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app) 
...
## <a name="step-5-configure-automatic-user-provisioning-to-teamviewer"></a>5. lépés Automatikus felhasználói kiépítés konfigurálása a TeamViewer programban 
...
### <a name="to-configure-automatic-user-provisioning-for-teamviewer-in-azure-ad"></a>A TeamViewer automatikus felhasználói kiépítésének konfigurálása az Azure AD-ben:

1. Jelentkezzen be az [Azure Portalra.](https://portal.azure.com) Válassza **a Vállalati alkalmazások**lehetőséget, majd a Minden **alkalmazás**lehetőséget.

    ![A vállalati alkalmazások panelje](common/enterprise-applications.png)

2. Az alkalmazások listájában válassza a **TeamViewer**lehetőséget.

    ![A TeamViewer hivatkozása az Alkalmazások listában](common/all-applications.png)
...
5. A **Rendszergazdai hitelesítő** adatok `ttps://webapi.teamviewer.com/scim/v2` csoportban írja be a **Tentant URL-címét** mezőbe, és írja be a **titkos jogkivonatban**korábban létrehozott parancsfájltokent. Kattintson **a Kapcsolat tesztelése** elemre annak biztosításához, hogy az Azure AD csatlakozni tud a TeamViewerhez. Ha a kapcsolat nem sikerül, győződjön meg arról, hogy a TeamViewer-fiók rendszergazdai engedélyekkel rendelkezik, majd próbálkozzon újra.

    ![Kiépítés](./media/teamViewer-provisioning-tutorial/provisioning.png)
...
8. A **Leképezések** csoportban válassza az **Azure Active Directory felhasználóinak szinkronizálása a TeamViewer programba**lehetőséget.

9. Tekintse át az Azure AD és a TeamViewer között szinkronizált felhasználói attribútumokat az **Attribútum-leképezés** szakaszban. Az **Egyező** tulajdonságokként kijelölt attribútumok a TeamViewer felhasználói fiókjainak egyeztetésére szolgálnak a frissítési műveletekhez. Ha úgy dönt, hogy módosítja az [egyező célattribútumot,](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes)gondoskodnia kell arról, hogy a TeamViewer API támogatja-e a felhasználók szűrését az adott attribútum alapján. A **módosítások** véglegesítéséhez kattintson a Mentés gombra.
...
11. Az Azure AD-kiépítési szolgáltatás engedélyezéséhez a TeamViewer, módosítsa a **kiépítés állapota** **be a** **Beállítások** szakaszban.

    ![Kiépítési állapot bevan kapcsolva](common/provisioning-toggle-on.png)

12. A **Beállítások** szakasz **Hatókör területén** a kívánt értékek kiválasztásával határozza meg azokat a felhasználókat és/vagy csoportokat, amelyeket ki szeretne építeni a TeamViewerbe.
