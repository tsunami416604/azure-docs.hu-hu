---
title: 'Oktatóanyag: Azure Active Directory-integráció az FloQast |} A Microsoft Docs'
...
ms.locfileid: "39042503"
---
# <a name="tutorial-azure-active-directory-integration-with-floqast"></a>Oktatóanyag: Azure Active Directory-integráció az FloQast
...
3. **[Hozzon létre egy FloQast tesztfelhasználót](#create-a-floqast-test-user)**  – egy megfelelője a Britta Simon FloQast, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **FloQast tartomány és URL-címek** területén kövesse az alábbi lépéseket, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód:
...
7. Az a **SAML-aláíró tanúsítvány** területén kattintson **metaadatainak XML** majd mentse a metaadat-fájlt a számítógépen, és hajtsa végre az alábbi lépéseket:
...
9. Az egyszeri bejelentkezés konfigurálása **FloQast** oldalon kell küldenie a letöltött **metaadatainak XML** való [FloQast támogatási csapatának](mailto:support@floqast.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
