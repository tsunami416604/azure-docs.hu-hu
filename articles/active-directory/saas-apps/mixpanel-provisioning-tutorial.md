---
title: 'Oktatóanyag: A Mixpanel konfigurálása az Azure Active Directoryval való automatikus felhasználói kiépítéshez | Microsoft dokumentumok'
description: Ismerje meg, hogyan lehet automatikusan kiépíteni és kiépíteni a felhasználói fiókokat az Azure AD-ről a Mixpanelre.
...
ms.locfileid: "76907603"
---
# <a name="tutorial-configure-mixpanel-for-automatic-user-provisioning"></a>Oktatóanyag: A Mixpanel konfigurálása automatikus felhasználói kiépítéshez

Ez az oktatóanyag ismerteti azokat a lépéseket, amelyeket a Mixpanelben és az Azure Active Directoryban (Azure AD) is végre kell hajtania az automatikus felhasználói kiépítés konfigurálásához. Ha konfigurálva van, az Azure AD automatikusan rendelkezik, és de-rendelkezések a felhasználók és csoportok [Mixpanel](https://mixpanel.com/pricing/) az Azure AD-kiépítési szolgáltatás használatával. A szolgáltatás működésével, működésével és a gyakori kérdésekkel kapcsolatos fontos részletekről az Automatikus felhasználói kiépítés és a [SaaS-alkalmazások üzembe helyezésének automatizálása az Azure Active Directoryval.](../manage-apps/user-provisioning.md) 


## <a name="capabilities-supported"></a>Támogatott képességek
> [!div class="checklist"]
> * Felhasználók létrehozása a Mixpanelen
> * Felhasználók eltávolítása a Mixpanelen, ha már nincs szükségük hozzáférésre
> * Felhasználói attribútumok szinkronizálása az Azure AD és a Mixpanel között
> * Csoportok és csoporttagságok kiépítése a Mixpanelen
> * [Egyszeri bejelentkezés a](https://docs.microsoft.com/azure/active-directory/saas-apps/mixpanel-tutorial) Mixpanelbe (ajánlott)
...
* A mixpanel fiók admin jogosultságokat említett org
* SSO engedélyezve mixpanel egy igényelt domain
...
3. Határozza meg, hogy milyen adatokat szeretne [leképezni az Azure AD és a Mixpanel között.](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes) 

## <a name="step-2-configure-mixpanel-to-support-provisioning-with-azure-ad"></a>2. lépés A Mixpanel konfigurálása az Azure AD-vel való kiépítés támogatásához
1. Az SSO beállításáért és a tartomány igényléséhez olvassa el [ezt](https://help.mixpanel.com/hc/articles/360036428871-Single-Sign-On)a .
2. Ezt követően létre kell hoznia egy SCIM-jogkivonatot a szervezeti beállítások hozzáférés biztonsági szakaszának SCIM lapján.
![Mixpanel token](./media/mixpanel-provisioning-tutorial/mixpanelscim.png)


## <a name="step-3-add-mixpanel-from-the-azure-ad-application-gallery"></a>3. lépés Mixpanel hozzáadása az Azure AD alkalmazásgyűjteményéből

Mixpanel hozzáadása az Azure AD alkalmazáskatalógusból a Mixpanel kiépítésének megkezdéséhez. Ha korábban már beállította a Mixpanel t az SSO-hoz, használhatja ugyanazt az alkalmazást. Azonban ajánlott, hogy hozzon létre egy külön alkalmazást, amikor az integráció tesztelése kezdetben. További információ az alkalmazások hozzáadásáról a galériából [itt.](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app) 
...
## <a name="step-5-configure-automatic-user-provisioning-to-mixpanel"></a>5. lépés Automatikus felhasználói kiépítés konfigurálása a Mixpanel panelen 
...
### <a name="to-configure-automatic-user-provisioning-for-mixpanel-in-azure-ad"></a>A Mixpanel automatikus felhasználói kiépítésének konfigurálása az Azure AD-ben:
...
5. A **Rendszergazdai hitelesítő adatok** szakaszban adja meg a Mixpanel **bérlői URL-címét** és **a titkos jogkivonatot.** Kattintson **a Kapcsolat tesztelése** elemre annak biztosításához, hogy az Azure AD csatlakozni tud a Mixpanelhez. Ha a kapcsolat nem sikerül, győződjön meg arról, hogy a Mixpanel-fiók rendszergazdai engedélyekkel rendelkezik, majd próbálkozzon újra.

    ![Kiépítés](./media/mixpanel-provisioning-tutorial/provisioning.png)
...
8. A **Leképezések** csoportban válassza **az Azure Active Directory felhasználóinak szinkronizálása a Mixpanelre lehetőséget.**

9. Tekintse át az Azure AD-ről a Mixpanelre szinkronizált felhasználói attribútumokat az **Attribútum-leképezés** szakaszban. Az **Egyező** tulajdonságokként kijelölt attribútumok a Mixpanel felhasználói fiókjainak egyeztetésére szolgálnak a frissítési műveletekhez. Ha úgy dönt, hogy módosítja az [egyező célattribútumot,](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes)gondoskodnia kell arról, hogy a Mixpanel API támogatja-e a felhasználók szűrését az adott attribútum alapján. A **módosítások** véglegesítéséhez kattintson a Mentés gombra.
...
10. A **Leképezések** csoportban válassza **az Azure Active Directory-csoportok szinkronizálása a Mixpanelhez lehetőséget.**

11. Tekintse át az Azure AD-ről a Mixpanelre szinkronizált csoportattribútumokat az **Attribútum-leképezés** szakaszban. Az **Egyező** tulajdonságokként kijelölt attribútumok a Mixpanel csoportjainak egyeztetésére szolgálnak a frissítési műveletekhez. A **módosítások** véglegesítéséhez kattintson a Mentés gombra.
...
13. Az Azure AD-kiépítési szolgáltatás engedélyezéséhez a Mixpanel, módosítsa a **kiépítés állapota** **be a** **Beállítások** szakaszban.

    ![Kiépítési állapot bevan kapcsolva](common/provisioning-toggle-on.png)

14. Adja meg azokat a felhasználókat és/vagy csoportokat, amelyeket ki szeretne építeni a Mixpanelbe, ha a **Beállítások** szakasz **Hatókör szakaszában** kiválasztja a kívánt értékeket.
