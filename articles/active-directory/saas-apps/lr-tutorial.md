...
3. **[Hozzon létre egy LoginRadius tesztfelhasználót](#create-a-loginradius-test-user)**  – egy megfelelője a Britta Simon LoginRadius, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **LoginRadius tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
7. Az egyszeri bejelentkezés konfigurálása **LoginRadius** oldalon kell küldenie a letöltött **metaadatainak XML** való [LoginRadius támogatási csoportjának](mailto:support@loginradius.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
