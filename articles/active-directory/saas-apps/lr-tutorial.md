...
**Ha LoginRadius szeretne hozzáadni a katalógusból, hajtsa végre a következő lépéseket:**
...
4. A keresőmezőbe írja be a **LoginRadius**kifejezést, válassza a **LoginRadius** elemet az eredmény panelen, majd kattintson a **Hozzáadás** gombra az alkalmazás hozzáadásához.
...
2. **[LoginRadius egyszeri bejelentkezés konfigurálása](#configure-loginradius-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
4. Az **alapszintű SAML-konfiguráció** szakaszban hajtsa végre a következő lépéseket:
    ...
    a. A **bejelentkezési URL-cím** szövegmezőbe írja be az URL-címet: `https://secure.loginradius.com/login`

    b. Az **azonosító (Entity ID)** szövegmezőbe írja be az URL-címet: `https://LoginRadius.hub.loginradius.com/`

    > [!NOTE]
    > Nyissa meg a bejelentkezési URL-cím lapot. Kattintson az **egyszeri bejelentkezés** fülre, és írja be a [LoginRadius-támogatási csoport](mailto:support@loginradius.com) által megadott **beépülő modul nevét** , majd kattintson a **Bejelentkezés** gombra, és a rendszer átirányítja az Azure ad-lapra a bejelentkezéshez.
...
Ha az egyszeri bejelentkezést szeretné konfigurálni a **LoginRadius** oldalon, el kell küldenie a letöltött **metaadatok XML** -fájlját és a megfelelő másolt url-címeket a Azure Portalról a [LoginRadius támogatási csapatához](mailto:support@loginradius.com). Ezt a beállítást úgy állították be, hogy az SAML SSO-kapcsolatok mindkét oldalon helyesen legyenek beállítva.
...
Ebben a szakaszban egy Britta Simon nevű felhasználót hoz létre a LoginRadius-ben. Együttműködik a [LoginRadius támogatási csapatával](mailto:support@loginradius.com) , hogy hozzáadja a felhasználókat a LoginRadius platformhoz. Az egyszeri bejelentkezés használata előtt létre kell hozni és aktiválni kell a felhasználókat.

### <a name="test-single-sign-on"></a>Az egyszeri bejelentkezés tesztelése 

Ebben a szakaszban az Azure AD egyszeri bejelentkezési konfigurációját teszteli a hozzáférési panel használatával.

Ha a hozzáférési panelen a LoginRadius csempére kattint, automatikusan be kell jelentkeznie arra a LoginRadius, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
