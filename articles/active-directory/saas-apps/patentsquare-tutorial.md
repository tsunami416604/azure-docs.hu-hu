...
4. Írja be a keresőmezőbe, **PatentSQUARE**, jelölje be **PatentSQUARE** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában PatentSQUARE](./media/patentsquare-tutorial/tutorial_patentsquare_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/patentsquare-tutorial/tutorial_patentsquare_samlbase.png)

3. Az a **PatentSQUARE tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk PatentSQUARE tartomány és az URL-címek](./media/patentsquare-tutorial/tutorial_patentsquare_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/patentsquare-tutorial/tutorial_patentsquare_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/patentsquare-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **PatentSQUARE**.
    ...
    ![Az alkalmazások listáját a PatentSQUARE hivatkozás](./media/patentsquare-tutorial/tutorial_patentsquare_app.png)  
