...
2. **[Peakon egyszeri bejelentkezés konfigurálása](#configure-peakon-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
5. Kattintson a **további URL-címek beállítása** elemre, és hajtsa végre a következő lépést, ha az alkalmazást **SP** -ben kezdeményezett módban szeretné konfigurálni:
    ...
    ![Képernyőkép: a "Sing on U R L" szövegmezőben a "további U R ls beállítása" szöveg jelenik meg.](common/metadata-upload-additional-signon.png)
...
### <a name="configure-peakon-single-sign-on"></a>Peakon egyetlen Sign-On konfigurálása
...
Ha a hozzáférési panelen a Peakon csempére kattint, automatikusan be kell jelentkeznie arra a Peakon, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
