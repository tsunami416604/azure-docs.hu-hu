---
title: 'Oktatóanyag: Azure Active Directory-integráció az Qualtrics |} A Microsoft Docs'
...
ms.locfileid: "39046209"
---
# <a name="tutorial-azure-active-directory-integration-with-qualtrics"></a>Oktatóanyag: Azure Active Directory-integráció az Qualtrics
...
3. **[Hozzon létre egy Qualtrics tesztfelhasználót](#create-a-qualtrics-test-user)**  – egy megfelelője a Britta Simon Qualtrics, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **Qualtrics tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **Qualtrics** oldalon kell küldenie a letöltött **metaadatainak XML** való [Qualtrics támogatási csoportjának](https://www.qualtrics.com/support/). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
