...
5.  A **rendszergazdai hitelesítő adatok** szakaszban adja meg a `https://<SmartFile sitename>.smartfile.com/ftp/scim` a **bérlői URL-címben**. Ilyen például a `https://demo1test.smartfile.com/ftp/scim`. Adja meg a **titkos jogkivonatban**korábban lekért **tulajdonosi jogkivonat** -értéket (termék: ProductPassword). Kattintson a **kapcsolat tesztelése** lehetőségre, hogy az Azure ad képes legyen csatlakozni a SmartFile. Ha a kapcsolat meghiúsul, győződjön meg arról, hogy a SmartFile-fiókja rendszergazdai jogosultságokkal rendelkezik, és próbálkozzon újra.
