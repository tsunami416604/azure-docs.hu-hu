...
1. A bal oldali menüsorban kattintson az **egyszeri bejelentkezés (SSO)** elemre, és az **SAML-alapú egyszeri bejelentkezés (SSO)** lapon hajtsa végre a következő lépéseket:
    ...
    e. Másolja a Azure Portal letöltött tanúsítványt megjegyzés nélkül `--BEGIN CERTIFICATE and END CERTIFICATE--` , és illessze be a **tanúsítványba (az Identity Provider által biztosított)** szövegmezőbe.
