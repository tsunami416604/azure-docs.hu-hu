---
title: 'Oktatóanyag: Azure Active Directory-integráció az YardiOne |} A Microsoft Docs'
...
ms.locfileid: "39050307"
---
# <a name="tutorial-azure-active-directory-integration-with-yardione"></a>Oktatóanyag: Azure Active Directory-integráció az YardiOne
...
3. **[Hozzon létre egy YardiOne tesztfelhasználót](#create-a-yardione-test-user)**  – egy megfelelője a Britta Simon YardiOne, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **YardiOne tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **YardiOne** oldalon kell küldenie a **alkalmazás összevonási metaadatainak URL-címe** való [YardiOne támogatási csapatának](https://clientcentral.yardi.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
