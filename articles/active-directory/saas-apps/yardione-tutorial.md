...
4. Írja be a keresőmezőbe, **YardiOne**, jelölje be **YardiOne** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában YardiOne](./media/yardione-tutorial/tutorial_yardione_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/yardione-tutorial/tutorial_yardione_samlbase.png)

3. Az a **YardiOne tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk YardiOne tartomány és az URL-címek](./media/yardione-tutorial/tutorial_yardione_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson a Másolás gombra másolása **alkalmazás összevonási metaadatainak URL-címe** és illessze be a Jegyzettömbbe. 
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/yardione-tutorial/tutorial_yardione_certificate.png) 
 
5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/yardione-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **YardiOne**.
    ...
    ![Az alkalmazások listáját a YardiOne hivatkozás](./media/yardione-tutorial/tutorial_yardione_app.png)  
