---
title: 'Oktatóanyag: Az Azure Active Directory-integrációval rendelkező BUKÓÍV |} A Microsoft Docs'
...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve Bukóív (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Bukóív egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* Támogatja a BUKÓÍV **SP és IDP** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **BUKÓÍV**válassza **BUKÓÍV** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
     ...
     ![Az eredmények listájában BUKÓÍV](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az BUKÓÍV nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó BUKÓÍV hivatkozás kapcsolata kell létrehozni.
...
2. **[Bukóív egyszeri bejelentkezés konfigurálása](#configure-rollbar-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre BUKÓÍV tesztfelhasználót](#create-rollbar-test-user)**  – egy megfelelője a Britta Simon BUKÓÍV, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **BUKÓÍV** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszra, ha az alkalmazás a konfigurálni kívánt **Identitásszolgáltató** kezdeményezett mód, hajtsa végre az alábbi lépéseket:
    ...
    ![Bukóív tartomány és URL-címeket egyetlen bejelentkezési adatait](common/idp-intiated.png)

    a. Az a **azonosító** szövegmezőbe írja be az URL-cím: `https://saml.rollbar.com`

    b. Az a **válasz URL-cím** szövegmezőbe írja be a következő minta használatával URL-cím: `https://rollbar.com/<accountname>/saml/sso/azure/`

5. Kattintson a **további URL-címet beállítani** , és hajtsa végre a következő lépést, ha az alkalmazás a konfigurálni kívánt **SP** kezdeményezett mód:

    ![Bukóív tartomány és URL-címeket egyetlen bejelentkezési adatait](common/metadata-upload-additional-signon.png)

    Az a **bejelentkezési URL-** szövegmezőbe írja be a következő minta használatával URL-cím:  `https://rollbar.com/<accountname>/saml/login/azure/`

    > [!NOTE]
    > Ezek a értékei nem valódi. Frissítse a tényleges válasz URL-cím és a bejelentkezési URL-ezeket az értékeket. Kapcsolattartó [BUKÓÍV ügyfél-támogatási csapatának](mailto:support@rollbar.com) beolvasni ezeket az értékeket. Emellett olvassa el a minták látható a **alapszintű SAML-konfigurációja** szakaszban az Azure Portalon.
...
7. Az a **BUKÓÍV beállítása** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-rollbar-single-sign-on"></a>Bukóív egyszeri bejelentkezés konfigurálása
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **BUKÓÍV**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **BUKÓÍV**.

    ![Az alkalmazások listáját a BUKÓÍV hivatkozás](common/all-applications.png)
...
### <a name="create-rollbar-test-user"></a>Bukóív tesztfelhasználó létrehozása

Ahhoz, hogy az Azure AD-felhasználók BUKÓÍV bejelentkezni, akkor ki kell építeni BUKÓÍV be. BUKÓÍV, esetén kiépítése a manuális feladat.
...
Ha a hozzáférési panelen a BUKÓÍV csempére kattint, meg kell lehet automatikusan bejelentkezett a BUKÓÍV, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
