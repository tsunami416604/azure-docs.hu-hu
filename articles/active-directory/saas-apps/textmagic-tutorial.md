...
4. Írja be a keresőmezőbe, **TextMagic**, jelölje be **TextMagic** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában TextMagic](./media/textmagic-tutorial/tutorial_textmagic_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/textmagic-tutorial/tutorial_textmagic_samlbase.png)
...
3. Az a **TextMagic tartomány és az URL-címek** területen tegye a következőket, ha szeretne beállítani az alkalmazás **IDP** kezdeményezett mód:
    ...
    ![Az egyszeri bejelentkezés információk TextMagic tartomány és az URL-címek](./media/textmagic-tutorial/tutorial_textmagic_url.png)

    Az a **azonosító** szövegmezőhöz URL-címet írja be: `https://my.textmagic.com/saml/metadata`

4. Ellenőrizze **megjelenítése speciális URL-beállításainak** , és végezze el a következő lépés, ha szeretne beállítani az alkalmazás **SP** kezdeményezett mód:

    ![Az egyszeri bejelentkezés információk TextMagic tartomány és az URL-címek](./media/textmagic-tutorial/url1.png)
...
5. A a **SAML-aláíró tanúsítványa** kattintson **tanúsítvány (Base64)** , és mentse a tanúsítványfájlt, a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/textmagic-tutorial/tutorial_textmagic_certificate.png) 

6. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/textmagic-tutorial/tutorial_general_400.png)
...
2. Az alkalmazások listában válassza ki a **TextMagic**.
    ...
    ![Az alkalmazások listáját a TextMagic hivatkozás](./media/textmagic-tutorial/tutorial_textmagic_app.png)  
