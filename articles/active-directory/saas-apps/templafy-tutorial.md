...
1. Az **alapszintű SAML-konfiguráció** szakaszban adja meg a következő mezők értékeit:
    ...
    A **bejelentkezési URL** szövegmezőbe írja be az URL-címet a következő minta használatával: `https://<CLIENTSUBDOMAIN>.templafy.com`
...
1. A fentiek mellett a Templafy alkalmazás néhány további attribútumot vár az SAML-válaszban, amelyek alább láthatók. Ezek az attribútumok előre fel vannak töltve, de a követelményeinek megfelelően áttekintheti őket.
    ...
    | Szervezeti egység | felhasználó. részleg | `http://schemas.templafy.com/2016/06/identity/claims`|
...
Az egyszeri bejelentkezés **Templafy** -oldalon való konfigurálásához el kell küldenie az **alkalmazás-összevonási metaadatok URL-címét** a [Templafy támogatási csapatának](mailto:support@templafy.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
