...
Ha a hozzáférési panelen a Sonarqube csempére kattint, automatikusan be kell jelentkeznie arra a Sonarqube, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
