...
## <a name="configure-and-test-azure-ad-single-sign-on-for-sonarqube"></a>Az Azure AD egyszeri bejelentkezés konfigurálása és tesztelése a Sonarqube
...
Az Azure AD SSO és a Sonarqube konfigurálásához és teszteléséhez hajtsa végre a következő építőelemeket:
...
1. A [Azure Portal](https://portal.azure.com/) **Sonarqube** alkalmazás-integráció lapján keresse meg a **kezelés** szakaszt, és válassza az **egyszeri bejelentkezés**lehetőséget.
...
Ebben a szakaszban egy B. Simon nevű felhasználót hoz létre a Sonarqube-ben. A [Sonarqube ügyfél-támogatási csapattal](https://www.sonarsource.com/support/) együttműködve veheti fel a felhasználókat a Sonarqube-platformba. Felhasználók kell létrehozni és egyszeri bejelentkezés használata előtt aktiválva. 

## <a name="test-sso"></a>Egyszeri bejelentkezés tesztelése 

Ebben a szakaszban tesztelni az Azure AD egyszeri bejelentkezés beállításai a hozzáférési panelen.

Ha a hozzáférési panelen a Sonarqube csempére kattint, automatikusan be kell jelentkeznie arra a Sonarqube, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [A Sonarqube kipróbálása az Azure AD-vel](https://aad.portal.azure.com/)
