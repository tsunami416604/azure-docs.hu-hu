...
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezve join.me (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* JOIN.Me egyszeri bejelentkezés engedélyezve van az előfizetés

## <a name="scenario-description"></a>Forgatókönyv leírása

Ebben az oktatóanyagban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés egy tesztkörnyezetben.

* támogatja a JOIN.Me **Identitásszolgáltató** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **join.me**válassza **join.me** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
     ...
     ![az eredmények listájában JOIN.Me](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés az join.me nevű tesztfelhasználó alapján **Britta Simon**.
Az egyszeri bejelentkezés működjön egy Azure AD-felhasználót és a kapcsolódó felhasználó join.me hivatkozás kapcsolata kell létrehozni.
...
2. **[Egyszeri bejelentkezés join.me konfigurálása](#configure-joinme-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[Hozzon létre join.me tesztfelhasználót](#create-joinme-test-user)**  – egy megfelelője a Britta Simon a felhasználó Azure ad-ben reprezentációja kapcsolódó join.me rendelkeznie.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, a felhasználónak nincs bármely lépése végrehajtani, mert az alkalmazás már előre integrálva van az Azure-ral.
    ...
    ![JOIN.Me tartomány és URL-címeket egyetlen bejelentkezési adatait](common/preintegrated.png)
...
Az egyszeri bejelentkezés konfigurálása **join.me** oldalon kell küldenie a **alkalmazás összevonási metaadatainak URL-címe** való [join.me támogatási csapatának](https://help.join.me/s/?language). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **join.me**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **join.me**.

    ![Az alkalmazások listáját a join.me hivatkozásra](common/all-applications.png)
...
### <a name="create-joinme-test-user"></a>Join.me tesztfelhasználó létrehozása
...
Ha a hozzáférési panelen a join.me csempére kattint, meg kell lehet automatikusan bejelentkezett a join.me, amelynek beállítása egyszeri bejelentkezés. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
