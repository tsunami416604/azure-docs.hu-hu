---
title: 'Oktatóanyag: Azure Active Directory-integráció atomi tanulással |} A Microsoft Docs'
...
ms.locfileid: "39053947"
---
# <a name="tutorial-azure-active-directory-integration-with-atomic-learning"></a>Oktatóanyag: Azure Active Directory-integráció atomi tanulással
...
4. A Keresés mezőbe írja be a **atomi Learning**.

    ![Az Azure ad-ben tesztfelhasználó létrehozása](./media/atomiclearning-tutorial/tutorial_atomiclearning_search.png)

5. Az eredmények panelen válassza ki a **atomi Learning**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
3. **[Egy atomi Learning tesztfelhasználó létrehozása](#creating-an-atomic-learning-test-user)**  – egy megfelelője a Britta Simon atomi Learning, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **atomi Learning tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Az egyszeri bejelentkezés konfigurálása **atomi Learning** oldalon kell küldenie a letöltött **metaadatainak XML** való [atomi Learning támogatási csoport](mailto:cs@atomiclearning.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
