---
title: 'Oktatóanyag: Azure Active Directory-integráció az ThirdLight |} A Microsoft Docs'
...
ms.locfileid: "39040388"
---
# <a name="tutorial-azure-active-directory-integration-with-thirdlight"></a>Oktatóanyag: Azure Active Directory-integráció az ThirdLight
...
4. A Keresés mezőbe írja be a **ThirdLight**.
...
3. **[ThirdLight tesztfelhasználó létrehozása](#creating-a-thirdlight-test-user)**  – egy megfelelője a Britta Simon ThirdLight, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
3. Az a **ThirdLight tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
6. Egy másik böngészőablakban jelentkezzen be a ThirdLight vállalati hely rendszergazdaként.

7. Lépjen a **konfigurációs \> rendszerfelügyelet**, és kattintson a **egy SAML2**.
   
    ![Rendszerfelügyelet](./media/thirdlight-tutorial/ic805843.png "rendszerfelügyelet")

8. Az egy SAML2 konfigurációs szakaszban hajtsa végre az alábbi lépéseket:
...
2. Lépjen a **felhasználók** fülre.

3. Válassza ki **felhasználók és csoportok**.

4. Kattintson a **új felhasználó hozzáadása** gombra.

5. Adja meg **a felhasználónév, a neve vagy a leírást, e-mailben, válasszon egy készletet, vagy új csoporttagok** kiépítendő érvényes AAD-fiókok.
