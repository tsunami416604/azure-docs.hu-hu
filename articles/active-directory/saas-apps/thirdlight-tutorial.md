...
4. Írja be a keresőmezőbe, **ThirdLight**.
    ...
    ![Az Azure AD tesztfelhasználó létrehozása](./media/thirdlight-tutorial/tutorial_thirdlight_search.png)

5. Az eredmények panelen válassza ki a **ThirdLight**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

    ![Az Azure AD tesztfelhasználó létrehozása](./media/thirdlight-tutorial/tutorial_thirdlight_addfromgallery.png)
...
7. Ugrás a **konfigurációs \> rendszerfelügyelet**, és kattintson a **egy SAML2**.
    ...
    ![Rendszer-felügyeleti](./media/thirdlight-tutorial/ic805843.png "rendszerfelügyelet")

8. A egy SAML2 konfigurációs szakaszban hajtsa végre az alábbi lépéseket:
   
    ![SAML-alapú egyszeri bejelentkezést](./media/thirdlight-tutorial/ic805844.png "SAML-alapú egyszeri bejelentkezést.")   
...
1. Az a **Azure-portálon**, a bal oldali navigációs ablaktábláján kattintson **Azure Active Directory** ikonra.
    ...
    ![Az Azure AD tesztfelhasználó létrehozása](./media/thirdlight-tutorial/create_aaduser_01.png) 

2. Azon felhasználók listájának megtekintéséhez keresse fel **felhasználók és csoportok** kattintson **minden felhasználó**.
    
    ![Az Azure AD tesztfelhasználó létrehozása](./media/thirdlight-tutorial/create_aaduser_02.png) 

3. Lehetőségre a **felhasználói** párbeszédpanel, kattintson a **Hozzáadás** párbeszédpanel tetején.
 
    ![Az Azure AD tesztfelhasználó létrehozása](./media/thirdlight-tutorial/create_aaduser_03.png) 

4. Az a **felhasználói** párbeszédpanel lapon, a következő lépésekkel:
 
    ![Az Azure AD tesztfelhasználó létrehozása](./media/thirdlight-tutorial/create_aaduser_04.png) 
