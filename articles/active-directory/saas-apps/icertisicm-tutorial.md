...
2. **[Konfigurálja a Icertis szerződéses felügyeleti platformjának egyszeri bejelentkezését](#configure-icertis-contract-management-platform-single-sign-on)** – az egyszeri bejelentkezési beállítások konfigurálásához az alkalmazás oldalán.
...
### <a name="configure-icertis-contract-management-platform-single-sign-on"></a>A Icertis-szerződések felügyeleti platformjának egyszeri bejelentkezésének konfigurálása
