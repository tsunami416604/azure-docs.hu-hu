...
1. Az **alapszintű SAML-konfiguráció** szakaszban adja meg a következő mezők értékeit:
    ...
    > [!NOTE]
    > Ezek az értékek nem valósak. Frissítse ezeket az értékeket a tényleges bejelentkezési URL-címmel és azonosítóval (Entity ID). A bejelentkezési URL-cím `Entity ID` automatikusan létrejön az egyes szervezetekhez. Az értékek lekéréséhez forduljon a HeyBuddy ügyfélszolgálati [csapatához](mailto:support@heybuddy.com) .
