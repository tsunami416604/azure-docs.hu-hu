...
4. Az **alapszintű SAML-konfiguráció** ablaktáblán hajtsa végre a következő lépéseket:
   ...
   1. Az **azonosító**mezőben adjon meg egy URL-címet, amelynek a mintája `https://<customer_firewall_host_name>/SAML20/SP`.

   2. A **Válasz URL-cím**mezőben adjon meg egy URL-címet, amelynek a mintája `https://<customer_firewall_host_name>/SAML20/SP/ACS`.
...
1. A Azure Portal válassza **Azure Active Directory** > **felhasználók** > **minden felhasználó**lehetőséget.
...
3. A **felhasználó** ablaktáblán hajtsa végre a következő lépéseket:
    ...
    2. A **Felhasználónév**mezőbe írja be a következőt: **BrittaSimon\@\<your_company_domain\>** . Például **BrittaSimon\@contoso.com**.
