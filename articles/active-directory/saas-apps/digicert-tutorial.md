...
1. A Keresés mezőbe írja be a **DigiCert**.

    ![Az Azure ad-ben tesztfelhasználó létrehozása](./media/digicert-tutorial/tutorial_digicert_search.png)

1. Az eredmények panelen válassza ki a **DigiCert**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[A DigiCert tesztfelhasználó létrehozása](#creating-a-digicert-test-user)**  – egy megfelelője a Britta Simon DigiCert, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a **DigiCert tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Az egyszeri bejelentkezés konfigurálása **DigiCert** oldalon kell küldenie a letöltött **metaadatainak XML** való [DigiCert támogatási csapatának](mailto:support@digicert.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az alkalmazások listájában jelölje ki a **DigiCert**.
