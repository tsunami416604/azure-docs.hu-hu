---
title: 'Oktatóanyag: Az Azure Active Directory-integráció, a DigiCert |} A Microsoft Docs'
...
ms.openlocfilehash: e7430849a4e009225645e5eb1c4e5210fdf52b1d
ms.sourcegitcommit: 7e772d8802f1bc9b5eb20860ae2df96d31908a32
ms.translationtype: MT
ms.contentlocale: hu-HU
ms.lasthandoff: 03/06/2019
ms.locfileid: "57440403"
---
...
* Szabályozhatja, ki férhet hozzá a DigiCert Azure AD-ben.
* Engedélyezheti a felhasználóknak, hogy lehet automatikusan bejelentkezett a DigiCert (egyszeri bejelentkezés) az Azure AD-fiókjukat.
...
* Támogatja a DigiCert **Identitásszolgáltató** által kezdeményezett egyszeri bejelentkezés
...
4. A Keresés mezőbe írja be a **DigiCert**válassza **DigiCert** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.

     ![Az eredmények listájában a DigiCert](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Az Azure AD egyszeri bejelentkezés tesztelése és konfigurálása

Ebben a szakaszban, tesztelése és konfigurálása az Azure AD egyszeri bejelentkezés a DigiCert nevű tesztfelhasználó alapján **Britta Simon**.
Egyszeri bejelentkezés működjön, az Azure AD-felhasználót és a kapcsolódó felhasználó a DigiCert hivatkozás kapcsolata kell hozható létre.
...
2. **[A DigiCert egyszeri bejelentkezés konfigurálása](#configure-digicert-single-sign-on)**  – az alkalmazás oldalán az egyszeri bejelentkezés beállításainak konfigurálása.
3. **[Hozzon létre egy Azure ad-ben tesztfelhasználót](#create-an-azure-ad-test-user)**  – az Azure AD egyszeri bejelentkezés az Britta Simon teszteléséhez.
4. **[Rendelje hozzá az Azure ad-ben tesztfelhasználó](#assign-the-azure-ad-test-user)**  – Britta Simon használata az Azure AD egyszeri bejelentkezés engedélyezéséhez.
5. **[A DigiCert tesztfelhasználó létrehozása](#create-digicert-test-user)**  – egy megfelelője a Britta Simon DigiCert, amely a felhasználó Azure ad-ben ábrázolása van csatolva van.
...
1. Az a [az Azure portal](https://portal.azure.com/), az a **DigiCert** alkalmazás integráció lapon jelölje be **egyszeri bejelentkezés**.
...
4. Az a **alapszintű SAML-konfigurációja** szakaszban, hajtsa végre az alábbi lépéseket:
    ...
    ![A DigiCert tartomány és URL-címeket egyetlen bejelentkezési adatait](common/idp-identifier.png)

    Az a **azonosító** szövegmezőbe írja be egy URL-címe:  `https://www.digicert.com/sso`
...
8. Az a **állítsa be a DigiCert** területén másolja megfelelően a követelmény a megfelelő URL-címe.
...
### <a name="configure-digicert-single-sign-on"></a>A DigiCert egyszeri bejelentkezés konfigurálása

Az egyszeri bejelentkezés konfigurálása **DigiCert** oldalon kell küldenie a letöltött **összevonási metaadatainak XML** és az Azure Portalról másolt URL-címek megfelelő [DigiCert támogatási csapatának](mailto:support@digicert.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az Azure Portalon válassza ki a **vállalati alkalmazások**, jelölje be **minden alkalmazás**, majd **DigiCert**.

    ![Vállalati alkalmazások panelen](common/enterprise-applications.png)

2. Az alkalmazások listájában jelölje ki a **DigiCert**.

    ![Az alkalmazások listáját a DigiCert hivatkozásra](common/all-applications.png)
...
### <a name="create-digicert-test-user"></a>A DigiCert tesztfelhasználó létrehozása
...
Ha a hozzáférési panelen a DigiCert csempére kattint, akkor kell automatikusan megtörténik a, a DigiCert, amelynek beállítása egyszeri Bejelentkezést. A hozzáférési panelen kapcsolatos további információkért lásd: [Bevezetés a hozzáférési Panel használatába](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
