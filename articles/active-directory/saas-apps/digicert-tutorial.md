...
2. **[DigiCert egyszeri bejelentkezés konfigurálása](#configure-digicert-single-sign-on)** – az egyes Sign-On beállítások konfigurálása az alkalmazás oldalán.
...
### <a name="configure-digicert-single-sign-on"></a>DigiCert egyetlen Sign-On konfigurálása
...
Ha a hozzáférési panelen a DigiCert csempére kattint, automatikusan be kell jelentkeznie arra a DigiCert, amelyhez be szeretné állítani az egyszeri bejelentkezést. További információ a hozzáférési panelről: [Bevezetés a hozzáférési panelre](../user-help/my-apps-portal-end-user-access.md).
