...
1. A Keresés mezőbe írja be a **itslearning**.

    ![Az Azure ad-ben tesztfelhasználó létrehozása](./media/itslearning-tutorial/tutorial_itslearning_search.png)

1. Az eredmények panelen válassza ki a **itslearning**, és kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
...
1. **[Egy itslearning tesztfelhasználó létrehozása](#creating-an-itslearning-test-user)**  – egy megfelelője a Britta Simon a felhasználó Azure ad-ben reprezentációja kapcsolódó itslearning rendelkeznie.
...
1. Az a **itslearning tartomány és URL-címek** szakaszban, hajtsa végre az alábbi lépéseket:
...
1. Az egyszeri bejelentkezés konfigurálása **itslearning** oldalon kell küldenie a letöltött **metaadatainak XML** való [itslearning támogatási csapatának](mailto:support@itslearning.com). Akkor állítsa ezt a beállítást, hogy a SAML SSO-kapcsolat megfelelően állítsa be mindkét oldalon.
...
1. Az alkalmazások listájában jelölje ki a **itslearning**.
