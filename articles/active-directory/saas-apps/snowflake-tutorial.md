...
1. Egy másik böngészőablakban, jelentkezzen be a Snowflake-Security-rendszergazdaként.

1. **Váltson a szerepkör** való **ACCOUNTADMIN**, kattintva **profil** a jobb felső oldalán található.
