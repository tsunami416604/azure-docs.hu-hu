...
2. A **[Sauce Labs konfigurálása – mobil-és webes tesztelési egyszeri bejelentkezés](#configure-sauce-labs---mobile-and-web-testing-single-sign-on)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
...
### <a name="configure-sauce-labs---mobile-and-web-testing-single-sign-on"></a>A Sauce Labs konfigurálása – a mobil-és webes tesztelési egyszeri bejelentkezés
