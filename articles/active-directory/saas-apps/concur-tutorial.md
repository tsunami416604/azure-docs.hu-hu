...
4. **[Hozzon létre beleértve tesztfelhasználót](#create-concur-test-user)**  - a-megfelelője a Britta Simon szerepel, amely kapcsolódik az Azure AD felhasználói ábrázolása beleértve.
