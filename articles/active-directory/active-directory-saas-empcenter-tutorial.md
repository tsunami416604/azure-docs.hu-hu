...
本教學課程的目的是要示範 Azure 與 EmpCenter 的整合。  
...
![案例](./media/active-directory-saas-empcenter-tutorial/IC802916.png "Scenario")
...
6.  在 **搜尋方塊**, ，型別 **EmpCenter**。

    ![應用程式庫](./media/active-directory-saas-empcenter-tutorial/IC802917.png "Application Gallery")

7.  在 [結果] 窗格中，選取 **EmpCenter**, ，然後按一下 [ **完成** 加入應用程式。
...
1.  在 Azure AD 入口網站上 **EmpCenter** 應用程式整合頁面上，按一下 [ **設定單一登入** 開啟 * * 設定單一登入 * * 對話方塊。

    ![設定單一登入](./media/active-directory-saas-empcenter-tutorial/IC802919.png "Configure Single Sign-On")

2.  在 **您希望使用者如何登入 EmpCenter** 頁面上，選取 **Microsoft Azure AD 單一登入**, ，然後按一下 [ **下一步**。
...
4.  在 **EmpCenter 在設定單一登入** ] 頁面上，若要下載中繼資料中，按一下 [ **下載中繼資料**, ，然後儲存您的電腦上的中繼資料檔案。
    ...
    ![設定單一登入](./media/active-directory-saas-empcenter-tutorial/IC802922.png "Configure Single Sign-On")
...
若要讓 Azure AD 使用者可以登入 EmpCenter，則必須將他們佈建到 EmpCenter。  
以 EmpCenter 而言，使用者帳戶必須由 EmpCenter 支援小組建立。

>[AZURE.NOTE] 您可以使用任何其他 EmpCenter 使用者帳戶建立工具或 Api 所提供 EmpCenter 來佈建 Azure Active Directory 使用者帳戶。
