...
6.  在**搜尋方塊**中，輸入 **EmpCenter**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-empcenter-tutorial/IC802917.png "Application Gallery")
...
5.  將下載的中繼資料檔案傳送給 EmpCenter 支援小組。
    >[AZURE.NOTE] EmpCenter 支援小組必須執行實際的 SSO 設定。
...
2.  在 **EmpCenter * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
