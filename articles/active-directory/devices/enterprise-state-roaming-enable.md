...
* **Felhasználó törlése**: Amikor egy felhasználó Azure AD-ben törölnek, a felhasználói fiók roaming-adatforgalom a 90, 180 nap után törlődik. 
* **Könyvtár törlése**: Egy egész címtár törlése az Azure ad-ben egy azonnali művelet. A beállítások adatainak társított, az adott címtár 90, 180 nap után törlődik. 
