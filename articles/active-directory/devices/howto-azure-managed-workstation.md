...
1. Kattintson a **Tovább** gombra.
1. Válassza ki a**kijelölt csoportokhoz****hozzárendelni kívánt** >  **hozzárendeléseket** > . A **felvenni kívánt csoportok kiválasztása**területen válassza a **biztonságos munkaállomások**lehetőséget.
1. Kattintson a **Tovább** gombra.
...
1. **Speciális beállítások** >  > –**Windows-eseménynaplók** kiválasztása**Data**
