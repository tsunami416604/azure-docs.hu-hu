<properties 
    ...
    description="了解如何使用 Adobe EchoSign 與 Azure Active Directory，來啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在**搜尋方塊**中，輸入 **Adobe EchoSign**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-adobe-echosign-tutorial/IC789514.png "Application Gallery")
...
2.  在 **Adobe EchoSign * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
