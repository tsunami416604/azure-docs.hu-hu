...
-   [Alkalmazás hozzáadása az Azure AD-galériából](#_Add_an_application)
...
## <a name="if-these-troubleshoot-steps-dont-resolve-the-issue"></a>Ha ezek elhárításához lépéseket nem sikerül megoldani a problémát 
