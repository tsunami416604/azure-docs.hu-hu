...
Az alábbiakban az összevont egyszeri bejelentkezés konfigurálása a SAML 2.0 nem galéria (pl. egyéni) alkalmazáshoz szükséges lépések magas szintű áttekintése.
