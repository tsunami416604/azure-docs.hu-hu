...
6.  在**搜尋方塊** 中，輸入 **TOPdesk - Secure**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-topdesk-secure-tutorial/IC790597.png "Application Gallery")
...
10. 在 **設定單一登入在 TOPdesk-Secure** ] 頁面上，來下載中繼資料檔中，按一下 [ **下載中繼資料**, ，然後儲存您的電腦上的本機檔案。
...
2.  在 **TOPdesk-Secure * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
