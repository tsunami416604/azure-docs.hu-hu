...
本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合 OpsGenie。<br>整合 OpsGenie 與 Azure AD 為您提供下列優點:
...
若要讓單一登入運作，Azure AD 必須知道 OpsGenie 與 Azure AD 中互相對應的使用者。換句話說，必須建立 Azure AD 使用者和 OpsGenie 中的相關的使用者之間的連結關聯性。<br>
...
4. * *[建立 OpsGenie 測試使用者](#creating-a-opsgenie-test-user)* *-若要連結到她在 Azure AD 代表 OpsGenie 中有對應的 Britta Simon。
...
<br><br>![設定單一登入](./media/active-directory-saas-opsgenie-tutorial/tutorial_opsgenie_04.png) <br>
    ...
    > [AZURE.NOTE] 請連絡您 [OpsGenie 支援小組](mailto:support@opsgenie.com) 如果需要您登入 URL。
