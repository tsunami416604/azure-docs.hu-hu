...
4.  在 **TeamSeer 在設定單一登入** ] 頁面上，下載您的憑證，按一下 [ **下載憑證**, ，然後儲存您的電腦上的憑證檔案。
...
>[AZURE.NOTE] 您可以使用任何其他 TeamSeer 使用者帳戶建立工具或 Api 來佈建 Azure AD 使用者帳戶的 TeamSeer 所提供。
