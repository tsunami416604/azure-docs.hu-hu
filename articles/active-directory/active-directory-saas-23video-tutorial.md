...
本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合 23 視訊。<br>與 Azure AD 整合 23 影片為您提供下列優點:
...
![應用程式][5]<br>
7. 在結果窗格中，選取 [23 Video]****，然後按一下 [完成]**** 以加入應用程式。
<br><br>![應用程式][25]<br>
...
建立此連結關聯性的方法是將 Azure AD 中**使用者名稱**的值指定為 23 Video 中 **Username** 的值。
...
<br><br>![Azure AD 單一登入][8] <br>
     ...
     > [AZURE.NOTE] 使用 SAML 2.0 的 Active Directory 整合適用於所有 23 Video 使用者。 請連絡支援部門 [support@23company.com](mailto:support@23company.com) 如果您需要相關的中繼資料。
