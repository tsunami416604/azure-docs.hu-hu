...
Az Azure AD SaaS integrálásáról további információért tekintse meg a cikket [alkalmazás-hozzáférés és egyszeri bejelentkezés az Azure Active Directoryval](active-directory-appssoaccess-whatis.md).
...
8. Válassza ki a **Mentés** gombot.
    ...
    ![Egyszeri bejelentkezés mentési gomb konfigurálása](./media/active-directory-saas-sapcloudauth-tutorial/tutorial_general_400.png)
