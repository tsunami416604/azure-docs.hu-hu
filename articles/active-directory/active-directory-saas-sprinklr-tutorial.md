...
6.  在 [搜尋方塊]**** 中，輸入 **Sprinklr**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-sprinklr-tutorial/IC782901.png "Application Gallery")
...
4.  在 **設定單一登入在 Sprinklr** ] 頁面上，下載您的憑證，按一下 [ **下載憑證**, ，然後儲存您的電腦上的憑證檔案。
...
2.  在 **Sprinklr * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
