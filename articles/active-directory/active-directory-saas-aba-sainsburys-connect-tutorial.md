<properties
    ...
    description="了解如何使用 ABa Sainsburys 連接與 Azure Active Directory 來啟用單一登入、 自動化佈建和更多功能!" 
...
5.  將下載的中繼資料檔傳送給 Aba Sainsburys Connect 支援小組。
    >[AZURE.NOTE] Aba Sainsburys Connect 支援小組必須執行實際的 SSO 組態。
...
>[AZURE.NOTE] 您可以使用任何其他的 Aba Sainsburys Connect 使用者帳戶建立工具或 Aba Sainsburys Connect 提供的 API 來佈建 Azure Active Directory 使用者帳戶。
...
2.  在 **Aba Sainsburys 連接 * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
