<properties 
    ...
    description="了解如何使用 Azure Active Directory 中的 AnswerHub，來啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在**搜尋方塊**中，輸入 **AnswerHub**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-answerhub-tutorial/IC785166.png "Application Gallery")
...
4.  在 **設定單一登入在 AnswerHub** ] 頁面上，下載您的憑證，按一下 [ **下載憑證**, ，然後將儲存在本機電腦上的憑證檔案。
...
2.  在 **AnswerHub * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
