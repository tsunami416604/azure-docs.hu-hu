...
本教學課程的目標在於告訴您如何使用 Azure Active Directory (Azure AD) 整合 Skilljar。<br>整合 Skilljar 與 Azure AD 為您提供下列優點:
...
若要讓單一登入運作，Azure AD 必須知道 Skilljar 與 Azure AD 中互相對應的使用者。換句話說，必須建立 Azure AD 使用者和 Skilljar 中的相關的使用者之間的連結關聯性。<br>
建立此連結關聯性的方法是將 Azure AD 中**使用者名稱**的值，指定為 Skilljar 中 **Username** 的值。
...
4. * *[建立 Skilljar 測試使用者](#creating-a-skilljar-test-user)* *-若要連結到她在 Azure AD 代表 Skilljar 中有對應的 Britta Simon。
...
<br><br>![設定單一登入](./media/active-directory-saas-skilljar-tutorial/tutorial_skilljar_04.png) <br>
    ...
    a.在 **登入 URL** 文字方塊中，輸入您的使用者用於登入使用以下模式 Skilljar 應用程式使用的 URL: * https://\<company name\>。 skilljar.com*
...
> [AZURE.NOTE] 如果您需要手動建立使用者，您需要連絡 Skilljar 支援小組。
