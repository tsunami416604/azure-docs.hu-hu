<properties 
    ...
    description="了解如何使用自動調整的套件與 Azure Active Directory，來啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在**搜尋方塊**中，輸入 **Adaptive Suite**。
    ...
    ![應用程式資源庫](./media/active-directory-saas-adaptive-suite-tutorial/IC805638.png "Application Gallery")
...
4.  在 **在自動調整的套件設定單一登入** ] 頁面上，下載您的憑證，按一下 [ **下載憑證**, ，然後將儲存在本機電腦上的憑證檔案。
...
2.  在 **自動調整的套件 * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
