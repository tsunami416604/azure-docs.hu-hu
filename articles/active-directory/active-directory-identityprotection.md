...
Az Azure Active Directory Identity Protection elemzi a konfigurációt, és észleli a sérülékenységeket, amelyek hatással lehetnek a felhasználói identitásokat. További részletekért lásd: [Azure Active Directory Identity Protection által észlelt biztonsági rések](identity-protection/vulnerabilities.md).
...
![Szervizelési](./media/active-directory-identityprotection/1000.png "szervizelés")
...
A vizsgálat tevékenységek köthet a [értesítések](identity-protection/notifications.md) Azure Active Directory Protection küld egy e-mailt.
...
![Bejelentkezési kockázati házirend](./media/active-directory-identityprotection/1014.png "bejelentkezési kockázati házirend")
...
* Állítsa be a felhasználókat és csoportokat a szabályzat vonatkozik:
    ...
    ![Bejelentkezési kockázati házirend](./media/active-directory-identityprotection/1015.png "bejelentkezési kockázati házirend")
* A bejelentkezési kockázati szint küszöbértéke (alacsony, közepes vagy magas), amely elindítja a szabályzat beállítása:

    ![Bejelentkezési kockázati házirend](./media/active-directory-identityprotection/1016.png "bejelentkezési kockázati házirend")
* Állítsa be az aktiválásakor a szabályzatot érvényesíteni kívánt vezérlőket:  

    ![Bejelentkezési kockázati házirend](./media/active-directory-identityprotection/1017.png "bejelentkezési kockázati házirend")
...
* Tekintse át, és azt aktiválása előtt változás hatásának vizsgálatában:
    ...
    ![Bejelentkezési kockázati házirend](./media/active-directory-identityprotection/1018.png "bejelentkezési kockázati házirend")
...
* [Kockázatos bejelentkezési helyreállítási](identity-protection/flows.md#risky-sign-in-recovery)
* [Kockázatos bejelentkezés blokkolva](identity-protection/flows.md#risky-sign-in-blocked)  
* [Az Azure AD Identity Protection a bejelentkezési élmény](identity-protection/flows.md)  
...
- Az a **Azure AD Identity Protection** panelen, a a **konfigurálása** területén kattintson **bejelentkezési kockázati házirend**.
    ...
    ![Felhasználói kockázati házirend](./media/active-directory-identityprotection/1014.png "felhasználói kockázati házirend")
...
![Felhasználói kockázat](./media/active-directory-identityprotection/1031.png "felhasználói kockázat")
...
1. Az a **Azure AD Identity Protection** panel alatt **vizsgálat**, kattintson a **kockázati események**.
    ...
    ![Manuális jelszó-visszaállítási](./media/active-directory-identityprotection/1002.png "manuális jelszó alaphelyzetbe állítása")
2. Az a **kockázati események** listában, kattintson a kockázatot jelent.

    ![Manuális jelszó-visszaállítási](./media/active-directory-identityprotection/1003.png "manuális jelszó alaphelyzetbe állítása")
3. A kockázati panelen kattintson a jobb gombbal a felhasználó.

    ![Manuális jelszó-visszaállítási](./media/active-directory-identityprotection/1004.png "manuális jelszó alaphelyzetbe állítása")
...
![A házirend](./media/active-directory-identityprotection/1005.png "házirend")

**A kapcsolódó konfigurációs párbeszédpanel megnyitásához**:

1. Az a **Azure AD Identity Protection** panelen kattintson a **kockázatosként megjelölt felhasználók**.

    ![Manuális jelszó-visszaállítási](./media/active-directory-identityprotection/1006.png "manuális jelszó alaphelyzetbe állítása")
2. A felhasználók a listában legalább egy kockázati események rendelkező felhasználót válasszon.

    ![Manuális jelszó-visszaállítási](./media/active-directory-identityprotection/1007.png "manuális jelszó alaphelyzetbe állítása")
3. A felhasználói panelen kattintson a **jelszó alaphelyzetbe állítása**.

    ![Manuális jelszó-visszaállítási](./media/active-directory-identityprotection/1008.png "manuális jelszó alaphelyzetbe állítása")
...
![Felhasználói kockázati házirend](./media/active-directory-identityprotection/1009.png "felhasználói kockázati házirend")
...
* Állítsa be a felhasználókat és csoportokat a szabályzat vonatkozik:
    ...
    ![Felhasználói kockázati házirend](./media/active-directory-identityprotection/1010.png "felhasználói kockázati házirend")
* A felhasználó kockázati szint küszöbértéke (alacsony, közepes vagy magas), amely elindítja a szabályzat beállítása:

    ![Felhasználói kockázati házirend](./media/active-directory-identityprotection/1011.png "felhasználói kockázati házirend")
* Állítsa be az aktiválásakor a szabályzatot érvényesíteni kívánt vezérlőket:

    ![Felhasználói kockázati házirend](./media/active-directory-identityprotection/1012.png "felhasználói kockázati házirend")
* Váltás a házirend állapota:

    ![Felhasználói kockázati házirend](./media/active-directory-identityprotection/403.png "MFA-regisztráció")
* Tekintse át, és azt aktiválása előtt változás hatásának vizsgálatában:

    ![Felhasználói kockázati házirend](./media/active-directory-identityprotection/1013.png "felhasználói kockázati házirend")
...
* [Feltört fiók helyreállítási folyamat](identity-protection/flows.md#compromised-account-recovery).  
* [Feltört fiók blokkolása folyamat](identity-protection/flows.md#compromised-account-blocked).  
...
![Felhasználói kockázati házirend](./media/active-directory-identityprotection/1019.png "felhasználói kockázati házirend")
...
* [A multi-factor authentication regisztrációs folyamat](identity-protection/flows.md#multi-factor-authentication-registration).  
* [Bejelentkezési élmény az Azure AD Identity Protection](identity-protection/flows.md).  
...
* [Az Azure Active Directory Identity Protection által észlelt biztonsági rések](identity-protection/vulnerabilities.md)

* [Az Azure Active Directory kockázati eseményei](active-directory-identity-protection-risk-events.md)

* [Az Azure Active Directory Identity Protection-értesítések](identity-protection/notifications.md)

* [Az Azure Active Directory Identity Protection-forgatókönyv](identity-protection/playbook.md)

* [Az Azure Active Directory Identity Protection-szószedet](identity-protection/glossary.md)

* [Az Azure AD Identity Protection a bejelentkezési élmény](identity-protection/flows.md)

* [Az Azure Active Directory Identity Protection - hogyan felhasználók tiltásának feloldása](identity-protection/howto-unblock-user.md)

* [Az Azure Active Directory Identity Protection és a Microsoft Graph használatának első lépései](identity-protection/graph-get-started.md)
