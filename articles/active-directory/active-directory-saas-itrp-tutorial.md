...
7.  在 [結果] 窗格中，選取 **ITRP**, ，然後按一下 [ **完成** 加入應用程式。
...
8.  在 [單一登入] 設定頁面上，執行下列步驟：
    ...
    1.  按一下 [ **啟用**。
    2.  在 Azure 網站中，在 **在 ITRP 設定單一登入** 對話方塊頁面中，複製 **遠端登出 URL** 值，並接著將它貼入 **遠端登出 URL** 文字方塊。
    3.  在 Azure 網站中，在 **在 ITRP 設定單一登入** 對話方塊頁面中，複製 **SAML SSO URL** 值，並接著將它貼入 **SAML SSO URL** 文字方塊。
...
5.  在 [新增人員] 對話方塊上，執行下列步驟：
    ...
    1.  型別 **名稱**, ，**電子郵件** 您想要佈建之有效 AAD 帳戶。
    2.  按一下 [ **儲存**。

>[AZURE.NOTE] 您可以使用任何其他 ITRP 使用者帳戶建立工具或 Api 來佈建 AAD 使用者帳戶提供 ITRP。
