...
4. Írja be a keresőmezőbe, **Riskware**, jelölje be **Riskware** eredmény panelen kattintson a **Hozzáadás** gombra kattintva vegye fel az alkalmazást.
    ...
    ![Az eredménylistában Riskware](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_addfromgallery.png)
...
2. Az a **egyszeri bejelentkezés** párbeszédablakban válassza **mód** , **SAML-alapú bejelentkezés** egyszeri bejelentkezés engedélyezése.
    ...
    ![Egyszeri bejelentkezés párbeszédpanel](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_samlbase.png)

3. Az a **Riskware tartomány és az URL-címek** területen tegye a következőket:

    ![Az egyszeri bejelentkezés információk Riskware tartomány és az URL-címek](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_url.png)
...
4. Az a **SAML-aláíró tanúsítványa** területen kattintson **metaadatainak XML-kódja** és mentse a metaadat-fájlt a számítógépen.
    ...
    ![A tanúsítvány letöltési hivatkozását](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_certificate.png) 

5. Kattintson a **mentése** gombra.

    ![Egyszeri bejelentkezés Mentés gombra konfigurálása](./media/active-directory-saas-riskware-tutorial/tutorial_general_400.png)
...
6. A a **Riskware konfigurációs** kattintson **konfigurálása Riskware** megnyitásához **bejelentkezés konfigurálása** ablak. Másolás a **Sign-Out és SAML-alapú egyszeri bejelentkezés szolgáltatás URL-címe** a a **rövid összefoglaló szakasz.**
    ...
    ![Riskware konfiguráció](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_configure.png) 
...
8. Kattintson a jobb felső sarokban **karbantartási** karbantartási lapjának megnyitásához. 
    ...
    ![Riskware konfigurációk karbantartása](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_maintain.png)

9. A karbantartási oldalon kattintson **hitelesítési**.

    ![Riskware konfigurációs authen](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_authen.png)

10. A **hitelesítési** lapon, a következő lépésekkel:

    ![Riskware konfigurációs authenconfig](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_config.png)
...
1. Az Azure portálon a bal oldali ablaktáblán kattintson a **Azure Active Directory** gombra.
    ...
    ![Az Azure Active Directory gomb](./media/active-directory-saas-riskware-tutorial/create_aaduser_01.png)

2. Azon felhasználók listájának megtekintéséhez keresse fel **felhasználók és csoportok**, és kattintson a **minden felhasználó**.

    ![A "felhasználók és csoportok" és "Minden felhasználó" hivatkozások](./media/active-directory-saas-riskware-tutorial/create_aaduser_02.png)

3. Megnyitásához a **felhasználói** párbeszédpanel, kattintson a **Hozzáadás** tetején a **minden felhasználó** párbeszédpanel megnyitásához.

    ![A Hozzáadás gombra.](./media/active-directory-saas-riskware-tutorial/create_aaduser_03.png)

4. Az a **felhasználói** párbeszédpanelen hajtsa végre az alábbi lépéseket:

    ![A felhasználó párbeszédpanel](./media/active-directory-saas-riskware-tutorial/create_aaduser_04.png)
...
2. Kattintson a jobb felső sarokban **karbantartási** karbantartási lapjának megnyitásához. 
    ...
    ![Riskware konfigurációs tart fenn.](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_maintain.png)

3. A karbantartási oldalon kattintson **személyek**.

    ![Riskware konfigurációs személyek](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_people.png)

4. Az a **részletek** lapra, hajtsa végre a következő lépéseket:
    
    ![Riskware konfiguráció részletei](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_details.png)
...
5. Az a **biztonsági** lapra, hajtsa végre a következő lépéseket:    
    ...
    ![Riskware konfigurációs biztonság](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_security.png)
...
6. Az a **szervezet** lapra, hajtsa végre a következő lépéseket:
    ...
    ![Riskware konfigurációs szervezeti](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_org.png)
...
2. Az alkalmazások listában válassza ki a **Riskware**.
    ...
    ![Az alkalmazások listáját a Riskware hivatkozás](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_app.png)  
