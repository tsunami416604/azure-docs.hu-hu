...
如需有關軟體需求和安裝 Azure AD 模組，以及有關 Azure AD 模組 cmdlet 管理管理單位，包括語法、 參數說明和範例，請參閱 [使用 Windows PowerShell 管理 Azure AD](https://msdn.microsoft.com/library/azure/jj151815.aspx)。
