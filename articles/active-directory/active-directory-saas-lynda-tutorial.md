<properties 
    ...
    description="了解如何使用 Azure Active Directory 中的 Lynda.com，來啟用單一登入、 自動化佈建和更多功能!" 
...
6.  在搜尋方塊****中，輸入 **Lynda.com**。

    ![應用程式資源庫](./media/active-directory-saas-lynda-tutorial/IC777524.png "Application Gallery")
...
4.  在 **設定單一登入在 Lynda.com** ] 頁面上，若要下載中繼資料中，按一下 [ **下載中繼資料**, ，然後將儲存在本機電腦上的憑證檔案。
...
2.  在 **Lynda.com * * 應用程式整合頁面上，按一下 [* * 將使用者指派**。
