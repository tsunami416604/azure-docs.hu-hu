...
This article is one in a series introducing Azure Media Services programming. The previous topic was [How to: Encode an Asset][How to: Encode an Asset].
...
Now that you know how to create a job and track it's progress, the next step is protecting assets. For more information, see [How to Protect an Asset with Azure Media Services][How to Protect an Asset with Azure Media Services].

  [How to: Encode an Asset]: http://go.microsoft.com/fwlink/?LinkID=301753&clcid=0x409
  [How to Protect an Asset with Azure Media Services]: http://go.microsoft.com/fwlink/?LinkID=301813&clcid=0x409
