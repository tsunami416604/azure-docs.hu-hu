...
3. Ha az Azure Functions használatával áttelepítési C#frissítsen a [funkciók V2](https://docs.microsoft.com/azure/azure-functions/functions-versions).
