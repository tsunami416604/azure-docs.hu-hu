...
## <a name="what-does-it-all-mean-performance-tiles-and-reports"></a><a name="metrics"></a>Mit jelent mindez? Teljesítmény csempék és jelentések
...
## <a name="diagnosing-issues"></a><a name="diagnosis"></a>Problémák diagnosztizálása
