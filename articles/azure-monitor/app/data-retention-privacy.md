...
* Az SDK-t integrálja az alkalmazás vagy [fejlesztés](../../azure-monitor/app/asp-net.md) vagy [futási időben](../../azure-monitor/app/monitor-performance-live-website-now.md). Számos különböző SDK-k különböző alkalmazástípusokat. Is egy [webes SDK](../../azure-monitor/app/javascript.md), amely betölti a végfelhasználó böngészőbe az oldal együtt.
...
* [Webalkalmazás-telemetriát](../../azure-monitor/app/asp-net.md) – HTTP-kérelmekre.  URI-t, a kérelem, válaszkód, ügyfél IP-cím feldolgozásához igénybe vett idő. Munkamenet-azonosító.
* [Weblapok](../../azure-monitor/app/javascript.md) -oldalon, a felhasználók és munkamenetek száma. Lapbetöltési idők. Kivételek. AJAX-hívások.
...
* [Kivételek](../../azure-monitor/app/asp-net-exceptions.md) és összeomlás - **memóriaképek zásobníku**, hozhat létre az azonosítója, CPU-típus. 
* [Függőségek](../../azure-monitor/app/asp-net-dependencies.md) -külső szolgáltatásokkal, például REST, SQL, AJAX-hívások. URI Azonosítójának vagy kapcsolati karakterlánc, időtartamának, sikeres, a parancs.
* [Rendelkezésre állási tesztek](../../azure-monitor/app/monitor-web-app-availability.md) -tesztelés és a lépéseket, a válaszok időtartama.
* [Nyomkövetési naplók](../../azure-monitor/app/asp-net-trace-logs.md) és [egyéni telemetriát](../../azure-monitor/app/api-custom-events-metrics.md) - **semmit, a naplók és a telemetria kódot**.
...
Ez akkor lehetséges, ha egy [telemetriai processzor beépülő modul](../../azure-monitor/app/api-filtering-sampling.md).
...
Minden adat titkosítása és, mert áthelyezése adatok között adatközpontokból.
