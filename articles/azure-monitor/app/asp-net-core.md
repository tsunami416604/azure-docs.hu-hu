...
4. Válassza ki az előfizetését. Ezután válassza az **erőforrás**-  >  **regisztráció**lehetőséget.
...
|Beállítás | Description | Alapértelmezett
|---------------|-------|-------
