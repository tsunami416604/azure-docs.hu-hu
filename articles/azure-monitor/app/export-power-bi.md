...
* [**Elemzési lekérdezések exportálása**](#export-analytics-queries). Ez az előnyben részesített módszer. Írja le a kívánt lekérdezést, és exportálja Power BIba. Ezt a lekérdezést egy irányítópulton helyezheti el, valamint bármilyen más adattal.
