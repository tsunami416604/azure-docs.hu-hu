...
- Profiljának ASP.NET Core [Azure-beli Linuxos web apps](../../azure-monitor/app/profiler-aspnetcore-linux.md).
- Az ASP.NET Debug [pillanatképek](../../azure-monitor/app/snapshot-debugger.md).