...
![Kattintson az Új, majd az Application Insights lehetőségre](./media/windows-services/01-new-asp.png)
...
![Kattintson a Tulajdonságok elemre, válassza ki a kulcsot, és nyomja le a ctrl+C billentyűkombinációt.](./media/windows-services/02-props-asp.png)
...
1. A Visual Studióban kattintson a jobb gombbal a projektjére, és válassza a **Manage NuGet Packages (NuGet-csomagok kezelése)** lehetőséget.
    ...
    ![Kattintson a jobb gombbal a projektre, és válassza a Manage Nuget Packages (NuGet-csomagok kezelése) lehetőséget](./media/windows-services/03-nuget.png)
2. Telepítse a Windows Server-alkalmazásokhoz tartozó „Microsoft.ApplicationInsights.WindowsServer” Application Insights-csomagot.
    ...
    ![Az „Application Insights” kifejezés keresése](./media/windows-services/04-ai-nuget.png)
...
![Események száma a Visual Studióban](./media/windows-services/appinsights-09eventcount.png)
...
![Kattintson végig rajtuk a további adatokért](./media/windows-services/12-first-perf.png)
...
![Az alkalmazás közzététele a Visual Studio segítségével](./media/windows-services/15-publish.png)
