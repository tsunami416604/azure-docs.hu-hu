...
ms.locfileid: "53999188"
---
# <a name="metric-telemetry-application-insights-data-model"></a>Metrika telemetriai adatokat: Application Insights-adatmodell

Metrika telemetriai által támogatott két típusa van [Application Insights](../../application-insights/app-insights-overview.md): egyszeri mérési és előre összesített metrikája. Egyetlen érték csak egy nevet és egy értéket. Előre összesített metrikája minimális és maximális értékét a metrika az aggregációs időköz és szórását, adja meg.
...
- Ismerje meg, hogyan használható [Application Insights API egyéni eseményekhez és a metrikák](../../azure-monitor/app/api-custom-events-metrics.md#trackmetric).
