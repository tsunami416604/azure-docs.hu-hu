...
A beállítások, például az IP-konfigurációs szabály, a TLS-beállítások és a bővítmények még nem érhetők el az ARG-ben, ezért az elemzési lekérdezések módosítása és a módosítások biztonságos kiszámításával további részleteket tudhat meg az alkalmazásban megváltoztatott adatokról. Ez az információ még nem érhető el az Azure Resource Graph-ban, de hamarosan elérhető lesz.
