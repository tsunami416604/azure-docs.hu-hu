...
Ha az AzureFunctions v2+ vagy az Azure WebJobs v3+ szolgáltatást használja , kövesse ezt a dokumentumot:https://docs.microsoft.com/azure/azure-functions/functions-monitoring#version-2x-3
