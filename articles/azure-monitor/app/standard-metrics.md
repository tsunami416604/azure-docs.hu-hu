...
* További információ a [napló alapú és a már aggregált mérőszámokról](https://docs.microsoft.com/azure/azure-monitor/app/pre-aggregated-metrics-log-metrics).
* [A log-alapú metrikák lekérdezései és definíciói](https://docs.microsoft.com/azure/azure-monitor/platform/app-insights-metrics).