...
Az ezen a [lapon](../../azure-functions/configure-monitoring.md#configure-sampling) található utasításokat követve konfigurálhatja a Azure functions futó alkalmazások adaptív mintavételezését.
