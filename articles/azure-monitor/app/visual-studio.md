...
* *Először teljesen konfiguráltam Application Insights, hogy telemetria küldjenek a portálra. Most azonban azt szeretném, hogy a telemetria csak a Visual Studióban legyen látható.*
  ...
  * Ha le szeretné állítani a telemetria küldését a portálra, tegye megjegyzésbe az ApplicationInsights. config fájlból `<instrumentationkey>...` sort. Ha készen áll arra, hogy ismét elküldhesse a telemetria a portálra, tegye meg a megjegyzéseit.
