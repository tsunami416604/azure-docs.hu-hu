...
ms.locfileid: "67807091"
---
# <a name="status-monitor-v2-api-get-applicationinsightsmonitoringconfig-v040-alpha"></a>A figyelő v2 API állapota: Get-ApplicationInsightsMonitoringConfig (v0.4.0-alpha)
