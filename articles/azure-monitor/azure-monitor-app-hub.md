...
ms.locfileid: "67875291"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Azure Monitor Application Insights dokumentációja</h1>
        <p>Azure Monitor Application Insights részletes programkód-szintű alkalmazás teljesítmény-figyelést biztosít.</p>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        <h3>Újdonságok</h3>
                                                        <p>
                                                            <a href="./app/azure-vm-vmss-apps.md">Kód nélkül figyelheti az Azure-beli virtuális gépeket és az Azure-beli virtuálisgép-méretezési csoport alkalmazásait</a><br>
                                                            <a href="./app/kubernetes.md">Kubernetes-alkalmazások figyelése</a><br>
                                                            <a href="./app/status-monitor-v2-overview.md">Állapotmonitor v2 IIS-alkalmazásokhoz</a><br>
                                                        </p>
                                                        <br><br>
                                                        <h3>Gyorsútmutatók</h3>
                                                        <p>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="./app/proactive-trace-severity.md">Nyomkövetés romlása</a><br>
                                                            <a href="./app/proactive-exception-volume.md">Kivételek rendellenes növekedése</a><br>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="./app/micrometer-java.md">Mikrométer mérőszámai</a><br>
                                                            <a href="./app/java-filter-telemetry.md">Szűrőtelemetria</a><br>
                                                            <a href="./app/java-trace-logs.md">Nyomkövetés naplózása</a><br>
                                                            <a href="./app/java-agent.md">Ügynök konfigurációja a függőségek nyomon követéséhez</a><br>
...
">Config. XML</a><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="./app/api-custom-events-metrics.md">Egyéni események és a mérőszámok</a><br>
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-JS">Nyílt forráskódú JavaScript SDK GitHub-tárház</a><br>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="cardSize">
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        <h3>Felhasználói viselkedés elemzése</h3>
                                                        <p>
                                                            <a href="./app/usage-overview.md">Áttekintés</a><br>
                                                            <a href="./app/usage-send-user-context.md">Felhasználói környezeti azonosítók küldése</a><br>
