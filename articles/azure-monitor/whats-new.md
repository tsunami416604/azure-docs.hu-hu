...
- Az [Azure Red Hat OpenShift v4. x konfigurálása az Azure monitor for containers szolgáltatással](./insights/container-insights-azure-redhat4-setup.md) – új cikk
...
- [Azure Key vaultok figyelése a Key vaultok Azure Monitorával (előzetes verzió)](./insights/key-vault-insights-overview.md) – új cikk
