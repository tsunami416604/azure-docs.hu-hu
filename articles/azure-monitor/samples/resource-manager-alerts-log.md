...
## <a name="number-of-results-template-up-to-version-2018-04-16"></a>Az eredmények sablonjának száma (legfeljebb 2018-04-16-es verzió)
Az alábbi minta [számos találati riasztási szabályt](../platform/alerts-unified-log.md#count-of-the-results-table-rows)hoz létre.
...
## <a name="metric-measurement-template-up-to-version-2018-04-16"></a>Metrika-mérési sablon (legfeljebb 2018-04-16-es verzió)
Az alábbi minta egy [metrikai mérési riasztási szabályt](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value)hoz létre.
...
## <a name="template-for-all-resource-types-from-version-2020-05-01-preview"></a>Sablon minden erőforrástípus számára (az 2020-05-01-es verzióból – előzetes verzió)
Az alábbi minta egy olyan szabályt hoz létre, amely bármilyen erőforrást célozhat meg.
