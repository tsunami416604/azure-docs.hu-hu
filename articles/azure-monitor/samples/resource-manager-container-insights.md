...
## <a name="enable-for-new-azure-red-hat-openshift-v3-cluster"></a>Új Azure Red Hat OpenShift v3-fürt engedélyezése
...
## <a name="enable-for-existing-azure-red-hat-openshift-v3-cluster"></a>Meglévő Azure Red Hat OpenShift v3-fürt engedélyezése
