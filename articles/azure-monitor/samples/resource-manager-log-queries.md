...
- [Microsoft. OperationalInsights-munkaterületek/savedSearches](/azure/templates/microsoft.operationalinsights/2020-03-01-preview/workspaces/savedsearches)

## <a name="simple-log-query"></a>Egyszerű napló lekérdezése
Az alábbi minta egy Log Analytics munkaterülethez tartozó napló-lekérdezést vesz fel.
...
## <a name="log-query-as-a-function"></a>Lekérdezés naplózása függvényként
Az alábbi minta egy Log Analytics munkaterülethez függvényként adja hozzá a naplózási lekérdezést.
...
## <a name="parameterized-function"></a>Paraméteres függvény
Az alábbi példa egy olyan függvényt használ, amely egy Log Analytics munkaterületre vonatkozó paramétert használ. A rendszer egy második naplózási lekérdezést is tartalmaz, amely a paraméteres függvényt használja.

> [!NOTE]
> Az erőforrás-sablon jelenleg az egyetlen módszer, amely paraméteres függvények esetében használható. Minden naplózási lekérdezés használhatja a függvényt, miután a munkaterületre telepítette.
...
* [További információ a functions](../log-query/functions.md)szolgáltatásról.