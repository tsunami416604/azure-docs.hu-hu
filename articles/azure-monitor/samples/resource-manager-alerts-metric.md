...
Ez a cikk példákat tartalmaz [Azure Resource Manager sablonok](../../azure-resource-manager/templates/template-syntax.md) használatával a [metrikai riasztási szabályok](../platform/alerts-metric-near-real-time.md) konfigurálásához a Azure monitorban. Mindegyik minta tartalmaz egy sablonfájlt és egy, a sablonhoz adni kívánt minta értékeket tartalmazó paramétereket tartalmazó fájlt.
