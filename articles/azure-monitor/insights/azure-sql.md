...
| --- | --- | --- |
| [Azure Diagnostics](../platform/collect-azure-metrics-logs.md) | **Igen** | Az Azure metrika és a naplózási adatok közvetlenül az Azure-ban érkeznek Azure Monitor naplókra. |
