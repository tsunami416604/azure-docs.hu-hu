...
| Operator | Igen | A következő értékek közül az összehasonlító operátort:<br><br>**gt = nagyobb, mint<br>lt = kisebb, mint** |
| Value | Igen | A feltételeknek teljesülniük kell a riasztást kiváltó idők számát. |
