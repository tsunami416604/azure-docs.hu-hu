...
A containers Agent Azure Monitor a cAdvisor végpontot használja a csomópont-ügynökön a teljesítmény metrikáinak összegyűjtéséhez. Ellenőrizze, hogy `cAdvisor port: 10255` a csomóponton lévő tároló ügynök úgy van-e konfigurálva, hogy a teljesítmény-metrikák gyűjtéséhez a fürt összes csomópontján meg lehessen nyitni.
