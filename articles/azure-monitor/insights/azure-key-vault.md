...
* Használat [Log Analytics naplóbeli kereséseivel](../../log-analytics/log-analytics-queries.md) Azure Key Vault részletes adatainak megtekintéséhez.
