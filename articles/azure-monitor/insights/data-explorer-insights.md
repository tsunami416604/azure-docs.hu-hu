---
title: Az Azure Adatkezelő-fürt figyelése az Azure-beli Azure Monitorokkal Adatkezelő (előzetes verzió) | Microsoft Docs
...
ms.locfileid: "97901731"
---
# <a name="monitoring-your-azure-data-explorer-cluster-with-azure-monitor-for-azure-data-explorer-preview"></a>Azure Adatkezelő-fürt figyelése az Azure-beli Azure Monitorokkal Adatkezelő (előzetes verzió)
...
![Képernyőkép az áttekintő élményről több gráfmal](./media/data-explorer-insights/insights-hub.png)
...
![A lekérdezési teljesítmény lap képernyőképe](./media/data-explorer-insights/query-performance.png)
...
[![Képernyőfelvétel a betöltési teljesítmény lapról](./media/data-explorer-insights/ingestion-performance.png)](./media/data-explorer-insights/ingestion-performance.png#lightbox)
...
![A "figyelési naplók engedélyezése" szöveget megjelenítő kék gomb képernyőképe](./media/data-explorer-insights/enable-logs.png)
...
[![Képernyőkép egy Azure Adatkezelő fürterőforrás-erőforrásról](./media/data-explorer-insights/overview.png)](./media/data-explorer-insights/overview.png#lightbox)
...
[![A hibák nézet képernyőképe](./media/data-explorer-insights/key-metrics.png)](./media/data-explorer-insights/key-metrics.png#lightbox)
...
[![Képernyőkép az Operations nézetről, amely a leggyakoribb alkalmazási diagramokat és lekérdezéseket, valamint a parancsok és lekérdezések számát, valamint a parancs típusa szerint a leggyakoribb parancsokat jeleníti meg.](./media/data-explorer-insights/usage.png)](./media/data-explorer-insights/usage.png#lightbox)

[![Képernyőkép az Operations nézetről, a lekérdezések számának sorszáma alkalmazás szerint, teljes memória az alkalmazás és a teljes CPU szerint alkalmazás szerint](./media/data-explorer-insights/usage-2.png)](./media/data-explorer-insights/usage-2.png#lightbox)
...
[![A gyorsítótár részleteinek képernyőképe](./media/data-explorer-insights/cache-tab.png)](./media/data-explorer-insights/cache-tab.png#lightbox)
...
![Képernyőkép a PIN-kód ikon kiválasztásáról](./media/data-explorer-insights/pin.png)
...
![Képernyőkép a Testreszabás gombról](./media/data-explorer-insights/customize.png)
...
![Képernyőfelvétel a munkafüzet-gyűjteményről](./media/data-explorer-insights/gallery.png)
