...
![Azure Monitor több fürt irányítópultjának – példa](./media/container-insights-analyze/azmon-containers-multiview.png)
...
![A tárolók példája egy összesítő](./media/container-insights-analyze/containers-nodes-containerstotal.png)
...
![Példa Lehatolás csomópontból a teljesítmény nézet-vezérlő](./media/container-insights-analyze/drill-down-controller-node.png)
