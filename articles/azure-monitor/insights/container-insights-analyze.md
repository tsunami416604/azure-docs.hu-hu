---
title: Az AK-fürt teljesítményének figyelése az Azure Monitor for containers szolgáltatással | Microsoft Docs
description: Ez a cikk bemutatja, hogyan tekintheti meg és elemezheti a teljesítményt és naplózhatja a Azure Monitor a tárolók számára.
...
ms.locfileid: "72554244"
---
# <a name="understand-aks-cluster-performance-with-azure-monitor-for-containers"></a>Az AK-fürt teljesítményének megismerése a tárolók Azure Monitorével
...
Az összes telepített AK-fürt állapotának megtekintéséhez válassza a **figyelő** elemet a Azure Portal bal oldali paneljén. Az **áttekintések** szakaszban válassza a **tárolók**lehetőséget. 
...
## <a name="view-performance-directly-from-an-aks-cluster"></a>Teljesítmény megtekintése közvetlenül egy AK-fürtből
...
Az alapértelmezett lap akkor nyílik meg, amikor **kijelöli** az  > -**fürt**kiválasztását. A négy soros teljesítményű diagram a fürt fő teljesítménymutatóit jeleníti meg. 
...
![Példa a szűrő használatával szűkítheti az eredményeket](./media/container-insights-analyze/add-filter-option-01.png)
...
![\<Name > vezérlők teljesítmény nézete](./media/container-insights-analyze/containers-controllers-view.png)
...
![\<Name > tárolók teljesítmény nézete](./media/container-insights-analyze/containers-containers-view.png)
