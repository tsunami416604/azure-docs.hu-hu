...
Tegyük fel például, hogy egy tároló rendszerképének öt tároló példánya van, és az egyes állapotuk **kritikus**, **Figyelmeztetés**, kifogástalan **, kifogástalan, kifogástalan**állapotú **.**  A tároló CPU-kihasználtsági figyelő állapota **kritikus**lesz, mivel a tárolók 90%-ának legrosszabb állapota **kritikus** , ha csökkenő súlyossági sorrendben rendezi a rendszer.
