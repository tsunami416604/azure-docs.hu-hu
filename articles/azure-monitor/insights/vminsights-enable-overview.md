...
<sup>1</sup> ez a régió jelenleg nem támogatja Azure monitor for VMS rendszerállapot-szolgáltatását.
...
|Operációs rendszer verziója |Teljesítmény |Térképek |Egészségügy |
|-----------|------------|-----|-------|
...
|LogicalDisk |Lemez sebessége (bájt/mp) |
|LogicalDisk |Lemez olvasási sebessége (bájt/s) |
|LogicalDisk |Olvasási sebesség (lemez/mp) |
|LogicalDisk |Lemez átvitele másodpercenként |
|LogicalDisk |Lemez írási sebessége (bájt/s) |
|LogicalDisk |Írási sebesség (írás/mp) |
...
Az állapotfigyelő funkció használatának megismeréséhez tekintse meg a [Azure monitor for VMS állapotának megtekintése](vminsights-health.md)című témakört. A felderített alkalmazások függőségeinek megtekintéséhez lásd: [Azure monitor for VMS Térkép megtekintése](vminsights-maps.md).
