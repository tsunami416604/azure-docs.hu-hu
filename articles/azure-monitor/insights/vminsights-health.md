...
![Állapot összegzése példa](./media/vminsights-health/health-diagnostics-windows-svc-rollup.png)
...
![A health feltételek példa konfigurálása](./media/vminsights-health/health-diagnostics-linuxvm-example-03.png)
...
![. Egy egység figyelő például egy állapotára vonatkozó feltételek konfigurálása](./media/vminsights-health/health-diagnostics-linuxvm-example-04.png)
...
![Felügyelt példány és az eredmények kiválasztása – példa](./media/vminsights-health/health-diagnostics-linuxvm-example-02.png)
