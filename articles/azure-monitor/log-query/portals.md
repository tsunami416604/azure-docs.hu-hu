...
Nyissa meg a Log Analytics lapot **naplók** a Log Analytics menüben. Ez az új felülettel jelentkezik a naplóadatok használatának és lekérdezések létrehozásáról. Ismerkedjen meg ezen a portálon, és vizsgálja meg a szolgáltatásokat [Ismerkedés a Log Analytics-oldal az Azure Portalon](../../azure-monitor/log-query/get-started-portal.md).
...
![A speciális analitika portálon](media/portals/advanced-analytics-portal.png)
...
![Log Search lap](media/portals/log-search-portal.png)
