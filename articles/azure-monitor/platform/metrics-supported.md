...
|Metrika|Metrika megjelenítendő neve|Unit (Egység)|Összesítés típusa|Leírás|Dimenziók|
|---|---|---|---|---|---|
|Average_%-os szabad inode|Szabad inode%-ban|Mennyiség|Átlag|Average_%-os szabad inode|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_ szabad területe (%)|Szabad terület (%)|Mennyiség|Átlag|Average_ szabad területe (%)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_%-ban használt inode|Felhasznált inode%-ban|Mennyiség|Átlag|Average_%-ban használt inode|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_% felhasznált terület|Felhasznált terület (%)|Mennyiség|Átlag|Average_% felhasznált terület|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Disk olvasási sebesség (bájt/s)|Lemez olvasási sebessége (bájt/s)|Mennyiség|Átlag|Average_Disk olvasási sebesség (bájt/s)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Olvasási sebesség (Average_Disk/s)|Olvasási sebesség (lemez/mp)|Mennyiség|Átlag|Olvasási sebesség (Average_Disk/s)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Disk adatátvitel gyakorisága (mp)|Lemez átvitele másodpercenként|Mennyiség|Átlag|Average_Disk adatátvitel gyakorisága (mp)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Disk írási sebesség (bájt/s)|Lemez írási sebessége (bájt/s)|Mennyiség|Átlag|Average_Disk írási sebesség (bájt/s)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Disk írás gyakorisága (művelet/mp)|Írási sebesség (írás/mp)|Mennyiség|Átlag|Average_Disk írás gyakorisága (művelet/mp)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Free (MB)|Szabad terület (MB)|Mennyiség|Átlag|Average_Free (MB)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
...
|Average_%-os rendelkezésre álló memória|Rendelkezésre álló memória%-ban|Mennyiség|Átlag|Average_%-os rendelkezésre álló memória|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_%-os rendelkezésre álló swap-terület|Rendelkezésre álló swap-terület (%)|Mennyiség|Átlag|Average_%-os rendelkezésre álló swap-terület|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_%-ban használt memória|Felhasznált memória (%)|Mennyiség|Átlag|Average_%-ban használt memória|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_%-ban használt lapozófájl|Felhasznált swap-terület%-ban|Mennyiség|Átlag|Average_%-ban használt lapozófájl|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Available memória (MB)|Rendelkezésre álló memória (MB)|Mennyiség|Átlag|Average_Available memória (MB)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Available (MB) – swap|Rendelkezésre álló memória (MB)|Mennyiség|Átlag|Average_Available (MB) – swap|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Olvasási sebesség (Average_Page/s)|Olvasott lap/mp|Mennyiség|Átlag|Olvasási sebesség (Average_Page/s)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Page írás gyakorisága (művelet/mp)|Írási idő/mp|Mennyiség|Átlag|Average_Page írás gyakorisága (művelet/mp)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Pages/s|Lap/mp|Mennyiség|Átlag|Average_Pages/s|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Used MB-ban|Felhasznált memória (MB) – lapozófájl|Mennyiség|Átlag|Average_Used MB-ban|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
...
|Továbbított Average_Total-bájtok|Továbbított bájtok összesen|Mennyiség|Átlag|Továbbított Average_Total-bájtok|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
...
|Továbbított Average_Total-csomagok|Továbbított csomagok összesen|Mennyiség|Átlag|Továbbított Average_Total-csomagok|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Fogadott Average_Total-csomagok|Fogadott csomagok összesen|Mennyiség|Átlag|Fogadott Average_Total-csomagok|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Total RX-hibák|Rx-hibák összesen|Mennyiség|Átlag|Average_Total RX-hibák|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
...
|Average_Total ütközések|Ütközések összesen|Mennyiség|Átlag|Average_Total ütközések|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
...
|Average_Pct-jogosultságú idő|PCT rendszerjogosultságú idő|Mennyiség|Átlag|Average_Pct-jogosultságú idő|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
...
|Average_% üresjárati idő|Üresjárati idő%-ban|Mennyiség|Átlag|Average_% üresjárati idő|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_%-os megszakítási ideje|Megszakítási idő%-ban|Mennyiség|Átlag|Average_%-os megszakítási ideje|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
...
|Average_%-os processzoridő|Processzoridő (%)|Mennyiség|Átlag|Average_%-os processzoridő|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
...
|Average_Free fizikai memória|Szabad fizikai memória|Mennyiség|Átlag|Average_Free fizikai memória|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Free terület a Lapozófájlokban|Szabad terület a Lapozófájlokban|Mennyiség|Átlag|Average_Free terület a Lapozófájlokban|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
...
|Average_Avg. Írási idő (mp/olvasás)|Átlagos írási idő (mp/olvasás)|Mennyiség|Átlag|Average_Avg. Írási idő (mp/olvasás)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Avg. Írási idő (mp/írás)|Átlagos írási idő (mp/írás)|Mennyiség|Átlag|Average_Avg. Írási idő (mp/írás)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Current-várólista hossza|Lemez aktuális várólistájának hossza|Mennyiség|Átlag|Average_Current-várólista hossza|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Olvasási sebesség (Average_Disk/s)|Olvasási sebesség (lemez/mp)|Mennyiség|Átlag|Olvasási sebesség (Average_Disk/s)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Disk adatátvitel gyakorisága (mp)|Lemez átvitele másodpercenként|Mennyiség|Átlag|Average_Disk adatátvitel gyakorisága (mp)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Disk írás gyakorisága (művelet/mp)|Írási sebesség (írás/mp)|Mennyiség|Átlag|Average_Disk írás gyakorisága (művelet/mp)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Free (MB)|Szabad terület (MB)|Mennyiség|Átlag|Average_Free (MB)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
...
|Fogadott Average_Bytes/s|Fogadott bájtok/s|Mennyiség|Átlag|Fogadott Average_Bytes/s|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
|Average_Bytes elküldésének gyakorisága (mp)|Küldési sebesség (bájt/s)|Mennyiség|Átlag|Average_Bytes elküldésének gyakorisága (mp)|Számítógép, ObjectName, példánynév, CounterPath, SourceSystem|
