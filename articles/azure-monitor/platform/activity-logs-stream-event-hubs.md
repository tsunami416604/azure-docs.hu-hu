...
1. Keresse meg a **tevékenységnapló** használatával a szakasz a **minden szolgáltatás** keresés a portál bal oldalán.
   ...
   ![Tevékenységnapló a listából a szolgáltatások a portálon](./media/activity-logs-stream-event-hubs/activity-logs-portal-navigate-v2.png)
2. Válassza ki a **exportálás eseményközpontba** gombra a napló elején.
   
   ![Exportálás gomb a portálon](./media/activity-logs-stream-event-hubs/activity-logs-portal-export-v2.png)
...
3. A megjelenő szakaszban válassza ki a **minden régióban**. Ne válassza az adott régióban.
   ...
   ![A szakasz exportálása](./media/activity-logs-stream-event-hubs/export-audit.png)
...
A tevékenységnapló sémája érhető el a [figyelése az Azure-tevékenységnapló előfizetés](../../azure-monitor/platform/activity-logs-overview.md). Minden esemény van egy JSON-blobok nevű tömbben *rekordok*.
