...
- További információ [Az Azure-](alerts-overview.md) beli riasztásokról
- Megtudhatja, hogyan [hozhat létre műveleti csoportot Resource Manager](action-groups-create-resource-manager-template.md) -sablonokkal
