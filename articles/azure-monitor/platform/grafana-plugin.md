...
## <a name="optional-monitor-your-custom-metrics-in-the-same-grafana-server"></a>Nem kötelező: Egyéni metrikák figyelése ugyanabban a Grafana-kiszolgálón
