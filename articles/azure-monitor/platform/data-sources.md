...
| Tárolás | Erőforrás-naplók küldése az Azure Storage-ba archiválás céljából. | [Azure-beli erőforrás-naplók archiválása](./resource-logs.md#send-to-log-analytics-workspace) |
