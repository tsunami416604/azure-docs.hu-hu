...
| Cél | Metódus | Description | Hivatkozás |
|:---|:---|:---|:---|
...
| Szolgáltatás | Cél | Description | Hivatkozás |
|:---|:---|:---|:---|
...
| [Azure Sentinel](/azure/sentinel/) | Azure Monitor-naplók | Az Azure Sentinel a különböző adatforrásokból gyűjtött adatokat egy Log Analytics munkaterületen tárolja, amely lehetővé teszi, hogy a rendszer a Azure Monitor által gyűjtött egyéb naplózási adatokkal elemezze.  | [Adatforrások csatlakoztatása](/azure/sentinel/quickstart-onboard) |
