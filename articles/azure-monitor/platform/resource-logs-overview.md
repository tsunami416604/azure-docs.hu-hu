...
Az erőforrás-diagnosztikai naplók sémája a `resourceId` tulajdonság által definiált erőforrástípus és a `category` tulajdonságok függvénye. Az alábbi listában az összes olyan Azure-szolgáltatás látható, amely támogatja az erőforrás-naplókat, és a szolgáltatásra mutató hivatkozásokat, valamint a kategória-specifikus sémát.
