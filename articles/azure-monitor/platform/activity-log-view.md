...
Az az [monitor Activity-log](../samples/cli-samples.md#view-activity-log-for-a-subscription) paranccsal kérheti le a tevékenység naplóját a parancssori felületről. Az alábbiakban néhány gyakori példát talál.
