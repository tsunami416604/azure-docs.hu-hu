...
[Automatikus skálázás a PowerShell használatával kezelheti.](../../monitoring-and-diagnostics/insights-powershell-samples.md#create-and-manage-autoscale-settings)
