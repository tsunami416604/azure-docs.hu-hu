...
- Felülvizsgálat [a Linux-ügynök hibaelhárítási](agent-linux-troubleshoot.md) Ha problémák merülnek fel telepítése vagy a Linux-ügynök felügyelete során.

- Felülvizsgálat [hibaelhárítása a Windows-ügynök](agent-windows-troubleshoot.md) Ha problémák merülnek fel telepítése vagy a Windows-ügynök felügyelete során.
