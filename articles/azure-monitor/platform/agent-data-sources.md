...
![Log Analytics-adatok gyűjtése](./media/agent-data-sources/overview.png)
...
| [Syslog](data-sources-syslog.md) | Linux |&#8226; |  |  |  |  |az Azure storage-ból: 10 perc; ügynök: a beérkezéskor |
