...
Nem ajánlott explicit módon beállítani az ügynököt úgy, hogy csak a TLS 1,2-et használja, kivéve, ha ez nem feltétlenül szükséges, mivel az elérhetővé válik a platform szintű biztonsági funkciók, amelyek lehetővé teszik az új, biztonságosabb protokollok automatikus észlelését és kihasználását, mint például TLS 1,3. 
...
| Változáskövetés |A szoftver leltározása, a Windows-szolgáltatások és a Linux-démon metaadatai, valamint a Windows/Linux-fájlok metaadatainak |
...
| Állami |StateChangeEventId, StateId, NewHealthState, OldHealthState, Context, TimeGenerated, TimeAdded, StateId2, Basemanagedentityid azonosító eltérése, MonitorId, HealthState, LastModified, LastGreenAlertGenerated, DatabaseTimeModified |
...
Regisztrálja az összes ügynököt egy regisztrációs kulccsal, és biztonságos kapcsolatot létesít az ügynök és a Log Analytics szolgáltatás között tanúsítványalapú hitelesítés és SSL használatával az 443-es porton keresztül. A Log Analytics titkos tárolót használ a kulcsok létrehozásához és karbantartásához. A titkos kulcsokat 90 naponta elforgatják, és az Azure-ban tárolják, és azokat az Azure-műveletek kezelik, akik szigorú szabályozási és megfelelőségi eljárásokat követnek.
...
Ha a felügyeleti kiszolgáló bármilyen okból nem tud kommunikálni a szolgáltatással, akkor a Operations Manager felügyeleti csoportnak, amely Log Analyticsba van integrálva, akkor az összegyűjtött adatokat a rendszer a felügyelet ideiglenes gyorsítótárában helyileg tárolja. Server.   Megpróbálják az adatküldés nyolc percenkénti újraküldését két órán keresztül.  A felügyeleti kiszolgálót megkerülő és közvetlenül a Log Analyticsnak elküldő adatműveletek esetén a viselkedés konzisztens a Windows-ügynökkel.  
