...
- VÁLASZ: Valószínűleg nem. Dinamikus küszöbérték jók jelentős eltérések észlelése lassan fejlődő problémák helyett.

- KÉRDÉS: Konfigurálhatja a dinamikus küszöbértékeket egy API-n keresztül?

- VÁLASZ: Dolgozunk rajta.
