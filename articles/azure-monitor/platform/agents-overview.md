...
- A virtuális gépek biztonságának kezelése [Azure Security Center](../../security-center/security-center-introduction.md)  vagy [Azure Sentinel](../../sentinel/overview.md)használatával. (Előzetes verzióban nem érhető el.)
