...
ms.locfileid: "75865037"
---
# <a name="azure-monitor-customer-managed-key-configuration"></a>Azure Monitor ügyfél által felügyelt kulcs konfigurálása 

Ez a cikk a Log Analytics-munkaterületek és a Application Insights-összetevők felhasználói által felügyelt kulcsainak (CMK) konfigurálására szolgáló háttér-információkat és lépéseket ismerteti. A konfigurálást követően a munkaterületekre eljuttatott összes adatfájl titkosítva van a Azure Key Vault kulccsal.
