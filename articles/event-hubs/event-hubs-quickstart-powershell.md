---
title: Azure rövid útmutató – eseménystreamek feldolgozása a PowerShell használatával | Microsoft Docs
description: Ez a rövid útmutató azt ismerteti, hogyan küldhet és fogadhat Azure Event Hubs-eseményeket a PowerShell és egy .NET-mintaalkalmazás használatával.
services: event-hubs
...
ms.locfileid: "40003610"
---
# <a name="quickstart-process-event-streams-using-powershell-and-net-standard"></a>Rövid útmutató: Eseménystreamek feldolgozása a PowerShell és a .NET Standard használatával
