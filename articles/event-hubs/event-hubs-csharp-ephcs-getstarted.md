...
A jelen oktatóanyag bemutatja, hogyan használhatja a klasszikus Azure portált eseményközpont létrehozásához. Bemutatja azt is, hogyan gyűjtheti az üzeneteket az eseményközpontba egy C# nyelven írt konzolalkalmazással, és hogyan kérheti le azokat párhuzamosan a C# [Event Processor Host][] tár használatával.

Az oktatóanyag teljesítéséhez az alábbiakra lesz szüksége:

+ Microsoft Visual Studio 2013 vagy újabb verzió vagy Windowshoz készült Microsoft Visual Studio Express. A jelen cikk példái a Visual Studio 2015-öt használják.
...
1.  Nyomja le az F5 billentyűt a **Fogadó** projekt indításához a Visual Studióból, majd várjon, amíg a projekt elindítja a fogadókat minden egyes partícióra vonatkozóan.

    ![][21]

2.  A **Küldő** projekt automatikusan futni fog. Nyomja le az **Enter** billentyűt a konzolablakban, és láthatja, ahogy az események megjelennek a fogadó ablakban.
