...
5. Navigáljon `azure-event-hubs-for-kafka/quickstart/java/producer/src/main/java/`, és nyissa meg a **TestDataReporter. Java** fájlt egy tetszőleges szerkesztőben. 
