...
1. Kövesse a [HDInsight alatt futó Storm - első lépések](../hdinsight/hdinsight-storm-overview.md) eljárással hozzon létre egy új HDInsight-fürtöt, és a távoli asztalon keresztül kapcsolódni hozzá.
...
10. Hozzon létre egy új osztályt **LoggerBolt** az alábbi kódra:
    ...
    A Storm bolt naplózza a fogadott események a tartalmát. Ez egyszerűen bővíthető rekordokat tárolni egy tároló szolgáltatást. A [HDInsight érzékelő elemzés oktatóanyag] ezt a módszert használja a HBase adatok tárolására.
