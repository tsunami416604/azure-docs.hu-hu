...
如需詳細資訊，請參閱 [Event Hubs overview]。
...
2.  執行 **寄件者** 程式，並查看接收器視窗中出現的事件。

    ![][23]

> [AZURE.NOTE] 本教學課程只在本機模式中使用 Storm 進行開發。 請參閱 [HDInsight Storm overview] 和官方 [Apache Storm] Storm 部署和模式的文件的詳細資訊。
