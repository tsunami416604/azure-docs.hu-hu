...
## <a name="jump-right-in"></a>Jump right in
...
In both quickstarts, you locally create and test a "hello world" durable function. Ezután közzéteheti a függvénykódot az Azure-ban. The function you create orchestrates and chains together calls to other functions.
