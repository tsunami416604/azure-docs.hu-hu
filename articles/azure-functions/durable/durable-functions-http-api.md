...
| Paraméter        | Parameter Type  | Leírás |
|------------------|-----------------|-------------|
...
| Mező              | Parameter type  | Leírás |
|--------------------|-----------------|-------------|
| **`functionName`** | URL-cím             | The name of the orchestrator function to start. |
| **`instanceId`**   | URL-cím             | Optional parameter. The ID of the orchestration instance. If not specified, the orchestrator function will start with a random instance ID. |
| **`{content}`**    | Request content | Választható. The JSON-formatted orchestrator function input. |
...
| Mező                   | Parameter type  | Leírás |
|-------------------------|-----------------|-------------|
| **`instanceId`**        | URL-cím             | The ID of the orchestration instance. |
...
|-----------------------|-----------|-------------|
| **`runtimeStatus`**   | sztring    | The runtime status of the instance. Values include *Running*, *Pending*, *Failed*, *Canceled*, *Terminated*, *Completed*. |
...
| **`createdTime`**     | sztring    | The time at which the instance was created. Uses ISO 8601 extended notation. |
| **`lastUpdatedTime`** | sztring    | The time at which the instance last persisted. Uses ISO 8601 extended notation. |
...
| Mező                  | Data type | Leírás |
|------------------------|-----------|-------------|
| **`instancesDeleted`** | egész szám   | The number of instances deleted. For the single instance case, this value should always be `1`. |
...
| Mező                   | Data type | Leírás |
|-------------------------|-----------|-------------|
| **`instancesDeleted`**  | egész szám   | The number of instances deleted. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL-cím             | The ID of the orchestration instance. |
| **`eventName`**   | URL-cím             | The name of the event that the target orchestration instance is waiting on. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL-cím             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Választható. The reason for terminating the orchestration instance. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL-cím             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Választható. The reason for rewinding the orchestration instance. |
...
| Mező             | Parameter type  | Leírás |
|-------------------|-----------------|-------------|
| **`entityType`**  | URL-cím             | The type of the entity. |
| **`entityKey`**   | URL-cím             | The unique name of the entity. |
| **`op`**          | Query string    | Választható. The name of the user-defined operation to invoke. |
| **`{content}`**   | Request content | The JSON-formatted event payload. |
