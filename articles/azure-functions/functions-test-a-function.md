...
A `ListLogger` osztály a `ILogger` felületet valósítja meg, és a tesztek során az üzenetek belső listáját tárolja.
...
- **Timer_should_log_message**: Ez a teszt létrehoz egy `ListLogger` egy példányát, és átadja egy időzítő függvénynek. A függvény futtatása után a rendszer ellenőrzi, hogy a napló be van-e jelölve, hogy a várt üzenet megtalálható legyen.
