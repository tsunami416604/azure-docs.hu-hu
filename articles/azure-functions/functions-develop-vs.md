...
A Visual Studio lehetővé teszi a C# Class Library-függvények fejlesztését, tesztelését és üzembe helyezését az Azure-ban. Ha ez a felhasználói élmény Azure Functions, akkor a [Azure functions bevezetésével](functions-overview.md)többet is megtudhat.
...
Ez a cikk részletesen ismerteti, hogyan használható a Visual Studio a C# Class Library-függvények fejlesztéséhez és az Azure-ban való közzétételéhez. A cikk elolvasása előtt végre kell hajtania a [Visual Studio functions](functions-create-your-first-function-visual-studio.md)rövid útmutatóját. 
