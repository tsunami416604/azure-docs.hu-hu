...
- **Választható nyelv**: az írási függvények a választott [ C#, a Java, a JavaScript, a Python és a PowerShell](supported-languages.md)használatával.
