...
* Kövesse a "Az Azure Functions Core eszközeinek telepítése" a [kódot és helyileg Azure Functions tesztelése](https://docs.microsoft.com/en-us/azure/azure-functions/functions-run-local)
