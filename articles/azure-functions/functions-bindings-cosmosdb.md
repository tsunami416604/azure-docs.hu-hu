...
> [!NOTE]
> Ez a cikk az Azure Functions 1.x. További információ a kötések használatáról a 2. x függvényekben: [Azure Cosmos db kötések a Azure functions 2. x verzióhoz](functions-bindings-cosmosdb-v2.md).
>
