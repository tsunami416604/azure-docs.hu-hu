...
Íme egy példa a C#-függvény kódjára, amely létrehoz egy statikus [HttpClient](https://msdn.microsoft.com/library/system.net.http.httpclient(v=vs.110).aspx) -példányt:
