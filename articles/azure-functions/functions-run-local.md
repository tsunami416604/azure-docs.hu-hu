...
- From the [Azure Portalra], search for and select **Storage accounts**. 
...
| **`--additional-packages`** | List of packages to install when building native dependencies. Például: `python3-dev libevent-dev`. |
