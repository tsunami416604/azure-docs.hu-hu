---
title: A Java és a Maven használata a függvények közzétételéhez – Azure Functions
...
Módosítsa a könyvtárat az újonnan létrehozott projekt mappájába (amely a Host. JSON és a Pom. xml fájlokat tartalmazza), és hozza létre és futtassa a függvényt a Maven használatával:
...
> [!NOTE] 
> Kotlin-alapú Azure Functions-projektet is létrehozhat az Azure-functions-Kotlin-archetípus használatával. További információért látogasson el a [GitHub-tárházba](https://github.com/microsoft/azure-maven-archetypes/tree/develop/azure-functions-kotlin-archetype) .
