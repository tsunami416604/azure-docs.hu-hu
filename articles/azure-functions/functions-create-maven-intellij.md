---
title: Azure-függvény létrehozása Javával és IntelliJ | Microsoft Docs
...
> [!IMPORTANT]
> A JAVA_HOME környezeti változót a JDK telepítési helyére kell beállítani a cikk lépéseinek elvégzéséhez.
...
1. Az **archetípus hozzáadása** ablakban végezze el a következő mezőket:
    ...
    - _Verzió_: A legújabb **1,22** -es verzió [a központi tárházból](https://mvnrepository.com/artifact/com.microsoft.azure/azure-functions-archetype)
    ![hozzon létre egy Maven-projektet az archetípusból a IntelliJ IDEA használatával](media/functions-create-first-java-intellij/functions-create-intellij.png)  
