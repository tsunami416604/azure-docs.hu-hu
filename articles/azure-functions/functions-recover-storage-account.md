...
Ha ellenőrizni szeretné a kvótát a [Azure Portalban](https://portal.azure.com), válassza a **Platform szolgáltatások** > **függvényalkalmazás beállítások** lehetőséget a Function alkalmazásban. Ha a beállított **napi használati kvótát** használja, a következő üzenet jelenik meg:
