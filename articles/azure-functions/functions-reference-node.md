...
| _sütik_ | A válaszban beállított HTTP cookie-objektumok tömbje. A HTTP-cookie-objektumok `name`, `value`és egyéb cookie-tulajdonságokkal rendelkeznek, például `maxAge` vagy `sameSite`. |
