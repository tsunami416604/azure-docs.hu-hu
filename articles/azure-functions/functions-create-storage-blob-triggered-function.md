...
1. Válassza a **függvények**lehetőséget, majd válassza a **+ Hozzáadás** lehetőséget egy új függvény hozzáadásához.
   ...
   :::image type="content" source="./media/functions-create-storage-blob-triggered-function/function-app-quickstart-choose-template.png" alt-text="A függvényalkalmazás elkészült." border="true":::

1. Válassza ki az **Azure Blob Storage trigger** sablonját.

1. Használja az ábra alatti táblázatban megadott beállításokat.

    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-create-blob-storage-trigger-portal-2.png" alt-text="A függvényalkalmazás elkészült." border="true":::
...
1. A függvény létrehozásához válassza a **create Function** elemet.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-create-blob-storage-trigger-portal-3.png" alt-text="A függvényalkalmazás elkészült." border="true":::
...
1. A függvényben az **Áttekintés** lapon válassza ki az erőforráscsoportot.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-resource-group.png" alt-text="A függvényalkalmazás elkészült." border="true":::

1. Keresse meg és válassza ki az erőforráscsoport Storage-fiókját.

    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-account-access.png" alt-text="A függvényalkalmazás elkészült." border="true":::

1. Válassza a **tárolók**, majd a **+ tároló**elemet. 

    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-add-container.png" alt-text="A függvényalkalmazás elkészült." border="true":::

1. A **név** mezőbe írja be a következőt: `samples-workitems` , majd válassza a **Létrehozás**lehetőséget.

    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-name-blob-container.png" alt-text="A függvényalkalmazás elkészült." border="true":::
...
1. Lépjen vissza a Azure Portalba, és keresse meg a függvényt a lap alján található **naplók** kibontásával, és győződjön meg arról, hogy a naplózási adatfolyam nincs szüneteltetve.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-log-expander.png" alt-text="A függvényalkalmazás elkészült." border="true":::
...
1. Válassza a **tárolók**lehetőséget, majd válassza ki a **Samples-workitems** tárolót.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-container.png" alt-text="A függvényalkalmazás elkészült." border="true":::

1. Válassza a **feltöltés**lehetőséget, majd válassza ki a mappa ikont a feltölteni kívánt fájl kiválasztásához.

    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-manager-upload-file-blob.png" alt-text="A függvényalkalmazás elkészült." border="true":::
...
1. Lépjen vissza a függvény naplóihoz, és győződjön meg arról, hogy megtörtént a blob olvasása.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/function-app-in-portal-editor.png" alt-text="A függvényalkalmazás elkészült." border="true":::
