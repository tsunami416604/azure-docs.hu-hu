...
| Dell SonicWALL                  | TZ 系列，NSA 系列，SuperMassive 系列，E-class NSA 系列 | SonicOS 5.8， [SonicOS 5.9](http://documents.software.dell.com/sonicos/5.9/microsoft-azure-configuration-guide/supported-platforms?ParentProduct=850), ，[SonicOS 6.x](http://documents.software.dell.com/sonicos/6.2/microsoft-azure-configuration-guide/supported-platforms?ParentProduct=646 )          | [指示 SonicOS 6.2](http://documents.software.dell.com/sonicos/6.2/microsoft-azure-configuration-guide?ParentProduct=646) [SonicOS 5.9 指示](http://documents.software.dell.com/sonicos/5.9/microsoft-azure-configuration-guide?ParentProduct=850)                                                                                                                                   | [指示 SonicOS 6.2](http://documents.software.dell.com/sonicos/6.2/microsoft-azure-configuration-guide?ParentProduct=646) [SonicOS 5.9 指示](http://documents.software.dell.com/sonicos/5.9/microsoft-azure-configuration-guide?ParentProduct=850)                                                                                                                                                                                      |
...
1. 使用 [記事本] 開啟範本。 
1. 搜尋和取代所有 <*文字*> 字串置換為適合您環境的值。 務必要包含 < 和 >。 當有指定名稱時，您選取的名稱應該是唯一名稱。 如果命令無法運作，請參閱裝置製造商文件。
...
| &lt;SP_AzureGatewayIpAddress&gt;       | 此資訊專屬於您的虛擬網路，位於管理入口網站中 **閘道 IP 位址**。 |
