...
Ha az adott eszköz nem szerepel az Ellenőrzött VPN-eszközök táblában, tekintse meg a jelen cikk Nem ellenőrzött VPN-eszközök szakaszát. Lehetséges, hogy az eszköz mégis kompatibilis az Azure-ral. A VPN-eszközök támogatásával kapcsolatban lépjen kapcsolatba az eszköze gyártójával.
...
- A Nagy teljesítményű és az útvonalalapú VPN-átjárók specifikációi azonosak, hacsak a szöveg másként nem jelzi. Például az útvonalalapú VPN-átjárókkal kompatibilis, ellenőrzött VPN-eszközök az új Azure Nagy teljesítményű VPN-átjárókkal is kompatibilisek lesznek. 


## Ellenőrzött VPN-eszközök 

Eszközszállítói partnereinkkel különböző standard VPN-eszközöket ellenőriztünk. Az alábbi listában szereplő eszközcsaládokban megtalálható összes eszköz kompatibilis az Azure VPN-átjárókkal. A konfigurálni kívánt megoldáshoz létrehozandó átjárótípus ellenőrzésének lépéseit a [VPN-átjárók](vpn-gateway-about-vpngateways.md) című cikk ismerteti. 
...
| Citrix                          | CloudBridge MPX készülék vagy VPX virtuális készülék       | N/A                                                | [Integrációs utasítások](https://www.citrix.com/welcome.html?resource=%2Fdownloads%2Fcloudbridge%2Fbetas-and-tech-previews%2Fcloudbridge-azure-integration)                                                                                                                                                                            | Nem kompatibilis                                                                                                                                                                                               |
...
| Fortinet                        | FortiGate                                                | FortiOS 5.0.7                                      | [Konfigurációs utasítások](http://docs.fortinet.com/fortigate/admin-guides)                                                                                                                                                                          | [Konfigurációs utasítások](http://docs.fortinet.com/fortigate/admin-guides)                                                                                                                                  |
...
>[AZURE.NOTE] Bár az Azure VPN Gateway támogatja az alább felsorolt értékeket, adott kombinációk megadására és kiválasztására jelenleg nincs lehetőség az Azure VPN Gateway átjárón. Az esetleges korlátozásokat a helyszíni VPN-eszközről kell megadni.
...
Az IPsec SA titkosítási és hitelesítési ajánlatok az alábbi táblában vannak felsorolva. Az ajánlatok prioritási sorrendben vannak felsorolva a választáshoz.
