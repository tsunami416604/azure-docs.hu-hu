...
# Első lépések
## [Tervezés és kialakítás](vpn-gateway-plan-design.md)
## [Beállítások](vpn-gateway-about-vpn-gateway-settings.md)
## [Helyek közötti kapcsolatokhoz tartozó VPN-eszközök](vpn-gateway-about-vpn-devices.md)
# [BGP és VPN-átjáró](vpn-gateway-bgp-overview.md)
## [Magas rendelkezésre állású kapcsolatok](vpn-gateway-highlyavailable.md)
...
#### [Klasszikus portál](vpn-gateway-site-to-site-create.md)
### Pont–hely kapcsolat
### [Azure Portal](vpn-gateway-howto-point-to-site-resource-manager-portal.md)
#### [(Klasszikus) Azure Portal](vpn-gateway-howto-point-to-site-classic-azure-portal.md)
#### [PowerShell](vpn-gateway-howto-point-to-site-rm-ps.md)
#### [Klasszikus portál](vpn-gateway-point-to-site-create.md)
### Virtuális hálózatok közötti kapcsolat
#### [Azure Portal](vpn-gateway-howto-vnet-vnet-resource-manager-portal.md)
#### [PowerShell](vpn-gateway-vnet-vnet-rm-ps.md)
#### [Klasszikus portál](virtual-networks-configure-vnet-to-vnet-connection.md)
### Különböző üzemi modellek virtuális hálózatai közötti kapcsolat
...
## [Pont–hely típusú kapcsolatokhoz tartozó önaláírt tanúsítványok kezelése](vpn-gateway-certificates-point-to-site.md)
