---
title: 'BGP és Azure VPN-átjáró: áttekintés'
...
---
# <a name="about-bgp-with-azure-vpn-gateway"></a>A BGP és az Azure VPN-átjáró
Ez a cikk áttekintést nyújt a BGP (Border Gateway Protocol) támogatásaz Azure VPN Gateway.
...
Nagyobb előtagokat is hirdethet, amelyek tartalmazhatnak néhány virtuális hálózati címelőtagot, például egy nagy privát IP-címteret (például 10.0.0.0/8). Vegye figyelembe, hogy az előtagok nem lehetnek azonosak a virtuális hálózat egyik előtagával sem. A rendszer elutasítja a virtuális hálózat előtagjaival azonos útvonalakat.
