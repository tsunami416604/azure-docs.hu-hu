...
## <a name="S2S"></a>Helyek közötti VPN-átjáró törlése
...
## <a name="deletep2s"></a>Pont – hely típusú VPN-átjáró törlése
...
## <a name="delete"></a>VPN-átjáró törlése az erőforráscsoport törlésével
