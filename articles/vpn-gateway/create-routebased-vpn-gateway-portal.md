...
description: Ismerje meg, hogyan hozhat létre egy Route-alapú Azure VPN Gateway-átjárót a Azure Portal használatával. A helyszíni hálózathoz való csatlakozáshoz használjon VPN-átjárót.
