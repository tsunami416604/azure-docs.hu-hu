...
description: A PowerShell használatával hozzon létre egy Route-alapú VPN-átjárót, és konfigurálja a VPN-eszközt a helyek közötti kapcsolat hozzáadásához.
