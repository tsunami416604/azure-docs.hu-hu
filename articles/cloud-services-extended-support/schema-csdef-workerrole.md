---
title: Azure Cloud Services (bővített támogatás) def. WorkerRole séma | Microsoft Docs
description: A Cloud Services feldolgozói szerepkör sémájával kapcsolatos információk (kiterjesztett támogatás)
ms.topic: article
...
ms.locfileid: "98744493"
---
# <a name="azure-cloud-services-extended-support-definition-workerrole-schema"></a>Azure Cloud Services (bővített támogatás) definíciós WorkerRole séma
...
|vmsize|sztring|Választható. Állítsa be ezt az értéket a szerepkörhöz kiosztott virtuális gép méretének módosításához. Az alapértelmezett érték `Small`. A lehetséges virtuálisgép-méretek és azok attribútumainak listáját lásd: [Cloud Services virtuális gépek méretei](available-sizes.md).|
