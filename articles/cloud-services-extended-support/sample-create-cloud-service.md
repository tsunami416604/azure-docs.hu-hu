---
title: Azure PowerShell-minták – Azure-felhőszolgáltatás (kiterjesztett támogatás) létrehozása
description: Példák az Azure Cloud Service (bővített támogatás) üzembe helyezéséhez szükséges parancsfájlok létrehozására
ms.topic: sample
...
## <a name="create-new-cloud-service-with-single-role"></a>Új felhőalapú szolgáltatás létrehozása egyetlen szerepkörrel
...
## <a name="create-new-cloud-service-with-single-role-and-remote-desktop-extension"></a>Új felhőalapú szolgáltatás létrehozása egyetlen szerepkörrel és távoli asztali bővítménnyel
...
## <a name="create-a-cloud-service-with-a-single-role-and-windows-azure-diagnostics-extension"></a>Felhőalapú szolgáltatás létrehozása egyetlen szerepkörrel és Windows Azure Diagnostics bővítménnyel
...
-ExtensionProfileExtension $extension
```
## <a name="create-new-cloud-service-with-single-role-and-certificate-from-key-vault"></a>Új felhőalapú szolgáltatás létrehozása egyetlen szerepkörrel és tanúsítvánnyal Key Vault
...
## <a name="create-new-cloud-service-with-multiple-roles-and-extensions"></a>Új felhőalapú szolgáltatás létrehozása több szerepkörrel és bővítménnyel
