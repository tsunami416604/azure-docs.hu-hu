...
如需有關 CHAP，以及如何設定您的 StorSimple 解決方案的詳細資訊，請移至 [StorSimple 裝置設定 CHAP](storsimple-configure-chap.md)。
...
- [匯入憑證的 cmdlet](https://technet.microsoft.com/library/hh848630.aspx)
