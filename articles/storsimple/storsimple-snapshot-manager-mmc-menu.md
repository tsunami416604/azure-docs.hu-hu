...
在 StorSimple Snapshot Manager 中，您會看到下列所有動作功能表和所有各種所列的動作 **動作** 窗格。 
...
您可以使用 **檢視** 選項來變更 **結果** 窗格檢視及變更主控台視窗檢視。 

#### 若要變更 [結果] 窗格檢視

1. 按一下桌面圖示，以啟動 StorSimple Snapshot Manager。

2. 在 **範圍** ] 窗格中，以滑鼠右鍵按一下任何節點，或展開節點，然後以滑鼠右鍵按一下中的項目 **結果** ] 窗格中，然後再按一下 **檢視** 選項。 

3. 若要新增或移除資料行中出現的 **結果** ] 窗格中，按一下 [ **新增/移除資料行**。  **新增/移除資料行** ] 對話方塊隨即出現。

    ![新增或移除 [結果] 窗格中的資料行](./media/storsimple-snapshot-manager-mmc-menu/HCS_SSM_Add_remove_columns.png) 

4. 完成表單，如下所示：

    - 選取項目從 **可用** 資料行清單中，按一下 **新增** 將其新增至 **顯示資料行** 清單。 

    - 按一下項目 **顯示資料行** 清單，然後按 **移除** 若要從清單中移除。 

    - 選取的項目中 **顯示** 資料行清單中，按一下 **移** 或 **下移** 清單中向上或向下移動項目。 

    - 按一下 [ **還原成預設值** 回到預設 **結果** 窗格組態。 
...
3. 選取或清除核取方塊，以顯示或隱藏主控台視窗中的項目。 當您完成所做的選擇，請按一下 **確定**。
...
2. 在 **範圍** ] 窗格中，以滑鼠右鍵按一下任何節點，以及 [ **從這裡開啟新視窗**。 

    新的視窗隨即出現，僅顯示您所選取的範圍。 例如，如果您以滑鼠右鍵按一下 **備份原則** 節點中，新的視窗只會顯示 **備份原則** 中的節點 **範圍** 窗格以及一份定義備份原則 **結果** 窗格。 請參閱下列範例。
...
2. 在 **範圍** ] 窗格中，以滑鼠右鍵按一下任何節點，或展開節點，然後以滑鼠右鍵按一下中的項目 **結果** ] 窗格中，然後再按一下 **重新整理**。 

## 匯出清單

您可以使用 **匯出清單** 動作，將清單儲存為逗點分隔值 (CSV) 檔案。 例如，您可以匯出備份原則清單或備份目錄。 然後，您可以將 CSV 檔案匯入試算表應用程式進行分析。

#### 若要將清單儲存為逗號分隔值 (CSV) 檔案

1. 按一下桌面圖示，以啟動 StorSimple Snapshot Manager。 

2. 在 **範圍** ] 窗格中，以滑鼠右鍵按一下任何節點，或展開節點，然後以滑鼠右鍵按一下中的項目 **結果** ] 窗格中，然後再按一下 **匯出清單**。 

3.  **匯出清單** ] 對話方塊隨即出現。 完成表單，如下所示： 

    1. 在 **檔案名稱** 方塊中，輸入 CSV 檔案的名稱或按一下箭頭以從下拉式清單中選取。

    2. 在 **檔案類型** 方塊中，按一下箭號，並從下拉式清單中選取檔案類型。

    3. 若要只儲存選取的項目，選取資料列，然後按一下 [ **只儲存選取的列** 核取方塊。 若要儲存所有匯出的清單，請清除 **只儲存選取的列** 核取方塊。
...
您可以使用 **協助** 功能表來檢視 StorSimple Snapshot Manager 和 MMC 的可用線上說明。

#### 若要檢視可用的線上說明

1. 按一下桌面圖示，以啟動 StorSimple Snapshot Manager。

2. 在 **範圍** ] 窗格中，以滑鼠右鍵按一下任何節點，或展開節點，然後以滑鼠右鍵按一下中的項目 **結果** ] 窗格中，然後再按一下 **協助**。 
