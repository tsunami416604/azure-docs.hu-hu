...
6. Az **eszközbeállítások** lapon:
   ...
   2. A létrehozandó eszköz **típusához** kattintson a **fájlkiszolgáló** ikonra ![](./media/storsimple-virtual-array-deploy3-fs-setup/image6.png). A fájlkiszolgálók lehetővé teszik a megosztott mappák létrehozását.
...
9. (Opcionálisan) konfigurálja a webproxy-kiszolgálót. Bár a webproxy konfigurációja nem kötelező, vegye figyelembe, hogy ha webproxyt használ, akkor csak itt konfigurálható.
   ...
   1. Adja meg a **webproxy URL-címét** a következő formátumban: *http://&lt;gazdagép-IP-cím vagy teljes tartománynév&gt;:P ORT száma*. Vegye figyelembe, hogy a HTTPS URL-címek nem támogatottak.
...
1. Nyomja meg az ![](./media/storsimple-virtual-array-deploy3-fs-setup/image22.png) + R billentyűt. A futtatási ablakban adja meg az  *&#92; &#92; elérési út&lt;fájlkiszolgáló&gt;nevét* , a fájlkiszolgáló nevét pedig a fájlkiszolgálón hozzárendelt eszköznév helyett. Kattintson az **OK** gombra.
