...
7. (Opcionálisan) konfigurálja a webproxy-kiszolgálót. Bár a webproxy konfigurációja nem kötelező, vegye figyelembe, hogy ha webproxyt használ, akkor csak itt konfigurálható.
