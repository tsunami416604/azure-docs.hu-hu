...
2. 按一下 [完成裝置設定]****。 這會啟動 [設定裝置精靈]。
    ...
    ![在 ](./media/storsimple-virtual-device/StorSimple_CompleteDeviceSetupSVA1M.png)
...
![段影片提供](./media/storsimple-virtual-device/Video_icon.png) **段影片提供**
...
- 在 [裝置]**** 頁面上，選取您需要容錯移轉的裝置，然後按一下 [容錯移轉]****，以開啟 [裝置容錯移轉精靈]。
...
若要管理您的虛擬裝置，請參閱詳細的清單中的工作流程 [管理 StorSimple 裝置使用 StorSimple Manager 服務](storsimple-manager-service-administration.md#administer-storsimple-device-using-storsimple-manager-service)。
