...
| 建立備份原則 | 執行下列其中一項:<ul><li>以滑鼠右鍵按一下 **備份原則**。</li><li>按一下或展開 **磁碟區群組**, ，然後以滑鼠右鍵按一下磁碟區群組。</li><li>按一下或展開 **備份類別目錄**, ，然後以滑鼠右鍵按一下磁碟區群組。</li></ul> | 按一下 [ **建立備份原則** 設定排定的備份磁碟區群組。 |
...
| 編輯 | 按一下 [ **備份原則**, ，然後以滑鼠右鍵按一下原則中的 **結果** 窗格。 | 按一下 [ **編輯** 變更磁碟區群組的備份排程。 |
