...
| Nyílt |Egy meglévő konzol megnyitásához kattintson a **Megnyitás** gombra. |
...
| Exit |Kattintson a **Kilépés** gombra a **fájl** menü bezárásához. |
...
| Segítség |Kattintson bármelyik csomópontra vagy eredményre. (Ez az elem megjelenik az összes **művelet** menük és **műveletek** ablaktáblán.) |Kattintson a **Súgó** lehetőségre az online súgó megnyitásához egy külön böngészőablakban. |
