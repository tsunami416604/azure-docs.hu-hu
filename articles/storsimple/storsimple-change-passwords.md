...
Azure 傳統入口網站 **設定** 頁面包含您可以重新設定 StorSimple Manager 服務管理 StorSimple 裝置的所有裝置參數。 本教學課程說明如何使用 **設定** 頁面來變更 StorSimple Snapshot Manager 或裝置系統管理員密碼。
...
1. 在傳統入口網站中，按一下 [ **裝置** > **設定** 為您的裝置。

2. 向下捲動至 **StorSimple Snapshot Manager** 一節。 輸入 14 或 15 個字元的密碼。 請確定密碼包含大寫、小寫、數字和特殊字元的組合。
...
2. 向下捲動至 **裝置系統管理員密碼** 一節。 提供含有 8 到 15 個字元的系統管理員密碼。 密碼必須是大寫、小寫、數字和特殊字元的組合。
