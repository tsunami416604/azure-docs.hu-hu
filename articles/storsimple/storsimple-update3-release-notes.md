...
| 15 |Az Azure PowerShell-parancsmagok és a helyileg rögzített kötetek |Nem hozható létre egy helyileg rögzített kötet Azure PowerShell-parancsmagok használatával. (Azure PowerShell használatával hoz létre kötet lesz helyezhető el.) Továbbá ne használja az Azure PowerShell-parancsmagok módosítsa a tulajdonságokat a helyileg rögzített kötet, mert a kötet típusa módosítása nemkívánatos hatásának a rétegzett. |Mindig használja a StorSimple Manager szolgáltatás módosíthatók a helyileg rögzített kötetekhez.  |Igen |Nem |
