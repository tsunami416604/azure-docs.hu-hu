...
| Frissítse a 1,0-es vagy újabb verziót, és az eszköz online állapotú.| Nincs szükség műveletre.                                       |
...
1. A **StorSimple Eszközkezelő**válassza a **felügyeleti &gt;** **kulcsok**lehetőséget.
