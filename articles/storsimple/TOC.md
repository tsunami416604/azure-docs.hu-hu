...
#### [A StorSimple-höz készült Windows PowerShell használata](storsimple-8000-windows-powershell-administration.md)
...
#### [A StorSimple-höz készült Windows PowerShell használata](storsimple-windows-powershell-administration.md)
...
#### [A 4-es frissítés telepítése – aktuális (Azure Portal)](storsimple-8000-install-update-4.md)

#### [A 4-es frissítés telepítése (klasszikus)](storsimple-install-update-4.md)
