...
| [步驟 3: 設定和註冊裝置，透過 Windows PowerShell for StorSimple](#step-3-configure-and-register-the-device-through-windows-powershell-for-storsimple)| 將裝置連接到您的網路，並向 Azure 使用管理服務安裝程式。|
