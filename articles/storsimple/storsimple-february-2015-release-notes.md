...
>[AZURE.IMPORTANT]   
>
> -使用 StorSimple Manager 服務和非 Windows PowerShell for StorSimple 來安裝 2 月更新。   
> -花大約一小時來安裝此更新。 不過，如果您要安裝累積更新，可能需要約 3 個小時才能完成程序。  
...
- 請確定控制器 0 與控制器 1 兩者的固定 IP 都可路由，並可以連線到網際網路用來提供更新裝置的服務。 您可以使用 [Test-connection cmdlet](https://technet.microsoft.com/library/hh849808.aspx) 偵測的網路，例如 outlook.com，以確認控制器有能力連線到外部網路外的已知的位址。
