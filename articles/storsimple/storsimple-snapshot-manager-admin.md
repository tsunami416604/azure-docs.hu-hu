...
| 建立備份原則 <br>編輯備份原則<br>刪除備份原則 | [使用 StorSimple Snapshot Manager 來建立和管理備份原則](storsimple-snapshot-manager-manage-backup-policies.md) |
| 檢視及管理排程的備份工作<br>檢視和管理最近的備份工作<br>檢視和管理目前正在執行備份工作 | [使用 StorSimple Snapshot Manager 來檢視和管理備份作業](storsimple-snapshot-manager-manage-backup-jobs.md) |
| 還原磁碟區<br>複製磁碟區或磁碟區群組<br>刪除備份<br>復原檔案<br>還原 StorSimple Snapshot Manager 資料庫| [使用 StorSimple Snapshot Manager 來管理備份目錄](storsimple-snapshot-manager-manage-backup-catalog.md) |
