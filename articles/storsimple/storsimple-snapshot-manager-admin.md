...
| Használja az StorSimple Snapshot Managerban található általános MMC-funkciókat:<ul><li>Megtekintés</li><li>Új ablak innen</li><li>Frissítés</li><li>Exportálási lista</li><li>Segítség</li></ul> |[Használja az MMC menü műveleteit a StorSimple Snapshot Manager](storsimple-snapshot-manager-mmc-menu.md) |
