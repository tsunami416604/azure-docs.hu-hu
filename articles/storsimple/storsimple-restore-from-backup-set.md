...
2. 選取備份組，如下所示：
  ...
  3. 指定時間範圍。
  4. 按一下核取圖示 ![核取圖示](./media/storsimple-restore-from-backup-set/HCS_CheckIcon.png) 若要執行此查詢。
...
7. 檢閱還原資訊，然後按一下核取圖示 ![核取圖示](./media/storsimple-restore-from-backup-set/HCS_CheckIcon.png)。 這將會初始還原工作，您可以藉由存取檢視 **工作** 頁面。 

8. 還原完成之後，您可以確認磁碟區的內容已由備份的磁碟區所取代。

![可用的視訊](./media/storsimple-restore-from-backup-set/Video_icon.png) **可用的視訊**
