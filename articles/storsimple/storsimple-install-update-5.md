---
title: "Frissítés 5 StorSimple 8000 series eszköz klasszikus portál telepítése |} Microsoft Docs"
description: "Ismerteti a StorSimple 8000 Series Update 5 telepíthető a StorSimple 8000 series eszköz a klasszikus portálon."
services: storsimple
...
> * Ha egy 3. frissítés előtti verziót futtatja, javasoljuk, hogy a gyorsjavítások a módszerrel telepítse frissítés 5. Végigvezeti Önt a frissítési támogatása érdekében [egy támogatási jegy jelentkezzen](storsimple-8000-contact-microsoft-support.md).
> * Ha a frissítés 3 futtatja, és később, azt javasoljuk, hogy telepítse a szoftver- és egyéb rendszeres frissítéseket, a klasszikus Azure portálon keresztül. Attól függően, a verzióra frissít, a, a frissítések órát is igénybe vehet 4 (vagy újabb) telepítéséhez. A karbantartási mód frissítéseket telepíteni kell az eszköz a Windows PowerShell felületén keresztül. Karbantartási mód frissítések zavaró frissítések érhetők el, mert ezek eredményez le egyszerre az eszközhöz.
...
## <a name="install-update-5-via-the-azure-classic-portal"></a>5. frissítésétől telepítése a klasszikus Azure portálon keresztül
...
* A karbantartási mód frissítések letöltése a felsorolt lépéseket követve [gyorsjavítások letöltése](#to-download-hotfixes) keresését, és töltse le a KB4037263, mely telepíti lemez belső vezérlőprogram-frissítésekre (a más frissítések már telepítve kell lennie mostanra). Kövesse a felsorolt lépéseket [telepítse, és ellenőrizze a karbantartási mód gyorsjavítások](#to-install-and-verify-maintenance-mode-hotfixes) a karbantartási mód telepítendő frissítések.
...
> [!NOTE]
> 5. frissítésétől telepítése az ajánlott módszer van a klasszikus Azure portálon keresztül. Azonban ha egy 3. frissítés előtti verziót futtatja, javasoljuk, hogy ezt a módszert frissítés 5 telepítéséhez. Ezt az eljárást is kell használni, ha az átjáró ellenőrzése sikertelen, a klasszikus Azure portálon keresztül frissítések telepítése közben. Az ellenőrzés sikertelen lesz, ha egy nem DATA 0 hálózati adapterén rendelt átjáró és az eszköz frissítése 1-nél korábbi szoftver verziót futtat.
