...
[AZURE。重要] 刪除服務之後，無法還原作業。 使用服務的任何裝置在可以搭配另一個服務使用之前，都必須恢復出廠預設值。 在此案例中，裝置上的本機資料以及組態將會遺失。
...
1. 按一下核取圖示 ![核取圖示](./media/storsimple-manage-service/HCS_CheckIcon.png) 關閉此對話方塊。
