...
## <span id="CreateRubyApp"></span></a>Create a Ruby Application

Create a Ruby application. For instructions,
see [Create a Ruby Application on Azure][Create a Ruby Application on Azure].

## <span id="ConfigAccessStorage"></span></a>Configure Your Application to Access Storage
...
## <span id="SetupStorageConnection"></span></a>Setup an Azure Storage Connection
...
You can just modify the **create\_container()** call to pass the **:public\_access\_level** option:
...
## <span id="DownloadBlobs"></span></a>How To: Download Blobs
