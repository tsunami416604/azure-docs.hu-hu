...
* [Microsoft Q&egy kérdés oldal](https://docs.microsoft.com/answers/topics/azure-spring-cloud.html)
* [Java Spring Cloud webhely](https://spring.io/)
* [Rugós keretrendszer](https://cloud.spring.io/spring-cloud-azure/)
* [A Spring használata az Azure-ban](https://docs.microsoft.com/azure/developer/java/spring-framework/)
