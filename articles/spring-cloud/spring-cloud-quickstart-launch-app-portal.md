...
Ez a rövid útmutató bemutatja, hogyan helyezhet üzembe egy meglévő Spring Cloud-alkalmazást az Azure-ban. [Itt látható](https://github.com/xscript/PiggyMetrics) az oktatóanyagban használt minta alkalmazás kódjára mutató hivatkozás. Ha elkészült, a megadott minta alkalmazás elérhető lesz az interneten, és készen áll a Azure Portalon keresztül történő felügyeletre.
...
1. Az alkalmazások üzembe helyezésének befejezése néhány percet vesz igénybe. Annak ellenőrzéséhez, hogy telepítve vannak-e, nyissa meg az **alkalmazás irányítópultját** a Azure Portal. A három alkalmazás sorát kell látnia.
