...
Lépjen a Azure Portal **Key Vault** irányítópultra, kattintson a **hozzáférés-vezérlés** menüre, majd nyissa meg a **szerepkör-hozzárendelések** lapot. a **hatókör** **típusához** és `This resource` válassza az **alkalmazások** lehetőséget.  Ekkor meg kell jelennie az előző lépésben létrehozott hitelesítő adatoknak:

 ![Hozzáférési szabályzat beállítása](./media/github-actions/key-vault1.png)

Másolja a hitelesítő adat nevét (például `azure-cli-2020-01-19-04-39-02`). Nyissa meg a **hozzáférési házirendek** menüt, kattintson a **+ hozzáférési házirend hozzáadása** hivatkozásra.  Válassza a **sablon**`Secret Management` lehetőséget, majd válassza a **rendszerbiztonsági tag**lehetőséget. Illessze be a hitelesítő adat nevét az **elsődleges**/válassza a beviteli mező **elemet** :
