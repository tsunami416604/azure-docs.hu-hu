...
ms.locfileid: "90936293"
---
# <a name="defender-for-iot-customizable-security-alerts"></a>Defender for IoT – testreszabható biztonsági riasztások
...
A IoT-riasztások következő listáját a várt IoT Hub és/vagy az eszköz viselkedése alapján meghatározhatja. Az egyes riasztások testreszabásával kapcsolatos további információkért lásd: [egyéni riasztások létrehozása](quickstart-create-custom-alerts.md).
