...
Az Azure RTOS biztonsági modulja ingyenes letöltést biztosít az eszközei számára. A IoT Cloud Service-hez készült Defender az Azure-előfizetések esetében 30 napos próbaidőszakot biztosít. Az első lépésekhez töltse le az [Azure RTOS biztonsági modulját](https://github.com/MicrosoftDocs/azure-docs/blob/master/articles/defender-for-iot/iot-security-azure-rtos.md) . 
