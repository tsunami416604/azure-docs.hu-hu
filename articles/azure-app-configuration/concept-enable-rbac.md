...
1. A rendszerbiztonsági tag identitása hitelesítve van, és a rendszer OAuth 2,0 tokent ad vissza.  A jogkivonatot `https://login.microsoftonline.com/{tenantID}` kérő erőforrás neve `{tenantID}` megegyezik azzal a Azure Active Directory bérlői azonosítóval, amelyhez az egyszerű szolgáltatásnév tartozik.
