...
Az alábbi parancs vagy [Azure Portal](/azure/storage/common/storage-auth-aad-rbac-portal#assign-rbac-roles-using-the-azure-portal) használatával biztosíthatja az Azure függvényalkalmazás hozzáférését a tárolási sorhoz. 
