...
如果您的專案已設定為使用 Gradle 來建置，加入下列幾行，其中 `相依性` build.gradle 檔案中的群組:
...
----|----|----
 ...
 Log4j v1.2| [具有 Log4J v1.2 附加器的 SDK](http://dl.windowsazure.com/applicationinsights/javabin/log4j1_2Appender.zip)| applicationinsights-logging-log4j1_2
...
既然您已設定為傳送追蹤至 Application Insights 專案，您可以檢視和搜尋這些追蹤是否有在 Application Insights 入口網站中 [診斷搜尋 ][diagnostic] 刀鋒視窗。
