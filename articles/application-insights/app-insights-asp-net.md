...
# Az Application Insights beállítása az ASP.NET-webhelyhez
...
## 3. lépés: A telemetria megtekintése
...
### Telemetria megtekintése a Visual Studióban
...
### Telemetria megtekintése a webportálon
...
## 4. lépés: Az alkalmazás közzététele
