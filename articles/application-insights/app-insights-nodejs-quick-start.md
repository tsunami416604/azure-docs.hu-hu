...
Ha nem rendelkezik Node.js-webalkalmazással, a létrehozásához követheti a [Node.js-webalkalmazások létrehozásához készült útmutató](https://docs.microsoft.com/en-us/azure/app-service/app-service-web-get-started-nodejs) utasításait.
...
3. Módosítsa az alkalmazás első .js-fájlját, és adja hozzá az alábbi két sort a szkript legtetejéhez. A [Node.js rövid útmutatójában található alkalmazás](https://docs.microsoft.com/en-us/azure/app-service/app-service-web-get-started-nodejs) használata esetén az index.js fájlt kell módosítania. 
