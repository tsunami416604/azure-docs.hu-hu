...
* [Azure webalkalmazások és virtuális gépek](app-insights-azure-web-apps.md)
...
## <a name="a-nameprojectsa-build-your-own-sdk"></a><a name="projects"></a> Saját SDK kialakítása
