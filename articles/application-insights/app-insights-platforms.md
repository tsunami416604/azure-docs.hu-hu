...
+ [ASP.NET 的即時應用程式](app-insights-monitor-performance-live-website-now.md)
+ [ASP.NET 5](app-insights-asp-net-five.md)
+ [Android](https://github.com/Microsoft/ApplicationInsights-Android)
+ [Azure web 應用程式和 Vm](../insights-perf-analytics.md)
+ [Azure 雲端服務](app-insights-cloudservices.md)& #151，包括 web 和背景工作角色
+ [從 Microsoft Dynamics CRM Online](app-insights-sample-mscrm.md)
+ [iOS](https://github.com/Microsoft/ApplicationInsights-iOS)
+ [J2EE](app-insights-java-get-started.md)
+ [J2EE-已即時應用程式](app-insights-java-live.md)
...
+ [實體](https://github.com/fidmor89/appInsights-Concrete)
...
+ [資料流分析](app-insights-export-power-bi.md)
