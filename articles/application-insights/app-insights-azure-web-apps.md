...
* Az [Application Insights JavaScript-alkalmazásokhoz és weblapokhoz](app-insights-web-track-usage.md) való használatával ügyféltelemetriát kaphat azoktól a böngészőktől, amelyek ellátogatnak egy weblapra.
