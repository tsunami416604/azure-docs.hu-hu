...
> [AZURE.NOTE] 在此頁面上的程序會將 SDK 加入您的 web 應用程式在執行階段。 如果您不想要更新或重建您的原始程式碼，這會非常好用。 但如果可以的話，我們建議您 [將 SDK 加入原始程式碼](app-insights-java-get-started.md) 改。 這樣可以提供您更多選項，包括撰寫程式碼來追蹤使用者活動。
