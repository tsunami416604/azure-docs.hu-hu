<properties 
    pageTitle="Trendek elemzése a Visual Studióban | Microsoft Azure" 
...
# Trendek elemzése a Visual Studióban

Az Application Insights Trends eszköze megjeleníti alkalmazása fontos telemetria-eseményeinek időbeli változásait, ezzel segítve a problémák és hibák gyors azonosítását. Azáltal, hogy részletesebb diagnosztikai információhoz ad hozzáférést, a Trends segíthet az alkalmazás teljesítményének növelésében, a kivételek okának megtalálásában, valamint az egyéni eseményeire vonatkozó háttérismeretek feltárásában.

![Példa a Trends ablakára](./media/app-insights-visual-studio-trends/app-insights-trends-hero-750.png)

> [AZURE.NOTE] Az Application Insights Trends elérhető a Visual Studio 2015 Update 3 vagy újabb verzióban, vagy a [Developer Analytics Tools bővítmény](https://visualstudiogallery.msdn.microsoft.com/82367b81-3f97-4de1-bbf1-eaf52ddc635a) 5.209-es és újabb verziójában.

## Az Application Insights Trends megnyitása
...
## Trendek megjelenítése az alkalmazásban
...
4. Ismételje meg a folyamatot a trendek kimutatásához a telemetria adott alkészleteiben. Megkeresheti például a „GET Home/Index” nevű _és_ Németországból érkezett _és_ 500-as válaszkóddal rendelkező kiszolgálókérelmeket. 
...
> [AZURE.TIP] A rendellenességek kiemelése különösen hasznos kis buborékok idősorozataiban található kiugró értékek kimutatásához, amelyek máskülönben ugyanakkora méretűnek tűnnének.  
