...
* [Hozzon létre egy Application Insights-erőforrást](app-insights-create-new-resource.md) az [Azure Portalon](https://portal.azure.com). Az alkalmazás típusánál válassza **általános**.
...
További információkért lásd: [konfigurációs fájl ismertetése](app-insights-configuration-with-applicationinsights-config.md).
...
* [Függőségek figyelése](app-insights-asp-net-dependencies.md) megtekintheti, ha a REST, SQL és más külső erőforrások okoznak lassulást.
