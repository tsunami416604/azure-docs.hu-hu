...
![Kattintson a jobb gombbal a projektre, és válassza az Application Insights, nyissa meg.](./media/app-insights-asp-net-exceptions/34.png)
...
![Kivétel részleteit tartalmazó panel](./media/app-insights-asp-net-exceptions/ExceptionDetailsBlade.png)
...
![Hibák megtekintése (Kivételek lapon) osztályozása](./media/app-insights-asp-net-exceptions/FailuresTriageView_Exceptions.png)
...
* [A TrackEvent()](app-insights-api-custom-events-metrics.md#trackevent) általában szolgál a használati mintákat, figyelés, de az adatok is elküldi a diagnosztikai keresésben megjelenik egyéni eseményeket. Nevesített eseményeket és a karakterlánc-tulajdonságok és numerikus metrikák, amelyen is képes továbbítani [szűrése a diagnosztikai keresésben](app-insights-diagnostic-search.md).
* [TrackTrace()](app-insights-api-custom-events-metrics.md#tracktrace) hosszabb adatok, például a POST információk elküldését teszi lehetővé.
* [TrackException()](#exceptions) veremkiíratásokat küld. [További tudnivalók a kivételek](#exceptions).
* Ha már használ egy naplózási keretrendszert, például a Log4Net, NLog, vagy, [ezeket a naplókat rögzítése](app-insights-asp-net-trace-logs.md) és megtekintheti őket a kérések és kivételek adatok mellett a diagnosztikai keresésben.

Ezek az események megtekintéséhez nyissa meg a [keresési](app-insights-diagnostic-search.md), nyissa meg a szűrőt, és válassza a egyéni esemény, nyomkövetési vagy kivétel.

![Áthatoló részletezést](./media/app-insights-asp-net-exceptions/viewCustomEvents.png)
...
A tulajdonságok és a mértékek paraméterek megadása nem kötelező, de hasznos [szűrési és hozzáadása](app-insights-diagnostic-search.md) további információt. Például ha egy alkalmazás futtatható a több játékok, található egy adott játék kapcsolódó összes kivétel jelentést. Hozzáadhat elemeket a szótárakat tetszés szerint.
...
Ha rendelkezik [telepítve van az Application Insights-ügynökkel](app-insights-monitor-performance-live-website-now.md) egy grafikont a kivételek száma, a .NET-mért kap a kiszolgálón. Ez magában foglalja a kezelt és a nem kezelt .NET-kivételeket.
...
* [Megfigyelheti az oldalbetöltési időket, a böngészőkivételek és AJAX-hívások](app-insights-javascript.md)
* [A figyelő teljesítményszámlálók](app-insights-performance-counters.md)
