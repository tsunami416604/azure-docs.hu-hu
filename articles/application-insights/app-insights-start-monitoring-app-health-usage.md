...
![Példa teljesítményfigyelő diagramokra](./media/app-insights-start-monitoring-app-health-usage/10-perf.png)
...
![Kattintson az Új, majd az Application Insights lehetőségre](./media/app-insights-start-monitoring-app-health-usage/01-new-asp.png)
...
![Kattintson a Tulajdonságok elemre, válassza ki a kulcsot, és nyomja le a ctrl+C billentyűkombinációt.](./media/app-insights-start-monitoring-app-health-usage/02-props-asp.png)
...
1. Visual Studióban szerkessze a webalkalmazási projekt NuGet-csomagjait.
    ...
    ![Kattintson a jobb gombbal a projektre, és válassza a Manage Nuget Packages (NuGet-csomagok kezelése) lehetőséget](./media/app-insights-start-monitoring-app-health-usage/03-nuget.png)

2. Az Application Insights SDK telepítése a webalkalmazásokhoz

    ![Az „Application Insights” kifejezés keresése](./media/app-insights-start-monitoring-app-health-usage/04-ai-nuget.png)
...
## <a name="run"></a> 3. A projekt futtatása
...
## <a name="monitor"></a> 4. A telemetria megtekintése
...
![Kattintson végig rajtuk a további adatokért](./media/app-insights-start-monitoring-app-health-usage/12-first-perf.png)
...
![Az alkalmazás közzététele a Visual Studio segítségével](./media/app-insights-start-monitoring-app-health-usage/15-publish.png)
...
## 5. Függőségi nyomkövetés (és IIS teljesítményszámlálók) hozzáadása
...
![A webalkalmazásban Beállítások, Bővítmények, Hozzáadás, Application Insights](./media/app-insights-start-monitoring-app-health-usage/05-extend.png)
...
## 6. Ügyféloldali megfigyelés hozzáadása
...
![A webalkalmazásban nyissa meg a gyors üzembe helyezést, és kattintson a „Kód lekérése a weblapok figyeléséhez” lehetőségre](./media/app-insights-start-monitoring-app-health-usage/02-monitor-web-page.png)
...
![ASP.NET-projekt létrehozása](./media/app-insights-start-monitoring-app-health-usage/appinsights-01-vsnewp1.png)
...
![Az Application Insights hozzáadása lehetőség kiválasztása](./media/app-insights-start-monitoring-app-health-usage/appinsights-03-addExisting.png)
...
![Kattintson a jobb gombbal a projektre, és nyissa meg az Azure portált](./media/app-insights-start-monitoring-app-health-usage/appinsights-04-openPortal.png)
