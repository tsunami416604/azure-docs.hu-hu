...
![Adatmegőrzési egérrel való rámutatás](./media/app-insights-usage-retention/hover.png)
...
[További információ az egyéni események írása](app-insights-api-custom-events-metrics.md#trackevent).
