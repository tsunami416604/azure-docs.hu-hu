...
Ez az oktatóanyag egy sorozat második része. Elsajátíthatja, hogyan méretezheti manuálisan egy alkalmazás több szolgáltatáspéldányát, amelyeket [előzőleg helyezett üzembe a Service Fabric Meshben](service-fabric-mesh-tutorial-template-deploy-app.md).  Ha elkészült, a következővel fog rendelkezni:
