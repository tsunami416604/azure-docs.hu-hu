---
title: Azure-partneri szolgáltatás – gyakori kérdések
description: Ismerkedjen meg Microsoft Azure társ-szolgáltatással kapcsolatos gyakori kérdések
...
- A társ-szolgáltatási kapcsolatok bevezetéséhez tekintse meg a következő témakört: előkészítési [szolgáltatások](onboarding-model.md).
- A társ-szolgáltatási kapcsolatok regisztrálásáról további információt a következő témakörben talál: [társ-szolgáltatási kapcsolatok regisztrálása – Azure Portal](azure-portal.md).
