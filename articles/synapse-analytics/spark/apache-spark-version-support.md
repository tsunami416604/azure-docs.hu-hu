---
title: Apache Spark verzió támogatása
...
azureml-adatelőkészítés = = 1.6.3

azureml-adatelőkészítés-Native = = 14.1.0

azureml – alapértékek = = 1.6.0

azureml-magyarázat-Model = = 1.6.0

azureml – értelmezés = = 1.6.0
...
azureml – folyamat = = 1.6.0

azureml – folyamat – mag = = 1.6.0

azureml-pipeline-Steps = = 1.6.0

azureml-SDK = = 1.6.0

azureml-telemetria = = 1.6.0
...
értelmezés – Közösség = = 0.10.2

értelmezés – mag = = 0.1.21
...
kötél-py3k = = 0.9.4. post1

ruamel. YAML = = 0.15.89

s3transfer = = 0.2.1

scikit – rendszerkép = = 0.15.0
