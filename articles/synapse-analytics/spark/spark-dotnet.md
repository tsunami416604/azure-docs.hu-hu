...
A kiválasztott NuGet-csomagokat a jegyzetfüzetbe telepítheti a `#r` NuGet-csomag neve előtti szimbólummal. Az alábbi ábrán egy példa látható:
