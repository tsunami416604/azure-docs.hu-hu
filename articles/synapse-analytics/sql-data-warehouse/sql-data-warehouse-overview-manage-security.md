...
Az Azure Synapse Analytics kiszolgálószintű IP-tűzfalszabályokat használ. Nem támogatja az adatbázisszintű IP-tűzfal szabályokat. További információ: [Azure SQL Database firewall rules](../../sql-database/sql-database-firewall-configure.md?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json)
...
A különböző protokollokkal a raktárhoz való csatlakozással kapcsolatos részletekért és példákért a [Csatlakozás az SQL-készlethez](../sql/connect-overview.md)című témakörben talál.
