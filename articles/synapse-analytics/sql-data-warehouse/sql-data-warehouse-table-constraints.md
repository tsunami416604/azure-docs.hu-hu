...
A szintaxishoz kattintson az [ALTER TABLE](/sql/t-sql/statements/alter-table-transact-sql) és a [CREATE TABLE](/sql/t-sql/statements/create-table-azure-sql-data-warehouse)elemre. 
