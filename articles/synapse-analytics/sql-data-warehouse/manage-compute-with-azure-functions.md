...
Az Azure Function App SQL-készlettel való használatához létre kell hoznia egy [egyszerű szolgáltatásfiókot](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-create-service-principal-portal) közreműködői hozzáféréssel az SQL-készletpéldányával azonos előfizetés keretében. 
...
3. Jelenleg a *%ScaleDownTime%* vagy a *%ScaleUpTime%* értéknek kell megjelennie. Ezek az értékek azt jelzik, hogy az ütemezés az [Alkalmazásbeállításokban](../../azure-functions/functions-how-to-use-azure-function-app-settings.md) beállított értékeken alapul. Egyelőre figyelmen kívül hagyhatja ezt az értéket, és a következő lépések alapján módosíthatja az ütemezést a kívánt időpontra.
...
4. Az ütemezési területen adja meg az SQL Data Warehouse vertikális felskálázásának gyakoriságát CRON-kifejezésként. 
   ...
   Például *a "0 30 9 * * 1-5"* minden hétköznap 9:30-kor egy eseményindítót tükrözne. További információért tekintse meg az Azure Functions [ütemezési példákat](../../azure-functions/functions-bindings-timer.md#example) ismertető leírását.
