---
title: Hitelesítés
description: Ismerje meg, hogyan hitelesítheti magát az Azure Synapse Analytics az Azure Active Directory (AAD) vagy az SQL Server-hitelesítés használatával.
...
* Adatbázis-engedélyek kezelése külső (AAD) csoportokkal.
...
* Az Azure Active Directory-hitelesítés konfigurálásának és használatának lépései közel azonosak az Azure SQL Database és az Azure Synapse SQL Analytics szolgáltatásában. Kövesse az [SQL-adatbázishoz vagy az SQL-készlethez való csatlakozás az Azure Active Directory-hitelesítés használatával](../../sql-database/sql-database-aad-authentication.md)című témakör részletes lépéseit.
