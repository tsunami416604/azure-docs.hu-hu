...
description: A Synapse SQL-ben támogatott rendszernézetek dokumentációjára mutató hivatkozások.
author: filippopovic
...
ms.locfileid: "81431565"
---
# <a name="system-views-supported-in-synapse-sql"></a>A Synapse SQL által támogatott rendszernézetek
A Synapse SQL-ben támogatott T-SQL utasítások dokumentációjára mutató hivatkozások.

> [!NOTE]
> A Synapse SQL igény szerinti igény szerinti csak az SQL Server katalógusnézeteit támogatja.  

## <a name="sql-pool-catalog-views"></a>SQL készletkatalógus-nézetek
...
* [sys.pdw_materialized_view_column_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-column-distribution-properties-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (előzetes verzió)
* [sys.pdw_materialized_view_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-distribution-properties-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (előzetes verzió)
* [sys.pdw_materialized_view_mappings](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-mappings-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (előzetes verzió)
...
## <a name="sql-pool-dynamic-management-views-dmvs"></a>SQL-készlet dinamikus felügyeleti nézetei (DMV-k)
...
## <a name="sql-server-dmvs-applicable-to-sql-pool"></a>SQL Server dmv-k, amelyek az SQL-készletre vonatkoznak
...
* [sys.adatbázisok](/sql/relational-databases/system-catalog-views/sys-databases-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.paraméterek](/sql/relational-databases/system-catalog-views/sys-parameters-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.partíciók](/sql/relational-databases/system-catalog-views/sys-partitions-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.sysadatbázisok](/sql/relational-databases/system-compatibility-views/sys-sysdatabases-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.sysreferencia](/sql/relational-databases/system-compatibility-views/sys-sysreferences-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
Az SQL pool és az Analytics Platform System párhuzamos adattárháza (PDW) ugyanazokat a rendszernézeteket használja. Minden dmv rendelkezik egy pdw_node_id nevű oszlopmal, amely a számítási csomópont azonosítója.
...
* [OSZLOPOK](/sql/relational-databases/system-information-schema-views/columns-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
* [Paraméterek](/sql/relational-databases/system-information-schema-views/parameters-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
* [Rutinok](/sql/relational-databases/system-information-schema-views/routines-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [Táblázatok](/sql/relational-databases/system-information-schema-views/tables-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [Kilátás nyílik](/sql/relational-databases/system-information-schema-views/views-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)

## <a name="next-steps"></a>További lépések

További információt a [Synapse SQL T-SQL-utasítások](/sql-data-warehouse/sql-data-warehouse-reference-tsql-language-elements)és [a Synapse SQL T-SQL nyelvi elemei című témakörben](/sql-data-warehouse/sql-data-warehouse-reference-tsql-statements)talál.
