...
ms.locfileid: "38467725"
---
# <a name="azure-policy-samples"></a>Azure Policy-minták

A következő táblázat az Azure Policyhez használható JSON-mintákra mutató hivatkozásokat tartalmaz. Ezek a minták az [Azure Policy mintaadattárában](https://github.com/Azure/azure-policy) is megtalálhatók.
