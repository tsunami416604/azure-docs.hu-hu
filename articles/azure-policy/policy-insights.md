...
1. Töltse le a házirend-hozzárendelés azonosítója a következő parancsok futtatásával:
  ...
  A házirend-hozzárendelés azonosítója első kapcsolatos további információkért lásd: [Get-AzureRMPolicyAssignment](https://docs.microsoft.com/powershell/module/azurerm.resources/Get-AzureRmPolicyAssignment).
...
A parancsmaggal kapcsolatban további információkért lásd: [Set-AzureRmPolicyAssignment](/powershell/module/azurerm.resources/Set-AzureRmPolicyAssignment).
