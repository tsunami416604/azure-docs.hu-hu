---
title: Azure Policy JSON-minta – Egyéni VM-lemezképek engedélyezése egy adott erőforráscsoportból | Microsoft Docs
description: Ez a JSON-mintaszabályzat megköveteli, hogy az egyéni lemezképek a jóváhagyott erőforráscsoportból származzanak.
...
Ez a JSON-mintaszabályzat megköveteli, hogy az egyéni lemezképek a jóváhagyott erőforráscsoportból származzanak. Meg kell adnia a jóváhagyott erőforráscsoport nevét.
...
További Azure Policy-sablonmintákat az Azure Policy dokumentációjában találhat.
