---
title: Azure Policy JSON-minta – Express Route-sávszélesség megkövetelése | Microsoft Docs
description: Ez a JSON-mintaszabályzat megköveteli a megadott sávszélességek használatát az Express Route-útvonalakon.
...
ms.locfileid: "34600867"
---
# <a name="allowed-express-route-bandwidth"></a>Express Route-sávszélesség megkövetelése

Ez a szabályzat megköveteli a megadott sávszélességek használatát az Express Route-útvonalakon. Meg kell adnia egy tömböt, mely tartalmazza az Express Route-útvonalakhoz használható termékváltozatokat.
