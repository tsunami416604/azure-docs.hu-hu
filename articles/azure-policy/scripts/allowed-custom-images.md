---
title: Azure Policy JSON-minta – Jóváhagyott VM-lemezképek | Microsoft Docs
description: Ez a JSON-mintaszabályzat előírja, hogy csak jóváhagyott lemezképek legyenek telepítve a környezetben.
...
- A virtuális gépekre vonatkozó további Azure Policy-példákat talál a [Szabályzatok alkalmazása Windows rendszerű virtuális gépekre](../../virtual-machines/windows/policy.md) című témakörben.