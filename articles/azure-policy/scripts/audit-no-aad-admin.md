---
title: Azure Policy JSON-minta – Azure Active Directory-rendszergazda hiányának naplózása | Microsoft Docs
description: Ez a JSON-mintaszabályzat naplózza, ha nincs Azure Active Directory-rendszergazda hozzárendelve az SQL-kiszolgálóhoz.
