---
title: Azure Policy JSON-minta – Hálózati biztonsági csoport minden hálózati adapteren | Microsoft Docs
description: Ez a JSON-mintaszabályzat megköveteli, hogy minden egyes virtuális hálózati adapter egy bizonyos hálózati biztonsági csoportot használjon.
...
Ez a szabályzat megköveteli, hogy minden egyes virtuális hálózati adapter egy bizonyos hálózati biztonsági csoportot használjon. Meg kell adnia a használandó hálózati biztonsági csoport azonosítóját.
