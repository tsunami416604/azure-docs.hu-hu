---
title: Azure Policy JSON-minta – Címke és címkeérték kényszerített használata erőforráscsoportokra | Microsoft Docs
description: Ez a JSON-mintaszabályzat előírja egy címke és egy érték használatát egy erőforráscsoporthoz.
