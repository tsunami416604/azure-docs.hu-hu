---
title: "Az Azure házirend json-mintát - naplózási kiszolgáló szintű fenyegetések észlelése beállítás |} Microsoft Docs"
...
---
# <a name="audit-server-level-threat-detection-setting"></a>Naplózási szint fenyegetések észlelése beállítást
