---
title: Azure Policy JSON-minta – Csak bizonyos platformú VM-lemezkép használatának engedélyezése | Microsoft Docs
description: Ez a JSON-mintaszabályzat megköveteli az UbuntuServer egy bizonyos verziójának használatát a virtuális gépektől.
...
---
# <a name="only-allow-a-certain-vm-platform-image"></a>Csak bizonyos platformú VM-lemezkép használatának engedélyezése

Megköveteli az UbuntuServer egy bizonyos verziójának használatát a virtuális gépektől.
