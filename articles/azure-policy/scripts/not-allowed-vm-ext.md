---
title: Azure Policy JSON-minta – Tiltott virtuálisgép-bővítmények | Microsoft Docs
description: Ez a JSON-mintaszabályzat megtiltja a megadott bővítmények használatát.
