---
title: Azure Policy JSON-minta – Hybrid Use Benefit tiltása | Microsoft Docs
description: Ez a JSON-mintaszabályzat megtiltja az Azure Hybrid Use Benefit (AHUB) használatát.
