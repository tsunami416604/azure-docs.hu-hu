---
title: Azure Policy JSON-minta – Hálózati biztonsági csoport minden alhálózaton | Microsoft Docs
description: Ez a JSON-mintaszabályzat megköveteli, hogy minden egyes virtuális alhálózat egy bizonyos hálózati biztonsági csoportot használjon.
