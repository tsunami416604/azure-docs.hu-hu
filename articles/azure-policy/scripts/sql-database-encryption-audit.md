---
title: Azure Policy JSON-példa – SQL Database-adatbázisok transzparens adattitkosításának naplózása | Microsoft Docs
description: Ez a json-mintaszabályzat naplózza, ha az SQL Database-adatbázisban nincs engedélyezve a transzparens adattitkosítás.
