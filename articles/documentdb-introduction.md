...
-   [Try DocumentDB now][Try DocumentDB now]
-   [Understand DocumentDB concepts][Understand DocumentDB concepts]
-   [Interact with DocumentDB][Interact with DocumentDB]
-   [Create a database account][Create a database account]
-   [Get started with DocumentDB][Get started with DocumentDB]
