...
5.  Complete the required fields for the new user. Kattintson a **Létrehozás** gombra.
...
10. Válassza a **Hozzárendelés** elemet. The added users are displayed in the list with the administrator role assigned.
