...
![Számítógép csoport szűrve folyamatok](media/monitoring-service-map/machine-groups-filtered.png)
...
![Gép összefoglalás ablaktábla](media/monitoring-service-map/machine-summary.png)
