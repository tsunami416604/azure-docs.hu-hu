...
3. A piactér keresési eredmények oldalon válassza ki a **Service Map** a listából.<br><br> ![Azure Marketplace-en keresési eredmények közül válassza ki a Service Map megoldás](./media/monitoring-service-map/marketplace-search-results.png)<br>
4. Az a **Service Map** áttekintés ablaktábláján, tekintse meg a megoldás részleteit, és kattintson a **létrehozás** a Log Analytics-munkaterülethez a bevezetési folyamat megkezdéséhez.<br><br> ![Előkészítése a Service Map megoldás](./media/monitoring-service-map/service-map-onboard.png).
...
A Service Map elérése a Log Analytics-munkaterület az Azure Portalon, és válassza a **megoldások** a bal oldali ablaktáblán.<br><br> ![Válassza ki a munkaterület megoldások beállítást](./media/monitoring-service-map/select-solution-from-workspace.png).<br> Megoldások listájából válassza ki a **ServiceMap(workspaceName)** és a Service Map megoldás áttekintése lapon kattintson az összefoglalás csempére a Service Map.<br><br> ![A Service Map-összefoglaló csempe](./media/monitoring-service-map/service-map-summary-tile.png).
...
![A Service Map áttekintése](media/monitoring-service-map/service-map-overview.png)
...
![Jelvények állapota](media/monitoring-service-map/status-badges.png)
...
![Számítógépcsoport](media/monitoring-service-map/machine-group.png)
...
![Csoportok lapon](media/monitoring-service-map/machine-groups-tab.png)

Ezután válassza ki a csoport nevét, a térkép megtekintéséhez az adott gép csoporthoz.
![Számítógépcsoport](media/monitoring-service-map/machine-group.png) a gépeket a csoporthoz tartozó a fehér a térképen foglaltaknak.

A csoport kiterjesztése a gépeken a gép csoportot alkotó listázza.

![Gépek csoportosítása a gépek](media/monitoring-service-map/machine-groups-machines.png)
...
![Szűrőcsoport](media/monitoring-service-map/machine-groups-filter.png)
...
![Minden számítógépcsoport dolgozza fel.](media/monitoring-service-map/machine-groups-all.png)
...
![A szűrt folyamatok számítógépcsoport](media/monitoring-service-map/machine-groups-filtered.png)
...
![Gép csoport menü](media/monitoring-service-map/machine-groups-menu.png)
...
![Sikertelen kapcsolatok](media/monitoring-service-map/failed-connections.png)
...
![Ügyfél tulajdonságai](media/monitoring-service-map/client-group-properties.png)
...
![Gép összefoglalás panel](media/monitoring-service-map/machine-summary.png)
...
![Gép Tulajdonságok ablaktábla](media/monitoring-service-map/machine-properties.png)
...
![Tulajdonságok ablaktábla feldolgozása](media/monitoring-service-map/process-properties.png)
...
![Folyamat összefoglalás panel](media/monitoring-service-map/process-summary.png)
...
![Számítógép-riasztások panel](media/monitoring-service-map/machine-alerts.png)
...
![Gép alkalmazásnapló-események ablak](media/monitoring-service-map/log-events.png)
...
![Gép ügyfélszolgálat panel](media/monitoring-service-map/service-desk.png)
...
![Gép Change Tracking panel](media/monitoring-service-map/change-tracking.png)
...
![Számítógép teljesítménye paneljén](media/monitoring-service-map/machine-performance.png)
...
![Gép biztonsági panel](media/monitoring-service-map/machine-security.png)
...
Tudjon meg többet [naplókereséseket](../log-analytics/log-analytics-log-searches.md) a Log Analytics által a Service Map összegyűjtött adatok lekéréséhez.


## <a name="troubleshooting"></a>Hibaelhárítás
Tekintse meg a [hibaelhárítás szakaszhoz a konfigurálása a Service Map dokumentum]( monitoring-service-map-configure.md#troubleshooting).
