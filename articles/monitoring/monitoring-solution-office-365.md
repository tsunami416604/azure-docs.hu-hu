...
Ez a megoldás nem telepíti a minden felügyeleti csomagot [csatlakoztatott felügyeleti csoportok](../log-analytics/log-analytics-om-agents.md).
  
## <a name="install-and-configure"></a>Telepítés és konfigurálás
Először adja hozzá a [az előfizetés az Office 365-megoldás](monitoring-solutions.md#install-a-management-solution). Miután hozzáadta, ebben a szakaszban neki hozzáférést az Office 365-előfizetéssel, hajtsa végre a konfigurációs lépéseket.
...
1. Kattintson az **Új alkalmazásregisztráció** elemre.
    ...
    ![Alkalmazásregisztráció hozzáadása](media/monitoring-solution-office-365/add-app-registration.png)
1. Adja meg az alkalmazás **neve** és **bejelentkezési URL-**.  A név legyen leíró.  Használat _http://localhost_ URL-címet, és tarthatja _webalkalmazás / API_ a a **alkalmazástípus**
    ...
    ![Alkalmazás létrehozása](media/monitoring-solution-office-365/create-application.png)
1. Kattintson a **létrehozás** , és ellenőrizze az alkalmazás adatait.

    ![Regisztrált alkalmazás](media/monitoring-solution-office-365/registered-app.png)
...
1. Válassza ki **tulajdonságok**. Változás **több-bérlős** való _Igen_.
    ...
    ![Több-bérlős beállításai](media/monitoring-solution-office-365/settings-multitenant.png)
...
1. Kattintson a **API kiválasztása** , majd **az Office 365 felügyeleti API-k**. Kattintson a **Office 365 felügyeleti API-k**. Kattintson a **Kiválasztás** gombra.
    ...
    ![API kiválasztása](media/monitoring-solution-office-365/select-api.png)
...
1. A **engedélyek kiválasztása** válassza ki a következő beállításokat is **Alkalmazásengedélyek** és **delegált engedélyek**:
    ...
    ![API kiválasztása](media/monitoring-solution-office-365/select-permissions.png)

1. Kattintson a **kiválasztása** , majd **kész**.
1. Kattintson a **engedélyeket** majd **Igen** az ellenőrző kérdés.

    ![Engedélyek megadása](media/monitoring-solution-office-365/grant-permissions.png)
...
1. Kattintson a **mentése** , majd másolja a **érték** , amely akkor jön létre.
    ...
    ![Kulcsok](media/monitoring-solution-office-365/keys.png)
...
1. Megjelenik egy ablak, az alábbihoz hasonló. Kattintson a **fogadja el**.
    ...
    ![Rendszergazdai jóváhagyás](media/monitoring-solution-office-365/admin-consent.png)
...
### <a name="troublshooting"></a>Hibaelhárítás
...
Az Office 365 felügyeleti megoldás részben ismertetett eljárással eltávolíthatja [távolítsa el a felügyeleti megoldás](../monitoring/monitoring-solutions.md#remove-a-management-solution). A begyűjtött adatok Office 365-ből azokat a Log Analytics azonban nem leáll. Mondja le az Office 365 és az adatgyűjtés leállításához az alábbi eljárást követve.
...
![Az Office 365-összefoglaló csempe](media/monitoring-solution-office-365/tile.png)  

Kattintson a **Office 365** csempére kattintva nyissa meg a **Office 365** irányítópult.

![Az Office 365-irányítópult](media/monitoring-solution-office-365/dashboard.png)  
...
| RecordType | A végrehajtott művelet típusát. |
