...
![Forgatókönyv szerkesztése](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![Runbook tesztelése](media/monitoring-runbook-datacollect/test-runbook.png)
...
![Runbook közzététele](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![Naplózás és nyomkövetés](media/monitoring-runbook-datacollect/logging.png)
...
![Forgatókönyv ütemezése](media/monitoring-runbook-datacollect/schedule-runbook.png)
...
Egy runbook elindul, amikor valaki [létrejön egy feladat](../automation/automation-runbook-execution.md) és a kimenetet a naplóba.  Sőt ezek a ugyanazt a feladatot, amely a runbook gyűjti.  Ellenőrizheti, hogy a runbookot a runbook a feladatok ellenőrzésével, az ütemezés kezdési ideje után megfelelően elindul-e.

![Feladatok](media/monitoring-runbook-datacollect/jobs.png)
...
5. Görgessen az alul található egy bejegyzés az alábbi képen láthatóhoz hasonló.<br>![Részletes](media/monitoring-runbook-datacollect/verbose.png)
