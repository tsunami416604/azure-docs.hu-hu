...
more information on blobs, see the [Next steps][Next steps] section.

> [WACOM.NOTE] This guide targets the Azure .NET Storage Client Library 2.x and above. The recommended version is Storage Client Library 4.x, which is available via [NuGet][NuGet] or as part of the [Azure SDK for .NET][Azure SDK for .NET]. See [How to: Programmatically access Blob storage][How to: Programmatically access Blob storage] below for more details on obtaining the Storage Client Library.
...
-   [How to: Programmatically access Blob storage][How to: Programmatically access Blob storage]
...
-   [How to: Delete blobs][How to: Delete blobs]
-   [How to: List blobs in pages asynchronously][How to: List blobs in pages asynchronously]
...
For more information, see [CloudBlobContainer.ListBlobs][CloudBlobContainer.ListBlobs].
...
-   View the Blob service reference documentation for complete details about available APIs:
...
-   View more feature guides to learn about additional options for storing data in Azure.
    ...
    -   Use [Queue Storage][Queue Storage] to store unstructured data.
