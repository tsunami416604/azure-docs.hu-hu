...
Jelenleg a SignalR [két verziója](https://docs.microsoft.com/aspnet/core/signalr/version-differences) használható a webalkalmazásokhoz: a SignalR for ASP.NET és az ASP.NET Core SignalR, amely egyben a legújabb verzió is. Az Azure SignalR szolgáltatás az ASP.NET Core SignalR-re épülő, az Azure által kezelt szolgáltatás. 
