...
1. Nyisson meg egy terminált a VS Code kiválasztásával **Nézet > beépített terminál** a menüből (Ctrl -\`).
...
1. Adja meg az alábbi információkat:
    ...
    | Tárfiók | Válassza ki a **Create new storage account** (Új tárfiók létrehozása) elemet |
...
1. Adja meg a következő információkat:
    ...
    | Name (Név) | Érték |
    |---|---|
    | Name (Név) | Adjon meg egy egyedi nevet a blobtárfióknak |
