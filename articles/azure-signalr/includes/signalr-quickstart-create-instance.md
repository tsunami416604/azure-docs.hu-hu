...
1. Adja meg az alábbi beállításokat.
    ...
    | **Helyen** | USA nyugati régiója | Válasszon egy Önhöz közeli [régiót](https://azure.microsoft.com/regions/). |
    ...
    | **Szolgáltatási mód** |  Kiszolgáló nélküli | Az Azure Functions vagy a REST API használatával való használatra. |
...
1. A példány üzembe helyezése után nyissa meg a portálon, és keresse meg a Beállítások lapot. Módosítsa a szolgáltatási mód beállítást *kiszolgáló nélkülire* csak akkor, ha az Azure SignalR szolgáltatást az Azure Functions binding vagy a REST API használatával használja. Hagyja a *Klasszikus* vagy *az Alapértelmezett* egyébként.