...
-   [What Are Media Services?][What Are Media Services?]
-   [Setting Up an Azure Account for Media Services][Setting Up an Azure Account for Media Services]
-   [Setting up for Media Services development][Setting up for Media Services development]
-   [How to: Use Media Services with Java][How to: Use Media Services with Java]
-   [Additional Resources][Additional Resources]

## <a name="what-are"></a><span class="short header">What are Media Services?</span>What are Media Services?
...
The following provides a list of available client SDKs and player frameworks. For more information on these and other planned SDKs and player frameworks, and the functionality they can support, see [Media Services Client Development][Media Services Client Development].
...
## <a name="setup-account"></a><span class="short header">Setting up an account</span>Setting up an Azure account for Media Services

To set up your Media Services account, use the Azure Management Portal. See the topic [How to Create a Media Services Account][How to Create a Media Services Account]. After creating your account in the Management Portal, you are ready to set up your computer for Media Services development.

## <a name="setup-dev"> </a><span class="short header">Setting up for Media Services development</span>

This section contains general prerequisites for Media Services development using the Media Services SDK for Java.

### Prerequisites

-   A Media Services account in a new or existing Azure subscription. See the topic [How to Create a Media Services Account][How to Create a Media Services Account].
-   The Azure Libraries for Java, which you can install from the [Azure Java Developer Center][Azure Java Developer Center].

## <a name="connect"> </a><span class="short header">Use Media Services with Java</span>How to: Use Media Services with Java
...
You'll need to set up a media services account before using this code. For information about setting up an account, see [How to Create a Media Services Account][2].
...
## <a name="additional-resources"></a><span class="short header">Additional Resources</span>Additional Resources
...
For Media Services Javadoc documentation, see [Azure Libraries for Java documentation][Azure Libraries for Java documentation].
  ...
  [How to Use Smooth Streaming Plugin for Adobe Open Source Media Framework]: http://go.microsoft.com/fwlink/?LinkId=275034
