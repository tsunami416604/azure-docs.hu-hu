...
A farm olyan földrajzi terület, amelynek az a célja, hogy hő hozzon létre. Farmokat a Farms [API](https://aka.ms/FarmBeatsDatahubSwagger) -val vagy a FarmsBeats- [gyorsító kezelőfelületén](manage-farms.md#create-farms) hozhat létre.
