...
A drone-képek Azure FarmBeats-mel való integrálása segít a orthomosaic adatoknak az adatközpontba való bevezetésében a farmon folytatott drone-repülőjáratokon. Miután az elérhetővé válik, megtekintheti a FarmBeats-gyorsító szolgáltatásban. Az adatok az adatfúzióhoz, valamint a mesterséges intelligencia és a gépi tanulási modellek létrehozásához használhatók.

## <a name="before-you-begin"></a>Előzetes teendők

  - Győződjön meg arról, hogy üzembe helyezte az Azure-FarmBeats. További információ a FarmBeats telepítéséről: [FarmBeats telepítése](prepare-for-deployment.md).
...
Az FarmBeats adatközpontba történő elküldését követően a FarmBeats Datahub API-k használatával kérdezheti le a jelenet tárolóját.
...
Ismerje meg, hogyan használhatja a FarmBeats Datahub [API-kat](references-for-farmbeats.md#rest-api) a drone-képek beszerzéséhez.
