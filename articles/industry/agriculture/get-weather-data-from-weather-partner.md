...
Az időjárási idő beszerzéséhez győződjön meg arról, hogy [telepítette a FarmBeats](./install-azure-farmbeats.md). Az időjárási integrációt a 1.2.11 és újabb verziók támogatják. 
