...
[MongoDB][MongoDB] is a popular open source, high performance NoSQL database. Using the Azure Management Portal, you can create a virtual machine running CentOS Linux from the Image Gallery. You can then install and configure a MongoDB database on the virtual machine.
