...
# <span id="managemediaservicesorigins"></span></a>How to Manage Streaming Endpoints in a Media Services Account
...
1.  In the [Management Portal][Management Portal], click **Media Services**. Then, click the name of the media service.
...
3.  Specify configuration for Akamai signature header authentication.
    ...
    The configuration on this page will only apply to streaming endpoints that have at least one reserved unit. To reserve the on-demand streaming reserved units, go to the SCALE tab. For detailed information about reserved units, see [Scaling Media Services][Scaling Media Services].

  [Management Portal]: https://manage.windowsazure.com/
  [Origin page]: ./media/media-services-manage-origins/media-services-origins-page.png
  [Configure origin]: ./media/media-services-manage-origins/media-services-origins-configure.png
  [Scaling Media Services]: ../media-services-how-to-scale/
