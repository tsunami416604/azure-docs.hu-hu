...
Hozzon létre egy új erőforráscsoportot és egy AK-fürtöt, majd használja a kulcsot az operációsrendszer-lemez titkosításához.
...
## <a name="add-a-node-pool-to-an-existing-aks-cluster-and-encrypt-the-os-disk-with-a-customer-managed-key"></a>Csomópont-készlet hozzáadása meglévő AK-fürthöz és az operációsrendszer-lemez titkosítása egy ügyfél által felügyelt kulccsal

Az új nodepools alapértelmezés szerint nem használnak titkosított lemezeket.  A következő parancs használatával hozzáadhat új csomópont-készletet egy meglévő fürthöz, és titkosíthatja az operációsrendszer-lemezt a saját kulcsával.
