...
A Linux vagy a `curl` [Linux rendszerhez készült Windows alrendszer][install-wsl]bash-alapú rendszerhéjában a következő módon töltheti le az Linkerd-kiadást:
