...
---
A Windows PowerShell-alapú rendszerhéjában a paranccsal `Invoke-WebRequest` töltse le a Consul Helm chart kiadást, majd a `Expand-Archive` következő módon bontsa ki a t:
