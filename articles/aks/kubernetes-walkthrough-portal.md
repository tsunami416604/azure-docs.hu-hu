...
Ha meg szeretné tekinteni a `azure-vote-front` Pod-naplókat, válassza a **tárolók megjelenítése** a tárolók listájának legördülő listából. Ezek a naplók tartalmazzák a tároló *stdout* és *stderr* streamjét is.
