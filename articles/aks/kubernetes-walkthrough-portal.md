...
> [!NOTE]
> Ha ezeket a műveleteket egy helyi rendszerhéj-telepítésben szeretné elvégezni, először ellenőriznie kell az Azure CLI-t, majd az parancs használatával kell csatlakoznia az Azure-hoz `az login` .
