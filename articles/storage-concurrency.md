...
-   [Specifying Conditional Headers for Blob Service Operations][1]
...
-   [Operations on Entities][Operations on Entities]
...
-   [Queue Service REST API][Queue Service REST API]
...
-   [Managing Concurrency using Azure Storage - Sample Application][here]

For more information on Azure Storage see:

-   [Microsoft Azure Storage Home Page][Microsoft Azure Storage Home Page]
-   [Introduction to Azure Storage][Introduction to Azure Storage]
-   Storage Getting Started for [Blob][Blob], [Table][Table] and [Queues][Queues]
-   Storage Architecture – [Windows Azure Storage : A Highly Available Cloud Storage Service with Strong Consistency][Windows Azure Storage : A Highly Available Cloud Storage Service with Strong Consistency]

  [here]: http://code.msdn.microsoft.com/windowsazure/Managing-Concurrency-using-56018114
  [Specifying Conditional Headers for Blob Service Operations]: http://msdn.microsoft.com/en-us/library/dd179371.aspx
  [lease]: http://msdn.microsoft.com/en-us/library/azure/ee691972.aspx
  [1]: http://msdn.microsoft.com/en-us/library/azure/dd179371.aspx
  ...
  [Blob]: http://azure.microsoft.com/en-us/documentation/articles/storage-dotnet-how-to-use-blobs/
  [Table]: http://azure.microsoft.com/en-us/documentation/articles/storage-dotnet-how-to-use-tables/
  [Queues]: http://azure.microsoft.com/en-us/documentation/articles/storage-dotnet-how-to-use-queues/
