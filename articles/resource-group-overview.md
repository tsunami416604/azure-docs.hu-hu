...
6. Egy erőforrás más erőforráscsoportok erőforrásaival is interakcióba tud lépni. Az ilyen interakciók gyakoriak azokban az esetekben, amikor az erőforrások kapcsolódnak, de életciklusuk nem egyezik (például az adatbázishoz kapcsolódó webalkalmazások esetén).
