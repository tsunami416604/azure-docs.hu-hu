...
A következő `GET` HTTP-kérelem használatával sorolja fel az előfizetéséhez tartozó állapotadatok listáját a és `2018-05-16` `2018-06-20`a közötti időtartamra.
...
| api-verzió | A kérelemhez használandó API-verzió.<br /><br /> Ez a dokumentum a fenti URL `2015-04-01`-cím részét képező API-verziót tartalmazza.  |
