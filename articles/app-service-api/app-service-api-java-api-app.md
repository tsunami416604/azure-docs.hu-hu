...
1. 瀏覽至 [Swagger 的線上編輯器](http://editor.swagger.io/)。 抵達之後，依序按一下 [File] (檔案) -> [Paste JSON] (貼上 JSON)**** 功能表項目 。
...
1. 建立新的 API 應用程式中 [Azure 入口網站](http://portal.azure.com), ，即可在 **新增-> [Web + 行動]-> [API 應用程式** 功能表項目。
