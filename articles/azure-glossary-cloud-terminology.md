...
* [A Microsoft Azure és az Amazon Web Services](https://azure.microsoft.com/campaigns/azure-vs-aws/mapping/) -definíciók az Azure-szolgáltatások és AWS másolataik.<!-- I propose to link to https://azure.microsoft.com/en-us/services/ instead of this -->
