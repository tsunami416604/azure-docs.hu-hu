...
Internetes Exchange-szolgáltatóként a társítás [létrehozásával]( https://go.microsoft.com/fwlink/?linkid=2129593)hozhat létre Exchange-társi kérelmet.
...
A régi társítási kapcsolatokat a társítás [létrehozásával]( https://go.microsoft.com/fwlink/?linkid=2129593)alakíthatja át.

####  <a name="configure-basic-settings"></a>Az alapvető beállítások konfigurálása
>   ![A Peering Service regisztrálása](./media/setup-basics-tab.png)
