...
<tags ms.service="virtual-machines" ms.workload="infrastructure-services" ms.tgt_pltfrm="vm-windows" ms.devlang="na" ms.topic="article" ms.date="09/12/2014" ms.author="kathydav"></tags>
...
> You can also try the richer, customizable [Azure Preview Portal][1] to create a virtual machine, automate the deployment of multi-machine application templates, use enhanced VM monitoring and diagnostics features, and more. The available VM configuration options in the two Portals overlap substantially but aren't identical.
...
This section shows you how to attach an empty data disk to the virtual machine. See the [Attach a Data Disk Tutorial][Attach a Data Disk Tutorial] for more information on attaching empty disks as well as how to attach existing disks.
...
7.  Connect to the virtual machine by using the steps in the previous section, [How to log on to the virtual machine after you create it][How to log on to the virtual machine after you create it] (\#logon).
...
[VIDEO: Getting Started with VHDs - What's Really Happening][VIDEO: Getting Started with VHDs - What's Really Happening]

[VIDEO: FAQ with Mark Russinovich - Does Windows Azure run Windows?][VIDEO: FAQ with Mark Russinovich - Does Windows Azure run Windows?]

[VIDEO: Adding a new virtual machine to a Web Farm by making reusable images][VIDEO: Adding a new virtual machine to a Web Farm by making reusable images]

[VIDEO: Adding Virtual Hard Drives, Storage Accounts, and Scaling Virtual Machines][VIDEO: Adding Virtual Hard Drives, Storage Accounts, and Scaling Virtual Machines]

[VIDEO: Scott Guthrie starts with Virtual Machines][VIDEO: Scott Guthrie starts with Virtual Machines]

[VIDEO: Storage and Disk Basics with Azure Virtual Machines][VIDEO: Storage and Disk Basics with Azure Virtual Machines]
  ...
  [Attach a Data Disk Tutorial]: http://www.windowsazure.com/en-us/documentation/articles/storage-windows-attach-disk/
  ...
  [About VHDs in Azure]: http://msdn.microsoft.com/en-us/library/azure/dn790344.aspx
