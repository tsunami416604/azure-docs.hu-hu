...
![UD FD configuration][UD FD configuration]

> [WACOM.NOTE] For instructions, see [How to Configure an Availability Set for Virtual Machines][How to Configure an Availability Set for Virtual Machines].
