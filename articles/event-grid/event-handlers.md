...
description: A Azure Event Grid támogatott eseménykezelőit ismerteti
services: event-grid
author: spelluru
...
A forrásként Event Hubs Példákért lásd: [Event Hubs forrás](event-sources.md#event-hubs).
