...
| Tulajdonság neve | Description |
| ---------------- | ------------ |
| `metrics__reporterType` | A végpontot metrikái a Reporter típusa. Az alapértelmezett érték az `none` , és letiltja a metrikákat. Ezzel a beállítással `prometheus` engedélyezheti a metrikákat a Prometheus kiállítási formátumában.