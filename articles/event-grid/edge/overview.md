...
A Event Grid IoT Edge használatával kapcsolatos esetleges problémák jelentése a [https://github.com/Azure/event-grid-iot-edge/issues](https://github.com/Azure/event-grid-iot-edge/issues)következő helyen:.
