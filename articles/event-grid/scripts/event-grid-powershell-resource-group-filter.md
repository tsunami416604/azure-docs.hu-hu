...
description: Azure Event Grid & Azure PowerShell parancsfájl mintája – előfizetés erőforrás-csoportra, és erőforrás alapján történő szűrés
services: event-grid
