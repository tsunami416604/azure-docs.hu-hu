...
description: Ez a cikk egy minta Azure PowerShell-parancsfájlt tartalmaz, amely bemutatja, hogyan iratkozhat fel az Event Grid-eseményekre egy egyéni témakörhöz.
services: event-grid
