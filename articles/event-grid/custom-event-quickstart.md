...
- [Azure Blob Storage-események átirányítása egyéni webes végpontra (előzetes verzió)](../storage/blobs/storage-blob-event-quickstart.md?toc=%2fazure%2fevent-grid%2ftoc.json)
