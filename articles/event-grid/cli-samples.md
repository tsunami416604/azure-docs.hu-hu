...
description: Azure CLI-minták az Event Gridhez
services: event-grid
author: spelluru
manager: timlt
...
| [Feliratkozás Azure-előfizetésre](scripts/event-grid-cli-azure-subscription.md)| Feliratkozik egy Azure-előfizetés eseményeire. |
