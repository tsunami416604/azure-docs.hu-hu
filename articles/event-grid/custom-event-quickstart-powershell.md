...
ms.locfileid: "53096671"
---
# <a name="quickstart-route-custom-events-to-web-endpoint-with-powershell-and-event-grid"></a>Gyors útmutató: Egyéni események átirányítása a PowerShell és az Event Grid webes végpont
