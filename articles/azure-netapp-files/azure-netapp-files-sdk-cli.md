---
title: Azure NetApp SDK-k fájlok |} A Microsoft Docs
description: Az SDK-k Azure NetApp fájlok által támogatott sorolja fel.
...
ms.locfileid: "65957880"
---
# <a name="azure-netapp-files-sdks"></a>Azure NetApp Files SDK-k

Ez a cikk felsorolja az SDK-k Azure NetApp fájlokat támogatja.

## <a name="supported-sdks"></a>Támogatott SDK-k 

Az alábbi táblázat felsorolja a támogatott SDK-k.  A GitHub közzétett helyeken támogatott SDK-k részleteit is található.  

|    Nyelv    |    SDK-t közzétett helye    |
|------------------|--------------------------------------------------------------------------------------------|
...
## <a name="next-steps"></a>További lépések   
 [Az Azure SDK-k letöltése](https://azure.microsoft.com/downloads/)
