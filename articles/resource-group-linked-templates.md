...
您可以透過在主要範本中新增指向連結的範本之部署資源，以在兩個範本之間建立連結。 將 **templateLink** 屬性設為連結的範本之 URI。 您可以 
提供的參數值連結的範本或在範本中指定的值直接 
連結到參數檔案。 以下範例會使用 **parameters** 屬性直接指定參數值。
...
如果您需要從連結的範本將值傳遞給主要範本，您可以在連結範本的 **outputs** 區段中建立一個值。 如需範例，請參閱 
