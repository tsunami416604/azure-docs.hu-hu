...
# <a name="setup-dev"> </a><span class="short header">Setting up your computer for Media Services development</span>
...
-   Use the [windowsazure.mediaservices Nuget][windowsazure.mediaservices Nuget] package to install Azure SDK for .NET. The following section shows how to use **Nuget** to install the Azure SDK.

## <a name="setup-account"></a><span class="short header">Setting up an Azure account for Media Services</span>

To set up your Media Services account, use the Azure Management Portal (recommended). See the topic [How to Create a Media Services Account][How to Create a Media Services Account]. After creating your account in the Management Portal, you are ready to set up your computer for Media Services development.
...
4.  Use the [windowsazure.mediaservices Nuget][windowsazure.mediaservices Nuget] package to add references to **Azure SDK for .NET.** (all other dependent assemblies will be installed as well).
...
## <a name="setup-account"></a><span class="short header">Connect to Media Services</span>
...
It is often useful to define a module-level variable of type **CloudMediaContext** to hold a reference to the server context. For more information, see [Connecting to Media Services with the Media Services SDK for .NET][Connecting to Media Services with the Media Services SDK for .NET].

The rest of the code examples in this topic use a variable called \*\*\_context\*\* to refer to the server context.

## Next Steps

Now that you have set up your computer and created a Visual Studio solution for programming Media Services, go to the [How to Create an Encrypted Asset and Upload to Storage][How to Create an Encrypted Asset and Upload to Storage] topic.
