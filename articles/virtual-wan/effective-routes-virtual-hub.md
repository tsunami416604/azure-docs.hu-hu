...
## <a name="understand"></a>Az útvonalak ismertetése
...
## <a name="view"></a>Érvényes útvonalak megtekintése
...
### <a name="routetable"></a>Hub-útválasztási táblázat
...
### <a name="abouthubroute"></a>Tudnivalók a hub útválasztási táblájáról
...
### <a name="aboutdefaultroute"></a>Az alapértelmezett útvonal (0.0.0.0/0)
