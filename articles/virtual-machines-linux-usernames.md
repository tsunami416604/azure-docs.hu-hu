...
-   See also: [Linux Standard Base - User ID Ranges][Linux Standard Base - User ID Ranges]
...
-   www-data
  ...
  [Linux Standard Base - User ID Ranges]: http://refspecs.linuxfoundation.org/LSB_4.1.0/LSB-Core-generic/LSB-Core-generic/uidrange.html
