...
<tags ms.service="web-sites" ms.workload="web" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="10/12/2014" ms.author="tdykstra"></tags>
...
-   [Using the WebJobs SDK outside of WebJobs][Using the WebJobs SDK outside of WebJobs]
-   [Using the WebJobs SDK to invoke any function][Using the WebJobs SDK to invoke any function]
-   [Next steps][Next steps]

## <span id="overview"></span></a>Overview

[WebJobs][WebJobs] is a feature of Azure Websites that enables you to run a program or script in the same context as a website. The purpose of the WebJobs SDK is to simplify the task of writing code that runs as a WebJob and works with Azure Storage queues, blobs, and tables, and Service Bus queues.
...
## <span id="scenarios"></span></a>Scenarios
...
-   Other long-running tasks that you want to run in a background thread, such as [sending emails][sending emails].

## <span id="code"></span></a> Code samples
...
## <span id="workerrole"></span></a>Using the WebJobs SDK outside of WebJobs
...
-   For more information, see [How to manually invoke a function][How to manually invoke a function] and [How to write logs][How to write logs]

## <span id="nextsteps"></span></a>Next steps

For more information about the WebJobs SDK, see [Azure WebJobs Recommended Resources][Azure WebJobs Recommended Resources].
  ...
  [WebJobs]: /en-us/documentation/articles/web-sites-create-web-jobs/
  [WebJobs SDK Get Started tutorial]: ../websites-dotnet-webjobs-sdk-get-started/
  [sending emails]: https://github.com/victorhurdugaci/AzureWebJobsSamples/tree/master/SendEmailOnFailure
  ...
  [How to manually invoke a function]: ../websites-dotnet-webjobs-sdk-storage-queues-how-to/#manual
  [How to write logs]: ../websites-dotnet-webjobs-sdk-storage-queues-how-to/#logs
  [Azure WebJobs Recommended Resources]: http://go.microsoft.com/fwlink/?linkid=390226
