...
1.  Connect to the virtual machine by clicking **Connect** on the command bar. For details, see [How to Log on to a Virtual Machine Running Linux][How to Log on to a Virtual Machine Running Linux].
...
5.  In the [Management Portal][Management Portal], select the virtual machine, and then click **Shut down**.
