...
# <span id="monitormediaservicesaccount"></span></a>How to Monitor a Media Services Account
...
> [WACOM.NOTE] Additional costs are associated with monitoring storage data in the Azure Management Portal. For more information, see [Storage Analytics and Billing][Storage Analytics and Billing].

## <span id="configuremonitoring"></span></a>How to: Monitoring a Media Services account

1.  In the [Management Portal][Management Portal], click **Media Services**, and then click the Media Services account name to open the dashboard.
...
## <span id="configuringstorage"></span></a>How to: Monitoring your blob storage usage (Optional)
...
1.  When you finish the monitoring configuration, click **Save**.
    ...
    Metrics are stored in the storage account in four tables named $MetricsTransactionsBlob, $MetricsTransactionsTable, $MetricsTransactionsQueue, and $MetricsCapacityBlob. For more information, see [Storage Analytics Metrics][Storage Analytics Metrics].

<!-- Images -->

  [Storage Analytics and Billing]: http://go.microsoft.com/fwlink/?LinkId=256667
  [Management Portal]: http://go.microsoft.com/fwlink/?LinkID=256666
