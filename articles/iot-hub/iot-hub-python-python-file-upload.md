...
1. Egy szövegszerkesztővel hozzon létre egy blobtárolóba feltölteni kívánt fájl tesztelése. 
...
1. Adja hozzá a következő `import` utasításokat és változókat elején a **FileUpload.py** fájlt. 
