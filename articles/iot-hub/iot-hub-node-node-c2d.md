...
2. Regisztrálja a kezelőt az eszköz ügyfelével a IoT Hub küldött üzenetek fogadásához. Vegye fel a hívást `client.on` közvetlenül az eszköz ügyfelét létrehozó sor után, a következő kódrészlethez hasonlóan:
