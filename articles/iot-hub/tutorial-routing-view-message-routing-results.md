...
A Stream Analytics-feladatokban válassza a **start** > **most** > **Indítás**lehetőséget. Ha a feladat sikeresen elindult, a feladat állapota **Leállítva** értékről **Fut** értékre változik.
...
Az erőforráscsoport eltávolításához használja a [Remove-AzResourceGroup](https://docs.microsoft.com/powershell/module/az.resources/remove-azresourcegroup) parancsot. `$resourceGroup` az oktatóanyag elején **ContosoResources** vissza.
