...
- Az eszköz TCP/IP-szintű alaphelyzetbe állítást küldött, de nem küldött alkalmazás szintű `MQTT DISCONNECT`. Alapvetően az eszköz hirtelen lezárta az alapul szolgáló szoftvercsatorna-kapcsolatát. Időnként ezt a problémát az Azure IoT SDK régebbi verzióiban felmerülő hibák okozzák.
