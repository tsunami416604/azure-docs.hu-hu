...
HTTP megvalósítja a hitelesítési érvényes token-ot a **engedélyezési** kérelemfejlécet.
...
* A MQTT, az AMQP vagy a HTTP-felületek közvetlen használatát.
...
| {URL-kódolású-resourceURI} |Alacsonyabb eset az URL-kódolást a nagybetűs erőforrás URI |
...
> [!NOTE]
> A .NET használatával SAS-jogkivonat készítése lehet [eszköz explorer] [ lnk-device-explorer] eszköz vagy a platformfüggetlen, csomópont-alapú [IOT hubbal-explorer] [ lnk-iothub-explorer] parancssori segédprogram.
...
Most már rendelkezik megtudta, hogyan való hozzáférést az IoT-központ, a következő IoT Hub fejlesztői útmutató témakörei iránt érdeklődik esetleg:
