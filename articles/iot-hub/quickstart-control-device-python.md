...
1. Egy terminálablakban keresse meg a Python-mintaprojekt gyökérmappáját. Ezután lépjen a **Quickstarts\simulated-device-2** mappába.
...
1. Egy másik terminálablakban keresse meg a Python-mintaprojekt gyökérmappáját. Ezután lépjen a **Quickstarts\back-end-application** mappába.

1. Nyissa meg a **BackEndApplication.py** fájlt egy Ön által választott szövegszerkesztőben.

    Cserélje le az `CONNECTION_STRING` változó értéket a szolgáltatás korábban lejegyzett kapcsolati karakterláncára. Mentse a **BackEndApplication.py** fájl módosításait.
...
> [Oktatóanyag: Telemetria irányítása különböző végpontokra feldolgozás céljából](iot-hub-python-python-process-d2c.md)