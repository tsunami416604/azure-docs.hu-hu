...
2.  Használja a [adb](https://developer.android.com/studio/command-line/adb) eszközzel csatlakozzon az Android dolgot eszközre a fentebb feltüntetett IP-címmel.  Ellenőrizze a kapcsolatot a következő paranccsal a terminálról.  Megjelenik az "csatlakoztatva" állapottal eszközök
    ```
    adb devices
    ```
