...
Az esemény rács integrációra van nyilvános előzetes verziójában, ezért nem áll rendelkezésre régiók száma korlátozott. Az integráció a következő régiókban található IoT-központok működik:
...
IoT Hub esemény-előfizetések szűrhetők az események esemény típusa és az eszköz neve alapján. Az esemény rács munkálatok tárgy szűrők alapján **előtag** és **utótag** megegyezik, így az előfizető kézbesíti az eseményeket egy egyező témát. 
