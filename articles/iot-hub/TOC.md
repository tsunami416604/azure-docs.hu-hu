...
#### [Adafruit Feather HUZZAH ESP8266 és Arduino IDE](iot-hub-arduino-huzzah-esp8266-get-started.md)
...
## [Node.js (Eszközök)](https://docs.microsoft.com/en-us/javascript/api/azure-iot-device/)
## [Node.js (Szolgáltatás)](https://docs.microsoft.com/en-us/javascript/api/azure-iothub)
