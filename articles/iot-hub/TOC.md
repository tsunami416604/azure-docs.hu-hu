...
# Első lépések
## Első lépések a szimulált eszközökkel
...
## [Ikereszközök – első lépések (Node)](iot-hub-node-node-twin-getstarted.md)
## [Ikereszközök – első lépések (.NET/Node)](iot-hub-csharp-node-twin-getstarted.md)
## [Közvetlen metódusok használata a Node.js-ben](iot-hub-node-node-direct-methods.md)
## [Közvetlen metódusok használata a .NET/Node-ban](iot-hub-csharp-node-direct-methods.md)
## [Eszközfelügyelet a Node.js-ben – első lépések](iot-hub-node-node-device-management-get-started.md)
## [Eszközfelügyelet a .NET/Node-ban – első lépések](iot-hub-csharp-node-device-management-get-started.md)
## [Az ikertulajdonságok használata (Node)](iot-hub-node-node-twin-how-to-configure.md)
## [Az ikertulajdonságok használata (.NET/Node)](iot-hub-csharp-node-twin-how-to-configure.md)
## [Eszközfeladatok használata az eszköz belső vezérlőprogramjának frissítéséhez a Node.js-ben](iot-hub-node-node-firmware-update.md)
