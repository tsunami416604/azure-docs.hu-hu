...
| [Python](https://github.com/Azure/azure-iot-sdk-python/tree/master/azure-iot-device/samples) | Alapértelmezés szerint a MQTT támogatja | `websockets=True` hozzáadása az ügyfél létrehozásához szükséges hívásban |
