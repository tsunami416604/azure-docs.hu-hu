...
- [Azure IoT 裝置 SDK c][] ANSI C (C99) 以撰寫可攜性和廣泛的平台相容性。
...
這 [文件][OS Platforms and hardware compatibility] 描述具有不同的 OS 平台，以及包含在特定裝置設定的裝置 Sdk 的相容性 [IoT 程式的 Microsoft Azure 認證][]。
