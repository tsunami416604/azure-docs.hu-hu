---
title: OData search.in-függvény referenciája – Azure Search
description: A OData search.in függvényt Azure Search lekérdezésekben.
ms.date: 06/13/2019
services: search
ms.service: search
ms.topic: conceptual
...
ms.locfileid: "69647938"
---
# <a name="odata-searchin-function-in-azure-search"></a>OData `search.in` függvény Azure Search
...
> [!NOTE]
> A OData standard 4,01-es verziója nemrég bemutatta a [ `in` kezelőt](https://docs.oasis-open.org/odata/odata/v4.01/cs01/part2-url-conventions/odata-v4.01-cs01-part2-url-conventions.html#_Toc505773230), amely hasonló viselkedést tartalmaz `search.in` a Azure Search függvényében. A Azure Search azonban nem támogatja ezt az operátort, ezért Ehelyett a `search.in` függvényt kell használnia.
...
> [Azure Search OData szintaxisának diagramja](https://azuresearch.github.io/odata-syntax-diagram/#search_in_call)
...
Ha használja `search.in`, akkor várható, hogy a második paraméterben a másodpercben megadott idő több száz vagy ezer értékből álló listát tartalmaz. Az átadható elemek `search.in`száma nincs kifejezett korláttal, de a kérések maximális mérete továbbra is korlátozott. Azonban a késés növekedni fog, ahogy az értékek száma növekszik.
