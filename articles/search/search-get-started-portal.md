...
description: Ebből a portálból megtudhatja, hogyan használhatja az adatimportálás varázslót az első keresési index létrehozásához, betöltéséhez és lekérdezéséhez az Azure Cognitive Searchban.
author: tchristiani
manager: nitinme
ms.author: terrychr
