<properties
    pageTitle="Az Azure Search REST API-k értékelése és tesztelése a Fiddler használatával | Microsoft Azure | Üzemeltetett felhőalapú keresőszolgáltatás"
...
3. A **Szerkesztő** lapon állítson össze egy, az alábbi képernyőfelvételen láthatóhoz hasonló kérelmet.

    ![][1]

2. Válassza a **PUT** lehetőséget.

3. Adja meg a szolgáltatás URL-címét, a kérelem attribútumait, valamint az API-verziót meghatározó URL-címet. Ügyeljen az alábbiakra:
