...
6. 程式的其餘部分會使用 [Azure 搜尋管理 REST API](http://msdn.microsoft.com/library/dn832684.aspx)。 請注意， `api 版本` 這個 API 是 Azure 資源管理員 api 版本不同。 例如， `/listAdminKeys? api 版本 = 2014年-07-31-預覽` 顯示 `api 版本` Azure 搜尋管理 REST api。
