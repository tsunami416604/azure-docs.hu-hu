...
A következő EBNF ([Extended Backus-Naur Form](https://en.wikipedia.org/wiki/Extended_Backus–Naur_form)) a és függvények nyelvtanát határozza meg `search.ismatch` `search.ismatchscoring` :
