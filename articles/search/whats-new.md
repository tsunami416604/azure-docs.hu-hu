...
| [Felügyelet .NET SDK 4,0](/dotnet/api/overview/azure/search/management) | .NET SDK | Az Azure SDK frissítése a Management SDK-hoz, az 2020-08-01-es verzió megcélozva REST API. | Általánosan elérhető. |
...
| [Okapi BM25 relevanciás algoritmus](index-ranking-similarity.md) | Lekérdezés | Az új relevancia-rangsorolási algoritmus automatikusan használatban van minden új, július 15. után létrehozott keresési szolgáltatáshoz. A korábban létrehozott szolgáltatások esetében a `similarity` tulajdonságot a tárgymutató mezőinek beállításával engedélyezheti. | Általánosan elérhető. </br> Használja a [Search REST API 2020-06-30](/rest/api/searchservice/) vagy újabb, vagy REST API 2019-05-06. |
...
| [a featuresMode relevancia pontszámának bővítése (előzetes verzió)](index-similarity-and-scoring.md#featuresMode-param) | Lekérdezés | Adja hozzá ezt a lekérdezési paramétert a relevancia pontszám kibontásához a további részletek megjelenítéséhez: mező szerinti hasonlósági pontszám, mező szerinti kifejezés gyakorisága, valamint az egyedi tokenek által egyeztetve. <br/><br/>Az egyéni pontozási algoritmusok ezt az információt használhatják. A *Range algoritmusok megismerése* egy speciális egyéni pontozási képesség, amely akkor valósítható meg, ha a releváns pontszám részleteit adja meg. A képességet bemutató minta: a [Machine learning (LearnToRank) hozzáadása a relevancia kereséséhez](https://github.com/Azure-Samples/search-ranking-tutorial). | Nyilvános előzetes verzió. </br> Használja a [Search REST API 2020-06-30 – Preview](/rest/api/searchservice/index-preview) vagy REST API 2019-05-06-Preview lehetőséget. |
...
## <a name="2019-feature-announcements"></a>2019 funkció bejelentései
