---
title: Egyéni elemzők hozzáadása karakterlánc-mezőkhöz indexben
...
ms.locfileid: "72790161"
---
# <a name="add-custom-analyzers-to-an-azure-cognitive-search-index"></a>Egyéni elemzők hozzáadása egy Azure Cognitive Search indexhez
...
## <a name="overview"></a>Áttekintés
 ...
 Az Azure Cognitive Search-ban előre definiált nyelvtől független elemzők közül választhat az [elemzők](#AnalyzerTable) táblában, illetve a Language [analyzers &#40;Azure Cognitive Search Service Rest APIban&#41;](index-add-language-analyzers.md)felsorolt nyelvspecifikus elemzők közül. Lehetősége van saját egyéni elemzők definiálására is.  
...
## <a name="create-custom-analyzers"></a>Egyéni elemzők létrehozása
 ...
 A `tokenizer_name` egy tokenizer neve, `token_filter_name_1` és `token_filter_name_2` a jogkivonat-szűrők nevei, a `char_filter_name_1` és a `char_filter_name_2` a char Filters ( [Tokenizers](#Tokenizers), [token Filters](#TokenFilters) and char Filters Tables for valid Values).
...
|Type (Típus)|Elemző típusa a támogatott elemzők listájából. Tekintse meg az alábbi [elemzők](#AnalyzerTable) tábla **analyzer_type** oszlopát.|  
...
|-|-|  
|Név|Csak betűket, számokat, szóközöket, kötőjeleket vagy aláhúzásokat tartalmazhat, csak alfanumerikus karakterrel kezdődhet és végződhet, és legfeljebb 128 karakter hosszú lehet.|  
|Type (Típus)|A következőnek kell lennie: "#Microsoft. Azure. Search. CustomAnalyzer".|  
...
|-|-|  
|Név|Csak betűket, számokat, szóközöket, kötőjeleket vagy aláhúzásokat tartalmazhat, csak alfanumerikus karakterrel kezdődhet és végződhet, és legfeljebb 128 karakter hosszú lehet.|  
|Type (Típus)|Char Filter típus a támogatott char-szűrők listájából. Lásd a **char_filter_type** oszlopot az alábbi [char Filters](#char-filters-reference) táblázatban.|  
...
|-|-|  
|Név|Csak betűket, számokat, szóközöket, kötőjeleket vagy aláhúzásokat tartalmazhat, csak alfanumerikus karakterrel kezdődhet és végződhet, és legfeljebb 128 karakter hosszú lehet.|  
|Type (Típus)|A Tokenizer neve a támogatott tokenizers listájáról. Tekintse meg a **tokenizer_type** oszlopot az alábbi [Tokenizers](#Tokenizers) táblázatban.|  
...
|-|-|  
|Név|Csak betűket, számokat, szóközöket, kötőjeleket vagy aláhúzásokat tartalmazhat, csak alfanumerikus karakterrel kezdődhet és végződhet, és legfeljebb 128 karakter hosszú lehet.|  
|Type (Típus)|A jogkivonat-szűrő neve a támogatott jogkivonat-szűrők listájából. Tekintse meg az alábbi **token_filter_type** oszlopot a [jogkivonat-szűrők](#TokenFilters) táblázatban.|  
...
|**analyzer_name**|<sup>1</sup> . analyzer_type|**Leírás és beállítások**|  
|-|-|-|  
...
|**char_filter_name**|<sup>1</sup> . char_filter_type|**Leírás és beállítások**|  
|-|-|-|
...
|**tokenizer_name**|<sup>1</sup> . tokenizer_type|**Leírás és beállítások**|  
|-|-|-|  
...
|**token_filter_name**|<sup>1</sup> . token_filter_type|**Leírás és beállítások**|  
|-|-|-|  
...
## <a name="see-also"></a>Lásd még:  
 [Azure Cognitive Search REST API](https://docs.microsoft.com/rest/api/searchservice/) -k   
 [Elemzők az Azure-ban Cognitive Search > példákat](search-analyzers.md#examples)    
