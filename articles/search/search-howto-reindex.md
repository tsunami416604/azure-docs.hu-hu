...
4. [Frissítési indexre](https://docs.microsoft.com/rest/api/searchservice/update-index) vonatkozó kérés küldése az Azure-Cognitive Search index fizikai kifejezésének újraépítéséhez. 
