...
+ Hozzon létre intuitív keresési funkciókat értékkorlátozó navigációs és szűrőket, szinonimák, automatikus kiegészítés és a szöveg elemzése "javaslat" automatikusan kijavíthatók keresési feltételek.
