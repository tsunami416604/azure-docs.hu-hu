...
Az intelligens keresés hasonló szerkezetű egyezéseket keres, és egy kifejezést legfeljebb 50 kifejezésre bővít, amelyek két vagy kevesebb távolsági feltételnek felelnek meg. További információ: [Fuzzy search](search-query-fuzzy.md).
