...
根據預設，所有可搜尋的欄位使用 [Lucene 標準分析器](http://lucene.apache.org/core/4_10_0/analyzers-common/org/apache/lucene/analysis/standard/StandardAnalyzer.html) 其中具有語言中立性。 若要檢視支援的分析器的完整清單，請參閱 [Azure 搜尋服務中的語言支援](https://msdn.microsoft.com/library/azure/dn879793.aspx)。
...
`https://[service name].search.windows.net/indexes/[index 名稱] / 文件? 搜尋 = darmowy searchFields = description_pl api 版本 = 2015年-02-28`
...
`https://[service name].search.windows.net/indexes/[index 名稱] / 文件? 搜尋 = Microsoft scoringProfile = englishFirst api 版本 = 2015年-02-28`
