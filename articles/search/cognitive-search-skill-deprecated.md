---
title: Elavult kognitív képességeket (Azure Search) |} A Microsoft Docs
...
ms.locfileid: "52449943"
---
#    <a name="deprecated-cognitive-seach-skills"></a>Elavult Cognitive értesítés keresése képességek

Ez a dokumentum ismerteti a kognitív képességeket, amelyek tekinthetők elavult. Használja az útmutató tartalma:

* Ismeretek neve: El fognak évülni szakértelem nevével vannak leképezve a @odata.type attribútum.
* Utolsó elérhető api-verzió: a nyilvános API-t, mely szakértelmével keresztül a megfelelő tartalmazó elavult szakértelem létrehozott vagy frissítheti az Azure search a legutóbbi verzióját.
* Támogatás vége: az elmúlt nap elteltével a megfelelő szakértelmet számít nem támogatott. Korábban létrehozott ismereteket kell továbbra is működik, de felhasználók ajánlott elavult szakértelem migrálni.
