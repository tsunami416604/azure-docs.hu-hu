...
- [Azure 搜尋](http://azure.microsoft.com/services/search/)
...
> [AZURE.NOTE] 沒有在 Azure 搜尋服務最近引入原型索引子功能。 在我們第一個版本中，這個功能因為太晚出現而沒辦法讓我們使用，但它貌似可解決我們之前用索引子工作所解決的相同問題，也就是自動化資料載入作業。
...
> [AZURE.NOTE] 除了將經過處理的資料，協助我們已經建置原型的了解搜尋科技如何運作，讓我們更有生產力，也更讚賞的內建功能。 如果您需要加強搜尋查詢建構、多面向導覽和篩選器等，也許您要在原型階段花更多時間。 
