...
-   [Overview of Hudson][Overview of Hudson]
-   [Benefits of using the Blob service][Benefits of using the Blob service]
-   [Prerequisites][Prerequisites]
-   [How to use the Blob service with Hudson CI][How to use the Blob service with Hudson CI]
...
## <span id="overview"></span></a><span class="short header">Overview</span>Overview of Hudson
...
More information about Hudson can be found at [Meet Hudson][Meet Hudson].

## <span id="benefits"></span></a><span class="short header">Benefits</span>Benefits of using the Blob service
...
## <span id="prerequisites"></span></a><span class="short header">Prequisites</span>Prequisites
...
## <span id="howtouse"></span></a><span class="short header">How to use Blob service</span>How to use the Blob service with Hudson CI
...
## <span id="howtoinstall"></span></a><span class="short header">How to install</span>How to install the Azure Storage plugin
...
## <span id="howtoconfigure"></span></a><span class="short header">How to configure</span>How to configure the Azure Storage plugin to use your storage account
...
## <span id="howtocreatepostbuild"></span></a><span class="short header">How to create post-build action</span>How to create a post-build action that uploads your build artifacts to your storage account
...
## <span id="components"></span></a><span class="short header">Blob service components</span>Components used by the Blob service
