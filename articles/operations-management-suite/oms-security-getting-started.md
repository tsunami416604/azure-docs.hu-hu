<properties
   pageTitle="Az Operations Management Suite biztonsági és auditálási megoldás használatának első lépései | Microsoft Azure"
...
> [AZURE.NOTE] Az ügynök összegyűjti az adatokat – például a számítógép nevét, az IP-címet és a felhasználó nevét – az aktuális és engedélyezett események alapján. Nem gyűjt azonban dokumentumokat vagy fájlokat, adatbázisneveket, illetve személyes adatokat.   
...
> [AZURE.NOTE] Ha további információkat szeretne arról, hogyan védi meg az OMS az adatait, olvassa el az OMS használatával végzett adatvédelmet ismertető cikket.
...
> [AZURE.NOTE] Az adatmegőrzés az OMS-díjcsomag szerint alakul. További információkért keresse fel a [Microsoft Operations Management Suite](https://www.microsoft.com/server-cloud/operations-management-suite/pricing.aspx) árképzését ismertető oldalt.
...
> [AZURE.NOTE] Az OMS keresési lekérdezéseivel kapcsolatos további információkért olvassa el az [OMS keresési referenciáját bemutató cikket](https://technet.microsoft.com/library/mt450427.aspx).
...
> [AZURE.NOTE] a *rang* olyan helyezés, amelyet a rendszer a védelem állapota (bekapcsolt, kikapcsolt, frissített stb.), illetve a talált fenyegetések alapján állapít meg. Ennek számszerűsítése segíti az összesítést.
...
> [AZURE.NOTE] a frissítési megoldással kapcsolatos további információkért olvassa el [a kiszolgálók Rendszerfrissítések megoldással történő frissítését ismertető cikket](https://technet.microsoft.com/library/mt484096.aspx).
...
> [AZURE.NOTE] jelenleg az adatok csak a biztonsági események bejelentkezési adatain (4624-es eseményazonosító) alapulnak, a jövőben azonban az Office365-bejelentkezések és az Azure AD-adatok is bekerülnek a felhasznált adatok körébe.
