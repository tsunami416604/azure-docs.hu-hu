<properties
    ...
    description="Azure Media Hyperlapse 從第一個人或動作相機內容建立平滑的時間屆滿影片。本主題說明如何使用 Media Indexer。"
...
> [AZURE.NOTE] 為了使程式碼可以運作，您應該已經具備在名稱為「context」之範圍內的 CloudMediaContext。 若要深入了解，閱讀 [內容管理文章](media-services-manage-content.md)。
