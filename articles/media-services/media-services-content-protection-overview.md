...
[做為服務和 AES 動態加密，使用 Azure 媒體服務宣告 PlayReady](http://mingfeiy.com/playready)

[Azure 媒體服務 PlayReady 授權傳遞定價說明](http://mingfeiy.com/playready-pricing-explained-in-azure-media-services)

[如何偵錯 Azure 媒體服務的 AES 加密的資料流](http://mingfeiy.com/debug-aes-encrypted-stream-azure-media-services)
