...
A következő C# kód bemutatja, hogyan hozhat létre adatfolyam-keresőt, és hogyan határozhat meg `StreamingLocator.Filters`. Ez egy nem kötelezően megadandó tulajdonság, amely `IList<string>` a szűrők nevét.
