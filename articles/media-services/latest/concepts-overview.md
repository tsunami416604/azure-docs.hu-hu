...
> [!NOTE]
> Jelenleg a [Azure Portal](https://portal.azure.com/) használható a következőhöz: Media Services v3 [élő események](live-events-outputs-concept.md), View (nem felügyelt) v3- [eszközök](assets-concept.md)kezelése, valamint az API-k [elérésére vonatkozó információk beszerzése](access-api-portal.md).
