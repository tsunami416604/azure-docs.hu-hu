...
---
# <a name="create-and-monitor-media-services-events-with-event-grid-using-the-azure-portal"></a>Media Services események létrehozása és figyelése Event Grid használatával a Azure Portal
