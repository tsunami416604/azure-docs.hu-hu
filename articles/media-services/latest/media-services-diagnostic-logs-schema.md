...
Részletes információkért lásd: [Azure Monitor-metrikák](../../azure-monitor/platform/data-collection.md) és [Azure Monitor-diagnosztikai naplók](../../azure-monitor/platform/diagnostic-logs-overview.md).
