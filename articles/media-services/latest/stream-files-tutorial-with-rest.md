...
Részletes információkat a [hitelesítő adatok Beszerzése Media Services API eléréséhez](access-api-howto.md) című témakörben talál.
...
3. Kattintson a **Küldés** gombra.
    ...
    * A rendszer a következő **put** műveletet elküldi:
