...
Media Services erőforrásnevek nem tartalmazhatják a következőket: "<", ">", "%", "&", ":"&#92;, "", "?", "/", "*", "+", ".", a szimpla idézőjel karakter vagy bármely vezérlőelem-karakter. Minden egyéb karakter engedélyezett. Az erőforrásnév maximális hossza 260 karakter.
