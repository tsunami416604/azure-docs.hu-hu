...
A kulcs eléréséhez használja a `GetPolicyPropertiesWithSecretsAsync`t, ahogyan az az [aláíró kulcs beolvasása a meglévő házirendből](get-content-key-policy-dotnet-howto.md#get-contentkeypolicy-with-secrets) című ábrán látható.
