...
A következő REST-dokumentum részletesen ismerteti a [feladatokkal kapcsolatos hibakódokat](/rest/api/media/jobs/get#joberrorcode).
...
- [Streaming Endpoint hibakódok](streaming-endpoint-error-codes.md)
