...
請注意，除了能夠使用動態封裝功能，隨選串流保留單元提供您專用傳出功能，此功能可以以 200 Mbps 為增量來購買。 根據預設，隨選串流是以共用執行個體模型設定哪些伺服器資源 (例如，運算、 流出容量等) 與所有其他使用者共用。 若要改進隨選串流輸送量，建議購買隨選串流保留單元。
...
- [使用 PlayReady DRM 保護](media-services-rest-deliver-streaming-content.md)
- [使用 AES 128 金鑰保護](media-services-protect-with-aes128.md)
