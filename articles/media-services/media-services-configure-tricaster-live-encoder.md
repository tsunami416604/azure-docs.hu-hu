...
1. 建立新 **NewTek TriCaster** 根據所使用的是何種視訊輸入的來源的專案。 
2. 一次在該專案中，找到 **資料流** ] 按鈕，然後按一下齒輪圖示，就可以存取資料流組態] 功能表。

    ![tricaster](./media/media-services-tricaster-live-encoder/media-services-tricaster3.png)
3. 一旦已開啟功能表，按一下 [ **新增** 連接標題底下。 當系統提示您選擇的連線類型，選取 **Adobe Flash**。

    ![tricaster](./media/media-services-tricaster-live-encoder/media-services-tricaster4.png)

4. 按一下 [ **確定**。

5. FMLE 設定檔可以立即匯入的下拉式清單底下的箭號，即可 **串流的設定檔** 並巡覽至 **瀏覽**。
...
6. 取得通道的輸入 URL，以便將它指派給 Tricaster **RTMP 端點**。
...
7. 貼上這項資訊 **位置** 欄位底下 **Flash 伺服器** Tricaster 專案內。 也指派中的資料流名稱 **資料流識別碼** 欄位。 

    如果資料流資訊已新增至 FMLE 設定檔，也能匯至這個區段，即可 **匯入設定**, 、 瀏覽至儲存 FMLE 設定檔，然後按一下 **確定**。 相關的 [Flash Server] 欄位應該填入 FMLE 的資訊。

    ![tricaster](./media/media-services-tricaster-live-encoder/media-services-tricaster7.png)

9. 完成時，按一下 [ **確定** 螢幕的底部。 視訊和音訊的輸入內容 Tricaster 準備好時，開始依序按一下串流處理至 AMS **資料流** ] 按鈕。
