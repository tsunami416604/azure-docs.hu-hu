...
#### <a id="LinkContentKeyAuthorizationPoliciesWithOptions"></a>ContentKeyAuthorizationPolicies csatolása lehetőségekkel
Kérés:
...
#### <a id="AddAuthorizationPolicyToKey"></a>Engedélyezési szabályzat hozzáadása a tartalmi kulcshoz
Kérés:
...
#### <a id="schema"></a>Jogkivonat-korlátozási séma
