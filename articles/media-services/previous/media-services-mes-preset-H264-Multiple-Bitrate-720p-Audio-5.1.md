---
title: H264 Többszörös bitráta 720p Audio 5.1 | Microsoft dokumentumok
description: A témakör a **H264 Többszörös bitráta 720p Audio 5.1** feladatkészlet andverview nézetét adja.
author: Juliako
manager: femila
editor: ''
...
`Media Encoder Standard`meghatározza a kódolási feladatok létrehozásakor használható kódolási készleteket. Az a segítségével `preset name` megadhatja, hogy milyen formátumba szeretné kódolni a médiafájlt. Vagy létrehozhat saját JSON- vagy XML-alapú készleteket (UTF-8 vagy UTF-16 kódolással. Ezután adja át az egyéni készletet a kódolónak. A `Media Encoder Standard` kódoló által támogatott összes előre beállított név listáját a [Media Encoder Standard feladatkészletek című témakörében tartalmazza.](media-services-mes-presets-overview.md)  
 ...
 Ez a `H264 Multiple Bitrate 720p Audio 5.1` témakör az előre beállított xml és JSON formátumban jelenik meg.  
  
 Ez az előre beállított készlet 6 GOP-hoz igazított MP4-fájlt hoz létre, 3400 kbit/s-tól 400 kbps-ig terjedő sebességgel, valamint AAC 5.1-es hangfájlokat. Az előre beállított profillal, bitrátával, mintavételi sebességgel stb. Az egyes elemek jelentéseiről és az egyes elemek érvényes értékeinek magyarázatáról a [Media Encoder Standard sémában](media-services-mes-schema.md)lehet eltekinteni.  
