...
> [!NOTE]
> A különböző régiókban található Azure Media Services-funkciók elérhetőségével kapcsolatos további információkért lásd: [AMS-szolgáltatások régiók között](availability-regions-v-2.md).
