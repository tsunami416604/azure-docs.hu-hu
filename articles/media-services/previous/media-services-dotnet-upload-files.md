...
ms.locfileid: "55984222"
---
# <a name="upload-files-into-a-media-services-account-using-net-legacy"></a>Fájlok feltöltése Media Services-fiók használata a .NET (örökölt)
