...
* [A Java ügyfél-SDK használatának első lépései az Azure Media Services](https://docs.microsoft.com/azure/media-services/media-services-java-how-to-use)
