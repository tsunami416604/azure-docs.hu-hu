...
Egy lokátor lejárati dátumának frissítéséhez használja a [REST API](/rest/api/media/operations/locator#update_a_locator) vagy a [.NET API](/dotnet/api/microsoft.windowsazure.mediaservices.client.ilocator)-t. 
