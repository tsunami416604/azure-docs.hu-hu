---
title: HTTP-bővítmény adategyezménye – Azure
description: Ebből a cikkből megtudhatja, hogyan lehet HTTP protokollt használni az élő videó elemzési modulja és az AI-vagy CV-modulja közötti üzenetek küldéséhez.
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88691866"
---
# <a name="http-extension-data-contract"></a>HTTP-bővítmény adategyezménye

Ebből a cikkből megtudhatja, hogyan lehet HTTP protokollt használni az élő videó elemzési modulja és az AI-vagy CV-modulja közötti üzenetek küldéséhez.
...
![osztály-hierarchia](./media/http-data-contract/class-hierarchy.png)
