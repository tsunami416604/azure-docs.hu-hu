...
2. 連接至媒體服務 URI 
    ...
    >[AZURE.NOTE] 順利連接到 https://media.windows.net 之後, 您會收到指定另一個媒體服務 URI 的 301 重新導向。 後續的呼叫必須送到新的 URI。
...
請注意必須經過 URL 編碼的媒體服務帳戶的 AccountKey (請參閱 [Percent-encoding](http://tools.ietf.org/html/rfc3986#section-2.1) 使用它做為存取權杖要求中 client_secret 值時。
...
>[AZURE.NOTE] 一旦您熟悉新的 URI，這是應該用來與媒體服務的 URI。 
