...
## <a id="create_ams"></a>建立媒體服務帳戶使用入口網站
...
## <a id="connect"></a>連接到媒體服務帳戶，使用 REST API
...
## <a id="upload"></a>建立新資產並上傳視訊檔案，使用 REST API
...
- 取得至少一個串流單元 ** 串流端點 **從您打算傳遞內容 (如本節所述)。
...
## <a id="encode"></a>將來源檔案編碼成一組調適性位元速率 MP4 檔案
...
## <a id="publish_get_urls"></a>發行資產及取得串流和漸進式下載 Url 使用 REST API
...
- <a href="http://channel9.msdn.com/Shows/Azure-Friday/Azure-Media-Services-101-Get-your-video-online-now-">Azure Media Services 101-立即取得您的線上影片!</a>
