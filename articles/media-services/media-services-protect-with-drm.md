...
>[AZURE.NOTE]Objektumtovábbítási szabályzat hozzáadásakor vagy módosításakor törölnie kell az ahhoz tartozó meglévő lokátort (ha van), majd létre kell hoznia egy új lokátort.
...
1. A NuGet segítségével telepítse, majd adja hozzá az Azure Media Services .NET SDK-t.
2. Adja hozzá a további referenciákat: System.Configuration.
2. Adja hozzá a fióknevet és a kulcsadatokat tartalmazó konfigurációs fájlt:
...
1. Szerezzen be legalább egy streamelési egységet a tartalom továbbításához használni kívánt streamvégpontra. További információkért lásd a [streamvégpontok konfigurálását bemutató részt](media-services-dotnet-get-started.md#configure-streaming-endpoint-using-the-portal).

1. Írja felül a Program.cs fájlban található kódot az itt látható kóddal.
