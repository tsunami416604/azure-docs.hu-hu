...
您可以使用 [castLabs](http://castlabs.com/company/partners/azure/) 將 Widevine 授權傳遞。 如需詳細資訊，請參閱 [到 Azure 媒體服務使用 castLabs 將 DRM 授權](media-services-castlabs-integration.md)
