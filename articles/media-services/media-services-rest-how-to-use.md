...
---|---|---
 ...
 Accept| 內容類型| 要求的內容類型，如下所示的回應:<p> -application/json; odata = verbose<p> -application/atom + xml<p> 回應可能會有不同的內容類型，如 blob 擷取，成功的回應會包含 blob 資料流，做為裝載的位置。
 ...
 client-request-id| String| 呼叫端定義的值，識別指定的要求。如果指定，回應訊息中將包含此值以做為對應要求的方式。<p><p>**重要**<p>值應限定在 2096b (2k)。
