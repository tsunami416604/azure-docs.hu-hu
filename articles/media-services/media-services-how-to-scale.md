...
如需詳細資訊，請參閱 [跨多個儲存體帳戶管理媒體服務資產](https://msdn.microsoft.com/library/azure/dn271889.aspx) 和 [使用 Azure 儲存體](https://msdn.microsoft.com/library/azure/dn767951.aspx)。
