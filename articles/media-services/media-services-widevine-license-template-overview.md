...
| policy_overrides. renewal_delay_seconds |Int64 |Hány másodperc után license_start_time, megújítási először megkísérlése előtt. Ha igaz can_renew csak használja ezt a mezőt. Alapértelmezett érték a 0 |
