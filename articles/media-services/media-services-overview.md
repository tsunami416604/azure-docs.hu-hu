...
3. (選擇性) 設定開發環境。 針對開發環境選擇 .NET 或 REST API。 如需詳細資訊，請參閱 [設定環境](media-services-dotnet-how-to-use.md)。
    ...
    此外，了解如何以程式設計方式連接 [連線](media-services-dotnet-connect_programmatically.md)。
...
- [如何監控工作](media-services-portal-check-job-progress.md)
- [如何建立內容索引](media-services-manage-content.md#index)
- [如何保護內容](media-services-manage-content.md#encrypt)
- [如何保護發行](media-services-manage-content.md#publish)
- [如何調整編碼](media-services-portal-encoding-units.md)

## <a id="live_scenarios"></a>提供使用 Azure 媒體服務即時串流事件
