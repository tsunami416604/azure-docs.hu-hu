...
本文說明 **區段** ] 索引標籤的 **Mobile Engagement** 入口網站。 您使用 **Mobile Engagement** 入口網站來監視和管理行動應用程式。 請注意，若要使用入口網站您首先需要建立 **Azure Mobile Engagement** 帳戶。 如需詳細資訊，請參閱 [建立 Azure Mobile Engagement 帳戶](mobile-engagement-create-account.md)。
