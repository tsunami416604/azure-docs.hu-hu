...
接下來，在您的專案上安裝新的 Microsoft Azure Engagement nuget 封裝。 您可以找到它直接依據 [Nuget](http://www.nuget.org/packages/MicrosoftAzure.MobileEngagement)。 此動作會取代所有 Engagement 使用的資源檔，並將新的 Engagement DLL 新增到您專案的「參考」。
