...
| --- | --- |
| INTERNET |Szükséges. Alapszintű jelentéskészítéshez |
| ACCESS_NETWORK_STATE |Szükséges. Alapszintű jelentéskészítéshez |
| RECEIVE_BOOT_COMPLETED |Szükséges. Az értesítések központ megjelennek az eszköz újraindítását követően. |
