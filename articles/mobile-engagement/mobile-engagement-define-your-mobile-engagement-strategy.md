<properties
    pageTitle="A Mobile Engagement-stratégia kidolgozása | Microsoft Azure"
...
## A Mobile Engagement segítséget nyújt a céljai megvalósításához
...
### Használati esetek az első lépésekhez
...
## Miért van szüksége elemzésekre a bevonáshoz?
...
>[AZURE.NOTE] Emlékezzen erre: A túl sok adat használhatatlanná teszi az adatokat!

### Használati esetek és ajánlott eljárások
...
### Hogyan hozhatunk létre remek címkézési tervet?
