<properties
    pageTitle="Ismerkedés az Azure Mobile Engagement Xamarin.iOS-alkalmazásokkal való használatával"
...
3. Töltse ki az **App Name** (Alkalmazás neve) és az **Organization Identifier** (Szervezeti azonosító) mezőt, majd kattintson a **Next** (Tovább) gombra. 
    ...
    > [AZURE.IMPORTANT] Győződjön meg róla, hogy az iOS-alkalmazás majdani üzembe helyezéséhez használandó közzétételi profil olyan alkalmazásazonosítót használ, amely pontosan megegyezik az itt szereplő csomagazonosítóval. 
