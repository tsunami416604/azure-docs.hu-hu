...
*"John 是嚴重的美式足球風扇! 登入我們 NFL 一節，並有機會贏得免費存取 SuperBowl! 」*
...
* 「 大家好 Wes，其中一個您最愛的品牌的咖啡將會在銷售 25%的折扣 2015 年 9 月的第一週。 感謝您身為客戶並想要確定您已知道 >。*
...
2. **投票**：可讓您透過詢問使用者問題，向使用者收集資訊。 建立目標使用者的準則時，便可那些答案。
...
標記計劃不應標記應用程式中的所有項目。 它只應包含屬於行動業務開發策略的標記資料。 這可能隨著應用程式而有所不同。  [媒體腳本範本 ][media playbook link] 提供 Azure Mobile Engagement 可協助您建立的標記計劃與指定的方法。 請使用**標記計劃**工作表做為建置標記計劃的指南。
...
將 Azure Mobile Engagement SDK 整合到您的應用程式的逐步指示，請遵循  [Engagement SDK 整合](mobile-engagement-windows-store-integrate-engagement.md) Azure 網站上的文件。 請從位於該頁頂端的連結中選擇您的目標平台。
