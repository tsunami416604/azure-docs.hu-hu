<properties
   pageTitle="DNS-zóna létrehozása a parancssori felület (CLI) használatával| Microsoft Azure"
...
# Azure DNS-zóna létrehozása a parancssori felület használatával
...
## 1. lépés: Az Azure CLI beállítása
...
### 2. Kapcsolja át a parancssori felület működési módját
...
### 3. Jelentkezzen be az Azure-fiókjába
...
## 2. lépés: A DNS-zóna létrehozása
...
### DNS-zóna és címkék létrehozása
...
Ha az alábbi példában a parancsot a *myresourcegroup* erőforráscsoporttal, az *"@"* rekordhalmaz-névvel (gyökérrekordként) és a *SOA* típussal futtatja, akkor a kimenete a következő lesz:
...
>[AZURE.NOTE] A DNS-zóna gyökerében (más néven *legfelső pontján*) található rekordhalmazok az **@** karaktert használják a rekordhalmaz neveként.
