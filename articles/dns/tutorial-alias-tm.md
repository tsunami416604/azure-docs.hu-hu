...
6. Nyilvános bejövő portok esetében válassza a **http**  >  **https**  >  **RDP (3389)** lehetőséget, majd kattintson **az OK gombra**.
...
1. Válassza **az erőforrás létrehozása**  >  **hálózatkezelés**  >  **Traffic Manager profil**lehetőséget.
