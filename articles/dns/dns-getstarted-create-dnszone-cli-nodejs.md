---
title: "DNS-zóna létrehozása az Azure CLI 1.0 használatával| Microsoft Docs"
description: "Ez a témakör a DNS-zónák létrehozását ismerteti az Azure DNS-ben. Egy lépésenkénti útmutató, amelynek segítségével az Azure CLI 1.0 használatával létrehozhatja és kezelheti az első DNS-zónáját."
services: dns
...
# <a name="create-an-azure-dns-zone-using-azure-cli-10"></a>Azure DNS-zóna létrehozása az Azure CLI 1.0 használatával
