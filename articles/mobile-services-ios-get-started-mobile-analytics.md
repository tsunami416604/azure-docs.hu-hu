...
<tags ms.service="mobile-services" ms.workload="mobile" ms.tgt_pltfrm="mobile-multiple" ms.devlang="multiple" ms.topic="article" ms.date="10/10/2014" ms.author="mahender"></tags>
...
In this tutorial, you add mobile analytics capabilities to your app using [Capptain][Capptain]. Mobile Analytics allow you to determine how users are interacting with your app and what sections are driving the most activity. To start getting these data, you will instrument your app with the Capptain SDK.
...
1.  [Initialize the Capptain SDK][Initialize the Capptain SDK]
2.  [Overload UIViewController][Overload UIViewController]

This tutorial requires the following:

-   A [Capptain][Capptain] account
-   A [Mobile Services Standard tier][Mobile Services Standard tier] app
...
Find out more about what Capptain can do for your app at [][Capptain]<http://www.capptain.com></a>

<!-- Anchors. --> <!-- URLs. -->

  [iOS]: /en-us/documentation/articles/mobile-services-ios-get-started-mobile-analytics "iOS"
