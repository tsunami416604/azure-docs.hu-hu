...
4. Adja meg a kívánt értékeket a a **hozzon létre egy új Azure Container Registry**.
    ...
    | **Beállításjegyzékbeli hely** | Egy hely Önhöz | Válassza ki a hely egy [régió](https://azure.microsoft.com/regions/) Önhöz vagy a tároló-beállításjegyzék-t használó más szolgáltatások közelében. |
