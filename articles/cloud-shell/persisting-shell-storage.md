...
Megjegyzés: Ha szeretne egy függvény megadása egy fájlban, és adja neki a PowerShell-parancsmagokkal, majd a pont operátort kell foglalni. Például:. .\MyFunctions.ps1

## <a name="next-steps"></a>További lépések
[A bash Cloud Shell rövid](quickstart.md) <br>
[A PowerShell Cloud Shell rövid](quickstart-powershell.md) <br>
[További tudnivalók a Microsoft Azure Files storage:](https://docs.microsoft.com/azure/storage/storage-introduction) <br>
