...
description: Ismerje meg, részletezje és vizsgálja meg Azure Security Center IoT biztonsági riasztásait a IoT-eszközökön.
...
ms.locfileid: "88068565"
---
# <a name="quickstart-investigate-security-alerts"></a>Gyors útmutató: biztonsági riasztások vizsgálata

A IoT Azure Security Center által kiadott riasztások ütemezett vizsgálata és szervizelése a legjobb módszer a IoT-megoldások megfelelőségének és védelmének biztosítására.
...
A következő cikkből többet tudhat meg a Azure Security Center a riasztási típusokról és a lehetséges testreszabásokról...
