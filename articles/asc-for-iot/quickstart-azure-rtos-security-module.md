...
A IoT Hub Log Analytics betöltése alapértelmezés szerint ki van kapcsolva a IoT-megoldás Azure Security Center. Az Azure RTOS biztonsági moduljának használatának engedélyezéséhez tegye a következőket: 
