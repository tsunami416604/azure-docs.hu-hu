---
title: Biztonsági ügynök indítása –– problémamegoldás (Linux)
...
1. A beolvasási biztonsági ügynök hibaparancs lekéri az Azure Security Center az IoT-ügynök által létrehozott összes naplót. Az alábbi táblázat segítségével megismerheti a hibákat, és megtartható a javításhoz szükséges lépések.
...
1. Ha szükséges, ismételje meg az előző folyamatokat az ügynök leállításának kényszerítéséhez, és olvassa be a hibákat, ha az ügynök továbbra is sikertelen az indítási folyamaton.
