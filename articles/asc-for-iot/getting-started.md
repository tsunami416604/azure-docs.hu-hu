...
Ez a cikk a IoT szolgáltatás Azure Security Center különböző összetevőit ismerteti, és bemutatja, hogyan kezdheti meg a szolgáltatást két lehetséges üzembe helyezési lehetőség használatával.
...
A fokozott biztonsági képességekhez Azure Security Center IoT-ügynökök számára történő üzembe helyezése mellett a IoT Hub biztonság engedélyezése az ügynök-alapú események gyűjtését, elemzését és veszélyforrások észlelését teszi lehetővé a IoT-eszközökről, valamint a biztonsági helyzet átfogó felügyeleti képességeiről.
