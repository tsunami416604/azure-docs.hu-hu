...
Az **Azure DevOps Project** segítségével konfigurálhatja a folyamatos integrációs (CI) és folyamatos kézbesítési (CD) folyamatot egy Ruby on Rails-alkalmazáshoz.  Az Azure DevOps Project egyszerűsíti a Azure DevOps Services-build és a kiadási folyamat kezdeti konfigurációját.
