...
Az **Azure DevOps Project** segítségével konfigurálhatja a folyamatos integrációs (CI) és folyamatos kézbesítési (CD) folyamatot egy .NET Core- vagy ASP.NET-alkalmazáshoz.  Az Azure DevOps Project egyszerűsíti a VSTS-build és a kiadási folyamat kezdeti konfigurációját.
...
1. Hozzon létre egy **új** ingyenes VSTS-fiókot, vagy válasszon ki egy **meglévőt**.  Válasszon egy **nevet** a VSTS-projektnek.  Válassza ki az **Azure-előfizetését**, a **helyet**, és adjon egy **nevet** az alkalmazásnak.  Ha elkészült, kattintson a **Kész** gombra.
    ...
    ![VSTS-adatok megadása](_img/azure-devops-project-aspnet-core/vstsazureinfo.png)
...
1. Válassza a **Szerkesztés** elemet.
    ...
    ![Builddefiníció](_img/azure-devops-project-aspnet-core/builddef.png)
...
1. Válassza az **Eseményindítókat**.  Az Azure DevOps-projekt automatikusan létrehozott egy CI-eseményindítót, és az adattárban történő minden egyes véglegesítés létrehoz egy új buildet.  Lehetősége van belefoglalni az ágakat, vagy kizárni őket a CI-folyamatból.
