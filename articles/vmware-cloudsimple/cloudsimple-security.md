...
A CloudSimple szolgáltatás logikailag elkülöníti a 2. rétegbeli hálózatokat, amelyek korlátozzák a saját privát hálózatokhoz való hozzáférést a saját felhőalapú környezetében. A saját felhőalapú hálózatait tűzfal használatával tovább védetté teheti. A CloudSimple-portál lehetővé teszi az EW és az NS hálózati forgalom szabályozásának meghatározását az összes hálózati forgalomra vonatkozóan, beleértve a belső Felhőbeli forgalom, a belső felhőalapú forgalom, az internet felé irányuló hálózati forgalom, valamint a helyszíni hálózaton keresztül az IPsec VPN-hez vagy ExpressRoute-kapcsolatok.
...
Alapértelmezés szerint az ügyfelek a privát felhőben a vCenter napi műveleteihez szükséges jogosultságokat kapják meg. Ez a jogosultsági szint nem tartalmaz rendszergazdai hozzáférést a vCenter. Ha átmenetileg szükség van a rendszergazdai hozzáférésre, [](escalate-private-cloud-privileges.md) akkor a rendszergazdai feladatok elvégzése után a jogosultságokat korlátozott időtartamra is kiterjesztheti.
