...
ms.locfileid: "65160170"
---
# <a name="cloudsimple-node-quota-limits"></a>CloudSimple csomópont kvóta korlátját

Négy csomópont elérhető és megvásárolható kiadása, az alapértelmezett mennyiséget esetén CloudSimple szolgáltatás engedélyezve van az előfizetés.  Bármely vásárolhat [csomóponttípus](cloudsimple-node.md) Azure Portalról.  Három csomópont az azonos termékváltozatának legalább egy Magánfelhő létrehozásához szükségesek.  A csomópontok vásárolt, jelenhet meg hiba vásárolhat további csomópontokat megkísérlésekor.
...
* [Vásárlás csomópontok](create-nodes.md)
