...
5. A varázsló 3. lépésében adja meg az adattár nevét, az elérési utat és a kiszolgálót. Használhatja a Data Box IP-címét a kiszolgálóhoz. A mappa elérési útja a `/<StorageAccountName_BlockBlob>/<ContainerName>/` formátumban jelenik meg.
...
8. Rendeljen engedélyeket az ügyfél IP-címeihez az NFS-megosztás eléréséhez az `/etc/exports` fájl szerkesztésével.
