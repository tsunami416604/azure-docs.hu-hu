...
A számítási [feladatok migrálása a 2](migration-layer-2-vpn.md) . rétegbeli hálózatokkal című témakör leírja, hogyan használható 2. RÉTEGbeli VPN a 2. rétegbeli hálózat kiépítéséhez a helyi környezetből a saját felhőbe.
