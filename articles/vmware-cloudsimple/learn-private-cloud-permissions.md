...
> [!NOTE]
> Az CloudSimple saját Felhőbeli vCenter `cloudowner@cloudsimple.local` alapértelmezett felhasználója a privát felhő létrehozása a helyszíni vCenter való összekapcsolás nélkül.
...
| **dvPort csoport** | Hozzon létre <br> Törlés <br> Módosítás <br> Házirend-művelet <br> Hatókör-művelet |
...
| **ESX-ügynök kezelője** | Konfiguráció <br> Módosítás <br> Nézet |
| **Kiterjesztés** | Bővítmény regisztrálása <br> Bővítmény regisztrációjának törlése <br> Bővítmény frissítése |
| **Külső statisztikai szolgáltató**| Regisztrálás <br> Regisztráció törlése <br> frissítés |
| **Mappa** | Mappa létrehozása <br> Mappa törlése <br> Mappa áthelyezése <br> Mappa átnevezése |
| **Globális** | Feladat megszakítása <br> Kapacitástervezés <br> Diagnosztika <br> Metódusok letiltása <br> Metódusok engedélyezése <br> Globális címke <br> Állapot <br> Licencek <br> Esemény naplózása <br> Egyéni attribútumok kezelése <br> Proxy <br> Parancsfájlművelet <br> Service managerek <br> Egyéni attribútum beállítása <br> Rendszercímke |
| **Állapot-frissítési szolgáltató** | Regisztrálás <br> Regisztráció törlése <br> frissítés |
...
| **Munkamenetek** | Felhasználó megszemélyesítése <br> Message <br> Munkamenet ellenőrzése <br> Munkamenetek megtekintése és leállítása |
...
| **Szállítási szolgáltatás**| Felügyelet <br> Figyelés |
| **vApp** | Virtuális gép felvétele <br> Erőforráskészlet kiosztása <br> VApp-hozzárendelés <br> Klónozás <br> Hozzon létre <br> Törlés <br> Exportálás <br> Importálás <br> Áthelyezés <br> Kikapcsolás <br> Bekapcsolás <br> Átnevezés <br> Felfüggesztése <br> Regisztráció törlése <br> OVF-környezet megtekintése <br> vApp-alkalmazás konfigurációja <br> vApp-példány konfigurációja <br> vApp többé-konfiguráció <br> vApp erőforrás-konfiguráció |
...
| **Virtuális gép > interakció** | Válasz kérdése <br> Biztonsági mentési művelet a virtuális gépen <br> CD-adathordozó konfigurálása <br> Hajlékonylemezes adathordozó konfigurálása <br> Konzol interakciója <br> Képernyőkép létrehozása <br> Az összes lemez töredezettségmentesítése <br> Eszköz csatlakoztatása <br> Drag and drop <br> Vendég operációs rendszer felügyelete a VIX API-val <br> USB-HID-beolvasó kódok behelyezése <br> Szüneteltetés vagy szüneteltetés <br> Törlési vagy zsugorodási műveletek végrehajtása <br> Kikapcsolás <br> Bekapcsolás <br> Munkamenet rögzítése a virtuális gépen <br> Visszajátszás-munkamenet a virtuális gépen <br> Visszaállítás <br> Hibatűrés folytatása <br> Felfüggesztése <br> Hibatűrés felfüggesztése <br> Feladatátvételi teszt <br> Másodlagos virtuális gép újraindításának tesztelése <br> Hibatűrés kikapcsolása <br> Hibatűrés bekapcsolása <br> VMware-eszközök telepítése |
| **Virtuális gép > leltározása** | Létrehozás meglévőből <br> Új létrehozása <br> Áthelyezés <br> Regisztrálás <br> Eltávolítás <br> Regisztráció törlése |
...
| **Virtuális gép > Pillanatképek kezelése** | Pillanatkép létrehozása <br> Pillanatkép eltávolítása <br> Pillanatkép átnevezése <br> Helyreállítás pillanatképre |
