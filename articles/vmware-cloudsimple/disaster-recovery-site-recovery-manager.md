...
2. Hozzon létre egy felhasználót a saját felhőben a vSphere replikálás és az SRM telepítéséhez. Az alábbiakban ismertetett [vCenter felhasználói felület: hozzon létre egy felhasználót a vRA &AMP; SRM telepítéséhez](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation).
