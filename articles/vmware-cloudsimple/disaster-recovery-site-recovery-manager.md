...
2. Hozzon létre egy felhasználót a saját felhőben a vSphere replikálás és az SRM telepítéséhez. Alább az [vCenter felhasználói felületén: Hozzon létre egy felhasználót a saját felhőben a vRA](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation)& SRM telepítéséhez.
...
5. A vRA vonatkozó tűzfalszabályok konfigurálása. Alább a CloudSimple [-portálon: A vRA](#cloudsimple-portal-configure-firewall-rules-for-vra)vonatkozó tűzfalszabályok konfigurálása.
...
#### <a name="vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation"></a>vCenter felhasználói felülete: Felhasználó létrehozása saját felhőben a vRA és az SRM telepítéséhez
...
#### <a name="vcenter-ui-configure-srm"></a>vCenter felhasználói felülete: Az SRM konfigurálása
