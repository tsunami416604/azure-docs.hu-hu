---
title: Rövid útmutató – VMware virtuális gép létrehozása a saját felhőben
...
Alapértelmezés szerint a rendszer megtagadja az internetrőlérkező összes bejövő forgalmat. Ha bármilyen más portot szeretne megnyitni, hozzon létre egy [Tűzfalszabály-táblázatot](firewall.md).
...
Megoldás telepítéséhez további jogosultságokat kell megadnia korlátozott időtartamra. Lásd [](escalate-private-cloud-privileges.md): a jogosultságok kiterjesztésének megtalálása.
