...
> | | |
> | --- | --- |
> | **Leírás** | Lehetővé teszi tárfiókok kezelését. A fiókkulcs, amely keresztül megosztott kulcsos engedélyezési adatok eléréséhez használható hozzáférést biztosít. |
