...
| [API Management szolgáltatás közreműködői](#api-management-service-contributor) | Kezelheti a szolgáltatást és az API-kat |
| [API Management Service operátori szerepkör](#api-management-service-operator-role) | Szolgáltatásokat kezelhet, de API-kat nem |
| [API Management szolgáltatás-olvasó szerepkör](#api-management-service-reader-role) | Írásvédett hozzáférés a szolgáltatáshoz és az API-khoz |
| [Application Insights összetevő közreműködője](#application-insights-component-contributor) | Kezelhet Application Insights-összetevőket |
...
| [Automation Runbook operátor](#automation-runbook-operator) | Runbook-tulajdonságok olvasása – a runbook-feladatok létrehozásához. |
...
| [Azure Stack regisztrációs tulajdonos](#azure-stack-registration-owner) | Lehetővé teszi az Azure Stack-regisztrációk kezelését. |
...
| [Backup-olvasó](#backup-reader) | Megtekintheti a biztonsági mentési szolgáltatásokat, de nem végezhet módosításokat |
...
| [Blockchain-hozzáférés (előzetes verzió)](#blockchain-member-node-access-preview) | Engedélyezi a hozzáférést a Blockchain Member csomópontjaihoz |
| [CDN-végpont közreműködői](#cdn-endpoint-contributor) | Kezelhet CDN-végpontokat, de nem tud hozzáférést adni más felhasználóknak. |
| [CDN-végpont olvasója](#cdn-endpoint-reader) | Megtekintheti a CDN-végpontokat, de nem végezhet módosításokat. |
| [CDN-profil közreműködői](#cdn-profile-contributor) | Kezelheti a CDN-profilokat és azok végpontjait, de nem tud hozzáférést adni más felhasználóknak. |
...
| [Klasszikus Storage-fiók közreműködői](#classic-storage-account-contributor) | Lehetővé teszi a hagyományos tárfiókok kezelését, de ezekhez nem biztosít hozzáférést. |
| [A klasszikus Storage-fiók kulcs-kezelő szolgáltatásának szerepköre](#classic-storage-account-key-operator-service-role) | A hagyományos tárfiók kulcsának operátorai jogosultak a hagyományos tárfiókokhoz tartozó kulcsok listázására és újragenerálására |
| [Klasszikus virtuális gép közreműködője](#classic-virtual-machine-contributor) | Lehetővé teszi a hagyományos virtuális gépek kezelését, de ezekhez nem biztosít hozzáférést, és nem teszi lehetővé a virtuális gépekhez hozzárendelt virtuális hálózatok és tárfiókok elérését sem. |
...
| [Cognitive Services Adatolvasó (előzetes verzió)](#cognitive-services-data-reader-preview) | Cognitive Services-kulcsok olvasását teszi lehetővé. |
...
| [Cost Management közreműködő](#cost-management-contributor) | Megtekintheti a költségeket és kezelheti a költségkonfigurációt (például költségvetés, exportok) |
| [Cost Management olvasó](#cost-management-reader) | Megtekintheti a költségadatokat és a konfigurációt (például költségvetés, exportok) |
| [Data Box közreműködő](#data-box-contributor) | Engedélyezi a Data Box Service minden funkciójának kezelését, kivéve a hozzáférés másoknak való megadását. |
| [Data Box olvasó](#data-box-reader) | Engedélyezi a Data Box Service kezelését, kivéve a rendelések létrehozását, a rendelésadatok szerkesztését és a hozzáférés másoknak való megadását. |
...
| [Adattisztító](#data-purger) | Véglegesen törölheti az elemzési adatokat |
...
| [HDInsight tartományi szolgáltatások közreműködője](#hdinsight-domain-services-contributor) | Olvashatja, létrehozhatja, módosíthatja és törölheti a HDInsight Enterprise Security Package csomaghoz szükséges Domain Services-műveleteket |
| [Intelligens rendszer-fiók közreműködői](#intelligent-systems-account-contributor) | Lehetővé teszi az intelligens rendszerek fiókjainak kezelését, az azokhoz való hozzáférés nélkül. |
...
| [Felügyelt alkalmazás operátori szerepköre](#managed-application-operator-role) | Engedélyezi a felügyelt alkalmazások erőforrásainak olvasását és műveletek azokon való végrehajtását |
...
| [Felügyelt identitás közreműködői](#managed-identity-contributor) | A felhasználóhoz hozzárendelt identitás létrehozása, olvasása, frissítése és törlése |
| [Felügyelt identitás operátora](#managed-identity-operator) | A felhasználóhoz hozzárendelt identitás olvasása és hozzárendelése |
| [Felügyeleti csoport közreműködője](#management-group-contributor) | Felügyeleti csoport közreműködői szerepköre |
| [Felügyeleti csoport olvasója](#management-group-reader) | Felügyeleti csoport olvasói szerepköre |
...
| [Figyelési metrikák közzétevője](#monitoring-metrics-publisher) | Lehetővé teszi a metrikák Azure-erőforrásokhoz való közzétételét |
...
| [Új ereklye APM-fiók közreműködői](#new-relic-apm-account-contributor) | Lehetővé teszi a New Relic Application Performance Management-fiókok és -alkalmazások kezelését, az azokhoz való hozzáférés nélkül. |
...
| [Redis Cache közreműködő](#redis-cache-contributor) | Lehetővé teszi a Redis-gyorsítótárak kezelését, az azokhoz való hozzáférés nélkül. |
| [Erőforrás-házirend közreműködője (előzetes verzió)](#resource-policy-contributor-preview) | (Előnézet) Erőforrás-szabályzat létrehozására/módosítására, támogatási jegy létrehozására, valamint erőforrások/hierarchia beolvasására jogosultsággal rendelkező, EA-beli visszatöltött felhasználók. |
| [Ütemező – feladattípusok közreműködői](#scheduler-job-collections-contributor) | Lehetővé teszi a Scheduler-feladatgyűjtemények kezelését, az azokhoz való hozzáférés nélkül. |
...
| [Térbeli horgonyok fiók közreműködője](#spatial-anchors-account-contributor) | Lehetővé teszi a fiókban található térbeli fixpontok kezelését, de azok törlését nem |
| [Térbeli horgonyok fiókjának tulajdonosa](#spatial-anchors-account-owner) | Lehetővé teszi a fiókban található térbeli fixpontok kezelését, beleértve azok törlését is |
| [Térbeli horgonyok fiókjának olvasója](#spatial-anchors-account-reader) | Lehetővé teszi a fiókban található térbeli fixpontok megkeresését és azok tulajdonságainak beolvasását |
...
| [Támogatási kérelem közreműködői](#support-request-contributor) | Támogatási kérések létrehozását és kezelését teszi lehetővé |
...
| [Virtuális gép rendszergazdai bejelentkezése](#virtual-machine-administrator-login) | A virtuális gépek megtekintése a portálon, és bejelentkezés rendszergazdaként |
...
| [Virtuális gép felhasználói bejelentkezés](#virtual-machine-user-login) | A virtuális gépek megtekintése a portálon, és bejelentkezés hagyományos felhasználóként. |
| [Webes csomag közreműködői](#web-plan-contributor) | Lehetővé teszi a webes tarifacsomagok kezelését, az azokhoz való hozzáférés nélkül. |
| [Webhely közreműködői](#website-contributor) | Lehetővé teszi a webhelyek kezelését (a webes tarifacsomagokét azonban nem), az azokhoz való hozzáférés nélkül. |
...
> | **Műveletek** |  |
> | Microsoft.ContainerService/managedClusters/listClusterAdminCredential/action | Felügyelt fürt fürtadminisztrátori hitelesítő adatainak listázása |
> | **Nincs tapintat** |  |
> | *none* |  |
> | **DataActions** |  |
> | *none* |  |
...
## <a name="blockchain-member-node-access-preview"></a>Blockchain Member csomópont-hozzáférés (előzetes verzió)
> [!div class="mx-tableFixed"]
> | | |
> | --- | --- |
> | **Leírás** | Engedélyezi a hozzáférést a Blockchain Member csomópontjaihoz |
...
> | Microsoft. bepillantások/metricdefinitions/olvasás | A metrikadefiníciók olvasása |
...
> | Microsoft. Resources/előfizetések/olvasás | Beolvassa az előfizetések listáját. |
...
> | Microsoft. bepillantások/diagnosticSettings/olvasás | Erőforrás diagnosztikai beállításának olvasása |
> | Microsoft.Insights/logDefinitions/read | A naplódefiníciók olvasása |
> | Microsoft. bepillantások/metricdefinitions/olvasás | A metrikadefiníciók olvasása |
> | Microsoft. bepillantások/mérőszámok/olvasás | Metrikák olvasása |
> | Microsoft.ResourceHealth/availabilityStatuses/read | Beolvassa a megadott hatókörben lévő összes erőforrás rendelkezésre állási állapotát |
...
> | | |
> | --- | --- |
> | **Leírás** | Cosmos DB-adatbázis vagy fióktároló visszaállítására vonatkozó kérelmet küldhet. |
...
> | | |
> | --- | --- |
> | **Leírás** | Megtekintheti a költségeket és kezelheti a költségkonfigurációt (például költségvetés, exportok) |
...
> | | |
> | --- | --- |
> | **Leírás** | Megtekintheti a költségadatokat és a konfigurációt (például költségvetés, exportok) |
...
> | | |
> | --- | --- |
> | **Leírás** | Engedélyezi a Data Box Service minden funkciójának kezelését, kivéve a hozzáférés másoknak való megadását. |
...
> | | |
> | --- | --- |
> | **Leírás** | Engedélyezi a Data Box Service kezelését, kivéve a rendelések létrehozását, a rendelésadatok szerkesztését és a hozzáférés másoknak való megadását. |
> | **Azonosító** | 028f4ed7-e2a9-465e-a8f4-9c0ffdfdc027 |
> | **Műveletek** |  |
> | Microsoft. Authorization/*/READ | Szerepkörök és szerepkör-hozzárendelések olvasása |
> | Microsoft.Databox/*/read |  |
> | Microsoft.Databox/jobs/listsecrets/action |  |
> | Microsoft.Databox/jobs/listcredentials/action | A megrendeléssel kapcsolatos titkosítatlan hitelesítő adatok listázása. |
> | Microsoft.Databox/locations/availableSkus/action | Ez a metódus a rendelkezésre álló termékváltozatok listáját adja vissza. |
> | Microsoft.Databox/locations/validateAddress/action | A szállítási cím ellenőrzése és másodlagos címek biztosítása, ha vannak ilyenek. |
> | Microsoft.ResourceHealth/availabilityStatuses/read | Beolvassa a megadott hatókörben lévő összes erőforrás rendelkezésre állási állapotát |
> | Microsoft.Support/* | Támogatási jegyek létrehozása és kezelése |
> | **Nincs tapintat** |  |
> | *none* |  |
...
> | **Műveletek** |  |
> | Microsoft.Insights/components/*/read |  |
> | Microsoft. bepillantások/összetevők/kiürítés/művelet | Adatok végleges törlése az Application Insightsból |
...
> | | |
> | --- | --- |
> | **Leírás** | Lehetővé teszi a EventGrid-eseményelőfizetések műveleteinek kezelését. |
...
> | | |
> | --- | --- |
> | **Leírás** | Lehetővé teszi a EventGrid-eseményelőfizetések olvasását. |
...
> | | |
> | --- | --- |
> | **Leírás** | Olvashatja, létrehozhatja, módosíthatja és törölheti a HDInsight Enterprise Security Package csomaghoz szükséges Domain Services-műveleteket |
...
## <a name="managed-application-operator-role"></a>Felügyeltalkalmazás-operátori szerepkör
> [!div class="mx-tableFixed"]
> | | |
> | --- | --- |
> | **Leírás** | Engedélyezi a felügyelt alkalmazások erőforrásainak olvasását és műveletek azokon való végrehajtását |
...
## <a name="managed-applications-reader"></a>Felügyeltalkalmazás-olvasó
> [!div class="mx-tableFixed"]
> | | |
> | --- | --- |
...
> | | |
> | --- | --- |
> | **Leírás** | Lehetővé teszi a metrikák Azure-erőforrásokhoz való közzétételét |
...
> | **Műveletek** |  |
> | Microsoft.Storage/storageAccounts/listKeys/action | A megadott tárfiók hozzáférési kulcsainak lekérése. |
> | Microsoft.Storage/storageAccounts/ListAccountSas/action | A fiók SAS-jogkivonatát adja vissza a megadott tárfiókhoz. |
> | Microsoft.Storage/storageAccounts/read | A tárfiókok listájának vagy a megadott tárfiók tulajdonságainak lekérése. |
> | **Nincs tapintat** |  |
> | *none* |  |
> | **DataActions** |  |
...
## <a name="user-access-administrator"></a>Felhasználói hozzáférés adminisztrátora
> [!div class="mx-tableFixed"]
> | | |
> | --- | --- |
...
> | | |
> | --- | --- |
> | **Leírás** | A virtuális gépek megtekintése a portálon, és bejelentkezés rendszergazdaként |
...
> | | |
> | --- | --- |
> | **Leírás** | Lehetővé teszi a virtuális gépek kezelését, az azokhoz való hozzáférés nélkül, és nem teszi lehetővé a virtuális gépekhez hozzárendelt virtuális hálózatok és tárfiókok elérését sem. |
...
> | | |
> | --- | --- |
> | **Leírás** | A virtuális gépek megtekintése a portálon, és bejelentkezés hagyományos felhasználóként. |
