...
![Kapcsolat közötti elemek Azure Active Directory - ábra](./media/overview/rbac_aad.png)
...
[Beépített RBAC-szerepkörök](built-in-roles.md) felsorolja azokat a szerepköröket, az Azure-ban érhető el. Azt adja meg az operatív és hatókörhöz, amely minden beépített szerepkörök a felhasználók számára. Ha még nagyobb mértékben vezérelheti a saját szerepköröket definiál, lásd: hogyan hozhat létre [egyéni szerepkörök az Azure RBAC](custom-roles.md).
...
* Ismerkedés a [szerepköralapú hozzáférés-vezérlés az Azure portálon](role-assignments-portal.md).
