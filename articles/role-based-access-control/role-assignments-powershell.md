...
![Az RBAC PowerShell-Get AzureRmRoleDefinition – képernyőkép](./media/role-assignments-powershell/1-get-azure-rm-role-definition1.png)
...
![Az RBAC PowerShell-Get AzureRmRoleDefinition egy adott szerepkör esetében – képernyőkép](./media/role-assignments-powershell/1-get-azure-rm-role-definition2.png)
...
![Az RBAC - Get-AzureRmRoleAssignment erőforráscsoport - PowerShell képernyőképe](./media/role-assignments-powershell/4-get-azure-rm-role-assignment1.png)
...
![Az RBAC PowerShell-Get AzureRmRoleAssignment egy felhasználó számára – képernyőkép](./media/role-assignments-powershell/4-get-azure-rm-role-assignment2.png)
...
![Az RBAC PowerShell új AzureRmRoleAssignment – képernyőkép](./media/role-assignments-powershell/2-new-azure-rm-role-assignment2.png)
...
![Az RBAC PowerShell új AzureRmRoleAssignment – képernyőkép](./media/role-assignments-powershell/2-new-azure-rm-role-assignment3.png)
...
![Az RBAC PowerShell új AzureRmRoleAssignment – képernyőkép](./media/role-assignments-powershell/2-new-azure-rm-role-assignment4.png)
...
![Az RBAC PowerShell-Remove AzureRmRoleAssignment – képernyőkép](./media/role-assignments-powershell/3-remove-azure-rm-role-assignment.png)
...
![Az RBAC PowerShell-Get AzureRmRoleDefinition – képernyőkép](./media/role-assignments-powershell/2-new-azurermroledefinition.png)
...
![Az RBAC PowerShell-Set AzureRmRoleDefinition – képernyőkép](./media/role-assignments-powershell/3-set-azurermroledefinition-1.png)
...
![Az RBAC PowerShell-Set AzureRmRoleDefinition – képernyőkép](./media/role-assignments-powershell/3-set-azurermroledefinition-2.png)
...
![Az RBAC PowerShell-Remove AzureRmRoleDefinition – képernyőkép](./media/role-assignments-powershell/4-remove-azurermroledefinition.png)
...
![Az RBAC PowerShell-Get AzureRmRoleDefinition – képernyőkép](./media/role-assignments-powershell/5-get-azurermroledefinition-1.png)
...
![Az RBAC PowerShell-Get AzureRmRoleDefinition – képernyőkép](./media/role-assignments-powershell/5-get-azurermroledefinition2.png)

## <a name="see-also"></a>Lásd még
* [Using Azure PowerShell használata az Azure Resource Manager eszközzel](../azure-resource-manager/powershell-azure-resource-manager.md)
