---
title: Oktatóanyag – csoportos hozzáférés biztosítása az Azure-erőforrásokhoz a RBAC és a Azure PowerShell használatával
...
| Rendszerbiztonsági tag | Szerepkör-definíció | Scope |
| --- | --- | --- |
