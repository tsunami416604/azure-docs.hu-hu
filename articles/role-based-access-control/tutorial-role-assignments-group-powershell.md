---
title: 'Oktatóanyag: Csoportos hozzáférés biztosítása az Azure-erőforrásokhoz az RBAC-kal és az Azure PowerShell-lel'
description: Ebből az oktatóanyagból megtudhatja, hogyan adhat hozzá csoporthozzáférést az Azure-erőforrásokhoz szerepköralapú hozzáférés-vezérlés (RBAC) és Azure PowerShell használatával.
...
ms.locfileid: "77138235"
---
# <a name="tutorial-grant-a-group-access-to-azure-resources-using-rbac-and-azure-powershell"></a>Oktatóanyag: Csoportos hozzáférés biztosítása az Azure-erőforrásokhoz az RBAC és az Azure PowerShell használatával

[Szerepköralapú hozzáférés-vezérlés (RBAC)](overview.md) az Azure-erőforrásokhoz való hozzáférés kezelése. Ebben az oktatóanyagban hozzáférést biztosít egy csoport számára, hogy mindent megtekinthessen az előfizetésben és mindent kezelhessen egy erőforráscsoportban az Azure PowerShell használatával.
...
Ha nem rendelkezik a csoportok létrehozásához szükséges engedélyekkel, próbálja ki az [oktatóanyagot: Adjon meg egy felhasználói hozzáférést az Azure-erőforrásokhoz az RBAC és az Azure PowerShell használatával.](tutorial-role-assignments-user-powershell.md)
...
A csoport számára a hozzáférés engedélyezéséhez a [New-AzRoleAssignment](/powershell/module/az.resources/new-azroleassignment) paranccsal rendeljen hozzá egy szerepkört. Meg kell adnia a rendszerbiztonsági tagot, a szerepkör-definíciót és a hatókört.
