...
![Az Azure AD felügyeleti központban - tulajdonságok – globális rendszergazdák által kezelhető Azure-előfizetés – képernyőkép](./media/elevate-access-global-admin/aad-azure-portal-global-admin-can-manage-azure-subscriptions.png)
...
- További információ [szerepköralapú hozzáférés-vezérlés többi kezelése](role-assignments-rest.md)

- [Hozzáférés-hozzárendelések kezelése](role-assignments-users.md) az Azure-portálon
