...
![A browser window displaying the service hosted on Azure][A browser window displaying the service hosted on Azure]
...
2.  Change directories to the **c:\\node** directory and then enter the following commands to create a new solution named **chatapp** and a worker role named **WorkerRole1**:
    ...
    ![The output of the new-azureservice and add-azurenodeworkerrolecmdlets][The output of the new-azureservice and add-azurenodeworkerrolecmdlets]

## Download the Chat Example

For this project, we will use the chat example from the [Socket.IO
GitHub repository][Socket.IO
...
1.  Create a local copy of the repository by using the **Clone** button. You may also use the **ZIP** button to download the project.
    ...
    ![A browser window viewing https://github.com/LearnBoost/socket.io/tree/master/examples/chat, with the ZIP download icon highlighted][A browser window viewing https://github.com/LearnBoost/socket.io/tree/master/examples/chat, with the ZIP download icon highlighted]
...
2.  Navigate the directory structure of the local repository until you arrive at the **examples\\chat**
    ...
    **C:\\node\\chatapp\\WorkerRole1** directory created earlier.
    ...
    ![Explorer, displaying the contents of the examples\chat directory extracted from the archive][Explorer, displaying the contents of the examples\chat directory extracted from the archive]
...
In this tutorial you learned how to create a basic chat application hosted in an Azure Cloud Service. To learn how to host this application in an Azure Website, see [Build a Node.js Chat Application with Socket.IO on an Azure Web Site][Build a Node.js Chat Application with Socket.IO on an Azure Web Site].

  [A browser window displaying the service hosted on Azure]: ./media/cloud-services-nodejs-chat-app-socketio/socketio-10.png
  [Azure PowerShell icon]: ./media/cloud-services-nodejs-chat-app-socketio/azure-powershell-start.png
  ...
  [Socket.IO
  GitHub repository]: https://github.com/LearnBoost/socket.io/tree/0.9.14
  ...
  [Explorer, displaying the contents of the examples\\chat directory extracted from the archive]: ./media/cloud-services-nodejs-chat-app-socketio/socketio-5.png
  ...
  [Build and deploy a Node.js application to an Azure Cloud Service]: https://www.windowsazure.com/en-us/develop/nodejs/tutorials/getting-started/
  [Azure SDK for Node.js GitHub repository]: https://github.com/WindowsAzure/azure-sdk-for-node
  [Build a Node.js Chat Application with Socket.IO on an Azure Web Site]: /en-us/develop/nodejs/tutorials/website-using-socketio/
