...
## <a name="configure-threat-protection-from-security-center"></a>Veszélyforrások elleni védelem konfigurálása Security Center
...
1. Válassza ki az **árképzési szintet**.
