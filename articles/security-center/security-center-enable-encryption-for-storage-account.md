---
title: Titkosítás az Azure storage-fiókot az Azure Security Centerben |} A Microsoft Docs
...
---
# <a name="encryption-for-azure-storage-account-in-azure-security-center"></a>Titkosítás az Azure storage-fiókot az Azure Security Centerben

Az Azure Storage-titkosítás inaktív adatok az összes Azure-tárfiókok alapértelmezés szerint engedélyezve van. Az Azure Storage titkosítja az adatokat, amikor Azure Storage tárterületre írt és visszafejti őket a lekérés előtt. További információkért lásd: [inaktív adatok titkosítása az Azure Storage](../storage/common/storage-service-encryption.md).
