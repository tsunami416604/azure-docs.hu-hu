...
A fenyegetéseket a gazdagép és az AK-fürt szintjén észleljük. Részletekért lásd: [Azure Container Service](https://docs.microsoft.com/azure/security-center/security-center-alerts-compute#azure-container-service-).
