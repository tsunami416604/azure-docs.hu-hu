...
- **Automatikus**bevezetéssel: a Microsoft Defender ATP-érzékelő automatikusan engedélyezve van a Azure Security Centerba beépített Windows-kiszolgálókon (a windows Server 2019-at futtatók kivételével).
