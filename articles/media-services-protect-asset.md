...
This article is one in a series introducing Azure Media Services programming. The previous topic was [How to: Check Job Progress][How to: Check Job Progress].
...
1.  Retrieve configuration data. You can get an example configuration file from the [Task Preset for Azure Media Encryptor][Task Preset for Azure Media Encryptor] topic.
...
-   [Protecting Assets with Microsoft PlayReady][Protecting Assets with Microsoft PlayReady]
-   [Microsoft PlayReady][Microsoft PlayReady]

</p>
## Next Steps

Now that you know how to protect asssets with Media services, go to the [How To Manage Assets][How To Manage Assets] topic.

  [How to: Check Job Progress]: ../media-services-check-job-progress/
  [Task Preset for Azure Media Encryptor]: http://msdn.microsoft.com/en-us/library/hh973610.aspx
  [Protecting Assets with Microsoft PlayReady]: http://msdn.microsoft.com/en-us/library/dn189154.aspx
  [Microsoft PlayReady]: http://www.microsoft.com/PlayReady/
  [How To Manage Assets]: ../media-services-manage-assets/
