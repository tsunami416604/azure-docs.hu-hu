...
1. A Labs listából válassza ki *a labort*. 
    ...
    > [!NOTE]
    > Az Azure Bastion jelenleg előzetes verzióban érhető el. A következőkre korlátozódik: USA nyugati régiója, USA keleti régiója, Nyugat-Európa, az USA déli középső régiója, Kelet-Ausztrália és Kelet-Japán. Ezért hozzon létre egy labort ezekben a régiókban, ha a labor egyike sincs bennük. 
