---
title: Kapcsolat felvétel a Go-val - Azure Database for PostgreSQL - Single Server
description: Ez a rövid útmutató egy Go programozási nyelvi mintát biztosít, amely az Azure Database for PostgreSQL – Single Server adatbázisból származó adatok csatlakoztatásához és lekérdezéséhez használható.
author: rachel-msft
ms.author: raagyema
...
---
# <a name="azure-database-for-postgresql---single-server-use-go-language-to-connect-and-query-data"></a>Azure Database for PostgreSQL – Single Server: A Go nyelv használata adatok csatlakoztatásához és lekérdezéséhez
