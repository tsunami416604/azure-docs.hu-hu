...
- Hozzon létre egy új, nem naplózott táblát a (z) `CREATE UNLOGGED TABLE <tableName>`szintaxis használatával.
- Konvertáljon egy meglévő naplózott táblázatot egy nem naplózott táblára a `ALTER TABLE <tableName> SET UNLOGGED`szintaxis használatával.  

A folyamat megfordításához használja a következő szintaxist: `ALTER TABLE <tableName> SET LOGGED`.
