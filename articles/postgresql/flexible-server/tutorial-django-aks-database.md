...
Hozzon létre egy rugalmas kiszolgálót az az [postgreSQL flexibilis-Server Create](/cli/azure/postgresql/flexible-server?view=azure-cli-latest&preserve-view=true)paranccsal. A következő parancs egy kiszolgálót hoz létre az Azure CLI helyi környezetében lévő szolgáltatás-alapértékek és-értékek használatával:
