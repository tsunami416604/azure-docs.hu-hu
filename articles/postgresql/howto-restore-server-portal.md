---
title: Biztonsági mentés és visszaállítás - Azure portal - Azure Database for PostgreSQL - Single Server
description: Ez a cikk ismerteti, hogyan lehet visszaállítani egy kiszolgálót az Azure Database for PostgreSQL – Single Server az Azure Portal használatával.
author: rachel-msft
ms.author: raagyema
...
---
# <a name="how-to-backup-and-restore-a-server-in-azure-database-for-postgresql---single-server-using-the-azure-portal"></a>Kiszolgáló biztonsági mentése és visszaállítása az Azure Database for PostgreSQL -Single Server szolgáltatásban az Azure portal használatával
...
A létrehozás során ezeknek az értékeknek a beállításáról az [Azure Database for PostgreSQL server rövid útmutatójában](quickstart-create-server-database-portal.md)talál további információt.

A kiszolgáló biztonsági mentési megőrzési ideje a következő lépésekkel módosítható:
...
Az Azure Database for PostgreSQL lehetővé teszi, hogy visszaállítsa a kiszolgálót egy pont-az-időben, és egy új példányát a kiszolgáló. Ezzel az új kiszolgálóval helyreállíthatja az adatokat, vagy beállíthatja, hogy az ügyfélalkalmazások erre az új kiszolgálóra mutassanak.
...
1. Az Azure Portalon válassza ki az Azure Database for PostgreSQL-kiszolgáló. 
...
3. Töltse ki a Visszaállítás űrlapot a szükséges információkkal:
   ...
   ![Azure Database for PostgreSQL – Információk visszaállítása](./media/howto-restore-server-portal/3-restore.png)
...
1. Válassza az **Erőforrás létrehozása** gombot (+) a portál bal felső sarkában. Válassza **az Adatbázisok** > **Azure-adatbázis a PostgreSQL számára**lehetőséget.
