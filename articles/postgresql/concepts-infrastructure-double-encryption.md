...
> [!NOTE]
> Ez a funkció minden olyan Azure-régióban elérhető, ahol a Azure Database for PostgreSQL támogatja a "általános célú" és a "memória-optimalizált" árképzési szintet.
