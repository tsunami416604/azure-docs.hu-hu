...
```
A kimenet felsorolja a tűzfalszabályok (ha vannak) alapértelmezés szerint JSON formátumban. A kapcsoló `--output table`t a kimenetként olvasható táblázatos formátumra használhatja.
```azurecli-interactive
