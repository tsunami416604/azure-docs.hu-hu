...
可透過 Azure 自動化中管理虛擬機器 [PowerShell](https://msdn.microsoft.com/library/azure/jj156055.aspx)。 Azure 自動化包含 Azure PowerShell Cmdlet，因此您可以在此服務內執行所有的虛擬機器管理工作。 您也可以將 Azure 自動化中的 Cmdlet 與其他 Azure 服務的 Cmdlet 搭配，以便在 Azure 服務和協力廠商系統上自動執行複雜的工作。
