...
| [az vm extension set](https://docs.microsoft.com/cli/azure/vm#az_vm_create) | Hozzáadja az egyéni szkriptbővítményt a virtuális géphez, amely meghív egy szkriptet a WordPress telepítésére. |
