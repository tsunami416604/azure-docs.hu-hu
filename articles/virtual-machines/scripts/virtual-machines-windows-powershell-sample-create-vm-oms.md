---
title: Azure PowerShell Windows-parancsfájl mintája – Azure Monitor naplók
...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Egy virtuálisgép-bővítményt ad hozzá a virtuális géphez. |
