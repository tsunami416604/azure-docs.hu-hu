...
| [Azure virtuális gép bővítmény beállítása](https://docs.microsoft.com/cli/azure/vm/extension#az_vm_extension_set) | Hozzáadja, és futtat egy virtuálisgép-bővítményt egy virtuális géphez. Ez a példa az egyéni parancsprogramok futtatására szolgáló bővítmény segítségével telepítse az IIS.|
