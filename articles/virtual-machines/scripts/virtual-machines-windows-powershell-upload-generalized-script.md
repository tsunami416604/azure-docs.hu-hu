---
title: Általánosított virtuális merevlemez feltöltése Azure PowerShell szkript mintába
...
| [Add-AzVhd](/powershell/module/az.compute/add-azvhd)                                               | Feltölt egy virtuális merevlemezt egy helyi virtuális gépről egy Azure-beli felhőalapú tárfiókban található blobba.                                                                       |
| [Új – AzImageConfig](/powershell/module/az.compute/new-azimageconfig)                               | Konfigurálható rendszerkép-objektumot hoz létre.                                                                                                                                                 |
| [Set-AzImageOsDisk](/powershell/module/az.compute/set-azimageosdisk)                               | Beállítja egy operációsrendszer-lemez tulajdonságait egy rendszerkép-objektumon.                                                                                                                        |
| [Új – AzImage](/powershell/module/az.compute/new-azimage)                                           | Új rendszerképet hoz létre.                                                                                                                                                                 |
...
| [Set-AzVMSourceImage](/powershell/module/az.compute/set-azvmsourceimage)                           | Meghatározza egy virtuális gép rendszerképét.                                                                                                                                            |
| [Set-AzVMOSDisk](/powershell/module/az.compute/set-azvmosdisk)                                     | Beállítja egy operációsrendszer-lemez tulajdonságait egy virtuális gépen.                                                                                                                      |
| [Set-AzVMOperatingSystem](/powershell/module/az.compute/set-azvmoperatingsystem)                   | Beállítja egy operációsrendszer-lemez tulajdonságait egy virtuális gépen.                                                                                                                      |
