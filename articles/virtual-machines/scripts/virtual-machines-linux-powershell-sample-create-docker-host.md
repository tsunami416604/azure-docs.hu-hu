---
title: Azure PowerShell-példaszkript – Docker
...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Egy virtuálisgép-bővítményt ad hozzá a virtuális géphez. Ebben a példában a Docker-bővítménnyel konfigurálja a Dockert és futtatja az NGINX Docker-tárolót. |
