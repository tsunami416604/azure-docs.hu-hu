...
Kapcsolódjon a kívánt Azure-fiókhoz a [AzAccount](/powershell/module/az.accounts/connect-azaccount) és a [set-AzAccount](/powershell/module/az.accounts/set-azcontext)használatával.
