---
title: A virtuális gép számítási igényű Java-alkalmazás
...
2. Kattintson a **hozzon létre egy erőforrást**, kattintson a **számítási**, kattintson a **virtuális gép**, és kattintson a **a gyűjtemény**.
