...
* **MPI** – Microsoft MPI (MS-MPI) 2012 R2 vagy újabb, illetve az Intel MPI-kódtár 5.x
  ...
  Nem SR-IOV engedélyezve van a virtuális gépek, a támogatott MPI-megvalósításokban az a Microsoft hálózati közvetlen (ND) felületen példányok közötti kommunikáció során. Az SR-IOV engedélyezett Virtuálisgép-méretek (HB és a hibrid kapcsolat sorozat) az Azure-ban lehetővé teszi a Mellanox OFED használandó MPI szinte bármelyik verziója. 
