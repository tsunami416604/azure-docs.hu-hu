---
title: Parancsfájlok futtatása Azure Windows virtuális gépben
description: Ez a témakör a parancsfájlok Windows virtuális gépen belüli futtatását ismerteti
services: automation
...
---
# <a name="run-scripts-in-your-windows-vm"></a>Parancsfájlok futtatása a Windows virtuális gépben
...
Az [egyéni parancsfájl-bővítmény](../extensions/custom-script-windows.md) elsősorban a telepítés utáni konfigurációhoz és a szoftvertelepítéshez használatos.
...
* [Egyéni parancsfájl-bővítmény](../extensions/custom-script-windows.md)
