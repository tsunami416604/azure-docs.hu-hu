...
Az 2019-11-01-es verzió jelenleg üzembe kerül, és nem minden régióban érhető el.
...
Az aláíráshoz használt tanúsítvány körül ismert probléma van. Előfordulhat, `metadata.azure.com` hogy a tanúsítványok nem rendelkeznek pontos egyezéssel a nyilvános felhőben. Ezért a minősítés érvényesítésének lehetővé kell tennie egy köznapi név `.metadata.azure.com` használatát bármely altartományból.
...
1. Futtassa a következő parancsot, és használja a Hálózati célhely (`0.0.0.0`) interfészének címe (), amely`10.0.1.10`ebben a példában található ().
