...
* [Virtuális gépek figyelése az Azure-ban](./monitor.md)
...
* [A virtuálisgép-sablon letöltésével kapcsolatos információk](./download-template.md)
...
* [Az Azure által felügyelt identitások integrálása](../../azure-app-configuration/howto-integrate-azure-managed-service-identity.md)
