...
Microsoft.ClassicCompute jelöli az Azure Service Manageren keresztül üzembe helyezett klasszikus erőforrások. Ha az erőforrás-kezelő használatával telepít, majd Microsoft.Compute töltse be az igénybe vett szolgáltatás. Tudjon meg többet a [Azure üzembe helyezési modellek](../../azure-resource-manager/resource-manager-deployment-model.md).
