...
Ha szeretné megtudni, hogyan hozhat létre CI-/CD-folyamatot az Azure DevOps Services és egy IIS-t futtató, Windows rendszerű virtuális gép segítségével, lépjen a következő oktatóanyagra.
