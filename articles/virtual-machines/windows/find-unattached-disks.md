...
További információkért lásd: [törölni a tárfiókot](../../storage/common/storage-create-storage-account.md) és [azonosítása árva lemezek PowerShell használatával](https://blogs.technet.microsoft.com/ukplatforms/2018/02/21/azure-cost-optimisation-series-identify-orphaned-disks-using-powershell/)
