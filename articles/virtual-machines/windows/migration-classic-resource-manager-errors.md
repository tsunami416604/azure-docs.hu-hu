...
description: Ez a cikk az IaaS-erőforrások Azure Service Managementből az Azure Resource Manager-verembe való áttelepítése során előforduló leggyakoribb hibákat és megoldásokat katalogizálja.
author: tanmaygore
manager: vashan
