---
title: Számítási teljesítménypont az Azure Windows virtuális gépekhez
description: Hasonlítsa össze az SPECint számítási teljesítménypontszámait a Windows Server t futtató Azure virtuális gépekhez.
...
ms.locfileid: "77651049"
---
# <a name="compute-benchmark-scores-for-windows-vms"></a>Számítási teljesítménypont-pontszámok a Windows virtuális gépekhez
A következő SPECInt benchmark pontszámok a Windows Server t futtató azure-beli virtuális gépek számítási teljesítményét mutatják. Számítási teljesítménypontszámok [linuxos virtuális gépekhez](../linux/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)is elérhetők.


## <a name="av2---general-compute"></a>Av2 - Általános Számítás
| Méret | vCPU-k | NUMA csomópontok | CPU | Futtatás | Átlagos alapkamat | SztdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
SPEC Int egy meglehetősen hosszú ideig futó teszt, amely általában kimeríti a rendelkezésre álló burst hitelek.  Ezért a fenti számok közelebb állnak a virtuális gép alapteljesítményéhez (bár tükrözhetik a futtatások között felhalmozódott burst időt).  Rövid, bursty, munkaterhelések (jellemző a B-sorozat) teljesítmény általában közelebb áll a Ds v3 sorozat..
...
| Standard_D32_v3 | 32 | 2 | Intel(R) Xeon(R) CPU E5-2673 v3 @ 2.40GHz | 7 | 538.6 | 9.4 verzió | 
...
| Standard_DS14 4_v2 4_v2 | 4 | 1 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz | 28 | 132.8 | 6.6 | 
| Standard_DS14 4_v2 4_v2 | 4 | 2 | Intel(R) Xeon(R) CPU E5-2673 v3 @ 2.40GHz | 16 | 125.1 | 4.8 | 
...
| Standard_D14_v2 | 16 | 1 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz | 23 | 473.0 | 9.4 verzió | 
...
| Standard_E32s_v3 | 32 | 2 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz | 31 | 577.9 | 9.4 verzió | 
...
| 32s_v3 Standard_E64 | 32 | 2 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz | 4 | 592.5 | 4.4 | 
...
| Standard_M64-32 ms | 32 | 2 | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2,50 GHz | 12 | 586.8 | 5.4 | 
...
| Standard_M128-32 ms | 32 | 4 | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2,50 GHz | 13 | 620.5 | 2.5 | 
| Standard_M128-64 ms | 64 | 4 | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2,50 GHz | 12 | 1140.8 | 2.9 | 
...
## <a name="about-specint"></a>Körülbelül SPECint
A Windows-számok at az [SPECint 2006](https://www.spec.org/cpu2006/results/rint2006.html) Windows Server rendszeren való futtatásával számították ki. Az SPECint az alapdíj opcióval (SPECint_rate2006) futott, vCPU-nként egy példánysal. Az SPECint 12 különböző vizsgálatból áll, amelyek mindegyike háromszor fut, figyelembe véve az egyes vizsgálatok medián értékét, és súlyozásuk, hogy összetett pontszámot alkossanak. Ezeket a teszteket ezután több virtuális gépen futtatták, hogy biztosítsák az átlagos pontszámokat.

## <a name="next-steps"></a>További lépések
* A tárolókapacitást, a lemezrészleteket és a virtuális gépméretek közötti választástovábbi szempontjait a [Virtuális gépek méretei (Méretek) (Virtuális gépek méretei)](sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)ismerteti.
