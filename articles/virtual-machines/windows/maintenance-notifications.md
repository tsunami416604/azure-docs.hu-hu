---
title: Windows rendszerű virtuális gépek karbantartási értesítéseinek kezeléséhez az Azure-ban
...
Az Azure PowerShell használatával is megtekintheti, hogy a virtuális gépek karbantartásra vannak-e ütemezve. A tervezett karbantartási információk a [Get-AzVM](https://docs.microsoft.com/powershell/module/az.compute/get-azvm) parancsmagból érhetők el, ha a `-status` paramétert használja.
...
**A:** A tervezett karbantartás már elérhető a Virtual Machine Scale Sets számára. Az önkiszolgáló karbantartás elindításával kapcsolatos utasításokért tekintse meg a VMSS-dokumentum [tervezett karbantartását](../../virtual-machine-scale-sets/virtual-machine-scale-sets-maintenance-notifications.md) .
