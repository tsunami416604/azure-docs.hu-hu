...
Állítsa be a virtuális gép rendszergazdai felhasználónevét és jelszavát a [Get-hitelesítőadat használatával](/powershell/module/microsoft.powershell.security/get-credential):
