...
3. Állítsa be az Azure AD-alkalmazáshoz tartozó Key Vault-hozzáférési szabályzatot.
4. A Key Vault speciális hozzáférési házirendjeinek beállítása.
