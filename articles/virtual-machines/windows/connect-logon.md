...
Ha a PowerShellt használja, és telepítette a aure PowerShell-modult, akkor a `Get-AzRemoteDesktopFile` parancsmag használatával is kapcsolódhat az alább látható módon.
