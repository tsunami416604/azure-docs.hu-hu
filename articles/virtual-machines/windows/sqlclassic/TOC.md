...
## [Virtuális gép létrehozása az Azure PowerShell használatával](../classic/ps-sql-create.md)
## [Kapcsolódás virtuális géphez](../classic/sql-connect.md)
...
### [AlwaysOn rendelkezésre állási csoport konfigurálása a klasszikus portálon](../classic/portal-sql-alwayson-availability-groups.md)
### [AlwaysOn rendelkezésre állási csoport konfigurálása PowerShellel](../classic/ps-sql-alwayson-availability-groups.md)
### [Belső figyelő konfigurálása rendelkezésre állási csoporthoz](../classic/ps-sql-int-listener.md)
### [Külső figyelő konfigurálása rendelkezésre állási csoporthoz](../classic/ps-sql-ext-listener.md)
### [Helyi rendelkezésre állási csoport kiterjesztése az Azure-ba](../classic/sql-onprem-availability.md)
## Kezelés
### [Microsoft SQL Server IaaS-ügynök bővítmény használata](../classic/sql-server-agent-extension.md)
### [Automatikus javítás](../classic/sql-automated-patching.md)
### [Azure Key Vault-integráció konfigurálása](../classic/ps-sql-keyvault.md)
### [Premium Storage használata](../classic/sql-server-premium-storage.md)
...
### [Automatikus biztonsági mentés](../classic/sql-automated-backup.md)
...
### [SQL Server Business Intelligence az Azure virtuális gépeken](../classic/ps-sql-bi.md)
### [A ReportViewer használata az Azure-ban üzemeltetett webhelyeken](../classic/sql-server-reportviewer.md)
### [Jelentéskészítő kiszolgálóval rendelkező Azure virtuális gép létrehozása PowerShell használatával](../classic/ps-sql-report.md)
