...
Több virtuális gép is létrehozható az ugyanazon felhőszolgáltatásban. A virtuális gépek forgatókönyv ismertetése: [virtuális gépek csatlakoztatása virtuális hálózattal vagy felhőszolgáltatással szolgáltatással](../classic/connect-vms-classic.md#connect-vms-in-a-standalone-cloud-service). Ebben a forgatókönyvben egy virtuális gépen ügyfél megkísérli ugyanazon a felhőszolgáltatáson egy másik virtuális gépen futó SQL-kiszolgálóhoz való csatlakozáshoz.
