---
title: Azure-beli Gyorsindítás sablonok használata az Azure-beli virtuális gépeken SQL Server always on rendelkezésre állási csoport konfigurálásához
...
ms.locfileid: "70100583"
---
# <a name="use-azure-quickstart-templates-to-configure-an-always-on-availability-group-for-sql-server-on-an-azure-vm"></a>Azure-beli Gyorsindítás sablonok használata az Azure-beli virtuális gépeken SQL Server always on rendelkezésre állási csoport konfigurálásához
...
5. A terheléselosztó **létrehozása** párbeszédpanelen konfigurálja a terheléselosztó a következőképpen:
   ...
   | Beállítás | Value |
   | --- | --- |
   | **Name** |Adja meg a terheléselosztó nevét jelölő szöveges nevet. Írja be például a következőt: **sqlLB**. |
