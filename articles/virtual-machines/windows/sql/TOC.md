...
### Felügyeleti feladatok automatizálása
...
# Útmutatók
## SQL-alapú virtuális gép létrehozása
### [A portál használata](virtual-machines-windows-portal-sql-server-provision.md)
### [Azure PowerShell használata](virtual-machines-windows-ps-sql-create.md)
## Migrate (Áttelepítés)
