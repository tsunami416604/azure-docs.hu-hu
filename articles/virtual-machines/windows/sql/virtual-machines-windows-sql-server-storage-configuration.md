...
* Mindig automatikus tárolási konfigurációt használja [prémium szintű storage](../../../storage/common/storage-premium-storage.md) P30 adatlemezek. Ebből következően nincs leképezést eredményez a kijelölt terabájt és a számát a virtuális Géphez csatlakozik, adatlemezek között 1:1.
