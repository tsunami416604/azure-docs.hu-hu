...
1. Írja `2017` be az **SQL Virtual Machines** csempén található SQL Server képkeresés mezőbe, majd válassza az **ingyenes SQL Server licenc: SQL Server 2017 fejlesztő a Windows Server 2016** a legördülő menüből. 
