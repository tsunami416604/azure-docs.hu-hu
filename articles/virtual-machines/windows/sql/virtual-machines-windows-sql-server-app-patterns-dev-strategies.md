...
* Szeretné kihasználni az Azure-környezet képességeit, de a Azure SQL Database nem támogatja az alkalmazás által igényelt összes funkciót. Ez a következő területeket tartalmazhatja:
  ...
  * **HIPAA-megfelelőség**: az egészségügyi ügyfelek és a független szoftvergyártók (ISV-EK) az azure [Azure SQL Database](../../../sql-database/sql-database-technical-overview.md) [Virtual Machines-ben választhatnak SQL Server az Azure-ban](virtual-machines-windows-sql-server-iaas-overview.md) , mert az Azure-beli virtuális gépeken lévő SQL Servert a HIPAA Business Associate Agreement (Baa) szabályozza. A megfelelőséggel kapcsolatos információkért lásd [: Microsoft Azure Adatvédelmi központ: megfelelőség](https://azure.microsoft.com/support/trust-center/compliance/).
...
Mivel ez nagyon gyakori minta a kezdéshez, előfordulhat, hogy az áttelepítéssel kapcsolatos következő cikk hasznos lehet az adatainak a SQL Server VMba való áthelyezéséhez: [adatbázis áttelepítése egy Azure-beli virtuális gépen lévő SQL Serverre](virtual-machines-windows-migrate-sql.md).
...
Vegye figyelembe, hogy az Azure-beli Load Balancer a terheléselosztáshoz hasonló módon működik a helyszíni környezetben. További információ: terheléselosztás [Az Azure infrastruktúra-szolgáltatásokhoz](../tutorial-load-balancer.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
