...
|  | Hagyományos webes fejlesztés az Azure Virtual machines szolgáltatásban | A cloud Services, Azure-ban | Web Hosting with Azure Web Apps |
| --- | --- | --- | --- |
...
Ezen programozási módszerek közötti választáshoz további információkért lásd: [Azure Web Apps, a Cloud Services és a virtuális gépek: Mikor érdemes használni, amely](/azure/architecture/guide/technology-choices/compute-decision-tree).
