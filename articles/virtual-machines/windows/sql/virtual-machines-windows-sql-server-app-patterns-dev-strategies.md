...
| Szint | Leírás |
| --- | --- |
| **Presentation** |A *bemutatási szint* (webes réteg, előtér-réteg), amelyben a felhasználók interakcióba az alkalmazás a réteg. |
| **Business** |A *üzleti szint* (középső réteg) a réteget, a bemutatási szinten, és az adatszint egymással kommunikálnak, és a rendszer a fő funkciókat tartalmazza. |
...
| **Fejlesztési és üzembe helyezés** |A Visual Studio, WebMatrix, Visual Web Developer, WebDeploy, FTP, TFS, IIS-kezelő PowerShell. |Visual Studio, Azure SDK, TFS, PowerShell. Minden felhőalapú szolgáltatás a szolgáltatás és konfigurációs telepítése két környezet rendelkezik: átmeneti és üzemi. Az átmeneti tesztelje azt, mielőtt előléptetés éles üzemhez egy felhőalapú szolgáltatás telepítése. |Visual Studio, WebMatrix, Visual Web Developer, FTP, GIT, BitBucket, Codeplex webhelyen, dropbox-ba, a GitHub, Mercurial, TFS, webes telepíti, PowerShell. |
