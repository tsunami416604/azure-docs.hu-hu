...
| **Privát** | Kapcsolódás SQL Server ugyanahhoz a virtuális hálózathoz |
...
Bármely internet-hozzáféréssel rendelkező ügyfél csatlakozhat a SQL Server példányhoz a virtuális gép nyilvános IP-címének vagy az IP-címhez rendelt bármely DNS-címkének a megadásával. Ha a SQL Server port 1433, nem kell megadnia azt a kapcsolódási karakterláncban. A következő kapcsolati karakterlánc egy SQL-hitelesítést `sqlvmlabel.eastus.cloudapp.azure.com` használó SQL virtuális géphez csatlakozik (a nyilvános IP-címet is használhatja).
