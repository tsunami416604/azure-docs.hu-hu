...
* Ismerje meg, hogyan [hozhat létre több hálózati adapterrel rendelkező virtuális gépet](../../virtual-network/virtual-network-deploy-multinic-classic-ps.md).
