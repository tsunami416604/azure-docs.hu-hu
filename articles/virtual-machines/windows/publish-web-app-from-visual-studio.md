...
- Figyelmeztetés: Ezzel a beállítással a webkiszolgálón található összes fájl (wwwroot könyvtár) törlődik. Győződjön meg arról, hogy ismeri a gép állapotát, mielőtt engedélyezi ezt a beállítást. 
