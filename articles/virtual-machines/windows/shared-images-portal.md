---
title: Megosztott Azure-beli virtuálisgép-rendszerképek létrehozása a Windowshoz a portál használatával | Microsoft Docs
...
> [!IMPORTANT]
> A portálon nem lehet virtuális gépet üzembe helyezni egy másik Azure-bérlő lemezképéről. Ha a bérlők között megosztott rendszerképből szeretne virtuális gépet létrehozni, az [Azure CLI](../linux/shared-images.md#create-a-vm) -t vagy [](shared-images.md#create-vms-from-an-image)a PowerShellt kell használnia.
