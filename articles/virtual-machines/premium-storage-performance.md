...
>
> * Linux esetén: [az alkalmazás teljesítményteszte Azure Disk Storage](./disks-benchmarks.md)
> * Windows esetén: [egy lemez teljesítményértékelése](./disks-benchmarks.md).
>
