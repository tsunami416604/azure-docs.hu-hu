...
>[AZURE.NOTE] 映像庫中的映像 VHD 名稱會定期變更，因此您必須取得目前的映像名稱，才能部署虛擬機器。 若要這樣做，請參閱 [使用 Windows PowerShell 管理映像 Windows](https://msdn.microsoft.com/library/azure/dn790330.aspx), ，然後以您想要使用的 vhd 檔案的名稱取代 {來源-映像-名稱}。 例如，「 a699494373c04fc0bc8f2bb1389d6106__Windows-Server-2012-R2-201411.01-en.us-127GB.vhd 」。
