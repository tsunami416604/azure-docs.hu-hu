...
>
> A GPU-memória megnövekedett mérete miatt az új ND40rs_v2 virtuális gépen a [2. generációs virtuális gépek](./generation-2.md) és a Piactéri rendszerképek használata szükséges. 
>
