...
A kapcsolódási beállítások megadásához vagy futtathatja a javasolt konfiguráció parancsot (`eval $(docker-machine env myvm)`), vagy manuálisan állíthatja be a környezeti változók. 
