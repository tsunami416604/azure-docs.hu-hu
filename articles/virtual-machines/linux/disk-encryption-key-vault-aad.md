...
### <a name="create-a-key-vault-with-powershell"></a><a name="bkmk_KVPSH"></a>Kulcstartó létrehozása a PowerShell használatával
...
### <a name="create-a-key-vault-with-a-resource-manager-template"></a><a name="bkmk_KVRM"></a>Kulcstartó létrehozása Erőforrás-kezelő sablonnal
...
### <a name="set-up-an-azure-ad-app-and-service-principal-with-azure-powershell"></a><a name="bkmk_ADappPSH"></a>Azure AD-alkalmazás és egyszerű szolgáltatás beállítása az Azure PowerShell használatával 
...
### <a name="set-up-an-azure-ad-app-and-service-principal-though-the-azure-portal"></a><a name="bkmk_ADappRM"></a>Azure AD-alkalmazás és egyszerű szolgáltatás beállítása az Azure Portalon
...
## <a name="set-the-key-vault-access-policy-for-the-azure-ad-app"></a><a name="bkmk_KVAP"></a>Az Azure AD-alkalmazás key vault-hozzáférési szabályzatának beállítása
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-powershell"></a><a name="bkmk_KVAPPSH"></a>Az Azure PowerShell segítségével beállíthatja az Azure AD-alkalmazás key vault-hozzáférési szabályzatát
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-cli"></a><a name="bkmk_KVAPCLI"></a>Az Azure CLI-vel beállíthatja az Azure AD-alkalmazás key vault-hozzáférési szabályzatát
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-the-portal"></a><a name="bkmk_KVAPRM"></a>Állítsa be az Azure AD-alkalmazás key vault-hozzáférési szabályzatát a portállal
...
## <a name="set-key-vault-advanced-access-policies"></a><a name="bkmk_KVper"></a>A kulcstartó speciális hozzáférési házirendjeinek beállítása
...
### <a name="set-key-vault-advanced-access-policies-with-azure-powershell"></a><a name="bkmk_KVperPSH"></a>Kulcstartó speciális hozzáférési szabályzatának beállítása az Azure PowerShell használatával
...
### <a name="set-key-vault-advanced-access-policies-using-the-azure-cli"></a><a name="bkmk_KVperCLI"></a>Kulcstartó speciális hozzáférési szabályzatok beállítása az Azure CLI használatával
...
### <a name="set-key-vault-advanced-access-policies-through-the-azure-portal"></a><a name="bkmk_KVperrm"></a>Kulcstartó speciális hozzáférési szabályzatok beállítása az Azure Portalon keresztül
...
## <a name="set-up-a-key-encryption-key-optional"></a><a name="bkmk_KEK"></a>Kulcstitkosítási kulcs beállítása (nem kötelező)
...
### <a name="set-up-a-key-encryption-key-with-azure-powershell"></a><a name="bkmk_KEKPSH"></a>Kulcstitkosítási kulcs beállítása az Azure PowerShell használatával 
...
## <a name="certificate-based-authentication-and-a-kek-optional"></a><a name="bkmk_CertKEK"></a>Tanúsítványalapú hitelesítés és KEK (nem kötelező)
...
> [!IMPORTANT]
> Az Azure AD tanúsítványalapú hitelesítés jelenleg nem támogatott linuxos virtuális gépeken.
