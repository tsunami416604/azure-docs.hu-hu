...
1. SSH-kapcsolatot a virtuális Gépet a megfelelő hitelesítő adatokkal. Ezt úgy szerezheti be a nyilvános IP-címet a virtuális gép a [az vm megjelenítése](/cli/azure/vm#show):
