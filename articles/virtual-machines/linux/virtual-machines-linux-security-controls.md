...
| Biztonsági ellenőrzés | Igen/nem | Jegyzetek|
|---|---|--|
| Azure monitoring-támogatás (log Analytics, alkalmazás-elemzések stb.)| Igen | Lásd: [Linux rendszerű virtuális gépek monitorozása és frissítése az Azure-ban](./tutorial-monitor.md). |
