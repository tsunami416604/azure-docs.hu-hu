...
Az Azure virtuális gép a Docker használatához rendelkeznie kell a virtuális gép használt Linux kép a [Azure Linux Virtuálisgép-ügynök](../../extensions/agent-linux.md) telepítve. Jelenleg nincsenek lemezképekről Ez csak két típusa:

* Az Azure kép katalógusából Ubuntu kép vagy
* A egyéni létrehozott Azure Linux ügynök a Linux-lemezkép telepítve és konfigurálva. Lásd: [Azure Linux Virtuálisgép-ügynök](../../extensions/agent-linux.md) hogyan hozhat létre egyéni Linux virtuális gép és az Azure Virtuálisgép-ügynök további információt.
