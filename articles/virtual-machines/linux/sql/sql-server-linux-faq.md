...
1. **Milyen SQL Server virtuálisgép-katalógus lemezképei érhetők el?**
   ...
   Az Azure a Linux és a Windows összes kiadásában a SQL Server összes támogatott főbb kiadásához biztosít virtuálisgép-lemezképeket. További részletekért tekintse meg a Linux rendszerű [virtuális gépek rendszerképeinek](sql-server-linux-virtual-machines-overview.md#create) és a [Windowsos virtuálisgép-rendszerképeknek](../../windows/sql/virtual-machines-windows-sql-server-iaas-overview.md#payasyougo)a teljes listáját.
