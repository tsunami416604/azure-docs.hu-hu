---
title: Az Azure-beli Linux rendszerű virtuális gépek karbantartási értesítéseinek kezelésével
...
A következő hívás kezdeményezi a karbantartást egy virtuális gépen, ha `IsCustomerInitiatedMaintenanceAllowed` értéke TRUE (igaz).
