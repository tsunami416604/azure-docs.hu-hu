---
title: Teljesítményteszt pontszámok Azure Linux virtuális gépek számítási |} Microsoft Docs
description: Hasonlítsa össze a CoreMark számítási teljesítményteszt pontszámok Linux operációs rendszert futtató Azure virtuális gépekhez.
...
## <a name="av2---general-compute"></a>Av2 - általános számítási
...
| Standard_A2m_v2 | Intel(R) Xeon(R) CPU E5-2673 v3 @ 2.40GHz | 2 | 1 | 16.0 | 12,450 | 563 | 4.52-es % | 35 |
...
| Virtuális gép mérete | CPU | Virtuális magok | NUMA-csomópontok | Memory(GiB) | Átlagos pontszám | StdDev | StdDev% | #Runs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Standard_A0 | AMD Opteron(tm) processzor 4171 ő | 1 | 1 | 0,6 | 3,556 | 14 | 0.39 % | 21 |
...
## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - általános számítási + prémium szintű Storage
...
| Standard_D16s_v3 | Intel(R) Xeon(R) CPU E5-2673 v3 @ 2.40GHz | 16 | 1 | 64.4 | 158,407 | 3,267 | 2.06 pontját % | 119 |
...
## <a name="dv3---general-compute"></a>Dv3 - általános számítási
...
| Standard_D32_v3 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30-as GHz | 32 | 1 | 128.9 | 311,375 | 3,714 | 1,19 % | 49 |
| Standard_D64_v3 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30-as GHz | 64 | 2 | 257.9 | 613,424 | 19,225 | 3.13 % | 84 |

## <a name="esv3---memory-optimized--premium-storage"></a>Esv3 - Memóriaoptimalizált + prémium szintű Storage
...
## <a name="ev3---memory-optimized"></a>Ev3 - Memóriaoptimalizált
...
## <a name="dsv2---storage-optimized"></a>DSv2 - Memóriaoptimalizált tároló
...
## <a name="dv2---general-compute"></a>Dv2 - általános számítási
...
| Standard_D3_v2 | Intel(R) Xeon(R) CPU E5-2673 v3 @ 2.40GHz | 4 | 1 | 14.0 | 57,666 | 1,559 | 2.70. bekezdés % | 168 |
...
## <a name="d---general-compute"></a>D – számítási általános
...
## <a name="ds---storage-optimized"></a>DS - Memóriaoptimalizált tároló
...
## <a name="fsv2---compute--storage-optimized"></a>Fsv2 - számítási + optimalizált tárolás
(3/23/2018 7:33:23 óra pbi 2050259)

| Virtuális gép mérete | CPU | Virtuális magok | NUMA-csomópontok | Memory(GiB) | Átlagos pontszám | StdDev | StdDev% | #Runs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Standard_F2s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 a @ 2.70GHz | 2 | 1 | 3.9 | 25,392 | 157 | 0.62 % | 49 |
| Standard_F4s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 a @ 2.70GHz | 4 | 1 | 8.0 | 48,065 | 656 | 1.36% | 42 |
| Standard_F8s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 a @ 2.70GHz | 8 | 1 | 16.0 | 95,026 | 1,205 | 1.27 % | 49 |
| Standard_F16s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 a @ 2.70GHz | 16 | 1 | 32.1 | 187,039 | 2,681 | 1.43 % | 42 |
| Standard_F32s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 a @ 2.70GHz | 32 | 1 | 64.4 | 375,828 | 5,180 | 1,38 % | 70 |
| Standard_F64s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 a @ 2.70GHz | 64 | 2 | 128.9 | 741,859 | 5,954 | 0,80 % | 49 |
| Standard_F72s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 a @ 2.70GHz | 72 | 2 | 145.0 | 831,616 | 4,867 | 0.59 % | 42 |

## <a name="f---compute-optimized"></a>F - számítási optimalizált
...
## <a name="fs---compute-and-storage-optimized"></a>FS – számítási és tárolási optimalizált
...
## <a name="g---compute-optimized"></a>G - számítási optimalizált
...
| Standard szintű, G5 | Intel(R) Xeon(R) CPU E5-2698B v3 @ 2,00 GHz | 32 | 2 | 451.5 | 395,591 | 5,192 | 1.31 % | 154 |

## <a name="gs---storage-optimized"></a>GS - Memóriaoptimalizált tároló
...
| Standard h16mr méretű | Intel(R) Xeon(R) CPU E5-2667 v3 @ 3.20GHz | 16 | 2 | 225.7 | 272,683 | 6,484 | 2.38 % | 70 |
| Standard h16r méretű | Intel(R) Xeon(R) CPU E5-2667 v3 @ 3.20GHz | 16 | 2 | 112.8 | 271,822 | 6,126 | 2.25 % | 98 |

## <a name="hpc---a8-11"></a>HPC - A8-11
(3/23/2018 7:35:10 óra pbi 2050259)
...
## <a name="ls---storage-optimized"></a>Ls - optimalizált tároló
...
## <a name="m---memory-optimized"></a>M - memóriaoptimalizált
