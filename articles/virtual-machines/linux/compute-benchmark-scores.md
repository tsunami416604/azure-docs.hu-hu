---
title: Számítási teljesítménypont az Azure Linux virtuális gépekhez
description: Hasonlítsa össze a CoreMark számítási teljesítménypontszámait a Linuxot futtató Azure virtuális gépekhez.
...
---
# <a name="compute-benchmark-scores-for-linux-vms"></a>Számítási teljesítménypont a Linux-virtuális gépekhez
A következő CoreMark benchmark pontszámok az Azure nagy teljesítményű, Ubuntut futtató virtuálisgép-felállásának számítási teljesítményét mutatják. Számítási teljesítménypont-pontszámok a [Windows virtuális gépekhez](../windows/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)is elérhetők.

## <a name="av2---general-compute"></a>Av2 - Általános Számítás
(2019.03.15. 12:06:55 AM pbi 3897709)

| Virtuális gép mérete | CPU | vCPU-k | NUMA csomópontok | Memória(GiB) | Átlagos pontszám | SztdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
Megjegyzés: Az Av2 sorozatú virtuális gépek számos hardvertípusra és processzorra telepíthetők (ahogy fent látható). Az Av2 sorozatú virtuális gépek cpu-teljesítmény- és memóriakonfigurációval rendelkeznek, amelyek a legalkalmasabbak a belépő szintű számítási feladatokhoz, például a fejlesztéshez és a teszteléshez. A méret szabályozása viszonylag konzisztens processzorteljesítményt nyújt a futó példányszámára, függetlenül attól, hogy milyen hardveren van telepítve; azonban az újabb processzoroptimalizálást kihasználó szoftverek jelentősebb eltéréseket tapasztalhatnak a processzortípusok között.

## <a name="b---burstable"></a>B - Burstable
(2019.03.15. 12:27:08 AM pbi 3897709)
...
Megjegyzés: A B sorozatú virtuális gépek a felrobbanható teljesítménykövetelményekkel rendelkező számítási feladatokhoz szolgálnak. A virtuálisgép-példányok krediteket halmoznak fel, ha az alapértéknél kevesebbet használnak. Ha a virtuális gép kreditet halmozott fel, a virtuális gép akár 100%-os alapvonal felett is felrobbanhat a rövid CPU-burst követelmények teljesítése érdekében. A burst idő a rendelkezésre álló kreditektől függ, amely a virtuális gép méretének és idejének függvénye.  

A CoreMark egy rövid futó teszt, amely általában a rendelkezésre álló sorozatfelvétel-jóváírásokon belül fejeződik be.  Ezért a fenti számok általában a virtuális gép burst teljesítményét jelölik, ami tükrözi, amit a rövid, bursty, munkaterhelések (jellemző a B-sorozat) teljesítmény általában látni.

## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - Általános számítás + Prémium szintű tárhely
(2019.12.3., 6:52:03 PM pbi 3897709)
...
## <a name="dv3---general-compute"></a>Dv3 - Általános számítás
(2019.12.3., 6:54:27 PM pbi 3897709)
...
| Standard_D16_v3 | Intel(R) Xeon(R) CPU E5-2673 v3 @ 2.40GHz | 16 | 1 | 62.9 | 160,932 | 2200 | 1.37% | 140 |
...
## <a name="dsv2---storage-optimized"></a>DSv2 - Tárhely optimalizált
(2019.03.15. 12:53:13 AM pbi 3897709)
...
| Standard_DS14 4_v2 4_v2 | Intel(R) Xeon(R) CPU E5-2673 v3 @ 2.40GHz | 4 | 2 | 110.2 | 56,211 | 2,154 | 3.83% | 189 |
| Standard_DS14 4_v2 4_v2 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz | 4 | 1 | 110.2 | 59,651 | 2,560 | 4.29% | 518 |
...
## <a name="dv2---general-compute"></a>Dv2 - Általános számítás
(2019.12.3., 6:53:48 PM pbi 3897709)
...
## <a name="esv3---memory-optimized--premium-storage"></a>Esv3 - Memória optimalizált + Prémium tárhely
(2019.12.3.7:17:33 PM pbi 3897709)
...
| 32s_v3 Standard_E64 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz | 32 | 2 | 425.2 | 307,584 | 3,569 | 1.16% | 56 |

## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - Memória Opt + Premium Storage (elszigetelt)
(2019.11.4.10 10:07:29 PM pbi 3897709)

| Virtuális gép mérete | CPU | vCPU-k | NUMA csomópontok | Memória(GiB) | Átlagos pontszám | SztdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E64is_v3 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz | 64 | 2 | 425.2 | 627,745 | 4,062 | 0.65% | 196 |

## <a name="ev3---memory-optimized"></a>Ev3 - Memória optimalizált
(2019.01.32. 6:52:13 PM pbi 3897709)
...
## <a name="eiv3---memory-optimized-isolated"></a>Eiv3 - Memória optimalizált (elszigetelt)
(2019.12.3., 6:57:51 PM pbi 3897709)
...
## <a name="fsv2---compute--storage-optimized"></a>Fsv2 - Számítás + Tárolás optimalizált
(2019.12.3., 6:51:35 PM pbi 3897709)
...
## <a name="fs---compute-and-storage-optimized"></a>Fs - Számítás és tárolás optimalizált
(2019.03.15. 12:12:51 AM pbi 3897709)
...
## <a name="f---compute-optimized"></a>F - Számítás optimalizált
(2019.12.3., 6:53:59 PM pbi 3897709)
...
## <a name="gs---storage-optimized"></a>GS - Tárhely optimalizált
(2019.12.3.12. 10:22:33 PBI 3897709)
...
## <a name="g---compute-optimized"></a>G - Számítás optimalizált
(2019.12.3.10. 10:23:51 PM pbi 3897709)
...
## <a name="h---high-performance-compute-hpc"></a>H - Nagy teljesítményű számítás (HPC)
(2019.12.3.10. 10:50:51 PBI 3897709)
...
## <a name="lv2---storage-optimized"></a>Lv2 - Tárhely optimalizált
(2019.14.3.14.14.14.15.49:04:PBI 3897709)
...
## <a name="ls---storage-optimized"></a>Ls - Tárhely optimalizált
(2019.12.3.10. 10:22:29 PM pbi 3897709)
...
## <a name="m---memory-optimized"></a>M - Memória optimalizált
(2019.11.4.7:30:39 PM pbi 3897709)
...
| Standard_M16-4 ms | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2,50 GHz | 4 | 1 | 430.6 | 44,451 | 269 | 0.61% | 42 |
...
| Standard_M64-32 ms | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2,50 GHz | 32 | 2 | 1,763.9 | 337,599 | 4,738 | 1.40% | 42 |
...
| Standard_M128-32 ms | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2,50 GHz | 32 | 4 | 3,831.1 | 334,873 | 5,005 | 1.49% | 42 |
| Standard_M128-64 ms | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2,50 GHz | 64 | 4 | 3,831.1 | 667,808 | 18,145 | 2.72% | 42 |
...
## <a name="ncsv3---gpu-enabled"></a>NCSv3 - GPU engedélyezve
(2019.03.21., 17:48:37 PBI 3897709)
...
## <a name="ncsv2---gpu-enabled"></a>NCSv2 - GPU engedélyezve
(2019.12.3.11.19:19 PBI 3897709)
...
## <a name="nc---gpu-enabled"></a>NC - GPU engedélyezve
(2019.12.3.11.01:08:03 PBI 3897709)
...
## <a name="nds--gpu-enabled"></a>NDs- GPU engedélyezve
(2019.12.3.11.19:10 pbi 3897709)
...
## <a name="nv---gpu-enabled"></a>NV - GPU engedélyezve
(2019.12.3.11., 11:08:13 PBI 3897709)
...
## <a name="about-coremark"></a>A CoreMark-ról
A Linux-számokat a [CoreMark](https://www.eembc.org/coremark/faq.php) ubuntu futtatásával számították ki. A CoreMark a virtuális processzorok számára, a PThreads egyidejűségére pedig a szálak számára lett konfigurálva. Az iterációk célszámát a várt teljesítmény alapján módosították, hogy legalább 20 másodperces (általában sokkal hosszabb) futásidejű támpontként szolgáljon. A végeredmény a befejezett ismétlések számát és a teszt futtatásához eltelt másodpercek számát hányadossal teszi ki. Minden teszt et legalább hét alkalommal futtatott minden virtuális gép. A fenti tesztfuttatási dátumok. A tesztek több virtuális számítógépen futnak az Azure nyilvános régióiban, amelyekben a virtuális gép támogatott a dátum futtatásakor. Az alapaknak és a B (Burstable) sorozatnem jelenik meg, mert a teljesítmény változó. Az N sorozat nem jelenik meg, mivel GPU-centrikusak, és a Coremark nem méri a GPU teljesítményét.

## <a name="next-steps"></a>További lépések
* A tárolókapacitást, a lemezrészleteket és a virtuális gépméretek közötti választástovábbi szempontjait a [Virtuális gépek méretei (Méretek) (Virtuális gépek méretei)](sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)ismerteti.
* A CoreMark parancsfájlok Linuxos virtuális gépeken való futtatásához töltse le a [CoreMark parancsfájlcsomagot](https://download.microsoft.com/download/3/0/5/305A3707-4D3A-4599-9670-AAEB423B4663/AzureCoreMarkScriptPack.zip).
