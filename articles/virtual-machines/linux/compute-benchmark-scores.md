...
ms.locfileid: "98201178"
---
# <a name="compute-benchmark-scores-for-linux-vms"></a>A Linux rendszerű virtuális gépek számítási teljesítményteszt-pontszámai
Az alábbi összehasonlító teljesítménytesztek eredményei az Azure nagy teljesítményű virtuálisgép-felállásának számítási teljesítményét mutatják be Ubuntu rendszeren. A számítási teljesítménytesztek pontszámai a [Windows rendszerű virtuális gépek](../windows/compute-benchmark-scores.md)esetében is elérhetők.

## <a name="standard_das_v4"></a>Standard_Das_v4
(12/11/2019 2:28:52 AM PBI 5851281)

|Virtuális gép mérete| CPU | vCPU-k | NUMA-csomópontok | Memória (GiB) | Átlagos pontszám | Szórás | STD fejlesztői% | #Runs |
|---| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
|Standard_D2as_v4| AMD EPYC 7452 32 – core processzor | 2 | 1 | 7,8 | 29 726 | 693 | 2,33% | 42 |
|Standard_D4as_v4| AMD EPYC 7452 32 – core processzor | 4 | 1 | 15,7 | 59 224 | 1 595 | 2,69% | 42 |
|Standard_D8as_v4| AMD EPYC 7452 32 – core processzor | 8 | 1 | 31,4 | 116 412 | 3 613 | 3,10% | 42 |
|Standard_D16as_v4| AMD EPYC 7452 32 – core processzor | 16 | 2 | 62,9 | 229 489 | 7 209 | 3,14% | 35 |
|Standard_D32as_v4| AMD EPYC 7452 32 – core processzor | 32 | 4 | 125,9 | 461 916 | 6 746 | 1,46% | 35 |
...
| Virtuális gép mérete | CPU | vCPU-k | NUMA-csomópontok | Memória (GiB) | Átlagos pontszám | Szórás | STD fejlesztői% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2a_v4 | AMD EPYC 7452 32 – core processzor | 2 | 1 | 7,8 | 30 023 | 333 | 1,11% | 35 |
| Standard_D4a_v4 | AMD EPYC 7452 32 – core processzor | 4 | 1 | 15,7 | 59 685 | 1 141 | 1.91% | 77 |
| Standard_D8a_v4 | AMD EPYC 7452 32 – core processzor | 8 | 1 | 31,4 | 118 346 | 1 130 | 0,95% | 42 |
| Standard_D16a_v4 | AMD EPYC 7452 32 – core processzor | 16 | 2 | 62,9 | 231 131 | 3 830 | 1,66% | 35 |
| Standard_D32a_v4 | AMD EPYC 7452 32 – core processzor | 32 | 4 | 125,9 | 457 266 | 10 208 | 2,23% | 35 |
| Standard_D48a_v4 | AMD EPYC 7452 32 – core processzor | 48 | 6 | 188,9 | 664 078 | 17 241 | 2,60% | 35 |
| Standard_D64a_v4 | AMD EPYC 7452 32 – core processzor | 64 | 8 | 251,9 | 863 911 | 24 818 | 2,87% | 35 |
| Standard_D96a_v4 | AMD EPYC 7452 32 – core processzor | 96 | 12 | 377,9 | 1 290 455 | 13 640 | 1,06% | 35 |
...
| Virtuális gép mérete | CPU | vCPU-k | NUMA-csomópontok | Memória (GiB) | Átlagos pontszám | Szórás | STD fejlesztői% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2as_v4 | AMD EPYC 7452 32 – core processzor | 2 | 1 | 15,7 | 29 217 | 654 | 2,24% | 42 |
| Standard_E4as_v4 | AMD EPYC 7452 32 – core processzor | 4 | 1 | 31,4 | 58 356 | 480 | 0,82% | 42 |
| Standard_E8as_v4 | AMD EPYC 7452 32 – core processzor | 8 | 1 | 62,9 | 115 943 | 3 526 | 3,04% | 35 |
| Standard_E16as_v4 | AMD EPYC 7452 32 – core processzor | 16 | 2 | 125,9 | 227 383 | 5 619 | 2,47% | 35 |
| Standard_E32as_v4 | AMD EPYC 7452 32 – core processzor | 32 | 4 | 251,9 | 454 609 | 12 746 | 2,80% | 35 |
| Standard_E48as_v4 | AMD EPYC 7452 32 – core processzor | 48 | 6 | 377,9 | 682 769 | 9 257 | 1,36% | 35 |
| Standard_E64as_v4 | AMD EPYC 7452 32 – core processzor | 64 | 8 | 503,9 | 881 311 | 28 357 | 3,22% | 35 |
| Standard_E96as_v4 | AMD EPYC 7452 32 – core processzor | 96 | 12 | 661,4 | 1 299 233 | 14 997 | 1,15% | 70 |
...
| Virtuális gép mérete | CPU | vCPU-k | NUMA-csomópontok | Memória (GiB) | Átlagos pontszám | Szórás | STD fejlesztői% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2a_v4 | AMD EPYC 7452 32 – core processzor | 2 | 1 | 15,7 | 29 561 | 422 | 1,43% | 42 |
| Standard_E4a_v4 | AMD EPYC 7452 32 – core processzor | 4 | 1 | 31,4 | 58 303 | 1 280 | 2,20% | 42 |
| Standard_E8a_v4 | AMD EPYC 7452 32 – core processzor | 8 | 1 | 62,9 | 114 650 | 2 726 | 2,38% | 42 |
| Standard_E16a_v4 | AMD EPYC 7452 32 – core processzor | 16 | 2 | 125,9 | 226 947 | 4 661 | 2,05% | 35 |
| Standard_E32a_v4 | AMD EPYC 7452 32 – core processzor | 32 | 4 | 251,9 | 453 666 | 10 058 | 2,22% | 42 |
| Standard_E48a_v4 | AMD EPYC 7452 32 – core processzor | 48 | 6 | 377,9 | 665 200 | 18 714 | 2,81% | 35 |
| Standard_E64a_v4 | AMD EPYC 7452 32 – core processzor | 64 | 8 | 503,9 | 894 718 | 25 214 | 2,82% | 35 |
| Standard_E96a_v4 | AMD EPYC 7452 32 – core processzor | 96 | 12 | 661,4 | 1 298 074 | 15 948 | 1,23% | 35 |
...
> [!NOTE]
> A B sorozatú virtuális gépek a feldolgozható teljesítménnyel kapcsolatos követelményeknek megfelelő számítási feladatokhoz használhatók. A virtuálisgép-példányok akkor halmoznak fel kreditet, ha az alaptervnél kevesebbet használ. Ha a virtuális gép felhalmozott Kredittel rendelkezik, a virtuális gép az alapkonfiguráció felett akár 100%-ot is megadhat, hogy megfeleljen a rövid CPU-burst követelményeinek. A burst idő a virtuális gép méretének és időpontjának függvényében elérhető kredittől függ.  
>
...
## <a name="dsv2---storage-optimized"></a>DSv2 – optimalizált tárolás
...
## <a name="esv3---memory-optimized--premium-storage"></a>Esv3 – optimalizált memória + Premium Storage
...
## <a name="ev3---memory-optimized"></a>Ev3 – optimalizált memória
...
## <a name="eiv3---memory-optimized-isolated"></a>Eiv3 – optimalizált memória (elszigetelt)
...
## <a name="fsv2---compute--storage-optimized"></a>Fsv2 – a számítás és a tárolás optimalizált
(3/12/2019 6:51:35 PM PBI 3897709)

| Virtuális gép mérete | CPU | vCPU-k | NUMA-csomópontok | Memória (GiB) | Átlagos pontszám | Szórás | STD fejlesztői% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_F2s_v2 | Intel (R) Xeon (R) Platinum 8168 CPU @ 2.70 GHz | 2 | 1 | 3.9 | 28 219 | 1 843 | 6,53% | 700 |
| Standard_F4s_v2 | Intel (R) Xeon (R) Platinum 8168 CPU @ 2.70 GHz | 4 | 1 | 7,8 | 53 911 | 1 002 | 1,86% | 707 |
| Standard_F8s_v2 | Intel (R) Xeon (R) Platinum 8168 CPU @ 2.70 GHz | 8 | 1 | 15,7 | 106 467 | 1 101 | 1,03% | 707 |
| Standard_F16s_v2 | Intel (R) Xeon (R) Platinum 8168 CPU @ 2.70 GHz | 16 | 1 | 31,4 | 211 311 | 1 724 | 0,82% | 707 |
| Standard_F32s_v2 | Intel (R) Xeon (R) Platinum 8168 CPU @ 2.70 GHz | 32 | 1 | 62,9 | 423 175 | 4 346 | 1,03% | 707 |
| Standard_F64s_v2 | Intel (R) Xeon (R) Platinum 8168 CPU @ 2.70 GHz | 64 | 2 | 125,9 | 829 537 | 21 574 | 2,60% | 707 |
| Standard_F72s_v2 | Intel (R) Xeon (R) Platinum 8168 CPU @ 2.70 GHz | 72 | 2 | 141,7 | 933 800 | 26 783 | 2,87% | 707 |

## <a name="fs---compute-and-storage-optimized"></a>FS – a számítás és a tárolás optimalizált
...
## <a name="gs---storage-optimized"></a>GS-Storage optimalizált
...
## <a name="g---compute-optimized"></a>G – a számítás optimalizált
...
## <a name="lv2---storage-optimized"></a>Lv2 – optimalizált tárolás
(3/14/2019 5:49:04 PM PBI 3897709)

| Virtuális gép mérete | CPU | vCPU-k | NUMA-csomópontok | Memória (GiB) | Átlagos pontszám | Szórás | STD fejlesztői% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32 – core processzor | 8 | 1 | 62,9 | 80 528 | 404 | 0,50% | 119 |
| Standard_L16s_v2 | AMD EPYC 7551 32 – core processzor | 16 | 2 | 125,9 | 154 829 | 3 708 | 2,40% | 119 |
| Standard_L32s_v2 | AMD EPYC 7551 32 – core processzor | 32 | 4 | 251,9 | 310 811 | 7 751 | 2,49% | 119 |
| Standard_L64s_v2 | AMD EPYC 7551 32 – core processzor | 64 | 8 | 503,9 | 595 140 | 14 572 | 2,45% | 112 |
| Standard_L80s_v2 | AMD EPYC 7551 32 – core processzor | 80 | 10 | 629,9 | 773 171 | 19 559 | 2,53% | 119 |

## <a name="ls---storage-optimized"></a>Az ls-Storage optimalizált
...
## <a name="m---memory-optimized"></a>M-memória optimalizálva
...
## <a name="about-coremark"></a>Tudnivalók a megjegyzésekről
...
* A tárolási kapacitás, a lemez adatai és a virtuálisgép-méretek kiválasztásával kapcsolatos további szempontok: [virtuális gépek méretei](../sizes.md).
