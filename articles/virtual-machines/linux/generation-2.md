...
> [!IMPORTANT]
> Azure-támogatás a 2. generációs virtuális gépek jelenleg előzetes verzióban érhető el. Ez az előnézeti verzió egy szolgáltatásiszint-megállapodás nélkül biztosítja, és nem javasolt éles számítási feladatok esetében. Előfordulhat, hogy néhány funkció nem támogatott, vagy korlátozott képességekkel rendelkezik.
...
* [Dsv2 sorozat](https://docs.microsoft.com/azure/virtual-machines/linux/sizes-general#dsv2-series) és [Dsv3-sorozat](https://docs.microsoft.com/azure/virtual-machines/linux/sizes-general#dsv3-series-1)
