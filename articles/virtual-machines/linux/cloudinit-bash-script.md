...
Most hozzon létre egy virtuális gépet az [az VM Create](/cli/azure/vm) paranccsal, és adja meg a bash parancsfájlt `--custom-data simple_bash.sh` a következőképpen:
