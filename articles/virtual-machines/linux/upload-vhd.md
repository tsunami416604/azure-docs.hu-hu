...
Az alábbi példákban cserélje le a példában szereplő paramétereket a saját értékeire (például `myResourceGroup`: `mystorageaccount`,, `mydisks`és).
