...
Első lépésként kell a legújabb [Azure CLI 2.0](/cli/azure/install-azure-cli) telepítve, és bejelentkezett egy Azure-fiókba az [az bejelentkezési](/cli/azure/reference-index#az-login).
