---
title: Általános Azure CLI-parancsok
...
---
# <a name="common-azure-cli-commands-for-managing-azure-resources"></a>Általános Azure CLI-parancsok az Azure-erőforrások kezeléséhez
...
Az adott parancssori kapcsolókkal és beállításokkal kapcsolatos részletesebb segítségért használja az online parancs súgóját és beállításait a `az <command> <subcommand> --help`beírásával.
