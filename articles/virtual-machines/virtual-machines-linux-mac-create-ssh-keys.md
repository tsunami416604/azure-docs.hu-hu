---
title: "SSH nyilvános és titkos kulcspárok létrehozása Linux rendszerű virtuális gépekhez | Microsoft Docs"
description: "Létrehozhat SSH nyilvános és titkos kulcspárokat Linux rendszerű virtuális gépekhez."
...
Adja meg a `~/.ssh/` könyvtárba mentett titkos kulcsfájl nevét:
...
Másolja a nyilvános SSH-kulcsot a Linux rendszerű virtuális gépre:
...
Az SSH konfigurálása sikeres volt, ha a rendszer nem kéri a titkos kulcs jelszavát vagy egy bejelentkezési jelszót a VM-hez.
