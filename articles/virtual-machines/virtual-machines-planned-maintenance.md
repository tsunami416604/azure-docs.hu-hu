...
如需有關設定高可用性虛擬機器的詳細資訊，請參閱 [管理您的虛擬機器的可用性](virtual-machines-manage-availability.md)。
...
如需有關更新網域和容錯網域的詳細資訊，請參閱 [設定多部虛擬機器中的可用性設定組備援](virtual-machines-manage-availability.md#configure-multiple-virtual-machines-in-an-availability-set-for-redundancy)。
