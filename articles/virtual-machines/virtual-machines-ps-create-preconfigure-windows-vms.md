...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] [資源管理員模型](virtual-machines-ps-create-preconfigure-windows-resource-manager-vms.md)。
...
若要設定以 Linux 為基礎的虛擬機器系列主題，請參閱 [使用 Azure PowerShell 建立和預先設定以 Linux 為基礎的虛擬機器](virtual-machines-ps-create-preconfigure-linux-vms.md)。


## 步驟 1：安裝 Azure PowerShell

如果您尚未這麼做，請使用中的指示 [如何安裝和設定 Azure PowerShell](../install-configure-powershell.md) 本機電腦上安裝 Azure PowerShell。 然後，開啟 Azure PowerShell 命令提示字元。
...
Windows 型虛擬機器的其他預先組態選項，請參閱的語法 **Windows** 和 **WindowsDomain** 參數是設定 [Add-azureprovisioningconfig](https://msdn.microsoft.com/library/azure/dn495299.aspx)。
