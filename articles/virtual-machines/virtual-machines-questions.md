...
- Windows 的指示，請參閱 [建立和上載的 Windows 伺服器 VHD，以 Azure](virtual-machines-create-upload-vhd-windows-server.md)。
...
如需詳細資訊，請參閱 [虛擬機器價格](http://azure.microsoft.com/pricing/details/virtual-machines/)。
