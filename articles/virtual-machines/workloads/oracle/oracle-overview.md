...
* Engedélyezze az Oracle Real Application Clusters (RAC) szolgáltatást az Azure-ban az [Azure VMWare-megoldásvagy](https://docs.microsoft.com/azure/vmware-cloudsimple/oracle-real-application-clusters/) a [FlashGrid SkyCluster](https://www.flashgrid.io/oracle-rac-in-azure/)használatával.
