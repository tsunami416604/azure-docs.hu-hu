...
A Microsoft és az Oracle együttesen együttműködve lehetővé teszi, hogy az ügyfelek olyan Oracle-alkalmazásokat telepítsenek, mint például az Oracle E-Business Suite, a JD Edwards EnterpriseOne és a PeopleSoft a felhőben. Az előnézeti [magánhálózat](configure-azure-oci-networking.md) Microsoft Azure és az Oracle Cloud Infrastructure (OCI) közötti összekapcsolásának bevezetésével az Oracle-alkalmazások mostantól üzembe helyezhetők az Azure-ban az Azure-ban vagy a OCI-ban található háttér-adatbázisokkal. Az Oracle-alkalmazások Azure Active Directory is integrálhatók, így az egyszeri bejelentkezés beállítható úgy, hogy a felhasználók bejelentkezhetnek az Oracle-alkalmazásba a Azure Active Directory (Azure AD) hitelesítő adataik használatával.
...
[Több lehetőség](oracle-overview.md) is van az Oracle-alkalmazások Azure-ban történő üzembe helyezésére, többek között a rendelkezésre állásra és a biztonságos használatra. Az Azure [Oracle Database](oracle-vm-solutions.md) -alapú virtuálisgép-rendszerképeket is kínál, amelyeket akkor telepíthet, ha az Oracle-alkalmazásokat teljes egészében az Azure-ban futtatja.
...
*2. ábra: E-Business Suite – csak Azure-architektúrák*
...
Habár ez az architektúra az IDCS-integrációt mutatja be, az Azure AD Unified Access és az egyszeri bejelentkezés is engedélyezhető az Oracle Access Managerben Oracle Internet Directory vagy Oracle Unified Directory használatával. További információ: az [Oracle EBS üzembe helyezése az IDCS](https://cloud.oracle.com/iaas/whitepapers/deploy_ebusiness_suite_across_oci_azure_sso_idcs.pdf) -integrációval vagy az [Oracle EBS üzembe](https://cloud.oracle.com/iaas/whitepapers/deploy_ebusiness_suite_across_oci_azure_sso_oam.pdf)helyezése OAM-integrációval.
...
*3. ábra: JD Edwards EnterpriseOne – Felhőbeli architektúra*
...
*4. ábra: JD Edwards EnterpriseOne csak Azure architektúrával*
...
### <a name="presentation-tier"></a>Megjelenítési szintek
...
*6. ábra: A PeopleSoft csak Azure architektúrája*
...
Használjon [Terraform](https://github.com/microsoft/azure-oracle) -szkripteket Oracle-alkalmazások beállításához az Azure-ban, és hozzon létre több Felhőbeli kapcsolatot a OCI használatával.
