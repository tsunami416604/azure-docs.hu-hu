---
title: A HB sorozatú virtuális gépek méretének teljesítménye – Azure Virtual Machines | Microsoft Docs
...
| RDMA késés & sávszélesség                        | 2.35 USEC, 96,5 GB/s   |
| FIO helyi NVMe SSD-vel                           | ~ 1,7 GB/s olvasások, ~ 1,0 GB/s írások      |  
...
| #bytes  | Késés [második] (MPICH 3,3 + CH4) | Késés [második] (OpenMPI 4.0.0) | Késés [másodpercenként] (MVAPICH2 2,3) | Késés [mp] (Intel MPI 2019) |
|------|----------|----------|----------|----------|
