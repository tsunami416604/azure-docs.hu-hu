...
- Szerezze be a [vállalati kiszolgáló és](https://www.microfocus.com/documentation/enterprise-developer/#")a nagyvállalati fejlesztő dokumentációját.
...
A telepítés után ellenőrizze, hogy vannak-e további frissítések, mivel számos előfeltétel, például a Microsoft C++ újraterjeszthető és a .NET-keretrendszer telepítve van a vállalati kiszolgálóval együtt.

### <a name="upload-the-license"></a>A licenc feltöltése

1. Indítsa el a Micro Focus-licencek felügyeletét.

2. \> Kattintson a Micro Focus License Manager-licencek felügyelete elemre, majd kattintson a telepítés fülre. \> Válassza ki a feltölteni kívánt licenc formátum típusát: egy licencfájl vagy egy 16 karakterből álló licenckód. Egy fájl esetében például a **licencfájl**területen keresse meg a korábban feltöltött **mflic** -fájlt a virtuális gépre, és válassza a **Licencek telepítése**lehetőséget.
...
- [Nagyszámítógépi alkalmazások áttelepítése](/azure/architecture/cloud-adoption/infrastructure/mainframe-migration/application-strategies)
