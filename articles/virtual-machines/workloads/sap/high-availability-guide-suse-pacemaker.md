...
1. SLES frissítése
   ...
   > [!NOTE]
   > Előfordulhat, hogy az operációs rendszer frissítése vagy frissítése után újra kell indítania az operációs rendszert. 
