...
- A delta_datashipping és a logreplay két [működési mód](https://help.sap.com/viewer/6b94445c94ae495c83a19646e7c3fd56/2.0.02/en-US/627bd11e86c84ec2b9fcdf585d24011c.html) érhető el, amelyek egy ilyen forgatókönyvhöz érhetők el
- Mindkét működési mód esetében eltérő memória-követelmények vannak az előzetes betöltés nélkül
- Előfordulhat, hogy a Delta_datashipping a logreplay megkövetelése nélkül jelentősen kevesebb memóriát igényel. A [SAP HANA rendszer-replikálásának végrehajtásához](https://archive.sap.com/kmuuid2/9049e009-b717-3110-ccbd-e14c277d84a3/How%20to%20Perform%20System%20Replication%20for%20SAP%20HANA.pdf) tekintse meg az SAP-dokumentum 4,3. fejezetét.
...
Ezekben az esetekben beállíthatja, hogy milyen SAP-hívások [SAP HANA](https://help.sap.com/viewer/6b94445c94ae495c83a19646e7c3fd56/2.0.02/en-US/ca6f4c62c45b4c85a109c7faf62881fc.html) többszintű rendszerreplikálási konfigurációt a HANA rendszerreplikáció használatával. Az architektúra így néz ki:
...
> [!IMPORTANT]
> A különböző rétegek közötti műveleti módoknak homogénnek kell lenniük. A logreply **nem** használható az 1. és a 2. szintű és a delta_datashipping között a 3. szinten. Az összes réteghez konzisztensnek kell lennie, vagy más működési módot kell választania. Mivel a delta_datashipping nem alkalmas a RPO = 0 elérésére, az ilyen többrétegű konfigurációk esetében az egyetlen ésszerű működési mód marad a logreplay. A működési módokkal és bizonyos korlátozásokkal kapcsolatos részletekért tekintse meg az SAP-cikkek [működési módjait SAP HANA rendszer](https://help.sap.com/viewer/6b94445c94ae495c83a19646e7c3fd56/2.0.02/en-US/627bd11e86c84ec2b9fcdf585d24011c.html)-replikáláshoz című témakört. 
