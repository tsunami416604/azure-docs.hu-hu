...
Ez a cikk bemutatja, hogyan telepíthet és konfigurálhat magas rendelkezésre állású SAP-rendszert az Azure-ban, a Windows Server feladatátvételi fürt (WSFC) és a Scale-Out fájlkiszolgáló beállításával az SAP ASCS/SCS-példányok fürtözéséhez.
