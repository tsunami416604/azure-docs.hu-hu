...
- További tudnivalók [SAP HANA rendelkezésre állási belül egy Azure-régiót](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/sap-hana-availability-one-region).
- További tudnivalók [SAP HANA rendelkezésre állási Azure-régiók közötti](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/sap-hana-availability-across-regions). 
