...
Az Azure-ban támogatott SAP-szoftvereket az Azure-beli [üzembe helyezések által támogatott SAP-szoftvereket](./sap-supported-product-on-azure.md)ismertető cikkben találja.
