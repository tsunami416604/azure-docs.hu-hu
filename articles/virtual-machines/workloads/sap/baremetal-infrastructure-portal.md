...
ms.locfileid: "97675905"
---
# <a name="manage-baremetal-instances-through-the-azure-portal"></a>BareMetal-példányok kezelése a Azure Portal
 
Ez a cikk bemutatja, hogyan jeleníti meg a [Azure Portal](https://portal.azure.com/) a BareMetal-példányokat. Ez a cikk azokat a tevékenységeket mutatja be, amelyeket a Azure Portal az üzembe helyezett BareMetal-példányok egységével végezhet el. 
...
>[!NOTE]
>A 4,2-es változat a legújabb rebranded BareMetal-infrastruktúra a 4. változat architektúrán keresztül. Jelentős mértékben javult az Azure-beli virtuális gépek és a 4. változatban vagy sorokban üzembe helyezett BareMetal-példányok közötti hálózati késés.
...
Ha többet szeretne megtudni a BareMetal-ről, tekintse meg a [BareMetal számítási feladatok típusai](../../../virtual-machines/workloads/sap/get-started.md)című témakört.