...
4. Hozzon létre hálózati biztonsági csoportokra vonatkozó szabályokat a megadott nyilvános végpontokhoz való hozzáférés korlátozására. Ha van meglévő hálózati biztonsági csoport, módosíthatja azt. Az alábbi példa bemutatja, hogyan engedélyezheti a hozzáférést csak az Azure felügyeleti API-hoz: 
