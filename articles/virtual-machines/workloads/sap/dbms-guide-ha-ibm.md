...
További információ az Azure-beli Linux Pacemakerről: [a pacemaker beállítása SUSE Linux Enterprise Server az Azure-ban](./high-availability-guide-suse-pacemaker.md).
