...
* [Telepítse a virtuális gépeket][sap-high-availability-infrastructure-wsfc-shared-disk].

* [Azure Load Balancer létrehozása és konfigurálása az SAP-ASCS][sap-high-availability-infrastructure-wsfc-shared-disk-default-ascs-ilb-rules].

* [Ha Azure Load Balancer a sorba helyezni Replication Server 2 (ERS2) használata esetén a ERS2-konfigurációt kell végrehajtania ][sap-high-availability-infrastructure-wsfc-shared-disk-default-ascs-ilb-rules]. 
