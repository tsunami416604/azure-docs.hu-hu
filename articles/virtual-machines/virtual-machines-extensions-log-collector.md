...
5. 依照下列方式呼叫 SetAzureServiceLogCollector.ps1 (包含在本文結尾處)，以啟用雲端服務的 AzureLogCollector 延伸模組。 一旦完成執行時，您可以找到上傳的檔案在 `https://YouareStorageAccountName.blob.core.windows.net/vmlogs`
