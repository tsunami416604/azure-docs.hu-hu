...
>[AZURE.NOTE] 儲存體容量由使用 1024年 ^3 位元組當成 GB 的度量單位。 這有時稱為 gibibyte 或基底 2 定義。 比較使用不同基底系統的大小時，請記住，基底 2 的大小可能會顯示為小於基底 10，但是對於任何特定的大小 (例如 1 GB)，基底 2 的系統可提供比基底 10 系統更大的容量，因為 1024^3 大於 1000^3。
...
|大小 |CPU 核心|記憶體|NIC (最大)|最大 磁碟大小|最大 資料磁碟 (每個 1023 GB)|快取大小 (GB)|最大 磁碟 IOPS 與聊天室頻寬|
|---|---|---|---|---|---|---|---|
