...
Az alábbi példák a nyers JSON-fájlokat használja. Használat [az virtuálisgép-bővítmény csoportot](/cli/azure/vm/extension) , majd hívja meg a JSON-fájlokat. Ezek a JSON-fájlok is meghívhat az Azure-sablonok. 
