...
A méretezési csoport egyéni parancsfájl-bővítményének üzembe helyezéséhez lásd: [Add-AzVmssExtension](/powershell/module/az.compute/add-azvmssextension)
