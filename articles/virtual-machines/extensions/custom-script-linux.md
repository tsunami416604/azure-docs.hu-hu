...
Az egyéni parancsfájl-bővítmény végrehajtási állapotát is lekérheti, beleértve `commandToExecute` az Azure CLI használatával átadott tényleges argumentumokat is:
