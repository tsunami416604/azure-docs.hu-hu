...
A bővítményfájl állapota sub állapota és együtt a hibával kapcsolatos részletes és a leírás a egyes kiterjesztések futtatása sikeres/meghiúsult állapotkódok tartalmazza.
```
