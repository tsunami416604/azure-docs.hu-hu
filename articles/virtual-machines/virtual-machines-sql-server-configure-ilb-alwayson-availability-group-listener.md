...
本文著重於建立使用**內部負載平衡器 (ILB)** 的接聽程式。 如果您需要的公用/外部接聽程式，請參閱本文中提供的步驟設定版本 [外部接聽程式](virtual-machines-sql-server-configure-public-alwayson-availability-group-listener.md)
