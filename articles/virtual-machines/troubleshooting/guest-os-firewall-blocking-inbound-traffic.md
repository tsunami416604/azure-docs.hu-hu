...
description: 'Útmutató: a Távoli asztali portál (RDP) kapcsolatával kapcsolatos probléma, amely miatt a vendég operációs rendszer tűzfala blokkolja a bejövő forgalmat.'
