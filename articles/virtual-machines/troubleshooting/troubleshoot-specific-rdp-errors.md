...
További információ: az Azure-beli [virtuális gép "nincs távoli asztal elérhető licenckiszolgálóra"](/archive/blogs/mast/rdp-to-azure-vm-fails-with-no-remote-desktop-license-servers-available)nevű blogbejegyzést.
...
Ha például bejelentkezett a helyi fiók DC1\DCAdmin, majd előléptette a virtuális gépet tartományvezérlőként egy új erdőben a corp.contoso.com tartományhoz, a DC1\DCAdmin helyi fiókja törölve lesz, és egy új tartományi fiók (CORP\DCAdmin) jön létre ugyanazzal a jelszóval.
