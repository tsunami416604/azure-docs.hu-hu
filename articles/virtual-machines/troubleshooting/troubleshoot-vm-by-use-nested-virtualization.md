...
12. Válassza a **Telepítés** lehetőséget.
...
2.  Válassza [le és válassza le a javított operációsrendszer-lemezt](troubleshoot-recovery-disks-portal-windows.md#unmount-and-detach-the-original-virtual-hard-disk
).
