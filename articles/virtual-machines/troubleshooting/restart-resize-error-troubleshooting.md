...
## <a name="issue-error-when-starting-a-stopped-vm"></a>Probléma: hiba történt egy leállított virtuális gép indításakor
...
* Állítsa le az összes virtuális gépet a rendelkezésre állási csoportból, majd indítsa újra az egyes virtuális gépeket.
  ...
  1. Kattintson **Az erőforráscsoportok** > *az erőforráscsoport* > **erőforrások** > *a rendelkezésre állási* csoport > **Virtual Machines** *a virtuális gép* > **leállítása**elemre.
