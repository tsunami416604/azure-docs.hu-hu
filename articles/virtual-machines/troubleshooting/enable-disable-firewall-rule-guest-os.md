...
description: Megtudhatja, hogyan használhatja az online vagy offline távoli eszközöket vagy beállításjegyzék-beállításokat a vendég operációsrendszer tűzfalszabályainak engedélyezéséhez vagy letiltásához egy távoli Azure-beli virtuális gépen.
