...
Ha egy Azure-beli virtuális gép (VM) nagy számú csatlakoztatott virtuális Merevlemezrel rendelkezik, amelyek ugyanabban a Storage-fiókban találhatók, akkor előfordulhat, hogy túllépi az egyes Storage-fiókok méretezhetőségi céljait, ami miatt a virtuális gép váratlanul újraindul. Vizsgálja meg a Storage-fiók (**TotalRequests**/**TotalIngress**/**TotalEgress**) perc mérőszámait a tárolási fiók skálázhatósági céljainak meghaladása érdekében. A [metrikák](../../storage/common/storage-monitoring-diagnosing-troubleshooting.md#metrics-show-an-increase-in-PercentThrottlingError) című témakörben megtudhatja, hogy a mérőszámok a percentthrottlingerror értéket mutatnak megtörtént-e a szabályozás során.
