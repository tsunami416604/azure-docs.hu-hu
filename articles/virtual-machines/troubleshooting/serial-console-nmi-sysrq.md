---
title: Azure soros konzol SysRq és NMI hívásokhoz | Microsoft dokumentumok
...
* A fő Soros Konzol Linux dokumentációs oldal [itt](serial-console-linux.md)található .
...
* A soros konzol [Windows](serial-console-windows.md) virtuális gépekhez is elérhető
