---
title: Példányok leltárának megtekintése a Azure Portalban
description: Példányok leltárának megtekintése a Azure Portalban
services: azure-arc
...
1. A példányokat a többi Azure SQL-vagy Azure PostgreSQL-nagy kapacitású-erőforrással megegyező nézetben tekintheti meg (a szűrőket a részletes nézetekhez használhatja).
