...
* Tekintse meg a [támogatott operációs rendszerek](../../../azure-monitor/insights/vminsights-enable-overview.md#supported-operating-systems) című témakört, amely biztosítja, hogy az Ön által engedélyezett kiszolgálók operációs rendszerét Azure monitor for VMS támogatja.
