...
A **Windows**esetében az ügynök egy Windows Installer (`.MSI`) fájlba van csomagolva, és a [https://download.microsoft.com](https://download.microsoft.com)üzemeltetett [https://aka.ms/AzureConnectedMachineAgentból ](https://aka.ms/AzureConnectedMachineAgent)tölthető le.
...
* Ha már telepítette az ügynököt, hajtsa végre a `/opt/azcmagent/bin/hybridrp_proxy add https://{proxy-url}:{proxy-port}`parancsot, amely konfigurálja a proxyt, és újraindítja az ügynököt.
