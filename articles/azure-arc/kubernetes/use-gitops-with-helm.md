...
Futtassa az alábbi parancsot, és a böngészőben navigáljon a [localhost: 3000](http://localhost:3000) -re, és ellenőrizze, hogy fut-e az alkalmazás.
