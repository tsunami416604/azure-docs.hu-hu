...
-   An HDInsight cluster. For instructions on the various ways in which such clusters can be created, see [Provision HDInsight Clusters][Provision HDInsight Clusters].
...
1.  [Understand the scenario][Understand the scenario]
2.  [Run the Sample with Azure PowerShell][Run the Sample with Azure PowerShell]
3.  [The Java Code for the word counting MapReduce Program][The Java Code for the word counting MapReduce Program]
...
-   A MapReduce program. In this tutorial, you will use the word counting sample that comes with HDInsight clusters so you don't need to write your own. It is located on */example/jars/hadoop-examples.jar*. The file name is *hadoop-mapreduce-examples.jar* on version 3.0 HDInsight clusters. For instructions on writing your own MapReduce job, see [Develop Java MapReduce programs for HDInsight][Develop Java MapReduce programs for HDInsight].
-   An input file. You will use */example/data/gutenberg/davinci.txt* as the input file. For information on upload files, see [Upload Data to HDInsight][Upload Data to HDInsight].
...
## <span id="run-sample"></span></a>Run the Sample with Azure PowerShell
...
## <span id="java-code"></span></a>The Java Code for the word counting MapReduce Program
...
-   [Run the HDInsight Samples][Run the HDInsight Samples]
  ...
  [Understand the scenario]: #scenario
  [Run the Sample with Azure PowerShell]: #run-sample
  [The Java Code for the word counting MapReduce Program]: #java-code
