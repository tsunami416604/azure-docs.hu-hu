...
A sok előre konfigurált megoldás által használt [Azure IoT Hub][] szolgáltatás is érdekelheti. Az [Azure IoT Hub][] biztonságos és megbízható, az előre konfigurált megoldásarchitektúrában használt kétirányú kommunikációt nyújt az eszközök és a felhő között.
