...
* Ha törli az erőforráscsoportja a [Azure-portálon][lnk-azure-portal], csak törli az erőforrásokat, az erőforráscsoport. Az Azure Active Directory-alkalmazás az előkonfigurált megoldás társított törölnie kell a [a klasszikus Azure portálon][lnk-classic-portal].
