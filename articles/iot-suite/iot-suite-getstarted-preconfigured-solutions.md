...
> [!NOTE]
> Ahhoz, hogy biztosan törölje az előre konfigurált megoldáshoz kapcsolódó összes elemet, törölje azt az [azureiotsuite.com][lnk-azureiotsuite] webhelyről, és ne csak az erőforráscsoportot törölje a portálon.
> 
> 
