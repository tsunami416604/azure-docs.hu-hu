...
2. Kattintson a **mentett lekérdezések frissítése**elemre. Az eszköz értesíti, ha a változók frissítve lettek.
...
- Idősorozat-modell API-k
  ...
  - Példány API-k 
    ...
    - [Javaslom](https://docs.microsoft.com/rest/api/time-series-insights/dataaccessgen2/timeseriesinstances/suggest)
  - Hierarchia API-k
