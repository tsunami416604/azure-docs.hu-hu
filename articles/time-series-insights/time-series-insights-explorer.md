...
### <a name="in-this-video-we-cover-querying-data-using-the-time-series-insights-explorer-br"></a>Ez a videó ismerteti a Time Series Insights explorer használata az adatok lekérdezéséhez. </br>
...
1. Is frissítheti rendelkezésre állási automatikusan percenkénti kiválasztásával a **automatikus a** gombra.  Vegye figyelembe, hogy az "Automatikus – a" gomb csak a rendelkezésre állási diagram, a fő Vizualizáció a tartalom nem vonatkozik.
