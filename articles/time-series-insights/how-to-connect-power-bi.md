...
Ha már betöltött egy adatkészletet a Power BIban, de módosítani szeretné a lekérdezést (például a dátum/idő vagy a környezeti azonosító paramétereit), ezt a Power BI Speciális szerkesztő funkcióján keresztül teheti meg. További információért tekintse meg a [Power bi dokumentációját](/power-bi/desktop-query-overview) .
...
* További információ a Azure Time Series Insights [Power bi-összekötővel kapcsolatos fogalmakról](/power-bi/desktop-query-overview) .
