...
* **Idősorozat-lekérdezési (TSQ) API-k**: lehetővé teszi az események adatainak lekérését a forrás szolgáltatótól való rögzítéshez. Ezek az API-k műveleteket végezhetnek az idősorozat-adatokra vonatkozó számítások átalakításához, összevonásához és végrehajtásához.
...
[![Time sorozat lekérdezésének áttekintése](media/v2-update-tsq/tsq.png)](media/v2-update-tsq/tsq.png#lightbox)
...
* [Összesítő sorozat API](https://docs.microsoft.com/rest/api/time-series-insights/preview-query#aggregate-series-api): lehetővé teszi Time Series Insights adatok lekérdezését és lekérését a rögzített eseményekről mintavételezéssel és a rögzített adatok összesítésével.
  ...
  Támogatott aggregált típusok: `Min`, `Max`, `Sum`, `Count`, `Average`
