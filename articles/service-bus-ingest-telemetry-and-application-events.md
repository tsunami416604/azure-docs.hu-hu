...
-   [Event Hubs Pricing Details][Event Hubs Pricing Details]
-   [Event Sourcing Pattern][Event Sourcing Pattern]

## Build

-   [Event Hub REST API Reference][Event Hub REST API Reference]
-   [Event Hub Code Samples][Event Hub Code Samples]
