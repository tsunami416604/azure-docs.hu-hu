...
- A **felhőalapú fejlesztés egyszerűsítése:** Azure Files számos módon felhasználható az új felhőalapú fejlesztési projektek egyszerűsítésére is. Példa:
...
**Hivatkozik**
- [Azure Portal](https://portal.azure.com)
- [Azure Files dokumentáció](/azure/storage/files/storage-files-introduction)
...
**Hivatkozik**
- [Azure Portal](https://portal.azure.com)
- [Az Azure üzenetsor Storage dokumentációja](/azure/storage/queues/)
