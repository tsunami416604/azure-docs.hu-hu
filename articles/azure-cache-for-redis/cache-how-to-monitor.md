...
Alapértelmezés szerint a gyorsítótár-metrikák az Azure monitorban vannak [30 napig](../azure-monitor/platform/data-platform-metrics.md) majd törli. A gyorsítótár-metrikák 30 napnál hosszabb ideig megőrizni, akkor is [jelöl ki a storage-fiók](../azure-monitor/platform/archive-diagnostic-logs.md) , és adja meg egy **megőrzése (nap)** házirendet a gyorsítótár-metrikák. 
...
| Metrika | Leírás |
| --- | --- |
| Gyorsítótár-találatok |A megadott jelentési időszak során sikeres kulcs keresések száma. Ez leképezhető `keyspace_hits` a redis [INFO](https://redis.io/commands/info) parancsot. |
...
| Használt memória |A kulcs-érték párokat a gyorsítótárban (MB) a megadott jelentési időszak során használt gyorsítótár-memória mennyisége. Ezt az értéket képez `used_memory` a Redis INFO parancsát. Ez nem tartalmaz, metaadatait vagy töredezettsége. |
