...
Új Azure Cache a Redis-példány használatával jön létre a [New-azurermrediscache parancsmag esetében](https://docs.microsoft.com/powershell/module/azurerm.rediscache/new-azurermrediscache?view=azurermps-6.6.0) parancsmagot.
...
`Set-AzureRmRedisCache` használható az Azure Cache méretezését, a Redis-példány mikor a `Size`, `Sku`, vagy `ShardCount` tulajdonság módosítását mutatjuk be. 
...
Az Azure Cache redis törléséhez használja a [Remove-azurermrediscache parancsmag esetében](https://docs.microsoft.com/powershell/module/azurerm.rediscache/remove-azurermrediscache?view=azurermps-6.6.0) parancsmagot.
...
Adatok importálása az Azure Cache a Redis-példány használatával az `Import-AzureRmRedisCache` parancsmagot.
...
Egy Redis-példány az Azure Cache adatokat exportálhatnak a `Export-AzureRmRedisCache` parancsmagot.
...
Akkor indíthatja újra az Azure Cache a Redis-példány használata a `Reset-AzureRmRedisCache` parancsmagot.
