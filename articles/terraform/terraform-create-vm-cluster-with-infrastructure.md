---
title: "Terraform-modulok hozzon létre egy Linux virtuális gép elosztott terhelésű Azure-beli infrastruktúra"
description: "Linux virtuális gép fürt létrehozása az Azure-ban terheléselosztót Terraform modulok használata"
...
---
# <a name="create-a-vm-cluster-with-terraform-using-custom-hcl"></a>Hozzon létre egy Virtuálisgép-fürt használata egyéni Hardverkompatibilitási Terraform
...
> * A fürt létrehozásához a konfiguráció alkalmazásához
...
![Terraform terv](media/terraformPlanVmsWithModules.png)


## <a name="create-the-virtual-machines-with-apply"></a>Az alkalmazás a virtuális gépek létrehozása

Futtatás `terraform apply` Azure Virtuálisgép-fürt telepítéséhez.

![Terraform alkalmazása](media/terraformApplyVmsWithModules.png)

## <a name="next-steps"></a>Következő lépések

- Keresse meg a listában a [Azure Terraform modulok](https://registry.terraform.io/modules/Azure)
- Hozzon létre egy [virtuálisgép-méretezési rendelkező Terraform]()