...
Batch-fiók létrehozásakor megadhatja, ahol fiók létrehozott készleteket kell kiosztani. Ha szeretné foglaljon le címkészleteket a alapértelmezett Batch szolgáltatás előfizetésével vagy egy felhasználó az előfizetéshez. A kiválasztott érinti Önt a hitelesítéshez, hogyan fiókhoz tartozó erőforrásokhoz való hozzáférés.
...
- **Felhasználó-előfizetés.** Kiválaszthatja, hogy egy felhasználó az előfizetéshez megadott kötegelt készletek lefoglalni. Ha ezt a lehetőséget választja, hitelesítenie kell az Azure ad-val.
