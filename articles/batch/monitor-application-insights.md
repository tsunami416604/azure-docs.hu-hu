...
TopNWords.cs a példában a következő [instrumentation hívások](../application-insights/app-insights-api-custom-events-metrics.md) az Application Insights API-ból:
