...
A készletek és a Pool-csomópontok gyakran ideiglenesek, a csomópontok folyamatos hozzáadása és törlése miatt ajánlott a naplófájlok megőrzése. A [feladat kimeneti fájljai](./batch-task-output-files.md) kényelmes módon menthetők a naplófájlok az Azure Storage-ba.
