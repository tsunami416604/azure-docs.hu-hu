...
Ha a "cloudServiceConfiguration" készleteket használja, erősen ajánlott, hogy a "virtualMachineConfiguration" készleteket használja. Ez a cikk azt ismerteti, hogyan lehet áttérni a javasolt "virtualMachineConfiguration" konfigurációra.
