...
|---|---|
| [az role assignment create](/cli/azure/role#az-role-assignment-create) | Létrehoz egy új szerepkör-hozzárendelést egy felhasználóhoz, csoporthoz vagy egyszerű szolgáltatáshoz. |
