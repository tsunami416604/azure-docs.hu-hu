        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>A Batch-szolgáltatás ismertetése</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ismerkedés a Batch-szolgáltatással</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ismerkedés a Batch használatával .NET-környezetekben</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ismerkedés a Batch használatával pythonos környezetekben</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ismerkedés a Batch használatával Node.js-környezetekben</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Batch</h3>
                        <p><a href="/azure/batch/batch-diagnostics">Diagnosztikai naplók a Batchben</a></p>
                        <p><a href="/azure/batch/batch-analytics">Batch-elemzés</a></p>
                        <p><a href="/azure/batch/batch-compute-node-environment-variables">Batch számítási csomópont környezeti változói</a></p>
                    </div>
                </div>
            </div>
        </div>
