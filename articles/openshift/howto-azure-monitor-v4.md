...
> [!TIP]
> A szkript bash 4 funkciót használ, ezért győződjön meg róla, hogy a bash naprakész. A jelenlegi verzióját a `bash --version`segítségével tekintheti meg.
...
Visszajelzéseket és askcoin@microsoft.com kérdéseket tehet fel velünk.
