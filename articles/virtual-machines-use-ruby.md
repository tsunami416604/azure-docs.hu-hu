...
-   [Concepts][Concepts]
-   [Create a management certificate][Create a management certificate]
-   [Create a Ruby application][Create a Ruby application]
-   [Configure your application to use the SDK][Configure your application to use the SDK]
-   [Setup an Azure management connection][Setup an Azure management connection]
-   [How To: Work with Virtual Machines][How To: Work with Virtual Machines]
-   [How To: Work with images and disks][How To: Work with images and disks]
-   [How To: Work with Cloud Services][How To: Work with Cloud Services]
-   [How To: Work with Storage Services][How To: Work with Storage Services]
-   [Next steps][Next steps]

## <a name="what-is"> </a>What is service management?

Azure provides [REST APIs for service management operations][REST APIs for service management operations], including management of Azure Virtual Machines. The Azure SDK for ruby exposes management operations for Virtual Machines through the **Azure::VirtualMachineSerivce** class. Much of the virtual machine management functionality available through the [Azure Management Portal][Azure Management Portal] is accessible using this class.
...
You can obtain the subscription Id and a management certificate by using the Azure Cross-Platform Command-Line Interface (xplat-cli). See [Install and configure the Azure Cross-platform Command-Line Interface][Install and configure the Azure Cross-platform Command-Line Interface] for information on installing and configuring the xplat-cli.
...
<b>Note</b>
<p>If you receive a permissions related error, use <code data-inline="1">sudo gem install azure</code> instead.</p>
</div>
...
-   **:vm\_size** - The size of the VM. This determines memory size, number of cores, bandwidth, and other physical characteristics of the VM. See [Virtual Machine and Cloud Services sizes for Azure][Virtual Machine and Cloud Services sizes for Azure] for available sizes and physical characteristics.

-   **:winrm\_transport** - An array of the transports available for use with WinRM. Valid transports are 'http' and 'https'. If 'https' is specified as a transport, you must also use **:ssh\_private\_key\_file** and **:ssh\_certificate\_file** to specify the certificate used to secure the HTTPS communications.
...
-   Visit the [Virtual Machines][Virtual Machines] feature page
-   See the MSDN Reference: [Virtual Machines][1]
-   Learn how to host a [Ruby on Rails application on a Virtual Machine][Ruby on Rails application on a Virtual Machine]
  ...
  [Next steps]: #next-steps
  [REST APIs for service management operations]: http://msdn.microsoft.com/en-us/library/windowsazure/ee460799.aspx
  [Azure Management Portal]: https://manage.windowsazure.com
  [Install and configure the Azure Cross-platform Command-Line Interface]: http://www.windowsazure.com/en-us/manage/install-and-configure-cli/
  [Virtual Machine and Cloud Services sizes for Azure]: http://msdn.microsoft.com/en-us/library/windowsazure/dn197896.aspx
  [Virtual Machines]: http://www.windowsazure.com/en-us/documentation/services/virtual-machines/
  [1]: http://msdn.microsoft.com/en-us/library/windowsazure/jj156003.aspx
  [Ruby on Rails application on a Virtual Machine]: http://www.windowsazure.com/en-us/develop/ruby/tutorials/web-app-with-linux-vm/
