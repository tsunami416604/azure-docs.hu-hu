...
1. A kód cellán a lejátszás gombra kattintva futtassa a kódot; a kimenet megjelenik a dián:
    ...
    > [!Tip]
    > A cella kimenete a bemutató cellájának része. Ha jegyzetfüzet vagy Diavetítés nézetben futtat egy cellát, a kimenet a másik nézetben is megjelenik. A kimenet törléséhez használja a **cellát** > **aktuális kimeneteket** > **törölje** a parancsot (az aktuális cella esetében) vagy a **cellát** , > az **összes kimenetet** > **törölje** (az összes cella esetében).
