---
title: A Azure Notebooks áttekintése
description: Futtasson Jupyter jegyzetfüzeteket a felhőben az ingyenes Azure Notebooks szolgáltatás használatával, ahol nincs szükség beállításra vagy konfigurálásra.
...
ms.locfileid: "73496721"
---
# <a name="overview-of-azure-notebooks"></a>A Azure Notebooks áttekintése
...
A kód, a grafika és a magyarázó szöveg hatékony kombinációja miatt a Jupyter számos felhasználási célra népszerűvé vált, beleértve az adatelemzési útmutatást, az adattisztítást és az átalakítást, a numerikus szimulációt, a statisztikai modellezést és a fejlesztését gépi tanulási modellek.
