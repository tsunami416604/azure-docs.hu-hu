...
| **Klónozott** | Mindenki számára | Másolja át a kiválasztott projekt a saját fiókba. Kéri, ha még nem már bejelentkezhet. Lásd: [projekt klónozása](#clone-a-project). |
...
| | | | | | |
| --- | --- | --- | --- | --- | --- |
| körülbelül | account | adminisztráció | api-t | blog | osztályteremben |
| content | irányítópult | Ismerkedés | – gyakori kérdések | help | html |
