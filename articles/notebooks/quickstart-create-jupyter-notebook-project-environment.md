...
1. Néhány pillanat elteltével Azure Notebooks navigál az új projekthez. Vegyen fel egy jegyzetfüzetet a projektbe az **+ új** legördülő menü kiválasztásával (amely csak **+ként** jelenhet meg), majd a **Jegyzetfüzet**lehetőséget választva.
