...
-   [Concepts][Concepts]
-   [How to: Create a Media Services account using Quick Create][How to: Create a Media Services account using Quick Create]
...
## <span id="quick"></span></a>How to: Create a Media Services account using Quick Create

1.  In the [Management Portal][Management Portal], click **New**, click **Media Service**, and then click **Quick Create**.
