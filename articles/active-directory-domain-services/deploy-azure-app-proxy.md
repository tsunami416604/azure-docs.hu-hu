...
4. **Az Azure AD Domain Services** engedélyezve kell lennie az Azure AD-címtárban. Ha még nem tette, minden ismertetett feladatok végrehajtásával a [a kezdeti lépések útmutatóban](create-instance.md).
...
Ez ismertetett módon kihasználhassák a KCD erőforrás-alapú [cikk](deploy-kcd.md).
...
* [A Kerberos által korlátozott delegálás konfigurálása a felügyelt tartományon](deploy-kcd.md)
