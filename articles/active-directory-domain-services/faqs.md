...
Tekintse meg a [hibaelhárítási útmutatója](troubleshoot.md) konfigurálása és felügyelete az Azure AD Domain Services gyakori hibáinak megoldásokhoz.
...
Igen. Tekintse meg, hogyan engedélyezheti [Azure AD tartományi szolgáltatásokat az Azure CSP-előfizetésekben](csp.md).
...
Igen. Lásd: [engedélyezése az Azure AD Domain Services a PowerShell-lel](powershell-create-instance.md).
...
Nem, akkor még nem jelenleg lehet engedélyezni az Azure AD tartományi szolgáltatások sablon használatával. Helyette használhatja az PowerShell, [engedélyezése az Azure AD Domain Services a PowerShell-lel](powershell-create-instance.md).
