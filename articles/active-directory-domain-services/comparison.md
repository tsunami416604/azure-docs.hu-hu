---
title: Döntse el, ha az Azure AD Domain Services hogyan ideális a használati eset
...
* Felülvizsgálat közös [központi telepítési forgatókönyv az Azure AD tartományi szolgáltatásokhoz](scenarios.md).
* Végül [egy saját munka AD lehetőséget az Azure AD tartományi szolgáltatások összehasonlítása](comparison.md#compare-azure-ad-domain-services-to-diy-ad-domain-in-azure).
...
| --- |:---:|:---:|
| [**Felügyelt szolgáltatás**](comparison.md#managed-service) |**&#x2713;** |**&#x2715;** |
| [**Biztonságos üzembe helyezését**](comparison.md#secure-deployments) |**&#x2713;** |A rendszergazdának az üzemelő példány biztonságossá tételéhez. |
| [**DNS-kiszolgáló**](comparison.md#dns-server) |**&#x2713;** (felügyelt szolgáltatás) |**&#x2713;** |
| [**Tartományi vagy vállalati rendszergazdai jogosultságokkal**](comparison.md#domain-or-enterprise-administrator-privileges) |**&#x2715;** |**&#x2713;** |
| [**Csatlakozás tartományhoz**](comparison.md#domain-join) |**&#x2713;** |**&#x2713;** |
| [**Tartomány hitelesítése NTLM és Kerberos használatával**](comparison.md#domain-authentication-using-ntlm-and-kerberos) |**&#x2713;** |**&#x2713;** |
| [**Kerberos által korlátozott delegálás**](comparison.md#kerberos-constrained-delegation)|resource-based|erőforrás-alapú & fiók-alapú|
| [**Egyéni Szervezetiegység-struktúrája**](comparison.md#custom-ou-structure) |**&#x2713;** |**&#x2713;** |
| [**Sémakiterjesztések**](comparison.md#schema-extensions) |**&#x2715;** |**&#x2713;** |
| [**AD-tartomány vagy erdő megbízhatónak tekinti**](comparison.md#ad-domain-or-forest-trusts) |**&#x2715;** |**&#x2713;** |
| [**LDAP olvasása**](comparison.md#ldap-read) |**&#x2713;** |**&#x2713;** |
| [**Biztonságos LDAP (LDAPS)** ](comparison.md#secure-ldap) |**&#x2713;** |**&#x2713;** |
| [**LDAP-írás**](comparison.md#ldap-write) |**&#x2715;** |**&#x2713;** |
| [**Csoportházirend**](comparison.md#group-policy) |**&#x2713;** |**&#x2713;** |
| [**A földrajzilag elosztott üzembe**](comparison.md#geo-dispersed-deployments) |**&#x2715;** |**&#x2713;** |
...
[További információ](manage-dns.md)
...
[További információ](deploy-kcd.md)
...
[További információ](create-ou.md)
...
#### <a name="secure-ldap"></a>A Secure LDAP
...
[További információ](configure-ldaps.md)
...
[További információ](manage-group-policy.md)
...
> [!NOTE]
> Előfordulhat, hogy határozhatja meg, hogy egy házi KÉSZÍTÉSŰ lehetőség van olyan a központi telepítési használati esetek. Fontolja meg [visszajelzés megosztása](contact-us.md) segítsen megérteni, milyen funkciókat segít az Azure AD tartományi szolgáltatásokat a jövőben választotta. A visszajelzése segít fejlesztheti tovább a szolgáltatást, hogy jobban illeszkedjen az üzembe helyezésben, és a használati eseteket.
>
>
...
* [Központi telepítési forgatókönyv – Azure AD tartományi szolgáltatások](scenarios.md)
