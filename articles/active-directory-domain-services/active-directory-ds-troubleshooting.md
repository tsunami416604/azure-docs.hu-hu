...
- [Azure Active Directory User Voice 通道](http://feedback.azure.com/forums/169401-azure-active-directory)。 請務必在問題前加上 **'AADDS'** 字詞，才可送達我們。
- 您可能也用電子郵件我們在 [Azure AD 網域服務的意見反應](mailto:aaddsfb@microsoft.com)
