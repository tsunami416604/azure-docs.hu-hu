...
> [!NOTE]
> Ez az alapértelmezett NSG nem zárolni a használt biztonságos LDAP-port elérését. Biztonságos LDAP hozzáférés zárolását az interneten keresztül, lásd: [Ez a cikk](active-directory-ds-troubleshoot-ldaps.md).
>
