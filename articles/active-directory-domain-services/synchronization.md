...
> [!TIP]
> **Bejelentkezés a felügyelt tartományba UPN-formátum használatával** Az *sAMAccountName* attribútum, például a `AADDSCONTOSO\driley`, az Azure AD DS felügyelt tartomány egyes felhasználói fiókjaihoz automatikusan létrehozható. A felhasználók automatikusan létrehozott *sAMAccountName* eltérőek lehetnek az UPN-előtagtól, ezért nem mindig megbízható a bejelentkezés.
>
