...
A következő példában szereplő DNS-bejegyzés a külső DNS-szolgáltatóval vagy a helyi gazdagépek fájljával oldja fel a *LDAPS.aaddscontoso.com* a *40.121.19.239*külső IP-címére irányuló forgalmat:
