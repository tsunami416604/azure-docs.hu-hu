...
## [Biztonságos LDAP konfigurálása felügyelt tartományhoz](active-directory-ds-admin-guide-configure-secure-ldap.md)
...
## [Szinkronizálás a helyszíni címtárral](active-directory-ds-synchronization.md)
