...
Itt a "contoso100.com" a felügyelt tartomány DNS-tartományneve. a "contoso-RHEL" a felügyelt tartományhoz csatlakozó RHEL virtuális gép állomásneve.
...
1. Az SSH-terminálon írja be a következő parancsot a tartományhoz csatlakoztatott RHEL virtuális géphez való csatlakozáshoz az SSH használatával. Használjon olyan tartományi fiókot, amely a felügyelt tartományhoz tartozik (ebben azbob@CONTOSO100.COMesetben például "").
