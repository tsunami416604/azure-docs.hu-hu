...
<tags ms.service="documentdb" ms.workload="data-services" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="08/20/2014" ms.author="spelluru"></tags>
...
-   [How to: Create a DocumentDB account][How to: Create a DocumentDB account]
-   [Next steps][Next steps]

## <span id="HowTo"></span></a>How to: Create a DocumentDB account

1.  Sign in to the [Azure management preview portal][Azure management preview portal]
2.  Click New -\> DocumentDB Account.
    ...
    *For more information see, [Using Resource groups to manage your Azure resources][Using Resource groups to manage your Azure resources].*
...
4.  After the DocumentDB account has been created, it is ready for use with the default settings.
    ...
    *Note that the default consistency of the DocumentDB account will be set to Session. You can adjust the default consistency setting via the [Azure management preview portal][Azure management preview portal].*
    ![][6]
...
-   To learn more about DocumentDB, see the Azure DocumentDB documentation on [azure.com][azure.com]

<!--Image references-->

  [How to: Create a DocumentDB account]: #Howto
  [Next steps]: #NextSteps
  [Azure management preview portal]: https://portal.azure.com/
  ...
  [DocumentDB pricing details]: http://go.microsoft.com/fwlink/p/?LinkID=402317&clcid=0x409
  [Manage DocumentDB Capacity and Performance]: ../documentdb-manage/
