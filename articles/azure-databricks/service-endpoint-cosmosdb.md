...
2. Töltse ki a **példány részleteit** az **alapok** lapon a következő beállításokkal:
   ...
   |Geo-redundancia|Letiltás|
   |Több régióba írt írások|Engedélyezés|
...
3. A **cél információi** lapon adja meg a kapcsolatok karakterláncát. A `AccountEndpoint=<URL>;AccountKey=<key>;Database=<database>`a kapcsolatok karakterláncának formátuma. A AccountEndpoint és a AccountKey az előző szakaszban mentett elsődleges kapcsolatok karakterláncában szerepel. Fűzze hozzá `Database=<your database name>` a kapcsolódási karakterlánc végéhez, majd válassza az **ellenőrzés**lehetőséget. Ezután adja hozzá a gyűjtemény nevét és a partíciós kulcsot.
