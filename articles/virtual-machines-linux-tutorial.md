...
<tags ms.service="virtual-machines" ms.workload="infrastructure-services" ms.tgt_pltfrm="vm-linux" ms.devlang="na" ms.topic="article" ms.date="10/9/2014" ms.author="kathydav"></tags>
...
> [WACOM.NOTE] Even though you don't need any experience with Azure VMs to finish this tutorial, you do need an Azure account. You can create a free trial account in just a couple of minutes. For details, see [Create an Azure account][Create an Azure account].

This tutorial covers:

-   [About virtual machines in Azure][About virtual machines in Azure]
...
## <span id="virtualmachine"></span> </a>About virtual machines in Azure
...
-   [Introduction to Linux on Azure][Introduction to Linux on Azure]
...
-   [About Azure VM configuration settings][About Azure VM configuration settings]
  ...
  [Introducing Azure]: http://go.microsoft.com/fwlink/p/?LinkId=311926
  [virtual-machines-create-LinuxVM]: ../includes/virtual-machines-create-LinuxVM.md
  [virtual-machines-Linux-tutorial-log-on-attach-disk]: ../includes/virtual-machines-Linux-tutorial-log-on-attach-disk.md
