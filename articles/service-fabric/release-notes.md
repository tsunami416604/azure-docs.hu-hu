...
- **Előzetes** [ **verzió: a Service Fabric alkalmazások kulcstároló-referenciája **csak a verziószámmal ellátott titkokat** támogatja. Verziók nélküli titkos kódok nem támogatottak.**](https://docs.microsoft.com/azure/service-fabric/service-fabric-keyvault-references)
...
- [**Továbbfejlesztettük az erőforrás-irányítási támogatást**](https://docs.microsoft.com/azure/service-fabric/service-fabric-resource-governance): a kérelmek és a korlátozások megadása a CPU-és a memória-erőforrásokhoz.
