...
6. Az `Microsoft.Network/loadBalancers` erőforrásban módosítsa a `publicIPAddress` elemét, `frontendIPConfigurations` hogy az újonnan létrehozott helyett a meglévő statikus IP-címet hivatkozzon:
