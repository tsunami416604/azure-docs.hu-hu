...
- **授權由** -指出服務網狀架構看起來應該設定此憑證使用主體名稱或指紋。 使用要授權的主體名稱不是很好的安全性作法，不過，這可提供更多的彈性。


- **主體名稱** 指定授權的主體名稱時，才需要
- **簽發者指紋** 這是用來檢查用戶端出示其認證到伺服器時，伺服器可以執行的額外層級。
...
請參閱- [從客戶管理金鑰保存庫，將憑證部署至 Vm](http://blogs.technet.com/b/kv/archive/2015/07/14/vm_2d00_certificates.aspx) 如何文件。
