---
title: Azure Service Fabric szolgáltatási modell XML-séma elem csoportjai
description: A Service Fabric szolgáltatási modell XML-sémájában található elem-csoportokat ismerteti.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "84700868"
---
<!-- This article was generated by the Python script found in the service-fabric-service-model-schema.md file -->

# <a name="service-fabric-service-model-xml-schema-elements"></a>Service Fabric szolgáltatási modell XML-sémájának elemei

## <a name="partitiondescriptiongroup-group"></a>PartitionDescriptionGroup csoport
Meghatározza a szolgáltatás particionálási sémáját.
...
Meghatározza a skálázási triggert.
