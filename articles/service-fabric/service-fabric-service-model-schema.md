---
title: Az Azure Service Fabric szolgáltatásmodell XML-sémaleírásai
description: A Service Fabric szolgáltatásmodell XML-sémájának leírása, beleértve a helyet és az összetevők összegzését.
ms.topic: reference
ms.date: 12/10/2018
...
# <a name="service-model-xml-schema-documentation"></a>Szolgáltatásmodell XML-sémadokumentációja
Ez a cikk a ServiceFabricSDK-vel telepített ServiceFabricServiceModel.xsd sémafájlt dokumentálja.  Alapértelmezés szerint a sémafájl a *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd fájlra*van telepítve.

## <a name="namespace-bindings"></a>Névtérkötések
...
A ServiceFabricServiceModel.xsd a következő összetevőket határozza meg:
...
- [3 elemcsoportok](service-fabric-service-model-schema-element-groups.md)
- [16 attribútumcsoport](service-fabric-service-model-schema-attribute-groups.md)
