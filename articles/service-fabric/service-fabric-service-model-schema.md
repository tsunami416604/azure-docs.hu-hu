---
title: Az Azure Service Fabric Service Model XML-sémájának leírása
description: A Service Fabric szolgáltatási modell XML-sémájának leírása, beleértve a helyet és az összetevők összefoglalását.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "75639190"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>A szolgáltatási modell XML-sémájának dokumentációja
Ez a cikk a ServiceFabricServiceModel. xsd sémafájl a Service Fabric SDK-val telepített fájlját dokumentálja.  Alapértelmezés szerint a sémafájl telepítve van a *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Névtérbeli kötések

|Körzetszám|Névtér URI-ja|
|---|---|
|XS|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Összetevő összegzése 
A ServiceFabricServiceModel. xsd-ben a következő összetevők vannak definiálva:
- [257 elem](service-fabric-service-model-schema-elements.md)
...
- [3 elem csoportjai](service-fabric-service-model-schema-element-groups.md)
- [16 attribútum-csoport](service-fabric-service-model-schema-attribute-groups.md)
