...
ms.locfileid: "34809743"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Szolgáltatás modell XML-séma dokumentáció
Ez a cikk a Service Fabric SDK-val telepített ServiceFabricServiceModel.xsd sémafájl dokumentumokat.  Alapértelmezés szerint a következő sémafájl telepítés *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Namespace kötések
|Körzetszám|Namespace URI|
|---|---|
|Xs csomag|http://www.w3.org/2001/XMLSchema|

## <a name="component-summary"></a>Az összetevő összegzése 
A következő összetevőket a http://schemas.microsoft.com/2011/01/fabric ServiceFabricServiceModel.xsd névtér:
- [244 elemei](service-fabric-service-model-schema-elements.md)
