---
title: Az Azure Service Fabric service modell XML-séma leírásait |} A Microsoft Docs
description: Az XML-séma, a Service Fabric service model ismerteti.
...
ms.locfileid: "58310694"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Szolgáltatási modell XML-séma dokumentáció
Ez a cikk a Service Fabric SDK-val telepített ServiceFabricServiceModel.xsd sémafájl dokumentumok.  Alapértelmezés szerint a fájl a telepített *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Namespace-kötések

|Körzetszám|Namespace URI|
|---|---|
|xs|https:\//www.w3.org/2001/XMLSchema|

## <a name="component-summary"></a>Összetevő összegzése 
A következő összetevők ServiceFabricServiceModel.xsd vannak meghatározva:
- [257 elemek](service-fabric-service-model-schema-elements.md)
...
- [3 elem csoportok](service-fabric-service-model-schema-element-groups.md)
- [16 Attribútumcsoportok](service-fabric-service-model-schema-attribute-groups.md)
