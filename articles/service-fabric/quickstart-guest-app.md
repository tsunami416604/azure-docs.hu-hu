...
Mielőtt elkezdené, győződjön meg arról, hogy [beállította a fejlesztőkörnyezetet](service-fabric-get-started.md). Mert az tartalmazza a Service Fabric SDK és a Visual Studio 2019 vagy 2015 telepítése.
...
Az alkalmazásprojekt (**MyGuestApp**) nem tartalmaz közvetlenül semmilyen kódot. A projekt egy számos szolgáltatási projektre hivatkozik. Ezenfelül három egyéb típusú tartalmat tartalmazza:
...
Nyissa meg a **ServiceManifest.xml** fájlt a projektben. A jegyzékfájl alján van egy `<Resources> \ <Endpoints>` már meg van határozva egy bejegyzés. Módosítsa ezt a bejegyzést a `Port`, a `Protocol` és a `Type` hozzáadásával. 
...
Ha lenyomja **F5** és futtassa a projektet, a helyi fürthöz központilag telepítették. Azonban helyezzük üzembe inkább az Azure-ban.
...
A **Kapcsolati végpont** területen válassza ki az üzembe helyezés céljaként szolgáló Service Fabric-fürtöt. Ha még nincs fiókja, válassza ki a **&lt;új fürt létrehozása... &gt;** amely az Azure Portal webhelyen webböngésző-ablakot nyit meg. További információért lásd: [Fürt létrehozása a portálon](service-fabric-cluster-creation-via-portal.md#create-cluster-in-the-azure-portal). 
...
Lépjen erre a címre, ahol láthatja a `HELLO WORLD` választ.

## <a name="delete-the-cluster"></a>A fürt törlése

Ne felejtse el törölni az ebben a rövid útmutatóban létrehozott erőforrásokat, mivel ezek az erőforrások díjkötelesek.
