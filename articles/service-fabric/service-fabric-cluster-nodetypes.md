...
| --- | --- | --- | --- |
| név | Karakterlánc | Kiterjesztés egyedi neve |
...
| nodeTypeRef | Karakterlánc | NodeType neve |
...
| x509StoreName | Karakterlánc | Azon áruház neve, ahol a telepített fürt tanúsítványa található |
