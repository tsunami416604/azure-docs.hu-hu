...
| create | Hozza létre a megadott Service Fabric-szolgáltatást. |
...
| health | A megadott Service Fabric-szolgáltatás állapotának beolvasása. |
| info | A Service Fabric-alkalmazáshoz tartozó szolgáltatás adatainak beolvasása. |
| list | Az alkalmazás által meghatározott az alkalmazáshoz tartozó összes szolgáltatás adatainak beolvasása |
...
| feloldása | Oldja meg a Service Fabric-partícióhoz. |
| type-list | A Service Fabric-fürtben üzembe helyezett alkalmazás típus által támogatott szolgáltatástípusok információkat tartalmazó lista beolvasása. |
