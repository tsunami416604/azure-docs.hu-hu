---
title: Megbízható gyűjtemények objektumainak szerializálása
...
A [IStateSerializer \<T> ](/dotnet/api/microsoft.servicefabric.data.istateserializer-1) felületének megvalósításához egyéni szerializáló szükséges.
