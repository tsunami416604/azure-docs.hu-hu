...
3. Konfigurálja az egyszerű felhasználónevet, és konfigurálja a `RunAsPolicy` hivatkozást a [felhasználóra](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-fabric-settings#runas).
