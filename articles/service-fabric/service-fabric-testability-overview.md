...
這些相互關聯的失敗確實會在真實情況中發生 (即使不像個別失敗那麼頻繁)。 在這些案例於生產環境中發生前，能夠先測試這些案例會很重要。 更容易模擬生產工作負載在受控制的情況下 （所有工程師都在簡報上一天中的中間） 中的這些功能合用 2:00 的生產環境中的第一次發生。 m. 在早上。
...
我們打算在 Service Fabric 中透過 Testability 模組和服務，從開發人員環境到生產環境中，以相同的方法扭轉此情形。 作法有二：
