...
### <a name="steps"></a>Lépések
  1. Kérje le a Service Fabric Jenkins-tárolójának rendszerképét: ``docker pull raunakpandya/jenkins:9``
  2. Futtassa a tároló rendszerképét: ``docker run -itd -p 8080:8080 raunakpandya/jenkins:v9``
