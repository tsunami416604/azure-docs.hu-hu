...
A skálázási kódnak azonban nem kell a fürtben lévő szolgáltatásként futtatnia a méretezést. Mind a `IAzure`, mind `FabricClient` csatlakozhatnak a kapcsolódó Azure-erőforrásokhoz távolról, így a skálázási szolgáltatás könnyen lehet egy, a Service Fabric alkalmazáson kívül futó konzol-alkalmazás vagy Windows-szolgáltatás.
