...
A Service Fabric-alkalmazás kódba [hozzáférési jogkivonat beszerzésére](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/how-to-use-vm-token#get-a-token-using-http) az Azure Resource Manager azáltal, hogy a többi összes hasonló a következőhöz:
