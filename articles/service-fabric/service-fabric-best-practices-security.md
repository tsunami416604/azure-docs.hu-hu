...
További részletekért tekintse át az [Azure kulcstartó tanúsítvány](https://docs.microsoft.com/azure/key-vault/create-certificate) -létrehozási módszereit.
...
> - "C" rekord a kiépített `Alias record set`Microsoft sub-tartományokhoz. Használhatja például a Traffic Manager vagy a Load Balancer DNS-nevét.
...
[Titkosítási tanúsítvány beállítása és a titkok titkosítása Windows](https://docs.microsoft.com/azure/service-fabric/service-fabric-application-secret-management-windows)-fürtökön:
...
A [Key Vault tanúsítványok központi telepítése Service Fabric fürt virtuálisgép](#deploy-key-vault-certificates-to-service-fabric-cluster-virtual-machine-scale-sets) -méretezési csoportokban található utasításokkal Key Vault tanúsítványokat telepíthet a Service Fabric fürt Virtual Machine Scale sets.
...
[Titkosítási tanúsítvány beállítása és a titkok titkosítása Linux](https://docs.microsoft.com/azure/service-fabric/service-fabric-application-secret-management-linux)-fürtökön:
...
A [Key Vault tanúsítványok központi telepítése Service Fabric fürt virtuálisgép](#deploy-key-vault-certificates-to-service-fabric-cluster-virtual-machine-scale-sets) -méretezési csoportokra vonatkozó utasításokat a Service Fabric fürt Virtual Machine Scale sets.
...
Az Azure Service Fabric-fürtök a Managed Service Identityt támogató Virtual Machine Scale Sets [](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/services-support-msi#azure-services-that-support-managed-identities-for-azure-resources)futnak.
...
A Service Fabric alkalmazás kódjában [szerezzen be egy hozzáférési](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/how-to-use-vm-token#get-a-token-using-http) jogkivonatot a Azure Resource Managerhoz, és az alábbihoz hasonló Rest-t biztosít:
