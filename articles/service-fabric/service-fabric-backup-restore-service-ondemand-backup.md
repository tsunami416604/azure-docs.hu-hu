...
Az Azure Service Fabric rendelkezik az [adatfeldolgozás rendszeres biztonsági mentéséhez](service-fabric-backuprestoreservice-quickstart-azurecluster.md) szükséges funkciókkal és az adatbiztonsági mentéssel. Az igény szerinti biztonsági mentés azért hasznos, mert a mögöttes szolgáltatásban vagy a környezetében tervezett változások miatt védelmet biztosít az _adatvesztés_/az _adatsérülés_ ellen.
...
A [BackupPartition](https://docs.microsoft.com/rest/api/servicefabric/sfclient-api-backuppartition) API-val beállíthatja az indítást az igény szerinti biztonsági mentéshez `974bd92a-b395-4631-8a7f-53bd4ae9cf22`partíció-azonosítóhoz.
...
A [BackupPartition](https://docs.microsoft.com/rest/api/servicefabric/sfclient-api-backuppartition) API-val beállíthatja az indítást az igény szerinti biztonsági mentéshez `974bd92a-b395-4631-8a7f-53bd4ae9cf22`partíció-azonosítóhoz. A következő Azure Storage-információk belefoglalása:
