...
Deklarálja a bizalmas adatoknak az alkalmazás jegyzékfájlján belüli titkosításához használt tanúsítványt. Az alkalmazás szerzője a Invoke-ServiceFabricEncryptSecret parancsmag használatával titkosítja a bizalmas adatokat, amelyeket a rendszer a ConfigOverrides szakasz egyik paraméterére másol.
...
A szolgáltatási jegyzékfájlban szereplő konfigurációs beállításokat felülbírálja. A kulcs-érték párok egy vagy több szakaszát tartalmazza. A paraméterek értékei a Invoke-ServiceFabricEncryptSecret parancsmag használatával titkosíthatók.
...
## <a name="parameter-element-defined-in-parameters"></a>A paraméterekben definiált paraméter elem
...
## <a name="parameter-element-defined-in-section"></a>A (z) szakaszban definiált paraméter elem
...
Ha titkosított értékre van állítva, az alkalmazás fejlesztői feladata a tanúsítvány létrehozása és a Invoke-ServiceFabricEncryptSecret parancsmag használata a bizalmas adatok titkosításához.
...
## <a name="serviceplacementpolicy-element-defined-in-serviceplacementpolicies"></a>A ServicePlacementPolicies-ben definiált ServicePlacementPolicy elem
Meghatározza a szolgáltatás elhelyezésére vonatkozó házirendet, amely azt határozza meg, hogy a szolgáltatásnak vagy ne fusson bizonyos fürtbeli tartalék tartományokban.  Akkor hasznos, ha a fürt földrajzi távolságokat vagy geopolitikai régiókat ölel fel.
