...
A rendszer upshift/visszakapcsolást végrehajtásához dátumoszlopban-partíciók száma.
|Attribútum|Érték|
|---|---|
|név|ScaleIncrement|
|type|xs:String|
...
|content|elem(ek) 0, 0 regisztrációjában|
|meghatározott|a helyi [EnvironmentOverridesType complexType](service-fabric-service-model-schema-complex-types.md#environmentoverridestype-complextype), [EnvironmentVariablesType complexType](service-fabric-service-model-schema-complex-types.md#environmentvariablestype-complextype)|
...
#### <a name="scaleincrement"></a>ScaleIncrement
A rendszer upshift/visszakapcsolást végrehajtásához dátumoszlopban által példányok száma.
|Attribútum|Érték|
|---|---|
|név|ScaleIncrement|
|type|xs:String|
...
Ha az értéke igaz, ez a paraméter értékét titkosítva van. Az alkalmazás fejlesztőjének felelős tanúsítvány létrehozása és a bizalmas adatok titkosítása az Invoke-ServiceFabricEncryptSecret parancsmag használatával. A tanúsítvány adatait, amely titkosítani az értéket fogja használni a tanúsítványok szakaszban van megadva.
|Attribútum|Érték|
|---|---|
|név|IsEncrypted|
|type|xs:Boolean|
...
A szolgáltatás létrehozásakor használt ServicePackageActivationMode. Megengedett értékek: "SharedProcess" és "ExclusiveProcess". SharedProcess üzemmódot másodpéldányt vagy a szolgáltatás a különböző partíció(k) példány oszt egy csomóponton szolgáltatáscsomag azonos aktiválását. ExclusiveProcess üzemmódot minden replika vagy a szolgáltatás példánya fog rendelkezni a saját dedikált szolgáltatás aktiválását.
|Attribútum|Érték|
|---|---|
