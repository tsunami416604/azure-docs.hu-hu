...
| – várakozási idő – hibák | Az egymást követő hibák közötti várakozási idő (másodpercben) egyetlen iteráción belül.  Alapértelmezett\: 20. <br><br> Minél nagyobb az érték, annál kisebb a hibák közötti átfedés, és egyszerűbb a fürt által áthaladó állapot-váltások folyamata. Az ajánlásnak 1 és 5 közötti értékkel kell kezdődnie, és körültekintően kell eljárnia. |
| – várakozási idő – iterációk | A káosz két egymást követő ismétlése között eltelt idő (másodpercben). Minél nagyobb az érték, annál alacsonyabb a hibák befecskendezési sebessége.  Alapértelmezett\: 30. |
