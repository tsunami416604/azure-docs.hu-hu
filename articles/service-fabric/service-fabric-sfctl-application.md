...
| egészségügy | Lekéri a Service Fabric-alkalmazás állapotát. |
...
A csomag összes fájljának feltöltési folyamata opcionálisan megjeleníthető. A feltöltési folyamat elküldése `stderr`ra.
