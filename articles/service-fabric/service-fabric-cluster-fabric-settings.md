...
|TargetReplicaSetSize |int, az alapértelmezett érték 0 |Statikus|A FaultAnalysisService TargetReplicaSetSize NOT_PLATFORM_UNIX_START. |
...
| **A paraméter** | **Megengedett értékek** | **Frissítési szabályzat** | **Útmutatás vagy rövid leírás** |
| --- | --- | --- | --- |
|Enabled |Bool, az alapértelmezett érték false |Statikus|A ImageStoreService engedélyezett jelzője. Alapértelmezett: false |
...
|FabricDataRoot |Karakterlánc | Nem engedélyezett |Service Fabric az adatgyökérkönyvtárat. Az Azure alapértelmezett értéke d:\svcfab |
...
| **A paraméter** | **Megengedett értékek** | **Frissítési szabályzat** | **Útmutatás vagy rövid leírás** |
| --- | --- | --- | --- |
|Szolgáltatók |string (alapértelmezett érték: "DSTS") |Statikus|Az engedélyezni kívánt jogkivonat-ellenőrző szolgáltatók vesszővel tagolt listája (az érvényes szolgáltatók a következők: DSTS; HRE). Jelenleg csak egy szolgáltató engedélyezhető bármikor. |
