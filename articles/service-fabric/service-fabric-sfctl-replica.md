...
| --Service-Kind | A szolgáltatási replika (állapot nélküli vagy állapot-nyilvántartó) típusa, amelyre az állapotot jelenteni kell. A lehetséges értékek a következők:\: "állapot nélküli", "állapot-nyilvántartó".  Az alapértelmezett\: állapot-nyilvántartó. |
