...
Csoport által felügyelt szolgáltatás Account(gMSA) konfigurált fürtök (https://technet.microsoft.com/library/hh831782.aspx), egy új csomópont felveheti egy konfigurációs frissítéssel:
