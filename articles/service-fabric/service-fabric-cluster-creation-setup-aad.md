...
> [!NOTE]
> Az országos felhők esetében (például Azure Government, Azure China, Azure Germany) a `-Location` paramétert is meg kell adnia.
...
Kövesse az Azure AD beállításával és a felhasználói szerepkörök hozzárendelésével kapcsolatos utasításokat. Azt is javasoljuk, hogy kapcsolja be a "felhasználói hozzárendelés szükséges az alkalmazás eléréséhez" beállítást, ahogy azt `SetupApplications.ps1`.
...
#### <a name="problem"></a>Probléma
Amikor Service Fabric Explorerban próbál bejelentkezni az Azure AD-be, a lap egy hibát ad vissza: "AADSTS50011: a Válaszcím &lt;URL-cím&gt; nem felel meg az alkalmazáshoz konfigurált válaszoknak: &lt;GUID&gt;."
