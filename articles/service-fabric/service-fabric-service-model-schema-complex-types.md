...
Memória (MB) korlátozza. Csak pozitív egész szám lehet. A kódcsomagok (tárolók vagy folyamatok) nem tudnak ennél a korlátnál több memóriát lefoglalni, és ennek megkísérlése memóriahiány miatti kivételt eredményez.
...
A teljes memóriamennyiséget lapozófájl-kapacitás használható, MB-ban. Csak pozitív egész szám lehet.
...
Az enyhe korlátjának (megabájtban) a memória cégirányítási csak a memória a versengés a csomópont észlelése esetén érvényes. Csak pozitív egész szám lehet.
...
Rendelkezésre álló processzorok (csak Windows) használható százalékos értéke. Csak pozitív egész szám lehet. Ha a CPU-korlátok a szolgáltatási csomag számára meg van adva, ezt a paramétert hatékonyan figyelmen kívül.
...
Maximális átviteli sebessége (olvasási és írási) felhasználható iops. Csak pozitív egész szám lehet.
...
A maximális i/o (bájt / másodperc), amelyek segítségével (olvasási és írási). Csak pozitív egész szám lehet.
...
Lemezkvóta for containers szolgáltatásban.  Csak pozitív egész szám lehet.
...
Kernel memóriára vonatkozó (bájt).  Csak pozitív egész szám lehet.  Megjegyzés: Ez az adott Linux és windows rendszeren docker hiba lesz, ha a nem.
...
Shm/dev/bájt mérete. Ha nincs megadva, akkor a rendszer 64 MB-ot használja.  Csak pozitív egész szám lehet.  Vegye figyelembe, hogy ez Linux adott, az azonban nem e hiba docker lesz megadva.  Egyszerűen figyelmen kívül.
...
CPU-korlát logikai magok számát. Csak pozitív egész szám lehet.
...
#### <a name="memoryinmb"></a>MemoryInMB
Memória (MB) korlátozza. Csak pozitív egész szám lehet.
