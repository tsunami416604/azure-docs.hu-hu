---
title: Hogyan háríthatók el az Azure Redis Cache |} A Microsoft Docs
description: Útmutató az Azure Redis Cache a leggyakoribb hibák elhárításához.
...
* [Ügyféloldali hibaelhárítási](#client-side-troubleshooting) – Ez a szakasz hasznos útmutatást ad az azonosító és az Azure Redis Cache szolgáltatáshoz való csatlakozáskor az alkalmazás által okozott problémák elhárításához.
* [Kiszolgálóoldali hibaelhárítási](#server-side-troubleshooting) – Ez a szakasz hasznos útmutatást ad az azonosító és az Azure Redis Cache-kiszolgáló oldalán okozott problémák elhárításához.
