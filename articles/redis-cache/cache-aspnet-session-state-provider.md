...
description: Ismerje meg, hogyan használja az Azure Redis Cache ASP.NET-munkamenetállapot tárolására
...
Gyakran nem célszerű egy való életből vett felhőalapú alkalmazás valamilyen állapot tárolásához egy felhasználói munkamenethez tartozó elkerülése érdekében, de néhány olyan módszert hatással van a teljesítmény és méretezhetőség több, mint mások. Ha már állapot tárolására, a legjobb megoldás, maradjon kicsi állapot mennyisége és a cookie-kban tárolja. Amely nem megvalósítható, ha a következő legjobb megoldás, hogy az ASP.NET munkamenet-állapot szolgáltatóval elosztott, memóriában lévő gyorsítótárhoz. A legrosszabb megoldás a teljesítmény- és skálázhatósági szempontból az adatbázis biztonsági munkamenetállapot-szolgáltatóját. Ez a témakör áttekintést nyújt az Azure Redis Cache ASP.NET munkamenetállapot-szolgáltatóját használja. További munkamenet-állapot lehetőségekről további információkért lásd: [ASP.NET munkamenet-állapot beállításai](#aspnet-session-state-options).
...
A NuGet-csomag letölti és hozzáadja a szükséges szerelvényhivatkozásokat, és hozzáadja az alábbi szakasz a web.config fájl. Ez a szakasz tartalmazza a szükséges konfigurációval, hogy az ASP.NET alkalmazás a Redis Cache munkamenetállapot-szolgáltatóját használja.
...
Ezek a lépések elvégzése után az alkalmazás használata Redis Cache munkamenetállapot-szolgáltatója van konfigurálva. Ha az alkalmazás munkamenet-állapotot használ, az Azure Redis Cache-példány tárolódik.
...
Tekintse meg a [ASP.NET kimenetigyorsítótár-szolgáltatója az Azure Redis Cache](cache-aspnet-output-cache-provider.md).
