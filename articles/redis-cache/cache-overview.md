...
Az Azure Redis Cache hozzáférést biztosít egy biztonságos, dedikált Redis Cache gyorsítótárhoz, amely az Azure-on belül üzemel, a Microsoft kezeli, és az Azure-on belül bármelyik alkalmazás számára hozzáférhető.
