...
> [!NOTE]
> Ne adja meg a "Automation kezelő" szerepkör, kivéve, ha meg szeretné adni egy olyan operátort képes kezelni a fiók minden forgatókönyve feladataihoz.
...
|A Naplóelemzési munkaterület     | Log Analytics közreműködő| A Naplóelemzési munkaterület        |
|A Naplóelemzési munkaterület |Log Analytics olvasó| Előfizetés|
