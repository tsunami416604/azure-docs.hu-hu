...
2. Kattintson a **Forgatókönyvek** csempére a forgatókönyvek listájának megnyitásához.<br> ![Runbookok szabályozása](media/automation-first-runbook-textual/runbooks-control.png)
...
5. Ebben az esetben egy [PowerShell-alapú munkafolyamat-forgatókönyvet](automation-runbook-types.md#powershell-workflow-runbooks) hozunk létre, ezért a **Forgatókönyv típusának** válassza a **PowerShell-munkafolyamat** lehetőséget.<br> ![Új runbook](media/automation-first-runbook-textual/new-runbook.png)
...
2. Írja be a következőt: *Write-Output "Hello World."* a zárójelek közé.
   ...
   ```
3. A **Mentés** gombra kattintva mentse el a forgatókönyvet.<br> ![Runbook mentése](media/automation-first-runbook-textual/runbook-edit-toolbar-save.png)
...
4. Most csak elindítani szeretnénk a forgatókönyvet, tehát kattintson az **Indítás**, majd az **Igen** gombra, amikor a rendszer erre kéri.<br> ![Runbook indítása](media/automation-first-runbook-textual/runbook-toolbar-start.png)
...
1. Kattintson a MyFirstRunbook-Workflow panel **Szerkesztés** gombjára a szöveges szerkesztő megnyitásához.<br> ![Runbook szerkesztése](media/automation-first-runbook-textual/runbook-toolbar-edit.png)
...
6. Kattintson az **Indítás** gombra a forgatókönyv elindításához. Írja be a **VMName** és a **ResourceGroupName** értéket az elindítani kívánt virtuális géphez.<br> ![Runbook indítása](media/automation-first-runbook-textual/automation-pass-params.png)
