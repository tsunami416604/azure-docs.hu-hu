...
|ScheduledStartStop_Child | VMName <br> Művelet: Leállítása vagy elindítása <br> ResourceGroupName | Csak a szülő runbook hívása. Állítsa le vagy a ütemezett STOP start hajt végre.|  
