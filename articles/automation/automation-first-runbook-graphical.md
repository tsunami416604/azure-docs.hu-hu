...
2. Kattintson a **Forgatókönyvek** csempére a forgatókönyvek listájának megnyitásához.<br> ![Runbookok szabályozása](media/automation-first-runbook-graphical/runbooks-control.png)
