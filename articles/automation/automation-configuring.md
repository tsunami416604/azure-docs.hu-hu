...
11. 建立新 [Azure 自動化認證資產](http://msdn.microsoft.com/library/dn940015.aspx) 如您所建立的使用者帳戶。 [**認證類型**] 應該是 [**Windows PowerShell 認證**]。
...
- [使用 Azure Active Directory 對 Azure 進行驗證的 azure 自動化:](http://azure.microsoft.com/blog/2014/08/27/azure-automation-authenticating-to-azure-using-azure-active-directory/)
