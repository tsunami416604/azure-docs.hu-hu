...
> [!NOTE]
> Ez a kód nem távolítja el a Log Analytics ügynök Linux a számítógépről. Csak eltávolítja a hibrid Runbook feldolgozó szerepkör funkcióit és konfigurációját.
