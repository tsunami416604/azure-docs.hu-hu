...
![Parancsfájlok kiválasztása](./media/update-mgmt-pre-post-scripts/select-scripts.png)
...
![Kijelölt elemek](./media/update-mgmt-pre-post-scripts/selected-items.png)
...
![Eredmények frissítése](./media/update-mgmt-pre-post-scripts/update-results.png)
...
![A telepítés futtatásának eredményei](./media/update-mgmt-pre-post-scripts/deployment-run.png)
...
![Katalógusok listája](./media/update-mgmt-pre-post-scripts/runbook-gallery.png)
...
* Az Update Management részletes ismertetését lásd: [a virtuális gépek frissítéseinek és javításának kezelése](update-mgmt-manage-updates-for-vm.md).
