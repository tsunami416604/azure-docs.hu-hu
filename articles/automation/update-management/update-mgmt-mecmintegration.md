...
A felügyelt Windows-kiszolgálókat jelentéssel és frissítéssel állíthatja be és frissítheti a Windows Endpoint Configuration Managerban, valamint a befejezett frissítések telepítésének részletes állapotát [Update Management](update-mgmt-overview.md)használatával. Ha a Windows Endpoint Configuration Managert használja a frissítési megfelelőségi jelentéskészítéshez, de a frissítési központi telepítések Windows-kiszolgálókkal való kezeléséhez nem, akkor folytathatja a jelentéskészítést a végpont Configuration Manager, amíg a biztonsági frissítéseket Azure Automation Update Management kezeli.
