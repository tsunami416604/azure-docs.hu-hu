...
ms.locfileid: "47433192"
---
# <a name="manage-pre-and-post-scripts-preview"></a>Kezelése előtti és utáni parancsfájlokat (előzetes verzió)

Előtti és utáni szkriptek lehetővé teszik a PowerShell-forgatókönyvek az Automation-fiókban (előtti feladat) előtt és után (utáni) frissítés központi telepítés. Előtti és utáni parancsfájlokat futtatni, az Azure környezetben, és nem helyileg.
...
Az összes tulajdonság egy teljes példa található: [frissítés szoftverkonfigurációjáról - név alapján beolvasása](/rest/api/automation/softwareupdateconfigurations/getbyname#examples)

> [!NOTE]
> Egy központi telepítés a hozzáadott számítógépek [dinamikus csoportok (előzetes verzió)](automation-update-management.md#using-dynamic-groups) , jelenleg nem tartozik a **SoftwareUpdateConfigurationRunContext** paraméter.
