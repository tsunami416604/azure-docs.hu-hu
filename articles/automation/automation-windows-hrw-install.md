...
2. Ellenőrizze, hogy az ügynök megfelelően töltötte-e le az Automation-megoldást. Rendelkeznie kell egy **AzureAutomationFiles** nevű mappával a **C:\Program Files\Microsoft Monitoring Agent\Agent mappában.** 
