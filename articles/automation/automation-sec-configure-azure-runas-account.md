...
13. Zárja be a **Feladat összegzése** panelt, és a megfelelő **AzureAutomationTutorialScript** forgatókönyv paneljét.
...
9. Zárja be a **Kimenet** panelt, és lépjen vissza a **Feladat összegzése** panelre.
13. Zárja be a **Feladat összegzése** panelt, és a megfelelő **AzureClassicAutomationTutorialScript** forgatókönyv paneljét.
...
2. Már rendelkezik egy, a klasszikus erőforrások felügyeletére szolgáló Automation-fiókkal, de szeretné azt frissíteni, és klasszikus futtató fiókként használni, hogy megtakarítsa az új fiók létrehozásához és a forgatókönyvek és objektumok áthelyezéséhez szükséges időt.   
...
3. Az emelt szintű PowerShell parancssori rendszerhéjból lépjen a mappába, amely az 1. lépésben létrehozott parancsprogramot tartalmazza, és futtassa azt a *–ResourceGroup*, *-AutomationAccountName*, *-ApplicationDisplayName*, *-SubscriptionId* és *-CertPlainPassword* paraméterek értékeinek módosításával.<br>
    ...
    >[AZURE.NOTE] A rendszer az Azure rendszerrel történő hitelesítést fogja kérni a parancsprogram futtatása után. Olyan fiókkal kell bejelentkeznie, amely tagja az Előfizetés-adminisztrátorok szerepkörnek, illetve az előfizetés társadminisztrátorai közé tartozik.
