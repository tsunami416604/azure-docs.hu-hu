...
Az AWS használatával történő hitelesítéshez meg kell határozni az AWS hitelesítő adatokat az Azure Automation által futtatott forgatókönyvek hitelesítéséhez. Ha már rendelkezik egy létrehozott Automation-fiókot, és szeretné használni, amely AWS felé hitelesíteni, követheti a következő szakaszban ismertetett lépések: Ha meg szeretné üzemeltetni az AWS-erőforrásokat célzó runbookokhoz fiókot használja, akkor először hozzon létre egy új [ Automation-fiók](automation-offering-get-started.md) (hagyja ki az egyszerű szolgáltatás létrehozását), és kövesse az alábbi lépéseket:
