...
| Parancsmagok | Leírás |
|:--- |:--- |
| [Get-AzureRmAutomationCredential](/powershell/module/azurerm.automation/get-azurermautomationcredential) |Hitelesítőadat-eszköz adatait kérdezi le. Ez nem ad vissza egy PSCredential objektumot.  |
...
> [!NOTE]
> **Get-AzureRmAutomationCredential** nem ad vissza egy **PSCredential** , amely a hitelesítéshez használható. Csak hitelesítő adatokkal kapcsolatos információkat biztosít. Ha szeretné használni a hitelesítő adatokat a runbook kell használnia a **Get-AutomationPSCredential** beolvasni a **PSCredential** objektum.
...
![Adja hozzá a vászonhoz hitelesítő adatok](../media/credentials/credential-add-canvas.png)
...
![Adja hozzá a vászonhoz hitelesítő adatok](../media/credentials/get-credential.png)
