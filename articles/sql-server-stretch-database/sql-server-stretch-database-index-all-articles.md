...
| 2 |[Stretch Database korlátozásai](sql-server-stretch-database-limitations.md) |További információ a Stretch Database korlátozásáról. |
...
| 6 |[Enable Stretch Database for a table (A Stretch Database használatának engedélyezése táblákon)](sql-server-stretch-database-enable-table.md) |Megtudhatja, hogyan konfigurálhat egy táblát a Stretch Databasehoz. |
| 7 |[Az áttelepíteni kívánt sorok kiválasztása a Filter függvény használatával (Stretch Database)](sql-server-stretch-database-predicate-function.md) |Megtudhatja, hogyan választhatja ki az áttelepíteni kívánt sorokat egy Filter függvény használatával. |

## <a name="manage"></a>Kezelés
| &nbsp; | Cím | Leírás |
| ---:|:--- |:--- |
| 8 |[A Stretch Database letiltása és a távoli adatvisszaállítás](sql-server-stretch-database-disable.md) |Megtudhatja, hogyan tilthatja le a táblák Stretch Databaseét, és szükség esetén visszaállíthatja a távoli adatvesztést. |
| 9 |[Manage and troubleshoot Stretch Database (A Stretch Database felügyelete és hibáinak elhárítása)](sql-server-stretch-database-manage.md) |Megtudhatja, hogyan kezelheti és elháríthatja a Stretch Database. |
| 10 |[Az adatáttelepítés figyelése és hibakeresése (Stretch Database)](sql-server-stretch-database-monitor.md) |Megtudhatja, hogyan figyelheti az adatáttelepítés állapotát. |
| 11 |[Az adatáttelepítés szüneteltetése és folytatása (Stretch Database)](sql-server-stretch-database-pause.md) |Megtudhatja, hogyan szüneteltetheti vagy folytathatja az adatáttelepítést az Azure-ba. |

## <a name="security"></a>Biztonság
| &nbsp; | Cím | Leírás |
| ---:|:--- |:--- |
| 12 |[Transzparens adattitkosítás (TDE) engedélyezése az Azure-beli Stretch Databasehoz](sql-server-stretch-database-encryption-tde.md) |Transzparens adattitkosítás (TDE) engedélyezése az Azure-beli SQL Server Stretch Databasehoz |
| 13 |[Transzparens adattitkosítás (TDE) engedélyezése az Azure-beli Stretch Database (Transact-SQL)](sql-server-stretch-database-tde-tsql.md) |Transzparens adattitkosítás (TDE) engedélyezése SQL Server Stretch Database Azure-beli TSQL |
