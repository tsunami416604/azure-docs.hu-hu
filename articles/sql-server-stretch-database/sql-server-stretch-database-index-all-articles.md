---
title: Az SQL Server Stretch Database szolgáltatás összes téma |} A Microsoft Docs
description: Az Azure-szolgáltatás összes témakörök tábla nevű SQL Server Stretch Database a https://azure.microsoft.com/documentation/articles/, nevét és leírását.
...
Ez a témakör felsorolja az összes többi témakör, amely közvetlenül a alkalmazni a **SQL Server Stretch Database** az Azure szolgáltatás. A weblap kulcsszavak használatával kereshet **Ctrl + F**, és keresse meg a témakörök a jelenlegi lényeges.
...
| &nbsp; | Cím | Leírás |
| ---:|:--- |:--- |
| 5 |[Enable Stretch Database for a database (A Stretch Database használatának engedélyezése adatbázisokon)](sql-server-stretch-database-enable-database.md) |Ismerje meg a Stretch Database-adatbázis konfigurálása. |
...
| 9 |[Manage and troubleshoot Stretch Database (A Stretch Database felügyelete és hibáinak elhárítása)](sql-server-stretch-database-manage.md) |Manage and troubleshoot Stretch Database és útmutató. |
...
| 13 |[Transzparens adattitkosítás (TDE) engedélyezze a Stretch Database az Azure-ban (Transact-SQL)](sql-server-stretch-database-tde-tsql.md) |Az SQL Server Stretch Database az Azure TSQL transzparens adattitkosításának (TDE) engedélyezése |

## <a name="backup-and-recovery"></a>Biztonsági másolat és helyreállítás
| &nbsp; | Cím | Leírás |
| ---:|:--- |:--- |
| 14 |[Backup Stretch-enabled databases (A Stretch szolgáltatást használó adatbázisok biztonsági mentése)](sql-server-stretch-database-backup.md) |Ismerje meg, hogyan készíthet biztonsági mentést Stretch\-engedélyezett adatbázisok. |
| 15 |[A Stretch engedélyezve van az adatbázisok visszaállítása](sql-server-stretch-database-restore.md) |Ismerje meg, hogyan állíthatja vissza a Stretch\-engedélyezett adatbázisok. |
