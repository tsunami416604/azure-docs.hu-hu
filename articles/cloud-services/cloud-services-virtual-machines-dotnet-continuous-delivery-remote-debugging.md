...
2. Az Azure portálon] (http://go.microsoft.com/fwlink/p/?LinkID=269851), keresse meg a virtuális gépet a virtuális gép **RDP tanúsítvány UJJLENYOMATA**. Ez az érték szolgál a `ServerThumbprint` bővítménykonfiguráció értéket.
