...
## <a name="problem-my-role-instances-recycled-without-me-doing-anything"></a>Probléma Saját szerepkör-példányok újrahasznosítása anélkül, hogy bármit tennék
...
## <a name="problem-a-role-instance-is-looping-between-started-initializing-busy-and-stopped"></a>Probléma A szerepkör-példányok az elindított, az inicializálás, a foglalt és a leállított lépések között hurkok
