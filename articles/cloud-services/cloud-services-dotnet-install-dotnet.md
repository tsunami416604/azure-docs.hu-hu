...
Például .NET 4.6.2-es verziójához is telepíthető a Vendég operációsrendszer-család 4, amelyhez nem tartozik a .NET 4.6 bármelyik verzióját. (A Vendég operációsrendszer-család 5 .NET 4.6 kapható.) Az Azure vendég operációs rendszereinek kiadásait a legfrissebb információkért lásd: a [Azure vendég operációs rendszer kiadási hírek](cloud-services-guestos-update-matrix.md). 
...
* [4.6.2-es .NET webalkalmazás-telepítő](https://www.microsoft.com/download/details.aspx?id=53345)
...
> [!NOTE]
> Akkor is, ha az alkalmazás célozza .NET 4.6 .NET 4.6.2-es kell telepíthető a felhő szerepkör-szolgáltatás. A vendég operációs rendszer tartalmazza a Tudásbázis [3098779 frissítése](https://support.microsoft.com/kb/3098779) és [3097997 frissítése](https://support.microsoft.com/kb/3097997). Probléma akkor fordulhat elő, ha .NET 4.6 fölött a Tudásbázis frissítések telepítve van a .NET-alkalmazások futtatásakor. Ezek a problémák elkerülése érdekében telepítse a 4.6-os verzió, hanem .NET 4.6.2-es verziójához. További információkért lásd: a [Tudásbázis 3118750](https://support.microsoft.com/kb/3118750) és [4340191](https://support.microsoft.com/kb/4340191).
> 
> 
