...
További szerepkör-újrahasznosítási forgatókönyvek megtekintése a [Kevin Williamson blog](https://blogs.msdn.com/b/kwill/archive/2013/08/09/windows-azure-paas-compute-diagnostics-data.aspx)-sorozatában.
