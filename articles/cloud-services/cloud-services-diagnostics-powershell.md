...
如果您啟用診斷延伸模組使用 *Set-azureservicediagnosticsextension* 或 *新增 AzureServiceDiagnosticsExtensionConfig* 沒有 *角色* 參數，則您可以移除延伸模組使用 *Remove-azureservicediagnosticsextension* 沒有 *角色* 參數。 如果 *角色* 時啟用擴充功能，則也必須使用移除擴充功能時，所使用參數。
