...
| --------- | ---- | ----------- |  
|név|string|Kötelező. A webes szerepkör nevét. A szerepkör nevének egyedinek kell lennie.|  
...
|protokoll|string|Kötelező. Az átviteli protokoll a külső végpont számára. A webes szerepkör, a lehetséges értékek a következők `HTTP`, `HTTPS`, `UDP`, vagy `TCP`.|  
...
| Attribútum | Típus | Leírás |  
| --------- | ---- | ----------- |  
|név|string|Kötelező. A webhely vagy alkalmazás neve.|  
...
| Attribútum | Típus | Leírás |  
| --------- | ---- | ----------- |  
|név|string|Kötelező. Adja meg egy nevet a virtuális alkalmazás azonosításához.|  
...
| Attribútum | Típus | Leírás |  
| --------- | ---- | ----------- |  
|név|string|Kötelező. Adja meg a virtuális könyvtár nevét.|  
...
| Attribútum | Típus | Leírás |  
| --------- | ---- | ----------- |  
|név|string|Kötelező. Meghatározza a kötés azonosítására szolgáló nevet.|  
