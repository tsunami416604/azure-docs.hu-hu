...
A következő lépésekkel telepítheti az [OE SDK](https://github.com/openenclave/openenclave) -t az DCsv2-Series virtuális gépre, amely Ubuntu 18,04 LTS Gen 2 rendszerképet futtat. 
