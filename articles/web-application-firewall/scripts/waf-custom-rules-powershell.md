...
description: Azure PowerShell-parancsfájlminta – Webalkalmazás-tűzfal létrehozása az Application Gateway egyéni szabályain
author: vhorne
...
- A WAF egyéni szabályairól a [WebApplication Tűzfal egyéni szabályai](../ag/custom-waf-rules-overview.md) című témakörben talál további információt.
