...
$exclusion2 = New-AzApplicationGatewayFirewallExclusionConfig `
   ...
   -Selector "user"
```
Tehát ha az URL-címet `http://www.contoso.com/?user%281%29=fdafdasfda` átadni a WAF, nem értékeli ki a **fdafdasfda**karakterláncot, de továbbra is kiértékeli a **(z) %281 %29**nevű paramétert. 
