...
Azt is megvizsgálhatja, hogy a tűzfal naplófájljaiban megtekintheti, hogy mire van szükség a kizárási listához való hozzáadásához. A naplózás engedélyezéséhez tekintse [meg a háttérrendszer állapotát, a diagnosztikai naplókat és a Application Gateway mérőszámait](../../application-gateway/application-gateway-diagnostics.md).
...
A kérések és válaszok fejlécek megtekintésének egy másik módja, ha a Chrome fejlesztői eszközein belül keres. Nyomja le az F12 billentyűt, vagy kattintson a jobb gombbal > **vizsgálja** meg -> **fejlesztői eszközök**, majd válassza a **hálózat** fület. töltsön be egy weblapot, és kattintson a vizsgálni kívánt kérelemre.
