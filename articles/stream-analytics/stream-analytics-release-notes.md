---
title: Az Azure Stream Analytics - kibocsátási megjegyzései
description: Ez a cikk ismerteti az Azure Stream Analytics és a megfelelő Visual Studio eszközök kiadás előzményeit.
...
A frissítés a hibaelhárítási dokumentációja kiadás van.

A [hibaelhárítási útmutatója](stream-analytics-troubleshooting-guide.md) és egyéb docs kiadott. Tekintse át a jelen útmutató, és üdvözli a visszajelzést.
...
| A bemenetek/kimenetek hibaüzenet megjelenítése | Ha a feladat bemeneti vagy kimeneti kapcsolódó futásidejű hiba történik, ahol is, és a részletes hibaüzenet megtekintéséhez vigye feladat diagram is látható.|
...
| A bemeneti forrás következtetni adattípusok |A CREATE TABLE utasítás nem használható, ha a bemeneti típus bemeneti formátum van származtatva, például a fürt megosztott kötetei szolgáltatás minden mező karakterlánc. Mezők explicit módon átalakítása a függvény használatával típusa eltérő hibák elkerülése érdekében a megfelelő típusú. |
