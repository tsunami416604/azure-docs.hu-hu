...
* [A Visual Studio Code használatával helyileg tesztelheti stream Analytics lekérdezéseket az élő adatfolyam-bevitelsel a](visual-studio-code-local-run-live-input.md)
*[Azure stream Analytics-feladatok CI/CD NPM-csomag használatával történő üzembe helyezésével](setup-cicd-vs-code.md)