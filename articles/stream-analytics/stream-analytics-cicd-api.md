...
Manifest nasazení konfigurációját követően tekintse meg [üzembe helyezése az Azure IoT Edge-modulok az Azure CLI-vel](/iot-edge/how-to-deploy-modules-cli) üzembe helyezéshez.
