...
Annyi tokent `{datetime:<specifier>}`használhat, mint ahogyan az elérési út mintában, amíg el nem éri az elérési út előtagjának karakteres korlátját. A formázási megadások nem kombinálhatók egyetlen jogkivonaton belül a dátum és idő legördülő lista által már felsorolt kombinációk fölé. 
...
A blob Storage egyéni elérésiút-mintái használhatók a kaptár streaming konvencióval, amely arra vár, hogy a mappák a `column=` mappa nevében legyenek felcímkézve.
