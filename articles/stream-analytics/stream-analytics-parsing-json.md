...
## <a name="examples"></a>Példák
Beágyazott mezői eléréséhez használja (.) felépítését. Például ez a lekérdezés a fenti JSON-adatokat a szélességi és hosszúsági koordináták mellett a Location tulajdonsághoz lehetőséget választja:
...
[Adattípusok az Azure Stream Analytics szolgáltatásban](https://docs.microsoft.com/en-us/stream-analytics-query/data-types-azure-stream-analytics)
