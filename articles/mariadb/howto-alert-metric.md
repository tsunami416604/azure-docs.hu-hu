...
10. **E-mail/SMS/leküldéses/** hangműveletek típusának konfigurálása.
    ...
    ![Műveleti csoport](./media/howto-alert-metric/10-action-group-type.png)

11. Adja meg a riasztási szabály nevét, leírását és súlyosságát.

    ![Műveleti csoport](./media/howto-alert-metric/11-name-description-severity.png) 
