...
**Illesztőprogram** | **Linkek** | **Kompatibilis verziók** | **Nem kompatibilis verziók** | **Megjegyzések**
---|---|---|---|---
...
Node.js |  [MySQLjs a GitHubon](https://github.com/mysqljs/mysql/) <br> Telepítőcsomag a NPM-ből:<br> `npm install mysql` futtatása a NPM | 2,15 | 2.14.1 és előtte
GO | https://github.com/go-sql-driver/mysql/releases | 1,3, 1,4 | 1,2 és előtte | Használja az 1,3-es verzióhoz tartozó `allowNativePasswords=true`t a kapcsolatok karakterláncában. Az 1,4-es verzió egy javítást tartalmaz, és `allowNativePasswords=true` már nem szükséges.
