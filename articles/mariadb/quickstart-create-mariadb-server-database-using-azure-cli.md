---
title: 'Gyors útmutató: Hozzon létre egy Azure Database for MariaDB-kiszolgáló – Azure CLI-vel'
...
> [Az Azure CLI-vel MariaDB adatbázis tervezése](./tutorial-design-database-cli.md)
