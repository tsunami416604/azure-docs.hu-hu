...
2. 
    ![[診斷] 刀鋒視窗](./media/insights-how-to-use-diagnostics/Insights_CreateTime.png)
...
3. [**診斷**] 刀鋒視窗會有該資源的所有可能診斷和監視集合資料。 
    ![儲存體診斷診斷](./media/insights-how-to-use-diagnostics/Insights_StorageDiagnostics.png)
...
- **Windows 事件系統記錄檔**：傳送至系統通道的 Windows 事件。
