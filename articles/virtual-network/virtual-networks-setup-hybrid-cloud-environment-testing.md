...
使用中的 「 設定公司網路子網路的步驟 」 一節的指示 [測試實驗室指南: 基本設定 Windows Server 2012 R2 的](http://www.microsoft.com/download/details.aspx?id=39638) corpnet 子網路上設定 DC1、 APP1 和 CLIENT1 電腦。 **這個子網路必須與您的組織網路隔離，因為它會直接連線到網際網路，透過 RRAS1 電腦。** 
