...
* **Internet** (Resource Manager) (**INTERNET** klasszikus telepítéshez): Ez a címke az Azure nyilvános IP-címterét jelöli. A címkében lévő címeket [az Azure tulajdonában lévő nyilvános IP-címterekről](https://www.microsoft.com/download/details.aspx?id=41653) szóló, rendszeresen frissített dokumentum tartalmazza.
