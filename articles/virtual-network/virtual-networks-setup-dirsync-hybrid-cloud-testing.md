...
[部署 Office 365 目錄同步作業 (DirSync) 在 Microsoft Azure](http://technet.microsoft.com/library/dn635310.aspx)

[使用 Office 伺服器和雲端解決方案](http://technet.microsoft.com/library/dn262744.aspx)
