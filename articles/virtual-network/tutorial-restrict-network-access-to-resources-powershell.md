...
description: Megtudhatja, hogyan korlátjának növelését, és korlátozhatja a hálózati hozzáférést az Azure-erőforrások, például az Azure Storage és az Azure SQL Database, a virtuális hálózati Szolgáltatásvégpontok PowerShell használatával.
...
> [Virtuális hálózatok csatlakoztatása](./tutorial-connect-virtual-networks-powershell.md)
