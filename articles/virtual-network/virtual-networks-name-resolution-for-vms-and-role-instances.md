...
- [Azure 提供名稱解析](#azure-provided-name-resolution)
...
|--------------|----------------------------------|-------------------------------|
| 位於相同雲端服務中的角色執行個體或 VM 之間的名稱解析| Azure 提供的名稱解析| [Azure 提供名稱解析](#azure-provided-name-resolution)|
...
[AZURE。附註]: 'dnsmasq' 封裝是許多的 DNS 快取適用於 Linux 的其中之一。 使用它之前，請檢查特定需求的適用性，而且沒有安裝其他快取。
...
[關於在管理入口網站中設定虛擬網路設定](virtual-networks-settings.md)
