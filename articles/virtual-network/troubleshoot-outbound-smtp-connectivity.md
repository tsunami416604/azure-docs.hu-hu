...
A 2017. november 15. után létrehozott utólagos elszámolású előfizetések esetében technikai korlátozások lesznek érvényesek, amelyek letiltják a közvetlenül az előfizetésekben lévő virtuális gépekről küldött e-maileket. Ha azt szeretné, hogy az Azure-beli virtuális gépekről érkező e-mailek közvetlenül a külső e-mail-szolgáltatók számára legyenek elküldve (nem hitelesített SMTP-továbbító használatával), a Azure Portal egy Azure-Virtual Network erőforrásának **diagnosztizálás és megoldás** paneljének **kapcsolat** szakaszában törölje a korlátozást. Ha minősített, az előfizetés engedélyezve lesz, vagy a következő lépésekre vonatkozó utasításokat fog kapni.
...
Ha az Azure-erőforrásokat a CSP-n keresztül használja, az Azure Portalon egy Virtual Network-erőforráshoz tartozó "diagnosztika és megoldás" panel "kapcsolat" szakaszában lévő korlátozás eltávolítására vonatkozó kérést is elvégezhet. Ha minősített, az előfizetés engedélyezve lesz, vagy a következő lépésekre vonatkozó utasításokat fog kapni.
