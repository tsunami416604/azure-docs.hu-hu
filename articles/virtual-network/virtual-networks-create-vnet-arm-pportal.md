...
[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)] 本文件說明如何使用資源管理員部署模型來建立 VNet。 您也可以 [傳統部署模型中建立虛擬網路透過 Azure 預覽入口網站](virtual-networks-create-vnet-classic-pportal.md)。
