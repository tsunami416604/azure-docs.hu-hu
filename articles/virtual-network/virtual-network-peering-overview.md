...
* Az erőforrás-kezelő és a klasszikus telepítési modell esetében a virtuális hálózatok közötti társhálózati viszony előfeltétele, hogy a virtuális hálózatok ugyanahhoz az előfizetéshez tartozzanak.
