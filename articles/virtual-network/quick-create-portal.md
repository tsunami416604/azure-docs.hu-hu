...
1. A Azure Portal menüben válassza az **erőforrás létrehozása**lehetőséget. Az Azure Marketplace-en válassza a **hálózatkezelés** > **virtuális hálózat**lehetőséget.
...
1. Az Azure Marketplace-en válassza a **számítás** > **Windows Server 2019 Datacenter**elemet. Kattintson a **Létrehozás** gombra.
...
1. A **virtuális gép létrehozása – alapismeretek**területen adja meg vagy válassza ki az alábbi adatokat:
    ...
    | Image (Kép) | Alapértelmezett érték a **Windows Server 2019 Datacenter rendszerhez**. |
