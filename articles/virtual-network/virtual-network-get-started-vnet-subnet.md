...
1. Az [Azure Portalon](https://portal.azure.com) kattintson az **Erőforrás létrehozása** > **Számítás** > **Windows Server 2016 Datacenter** lehetőségre.
...
1. Az [Azure Portalon](https://portal.azure.com) kattintson a **Minden szolgáltatás** lehetőségre.
2. Írja be az *Erőforráscsoportok* kifejezést a *Szűrő* feliratú mezőbe. Kattintson a szűrt listában megjelenő **Erőforráscsoportok** elemre.
