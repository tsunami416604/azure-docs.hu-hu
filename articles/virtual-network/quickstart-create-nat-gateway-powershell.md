...
```
A konfigurációs definíciók kombinálásával hozzon létre egy **myVM** nevű virtuális gépet a [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) a **myResourceGroupNAT**-ben.
