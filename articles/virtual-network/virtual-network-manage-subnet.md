---
title: Hozzáadása, módosítása vagy törlése az Azure virtuális hálózat alhálózatának |} A Microsoft Docs
...
5. Adja meg az értékeket az alábbi paraméterekkel:
    - **Név**: A név a virtuális hálózaton belül egyedinek kell lennie. A maximális kompatibilitás érdekében az egyéb Azure-szolgáltatásokkal javasoljuk betűvel a név első karaktert. Például az Azure Application Gateway nem fog üzembe egy alhálózatot, amely számos kezdetű névvel rendelkezik.
