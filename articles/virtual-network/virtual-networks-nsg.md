...
|**來源連接埠範圍**|規則要符合的來源連接埠範圍|單一連接埠號碼從 1 到 65535 之間，連接埠範圍 (亦即 100-2000) 或 \ * （適用於所有連接埠）|嘗試盡可能使用連接埠範圍，以避免需要多個規則|
|**目的地連接埠範圍**|規則要符合的目的地連接埠範圍|單一連接埠號碼從 1 到 65535 之間，連接埠範圍 (亦即 100-2000) 或 \ * （適用於所有連接埠）|嘗試盡可能使用連接埠範圍，以避免需要多個規則|
