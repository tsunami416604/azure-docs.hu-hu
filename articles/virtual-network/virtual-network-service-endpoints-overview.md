...
- **[Azure App Service](https://docs.microsoft.com/en-us/azure/app-service/app-service-ip-restrictions)** : Hol érhető el az App service összes Azure-régióban elérhető előzetes.
