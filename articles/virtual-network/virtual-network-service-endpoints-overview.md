...
- **[Azure App Service](https://docs.microsoft.com/azure/app-service/app-service-ip-restrictions)** : Hol érhető el az App service összes Azure-régióban általánosan elérhető
