...
description: A hálózati virtuális berendezés (NVA) hibáinak elhárítása az Azure-ban és a NVA-konfigurációk alapszintű Azure platformra vonatkozó követelményeinek ellenőrzése.
