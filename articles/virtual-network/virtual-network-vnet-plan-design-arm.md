...
- Rendelkezik különböző virtuális hálózatokban lévő erőforrások a szervezeti felügyeleti kapcsolatos követelmények? Ha tehát, előfordulhat, hogy szét az erőforrásokat külön virtuális hálózati egyszerűsítése érdekében [engedélyek hozzárendelése](#permissions) egyéni felhasználóknak a szervezetben, vagy különböző szabályzatok hozzárendelése különböző virtuális hálózatokban.
