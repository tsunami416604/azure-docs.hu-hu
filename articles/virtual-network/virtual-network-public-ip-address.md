...
|PowerShell|[Get-AzPublicIpAddress](/powershell/module/az.network/get-azpublicipaddress) és egy nyilvános IP-címobjektumot, beállítások megtekintéséhez [Set-AzPublicIpAddress](/powershell/module/az.network/set-azpublicipaddress) ;-beállítások frissítése [Remove-AzPublicIpAddress](/powershell/module/az.network/remove-azpublicipaddress) törlése|
