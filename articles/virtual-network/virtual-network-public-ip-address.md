...
4. Adja meg vagy válassza ki a következő beállítások értékeit a **nyilvános IP-cím létrehozása**területen, majd válassza a **Létrehozás**lehetőséget:
   ...
   |Előfizetést|Igen|Ugyanabban az [előfizetésben](../azure-glossary-cloud-terminology.md?toc=%2fazure%2fvirtual-network%2ftoc.json#subscription) kell lennie, mint a nyilvános IP-cím hozzárendeléséhez használt erőforrásnak.|
