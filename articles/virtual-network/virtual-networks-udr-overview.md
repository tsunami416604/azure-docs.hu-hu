...
## <a name="next-hop-types-across-azure-tools"></a>Következő ugrás típusai az Azure-eszközökben
...
ER- és VPN Gateway-útvonalpropagálás letiltható egy alhálózaton egy útválasztási táblázatot egy tulajdonság használatával. Az Azure-ral a BGP használatával útvonalakat cserél, amikor útvonalak ne adják hozzá az összes alhálózat útválasztási táblázatot a virtuális hálózati átjáró útvonalpropagálás le van tiltva. A VPN-kapcsolatok következő ugrás típusú *virtuális hálózati átjáró* és [egyéni útvonalak](#custom-routes) használatával jönnek létre. További információkért lásd: [virtuális hálózati átjáró-útvonalpropagálás letiltása](manage-route-table.md#create-a-route-table).
...
|Alapértelmezett |Aktív |100.64.0.0/10       |Nincsenek                      |                   |
