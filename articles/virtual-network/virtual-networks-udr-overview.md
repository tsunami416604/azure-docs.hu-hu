---
title: Azure virtuális hálózati forgalom útválasztása
...
* **Nincs**: A **Nincs** típusú következő ugrásra irányuló forgalmat a rendszer eldobja, és nem irányítja az alhálózaton kívülre. Az Azure automatikusan alapértelmezett útvonalakat hoz létre a következő címelőtagokhoz:<br>
    ...
    * **10.0.0.0/8 és 192.168.0.0/16**: Az 1918-as RFC-ben magánhasználatra van fenntartva.<br>
...
|-----                  |----                                   |---------                    |--------|
|Alapértelmezett                |A virtuális hálózaton egyedi, például: 10.1.0.0/16|Virtuális hálózatok közötti társviszony                 |Összes|
