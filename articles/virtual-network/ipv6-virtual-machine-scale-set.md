...
---
# <a name="deploy-virtual-machine-scale-sets-with-ipv6-in-azure-preview"></a>Virtuálisgép-méretezési készletek üzembe helyezése az IPv6-tal az Azure-ban (előzetes verzió)
