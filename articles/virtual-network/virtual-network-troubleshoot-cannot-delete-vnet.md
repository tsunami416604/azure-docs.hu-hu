...
Letilthatja a szolgáltatást, lásd: [tiltsa le az Active Directory Domain Servicest az Azure portal használatával](../active-directory-domain-services/delete-aadds.md).
