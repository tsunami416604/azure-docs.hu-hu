...
* **Régiók:** az Azure-régiókban elérhető. 
* **Támogatott operációs rendszerekről:** Microsoft Windows Server 2012 R2 Datacenter és a Windows Server 2016
* **Virtuálisgép-méret:** általános célú és nyolc vagy több maggal rendelkező számítási optimalizált példány mérete. További információkért lásd: [Windows Virtuálisgép-méretek](../virtual-machines/windows/sizes.md?toc=%2fazure%2fvirtual-network%2ftoc.json).
