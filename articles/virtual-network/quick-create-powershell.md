...
Végül, ha helyileg futtatja a PowerShellt, `Connect-AzAccount`is futtatnia kell. Ez a parancs létrehozza az Azure-hoz való hozzáférést.
...
Nyisson meg egy parancssort a helyi számítógépen. Futtassa a következő parancsot: `mstsc`. Cserélje le a `<publicIpAddress>`t az utolsó lépésből visszaadott nyilvános IP-címmel:
