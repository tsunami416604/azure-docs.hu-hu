...
-   [How To: Concurrent access][How To: Concurrent access]
...
A blob can be either block, or page based. Block blobs allow you to more efficiently upload large data, while page blobs are optimized for read/write operations. For more information, see [Understanding block blobs and page blobs][Understanding block blobs and page blobs].
