...
The other samples that are available to help you get up to speed using HDInsight to run MapReduce jobs are listed on [Running the HDInsight Samples][Running the HDInsight Samples] along with links to instructions on how to run them.
...
2.  [The Java code for the Pi estimator MapReduce program][The Java code for the Pi estimator MapReduce program]
3.  [Summary][Summary]
...
3.  Run the following command to create a MapReduce definition:
...
4.  Run the following commands to submit the MapReduce job and wait for the job to complete:
...
5.  Run the following command to retrieve the MapReduce job standard output:
...
## <span id="java-code"></span></a>The Java code for the Pi estimator MapReduce program
...
-   [Azure HDInsight SDK documentation][Azure HDInsight SDK documentation]
  ...
  [Running the HDInsight Samples]: ../hdinsight-run-samples/
  ...
  [The Java code for the Pi estimator MapReduce program]: #java-code
  [Summary]: #summary
