...
This tutorial covers the APIs. For player development, Microsoft strongly recommends using [Player Framework for Windows 8][Player Framework for Windows 8]. Player framework makes it easier to build applications and provides many additional features.
...
-   Windows 8 32-bit or 64-bit. You can get [Windows 8 Enterprise Evaluation][Windows 8 Enterprise Evaluation] from MSDN.
-   Visual Studio 2012 or Visual Studio Express 2012 for Windows 8 installed on Windows 8. You can get the trial version from [here][here].
-   [Microsoft Smooth Streaming Client SDK for Windows 8][Microsoft Smooth Streaming Client SDK for Windows 8].

The completed solution for each lesson can be downloaded from MSDN Developer Code Samples (Code Gallery): [Lesson 1][Lesson 1], [Lesson 2][Lesson 2], [Lesson 3][Lesson 3], and [Lesson 4][Lesson 4].
...
![Smooth Streaming Windows Store application example][Smooth Streaming Windows Store application example]
...
5.  At the end of the **MainPage** class, past the following code:
    ...
    The sliderProgress\_PointerPressed event handler is defined here. There are more works to do to get it working, which will be covered in the next lesson of this tutorial.

6.  Press **CTRL+S** to save the file.

The finished the code behind file shall look like this:

![Codeview in Visual Studio of Smooth Streaming Windows Store application][Codeview in Visual Studio of Smooth Streaming Windows Store application]
...
6.  At the end of the **mediaElement\_AdaptiveSourceStatusUpdated** method, add the following code:
...
5.  Locate the mediaElement\_ManifestReady method, append the following code at the end of the function:
...
3.  At the top of the application, you can either use the default Smooth Streaming URL or enter a different one.
4.  Click **Set Source**.
5.  The default language is audio\_eng. Try to switch between audio\_eng and audio\_es. Everytime, you select a new stream, you must click the Submit button.
...
-   [How to build a Smooth Streaming Windows 8 JavaScript application with advanced features][How to build a Smooth Streaming Windows 8 JavaScript application with advanced features]
-   [Smooth Streaming Technical Overview][Smooth Streaming Technical Overview]

  [release notes]: http://www.iis.net/learn/media/smooth-streaming/smooth-streaming-client-sdk-for-windows-8-release-notes
