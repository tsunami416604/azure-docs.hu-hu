...
![A virtuálisgép-foglalás vásárlásának kiválasztását bemutató példa](./media/save-compute-costs-reservations/select-product-to-purchase.png)
...
![A foglalási hatókör módosítását bemutató példa](./media/save-compute-costs-reservations/rescope-reservation-resource-group.png)
...
Ha Ön Nagyvállalati Szerződéssel vagy Microsoft-ügyfélszerződéssel rendelkező ügyfél, a foglalás kihasználtságát [API-kkal](reservation-apis.md#see-reservation-usage) és a [használati adatok](understand-reserved-instance-usage-ea.md#common-cost-and-usage-tasks) alapján is lekérheti.
...
Ha az erőforráscsoportot áthelyezi egy másik előfizetésbe, a foglalás hatóköre nem frissül automatikusan. Ha törli az erőforráscsoportot, a hatókör nem frissül. [A foglalás hatókörét újból be kell állítania.](manage-reserved-vm-instance.md#change-the-reservation-scope) Ellenkező esetben a foglalás kihasználatlan lesz.
