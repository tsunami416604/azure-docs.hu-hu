...
1. Válassza a **Letöltés ikont** vagy a jobb oldalon található három pontot (`...`).
1. Megnyílik a letöltés ablaktábla a jobb oldalon. Válassza a **Letöltés** lehetőséget a **használat részletei** szakaszban.
