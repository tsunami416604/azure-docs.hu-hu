...
Ez a hiba az AWS költség- és használati jelentés definíciójával kapcsolatos, és jelentésspecifikus beállításokra van szükség. A követelményekért lásd: [Költség- és használati jelentés létrehozása az AWS-ben](aws-integration-set-up-configure.md#create-a-cost-and-usage-report-in-aws).

### <a name="internal-error-when-creating-connector"></a>Belső hiba történt az összekötő létrehozásakor

**Hibakód:** _Összekötő létrehozása – Nem sikerült létrehozni az összekötőt (&lt;ConnectorName&gt;). Ok: Belső hiba történt. Ellenőrizze, hogy a megfelelő AWS-tulajdonságok lettek-e megadva._

Ez a hiba akkor fordulhat elő, ha az AWS-összekötő és az előfizetés különböző felügyeleti csoportokban található. Az AWS-összekötőnek és az előfizetésnek ugyanabban a felügyeleti csoportban kell lennie.
