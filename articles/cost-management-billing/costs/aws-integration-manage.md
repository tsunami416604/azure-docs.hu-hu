...
| --- | --- | --- | --- |
| Rendelkezésre állási zóna | lineitem/AvailabilityZone | Mind |   |
| Földrajzi egység | termék/régió | Mind |   |
| Forgalmi díj |   | Mind |   |
| Fogyasztásmérő kategóriája | lineItem/ProductCode | Mind |   |
| Fogyasztásmérő alkategóriája | lineitem/Usagetype értékre | Mind |   |
| Művelet | lineItem/művelet | Mind |   |
| Erőforrás | lineItem/ResourceId | Mind |   |
| Erőforrás típusa | termék/instanceType | Mind | Ha a Product/instanceType értéke null, a rendszer a lineItem/Usagetype értékre-et használja. |
| Erőforrás GUID azonosítója | – | Mind | Az Azure Meter GUID-azonosítója. |
| Szolgáltatás neve | termék/ProductName | Mind | Ha a Product/ProductName értéke null, a rendszer lineItem/ProductCode használ. |
| Szolgáltatáscsomag |   |   |   |
| Subscription ID (Előfizetés azonosítója) | lineItem/UsageAccountId | Konszolidált fiók és felügyeleti csoport |   |
...
| Címke | resourceTags/\* | Mind | A _felhasználó:_ előtagot a rendszer eltávolítja a felhasználó által definiált címkékről a több felhőből származó címkék engedélyezéséhez. Az _AWS:_ előtag érintetlen marad. |
| Számlázási fiók azonosítója | számla/PayerAccountId | Felügyeleti csoport |   |
