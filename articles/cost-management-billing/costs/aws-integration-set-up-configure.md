...
2. Az Azure kezdőlapjának megnyitásához kattintson a bal oldali menüben lévő **Kezdőlap** elemre (3 vonalból álló „hamburger” menüikon).
3. Lépjen a lap alján található **Eszközök** > **Cost Management** elemre.
