...
- Azure-előfizetését megoszthatja másokkal, és [Azure-beli szerepköralapú hozzáférés-vezérléssel (Azure RBAC) kezelheti az Azure-előfizetéshez és -erőforrásokhoz való hozzáférést](../../role-based-access-control/role-assignments-portal.md).