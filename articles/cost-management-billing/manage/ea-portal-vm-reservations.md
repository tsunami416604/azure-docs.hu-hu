...
Részleges visszatérítést akkor biztosítunk, amikor egy EA-ügyfél kerettúllépéssel, nem Azure-előrefizetéssel (korábbi nevén pénzügyi keret) vásárolt foglalást ad vissza.
