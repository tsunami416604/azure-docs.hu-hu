...
|-------------| ----------------|
| **Aktív** | Az Azure-előfizetés aktív. Az előfizetés használatával üzembe helyezhet új erőforrásokat, és kezelheti a meglévőket.<br><br>Minden művelet (PUT, PATCH, DELETE, POST, GET) elérhető azon erőforrás-szolgáltatók számára, amelyek [regisztrálva vannak az előfizetéshez](../../azure-resource-manager/management/resource-providers-and-types.md#azure-portal). |
