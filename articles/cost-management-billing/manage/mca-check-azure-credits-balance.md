...
Használhatja az [Azure számlázási](/rest/api/billing/) vagy [használati](/rest/api/consumption/) API-jait a számlázási fiókhoz tartozó kreditegyenleg programozott módon való lekérdezéséhez.
