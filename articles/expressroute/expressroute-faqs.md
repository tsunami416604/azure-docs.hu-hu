...
號 您可以從您的服務提供者購買任何速度的 VPN 連線。 不過，您與 Azure 的連線將會受限於您所購買的 ExpressRoute 電路頻寬。
...
號 所有連結到相同 ExpressRoute 電路的虛擬網路都屬於相同路由網域，且不會彼此隔離的路由的觀點。 如果需要路由隔離，您必須建立個別的 ExpressRoute 電路。
...
號 您無法選取所需的功能。 當您開啟 ExpressRoute Premium 時，我們便會將所有功能啟用。
