...
* Az Azure Resource Manager PowerShell-parancsmagjainak legújabb verzióit kell. További információt [az Azure PowerShell telepítésével és konfigurálásával](/powershell/azure/overview) foglalkozó témakörben talál. 
