...
4. **設定線路的 Azure 私用對等。**
    ...
    您可以執行下列 Cmdlet 來為線路設定 Azure 私用對等。
        ...
        新增 AzureRmExpressRouteCircuitPeeringConfig-名稱"AzurePrivatePeering"-電路 $ckt PeeringType AzurePrivatePeering-PeerASN 100-PrimaryPeerAddressPrefix"10.0.0.0/30"-SecondaryPeerAddressPrefix"10.0.0.4/30"-VlanId 200

        設定 AzureRmExpressRouteCircuit ExpressRouteCircuit $ckt

    如果您選擇使用 MD5 雜湊，您可以使用下列 Cmdlet。

        新增 AzureRmExpressRouteCircuitPeeringConfig-名稱"AzurePrivatePeering"-電路 $ckt PeeringType AzurePrivatePeering-PeerASN 100-PrimaryPeerAddressPrefix"10.0.0.0/30"-SecondaryPeerAddressPrefix"10.0.0.4/30"-VlanId 200-SharedKey 」 為 A1B2C3D4 」
...
4. **設定線路的 Azure 公用對等**
    ...
    您可以執行下列 Cmdlet 來為線路設定 Azure 私用對等
        ...
        新增 AzureRmExpressRouteCircuitPeeringConfig-名稱"AzurePublicPeering"-電路 $ckt PeeringType AzurePublicPeering-PeerASN 100-PrimaryPeerAddressPrefix"12.0.0.0/30"-SecondaryPeerAddressPrefix"12.0.0.4/30"-VlanId 100

        設定 AzureRmExpressRouteCircuit ExpressRouteCircuit $ckt

    如果您選擇使用 MD5 雜湊，您可以使用下列 Cmdlet

        新增 AzureRmExpressRouteCircuitPeeringConfig-名稱"AzurePublicPeering"-電路 $ckt PeeringType AzurePublicPeering-PeerASN 100-PrimaryPeerAddressPrefix"12.0.0.0/30"-SecondaryPeerAddressPrefix"12.0.0.4/30"-VlanId 100-SharedKey 」 為 A1B2C3D4 」
