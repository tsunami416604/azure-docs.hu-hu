...
ms.locfileid: "46971642"
---
# <a name="expressroute-monitoring-metrics-and-alerts"></a>ExpressRoute-monitorozás, mérőszámok és riasztások
...
Keresse meg a **metrikák**, az ExpressRoute lapon a kapcsolatcsoporthoz, amelyet figyelni szeretne. A **figyelés** is megtekintheti a **metrikák**.
