<properties
   pageTitle="Azure ExpressRoute felhőszolgáltatók számára | Microsoft Azure"
...
# ExpressRoute felhőszolgáltatók (CSP) számára
...
>[AZURE.NOTE] Az ExpressRoute sávszélesség- és kapcsolatkorlátokkal rendelkezik, ami azt jelenti, hogy a nagyméretű/összetett megvalósításokhoz több ExpressRoute-kapcsolatcsoport szükséges ügyfelenként.
...
## Microsoft Azure erőforrás-kezelés
...
### Szolgáltatón keresztüli csatlakozás modell
...
### Szolgáltatóhoz való csatlakozás
...
>[AZURE.NOTE] Az ExpressRoute-hoz az ügyfélnek létre kell hoznia és fenn kell tartania egy ExpressRoute-kapcsolatcsoportot.  
...
>[AZURE.NOTE] A hálózati sávszélesség igény szerint növelhető a kommunikáció megszakadása nélkül, azonban a csökkentéséhez le kell bontani a kapcsolatcsoportot, és újra kell építeni az alacsonyabb hálózati sebességen.  
...
## ExpressRoute útválasztási tartományok
...
>[AZURE.NOTE] A Microsoft és a társviszony-létesítéshez a kapcsolatoknak egy, az ügyfél vagy a CSP által birtokolt nyilvános IP-címen keresztül kell megvalósulniuk, és az összes meghatározott szabálynak meg kell felelniük. További információkért lásd az [ExpressRoute-előfeltételek](expressroute-prerequisites.md) lapot.  
