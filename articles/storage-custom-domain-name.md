<properties urlDisplayName="custom dns storage" pageTitle="Configure a domain name for blob data in a storage account | Microsoft Azure" metaKeywords="" description="Learn how to configure a custom domain for accessing blob data in an Azure storage account." metaCanonical="" services="storage" documentationCenter="" title="Configure a custom domain name for blob data in a storage account" solutions="" authors="tamram" manager="adinah" editor="cgronlun" />
...
<b>Note</b> 
    <p>The procedures in this task apply to Azure storage accounts. For cloud services, see <a href = "/en-us/develop/net/common-tasks/custom-dns/">Configuring a Custom Domain Name for an Azure Cloud Service</a>; for Websites, see <a href="/en-us/develop/net/common-tasks/custom-dns-web-site/">Configuring a Custom Domain Name for an Azure Website</a>.</p> 
</div>
...
| Storage account   | **Default URL:** http://mystorageaccount.blob.core.windows.net                    
                      **Custom domain URL:** http://www.contoso.com                                     |
| Blob              | **Default URL:** http://mystorageaccount.blob.core.windows.net/mycontainer/myblob 
                     **Custom domain URL:** http://www.contoso.com/mycontainer/myblob                   |
| Root container    | **Default URL:** http://mystorageaccount.blob.core.windows.net/myblob             
                     or                                                                                 
                      http://mystorageaccount.blob.core.windows.net/$root/myblob                        
                      **Custom domain URL:** http://www.contoso.com/myblob                              
                     or                                                                                 
                      http://www.contoso.com/$root/myblob                                               |

This task will show you how to:

-   [Register a custom domain for your storage account][Register a custom domain for your storage account]
-   [Register a custom domain for your storage account using the intermediary asverify subdomain][Register a custom domain for your storage account using the intermediary asverify subdomain]
-   <a name="#verify-subdomain">Verify that the custom domain references your Blob service endpoint</a>

## <a name="register-domain"></a>Register a custom domain for your storage account
...
If your custom domain is currently supporting an application that cannot have any downtime, then use the procedure outlined in [Register a custom domain for your storage account using the intermediary asverify subdomain][Register a custom domain for your storage account using the intermediary asverify subdomain].
...
## <a name="register-asverify"></a>Register a custom domain for your storage account using the intermediary asverify subdomain
...
-   [How to Map CDN Content to a Custom Domain][How to Map CDN Content to a Custom Domain]
  ...
  [Configuring a Custom Domain Name for an Azure Cloud Service]: /en-us/develop/net/common-tasks/custom-dns/
  [Configuring a Custom Domain Name for an Azure Website]: /en-us/develop/net/common-tasks/custom-dns-web-site/
  [Register a custom domain for your storage account]: #register-domain
  [Register a custom domain for your storage account using the intermediary asverify subdomain]: #register-asverify
