...
| --- | --- |
| GET |https://{armendpoint}/subscriptions/{subId}/providers/Microsoft.Commerce/usageAggregates?reportedStartTime={reportedStartTime}&reportedEndTime={reportedEndTime}&aggregationGranularity={granularity}&api-version= 2015 06-01. dátumú előnézeti & continuationToken = {jogkivonat-value} |
...
| *API-verzió* |Az ilyen kérést használt protokoll verziója. 2015 06-01. dátumú előnézeti kell használnia. |
...
/Subscriptions/sub1/providers/Microsoft.Commerce/UsageAggregates?reportedStartTime=reportedStartTime=2014-05-01T00%3a00%3a00%2b00%3a00 és reportedEndTime LEKÉRÉSE = 2015-06-01T00 % 3a00 % 3a00 % 2b00 % 3a00 & aggregationGranularity napi = & api-version = 1.0
...
| *előfizetés-azonosító* |A felhasználó Azure előfizetés-azonosító |
