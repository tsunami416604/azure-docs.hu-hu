...
<!-- TBD | IS, ASDK -->  
- **Az Azure Stack Capacity Planner használhatóságuk**. Az Azure Stack [Capacity Planner](https://aka.ms/azstackcapacityplanner) kínál egy egyszerűsített élmény bevitelével S2D gyorsítótár és az S2D-kapacitás SKU-k megoldás meghatározásakor. Az 1000 virtuális gép korlátja el lett távolítva.
