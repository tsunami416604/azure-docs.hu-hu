...
Jelenleg használat esetén jelentést kap a hálózati, tárolási és számítási erőforrás-szolgáltatók.

| **Erőforrás-szolgáltató** | **A mérési azonosítója** | **A mérési neve** | **Egység** | **További információ** |
| --- | --- | --- | --- | --- | 
| **Hálózat** |F271A8A388C44D93956A063E1D2FA80B |Statikus IP-cím használata |IP-címek|Count IP-címről használt | 
| |9E2739BA86744796B465F64674B822BA |Dinamikus IP-cím használata |IP-címek|Count IP-címről használt | 
| **Tárolás** |B4438D5D-453B-4EE1-B42A-DC72E377F1E4 |TableCapacity |GB\*üzemideje (óra) |Tábla által felhasznált teljes kapacitás |
...
| | B9FF3CD0-28AA-4762-84BB-FF8FBAEA6A90 |TableTransactions |10 000 db kérelmek száma |TABLE szolgáltatási kérelmek (10 000 db) |
| | 50A1AEAF-8ECA-48A0-8973-A5B3077FEE0D |TableDataTransIn |Érkező adatok GB-ban |TABLE szolgáltatás adatok érkező GB-ban |
| | 1B8C1DEC-EE42-414B-AA36-6229CF199370 |TableDataTransOut |Outgress GB-ban |TABLE szolgáltatás adatforgalommal GB-ban |
| | 43DAF82B-4618-444A-B994-40C23F7CD438 |BlobTransactions |Kérések száma 10 000 db |A BLOB szolgáltatási kérelmek (10 000 db) |
| | 9764F92C-E44A-498E-8DC1-AAD66587A810 |BlobDataTransIn |Érkező adatok GB-ban |BLOB szolgáltatás adatok érkező GB-ban |
| | 3023FEF4-ECA5-4D7B-87B3-CFBC061931E8 |BlobDataTransOut |Outgress GB-ban |BLOB szolgáltatás adatforgalommal GB-ban |
| | EB43DD12-1AA6-4C4B-872C-FAF15A6785EA |QueueTransactions |Kérések száma 10 000 db |Várólista szolgáltatási kérelmek (10 000 db) |
| | E518E809-E369-4A45-9274-2017B29FFF25 |QueueDataTransIn |Érkező adatok GB-ban |Várólista szolgáltatás adatok érkező GB-ban | 
| | DD0A10BA-A5D6-4CB6-88C0-7D585CEF9FC2 |QueueDataTransOut |Outgress GB-ban |Várólista szolgáltatás adatforgalommal GB-ban |
| **Számítás** |FAB6EB84-500B-4A09-A8CA-7358F8BBAEA5 |Alapszintű VM-méret órák |Virtuális core perc | Vcores számú alkalommal fordult elő a virtuális gép futott perc |
| |9CD92D4C-BAFD-4492-B278-BEDC2DE8232A |Windows virtuális gép mérete üzemideje (óra) |Virtuális core perc | Vcores számú alkalommal fordult elő a virtuális gép futott perc |
| |6DAB500F-A4FD-49C4-956D-229BB9C8C793 |Virtuális gép mérete üzemideje (óra) |Virtuális gép üzemideje (óra) |Kiinduló és a Windows virtuális gép rögzíti. Nem igazítja a vcores |
| **Key Vault** | EBF13B9F-B3EA-46FE-BF54-396E93D48AB4 |Key Vault tranzakciók | 10000s kérelmek száma| Kulcstároló adatainak vezérlősík által fogadott REST API-kérelmek száma |
...
Jelenleg, lekérheti *csak által jelentett*.
...
| 400 vagy hibás kérés |*SubscriberIdIsNotDirectTenant* |A szolgáltató API-hívásának egy előfizetés-azonosító, amely nem egy érvényes bérlő a hívó használt. |
