...
1. [Jelentkezzen be a](azure-stack-connect-azure-stack.md) , a [Azure Stack felhasználói portál](https://portal.local.azurestack.external) válassza **előfizetés beszerzése**.
