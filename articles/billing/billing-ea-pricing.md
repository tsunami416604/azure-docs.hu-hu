---
title: A vállalat az Azure díjszabásának megtekintése |} A Microsoft Docs
description: Útmutató megtekintése és letöltése a díjszabás vagy végezzen költségbecslést a nagyvállalati szerződés díjszabása.
services: ''
documentationcenter: ''
author: adpick
manager: dougeby
...
ms.locfileid: "54904233"
---
# <a name="view-your-organizations-azure-enterprise-agreement-pricing"></a>A szervezet Azure nagyvállalati szerződéssel díjszabásának megtekintése 

Az Azure-ügyfelek az egy nagyvállalati szerződés (EA) előfordulhat, hogy megtekintheti, és töltse le a nagyvállalati szerződés díjszabása az Azure Portalról. A szervezet nagyvállalati szerződés díjszabása alapján az Azure díjkalkulátorát használatával is használhatja.
...
## <a name="estimate-costs-with-ea-pricing"></a>Költségbecslés a nagyvállalati szerződés díjszabása
...
- [Számlázással kapcsolatos Azure-nagyvállalati szerződéssel rendelkező ügyfelek számára](billing-understand-your-bill-ea.md)
