...
1. Keressen rá a **Költségkezelés + számlázás** kifejezésre.
    ...
    ![Képernyőkép a keresőmezőről a költségkezelés + számlázás keresőkifejezéssel ](./media/billing-payment-features-azure-portal/search-bar.png)

1. A **Saját előfizetések** listából válassza ki azt az előfizetést, amelyhez hozzá szeretné adni a hitelkártyát.
    ![Képernyőkép a saját előfizetések rácsának áttekintésével](./media/billing-payment-features-azure-portal/cost-management-billing-overview-x.png)

1. Válassza a **Fizetési módok** elemet.

    ![Képernyőkép kiválasztott fizetési módok panellel.](./media/billing-payment-features-azure-portal/subscription-payment-methods-blade.png)
...
1. Hitelkártya hozzáadásához válassza a „+” gombot a bal felső sarokban.
    ...
    ![Képernyőkép a pluszjelről](./media/billing-payment-features-azure-portal/subscription-payment-methods-plus.png)

1. Adja meg a hitelkártya adatait a jobb oldali űrlapon.

    ![A hitelkártya hozzáadása űrlapot megjelenítő képernyőkép.](./media/billing-payment-features-azure-portal/subscription-add-payment-method-x.png)
...
1. Ha ezt a kártyát szeretné aktív fizetési módként beállítani, jelölje be az **Ez legyen az aktív fizetési mód** beállítás melletti jelölőnégyzetet az űrlap felett. Ez a kártya lesz innentől az aktív fizetési eszköz az összes olyan előfizetés esetében, amely a kiválasztott előfizetéssel azonos kártyát használ.
    ...
    ![Képernyőkép a kártyát aktív fizetési móddá tevő jelölőnégyzettel.](./media/billing-payment-features-azure-portal/subscription-make-active-payment-method-x.png)
...
1. Jelölje be az aktív fizetési módként beállítani kívánt kártya melletti jelölőnégyzetet.
    ...
    ![Képernyőkép a hitelkártya mellett bejelölt jelölőnégyzettel](./media/billing-payment-features-azure-portal/subscription-checked-payment-method-x.png)

1. Kattintson a parancssáv **Beállítás aktívként** elemére.

    ![Képernyőkép a Beállítás aktívként gombról](./media/billing-payment-features-azure-portal/subscription-checked-payment-method-set-active.png)
...
![A kiválasztott hitelkártyát megjelenítő képernyőkép](./media/billing-payment-features-azure-portal/subscription-edit-payment-method-x.png)
...
1. A parancssávon kattintson a **Törlés** gombra.
    ...
    ![Képernyőkép a törlés gombról](./media/billing-payment-features-azure-portal/subscription-checked-payment-method-delete.png)
...
1. Válassza a **Fizetés számla alapján** lehetőséget a parancssorban.
    ...
    ![Képernyőkép kiválasztott fizetési módok panellel.](./media/billing-payment-features-azure-portal/subscription-payment-methods-pay-by-invoice.png)

1. Adja meg a számlás fizetési mód címét.
1. Kattintson a **Tovább** gombra.

Ha szeretne jogosulttá válni a számlás fizetésre, tekintse meg [a számla alapján történő fizetést ismertető témakört](billing-how-to-pay-by-invoice.md).
...
1. A **Saját előfizetések** listában válassza ki a Visual Studio Enterprise-előfizetését.
    ...
    ![Képernyőkép a saját előfizetések rácsának áttekintésével](./media/billing-payment-features-azure-portal/cost-management-overview-msdn-x.png)

1. Az előfizetés áttekintésében kattintson a narancssárga szalagcímre a költségkeret eltávolításához.
    
    ![Képernyőkép a költségkeret eltávolítása szalagcímről](./media/billing-payment-features-azure-portal/msdn-remove-spending-limit-banner-x.png)
...
1. Válassza ki, hogy határozatlan időre vagy csak az aktuális számlázási időszakra szeretné-e eltávolítani a költségkeretet.
   ...
   ![Képernyőkép a költségkeret eltávolítása panelről](./media/billing-payment-features-azure-portal/remove-spending-limit-blade-x.png)
...
1. A **Saját előfizetések** listában válassza ki Azure in Open-előfizetését.
    ...
    ![Képernyőkép a saját előfizetések rácsának áttekintésével](./media/billing-payment-features-azure-portal/cost-management-overview-aio-x.png)

1. Válassza a **Kreditelőzmények** lehetőséget.
    
    ![A kreditelőzményeket bemutató képernyőkép](./media/billing-payment-features-azure-portal/aio-credit-history-blade.png)

1. További kreditek hozzáadásához válassza a „+” gombot a bal felső sarokban.

    ![A kreditek hozzáadása gombot megjelenítő képernyőkép](./media/billing-payment-features-azure-portal/aio-credit-history-plus.png)
...
1. Válassza ki a fizetési mód típusát a legördülő menüből. Hozzáadhat egy termékkulcsot, vagy hitelkártyával krediteket vásárolhat.
    ...
    ![Képernyőkép a kreditek hozzáadása panel fizetési mód legördülő menüjéről](./media/billing-payment-features-azure-portal/add-credits-select-payment-method.png)
...
- További információ a [váratlan költségek elemzéséről és megelőzéséről az Azure Portalon](billing-getting-started.md)
