---
title: Ingyenes szolgáltatások ingyenes Azure-fiók létrehozása
...
Javasoljuk, használjon a [ingyenes szolgáltatásoldal](https://go.microsoft.com/fwlink/?linkid=859151) új szolgáltatások létrehozását. Vagy bejelentkezhet a a [az Azure portal](https://portal.azure.com)válassza **minden szolgáltatás** a bal oldalon, és keresse meg a **ingyenes szolgáltatások**.
...
## <a name="create-multiple-service-instances-in-allowed-limits"></a>Az engedélyezett határértékeken több szolgáltatáspéldány létrehozása
...
- Ismerje meg, hogyan [elkerülése az ingyenes Azure-fiók számolják](billing-avoid-charges-free-account.md).
