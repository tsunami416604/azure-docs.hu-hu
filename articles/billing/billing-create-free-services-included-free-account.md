...
Javasoljuk, használjon a [ingyenes szolgáltatásoldal](https://go.microsoft.com/fwlink/?linkid=859151) új szolgáltatások létrehozását. Vagy bejelentkezhet a a [az Azure portal](https://portal.azure.com)válassza **minden szolgáltatás** a bal oldalon, majd a keresési **ingyenes szolgáltatások**. 
