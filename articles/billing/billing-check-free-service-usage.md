...
2.  Keressen rá az **Előfizetések** kifejezésre.
    ...
    ![Képernyőkép az „előfizetések” kifejezés a portálon történő kereséséről](./media/billing-check-usage-of-free-services/billing-search-subscriptions.png)
