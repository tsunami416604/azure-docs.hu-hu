...
1. Navigáljon az [Azure Portalra](https://portal.azure.com) egy támogatási kérelem küldéséhez. Keresse meg és válassza ki a **Súgó és támogatás** elemet.
    ...
    ![Segítség és támogatás keresése, Microsoft Azure Portal](./media/billing-how-to-pay-by-invoice/search-for-help-and-support.png)

2. Válassza az **Új támogatási kérelem** lehetőséget.

    ![Új támogatási kérés hivatkozás, Súgó és támogatás képernyő, Microsoft Azure Portal](./media/billing-how-to-pay-by-invoice/help-and-support.png)
...
1. Nyissa meg az [Azure Portalt](https://portal.azure.com), és jelentkezzen be fiókadminisztrátorként. Keresse meg és válassza ki a **Költségkezelés + számlázás** lehetőséget.
    ...
    ![Keresse meg a Költségkezelés és számlázás elemet a Microsoft Azure Portalon.](./media/billing-how-to-pay-by-invoice/search.png)
...
1. Válassza a **Fizetés számlával** gombot a parancssávon.
    ...
    ![Fizetés számlával gomb, Fizetési módok, Microsoft Azure Portal](./media/billing-how-to-pay-by-invoice/pay-by-invoice.png)
...
1. A menüben válassza ki a **Számlázási profilok** elemet.
    ...
    ![Számlázási profilok menüpont, Költségkezelés és számlázás, Microsoft Azure Portal](./media/billing-how-to-pay-by-invoice/billing-profile.png)

1. Válasszon ki egy számlázási profilt.
1. A **Számlázási profilok** menüben válassza ki a **Fizetési módok** elemet.

   ![Fizetési módok menüpont, Számlázási profilok, Költségkezelés, Microsoft Azure Portal](./media/billing-how-to-pay-by-invoice/billing-profile-payment-methods.png)

1. Kattintson arra a szalagra, amely szerint jogosult a csekkes/átutalások fizetési mód használatára.

    ![A csekkes/átutalásos fizetési mód közötti váltásra szolgáló szalag, Fizetési módok, Microsoft Azure Portal](./media/billing-how-to-pay-by-invoice/customer-led-switch-to-invoice.png)
