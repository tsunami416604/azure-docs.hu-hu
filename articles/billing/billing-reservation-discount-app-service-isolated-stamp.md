...
- Ha többet szeretne tudni a lefoglalt App Service izolálttranzakció-kapacitás takarékossági céllal történő előzetes megvásárlásáról, tekintse meg az [az Azure App Service izolált tranzakciódíjért lefoglalt kapacitással történő előzetes fizetést](billing-prepay-app-service-isolated-stamp.md) ismertető szakaszt.
