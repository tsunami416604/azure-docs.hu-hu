...
## <a name="you-used-some-services-that-arent-free"></a>Nem ingyenes szolgáltatásokat használt

Miután frissítette a fiókját, az olyan szolgáltatások használatáért, amelyek nem tartoznak az ingyenes Azure-fiókhoz mellékelt ingyenes szolgáltatások közé, használatalapú díjszabás szerint kell fizetnie. Az ingyenes fiókhoz mellékelt szolgáltatások megismeréséhez tekintse meg [az ingyenes Azure-fiókkal kapcsolatos gyakori kérdéseket](https://azure.microsoft.com/free/free-account-faq/). A szolgáltatások használati adatait az Azure Portalon ellenőrizheti. További információért tekintse meg [a költséglebontás és a keretfelhasználási ráta a portálon történő rendszeres ellenőrzését](billing-getting-started.md#costs).
...
- [Ingyenes Azure-fiók frissítése](billing-upgrade-azure-subscription.md)
