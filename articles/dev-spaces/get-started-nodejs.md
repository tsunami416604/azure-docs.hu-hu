...
1. Keresse meg a `./public/index.html` fájlt, és szerkessze a HTML-kódot. For example, change the page's background color to a shade of blue [on line 15](https://github.com/Azure/dev-spaces/blob/master/samples/nodejs/getting-started/webfrontend/public/index.html#L15):
