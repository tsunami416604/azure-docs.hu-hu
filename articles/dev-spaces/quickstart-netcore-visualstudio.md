...
Ez a folyamat a szolgáltatáshoz való nyilvános hozzáférés letiltotta. A nyilvános hozzáférés engedélyezésére, frissítheti a [bejövő értéket a *values.yaml*][ingress-update].
