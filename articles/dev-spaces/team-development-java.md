---
title: Csapatfejlesztés Java és Visual Studio kód használatával
services: azure-dev-spaces
author: stepro
ms.author: stephpr
ms.date: 08/01/2018
ms.topic: tutorial
description: Ez az oktatóanyag bemutatja, hogyan használhatja az Azure Dev Spaces és a Visual Studio Code segítségével a csapatfejlesztést egy Java-alkalmazásban az Azure Kubernetes szolgáltatásban
...
---
# <a name="team-development-using-java-and-visual-studio-code-with-azure-dev-spaces"></a>Csapatfejlesztés Java és Visual Studio-kód használatával az Azure Dev Spaces segítségével
...
Lépjen a VS-kód `mywebapi` ablakba, és készítsen `String index()` egy `src/main/java/com/ms/sample/mywebapi/Application.java`kódszerkesztést a metóduson, például:
