...
Nyissa meg a VS Code ablakot `mywebapi` , és végezze el a kód `String index()` szerkesztését `src/main/java/com/ms/sample/mywebapi/Application.java`a metódushoz, például:
