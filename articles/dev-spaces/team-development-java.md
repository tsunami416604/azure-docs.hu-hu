---
title: Csoportmunka az Azure fejlesztői Spaces használatával a Java és a VS Code segítségével
...
ms.locfileid: "74132080"
---
# <a name="team-development-with-azure-dev-spaces-using-java-and-vs-code"></a>Csoportmunka az Azure fejlesztői Spaces használatával a Java és a VS Code segítségével
...
Lépjen a VS Code ablakra a `mywebapi`hoz, és végezze el a kód szerkesztését a `src/main/java/com/ms/sample/mywebapi/Application.java``String index()` metódusban, például:
