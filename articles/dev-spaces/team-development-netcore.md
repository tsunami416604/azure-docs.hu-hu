---
title: Csapatfejlesztés a .NET Core és a Visual Studio code használatával
services: azure-dev-spaces
ms.date: 07/09/2018
ms.topic: tutorial
description: Ez az oktatóanyag bemutatja, hogyan használhatja az Azure Dev Spaces és a Visual Studio Code segítségével a csapatfejlesztést egy .NET Core alkalmazáson az Azure Kubernetes szolgáltatásban
...
---
# <a name="team-development-using-net-core-and-visual-studio-code-with-azure-dev-spaces"></a>Csapatfejlesztés a .NET Core és a Visual Studio-kód használatával az Azure Dev Spaces segítségével
...
Lépjen a VS-kód `mywebapi` ablakba, és készítsen `string Get(int id)` egy `Controllers/ValuesController.cs`kódszerkesztést a metóduson, például:
