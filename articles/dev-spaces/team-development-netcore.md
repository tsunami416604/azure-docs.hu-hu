...
Nyissa meg a VS Code ablakot, `mywebapi` és végezze el a kód szerkesztését a `string Get(int id)` metódushoz `Controllers/ValuesController.cs` , például:
