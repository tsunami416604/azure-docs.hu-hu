...
A parancssorban hozza létre az erőforráscsoportot. Válassza valamely jelenleg támogatott régiót (EastUS, CentralUS, WestUS2, WestEurope, CanadaCentral vagy CanadaEast).
