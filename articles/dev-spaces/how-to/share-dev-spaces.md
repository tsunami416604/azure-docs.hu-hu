...
1. Kérje meg a csapattagokat, hogy a fejlesztéshez **válassza ki a fejlesztői helyet** .
   * A **parancssor vagy a vs Code**: megtekintheti a meglévő Azure dev-helyeket, `azds space list`amelyekhez hozzáférése van:. Fejlesztői terület kiválasztása: `azds space select`.
