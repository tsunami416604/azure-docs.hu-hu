...
<tbody>
	...
	<tr>
		...
		<td>Events generated by your code using the .NET <a href="http://msdn.microsoft.com/en-us/library/system.diagnostics.tracing.eventsource(v=vs.110).aspx">EventSource class</a>.</td>            
	</tr>
	<tr>
...
<h3>Step 4: Create your Diagnostics configuration file and install the extension</h3>
...
<h3>Step 5: Install Diagnostics on your Worker Role</h3>
...
<h3>Step 5: Remotely install Diagnostics on your Azure Virtual Machine </h3>
