...
[Telepítsen](container-service-deployment.md) és [kapcsolódjon](./../container-service-connect.md) Azure Container Service által konfigurált fürthöz. Fedezze fel a [Marathon felhasználói felületét](container-service-mesos-marathon-ui.md). [https://www.dynatrace.com/trial/](https://www.dynatrace.com/trial/) A Dynatrace SaaS-fiók beállításához nyissa meg a következőt:.  
...
1. A DC/OS felhasználói felületét `http://localhost:80/`a használatával érheti el. Egyszer a DC/OS felhasználói felületén navigáljon az **univerzum** lapra, és keresse meg a **Dynatrace**.
