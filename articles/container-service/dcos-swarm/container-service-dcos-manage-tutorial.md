...
Telepítse a DC/OS parancssori felületet az [az acs dcos install-cli](/cli/azure/acs/dcos#az-acs-dcos-install-cli) paranccsal. Az Azure Cloud Shell használata esetén a DC/OS parancssori felület már telepítve van. Ha az Azure CLI felületet macOS vagy Linux rendszeren futtatja, előfordulhat, hogy sudo módban kell futtatnia a parancsot.
...
Az előzőekben egy alkalmazást többpéldányosra méreteztünk. A DC/OS infrastruktúra is méretezhető attól függően, hogy több vagy kevesebb számítási kapacitásra van-e szükség. Ez a művelet az [az acs scale](/cli/azure/acs#az-acs-scale) paranccsal hajtható végre. 
