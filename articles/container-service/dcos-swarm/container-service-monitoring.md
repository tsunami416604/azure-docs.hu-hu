...
[Helyezzen üzembe](container-service-deployment.md) és [csatlakoztasson](../container-service-connect.md) egy, az Azure Container Service által konfigurált fürtöt. Fedezze fel a [Marathon felhasználói felületét](container-service-mesos-marathon-ui.md). A [https://datadoghq.com](https://datadoghq.com) datadoggal-fiók beállításához nyissa meg a következőt:. 
...
A DC/OS felhasználói felületét a használatával érheti el `http://localhost:80/` . Egyszer a DC/OS felhasználói felületen navigáljon a "Universe" elemre, amely a bal alsó sarokban található, majd keressen rá a "Datadoggal" kifejezésre, és kattintson a "telepítés" gombra.
