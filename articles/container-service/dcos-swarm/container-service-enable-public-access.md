...
5. Töltse ki a mintavételi űrlapot, és kattintson **az OK**gombra.
   ...
   | Elérési út |(HTTP-módban) A mintavételhez a relatív webhely elérési útja. A HTTPS nem támogatott. |
...
5. Töltse ki a tűzfalszabály a nyilvános port engedélyezéséhez, majd kattintson **az OK**gombra.
   ...
   | Protokoll |A forgalom korlátozása **TCP** vagy **UDP**alapján. Ha **nem** szeretne korlátozást megadni, használja a következőt:. |
