...
Alapértelmezés szerint a **Marathon** minden új alkalmazást üzembe helyez a *privát* ügynök csomópontjain. Az alkalmazás létrehozása során explicit módon telepítenie kell az alkalmazást a *nyilvános* csomópontokra. Válassza a **választható** fület, és adja meg a **Slave_public** az **elfogadható erőforrás-szerepkörök** értékhez. Ezt a folyamatot a [here](container-service-mesos-marathon-ui.md#deploy-a-docker-formatted-container) [DC/os](https://docs.mesosphere.com/1.7/administration/installing/oss/custom/create-public-agent/) dokumentációjában találja.
