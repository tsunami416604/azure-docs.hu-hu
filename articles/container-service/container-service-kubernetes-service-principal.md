...
Ha az [`az acs create`](https://docs.microsoft.com/en-us/cli/azure/acs#create) paranccsal hozza létre a Kubernetes-fürtöt, lehetősége van automatikusan létrehozni egy egyszerű szolgáltatást.
