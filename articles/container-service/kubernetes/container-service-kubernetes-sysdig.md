...
Ha nincs telepítve az `az` eszköz, [itt](https://github.com/azure/azure-cli#installation)talál útmutatást.
...
A tárolók figyeléséhez a Sysdig egy Kubernetes `DaemonSet`-t használó minden gépen futtat egy folyamatot.
