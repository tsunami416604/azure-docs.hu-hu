...
Azt is feltételezi, hogy az Azure CLI és az `kubectl` eszközök telepítve vannak.
...
A tárolók futtatása mellett a Kubernetes felhasználói felülete létrehoz egy külsőt, amely kiépíti `Service` a terheléselosztó számára a fürtben lévő tárolók felé irányuló forgalmat.
...
Szerkessze a `spec.replicas` kívánt mezőt `2` , majd kattintson a **frissítés**gombra.
