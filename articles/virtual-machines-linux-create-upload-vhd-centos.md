...
-   [Prepare a CentOS 6.x Virtual Machine for Azure][Prepare a CentOS 6.x Virtual Machine for Azure]
-   [Prepare a CentOS 7.0+ Virtual Machine for Azure][Prepare a CentOS 7.0+ Virtual Machine for Azure]

## Prerequisites

This article assumes that you have already installed a CentOS (or similar derivative) Linux operating system to a virtual hard disk. Multiple tools exist to create .vhd files, for example a virtualization solution such as Hyper-V. For instructions, see [Install the Hyper-V Role and Configure a Virtual Machine][Install the Hyper-V Role and Configure a Virtual Machine].
...
8.  **CentOS 6.3 Only**: Install the drivers for the Linux Integration Services
    ...
    **Important: The step is only valid for CentOS 6.3 and earlier.** In CentOS 6.4+ the Linux Integration Services are *already available in the kernel*.
    ...
    a) Obtain the .iso file that contains the drivers for the Linux Integration Services from the [Microsoft Download Center][Microsoft Download Center].

    b) In Hyper-V Manager, in the **Actions** pane, click **Settings**.

    ![Open Hyper-V settings][Open Hyper-V settings]

    c) In the **Hardware** pane, click **IDE Controller 1**.

    ![Add DVD drive with install media][Add DVD drive with install media]
...
16. Click **Action -\> Shut Down** in Hyper-V Manager. Your Linux VHD is now ready to be uploaded to Azure.
  ...
  [Microsoft Download Center]: http://www.microsoft.com/en-us/download/details.aspx?id=41554
