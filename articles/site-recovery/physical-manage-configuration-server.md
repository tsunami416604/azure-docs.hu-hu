...
1. A tárolóban nyissa meg **site Recovery infrastruktúra** > **konfigurációs kiszolgáló beállítást**, majd kattintson a szükséges konfigurációs kiszolgálóra.
...
Tekintse át az oktatóanyagokat a [fizikai kiszolgálók](tutorial-physical-to-azure.md) Azure-ba való vész-helyreállításának beállításához.
