...
A Site Recovery-infrastruktúra beállítása előtt a környezettel a következő tényezők mérhetők: kompatibilis virtuális gépek, a napi adatváltozási arány, a elérni kívánt RPO szükséges hálózati sávszélesség, a Site Recovery száma a szükséges összetevők és a kezdeti replikálás befejezéséhez szükséges idő. A szükséges információk összegyűjtéséhez hajtsa végre a következő lépéseket:
...
1. Nyissa meg a **Recovery Services** -tárolót > **site Recovery infrastruktúra** > **konfigurációs kiszolgálók**lehetőséget.
