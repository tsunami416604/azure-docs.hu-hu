---
title: "Szeretné áttekinteni a Hyper-V Azure-ba történő (System Center VMM nélküli) replikációjának architektúráját az Azure Site Recoveryvel? | Microsoft Docs"
...
# 1. lépés: Az architektúra áttekintése a Hyper-V Azure-ba történő replikációjához
