...
## <a name="excample-1-exclude-the-sql-server-tempdb-disk"></a>Adatbázist tartalmazó lemezének 1: SQL Server tempdb-adatbázist tartalmazó lemezének kizárása
