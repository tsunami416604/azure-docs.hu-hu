...
Mielőtt megkezdi a munkát, vegye figyelembe a következőket:
...
1. Ha egy Hyper-V virtuális gép [replikálásának engedélyezése](site-recovery-hyper-v-site-to-azure.md) után szeretné kizárni a lemezeket, a replikálni kívánt virtuális gépek kiválasztása után a **replikálás engedélyezése** > **Tulajdonságok** > a **tulajdonságok konfigurálása** lapon tekintse át az oszlop **replikálásához szükséges lemezeket** . Alapértelmezés szerint az összes lemez ki van választva replikálásra.
