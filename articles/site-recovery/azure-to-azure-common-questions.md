...
- A Site Recovery támogatja az 0,1-es Azure Disk Encryption-verziót, amelyhez Azure Active Directory (Azure AD) szükséges sémát kell megadni. A Site Recovery a 1,1-es verziót is támogatja, amely nem igényel Azure AD-t. [További információ az Azure Disk Encryption bővítmény sémák](../virtual-machines/extensions/azure-disk-enc-windows.md#extension-schemata).
...
Igen, a vész-helyreállítási régióban megvásárolhatja a [fenntartott Azure-beli virtuális gépeket](https://azure.microsoft.com/pricing/reserved-vm-instances/) , és site Recovery feladatátvételi műveletek is felhasználhatják őket. További konfiguráció nélkül van szükség.
