---
title: A helyszíni Hyper-V virtuális gépek vészhelyreállítása az Azure Site Recovery az Azure előkészítése |} A Microsoft Docs
description: Megtudhatja, hogyan készítheti elő az Azure a helyszíni Hyper-V virtuális gépek Azure Site Recovery használata vész-helyreállítási.
...
Ez az oktatóanyag az első rész abban a sorozatban, amely bemutatja, hogyan állíthat be vészhelyreállítást helyszíni virtuális gépekhez. Jelentősége, amikor a Hyper-V virtuális gépek védelméről.
...
Ez a cikk bemutatja, hogyan készítse elő az Azure-összetevőket, amikor a helyszíni virtuális gépeket (Hyper-V) replikálhat az Azure-bA. Eben az oktatóanyagban az alábbiakkal fog megismerkedni:
