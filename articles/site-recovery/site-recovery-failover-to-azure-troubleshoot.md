...
1. Nyissa meg a **virtuális gép** > **hálózatkezelés**csomópontot, majd kattintson a szükséges hálózati adapter nevére.  ![hálózati adapter](media/site-recovery-failover-to-azure-troubleshoot/network-interface.PNG)
...
3. A nyilvános IP-cím engedélyezéséhez kattintson az **Engedélyezés**gombra. IP-](media/site-recovery-failover-to-azure-troubleshoot/Enable-Public-IP.png) engedélyezése ![
4. Kattintson a **kötelező beállítások konfigurálása** > **új létrehozása**lehetőségre. ![új](media/site-recovery-failover-to-azure-troubleshoot/Create-New-Public-IP.png) létrehozása
...
A vitual-gépek ismételt védelemmel kapcsolatos további információkért lásd: [a gépek ismételt védetté és visszavétele a helyszíni helyre az Azure-ba történő feladatátvétel után](vmware-azure-reprotect.md).
...
## <a name="linux-master-target-registration-with-cs-fails-with-an-ssl-error-35"></a>A Linux Master Target regisztrációja a CS hibával meghiúsul, SSL-hiba 35 
