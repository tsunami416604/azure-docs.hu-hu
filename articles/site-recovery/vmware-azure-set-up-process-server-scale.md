...
2. Nyissa meg **site Recovery infrastruktúrát** > a **VMware és a fizikai gépeket** > **konfigurációs kiszolgálókat** (a VMware & fizikai gépeknél).
...
4. A **folyamat** -kiszolgáló hozzáadása >  válassza ki, **hogy hová szeretné telepíteni a folyamat-kiszolgálót**, válassza a **helyszíni kibővíthető folyamat kiszolgálójának központi telepítése**lehetőséget.
