...
Azure Disk Encryption (ADE) Windows operációs rendszerhez | Az [Azure ad](https://aka.ms/ade-aad-app) -alkalmazással titkosításra engedélyezett virtuális gépek támogatottak |
