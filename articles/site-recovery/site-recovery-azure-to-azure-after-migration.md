...
A replikáció beállítása és áttelepítése a helyszíni Hyper-V, VMware és fizikai munkaterhelések az Azure-ba, kövesse a [át Azure IaaS virtuális gépeket az Azure Site Recovery Azure-régiók közötti](site-recovery-migrate-to-azure.md) cikk. 
