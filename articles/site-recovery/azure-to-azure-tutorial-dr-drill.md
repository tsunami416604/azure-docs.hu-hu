...
- A feladatátvételi teszt futtatása előtt javasoljuk, hogy ellenőrizze a virtuális gép tulajdonságait, és győződjön meg róla, hogy az a vész-helyreállításra van konfigurálva. A replikálási és feladatátvételi tulajdonságok megtekintéséhez lépjen a virtuális gép **műveletei** > vész- **helyreállítási** > **tulajdonságaira** .
...
1. A feladatátvételi teszt során létrehozott virtuális gépek törléséhez válassza a **feladatátvételi teszt** törlése elemet a replikált elemen vagy a helyreállítási terven. A **Jegyzetek** területen jegyezheti fel és mentheti a feladatátvételi teszttel kapcsolatos megfigyeléseket.
