...
Ez az eljárás ismerteti egy helyreállítási terv feladatátvételi teszt futtatása. 
...
Ha csatlakozhat az Azure virtuális gépek a feladatátvételt követően RDP segítségével szeretne, végezze el a követelmények a táblázat foglalja össze.
