...
Virtuális hálózati szolgáltatásvégpontok<br/><br/> (Az azure storage tűzfalak és Vnetek) | Nem
...
Vendég-kiszolgáló EFI/UEFI| Részleges (áttelepítés Azure a Windows Server 2012 és újabb verziók VMware virtuális gépek csak.) </br></br> ** Megjegyzés: a tábla végén tekintse meg.
...
Vendég-kiszolgáló > 1 TB méretű lemez | Igen<br/><br/>Legfeljebb 4095 GB-ig
...
> [!NOTE]
> ** UEFI ** rendszerindító VMware virtuális gépek Windows Server 2012 rendszert futtató, vagy később telepíthetők át az Azure-bA. Következő korlátozások vonatkoznak.
...
Virtuális hálózati szolgáltatásvégpontok<br/><br/> Az Azure storage tűzfalak és a Vnetek konfigurálva a célként megadott tárolási/gyorsítótár storage-fiók (használt replikációs adatokat tároló) | Nem
...
**Adatlemez virtuális merevlemezének mérete** | Legfeljebb 4095 GB-ig | Előfeltételek ellenőrzése sikertelen, ha nem támogatott
...
**Virtuális gép neve** | 1 – 63 karakter.<br/><br/> Csak betűket, számokat és kötőjelet tartalmazhat.<br/><br/> A számítógépnév kell kezdődnie, és betűvel vagy számmal végződhet. | Frissítse az értéket a virtuálisgép-tulajdonságokat a Site Recovery szolgáltatásban.
