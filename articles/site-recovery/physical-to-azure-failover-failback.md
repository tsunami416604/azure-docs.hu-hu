...
1. A tárolóban > **beállítások** > **replikált elemek**területen kattintson a jobb gombbal arra a gépre, amelyre a feladatátvételt hajtotta **>.**
...
1. A tároló > **beállítások** >**replikált elemek**területen válassza ki a sikertelenül visszaadott virtuális gépeket, és kattintson az **ismételt védelem**elemre.
