...
Az oktatóanyag bemutatja, hogyan telepítheti át az Amazon Web Services-beli (AWS) virtuális gépeket (VM-eket) Azure-beli virtuális gépekre a Site Recovery használatával. Az Azure-ba, a rendszer kezeli, mintha fizikai, VMsare EC2 példányok áttelepítésekor a helyszíni számítógépek. Eben az oktatóanyagban az alábbiakkal fog megismerkedni:
...
1. Az [Azure Portal](https://portal.azure.com) menüjében kattintson az **Erőforrás létrehozása** -> **Tárolás** -> **Tárfiók** elemre.
...
1. Az a [Azure-portálon](https://portal.azure.com), kattintson a **hozzon létre egy erőforrást** > **hálózati** >
    **virtuális hálózat**
