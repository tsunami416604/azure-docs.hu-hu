...
**Adatlemezek száma** | 16 vagy kevesebb  | Előfeltételek ellenőrzése sikertelen lesz, ha nem támogatott.
...
**Merevlemez formátuma** | VHD <br/><br/> VHDX | A Site Recovery automatikusan átalakítja VHDX virtuális merevlemezen történő feladatátadást követően Azure-bA. Ha nem sikerül vissza a helyszíni virtuális gépek továbbra is a VHDX formátum.
