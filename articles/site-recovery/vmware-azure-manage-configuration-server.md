...
## <a name="upgrade-configuration-serverprocess-server-from-the-command-line"></a>Frissítse a konfigurációs kiszolgáló vagy folyamatkiszolgáló a parancssorból
