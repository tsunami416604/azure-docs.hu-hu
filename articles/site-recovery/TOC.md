...
# Első lépések
## [Azure-beli virtuális gépek replikálása (előzetes verzió)](azure-to-azure-walkthrough-overview.md)
### [1. lépés: Az architektúra áttekintése](azure-to-azure-walkthrough-architecture.md)
### [2. lépés: Előkészületek](azure-to-azure-walkthrough-prerequisites.md)
### [3. lépés: Hálózatkezelés megtervezése](azure-to-azure-walkthrough-network.md)
### [4. lépés: Tároló létrehozása](azure-to-azure-walkthrough-vault.md)
### [5. lépés: A replikáció engedélyezése](azure-to-azure-walkthrough-enable-replication.md)
### [6. lépés: Feladatátvételi teszt futtatása](azure-to-azure-walkthrough-test-failover.md)
...
## [Hyper-V-alapú virtuális gépek replikálása az Azure-ba (VMM-mel)](vmm-to-azure-walkthrough-overview.md)
### [1. lépés: Az architektúra áttekintése](vmm-to-azure-walkthrough-architecture.md)
...
### [8. lépés: A forrás és a cél beállítása](vmm-to-azure-walkthrough-source-target.md)
...
## [Hyper-V-alapú virtuális gépek replikálása másodlagos helyre (VMM-mel)](vmm-to-vmm-walkthrough-overview.md)
### [1. lépés: Az architektúra áttekintése](vmm-to-vmm-walkthrough-architecture.md)
### [2. lépés: Előfeltételek és korlátozások áttekintése](vmm-to-vmm-walkthrough-prerequisites.md)
### [3. lépés: Hálózatkezelés megtervezése](vmm-to-vmm-walkthrough-network.md)
### [4. lépés: A VMM és a Hyper-V előkészítése](vmm-to-vmm-walkthrough-vmm-hyper-v.md)
### [5. lépés: Tároló létrehozása](vmm-to-vmm-walkthrough-create-vault.md)
### [6. lépés: A forrás és a cél beállítása](vmm-to-vmm-walkthrough-source-target.md)
### [7. lépés: Hálózatleképezés konfigurálása](vmm-to-vmm-walkthrough-network-mapping.md)
### [8. lépés: Replikációs házirend létrehozása](vmm-to-vmm-walkthrough-replication.md)
### [9. lépés: A replikáció engedélyezése](vmm-to-vmm-walkthrough-enable-replication.md)
### [10. lépés: Feladatátvételi teszt futtatása](vmm-to-vmm-walkthrough-test-failover.md)
