...
Ha nem látja az Azure virtuális gép lehet választani, amikor a replikáció engedélyezése, ez elavult Site Recovery konfigurálása miatt maradhat az Azure virtuális gépen. Az elavult konfigurálása sikerült hagyható egy Azure virtuális gépen a következő esetekben:
