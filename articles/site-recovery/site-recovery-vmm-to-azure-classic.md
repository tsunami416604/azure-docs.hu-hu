<properties
    pageTitle="VMM-felhőkben futó Hyper-V virtuális gépek replikálása az Azure-ba | Microsoft Azure"
...
## Hálózatleképezési előfeltételek
...
## 2. lépés: A tároló regisztrációs kulcsának létrehozása
...
## 3. lépés: Az Azure Site Recovery Provider telepítése
...
## 4. lépés: Azure-tárfiók létrehozása
...
## 6. lépés: A felhő védelmi beállításainak konfigurálása
...
## 7. lépés: Hálózatleképezés konfigurálása
...
3. Ellenőrizze a virtuális gép tulajdonságait, és ha szükséges, módosítsa őket.

    ![Virtuális gépek ellenőrzése](./media/site-recovery-vmm-to-azure-classic/vm-properties.png)


4. A virtuális gép **Configure** (Konfiguráció) lapján a következő hálózati tulajdonságok módosíthatók.
...
>[AZURE.NOTE] A statikus IP-címet használó linuxos virtuális gépeket a rendszer nem támogatja.
