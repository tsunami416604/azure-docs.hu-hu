...
2. Tekintse át az erőforráscsoportot, a hálózatot, a tárterületet és a rendelkezésre állási készleteket. Végül kattintson az **OK** gombra. Ha van olyan erőforrás, amely újként van megjelölve, akkor az ismételt védelmi folyamat részeként jönnek létre.
...
4. A rendszer csak a forrásoldali lemez és a céllemez közötti változásokat szinkronizálja. A különbözeteket a lemezek összevetésével számítjuk ki, majd átvittük. Az alábbi ellenőrzéssel megkeresheti az ismételt védelem befejezésének becsült idejét.
5. A szinkronizálás befejeződése után a rendszer megkezdi a különbözeti replikációt, és egy helyreállítási pontot hoz létre a replikációs házirenddel összhangban.
...
4. A szinkronizálás befejeződése után a rendszer megkezdi a különbözeti replikációt, és egy helyreállítási pontot hoz létre a replikációs házirenddel összhangban.
...
1.  Ha a forrásként szolgáló virtuális gép által tárolt adattörlés, sérült vagy nem érhető el valamilyen ok miatt, például egy erőforráscsoport változása/törlése után, akkor a teljes Site Recovery fog történni, mivel a rendszer nem biztosít olyan adatforrást, amelyet a forrásoldali régióban használ.
