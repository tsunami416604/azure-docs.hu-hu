...
Ha NSG-t használ a forrásrégióban NSG-szabályok a storage szolgáltatás címkét hozhat létre. [További információk](azure-to-azure-about-networking.md#outbound-connectivity-for-ip-address-ranges).
