...
A Batch AI segítségével többféle módon taníthat be modelleket nagyobb léptékben. Példa: 
...
* **Adatok** -válasszon egy vagy több tárolási lehetőségek a bemeneti adatokat és a parancsprogramok kezelése és a feladat kimenete: Az Azure Files, az Azure Blob storage, vagy egy felügyelt NFS-kiszolgáló. A Batch AI támogatja az egyéni tárolási megoldásokat, beleértve a nagy teljesítményű párhuzamos fájlrendszereket is. Egyszerű konfigurációs fájlok használatával csatlakoztathatja a tárak fájlrendszereit a fürtcsomópontokhoz és a feladattárolókhoz.
