---
title: Azure CLI-példaszkript – Alacsony prioritású Batch AI-fürt létrehozása | Microsoft Docs
description: Azure CLI-példaszkript – Alacsony prioritású csomópontokból (virtuális gépekből) álló Batch AI-fürt létrehozása és kezelése
services: batch-ai
documentationcenter: ''
author: dlepow
manager: jeconnoc
