...
值 **baseUri** 參數可以包含特定的檔案，但是建構 URI 時，會使用基底的路徑。 例如，傳遞 **http://contoso.com/resources/azuredeploy.json** 為 baseUri 參數將會導致基底 URI **http://contoso.com/resources/**。
