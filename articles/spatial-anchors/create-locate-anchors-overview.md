...
> [C# on Unity (HoloLens, iOS és Android rendszerhez)](how-tos/create-locate-anchors-unity.md)
...
> [!div class="nextstepaction"]
> [C++/NDK az Androidon](how-tos/create-locate-anchors-cpp-ndk.md)
