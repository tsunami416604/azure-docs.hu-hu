...
Keresse meg `case DemoStep::ConfigSession:` és adja hozzá a következő sort, amely a fiók tartományához lett behelyettesítve a korábban: `configuration.AccountKey("MyAccountDomain");` .
