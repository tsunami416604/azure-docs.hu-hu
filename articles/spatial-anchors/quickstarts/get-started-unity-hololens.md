...
- HoloLens eszköz [fejlesztői mód](https://docs.microsoft.com/windows/mixed-reality/using-visual-studio) engedélyezve van.
...
Válassza ki **kapcsoló Platform** módosítása a platform **univerzális Windows Platform**.
