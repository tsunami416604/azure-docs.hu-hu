...
- Szüksége van egy Windows rendszerű számítógépre, amelyen a <a href="https://unity3d.com/get-unity/download" target="_blank">2019,1 vagy a 2019,2</a> vagy újabb, illetve a <a href="https://www.visualstudio.com/downloads/" target="_blank">Visual Studio 2019</a> vagy újabb egység van telepítve. A Visual Studio-telepítésnek tartalmaznia kell a **univerzális Windows-platform fejlesztési** munkaterhelést és a **Windows 10 SDK (10.0.18362.0 vagy újabb)** összetevőt. <a href="https://git-scm.com/download/win" target="_blank">A git for Windows és a</a> <a href="https://git-lfs.github.com/">git LFS</a>is telepítenie kell.
