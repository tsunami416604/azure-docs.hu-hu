---
title: Horgonyok létrehozása és megkeresése az eszközön lévő szenzorok használatával a Javaban | Microsoft Docs
description: Részletesen ismertetjük, hogyan hozhatók létre és találhatók a-eszközök a Java-on keresztül eszköz-érzékelőkkel.
author: bucurb
manager: dacoghl
...
ms.locfileid: "74093180"
---
# <a name="how-to-create-and-locate-anchors-using-on-device-sensors-in-java"></a>Horgonyok létrehozása és megkeresése az eszközön lévő szenzorok használatával Java-ban
