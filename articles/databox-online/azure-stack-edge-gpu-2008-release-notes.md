...
Ez az **Azure stack Edge 2008** -es kiadás a következő szoftververzió számára megfelel:
...
|**10.**|Kubernetes |A 31000-es port a Kubernetes-irányítópult számára van fenntartva. Hasonlóképpen, az alapértelmezett konfigurációban az IP-címek 10.96.0.1 és 10.96.0.10 a Kubernetes szolgáltatás és az alapvető DNS-szolgáltatás számára van fenntartva.|Ne használja a fenntartott IP-címeket.|
