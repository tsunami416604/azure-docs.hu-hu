...
description: Ismerteti a kritikus fontosságú nyílt problémákat és a megoldásait az Azure Stack Edge Pro-t futtató, előzetes verzió rendelkezésre állási kiadásával.
services: databox
author: alkohli
ms.service: databox
