---
title: Azure Stack Edge Pro 2011 kibocsátási megjegyzései
description: A cikk az 2011-es kiadást futtató Azure Stack Edge Pro kritikus fontosságú nyitott problémáit és megoldásait ismerteti.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "96466567"
---
# <a name="azure-stack-edge-2011-release-notes"></a>Azure Stack Edge 2011 kibocsátási megjegyzései

A következő kibocsátási megjegyzések azonosítják a kritikus nyitott problémákat, valamint az Azure Stack Edge-eszközök 2011-es kiadásával kapcsolatos megoldott problémákat. Ezek a kibocsátási megjegyzések Azure Stack Edge Pro GPU-ra, Azure Stack Edge Pro R-re és Azure Stack Edge mini R-eszközökre vonatkoznak. Az adott modellnek megfelelő szolgáltatásokat és problémákat minden esetben meghívjuk.
...
Ez a cikk az **Azure stack Edge 2011** kiadására vonatkozik<!--which maps to software version number **2.1.XXXX.XXXX**-->.

## <a name="whats-new"></a>Újdonságok

A következő új szolgáltatások érhetők el az Azure Stack Edge 2011 kiadásban. 
...
## <a name="known-issues-in-2011-release"></a>Ismert problémák a 2011 kiadásban

Az alábbi táblázat összefoglalja az 2011 kiadás ismert problémáit.
