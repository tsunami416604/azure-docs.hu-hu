...
Ezen a peremhálózati eszközön nincsenek egyéni modulok. Hozzáadhat egy egyéni vagy egy előre elkészített modult. Ha szeretné megismerni, hogyan hozhat létre egyéni modult, ugorjon a [C# modul fejlesztése a Data Box Edge eszközhöz](data-box-edge-create-iot-edge-module.md)című témakörre.
