...
ms.locfileid: "53263908"
---
# <a name="optimize-the-cost-required-to-run-queries-in-azure-cosmos-db"></a>A lekérdezések futtatásához az Azure Cosmos DB szükséges költségek optimalizálása
