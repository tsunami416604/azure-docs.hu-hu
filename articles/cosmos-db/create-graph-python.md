...
---
# <a name="azure-cosmos-db-create-a-graph-database-using-python-and-the-azure-portal"></a>Az Azure Cosmos DB: Hozzon létre egy gráfadatbázist Python és az Azure portal használatával
