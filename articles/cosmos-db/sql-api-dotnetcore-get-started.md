...
ms.locfileid: "52969278"
---
# <a name="tutorial-build-a-net-core-app-to-manage-data-stored-in-a-sql-api-account"></a>Oktatóanyag: SQL API-fiókban tárolt adatok kezelésére egy .NET Core-alkalmazás létrehozása
