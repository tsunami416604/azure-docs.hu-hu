...
## <a name="examples"></a>Példák
  ...
  A következő példa a `IS_OBJECT` függvény használatával ellenőrzi a JSON logikai, szám, karakterlánc, null, objektum, tömb és nem definiált típusok objektumait.  
