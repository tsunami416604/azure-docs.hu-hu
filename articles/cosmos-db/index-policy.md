...
- `precision` a befoglalt elérési utak index szintjén definiált szám. `-1` értéke a maximális pontosságot jelzi. Javasoljuk, hogy mindig állítsa be ezt az értéket `-1`ra.
