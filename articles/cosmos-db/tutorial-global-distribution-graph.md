...
ms.locfileid: "34763680"
---
# <a name="set-up-azure-cosmos-db-global-distribution-using-the-graph-api"></a>Az Azure Cosmos DB globális terjesztésének beállítása a Graph API használatával
