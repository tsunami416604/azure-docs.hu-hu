...
ms.locfileid: "54033115"
---
# <a name="quickstart-build-a-cassandra-app-with-net-and-azure-cosmos-db"></a>Gyors útmutató: A .NET és az Azure Cosmos DB Cassandra alkalmazás felépítése
