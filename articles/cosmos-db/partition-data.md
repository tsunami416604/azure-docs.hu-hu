...
:::image type="content" source="./media/partition-data/logical-partitions.png" alt-text="Fizikai partíciók számának megtekintése" border="false":::
