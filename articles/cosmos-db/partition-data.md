...
Egy tároló kiosztott átviteli sebesség egyenletesen oszlik fizikai partíciók között. Az átviteli sebesség kérelmek egyenletes elosztása nem partíciós kulcs kialakítás előfordulhat, hogy "Forró" partíciót alakíthatnak ki. A sebességhatárolt és a nem elég hatékony használata a kiosztott átviteli sebesség forró partíciók vezethet.

Logikai partíció ellentétben a fizikai partíciók a rendszer belső megvalósítását. A méret, elhelyezést vagy fizikai partíciók száma nem szabályozhatja, és logikai partíció és fizikai partíciók közötti nem szabályozhatja. Logikai partíciók száma és a terjesztési, adatok és az átviteli sebesség azonban szabályozhatja a megfelelő partíciókulcs kiválasztása.
...
* Ismerje meg, hogyan [üzembe helyezése egy Azure Cosmos DB-tároló átviteli sebességet](how-to-provision-container-throughput.md).
* Ismerje meg, hogyan [egy Azure Cosmos DB-adatbázis kiépítése átviteli](how-to-provision-database-throughput.md).
