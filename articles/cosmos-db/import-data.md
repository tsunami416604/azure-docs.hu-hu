...
Adja meg annak a gyűjteménynek a nevét, amelyből adatokat kíván importálni. Megadhatja vagy megadhat egy fájlt a lekérdezéshez, például `{pop: {$gt:5000}}`vagy kivetítést, például `{loc:0}`t, hogy mindkét szűrőhöz és az importálandó adatalakzathoz is megadjon.
...
![Képernyőkép a HBase forrásbeállításairól](./media/import-data/hbasesource1.png)

![Képernyőkép a HBase forrásbeállításairól](./media/import-data/hbasesource2.png)
