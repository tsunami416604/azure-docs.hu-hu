...
---
# <a name="azure-cosmos-db-create-a-graph-database-using-java-and-the-azure-portal"></a>Az Azure Cosmos DB: Hozzon létre egy gráfadatbázist Java és az Azure portal használatával
