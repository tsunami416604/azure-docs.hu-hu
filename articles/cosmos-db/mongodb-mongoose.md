---
title: "A Mongoose-keretrendszer használata Azure Cosmos DB-vel | Microsoft Docs"
...
1. Vegye fel a Cosmos DB kapcsolati karakterláncát és a Cosmos DB-nevet a ```.env``` fájlba.
