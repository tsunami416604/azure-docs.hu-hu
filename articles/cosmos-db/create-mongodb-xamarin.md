...
> [!IMPORTANT]
> A futásidejű hiba elkerülése `&replicaSet=globaldb` érdekében el kell távolítania a kulcs/érték párokat a kapcsolódási karakterlánc lekérdezési karakterláncában.
