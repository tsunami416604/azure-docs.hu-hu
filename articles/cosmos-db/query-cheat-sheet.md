...
:::image type="content" source="./media/query-cheat-sheet/azure-cosmos-db-cheat-sheet-letter.png" alt-text="Azure Cosmos DB lekérdezési Cheat Sheets – Letter méretű, SQL API, JavaScript, MongoDB, Gremlin és Table API lekérdezések és függvények" border="false":::
