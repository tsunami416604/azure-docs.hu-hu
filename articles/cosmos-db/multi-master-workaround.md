---
title: Több területi írási és olvasási műveletek végrehajtását kiválasztani a partíciós kulcs |} Microsoft Docs
description: További tudnivalók a helyi olvasási és írási alkalmazási architektúrákban tervezéséről Azure Cosmos DB több földrajzi régiók közötti partíciókulcsot kiválasztásával.
services: cosmos-db
author: SnehaGunda
manager: kfile
...
---
# <a name="perform-multi-region-writes-and-reads-by-choosing-the-right-partitioning-key"></a>Több területi írási és olvasási műveletek végrehajtását kiválasztani a particionálási kulcs
...
![Azure Cosmos DB több főkiszolgálós architektúra](./media/multi-master-workaround/multi-master.png)
