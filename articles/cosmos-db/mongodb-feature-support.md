...
## <a name="sort-operations"></a>Rendezési műveletekben
Használatakor a `findOneAndUpdate` művelet, rendezési műveletekben egyetlen mező támogatottak, de a rendezési műveletekben több mező alapján nem támogatottak.
