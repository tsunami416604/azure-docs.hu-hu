...
## <a name="high-throughput"></a>Nagy adatforgalom kezelése
...
![Háttérszolgáltatás](./media/relational-or-nosql/backend-scaled.png)
...
![Gráf](./media/relational-or-nosql/graph.png)
...
Ha olyan adatkezelést végez, amelynek struktúrái folyamatosan változnak nagy arányban, különösen abban az esetben, ha a tranzakciók olyan külső forrásokból származnak, ahol nehéz kikényszeríteni az adatbázison belüli megfelelést, érdemes megfontolnia, hogy több séma-agnosztikus megközelítést lehessen alkalmazni felügyelt NoSQL adatbázis-szolgáltatás, például Azure Cosmos DB használata.
...
A NoSQL-dokumentumok adatbázisának ajánlott módszere, ha a kategória neve és a címke neveit közvetlenül egy "termék dokumentumában" szeretné denormalizálni. Ahhoz azonban, hogy a kategóriák, címkék és termékek szinkronban maradjanak, a tervezési beállítások lehetővé teszik a karbantartási bonyolultság hozzáadását, mivel az adatok duplikálása a termék több rekordjára történik, nem pedig egy "egy a többhöz" nevű egyszerű frissítés. kapcsolat, valamint az adatlekérdezéshez való csatlakozás. 
