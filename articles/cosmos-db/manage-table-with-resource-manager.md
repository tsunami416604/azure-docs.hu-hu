...
## <a name="azure-cosmos-account-for-table-with-standard-manual-throughput"></a>Azure Cosmos-fiók a standard (manuális) átviteli sebességgel rendelkező táblázathoz
