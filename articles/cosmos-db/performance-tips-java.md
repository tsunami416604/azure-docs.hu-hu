...
1. **Csatlakoztatási mód: DirectHttps használata**
   ...
   2. [DirectHttps](https://docs.microsoft.com/java/api/com.microsoft.azure.documentdb.connectionmode)
      ...
      A Java SDK a HTTPS protokollt használja átviteli protokollként. A HTTPS a TLS-t használja a kezdeti hitelesítéshez és a forgalom titkosításához. A Java SDK használatakor csak a 443-es HTTPS-portot kell megnyitni. 
