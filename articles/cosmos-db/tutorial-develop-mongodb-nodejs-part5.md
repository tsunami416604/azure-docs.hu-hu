...
Ez a többrészes oktatóanyag bemutatja, hogyan hozhat létre egy Node.js-alkalmazást az Express, Angular, és kösse össze [Azure Cosmos DB MongoDB API-](mongodb-introduction.md) fiókot.
