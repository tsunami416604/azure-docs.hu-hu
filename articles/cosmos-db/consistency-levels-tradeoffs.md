...
## <a name="consistency-levels-and-data-durability"></a>Konzisztencia-szintek és az adatok tartóssága

Egy globálisan elosztott adatbázis-környezeten belül nincs közvetlen kapcsolat folytonosságát egy régióra kiterjedő szolgáltatáskimaradás konzisztencia szint és az adatok tartósságának között. A tábla közötti kapcsolat konzisztencia modellek és az adatok tartóssága régió széles körű leállás zajok mellett között kapcsolat határozza meg. Fontos megjegyezni, hogy az elosztott rendszerekben, még akkor is, erős konzisztencia, nem lehet elosztott adatbázis- és RPO és RTO miatt a CAP-tétel nulla. Ezért a további tudnivalókért lásd: [Azure Cosmos DB-ben konzisztenciaszintek](consistency-levels.md).
...
* A K & T = "K"-verziók (frissítések) egy elem száma. Vagy "T" alatt az időtartam alatt.
