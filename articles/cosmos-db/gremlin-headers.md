...
| status | Magyarázat |
| --- | --- |
| **401** | Hibaüzenet jelenik `"Unauthorized: Invalid credentials provided"` meg, ha a hitelesítési jelszó nem egyezik Cosmos db a fiók kulcsával. Navigáljon a Azure Portal Cosmos DB Gremlin-fiókjához, és győződjön meg arról, hogy a kulcs helyes.|
