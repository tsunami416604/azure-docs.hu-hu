---
title: Az Azure PowerShell szkript – fiókkulcsok lekérése az Azure Cosmos DB
description: Az Azure PowerShell-Példaszkript – fiókkulcsok lekérése az Azure Cosmos DB-hez
services: cosmos-db
