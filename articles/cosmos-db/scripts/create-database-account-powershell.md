---
title: "Az Azure PowerShell parancsfájl-Azure Cosmos DB SQL API-fiók létrehozása |} Microsoft Docs"
description: "Az Azure PowerShell-parancsfájl minta - Azure Cosmos DB SQL API-fiók létrehozása"
services: cosmos-db
...
---
# <a name="azure-cosmos-db-create-a-sql-api-account-using-powershell"></a>Az Azure Cosmos DB: PowerShell-lel SQL API-fiók létrehozása
