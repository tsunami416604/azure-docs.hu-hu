---
title: Azure PowerShell-Példaszkript – egy Azure Cosmos DB SQL API-fiók létrehozása
...
ms.locfileid: "54043107"
---
# <a name="azure-cosmos-db-create-a-sql-api-account-using-powershell"></a>Az Azure Cosmos DB: A PowerShell használatával az SQL API-fiók létrehozása
