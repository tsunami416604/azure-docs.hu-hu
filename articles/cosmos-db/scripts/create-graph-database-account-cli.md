---
title: Azure CLI-szkript – Azure Cosmos DB Gremlin API-fiók, adatbázis és gyűjtemény létrehozása | Microsoft Docs
description: Azure CLI-példaszkript – Azure Cosmos DB Gremlin API-fiók, adatbázis és gyűjtemény létrehozása
services: cosmos-db
...
Ez a CLI-példaszkript létrehoz egy Azure Cosmos DB Gremlin API-fiókot, adatbázist és gyűjteményt. 
