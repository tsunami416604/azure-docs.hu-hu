---
title: Table API-tábla létrehozása az Azure Cosmos DB-hez
description: Table API-tábla létrehozása az Azure Cosmos DB-hez
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "71275478"
---
# <a name="create-an-azure-cosmos-table-api-account-and-table-using-azure-cli"></a>Hozzon létre egy Azure Cosmos Table API-fiókot és táblát az Azure CLI használatával
