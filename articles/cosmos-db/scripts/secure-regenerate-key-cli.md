---
title: Azure CLI-szkript – Azure Cosmos DB-fiókkulcs újbóli létrehozása | Microsoft Docs
...
| [az cosmosdb create](https://docs.microsoft.com/cli/azure/cosmosdb#az-cosmosdb-create) | Frissít egy Azure Cosmos DB-fiókot. |
