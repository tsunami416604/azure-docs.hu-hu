---
title: Azure PowerShell script-Azure Cosmos DB MongoDB API-hoz tartozó RU/s frissítése
description: Azure PowerShell script-Azure Cosmos DB MongoDB API-hoz tartozó RU/s frissítése
author: markjbrown
