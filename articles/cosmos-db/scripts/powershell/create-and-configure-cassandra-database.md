---
title: Az Azure PowerShell-szkript – létrehozása egy Azure Cosmos DB Cassandra API-fiók
description: Azure PowerShell-példaszkript – egy Azure Cosmos DB Cassandra API-fiók létrehozása
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "65080813"
---
# <a name="azure-cosmos-db-create-a-cassandra-api-account-using-powershell"></a>Az Azure Cosmos DB: PowerShell-lel a Cassandra API-fiók létrehozása

Ez a PowerShell-példaszkript egy Azure Cosmos DB Cassandra API-fiókot hoz létre. 
