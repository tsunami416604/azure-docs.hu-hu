---
title: Az Azure PowerShell parancsfájl-egy Azure Cosmos DB Gremlin API-fiók létrehozása
description: Azure PowerShell-példaszkript – egy Azure Cosmos DB Gremlin API-fiók létrehozása
...
ms.locfileid: "65080785"
---
# <a name="azure-cosmos-db-create-a-gremlin-api-account-using-powershell"></a>Az Azure Cosmos DB: PowerShell-lel a Gremlin API-fiók létrehozása
