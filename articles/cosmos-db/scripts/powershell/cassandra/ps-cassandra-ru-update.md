---
title: Azure PowerShell-példaszkript – Azure Cosmos DB Update RU/s a Cassandra API-hoz
description: Azure PowerShell-példaszkript – Azure Cosmos DB Update RU/s a Cassandra API-hoz
author: markjbrown
...
---
# <a name="update-rus-for-a-keyspace-or-table-for-azure-cosmos-db---cassandra-api"></a>Kulcstér és tábla, az Azure Cosmos DB - Cassandra API frissítése RU/s
