---
title: Azure PowerShell parancsfájl-Azure Cosmos DB RU/s frissítése a Cassandra API
description: Azure PowerShell parancsfájl-Azure Cosmos DB RU/s frissítése a Cassandra API
author: markjbrown
