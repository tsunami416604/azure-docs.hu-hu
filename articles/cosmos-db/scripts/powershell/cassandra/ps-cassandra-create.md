---
title: Azure PowerShell-példaszkript – Azure Cosmos DB Cassandra API kulcstér és tábla létrehozása
description: Azure PowerShell-példaszkript – Azure Cosmos DB Cassandra API kulcstér és tábla létrehozása
author: markjbrown
