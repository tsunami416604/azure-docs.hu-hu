...
[!code-powershell[fő](../../../powershell_scripts/cosmosdb/get-mongodb-connection-string/get-mongodb-connection-string.ps1?highlight=37-41 "Azure Cosmos DB fiókból a MongoDB-kapcsolati karakterlánc beolvasása")]
