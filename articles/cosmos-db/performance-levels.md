...
Az [MSDN webhelyen](/dotnet/api/microsoft.azure.documents.client.documentclient) további példákat tekinthet meg, és további információkat tudhat meg az ajánlati módszerekről:
