...
A rendszer beszúr egy elemeket Azure Cosmos DBba, és az AZONOSÍTÓban [érvénytelen karakter](https://docs.microsoft.com/dotnet/api/microsoft.azure.documents.resource.id?view=azure-dotnet#remarks) szerepel.
