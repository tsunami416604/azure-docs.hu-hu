...
## <a name="add-an-azure-comsos-db-connection"></a>Azure Comsos DB-kapcsolat hozzáadása
...
A **PartitionKey** és a **RowKey** értéknek is sztringértéknek kell lennie. További információt a [Table Service adatmodelljét ismertető](http://msdn.microsoft.com/library/azure/dd179338.aspx) témakörben talál.
