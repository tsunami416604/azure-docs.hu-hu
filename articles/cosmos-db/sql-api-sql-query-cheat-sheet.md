...
Cosmos DB támogatja a relációs, hierarchikus és térbeli küld lekérdezést a JSON-dokumentumok használatával [SQL](sql-api-sql-query.md) a séma vagy a másodlagos indexek megadása nélkül. A szabványos ANSI SQL kulcsszavak és operátorok mellett Cosmos DB támogatja a JavaScript felhasználó által megadott funkciókat (UDF), a JavaScript kezelők és a beépített funkciók számos.
...
* A lépésein végighaladva a Cosmos DB lekérdezés lehetőségeit, tekintse meg [lekérdezés Cosmos DB](sql-api-sql-query.md).
