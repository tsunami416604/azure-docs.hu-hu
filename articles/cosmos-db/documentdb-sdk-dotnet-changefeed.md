...
* Kompatibilis [SQL .NET SDK](documentdb-sdk-dotnet.md) 1.17.0 verzió vagy újabb verzió.
* Kompatibilis [SQL .NET Core SDK](documentdb-sdk-dotnet-core.md) 1.5.1 verzió vagy újabb verzió.

### <a name="a-name111111"></a><a name="1.1.1"/>1.1.1
* Javítja a számítás a becsült hátralévő munka a változás-hírcsatorna üres volt, vagy nem volt függőben.
* Kompatibilis [SQL .NET SDK](documentdb-sdk-dotnet.md) 1.13.2 verzió vagy újabb verzió.
...
* GA SDK
* Kompatibilis [SQL .NET SDK](documentdb-sdk-dotnet.md) verziók 1.14.1 vagy régebbi verzió.
