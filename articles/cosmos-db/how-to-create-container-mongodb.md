...
[Hozzon létre egy gyűjteményt Azure Cosmos db for MONGODB API-hoz Resource Manager-sablonnal](manage-sql-with-resource-manager.md#azure-cosmos-account-with-standard-provisioned-throughput).
