...
ms.locfileid: "56588058"
---
# <a name="quickstart-build-a-cassandra-app-with-python-sdk-and-azure-cosmos-db"></a>Gyors útmutató: A Python SDK-t és az Azure Cosmos DB Cassandra alkalmazás felépítése
