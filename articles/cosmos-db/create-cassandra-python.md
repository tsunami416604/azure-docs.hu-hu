...
1. Töltse le a Baltimore CyberTrust főtanúsítványát a következő címről: [https://cacert.omniroot.com/bc2025.crt](https://cacert.omniroot.com/bc2025.crt). Nevezze át a fájlt a *. cer*kiterjesztésű fájl használatával.
...
2. Nyissa meg a *pyquickstart.py* , és módosítsa a `path\to\cert` úgy, hogy az új tanúsítványra mutasson.
