...
1. Telepítse a Azure Cosmos DBt használó Azure Kubernetes-fürtöt a következő paranccsal:
   ...
   * **ügyfél-azonosító:** Az egyszerű szolgáltatás appId. A `appId` vissza lett visszaadva a 4. lépésben megadott kimenetként.
   ...
   * **hely:**  A hely, ahol a fürtöt telepíteni kell, a jelenleg csak a "CentralUS" támogatott.
