...
Azure Cosmos DB API-MongoDB támogatja a TLS-kompatibilis kapcsolatokat. A kapcsolódáshoz meg kell adnia a **DialServer** függvényt az [MGO-ben. DialInfo](https://godoc.org/gopkg.in/mgo.v2#DialInfo), és használja a TLS-t [.* Tárcsázási* ](https://golang.org/pkg/crypto/tls#Dial) függvény a kapcsolat végrehajtásához.
...
Az **MgO. A Dial ()** metódus akkor használatos, ha nincs TLS-kapcsolat. A TLS-kapcsolatok esetében az **MgO. A DialWithInfo ()** metódust kötelező megadni.
