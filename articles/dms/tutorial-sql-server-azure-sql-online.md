...
> [!NOTE]
> Az Azure Database Migration Service online áttelepítése használatához hozzon létre egy példányt prémium tarifacsomagban alapján. További információ: az Azure Database Migration Service [díjszabás](https://azure.microsoft.com/pricing/details/database-migration/) lapot.
> [!IMPORTANT]
...
Miután nem okoz gondot az értékelés az és DMA meggyőződött arról, hogy a kijelölt adatbázis egy működőképes jelölt egy önálló adatbázis vagy készletezett databasein Azure SQL Database, az áttelepítéshez használható a séma migrálása az Azure SQL Database.
...
Áttelepíteni a **AdventureWorks2012** séma eszköz egy önálló adatbázis vagy készletezett Azure SQL Database-adatbázishoz, hajtsa végre az alábbi lépéseket:
