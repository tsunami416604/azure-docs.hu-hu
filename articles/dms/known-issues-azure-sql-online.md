...
További információkért tekintse meg a cikk [időbeli táblázatait](/sql/relational-databases/tables/temporal-tables?view=sql-server-2017).
...
2. Tiltsa le az eseményindítókat a forrás-adatbázison az [eseményindító letiltása (Transact-SQL)](/sql/t-sql/statements/disable-trigger-transact-sql?view=sql-server-2017)című cikkben ismertetett lépések alapján.
