...
- *TaskType*. Áttelepítési feladat létrehozása az SQL Server az Azure SQL Database-példány Managaged migrálási típus típusú *MigrateSqlServerSqlDbMi* várt. 
