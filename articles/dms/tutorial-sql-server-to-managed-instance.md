...
1. A **Forrásadatbázisok kiválasztása** képernyőn válassza ki a migrálni kívánt forrásadatbázist.
    ...
    ![Válassza ki a forrásadatbázisokat](media/tutorial-sql-server-to-managed-instance/select-source-databases.png)
...
1. A **Bejelentkezések kiválasztása** képernyőn válassza ki a migrálni kívánt bejelentkezési adatokat.
    ...
    ![Bejelentkezések kiválasztása](media/tutorial-sql-server-to-managed-instance/select-logins.png)
