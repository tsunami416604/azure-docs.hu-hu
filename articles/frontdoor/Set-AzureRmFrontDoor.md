...
## LEÍRÁS
A **Set-AzureRmFrontDoor** parancsmag frissíti egy bejárati ajtajának load balancert. Ha nincsenek megadva bemeneti paraméterek, a meglévő bejárati ajtó a régi paraméterek használható.

## PÉLDÁK

### 1. példa: egy meglévő bejárati ajtajának FrontDoorName és ResourceGroupName frissítse.
```powershell
...
frissíti egy meglévő FrontDoor.

### 2. példa: egy meglévő bejárati ajtajának PSFrontDoor objektum frissítése.
```powershell
...
### 3. példa: egy meglévő bejárati ajtajának frissíteni az erőforrás-azonosító
```powershell
...
### -EnabledState
A bejárati ajtajának terheléselosztó működési állapotát.
...
### -InputObject
A bejárati ajtajának objektum frissítése.
...
### -Név
Kezdettől fogva frissíteni a neve.
...
Erőforrás-azonosítóját a bejárati ajtó frissítése
