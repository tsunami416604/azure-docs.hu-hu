...
1. A képernyő bal felső részén válassza az **Erőforrás** > létrehozása**Web** > **Web App** > **Create**lehetőséget.
...
1. A képernyő bal felső részén válassza az **Erőforrás** > létrehozása**hálózati** > **bejárati ajtó** > **létrehozása lehetőséget.**
...
6. Szükség esetén módosíthatja az állapotminta és a terheléselosztás beállításait a háttérkészlethez, de az alapértelmezett értékeknek is működniük kell. Kattintson a **Hozzáadás** gombra.
