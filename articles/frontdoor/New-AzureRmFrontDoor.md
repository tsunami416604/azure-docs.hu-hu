...
## LEÍRÁS
A **New-AzureRmFrontDoor** parancsmag egy új Azure bejárati ajtajának terheléselosztót hoz létre a megadott erőforráscsoport az aktuális előfizetésben

## PÉLDÁK

### 1. példa: Hozzon létre egy bejárati ajtajának megadott paraméterek alapján.
```powershell
...
Hozzon létre egy bejárati ajtajának megadott paraméterek alapján.

## PARAMÉTEREK

### -Háttérkészletek
Backendpools útválasztási szabály számára elérhető.
...
### -EnabledState
A bejárati ajtajának terheléselosztó EnabledState.
Engedélyezve van az alapértelmezett érték
...
### -FrontendEndpoint
Előtérbeli végpontok útválasztási szabály számára elérhető.
...
### -HealthProbeSetting
Eszközállapot-mintavételi beállítások az bejárati ajtajának példányához tartozó.
...
A terheléselosztási az bejárati ajtajának példányához tartozó beállításokat.
...
### -ResourceGroupName
Az erőforráscsoport neve, amely a bejárati ajtó létrejön.
...
### -RoutingRule
Ez FrontDoor tartozó útválasztási szabályok
...
### -Címke
A címkék a FrontDoor társítani.
