...
description: Ismerje meg, hogyan hozhat létre Azure-beli bejárati szolgáltatást Azure Resource Manager sablon (ARM-sablon) használatával.
services: front-door
documentationcenter: ''
author: duongau
editor: ''
