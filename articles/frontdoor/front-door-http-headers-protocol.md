...
| ------------- | ------------- |
| Ezzel |  *Keresztül: 1.1 azure* </br> Bejárati ajtajának hozzáadja az ügyfél HTTP-verzió Via fejléc értéke "Azure" követ. Ez hozzáadódik jelzi az ügyfél HTTP-verzió és Azure bejárati ajtó a kérelem, az ügyfél és a háttérrendszer között egy köztes címzettnek.  |
...
| X-Azure-SocketIP |  *X-Azure-SocketIP: 127.0.0.1* </br> Származik-e az aktuális kérelem TCP-kapcsolathoz társított szoftvercsatorna IP-címet jelenti. A kérés ügyfél IP-cím nem lehet egyenlő a szoftvercsatorna IP-címére, mivel lehet önkényesen felülírni azt egy végfelhasználó.|
