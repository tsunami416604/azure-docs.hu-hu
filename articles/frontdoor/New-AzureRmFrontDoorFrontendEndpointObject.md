...
ms.locfileid: "47047513"
---
# Új AzureRmFrontDoorFrontendEndpointObject
...
### -CertificateType
biztonságos kapcsolatok egy frontendEndpoint használt tanúsítvány típusa
...
### -Állomásnév
A frontendEndpoint állomás neve.
A tartománynévnek kell lennie.
...
### -Protokolltípus
A TLS-bővítmény protokoll használt biztonságos kézbesítés
...
### -SecretName
A Key Vault titkos kulcsából, a teljes tanúsítvány PFX jelölő neve
...
### -SecretVersion
A Key Vault titkos kulcsából, teljes tanúsítványnak PFX megfelelő verziója
...
E munkamenet-affinitás engedélyezése ezen a gazdagépen.
Alapértelmezett érték le van tiltva.
...
Az Élettartama másodpercben. munkamenet-affinitást, használatára, ha van ilyen. Alapértelmezett érték: 0
...
### -Tároló
A Key Vault, amely tartalmazza az SSL-tanúsítvány
...
### -WebApplicationFirewallPolicyLink
Webalkalmazási tűzfal-házirend minden gazdagéphez (ha van) az erőforrás-azonosítója
