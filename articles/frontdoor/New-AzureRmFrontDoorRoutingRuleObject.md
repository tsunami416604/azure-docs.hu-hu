...
ms.locfileid: "47047537"
---
# Új AzureRmFrontDoorRoutingRuleObject
...
### 1. példa: Hozzon létre egy PSRoutingRuleObject bejárati ajtajának létrehozásához
```powershell
...
### -AcceptedProtocol
A szabálynak megfelelő protokoll rendszerek.
Alapértelmezett érték: {Https, Http}
...
### -BackendPoolName
Erőforrás-azonosító, amelyre ez a szabály irányítja a Háttérkészletek
...
### -CustomForwardingPath
Ez a szabály egyező erőforrás elérési utak újraírási használt egyéni elérési.
Hagyja üresen a bejövő elérési utat használja.
...
### -DynamicCompression
Engedélyezheti a dinamikus tömörítés a gyorsítótárazott tartalom gyorsítótárazása során engedélyezve van.
...
### -EnableCaching
-E engedélyezni a gyorsítótárazást az útvonal. Alapértelmezett értéke FALSE (hamis)
...
### -EnabledState
Ez a szabály engedélyezheti a használatát.
Engedélyezve van az alapértelmezett érték
...
### -ForwardingProtocol
Ha a forgalmat továbbítja, háttérrendszerek alapértelmezett érték MatchRequest Ez a szabály fogja használni a protokollt.
...
Ez a szabály társított előtérbeli végpontok nevei
...
### -PatternToMatch
Az útvonal minták a szabály nem lehet bármelyik * kivételével valószínűleg után a végső / az elérési út végén. Alapértelmezett értéke / *
...
Az URL-lekérdezés kezelésére a gyorsítótár kulcsot képező kapcsolatos kifejezések.
Alapértelmezett értéke StripAll
