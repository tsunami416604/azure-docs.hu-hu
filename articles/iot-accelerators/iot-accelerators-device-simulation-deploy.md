...
1. Kattintson a **válasszon** a a **eszköz szimuláció** csempén:
    ...
    ![Válassza ki az eszköz szimulálása](./media/iot-accelerators-device-simulation-deploy/select.png)
...
1. Kattintson a **Megoldás létrehozása** gombra a kiépítés elkezdéséhez. Ez a folyamat általában több percig tarthat futtatásához:
    ...
    ![Eszköz szimuláció megoldás részletei](./media/iot-accelerators-device-simulation-deploy/createsolution.png)
...
1. A a **kiépített megoldások** kattintson **indítása** alatt az új eszköz szimuláció megoldás:
    ...
    ![Új megoldás kiválasztása](./media/iot-accelerators-device-simulation-deploy/newsolution.png)
...
1. Az eszköz szimuláció-megoldás a panelen megjelenő információk is megtekinthetők. Válasszon **megoldás irányítópultja** csatlakozni az eszköz szimuláció megoldás.
    ...
    ![Megoldás panel](./media/iot-accelerators-device-simulation-deploy/properties.png)
...
Az eszköz szimuláció megoldás telepített, akkor a következő lépéssel fogja [Fedezze fel az eszköz szimuláció-megoldás funkcióinak](iot-accelerators-device-simulation-explore.md).
