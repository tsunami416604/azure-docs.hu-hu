...
1. Válassza ki az alkalmazást, majd kattintson a **manifest (jegyzékfájl**) elemre. Az alkalmazáshoz definiált két meglévő [alkalmazás-szerepkört](/azure/architecture/multitenant-identity/app-roles) láthatja:
