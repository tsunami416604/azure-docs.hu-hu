...
![Változás paraméterpanel-elrendezése](./media/iot-accelerators-remote-monitoring-customize/layout.png)
...
![Több telemetriai panelek](./media/iot-accelerators-remote-monitoring-customize/multiple-telemetry.png)
...
![Riasztások panel frissítése](./media/iot-accelerators-remote-monitoring-customize/reorder-columns.png)
