...
Most már rendelkezik megtanulta, hogyan szabhatja testre az szimuláció szolgáltatást. A javasolt következő lépésre megtudhatja, hogyan [egy fizikai eszköz csatlakozni a távoli felügyeleti megoldás](iot-accelerators-connecting-devices-node.md).
