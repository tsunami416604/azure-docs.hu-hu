...
| Stream Analytics     | Igen                | Igen                    |                   |
| Web Apps             | Igen                | Igen                    | Igen               |
| Cosmos DB            | Igen                | Igen                    |                    |
| Azure Storage         |                    | Igen                    | Igen               |

> [!NOTE]
> A távoli megfigyelési megoldásgyorsító üzembe helyezett erőforrás kapcsolatos további információkért lásd: [architekturális döntések távoli megfigyelési](iot-accelerators-remote-monitoring-architectural-choices.md).
