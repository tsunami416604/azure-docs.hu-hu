---
title: Felügyelt szolgáltatási ajánlat közzététele az Azure Marketplace-en
...
---
# <a name="publish-a-managed-services-offer-to-azure-marketplace"></a>Felügyelt szolgáltatási ajánlat közzététele az Azure Marketplace-en

Ebből a cikkből megtudhatja, hogyan tehet közzé nyilvános vagy magánfelügyelt szolgáltatásokat az [Azure Piactéren](https://azuremarketplace.microsoft.com) a [Cloud Partner Portal](https://cloudpartner.azure.com/)használatával, amely lehetővé teszi az Azure delegált erőforrás-kezeléséhez szükséges erőforrások rakoncátorára vonatkozó ajánlatot.

> [!NOTE]
> Az ajánlatok létrehozásához és közzétételéhez érvényes fiókkal kell rendelkeznie [a Partnerközpontban.](../../marketplace/partner-center-portal/create-account.md) Ha még nem rendelkezik fiókkal, a [regisztrációs folyamat](https://aka.ms/joinmarketplace) végigvezeti a Partnerközpontban létrehozott és a Kereskedelmi piactér programba való regisztráció lépésein. A Microsoft Partner Network (MPN) azonosító [automatikusan társítva](../../billing/billing-partner-admin-link-started.md) lesz a közzétett ajánlatokkal, hogy nyomon követhesse az ügyfélkapcsolatokra gyakorolt hatását.
>
...
A felügyelt szolgáltatások ajánlatának közzététele hasonló az Azure Marketplace-en bármilyen más típusú ajánlat közzétételéhez. A folyamatról az [Azure Marketplace és az AppSource közzétételi útmutatója,](../../marketplace/marketplace-publishers-guide.md) valamint [az Azure és az AppSource Piactér ajánlatai kezelése című témakörben olvashat.](../../marketplace/cloud-partner-portal/manage-offers/cpp-manage-offers.md) Tekintse át a [kereskedelmi piactér tanúsítási irányelveit](https://docs.microsoft.com/legal/marketplace/certification-policies)is, különösen a [Felügyelt szolgáltatások szakaszt.](https://docs.microsoft.com/legal/marketplace/certification-policies#700-managed-services)

Miután egy ügyfél hozzáadja az ajánlatot, delegálhat egy vagy több konkrét előfizetést vagy erőforráscsoportot, amelyeket ezután [az Azure delegált erőforrás-kezeléséhez kell beruházni.](#the-customer-onboarding-process) Vegye figyelembe, hogy ahhoz, hogy egy előfizetés (vagy egy előfizetésen belüli erőforráscsoportok) beszállhasson, az előfizetést engedélyezni kell a bevezetéshez a **Microsoft.ManagedServices** erőforrás-szolgáltató manuális regisztrálásával.

> [!IMPORTANT]
> A felügyelt szolgáltatási ajánlat minden egyes csomagja tartalmaz egy **Manifest Details szakaszt,** ahol meghatározza az Azure Active Directory (Azure AD) entitásokat a bérlőben, amelyek hozzáférhetnek a delegált erőforráscsoportokhoz és/vagy előfizetésekhez az ilyen csomagot megvásárló ügyfelek számára. Fontos tudni, hogy az itt megadott bármely csoport (vagy felhasználó vagy egyszerű szolgáltatás) minden olyan ügyfél számára azonos engedélyekkel rendelkezik, akik megvásárolják a csomagot. Ha különböző csoportokat szeretne hozzárendelni az egyes ügyfelekkel való munkához, külön privát csomagot kell közzétennie, amely kizárólag az egyes ügyfelek számára elérhető.

## <a name="create-your-offer-in-the-cloud-partner-portal"></a>Ajánlatlétrehozása a Cloud Partner Portal webhelyen
