...
1. Amikor [ARM-sablonokkal](onboard-customer.md)végez bevezetést, ügyeljen arra, hogy olyan hitelesítést tartalmazzon, amely tartalmazza a PEC Automation-fiókot egy olyan [Azure beépített szerepkörrel](/partner-center/azure-roles-perms-pec)rendelkező felhasználóként, amely jogosult a PEC használatára.
