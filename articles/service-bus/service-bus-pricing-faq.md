...
完成服務匯流排定價的詳細資訊，請參閱 [服務匯流排定價和計費](https://msdn.microsoft.com/library/dn831889.aspx) 和 [服務匯流排定價詳細資料](http://azure.microsoft.com/pricing/details/service-bus/)。 除了註明的價格，您還需支付您的應用程式佈建所在資料中心外部的輸出相關資料傳輸費用。 如需詳細資訊，請參閱下面的[何種服務匯流排用法需支付資料傳輸費用？何種不需？](#what-usage-of-service-bus-is-subject-to-data-transfer-what-is-not) 所說明。
