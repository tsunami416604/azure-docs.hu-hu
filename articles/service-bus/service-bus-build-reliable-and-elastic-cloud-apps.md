...
- [佇列型負載調節模式](http://msdn.microsoft.com/library/dn589783.aspx)
- [競爭取用者](http://msdn.microsoft.com/library/dn568101.aspx)
- [客戶經驗談](https://customers.microsoft.com/Pages/Home.aspx)

## 建置

- [如何使用服務匯流排佇列](service-bus-dotnet-how-to-use-queues.md)
- [寄不出去的服務匯流排代理傳訊 (年 10 月 21 2011年部落格文章)](http://geekswithblogs.net/asmith/articles/147398.aspx)
- [將服務匯流排應用程式與服務匯流排中斷和災難隔絕的最佳作法](service-bus-outages-disasters.md)
- [代理傳訊: 要求的回應範例](https://code.msdn.microsoft.com/Brokered-Messaging-Request-0ce8fcaf)
