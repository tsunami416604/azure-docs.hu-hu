...
從佇列接收訊息的最簡單方式是使用 [MessageReceiver](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.messagereceiver.aspx) 物件可以直接從建立 [MessagingFactory](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.messagingfactory.aspx) 使用 [CreateMessageReceiver](https://msdn.microsoft.com/library/azure/hh322642.aspx)。 訊息接收者可在兩種不同的模式下運作：**ReceiveAndDelete** 和 **PeekLock**。  [ReceiveMode](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.receivemode.aspx) 建立訊息接收者時，做為參數設定 [CreateMessageReceiver](https://msdn.microsoft.com/library/azure/hh322642.aspx) 呼叫。
