...
| tartós |- |- |
| prioritás |- |- |
| élettartam |Az üzenet élettartama |[TimeToLive](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage) |
| első-beszerző |- |- |
