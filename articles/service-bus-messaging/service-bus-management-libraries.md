...
## <a name="complete-code-to-create-a-queue"></a>Fejezze be a kódot, hogy a várólista létrehozása
Itt látható a teljes kód egy Service Bus-üzenetsor létrehozása: 
