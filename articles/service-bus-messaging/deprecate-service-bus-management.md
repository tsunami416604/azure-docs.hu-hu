...
| **Névterek – DeleteNamespaceAsync**<br/>[Service Bus névtér törlése](/rest/api/servicebus/delete-namespace)<br/>[Event Hubs névtér törlése](/rest/api/eventhub/delete-event-hub)<br/>[Továbbítási névtér törlése](/rest/api/servicebus/delete-namespace)<br/> ```DELETE  https://management.core.windows.net/{subscription ID}/services/ServiceBus/Namespaces/{namespace name}``` | [törlése](/rest/api/servicebus/namespaces/delete) | delete | [törlése](/rest/api/relay/namespaces/delete) | 
| **MessagingSKUPlan – GetPlanAsync**<br/>Service Bus/Event hub/Relay Get névtér<br/>```GET https://management.core.windows.net/{subscription ID}/services/ServiceBus/Namespaces/{namespace name}/MessagingPlan``` | [Get](/rest/api/servicebus/namespaces/get) | get | [Get](/rest/api/relay/namespaces/get) |
...
| **RegionCodes-GetRegionCodesAsync**<br/>Service Bus/EventHub/Relay Get névtér<br/>```GET https://management.core.windows.net/{subscription ID}/services/ServiceBus/Namespaces/{namespace name}``` | [listbysku](/rest/api/servicebus/regions/listbysku) | listbysku | &nbsp; | 
...
| **EventHubsCrud-ListEventHubsAsync**<br/>[Event Hubs listázása](/rest/api/eventhub/list-event-hubs)<br/>```GET https://management.core.windows.net/{subscription ID}/services/ServiceBus/Namespaces/{namespace name}/eventhubs?$skip={skip}&$top={top}``` | &nbsp; | [lista](/rest/api/servicebus/eventhubs/listbynamespace) | &nbsp; | 
