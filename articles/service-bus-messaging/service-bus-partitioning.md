...
Ha Azure Service Bus használatával particionált várólistákat és témaköröket szeretne használni, használja az Azure SDK 2,2-as vagy újabb verzióját, vagy adja meg `api-version=2013-10` vagy később a HTTP-kérelmeket.
