...
* A Data Lake Analytics használatának első lépései [az Azure portal](data-lake-analytics-get-started-portal.md) | [Azure PowerShell-lel](data-lake-analytics-get-started-powershell.md) | [CLI 2.0-val](data-lake-analytics-get-started-cli2.md)
