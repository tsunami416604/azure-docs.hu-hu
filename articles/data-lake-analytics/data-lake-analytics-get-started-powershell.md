...
>[AZURE.NOTE] Azure 入口網站提供的範例資料檔複製到預設資料湖存放區帳戶的使用者介面。 如需指示，請參閱 [開始使用 Azure 入口網站的 Azure 資料湖分析](data-lake-analytics-get-started-portal.md#upload-data-to-the-default-data-lake-store-account)。
