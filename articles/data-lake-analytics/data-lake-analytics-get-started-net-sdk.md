...
6. Az alkalmazás futtatásához nyomja le az **F5** billentyűt. A kimenet a következőképpen fog kinézni:
...
7. Ellenőrizze a kimeneti fájlt.  Az alapértelmezett útvonal és a fájlnév a c:\Temp\SearchLog-from-Data-Lake.csv.
