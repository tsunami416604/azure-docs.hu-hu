...
4. 將新檔案加入專案呼叫 **SampleUSQLScript.txt**, ，然後貼上下列 U SQL 指令碼。 資料湖分析工作是以 U-SQL 語言撰寫。 若要深入了解 U SQL，請參閱 [開始 U SQL 語言使用](data-lake-analytics-u-sql-get-started.md) 和 [U SQL 語言參考](http://go.microsoft.com/fwlink/?LinkId=691348)。
    ...
    在 C# 程式中，您將需要準備 **/Samples/Data/SearchLog.tsv** 檔案，而 **/Output/** 資料夾。    
