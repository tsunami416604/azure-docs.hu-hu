...
1. Nyissa meg a Azure Data Lake Analytics https://portal.azure.com használatával.
...
5. A **katalógus engedélyeinek kiválasztása** lépésben válassza ki azokat az adatbázisokat, amelyekre a felhasználónak hozzá kell férnie. A feladatok elküldéséhez olvasási és írási hozzáférés szükséges a Master adatbázishoz. Ha elkészült, kattintson az **OK** gombra.
...
1. Kövesse az útmutató utasításait: [Azure PowerShell telepítése és konfigurálása](https://azure.microsoft.com/documentation/articles/powershell-install-configure/).
