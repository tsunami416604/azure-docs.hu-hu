---
title: Azure Data Lake Analytics kezelése az Azure portál használatával
description: A cikkből megtudhatja, hogyan használható az Azure-portálon kezelheti a Data Lake Analytics-fiókok, adatforrások, felhasználók és feladatok.
...
ms.locfileid: "34623706"
---
# <a name="manage-azure-data-lake-analytics-using-the-azure-portal"></a>Azure Data Lake Analytics az Azure portál használatával kezelése
[!INCLUDE [manage-selector](../../includes/data-lake-analytics-selector-manage.md)]

Ez a cikk ismerteti az Azure Data Lake Analytics-fiókok, adatforrások, felhasználók és feladatok kezelése az Azure portál használatával.
