...
Mivel az U-SQL típusa rendszer a .NET Type rendszeren alapul, és a Spark saját típusú rendszert használ, amelyet a gazdagép nyelvi kötése érint, meg kell győződnie arról, hogy a jelenleg használt típusok le vannak zárva, és bizonyos típusok esetén a típus tartományai , a pontosság és/vagy a skála némileg eltérő lehet. Emellett a U-SQL és a Spark a `null` értékeket különbözőképpen kezeli.
