...
3. Írja be vagy válassza ki az alábbi értékeket:
   ...
   * **Data Lake Store**: Kattintson a *Kötelező beállítások konfigurálása* lehetőségre. Az útmutatást követve hozzon létre egy új Data Lake Store-fiókot, vagy válasszon ki egy már meglévőt. Minden Data Lake Analytics-fiókhoz tartozik egy függőségként kezelt Data Lake Store-fiók. A Data Lake Analytics-fióknak és a függő Data Lake Store-fióknak ugyanabban az Azure-adatközpontban kell lennie.
4. Tarifacsomag kiválasztása  
5. Kattintson a **Létrehozás** gombra. Ezzel visszatér a portál főoldalára, ahol megjelenik egy új, „Az Azure Data Lake Analytics telepítése” feliratú csempe. Az üzembe helyezési folyamatnak néhány percre szüksége lehet a Data Lake Analytics-fiók létrehozásához. Ha a fiók kész, a portál megnyitja a fiókot egy új panelen.
