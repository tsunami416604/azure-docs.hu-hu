...
## <a name="getstarted"></a>WebJobs 和 WebJobs SDK 快速入門
...
* [Microsoft 典範與實例的背景工作指引](https://github.com/mspnp/azure-guidance/blob/master/Background-Jobs.md)
* [宣佈 1.0.0 RTM 的 Microsoft Azure WebJobs SDK](/blog/2014/10/25/announcing-the-1-0-0-rtm-of-microsoft-azure-webjobs-sdk/)
...
* 影片
    ...
    * [Channel 9 上 azure WebJobs 影片系列](http://channel9.msdn.com/Tags/azurefridaywebjobs)
...
* [Git 將.NET 主控台應用程式部署到 Azure 中使用 WebJobs](http://blog.amitapple.com/post/73574681678/git-deploy-console-app/)
* [將 F # WebJob 部署至 Azure](http://blogs.msdn.com/b/dave_crooks_dev_blog/archive/2015/02/18/deploying-f-web-job-to-azure.aspx)
* [為 Azure Webjob 部署自訂的服務](http://withouttheloop.com/articles/2015-06-23-deploying-custom-services-as-azure-webjobs/)
* 影片
    * [Visual Studio 的 WebJobs 工具簡介](http://channel9.msdn.com/Shows/Web+Camps+TV/Introducing-WebJobs-Tooling-for-Visual-Studio-with-Brady-Gaster)
    * [WebJobs 工具和遠端偵錯](http://channel9.msdn.com/Shows/Web+Camps+TV/WebJobs-GA-Series-Episode-1-WebJobs-Tooling-with-Brady-Gaster)
...
* [連結到 web 工作排程器工作](http://blog.davidebbo.com/2015/05/scheduled-webjob.html)
* [排程 Azure Webjob cron 運算式](http://blog.amitapple.com/post/2015/06/scheduling-azure-webjobs/)

## <a name="debug"></a>測試和偵錯 WebJobs

* [新的開發人員與偵錯功能的 Visual Studio 中的 Azure WebJobs](http://blogs.msdn.com/b/webdev/archive/2014/11/12/new-developer-and-debugging-features-for-azure-webjobs-in-visual-studio.aspx)
* [檢視 Webjob 儀表板](websites-dotnet-webjobs-sdk-get-started.md#view-the-webjobs-sdk-dashboard)
* [如何使用 WebJobs SDK 寫入記錄，並在儀表板檢視](websites-dotnet-webjobs-sdk-storage-queues-how-to.md#logs)
...
* [在雲端主控互動式程式碼](http://blogs.msdn.com/b/jmstall/archive/2014/04/26/hosting-interactive-code-in-the-cloud.aspx)
* [取得使用 WebJobs SDK 的本機開發的儀表板](http://blogs.msdn.com/b/jmstall/archive/2014/01/27/getting-a-dashboard-for-local-development-with-the-webjobs-sdk.aspx)
* [將追蹤加入至 Azure WebJobs](http://blogs.msdn.com/b/mcsuksoldev/archive/2014/09/04/adding-trace-to-azure-web-sites-and-web-jobs.aspx)
...
* [調整 Web 應用程式與 Azure 網站](http://msdn.microsoft.com/magazine/dn786914.aspx)
...
* [在 Azure App Service 上執行 Powershell 的 Web 工作](http://blogs.msdn.com/b/nicktrog/archive/2014/01/22/running-powershell-web-jobs-on-azure-websites.aspx)
* [完成時在 Azure 觸發的 WebJobs 接獲通知](http://blog.amitapple.com/post/2014/03/webjobs-notification/)
* [使用 WebJobs 的簡單 Web 應用程式備份保留原則](http://azure.microsoft.com/blog/2014/04/28/simple-web-site-backup-retention-policy-with-webjobs/)
* [Azure Web 應用程式和雲端服務緩慢的第一次要求](http://wp.sjkp.dk/windows-azure-websites-and-cloud-services-slow-on-first-request/)。 示範如何使用 WebJobs 來模擬僅適用於標準定價層的 AlwaysOn 功能。
* [WebJobs 正常關機](http://blog.amitapple.com/post/2014/05/webjobs-graceful-shutdown/#.U72Il_5OWUl)。 WebJobs SDK 順利關機，請參閱 [正常關機](websites-dotnet-webjobs-sdk-storage-queues-how-to.md#graceful).)
...
* [如何運作 [BlobTrigger]?]() http://blogs.msdn.com/b/jmstall/archive/2014/04/17/how-does-blobinput-work.aspx
* [Azure Webjobs SDK 的進階繫結](http://victorhurdugaci.com/advanced-bindings-with-the-windows-azure-web-jobs-sdk/)
* [FREB 檔案上傳至 Azure 儲存體中使用 WebJobs SDK 的 web 工作](http://thenextdoorgeek.com/post/WAWS-WebJob-to-upload-FREB-files-to-Azure-Storage-using-the-WebJobs-SDK)
* [外部代管 Azure webjobs Azure，使用的記錄優勢，從 Azure 代管 webjob](http://bypassion.dk/?p=510)
...
* [Azure 部落格](/blog)
* [Amit Apple's blog](http://blog.amitapple.com/). 著重於 WebJobs (而非 SDK)。
* [Magnus Mårtensson 的部落格](http://magnusmartensson.com/)

## <a name="gethelp"></a>取得使用 WebJobs 的說明

* [WebJobs 的 StackOverflow](http://stackoverflow.com/questions/tagged/azure-webjobs)
* [WebJobs SDK 的 StackOverflow](http://stackoverflow.com/questions/tagged/azure-webjobssdk)
