...
若您在**標準**定價層中執行 Web 應用程式，Web Apps 可讓您從 3 個地理位置監視 2 個端點。
...
您也可以利用 (_s) extensions_ 監視應用程式效能。
...
[Azure Application Insights](/services/application-insights/) 和 [New Relic](/marketplace/partners/newrelic/newrelic/) 是兩個效能監視站台所提供的擴充功能。 若要使用 New Relic，您需要在執行階段安裝代理程式。 若要使用 Azure Application Insights，請透過 SDK 重建程式碼，您也可以安裝可存取其他資料的擴充功能。 SDK 可讓您撰寫程式碼來監視應用程式的詳細使用狀況和效能。
...
[Azure 網站 Team Services 工具，您應該了解](/blog/windows-azure-websites-online-tools-you-should-know-about/)。
