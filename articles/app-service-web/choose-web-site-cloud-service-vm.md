...
- 使用熱門語言，例如 [.Net][dotnet], ，[PHP][], ，[Node.js][nodejs], ，和 [Python][]。
- 有三種不同的調整層級可選，以向上調整至非常高的容量。
- 整合與其他 Azure 服務，例如 [SQL Database][sqldatabase], ，[服務匯流排][servicebus] 和 [儲存體][], ，或合作夥伴供應項目從 [Azure 市集][azurestore], ，例如 MySQL 和 MongoDB。
