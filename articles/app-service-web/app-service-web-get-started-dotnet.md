---
title: "Helyezze üzembe az első .NET-webalkalmazását öt perc alatt az Azure-ban | Microsoft Docs"
...
---
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>Helyezze üzembe az első .NET-webalkalmazását öt perc alatt az Azure-ban
Ez az oktatóanyag egy egyszerű .NET-webalkalmazás üzembe helyezéséhez nyújt segítséget az [Azure App Service-ben](../app-service/app-service-value-prop-what-is.md).
...
## <a name="deploy-an-net-web-app"></a>.NET-alapú webalkalmazás üzembe helyezése
...
4. Váltson egy munkakönyvtárra (a `CD` paranccsal), és klónozza a példaalkalmazást.
