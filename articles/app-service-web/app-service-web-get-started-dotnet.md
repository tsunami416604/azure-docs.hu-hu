<properties 
    pageTitle="Helyezze üzembe az első .NET-webalkalmazását öt perc alatt az Azure-ban | Microsoft Azure" 
...
# Helyezze üzembe az első .NET-webalkalmazását öt perc alatt az Azure-ban
...
1. A parancssori terminálban váltson egy munkakönyvtárba (`CD`), és az alábbi módon klónozza a mintaalkalmazást:
    ...
    ![Az alkalmazás mintakódjának klónozása az első Azure webalkalmazás számára](./media/app-service-web-get-started-languages/dotnet-git-clone.png)
