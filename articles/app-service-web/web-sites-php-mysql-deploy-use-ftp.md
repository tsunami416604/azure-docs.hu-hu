...
2. 按一下 [ **+ 新增** 左下方的 [Azure 入口網站。

    ![Create New Azure Web Site][new-website]

3. 按一下 [ **Web + 行動**, ，然後 **Web 應用程式 + MySQL**。
...
2. 輸入 *主機名稱部分* 從 `publishUrl` 您先前記到您的 FTP 用戶端的屬性。
...
兩者都上傳之後 `index.php` 和 `createtable.php`, ，瀏覽至 **http://[site name].azurewebsites.net/createtable.php** 若要建立應用程式的 MySQL 資料表，然後瀏覽至 **http://[site name].azurewebsites.net/index.php** 開始使用應用程式。
