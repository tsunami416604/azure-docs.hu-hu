...
<td>
[Required for 12.04 or 12.04.01 only][Required for 12.04 or 12.04.01 only]

</td>
<td>
Package: In package repo under walinuxagent
...
<td>
CentOS 6.3: [LIS drivers][here]; CentOS 6.4+ drivers: in Kernel

</td>
<td>
[Required for 6.3 only][Required for 6.3 only]

</td>
<td>
Package:In [Open Logic package repo][Open Logic package repo] under walinuxagent
 Source: [GitHub][GitHub]
...
<td>
Package: In repo, name: WALinuxAgent
 Source: [GitHub][GitHub]
...
<td>
Package: In [Cloud:Tools][Cloud:Tools] repo, name: WALinuxAgent
...
<sup>1</sup> **Note:** CoreOS on Azure is currently in developer preview (*alpha*).

  [this page]: ../virtual-machines-linux-create-upload-vhd/
  ...
  [here]: http://go.microsoft.com/fwlink/?LinkID=403033&clcid=0x409
  [Github]: https://github.com/azure/walinuxagent
  [Linux kernel compatibility patch]: http://go.microsoft.com/fwlink/?LinkID=403027&clcid=0x409
  [Required for 12.04 or 12.04.01 only]: http://go.microsoft.com/fwlink/?LinkID=275152&clcid=0x409
  [GitHub]: http://go.microsoft.com/fwlink/p/?LinkID=250998
  [Required for 6.3 only]: http://go.microsoft.com/fwlink/?LinkID=275153&clcid=0x409
  [Open Logic package repo]: http://olcentgbl.trafficmanager.net/openlogic/6/openlogic/x86_64/RPMS/
