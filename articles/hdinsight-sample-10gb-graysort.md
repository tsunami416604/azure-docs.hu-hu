...
1.  [Run the sample with Azure PowerShell][Run the sample with Azure PowerShell]
2.  [The Java code for the TeraSort MapReduce program][The Java code for the TeraSort MapReduce program]
3.  [Summary][Summary]
...
3.  Run the following command to create a MapReduce job definition"
...
4.  Run the following commands to submit job, wait for job to complete and then print the standard error:
...
## <span id="java-code"></span></a>The Java code for the TerraSort MapReduce program
...
## <span id="summary"></span></a>Summary
...
-   [Sample: Pi estimator][Sample: Pi estimator]
-   [Sample: Wordcount][Sample: Wordcount]
-   [Sample: C# Steaming][Sample: C# Steaming]
...
-   [Azure HDInsight SDK documentation][Azure HDInsight SDK documentation]
  ...
  [The Java code for the TeraSort MapReduce program]: #java-code
  [Summary]: #summary
