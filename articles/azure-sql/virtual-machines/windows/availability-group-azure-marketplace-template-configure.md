...
![Tesztkörnyezet architektúrája rendelkezésre állási csoportok számára az Azure-ban](./media/availability-group-azure-marketplace-template-configure/0-EndstateSample.png)
