...
Az Azure-beli virtuális gépeken futó SQL Server legjobb teljesítményének megismeréséhez tekintse meg az [Virtual Machines Azure-beli SQL Server teljesítményével kapcsolatos ajánlott eljárások](performance-guidelines-best-practices.md)című témakör útmutatását.
