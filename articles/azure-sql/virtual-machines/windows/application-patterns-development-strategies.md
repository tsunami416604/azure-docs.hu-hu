...
* Szeretné kihasználni az Azure-környezet képességeit, de a Azure SQL Database nem támogatja az alkalmazás által igényelt összes funkciót. Ez a következő területeket tartalmazhatja:
  ...
  * **HIPAA-megfelelőség**: az egészségügyi ügyfelek és a független szoftvergyártók (ISV-EK) az azure [Azure SQL Database](../../database/sql-database-paas-overview.md) [Virtual Machines-ben választhatnak SQL Server az Azure-ban](sql-server-on-azure-vm-iaas-what-is-overview.md) , mert az Azure-beli virtuális gépeken lévő SQL Servert a HIPAA Business Associate Agreement (Baa) szabályozza. A megfelelőséggel kapcsolatos információkért lásd [: Microsoft Azure Adatvédelmi központ: megfelelőség](https://azure.microsoft.com/support/trust-center/compliance/).
...
![Alkalmazás mintája – bemutatási réteg felskálázása](./media/application-patterns-development-strategies/IC728010.png)
...
![Alkalmazási minta üzleti szintű vertikális felskálázással](./media/application-patterns-development-strategies/IC728011.png)
...
A magas rendelkezésre állással és a vész-helyreállítási technikákkal kapcsolatos átfogó információk és oktatóanyagok: a [magas rendelkezésre állás és a vész-helyreállítás az Azure Virtual Machines SQL Server](business-continuity-high-availability-disaster-recovery-hadr-overview.md).
