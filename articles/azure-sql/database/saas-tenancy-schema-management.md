...
További információt a [Elastic Database feladatok](./elastic-jobs-overview.md) című cikkben talál.
...
* az **SP \_ Add \_ Job** létrehoz egy _hivatkozási adatok központi telepítés_ nevű feladatot.
