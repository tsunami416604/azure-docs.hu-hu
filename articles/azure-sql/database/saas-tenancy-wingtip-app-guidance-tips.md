...
A [SQL Server Management Studio (SSMS)](/sql/ssms/download-sql-server-management-studio-ssms) használatával csatlakozhat, és böngészhet az alkalmazás-kiszolgálók és-adatbázisok között.
