...
- [Az adattömörítés](https://docs.microsoft.com/sql/relational-databases/data-compression/data-compression) megvalósítása
- A készlet vertikális felskálázása egy szolgáltatási célkitűzésre a készlet nagyobb maximális méretével
