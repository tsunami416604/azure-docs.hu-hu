...
ms.locfileid: "84054496"
---
# <a name="quickstart-use-golang-to-query-a-azure-sql-database"></a>Rövid útmutató: Azure SQL Database-adatbázis lekérdezése a Golang használatával
...
2. A használatával `sqlcmd` csatlakozhat az adatbázishoz, és futtathatja az újonnan létrehozott SQL-szkriptet. Helyettesítse be a kiszolgáló és az adatbázis megfelelő adatait, valamint a felhasználónevet és a jelszót.
...
- [Az első Azure SQL-adatbázis megtervezése](design-first-database-tutorial.md)
