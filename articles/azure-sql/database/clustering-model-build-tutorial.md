...
* Az oktatóanyag második része feltételezi, hogy elvégezte az [**első részt**](clustering-model-prepare-data-tutorial.md) , és annak előfeltételeit.
...
![Könyök gráf](./media/clustering-model-build-tutorial/elbow-graph.png)
...
A négy fürt a következő [részben](clustering-model-prepare-data-tutorial.md#separate-customers)meghatározott változók használatával van megadva:
...
***Ha nem folytatja ezt az oktatóanyagot***, törölje a tpcxbb_1gb adatbázist a kiszolgálóról.
...
> [Oktatóanyag: fürtszolgáltatási modell üzembe helyezése az R-ben Azure SQL Database Machine Learning Services (előzetes verzió)](clustering-model-deploy-tutorial.md)
