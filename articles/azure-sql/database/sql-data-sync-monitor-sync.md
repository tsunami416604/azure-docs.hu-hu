...
![Adatszinkronizálás monitorozási irányítópultja](./media/sql-data-sync-monitor-sync/sync-monitoring-dashboard.png)
...
![Adatszinkronizálási értesítő e-mailek](./media/sql-data-sync-monitor-sync/sync-email-notifications.png)
...
-   [Az SQL Database áttekintése](../../sql-database/sql-database-technical-overview.md)
