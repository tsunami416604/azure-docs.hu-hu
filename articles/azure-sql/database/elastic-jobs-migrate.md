...
- A kiszolgálók és adatbázisok legfelső szintű célpontjai a "(,)" nevű új célcsoportra lesznek áttelepítve, amely \<serverName\> \<databaseName\> csak a legfelső szintű célt tartalmazza.
