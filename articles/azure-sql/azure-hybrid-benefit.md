...
![árképzési](./media/azure-hybrid-benefit/pricing.png)
...
- A szolgáltatás az Azure-ban (SQL Database felügyelt példányon) található, nagyvállalati szintű, SQL Serversal kompatibilis.
