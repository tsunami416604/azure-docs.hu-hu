...
Base64-kódolása az Nginx konfigurációs fájlját, az SSL-tanúsítvány és az SSL-kulcsot. A kódolt tartalom használatával konfigurálja az Nginx-tároló.
...
Adja meg a tartalmát a base64-kódolású felsoroltak közül a fájlok `secret`. A telepítés során ezek a fájlok kerülnek egy [titkos kötet](container-instances-volume-secret.md) tárolócsoportban. Ebben a példában a titkos kötet csatlakoztatva van a Nginx-tároló.
