...
1. A VS Code-ban keresse meg a `deployment.template.json` fájlt. Cserélje le a Node.js-modul createOptions a **deployment.template.json** az alábbi tartalmat, és mentse a fájlt: 
    ```json
