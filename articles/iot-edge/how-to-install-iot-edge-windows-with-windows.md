---
title: Telepítse az Azure IoT Edge Windows a Windows-tárolók |} A Microsoft Docs
description: A Windows-tárolókhoz konfigurált Windows-eszközök Azure IoT Edge telepítési utasításokat
author: kgremban
manager: philmea
ms.reviewer: veyalla
ms.service: iot-edge
