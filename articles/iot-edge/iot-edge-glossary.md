...
* Lásd: [IoT-központ szószedet](#iot-hub-devguide-glossary.md)
* Ismerje meg, IoT peremhálózati [modul fejlesztési](https://docs.microsoft.com/en-us/azure/iot-edge/iot-edge-modules)
* Ismerje meg, IoT peremhálózati [központi telepítés](https://docs.microsoft.com/en-us/azure/iot-edge/module-deployment-monitoring)
