...
3. Az 35. sorban cserélje le a karakterláncot **\<SQL-kapcsolatok karakterláncát\>** a következő karakterlánccal. Az **adatforrás** tulajdonság a SQL Server tárolóra hivatkozik, amely még nem létezik. A következő szakaszban létre kell hoznia az **SQL** néven.
