...
1. A VS Code Explorerben nyissa meg a **modules** > **sqlFunction** > **sqlFunction.cs**.
...
3. Az 35. sorban cserélje le a karakterláncot **\<SQL-kapcsolatok karakterláncát\>** a következő karakterlánccal. Az **adatforrás** tulajdonság a SQL Server tárolóra hivatkozik, amely még nem létezik, de a következő szakaszban található **SQL** néven fogja létrehozni. 
