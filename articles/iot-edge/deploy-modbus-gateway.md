...
5. Válassza ki a Modbus modult, `ModbusTCPModule`, a listáról, és válassza ki a **modul Twin beállítások** lapot. A modulhoz tartozó, dupla kívánt tulajdonságok esetében a szükséges JSON automatikusan ki van töltve.
...
9. Térjen vissza az eszköz részleteit tartalmazó oldalra, és kattintson a **Frissítés** elemre. Meg kell jelennie az új `ModbusTCPModule` modulnak, amely a IoT Edge futtatókörnyezettel együtt fut.
