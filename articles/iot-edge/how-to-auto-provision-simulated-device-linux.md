...
1. A Visual Studióban nyissa meg `cmake` a nevű `azure_iot_sdks.sln`könyvtárban létrehozott megoldást, és hozza létre a Build menü Build **Solution** parancsának **Build** használatával.
