...
Adja meg a következő szöveget, és cserélje le **\<proxy URL >-** címét a proxykiszolgáló címére és portjára. Ezután mentse és lépjen ki.
...
Nyisson meg egy PowerShell-ablakot rendszergazdaként, és futtassa a következő parancsot a beállításjegyzék új környezeti változóval való szerkesztéséhez. Cserélje le **\<proxy URL->** a proxykiszolgáló címére és portjára.
