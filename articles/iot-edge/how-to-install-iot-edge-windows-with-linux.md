---
title: Telepítse az Azure IoT Edge Windows a Linux-tárolók |} A Microsoft Docs
description: Az Azure IoT Edge a Linux-tárolókhoz konfigurált Windows-eszközök telepítési utasításokat
author: kgremban
manager: philmea
ms.reviewer: veyalla
ms.service: iot-edge
