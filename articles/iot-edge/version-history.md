...
* A **IoT Edge 1,2 (előzetes verzió)** további tartalmakat tartalmaz a legújabb előzetes kiadásban elérhető funkciókhoz és képességekhez: [1,2-RC1](https://github.com/Azure/azure-iotedge/releases/tag/1.2-rc1)
