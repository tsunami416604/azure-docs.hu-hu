...
Az eszköz manuális kiépítéséhez meg kell adnia azt egy eszköz- [kapcsolódási karakterlánctal](how-to-register-device-portal.md) , amelyet létrehozhat egy új eszköz regisztrálásával az IoT hub-ban.
