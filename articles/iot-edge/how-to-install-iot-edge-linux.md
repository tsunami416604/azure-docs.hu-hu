...
Az eszköz előkészítése az IoT Edge modul telepítése, és cserélje le ```<release>``` a **16.04** vagy **18.04** az Ubuntu kiadásának megfelelő módon.
