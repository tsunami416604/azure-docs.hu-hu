...
Ebben a szakaszban hozzáadja a szimulált IoT peremhálózati eszköz egy MS-SQL-adatbázis. Az SQL Server 2017 docker tároló rendszerképet használja, elérhető egy [Windows](https://hub.docker.com/r/microsoft/mssql-server-windows-developer/) tároló és regisztrációja, mivel egy [Linux](https://hub.docker.com/r/microsoft/mssql-server-linux/) tároló. 
...
3. Cserélje le a `<docker registry address>` kitölteni a befejezett oktatóanyag címmel [egy IoT-Edge-modul telepítése Azure funkciót](tutorial-deploy-function.md).
