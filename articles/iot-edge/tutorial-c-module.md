...
1. Ebben a forgatókönyvben az érzékelőről származó adatok JSON formátumban szerepelnek. A JSON formátumú üzenetek szűréséhez importáljon egy C-hez készült JSON-kódtárat. Ez az oktatóanyag Parson-kódtárat használ.
   ...
   2. Nyissa meg a **modulok** > **CModule** > **CMakeLists. txt fájlt**. A fájl tetején importálja a Parson-fájlokat **my_parson** nevű kódtárként.
   ...
   3. Adja `my_parson` hozzá a kódtárak listáját a CMakeLists. txt **target_link_libraries** függvényében.
...
1. A VS Code Explorerben nyissa meg az **üzembe helyezés. template. JSON** fájlt a IoT Edge megoldás munkaterületen.
