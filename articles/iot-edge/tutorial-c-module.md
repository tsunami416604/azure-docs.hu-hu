...
1. **View**  >  A vs Code parancs paletta megnyitásához kattintson a**parancs paletta** megtekintése elemre.
...
1. Nyissa meg a vs Code terminált a terminál **megtekintése**lehetőség kiválasztásával  >  **Terminal**.
