...
| runtime.settings.registryCredentials<br>. {registryId} .username | A tároló-beállításjegyzék felhasználóneve. Az Azure Container Registry esetében a felhasználónév általában a beállításjegyzék nevét.<br><br> A beállításjegyzékbeli hitelesítő adatok szükségesek a privát modulok képeihez. | Nem |
