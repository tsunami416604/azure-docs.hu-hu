...
4. Az a **virtuális hálózati átjáró létrehozása** lapon, töltse ki a virtuális hálózati átjáró értékeit:
   ...
   - **Név**: Adja meg egy nevet az átjáró objektumot hoz létre. Ez a név nem egyezik az átjáró-alhálózat neve. 

   - **Átjáró típusa**: Válassza ki **VPN** VPN-átjárókhoz. 

   - **VPN-típust**: Válassza ki a konfigurációjához megadott VPN-típust. A legtöbb konfigurációt igényelnek a **útvonalalapú** VPN-típust.
   ...
   - **Átjáróalhálózat címtartománya**: Ez a beállítás csak akkor látható, ha korábban létrehozott átjáró-alhálózatot a virtuális hálózat. Ha korábban már létrehozott egy érvényes átjáró-alhálózatot, akkor ez a beállítás nem jelenik meg.
   ...
   - **BGP ASN konfigurálása**: Ez a beállítás nincs kiválasztva, hagyja, kivéve, ha a konfiguráció kifejezetten igényel. Ha ezt a beállítást igényel, az alapértelmezett ASN szám van *65515*, amelyet módosíthat.
