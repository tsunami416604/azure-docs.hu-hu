...
1. Az [Azure Portalon](https://portal.azure.com) kattintson az **Összes erőforrás** lehetőségre, és keresse meg a virtuális hálózati átjárót.
...
3. Kattintson az ellenőrizni kívánt kapcsolat nevére az **Alapvető erőforrások** megnyitásához. Az Alapvető erőforrások panelen áttekintheti a kapcsolat további adatait. Az **Állapot** „Sikeres” vagy „Csatlakoztatva” értékű, ha a kapcsolat sikeresen létrejött.
   ...
   ![VPN Gateway-kapcsolat ellenőrzése az Azure Portallal](./media/vpn-gateway-verify-connection-portal-rm-include/connection-succeeded.png)
