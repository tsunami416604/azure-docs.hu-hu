...
- [(Windows 8.x 市集 C# |.NET)](../articles/mobile-services-dotnet-backend-windows-store-dotnet-add-paging-data.md)
- [(Windows 8.x 市集 C# |) Javascript](../articles/mobile-services-windows-store-dotnet-add-paging-data.md)
- [(Windows 8.x 市集 JavaScript |.NET)](../articles/mobile-services-dotnet-backend-windows-store-javascript-add-paging-data.md)
- [(Windows 8.x 市集 JavaScript |) Javascript](../articles/mobile-services-windows-store-javascript-add-paging-data.md)
