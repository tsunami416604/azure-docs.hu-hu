...
| --- | --- |
| Azure AD Domain Services | [Azure AD tartományi szolgáltatásokat tartalmazó virtuális hálózatok](../articles/active-directory-domain-services/migrate-from-classic-vnet.md) |
