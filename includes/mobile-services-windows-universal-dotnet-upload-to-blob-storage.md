...
2. 在左窗格中，選取 **線上** 類別、 搜尋 `WindowsAzure.Storage`, ，按一下 [ **安裝** 上 **Azure 儲存體** 套件，然後接受授權合約。 
...
1. 在 Visual Studio 中開啟 Package.appxmanifest 檔案，針對 Windows 應用程式專案，並在 **功能** 索引標籤中啟用 **網路攝影機** 和 **麥克風** 功能。
...
3. 按一下或點選預覽以拍照，然後按一下 [ **上載** 插入新項目並上傳映像。
