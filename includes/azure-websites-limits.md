...
---|---|---|---|---|---
[Web、 行動、 或 API 應用程式](../services/app-service/) 每 [應用程式服務方案](web-sites-web-hosting-plan-overview.md)<sup>1</sup>|10|100|無限制<sup>2</sup>|無限制<sup>2</sup>|無限制<sup>2</sup>
...
[排定的備份](web-sites-backup.md)||||一天一次|每 5 分鐘一次<sup>8</sup>
