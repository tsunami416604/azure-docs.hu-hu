...
A **importálási/exportálási JSON-fájlok használata-a/Azure Cosmos DB van**, lásd: [importálási/exportálási JSON-dokumentumok](../articles/data-factory/v1/data-factory-azure-documentdb-connector.md#importexport-json-documents) című szakaszában találhat az Azure Cosmos DB összekötő adatokkal.
