...
A teljesen automatizált Virtual WAN-t jelenleg a Citrix és a Riverbed támogatja. További információ: [Virtual WAN-partnerek](https://go.microsoft.com/fwlink/p/?linkid=2019615).
...
A virtuális központban irányíthatom UDR-rel a forgalmat?
...
### <a name="is-there-any-licensing-or-pricing-information-for-virtual-wan"></a>Elérhető valamilyen licenc- vagy díjszabási információ a Virtual WAN-ról?
...
A virtuális hálózati (VPN-) átjáró legfeljebb 30 alagutat támogat. Kapcsolatokhoz nagy mennyiségű VPN-forgalmat bonyolító Virtual WAN használata javasolt. A rendszer legfeljebb 100 ágak közötti kapcsolatot támogat, és 2 Gb/s sebességet biztosít központonként. A kapcsolatok aktív-aktív alagútnak minősülnek a helyszíni VPN-eszköz és a virtuális központ között. Régiónként egy központtal rendelkezhet, ami azt jelenti, hogy 100-nál is több ágat csatlakoztathat a központok között.
...
Az ágak száma központonként/régiónként legfeljebb 100 kapcsolat lehet, és a központban 2 G sebesség érhető el.
