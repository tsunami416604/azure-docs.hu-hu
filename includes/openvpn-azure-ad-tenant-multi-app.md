...
## <a name="users"></a>2. bérlői felhasználók létrehozása
...
## <a name="register-client"></a>3. regisztrálja a VPN-ügyfelet
...
## <a name="register-apps"></a>4. További alkalmazások regisztrálása
...
## <a name="assign-users"></a>5. felhasználók kiosztása alkalmazásokhoz
