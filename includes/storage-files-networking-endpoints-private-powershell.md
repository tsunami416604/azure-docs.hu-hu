...
Az Azure saját DNS-zóna létrehozása lehetővé teszi a Storage-fiók eredeti nevét, például a `storageaccount.file.core.windows.net` virtuális hálózatban lévő magánhálózati IP-címek feloldását. Bár a privát végpontok létrehozásának perspektívája nem kötelező, explicit módon szükséges az Azure-fájlmegosztás közvetlen csatlakoztatása az AD-felhasználóhoz, vagy a REST API keresztüli hozzáférés.  
