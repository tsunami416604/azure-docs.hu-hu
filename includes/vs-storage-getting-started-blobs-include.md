...
There are others ways to list the contents of a blob container. See [How to use Blob Storage from .NET][How to use Blob Storage from .NET] for more information.
...
There are other ways to save blobs as files. See [How to use Blob Storage from .NET][1] for more information.
...
[Learn more about Azure Storage][Learn more about Azure Storage]
See also [Browsing Storage Resources in Server Explorer][Browsing Storage Resources in Server Explorer].

  [How to use Blob Storage from .NET]: http://azure.microsoft.com/en-us/documentation/articles/storage-dotnet-how-to-use-blobs/#list-blob
  ...
  [Browsing Storage Resources in Server Explorer]: http://msdn.microsoft.com/en-us/library/azure/ff683677.aspx
