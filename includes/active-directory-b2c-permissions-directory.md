...
1. Válassza ki **Azure Active Directory gráfot**.
1. Válassza ki az **alkalmazás engedélyeit**.
1. Bontsa ki a **könyvtár** csomópontot, majd válassza a **Directory. ReadWrite. All** jelölőnégyzetet.
...
1. Válasszon ki egy bérlői rendszergazdai fiókot.
