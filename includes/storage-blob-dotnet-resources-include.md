...
- [API-referenciák dokumentációja](/dotnet/api/overview/azure/storage/client)
...
- [Csomag (NuGet) a 12. x verzióhoz – előzetes verzió](https://www.nuget.org/packages/Azure.Storage.Blobs)
