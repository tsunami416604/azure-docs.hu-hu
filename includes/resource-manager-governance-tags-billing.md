...
Használhatja az [Azure-beli számlázási API-kat](../articles/cost-management-billing/manage/usage-rate-card-overview.md) is a költségek programozott módon való megtekintéséhez.
