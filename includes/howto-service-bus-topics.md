...
6.  讓對話方塊中的其他欄位保留其預設值 (**Messaging** 和 **標準層**)，然後按一下核取記號。 此時系統會建立並啟用服務命名空間。 系統為帳戶提供資源時，您可能需要等幾分鐘。
...
1.  在左的導覽窗格中，按一下 [ **服務匯流排** 節點以顯示可用的命名空間清單:   
    ![][0]
