...
További információ az Azure-előfizetések és fiókok: [hogyan: Csatlakozzon az előfizetéséhez](/powershell/azureps-cmdlets-docs#step-3-connect).
