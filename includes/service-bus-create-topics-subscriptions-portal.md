...
## <a name="create-a-subscription-to-the-topic"></a>Előfizetés létrehozása az üzenettémához
...
3. Az a **előfizetés létrehozása** lap, adja meg egy **neve** az előfizetést, és válassza ki a **létrehozás**. 
