將驗證新增至您的行動應用程式: [iOS ][ios-get-started-users], ，[Xamarin.iOS ][xamarin-ios-get-started-users], ，[Xamarin.Android ][xamarin-android-get-started-users], ，[Windows 通用 ][windows-get-started-users]。
