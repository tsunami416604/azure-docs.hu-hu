...
ms.locfileid: "88077431"
---
* [App Service hitelesítés/engedélyezés áttekintése](../articles/app-service/overview-authentication-authorization.md).
* [A hitelesítés és az engedélyezés speciális használata Azure App Service](../articles/app-service/app-service-authentication-how-to.md)
* [Oktatóanyag: Felhasználók hitelesítése és engedélyezése végpontok között az Azure App Service-ben](../articles/app-service/tutorial-auth-aad.md)
* Hitelesítés hozzáadása a Mobile alkalmazáshoz: [iOS][ios-get-started-users], [Android][android-get-started-users], [Windows Universal][windows-get-started-users], [Xamarin. Android][xamarin-android-get-started-users], [Xamarin. iOS][xamarin-ios-get-started-users], [Xamarin. Forms][xamarin-forms-get-started-users], [Cordova][cordova-get-started-users].  
