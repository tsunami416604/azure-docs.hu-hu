...
ms.locfileid: "70232034"
---
* [App Service-hitelesítés / engedélyezés – áttekintés.](../articles/app-service/overview-authentication-authorization.md)
* [A hitelesítés és az engedélyezés speciális használata az Azure App Service szolgáltatásban](../articles/app-service/app-service-authentication-how-to.md)
* Add hitelesítés a mobil app: [iOS][ios-get-started-users], [Android][android-get-started-users], [Windows Universal][windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Forms][xamarin-forms-get-started-users], [Cordova][cordova-get-started-users].  
