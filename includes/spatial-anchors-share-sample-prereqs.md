...
* Fejezze be az [5 perces rövid](../articles/spatial-anchors/index.yml)útmutatók egyikét, és győződjön meg arról, hogy megfelel a választott gyors útmutatóban felsorolt előfeltételeknek. **Megjegyzés:** Az Android/NDK és az iOS/Swift gyors útmutatója jelenleg nem mutatja be az oktatóanyagban ismertetett képességeket.
...
* Egy vagy több eszköz (HoloLens, HoloLens 2, iOS vagy Android), amelyen üzembe helyezheti és futtathatja az alkalmazást.
