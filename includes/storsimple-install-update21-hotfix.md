...
3. A keresési mezőbe, a Microsoft Update katalógus, adja meg a Tudásbázis (KB) le szeretné tölteni, például a gyorsjavítás **3179904**, és kattintson a **keresési**.
   
    A gyorsjavítás-lista megjelenik, például **összegző szoftverfrissítési csomagot frissítés 2.2 a StorSimple 8000 Series**.
...
5. A fenti táblázatban szereplő további gyorsjavítások keresése (**3103616**, **3146621**), és adja hozzá a kosárhoz mindegyik.
...
4. Írja be az **Y** karaktert, amikor a rendszer kéri, hogy erősítse meg a gyorsjavítás telepítését.
   ...
   > [!IMPORTANT]
   > 2.2-es frissítés telepítése esetén csak a bináris fájl végrehajtásával kerüli meg a "minden-hcsmdssoftwareudpate" telepítéséhez. Ne telepítse a Konfigurációelemek és az MDS-ügynök végrehajtásával kerüli meg minden-cismdsagentupdatebundle a frissítése. Elmulasztása hibát eredményez. 
...
1. A szoftverfrissítés befejeztét követően ellenőrizze a rendszerszoftverek verzióját. Típus:
   ...
   * `MdsAgentVersion: 30.0.4698.16` 
     ...
     > 
     > 
2. Ismételje meg a 3-5 a fennmaradó normál módú gyorsjavításainak telepítéséhez.
   
   * Az iSCSI-frissítés KB3146621
   * A WMI-frissítés KB3103616
3. Kihagyhatja ezt a lépést, a 2. frissítés frissítésekor. 2. frissítés előtt verziójából származó frissítésekor, is szüksége lesz töltheti le:

    - A LSI illesztőprogram KB3121900

    - A Spaceport frissítés KB3090322

    - A Storport-frissítés KB3080728
