...
Több módon is ellenőrizheti, hogy a tároló fut-e. Keresse meg a kérdéses tároló *külső IP-* címét és a hozzá tartozó portot, és nyissa meg a kedvenc webböngészőjét. Az alábbi kérelmek URL-címeivel ellenőrizheti, hogy a tároló fut-e. Az alábbi példa a kérelem URL- `http://localhost:5000`címeit tartalmazza, de az adott tároló eltérő lehet. Ne feledje, hogy a tároló *külső IP-* címére és az elérhető portra támaszkodik.
