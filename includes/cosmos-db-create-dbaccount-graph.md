...
3. Az **Új fiók** panelen adja meg az Azure Cosmos DB-fiók kívánt beállításait. 
    ...
    Töltse ki az **Új fiók** panel mezőit a következő képernyőfelvételen látható információk alapján. Mivel a saját értékek nem egyeznek majd a képernyőfelvételen lévőkkel, a fiók beállítása során mindenképp egyedi értékeket válasszon. 
 
    ![Az Azure Cosmos DB panel](./media/cosmos-db-create-dbaccount-graph/create-nosql-db-databases-json-tutorial-2.png)
...
5. Az eszköztáron kattintson az **Értesítések** parancsra az üzembe helyezési folyamat megfigyeléséhez.
    ...
    ![Központi telepítés elindítva értesítés](./media/cosmos-db-create-dbaccount-graph/azure-documentdb-nosql-notification.png)
