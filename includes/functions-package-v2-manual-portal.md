...
|----------------------|----------------|
|Helyi fejlesztés – C# osztálytár       | [A csomag telepítése](../articles/azure-functions/functions-bindings-register.md#c-class-library-with-visual-studio-2019) |
|Helyi fejlesztés – C# parancsfájl, JavaScript,F# |[A bővítmény regisztrálása](../articles/azure-functions/functions-bindings-register.md#local-development-with-azure-functions-core-tools-and-extension-bundles)         |
