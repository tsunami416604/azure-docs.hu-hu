...
3. 按兩下安裝程式。 StorSimple Adapter for SharePoint 安裝精靈隨即啟動。 按一下 [ **下一步** 開始安裝。

    ![StorSimple 配接器安裝開始頁面](./media/storsimple-install-sharepoint-adapter/HCS_SSASP_Setup1-include.png)

4. 在 StorSimple Adapter for SharePoint 安裝設定頁面中，選取 [安裝位置，輸入您的 StorSimple 裝置上的 DATA 0 網路介面的 IP 位址，然後按一下 **下一步**。 
