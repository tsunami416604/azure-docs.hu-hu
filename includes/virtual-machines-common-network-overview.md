...
| [Azure PowerShell](../articles/virtual-machines/windows/multiple-nics.md) | Használat [New-AzNetworkInterface](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermnetworkinterface) együtt a **- PublicIpAddressId** paraméterrel a korábban létrehozott nyilvános IP-cím az azonosító. |
...
| [Azure PowerShell](../articles/virtual-network/virtual-network-deploy-static-pip-arm-ps.md) | Használhat [New-AzPublicIpAddress](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermpublicipaddress) az a **- AllocationMethod** Dynamic vagy Static paraméter. |
...
| [Azure PowerShell](../articles/virtual-network/tutorial-filter-network-traffic.md) | Használat [New-AzNetworkSecurityRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermnetworksecurityruleconfig) , és adja meg a szükséges szabályra vonatkozó információkat. Használat [New-AzNetworkSecurityGroup](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermnetworksecuritygroup) az NSG létrehozásához. Használat [Set-AzVirtualNetworkSubnetConfig](https://docs.microsoft.com/powershell/module/azurerm.network/set-azurermvirtualnetworksubnetconfig) az alhálózathoz tartozó NSG konfigurálásához. Használat [Set-AzVirtualNetwork](https://docs.microsoft.com/powershell/module/azurerm.network/set-azurermvirtualnetwork) adhatja az NSG-t a virtuális hálózathoz. |
...
| [Azure PowerShell](../articles/load-balancer/load-balancer-get-started-internet-arm-ps.md) | A korábban létrehozott nyilvános IP-cím azonosítójának megadásához használja [New-AzLoadBalancerFrontendIpConfig](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermloadbalancerfrontendipconfig) együtt a **- PublicIpAddress** paraméter. Használat [New-AzLoadBalancerBackendAddressPoolConfig](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermloadbalancerbackendaddresspoolconfig) hozhat létre a háttér-címkészletet konfigurációját. Használat [New-AzLoadBalancerInboundNatRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermloadbalancerinboundnatruleconfig) létrehozott előtérbeli IP-konfigurációhoz tartozó bejövő NAT-szabályok létrehozásához. Használat [New-AzLoadBalancerProbeConfig](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermloadbalancerprobeconfig) szükséges mintavételezők létrehozásához. Használat [New-AzLoadBalancerRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermloadbalancerruleconfig) a terheléselosztó konfigurációjának létrehozásához. Használat [New-AzLoadBalancer](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermloadbalancer) hozhat létre a terheléselosztót.|
