...
| [Azure PowerShell](../articles/virtual-machines/windows/multiple-nics.md) | Használjon [New-AzureRmNetworkInterface](/powershell/module/azurerm.network/new-azurermnetworkinterface) a a **- PublicIpAddressId** paramétert adja meg a nyilvános IP-cím, amelyet korábban hozott létre azonosítóját. |
| [Azure CLI](../articles/virtual-machines/linux/multiple-nics.md) | A nyilvános IP-cím, amelyet korábban hozott létre azonosítóját használja [az hálózat összevont hálózati létrehozása](https://docs.microsoft.com/cli/azure/network/nic#create) rendelkező a **– nyilvános ip-címek** paraméter. |
...
| Sablon | A hálózatok és alhálózatok létrehozásával legegyszerűbb módja a egy meglévő sablont, például letöltési [két vnettel rendelkező virtuális hálózati](https://github.com/Azure/azure-quickstart-templates/tree/master/101-vnet-two-subnets), és módosítsa az igényeinek. |
