...
A [hálózati adapter (NIC)](../articles/virtual-network/virtual-network-network-interface.md) a virtuális gép és a virtuális hálózat (VNet) közötti kapcsolat. Egy virtuális gépnek legalább egy hálózati adapterrel kell rendelkeznie, de a létrehozott virtuális gép méretétől függően több ilyennel is rendelkezhet. Ismerje meg, hogy az egyes virtuálisgép-méretek hány NIC-t támogatnak [Windows](../articles/virtual-machines/windows/sizes.md) vagy [Linux](../articles/virtual-machines/linux/sizes.md) rendszeren.
...
Az Azure-ban az alábbi [IP-cím](../articles/virtual-network/public-ip-addresses.md)típusokat rendelheti egy hálózati adapterhez:
...
- **[Port továbbítása](../articles/load-balancer/tutorial-load-balancer-port-forwarding-portal.md)** – meghatározza, hogy a bejövő forgalom hogyan áramlik át az ELŐTÉR-IP-címen, és a bejövő NAT-szabályokat használó háttérrendszer-IP-címhez legyen terjesztve.
...
- **[Kimenő szabályok](../articles/load-balancer/load-balancer-outbound-rules-overview.md)** – egy kimenő szabály konfigurálja a kimenő hálózati címfordítást (NAT) minden olyan virtuális gép vagy példány számára, amelyet a standard Load Balancer háttér-készlete azonosít a felületre.
...
| Metódus | Description |
| ------ | ----------- |
| Azure Portal | [A belső forgalom terhelését a Azure Portal terheléselosztási szolgáltatásával egyenlítheti](../articles/load-balancer/tutorial-load-balancer-standard-internal-portal.md)ki. |
...
A Load balancerrel és a virtuálisgép-méretezési csoportokkal kapcsolatos további információkért lásd: [hálózatkezelés az Azure-beli virtuálisgép-méretezési csoportokhoz](https://docs.microsoft.com/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-networking).
