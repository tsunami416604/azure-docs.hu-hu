...
| Módszer | Leírás |
| ------ | ----------- |
| Azure portál |  [A virtuális gépekre az Azure Portal használatával lehet terheléselosztást alkalmazni az internetes forgalomra](../articles/load-balancer/tutorial-load-balancer-standard-manage-portal.md). |
...
| Módszer | Leírás |
| ------ | ----------- |
| Azure portál | [A belső forgalom terhelését a Azure Portal egy alapszintű terheléselosztó használatával egyenlítheti](../articles/load-balancer/tutorial-load-balancer-basic-internal-portal.md)ki. |
