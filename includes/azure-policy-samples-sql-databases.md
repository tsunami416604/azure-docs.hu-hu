...
| [Transzparens adattitkosítás állapotának naplózása](../articles/governance/policy/samples/audit-trans-data-enc-status.md) | Naplózza, ha az SQL-adatbázis transzparens adattitkosítása nincs engedélyezve.  |