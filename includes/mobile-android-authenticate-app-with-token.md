...
3. 在 ToDoActivity.java 檔案中，新增下列定義 `cacheUserToken` 方法。
...
4. 在 ToDoActivity.java 檔案中，新增下列定義 `loadUserTokenCache` 方法。
...
5. 在 *ToDoActivity.java* 檔案中，將 `驗證` 方法，使用下列方法會使用權杖快取。 如果您想要使用 Google 以外的帳戶，請變更登入提供者。
