...
A futtatókörnyezet, az alábbi parancs értéke `PHP|7.0`. Minden támogatott futtatókörnyezetek megtekintéséhez futtassa [az webalkalmazás lista-futtatókörnyezetek](/cli/azure/webapp#list-runtimes). 
