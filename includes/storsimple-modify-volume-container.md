...
2. 在磁碟區容器的表格式清單中，選取您想要修改，然後按一下 [設定 **修改**。

3. 在 **修改磁碟區容器** 對話方塊方塊中，執行下列動作:
    ...
    2. 指定之後，就無法變更加密金鑰和儲存體帳戶。 如果您指定 **選取頻寬範本**, ，按一下箭頭以繼續進行下一個頁面。

4. 中的下一個頁面 **修改磁碟區容器** ] 對話方塊中:
    ...
    3. 按一下核取圖示 ![核取圖示](./media/storsimple-modify-volume-container/HCS_CheckIcon-include.png) 儲存更新的設定。  **磁碟區容器** 頁面將會更新以反映所做的變更。
