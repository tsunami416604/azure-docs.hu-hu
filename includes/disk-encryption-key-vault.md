...
Ehelyett egy KEK-t is importálhat a helyszíni kulcskezelő HSM-ből. További információ: [Key Vault dokumentáció](../articles/key-vault/keys/hsm-protected-keys.md).
