...
6. 輸入下列命令: `Invoke-hcssetupwizard`。
...
8. (選用) 設定 Web Proxy 伺服器。 雖然 Web Proxy 設定是選用的，但**請注意，如果您使用 Web Proxy，就只能在此處設定它**。 如需詳細資訊，請移至 [設定裝置的 web proxy](../articles/storsimple/storsimple-configure-web-proxy.md)。
