...
6.  Republish the mobile service project to Azure.
  ...
  [How to Use Code First Migrations to Update the Data Model]: /en-us/documentation/articles/mobile-services-dotnet-backend-how-to-use-code-first-migrations
