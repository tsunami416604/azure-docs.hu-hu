## <a name="what-is-the-table-service"></a>Mi az a Table Service?
...
A Table Service szolgáltatás hatalmas strukturált, nem relációs adatkészletek tárolására és lekérdezésére alkalmas, a táblák pedig az igény növekedésével együtt nőnek.
