...
2. A bal oldali menüben kattintson az **Új**, az **Adatbázisok**, majd az **Azure Cosmos DB** elemre.
   ...
   ![Képernyőfelvétel az Azure portálról, a További szolgáltatások és az Azure Cosmos DB menüpont kiemelve](./media/documentdb-create-dbaccount/create-nosql-db-databases-json-tutorial-1.png)
...
3. Az **Új fiók** panelen adja meg az Azure Cosmos DB-fiók kívánt beállításait. 
    ...
    ![Képernyőfelvétel az Új Azure Cosmos DB panelről](./media/documentdb-create-dbaccount/create-nosql-db-databases-json-tutorial-2.png)
    ...
    AP|Table (kulcs-érték)|Ebben a cikkben a [Table API](../articles/cosmos-db/table-introduction.md) használatával fogunk programozni.|
...
5. Az eszköztáron kattintson az **Értesítések** parancsra az üzembe helyezési folyamat megfigyeléséhez.
    ...
    ![Központi telepítés elindítva értesítés](./media/documentdb-create-dbaccount/azure-documentdb-nosql-notification.png)

6.  Amikor befejeződött a telepítés, nyissa meg az új fiókot az Összes erőforrás csempén. 

    ![DocumentDB-fiók az Összes erőforrás csempén](./media/documentdb-create-dbaccount/azure-documentdb-all-resources.png)