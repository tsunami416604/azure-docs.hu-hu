...
ms.locfileid: "38755889"
---
Az alábbiakban az Azure Active Directory szolgáltatás használati és egyéb szolgáltatási korlátai olvashatóak.

| Kategória | Korlátok |
| --- | --- |
| Könyvtárak |Egy felhasználó társítható egy legfeljebb 500 Azure Active Directory-címtár.<br />Példák a lehetséges kombinációkra: <ul> <li>Egy felhasználó létrehoz 500 könyvtárak.</li><li>Egy-egy felhasználóhoz, amelynek 500 könyvtárak kerül.</li><li>Egy felhasználó létrehoz 250 címtárat, és később hozzá mások által 250 más címtárakhoz.</li></ul> |
