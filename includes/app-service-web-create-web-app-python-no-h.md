...
A futtatókörnyezet, az alábbi parancs értéke `python|3.4`. Minden támogatott futtatókörnyezetek megtekintéséhez futtassa [az webalkalmazás lista-futtatókörnyezetek](/cli/azure/webapp#list-runtimes). 
