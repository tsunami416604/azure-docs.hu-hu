...
1. 在 **StorSimple Manager 服務** 頁面上，按一下您所建立的服務。 這樣會帶您到 **快速入門** 頁面。 (您可以按一下 [快速啟動圖示 ![StorSimple 快速入門圖示 ](./media/storsimple-get-service-registration-key-gov/HCS_QuickStartIcon-include.png) 存取 **快速入門** 頁面在任何時間。)
...
4. 按一下複製圖示 ![StorSimple 複製圖示](./media/storsimple-get-service-registration-key-gov/HCS_CopyIcon-include.png) 若要複製的機碼並加以儲存供日後使用。
