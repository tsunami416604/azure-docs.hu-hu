> [!IMPORTANT]
> A HDInsight-erőforrások Azure Service Managerrel történő kezelésének Azure parancssori felületi támogatása **elavult**, így 2017. január 1-től megszűnik. A jelen dokumentumban leírt lépések az új Azure parancssori felület parancsait használják, amelyek az Azure Resource Managerrel (ARM) működnek.
> 
