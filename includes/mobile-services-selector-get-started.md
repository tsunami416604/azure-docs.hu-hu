...
- [(Windows 執行階段 8.1 通用 C# |.NET)](../articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started.md)
- [(Windows 執行階段 8.1 通用 C# |) Javascript](../articles/mobile-services-javascript-backend-windows-store-dotnet-get-started.md)
- [(Windows 執行階段 8.1 通用 JavaScript |) Javascript](../articles/mobile-services-javascript-backend-windows-store-javascript-get-started.md)
