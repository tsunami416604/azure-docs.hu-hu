...
2. A portál bal oldali navigációs paneljén kattintson a **+ Erőforrás létrehozása**, a **Vállalati integráció**, majd a **Relay** elemre.
...
2. A Relay-névtér ablakában kattintson a **Megosztott elérési házirendek** elemre.
3. A **Megosztott elérési házirendek** ablakban kattintson a **RootManageSharedAccessKey** elemre.
   
    ![connection-info][connection-info]
4. A **Házirend: RootManageSharedAccessKey** képernyőn a **Kapcsolati karakterlánc – elsődleges kulcs** melletti **Másolás** gombra kattintva másolja a kapcsolati karakterláncot a vágólapra későbbi használatra. Illessze be ezt az értéket a Jegyzettömbbe vagy egy másik ideiglenes helyre.
