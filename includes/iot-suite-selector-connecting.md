...
> [!NOTE]
> Ha már hozzáadott egy eszközt a megoldásban, kihagyhatja ezt a lépést. A következő lépésben azonban szükség van az eszköz kapcsolati karakterláncára. Lekérheti az eszközhöz tartozó kapcsolatok karakterláncát a [Azure Portal](https://portal.azure.com) vagy az az [IOT](/cli/azure/iot?view=azure-cli-latest) CLI eszköz használatával.
