...
IIS | – Nincs előre meglévő alapértelmezett webhely. <br> – A 443-es porton nem figyelhető előre meglévő webhely vagy alkalmazás. <br>– Engedélyezze a [névtelen hitelesítést](https://technet.microsoft.com/library/cc731244(v=ws.10).aspx). <br> – Engedélyezze a [FastCGI](https://technet.microsoft.com/library/cc753077(v=ws.10).aspx) -beállítást.
| 
...
MySQL | Telepíteni kell a MySQL-t. Manuálisan is telepítheti, vagy Azure Site Recovery telepítheti. (További információt a [beállítások konfigurálása](../articles/site-recovery/vmware-azure-deploy-configuration-server.md#configure-settings)című témakörben talál.)
