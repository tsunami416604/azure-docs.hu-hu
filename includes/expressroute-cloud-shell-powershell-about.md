...
Ha nem szeretné használni az Azure Cloud Shellt, az Azure PowerShell helyi telepítése helyett. Mindenképpen telepítse a naprakész funkcióját Az Azure PowerShell modul legújabb verzióját. További információkért lásd: [Azure PowerShell telepítése](/powershell/azure/overview).
