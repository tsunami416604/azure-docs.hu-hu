...
-   [The Components of Azure][The Components of Azure]
...
-   [Big Compute and Data][Big Compute and Data]
-   [Media][Media]
-   [Commerce][Commerce]

[Getting Started][Getting Started]

## <span id="components"></span></a>The Components of Azure

Azure groups services into categories in the Management Portal and on various visual aids like the [What Is Windows Azure Infographic][What Is Windows Azure Infographic]. The Management Portal is what you use to manage most (but not all) services in Azure.
...
## <span id="portal"></span></a>Management Portal

Azure has a web interface called the [Management Portal][1] that allows administrators to access and administer most, but not all Azure features. Microsoft typically releases the newer UI portal in beta before retiring an older one. The newer one is called the ["Azure Preview Portal"]["Azure Preview Portal"].
...
## <span id="data"></span></a>Data Management
...
## <span id="networking"></span></a>Networking
...
For more information about planning and creating a virtual network that works for you, see [Virtual Network][Virtual Network].
...
For more information about ExpressRoute, see [ExpressRoute Technical Overview][ExpressRoute Technical Overview].
...
## <span id="DevService"></span></a>Developer Services
...
These SDKs help you build, deploy, and manage Azure applications. They're available either from [www.microsoftazure.com][www.microsoftazure.com] or GitHub, and they can be used with Visual Studio and Eclipse. Azure also offers command line tools that developers can use with any editor or development environment, including tools for deploying applications to Azure from Linux and Macintosh systems.
...
## <span id="identity"></span></a>Identity and Access
...
If you already using Windows Server or System Center, Azure backup is a natural solution for backing up your servers file system, virtual machines, and SQL Server databases. It works with encrypted, sparse and compressed files. There are some limitations, so you should [check the Azure Backup pre-requisites][check the Azure Backup pre-requisites] first.

## <span id="messaging"></span></a>Messaging and Integration
...
Because of the way the Azure grew over time, Azure Storage Queues and Service Bus Queues provide similar queuing services. The reasons why you would want to use one over the other are covered in the fairly technical paper [<link>][<link>]. In many scenarios, either will work.
...
## <span id="ComputeAssist"></span></a>Compute Assistance
...
## <span id="Performance"></span></a>Performance
...
## <span id="BigStuff"></span></a>Big Data and Big Compute
...
## <span id="start"></span></a>Getting Started

Now that you have the big-picture, the next step is to write your first Azure application. Choose your language, [get the appropriate SDK][get the appropriate SDK], and go for it. Cloud computing is the new default--get started now.
  ...
  [What Is Windows Azure Infographic]: http://azure.microsoft.com/en-us/documentation/infographics/azure/ "What Is Microsoft Azure Poster Infographic"
  ...
  [ExpressRoute Technical Overview]: http://msdn.microsoft.com/en-us/library/azure/dn606309.aspx
  [TrafficManager]: ./media/intro-to-azure/TrafficManagerIntroNew.png
  [www.microsoftazure.com]: http://azure.microsoft.com/en-us/downloads/
  ...
  [check the Azure Backup pre-requisites]: http://technet.microsoft.com/en-us/library/dn296608.aspx
  ...
  [get the appropriate SDK]: /en-us/downloads/
