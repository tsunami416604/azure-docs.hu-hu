...
| &emsp;&emsp;`autoscaleEnabled` | `autoscale_enabled` | Azt határozza meg, hogy engedélyezi-e az automatikus skálázást a webszolgáltatáshoz. `numReplicas`  = If `0`, `True`; Ellenkező esetben `False`. |
