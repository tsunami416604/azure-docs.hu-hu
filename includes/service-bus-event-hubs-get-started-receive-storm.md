...
2. 複製 `%STORM_HOME%\examples\eventhubspout\eventhubs-storm-spout-0.9-jar-with-dependencies.jar` 檔案到您的本機開發環境。 這包含 events-storm-spout。
