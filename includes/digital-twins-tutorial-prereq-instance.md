...
Ha már rendelkezik Azure digitális Twins-példánnyal az oktatóanyagban való együttműködéshez, szüksége lesz a példány **_állomásneve_** (keresse meg a[portálon](../articles/digital-twins/how-to-set-up-instance-portal.md#verify-success-and-collect-important-values)).