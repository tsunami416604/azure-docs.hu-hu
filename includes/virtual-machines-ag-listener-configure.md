...
3. A rendelkezésre állási csoport fürtszerepkört a hálózatról. A **Feladatátvevőfürt-kezelőben** alatt **szerepkörök**, kattintson a jobb gombbal a szerepkört, és válassza ki **szerepkör leállítása**.

4. <a name="congroup"></a>Az IP-erőforrást a rendelkezésre állási csoport konfigurálása.
...
5. <a name = "dependencyGroup"></a>Győződjön meg az SQL Server rendelkezésre állási csoport erőforrása az ügyfél hozzáférési pontjának függ.
...
6. <a name="listname"></a>Ellenőrizze az ügyfél hozzáférési pont erőforrás függ az IP-címet.
...
7. <a name="setparam"></a>Állítsa a fürt paramétereit a PowerShellben.
...
8. A rendelkezésre állási csoport fürtszerepkör online állapotba. A **Feladatátvevőfürt-kezelőben** alatt **szerepkörök**, kattintson a jobb gombbal a szerepkört, és válassza ki **szerepkör indítása**.
...
2. Kattintson a jobb gombbal **IP-cím**, és válassza ki **tulajdonságok**.

3. Másolás a **neve** IP-cím. Ez lehet `Cluster IP Address`. 

4. <a name="setwsfcparam"></a>Állítsa a fürt paramétereit a PowerShellben.
