...
![可用的視訊](./media/storsimple-take-backup/Video_icon.png) **可用的視訊**

若要看影片，示範如何取得 StorSimple 備份，按一下 [ [這裡](http://azure.microsoft.com/documentation/videos/take-a-storsimple-backup/)。
