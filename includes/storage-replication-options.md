...
For more details about replication options, see the [Azure Storage Team Blog][Azure Storage Team Blog] and [Azure Storage Redundancy Options][Azure Storage Redundancy Options].

The pricing differences between the various replication options can be found on the [Storage Pricing Details][Storage Pricing Details] page.

  [Azure Storage SLA]: /en-us/support/legal/sla/
  [Azure Storage Team Blog]: http://blogs.msdn.com/b/windowsazurestorage/
  [Azure Storage Redundancy Options]: http://msdn.microsoft.com/en-us/library/azure/dn727290.aspx
  [Storage Pricing Details]: /en-us/pricing/details/storage/
