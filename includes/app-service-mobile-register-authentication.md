首先，您必須在身分識別提供者網站中註冊您的應用程式，然後在行動應用程式後端中設定提供者產生的認證。

1. 依照提供者特定的指示設定您偏好的身分識別提供者：

    + [Azure 的 Active Directory](../articles/app-service-mobile/app-service-mobile-how-to-configure-active-directory-authentication.md)
