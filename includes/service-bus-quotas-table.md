...
| Témakörök és üzenetsorok száma névterenként |Névtér |Új témakör vagy a névtér a várólista létrehozása a későbbi kérelmeket a rendszer elutasítja. Eredményként, ha keresztül lehet konfigurálni a [az Azure portal][Azure portal], akkor jön létre, egy hibaüzenet. A felügyeleti API-t hív, ha kivétel a hívó kód érkezik. |10 000 (alapszintű/Standard szintű). Üzenettémák és -névtérben található üzenetsorok száma legfeljebb 10 000-et kell lennie. <br/><br/>A prémium szintű üzenetkezelési unit(MU) 1000. Maximális 4000-es érték. |
