...
|佇列/主題/訂閱實體的訊息大小|全系統|靜態|超過這些配額的內送訊息將會遭到拒絕，並呼叫程式碼將會收到例外狀況。|最大訊息大小 ︰ 256 KB。 <br /><br />**請注意** 系統負擔，因為這項限制通常會稍微少於 256 KB。<br /><br />標頭大小上限 ︰ 64 KB<br /><br />屬性包中的標頭屬性數目上限 ︰ **MaxValue**<br /><br />屬性包中屬性的大小上限 ︰ 沒有明確的限制。 受限於標頭大小上限。|
