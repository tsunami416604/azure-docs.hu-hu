...
| Témánként előfizetéseinek száma. |Entitás |A témakör a további előfizetések létrehozására szolgáló későbbi kérelmeket a rendszer elutasítja. Ennek eredményeképpen ha a portálon keresztül konfigurálható, egy hibaüzenet jelenik meg. A felügyeleti API-t hív, ha kivétel a hívó kód érkezik. |Standard és prémium szintű: Az egyes előfizetésekhez, beleszámít 1000 entitásokat, a beállított kvótát, üzenetsorok, témakörök és előfizetések névterenként. |
