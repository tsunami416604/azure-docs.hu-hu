...
A Linux rendszerű virtuális gépek átméretezésével kapcsolatos további információkért lásd: [linuxos virtuális gép átméretezése az Azure CLI](../articles/virtual-machines/linux/change-vm-size.md)-vel. Ha Windows rendszerű virtuális gépeket használ, és inkább a PowerShellt szeretné használni, tekintse meg [a Windows rendszerű virtuális gép](../articles/virtual-machines/windows/resize-vm.md)átméretezése  
...
| Méret | vCPU | Memória: GiB | Ideiglenes tároló (HDD): GiB | Adatlemezek max. száma | Adatlemez maximális átviteli sebessége: IOPS | Hálózati adapterek max. száma / várt hálózati sávszélesség (Mbps)  |
| --- | --- | --- | --- | --- | --- | --- |
...
| Size | vCPU | Memória: GiB | Ideiglenes tároló (HDD): GiB | Adatlemezek max. száma | Adatlemez maximális átviteli sebessége: IOPS | Hálózati adapterek maximális száma|
| --- | --- | --- | --- | --- | --- | --- |
...
<sup>2</sup> a VM-család a következő processzorok egyikén futhat: 2,2 GHz-es Intel Xeon® E5-2660 v2, 2,4 GHz-es Intel Xeon® E5-2673 v3 (Haswell) vagy 2,3 GHz-es Intel XEON® E5-2673 v4 (Broadwell)  
...
| &nbsp;<sup>3</sup> . Standard_GS4 |16 |224 |448 |64 |80,000 / 800 (2,112) |40,000 / 1,000 |8 / 16000 |
...
| &nbsp;<sup>1</sup> . Standard G5 | 32        | 448         | 6,144          | 96000 / 1500 / 750                                       | 64 / 64 x 500                     | 8 / 20000           |
