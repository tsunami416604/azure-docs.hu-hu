...
* [Azure Functions – ajánlott eljárások](../articles/azure-functions/functions-best-practices.md)
...
* [Az Azure Functions tesztelése](../articles/azure-functions/functions-test-a-function.md)  
  Különböző függvénytesztelési eszközöket és technikákat ír le.
* [Az Azure Functions méretezése](../articles/azure-functions/functions-scale.md)  
