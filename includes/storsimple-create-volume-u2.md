...
2. A Kötet hozzáadása varázslóban az **Alapbeállítások** területen:
   ...
   1. Kattintson a nyíl ikonra ![nyíl ikon](./media/storsimple-create-volume-u2/HCS_ArrowIcon-include.png) a következő oldalra lépéshez.
