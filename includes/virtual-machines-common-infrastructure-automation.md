...
- [Hozzon létre egy alapszintű DSC-konfigurációt](https://msdn.microsoft.com/powershell/dsc/quickstarts/website-quickstart).
...
## <a name="azure-custom-script-extension"></a>Egyéni Azure-szkriptek bővítménye
