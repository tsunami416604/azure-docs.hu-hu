...
A [Linux](../articles/virtual-machines/linux/extensions-customscript.md) vagy a [Windows rendszerhez](../articles/virtual-machines/windows/extensions-customscript.md) készült egyéni parancsfájl-bővítmény letölti és végrehajtja az Azure-beli virtuális gépeken futó parancsfájlokat. A bővítményt a virtuális gép létrehozásakor vagy a virtuális gép használatba helyezésekor bármikor használhatja.
...
[Azure Resource Manager](../articles/azure-resource-manager/templates/overview.md) az Azure üzembe helyezési és kezelési szolgáltatása. Olyan felügyeleti réteget biztosít, amely lehetővé teszi az Azure-előfizetésében lévő erőforrások létrehozását, frissítését és törlését. A felügyeleti funkciókat, például a hozzáférés-vezérlést, a zárolásokat és a címkéket használhatja az erőforrások biztonságossá tételéhez és rendszerezéséhez az üzembe helyezés után.

Az alábbiak végrehajtásának módját ismerheti meg:

- [Helyszíni virtuális gépek üzembe helyezése Resource Manager-sablonnal](../articles/virtual-machines/linux/spot-template.md).
- [Helyezzen üzembe egy Azure-beli virtuális gépet a C# és egy Resource Manager-sablon használatával](../articles/virtual-machines/windows/csharp-template.md).
- [Hozzon létre egy Windows rendszerű virtuális gépet egy Resource Manager-sablonból](../articles/virtual-machines/windows/ps-template.md).
