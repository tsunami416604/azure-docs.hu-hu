...
|--------|-----|-----|-----------|----------|
| TCP 80 (HTTP)|In|LAN|Igen|Ez a port a blob Storage REST API-k HTTP-n keresztüli Data Box való kapcsolódására szolgál. Ha nem csatlakozik a REST API-khoz, a rendszer automatikusan átirányítja a helyi webes felhasználói felületre a 8443-es kapcsolaton keresztül. |
| TCP 443 (HTTPS)|In|LAN|Igen|Ez a port a blob Storage REST API-k HTTPS-kapcsolaton keresztüli Data Box való kapcsolódására szolgál. Ha nem csatlakozik a REST API-khoz, a rendszer automatikusan átirányítja a helyi webes felhasználói felületre a 8443-es kapcsolaton keresztül. |
