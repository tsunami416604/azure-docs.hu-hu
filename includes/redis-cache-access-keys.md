...
Amikor az Azure Cache a Redis-példányt, akkor a gyorsítótár-ügyfelek a gyorsítótár kell a gazdagépnév, portok és egy kulcsot. Egyes ügyfelek különböző neveken hivatkozhatnak ezekre az elemekre. Ezeket az információkat lekérheti az Azure Portalon.
...
2. A gazdagépnév és a hozzáférési kulcsok lekéréséhez válassza a **Tulajdonságok** lehetőséget.
    ...
    ![Az Azure Cache a Redis-tulajdonságok](media/redis-cache-access-keys/redis-cache-hostname-ports.png)
