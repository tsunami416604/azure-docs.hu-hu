...
ms.locfileid: "34664622"
---
### <a name="network-security-groups"></a>Network Security Groups (Hálózati biztonsági csoportok)

|  |  |
|---------|---------|
| [NSG X minden hálózati adapteren](../articles/azure-policy/scripts/nsg-on-nic.md) | Előírja, hogy minden virtuális hálózati adapterhez egy adott hálózati biztonsági csoportot kell használni. A használandó hálózati biztonsági csoport azonosítóját Ön határozza meg. |
