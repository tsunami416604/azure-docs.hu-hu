...
2. 程式碼中必須根據 `import` 陳述式解析的標準 Android 物件可能會產生錯誤訊息。
...
2. 在 [專案總管] 索引標籤的 [Gradle 指令碼]**** 下，開啟 **build.gradle (modeule: app)** 檔案。 請確認 **compileSdkVersion** 和 **buildToolsVersion** 設定最新安裝的 SDK 版本。 標記外觀如下：
