...
| [Bejelentkezés hozzáadása egy többplatformos Xamarin-alkalmazás](https://github.com/Azure-Samples/active-directory-xamarin-native-v2)| [Bejelentkezés felvétele Node.js-webalkalmazás](https://github.com/AzureADQuickStarts/AppModelv2-WebApp-OpenIDConnect-nodejs) |[Az OpenID Connect protokollal JavaScript gyógyfürdők](../articles/active-directory/develop/active-directory-v2-protocols-implicit.md) |
