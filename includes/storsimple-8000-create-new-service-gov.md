...
3. Hajtsa végre a következő lépéseket a **StorSimple-eszközkezelő** paneljén:
   ...
   4. Adjon meg egy **helyet** a szolgáltatáshoz. A földrajzi régióban, ahol szeretné az eszköz üzembe helyezése helyre hivatkozik. Válassza ki **USGov Iowa** vagy **USGov Virgina**.
