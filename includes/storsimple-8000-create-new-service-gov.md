...
3. Hajtsa végre a következő lépéseket a **StorSimple-eszközkezelő** paneljén:
   ...
   4. Adjon meg egy **helyet** a szolgáltatáshoz. A hely arra a földrajzi régióra utal, ahová az eszközt telepíteni szeretné. Válassza a **USA Korm. Iowa** vagy a **USA Korm. Virginia**lehetőséget.
