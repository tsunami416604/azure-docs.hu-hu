...
2. A kormányzati portálon kattintson a **+** és a Marketplace-en kattintson **összes**. _StorSimple fizikai eszközök_ keresése. Válassza ki, majd kattintson a **StorSimple fizikaieszköz-sorozat** lehetőségre, majd kattintson a **Létrehozás** gombra. Másik lehetőségként a kormányzati portálon kattintson **+** , majd a **tárolási**, kattintson a **StorSimple fizikaieszköz-sorozat**.
3. Hajtsa végre a következő lépéseket a **StorSimple-eszközkezelő** paneljén:
   ...
   4. Adjon meg egy **helyet** a szolgáltatáshoz. A földrajzi régióban, ahol szeretné az eszköz üzembe helyezése helyre hivatkozik. Válassza ki **USGov Iowa** vagy **USGov Virginia**.
